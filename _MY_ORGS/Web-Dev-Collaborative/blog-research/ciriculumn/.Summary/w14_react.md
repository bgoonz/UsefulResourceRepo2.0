...
- [**React Concepts And Features**](#react-concepts-and-features)
  ...
  - [Speed](#speed)
- [**Intro to ES6 Modules**](#intro-to-es6-modules)
...
[**Basic React Learning Objectives**](#basic-react-learning-objectives)
- [**From JavaScript To DOM**](#from-javascript-to-dom)
...
- [*Walk-Through: Creating Elements In React*](#walk-through-creating-elements-in-react)
- [**Thinking In Components**](#thinking-in-components)
  - [Components](#components)
  - [The navigation component](#the-navigation-component)
  - [The details components](#the-details-components)
  - [Putting it all together](#putting-it-all-together)
  - [There is probably more](#there-is-probably-more)
- [*JSX Walk-Through: Navigation Component*](#jsx-walk-through-navigation-component)
- [*JSX Walk-Through: Pet Details, Part 1*](#jsx-walk-through-pet-details-part-1)
- [*JSX Walk-Through: Pet Details, Part 2*](#jsx-walk-through-pet-details-part-2)

[**React Class Components Learning Objectives**](#react-class-components-learning-objectives)
- [**Simple React Project**](#simple-react-project)
...
- [**Official React Documentation**](#official-react-documentation)
- [*Calculator Project*](#calculator-project)
- [*React Widgets Project*](#react-widgets-project)

[**React Router Learning Objectives**](#react-router-learning-objectives)
[**React Builds Learning Objectives**](#react-builds-learning-objectives)
- [**React Router Introduction**](#react-router-introduction)
  - [Getting started with routing](#getting-started-with-routing)
  - [Creating frontend routes](#creating-frontend-routes)
  - [Match](#match)
- [**React Router Navigation**](#react-router-navigation)
  - [Adding links for navigation](#adding-links-for-navigation)
  - [Switching between routes](#switching-between-routes)
  - [Redirecting users](#redirecting-users)
  - [History](#history)
- [**React Router Nested Routes**](#react-router-nested-routes)
  - [Why nested routes?](#why-nested-routes)
  - [What are nested routes?](#what-are-nested-routes)
- [**React Builds**](#react-builds)
  - [Understanding front-end builds](#understanding-front-end-builds)
  - [Pulling back the covers (a bit) on the Create React App build process](#pulling-back-the-covers-a-bit-on-the-create-react-app-build-process)
  - [Preparing to deploy a React application for production](#preparing-to-deploy-a-react-application-for-production)
- [**React Router Documentation**](#react-router-documentation)
  - [Setting up React Router](#setting-up-react-router)
  - [Routes and Links](#routes-and-links)
  - [Switch and Redirect](#switch-and-redirect)
  - [React Router Params (ownProps)](#react-router-params-ownprops)
- [*Rainbow Routes Project*](#rainbow-routes-project)
- [*Exploring React Builds Project*](#exploring-react-builds-project)

[**React Context Learning Objectives**](#react-context-learning-objectives)
- [**React Context**](#react-context)
  - [Using Context](#using-context)
  - [Updating the Context from a nested component](#updating-the-context-from-a-nested-component)
- [*React Context To-do List Project*](#react-context-to-do-list-project)
- [*React Twitter Lite Project*](#react-twitter-lite-project)
...
's own learning platform that you're reading this on uses React as
...
[Convert element tree to virtual DOM]: https://-open-assets.s3-us-west-1.amazonaws.com/Modular-Curriculum/content/react-redux/topics/intro-to-react/assets/react-example-conversion-virtual-dom.svg
...
[Hello programmers with dev tools]:
  https://-open-assets.s3-us-west-1.amazonaws.com/Modular-Curriculum/content/react-redux/topics/intro-to-react/assets/react-hello-programmers-create-element-with-react-tools.png
[React DevTools for Google Chrome screenshot]:
  https://-open-assets.s3-us-west-1.amazonaws.com/Modular-Curriculum/content/react-redux/topics/intro-to-react/assets/react-devtools.png
...
[Petrack pet detail page]: https://-open-assets.s3-us-west-1.amazonaws.com/Modular-Curriculum/content/react-redux/topics/intro-to-react/assets/pettrack-pet-detail.png
...
[Petrack PetDetails before and after load]: https://-open-assets.s3-us-west-1.amazonaws.com/Modular-Curriculum/content/react-redux/topics/intro-to-react/assets/react-information-data-load.gif
[Petrack PetDetails with loading message]: https://-open-assets.s3-us-west-1.amazonaws.com/Modular-Curriculum/content/react-redux/topics/intro-to-react/assets/react-information-with-loading-message-data-load.gif
[Data passed down to PetDetailPage]: https://-open-assets.s3-us-west-1.amazonaws.com/Modular-Curriculum/content/react-redux/topics/intro-to-react/assets/create-react-app-passing-data-into-pet-detail-page.gif
...
help save you time,  has a custom template that you can use with
...
[react simple project]: https://github.com/-starters/react-simple-project
...
[init state]: https://-open-assets.s3-us-west-1.amazonaws.com/Modular-Curriculum/content/react-redux/topics/react-class-components/assets/react-class-components-init-state.png
...
[console alert button]: https://-open-assets.s3-us-west-1.amazonaws.com/Modular-Curriculum/content/react-redux/topics/react-class-components/assets/event-handling-console-alert-button.png
...
[onchange event handler]: https://-open-assets.s3-us-west-1.amazonaws.com/Modular-Curriculum/content/react-redux/topics/react-class-components/assets/react-forms-onchange-event-handler.png
...
ReactDOM.render(
  <React.StrictMode>
    <FetchingData gitHubUsername='' />
  </React.StrictMode>,
  document.getElementById('root')
);
```

Here's the component displaying the public repositories for the ``
GitHub username:
...
[component lifecycle demo]: https://-open-assets.s3-us-west-1.amazonaws.com/Modular-Curriculum/content/react-redux/topics/react-class-components/assets/component-lifecycle-demo.png
...
[create-react-app]: https://github.com/facebook/create-react-app
[Live Demo]: https://.github.io/curriculum/calculator/
...
running `npx create-react-app widgets --template @/simple`. Note how
...
[**Live Demo!**]:
  https://.github.io/curriculum/widgets/
...
```sh
npx create-react-app rainbow-routes --template @/simple
```
...
```sh
npx create-react-app exploring-react-builds --template @/simple
```
...
[create-react-app]: https://github.com/facebook/create-react-app
[react builds cat]: https://-open-assets.s3-us-west-1.amazonaws.com/Modular-Curriculum/content/react-redux/topics/react-builds/assets/react-builds-cat.png
...
[react builds transpilation]: https://-open-assets.s3-us-west-1.amazonaws.com/Modular-Curriculum/content/react-redux/topics/react-builds/assets/react-builds-transpilation.png
...
```sh
git clone https://github.com/-starters/react-context-pups-starter.git
```
...
```sh
npx create-react-app context-to-do-list --template @/simple
```
...
[debugger-context]: https://-open-assets.s3-us-west-1.amazonaws.com/Modular-Curriculum/content/react-redux/topics/react-context/assets/debugger-context.gif
[debugger-createTask]: https://-open-assets.s3-us-west-1.amazonaws.com/Modular-Curriculum/content/react-redux/topics/react-context/assets/debugger-createTask.gif
...
```sh
git clone https://github.com/-starters/react-twitter-revisited-starter.git
```
...
```sh
npx create-react-app twitter-front-end --template @/simple
```
