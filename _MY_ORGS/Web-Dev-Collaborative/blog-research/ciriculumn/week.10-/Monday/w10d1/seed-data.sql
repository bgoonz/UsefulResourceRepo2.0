...
-- Can insert this into a database with a simple command.
-- psql -d [database] < [path_to_file/file.sql]
-- The left caret (<) takes the standard input from the file on the right (your seed file) and inputs it into the program on the left (psql).
