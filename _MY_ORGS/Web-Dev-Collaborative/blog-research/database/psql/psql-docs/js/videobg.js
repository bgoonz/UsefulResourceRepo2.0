      ...
      e.w3 && !( e.wk && e.wk < 312 ) && a && b && c && d && g ?
        ( w( b, !1 ),
          O( function () {
            ...
            let e = {}
            if ( m && typeof m === u )
              for ( let n in m ) e[ n ] = m[ n ]
            e.data = a
            e.width = c
            e.height = d
            n = {}
            if ( l && typeof l === u )
              for ( let s in l ) n[ s ] = l[ s ]
            if ( h && typeof h === u ) {
              for ( let t in h ) {
                n.flashlets =
...
( function ( p, d, t ) {
  ...
  function B( b ) {
    ...
    e( function () {
      y || ( ( y = 1 ), k() )
    }, s.errorTimeout ) !b.e && q.parentNode.insertBefore( c, q )
  }
  ...
  function D( a, g, f, p, t, N ) {
    ...
    l.src = l.data = g!c && ( l.style.display = 'none' )
    l.width = l.height = '0'
    a != 'object' && ( l.type = f )
  ...
  if ( void 0 == jQuery ) console.log( 'Jquery not included!' )
    ...
    video_background.prototype = {
      make_video: function () {
        ...
        this.video = this.$video.get( 0 ) !1 !== this.parameters.video_ratio &&
      ...
      youtube_ready_fun: function ( a ) {
        ...
        this.$video = b( '#' + this.id + '_yt' ) !1 !== this.parameters.video_ratio &&
          ( ( this.resize_timeout = !1 ),
            b( window ).resize(
              b.proxy( function () {
                clearTimeout( this.resize_timeout )
      ...
      make_flash: function () {
        let a = {
          url:
            !1 != this.parameters.mp4 ?
            this.parameters.mp4 : this.parameters.flv,
