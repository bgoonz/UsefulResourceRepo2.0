...
- [React Components & Libraries](#react-components--libraries)
      - [Contents](#contents)
  ...
  - [UI Components](#ui-components-1)
    - [Table / Data Grid](#table--data-grid-1)
    ...
    - [Chart](#chart-1)
    - [Tree](#tree-1)
    - [UI Navigation](#ui-navigation-1)
    - [Custom Scrollbar](#custom-scrollbar-1)
    - [Audio / Video](#audio--video-1)
    - [Map](#map-1)
    - [Time / Date / Age](#time--date--age-1)
    - [Photo / Image](#photo--image-1)
    - [Icons](#icons-1)
    - [Paginator](#paginator-1)
    - [Markdown Viewer](#markdown-viewer-1)
    - [Miscellaneous](#miscellaneous-5)
    - [Form Components](#form-components-1)
      - [Date / Time picker](#date--time-picker-1)
      ...
      - [Type Select](#type-select-1)
      - [Autosize Input / Textarea](#autosize-input--textarea-1)
      - [Star Rating](#star-rating-1)
      - [Drag and Drop](#drag-and-drop-1)
      - [Sortable List](#sortable-list-1)
      - [Rich Text Editor](#rich-text-editor-1)
      - [Markdown Editor](#markdown-editor-1)
      - [Image Editing](#image-editing-1)
      - [Form Component Collections](#form-component-collections-1)
      - [Miscellaneous](#miscellaneous-6)
  - [UI Layout](#ui-layout-1)
  - [UI Animation](#ui-animation-1)
    - [Parallax](#parallax-1)
  - [UI Frameworks](#ui-frameworks-1)
    - [Responsive](#responsive-1)
      - [Bootstrap](#bootstrap-1)
      - [Material Design](#material-design-1)
    - [Mobile](#mobile-1)
    - [Component Collections](#component-collections-1)
    - [Other](#other-1)
  - [UI Utilites](#ui-utilites-1)
    - [Reporter](#reporter-1)
      - [Visibility Reporter](#visibility-reporter-1)
      - [Measurement Reporter](#measurement-reporter-1)
    - [Device Input](#device-input-1)
      - [Keyboard Events](#keyboard-events-1)
      - [Scroll Events](#scroll-events-1)
      - [Touch Events](#touch-events-1)
      - [Touch Swipe](#touch-swipe-1)
      - [Mouse Events](#mouse-events-1)
    - [Meta Tags](#meta-tags-1)
    - [Portal](#portal-1)
    - [Test User Behavior](#test-user-behavior-1)
  - [Code Design](#code-design-1)
    - [Data Store](#data-store-1)
    - [Form Logic](#form-logic-1)
    - [Router](#router-1)
    - [Props from server](#props-from-server-1)
    - [Communication with server](#communication-with-server-1)
    - [CSS / Style](#css--style-1)
    - [HTML Template](#html-template-1)
    - [Isomorphic Apps](#isomorphic-apps-1)
    - [Boilerplate](#boilerplate-1)
    - [Miscellaneous](#miscellaneous-7)
  - [Utilities](#utilities-1)
    - [i18n](#i18n-1)
    - [Framework bindings / integrations](#framework-bindings--integrations-1)
    - [Integrations with Third Party Services](#integrations-with-third-party-services-1)
  - [Performance](#performance-1)
    - [UI](#ui-1)
      - [Inspect](#inspect-2)
      - [Lazy Load](#lazy-load-1)
    - [App Size](#app-size-1)
  ...
  - [Miscellaneous](#miscellaneous-9)
    - [Static Website Generator](#static-website-generator-1)
...
### Static Website Generator
 ...
 - [sitegen](https://github.com/andreypopp/sitegen) - Generate websites by composing React components.# React Components & Libraries
