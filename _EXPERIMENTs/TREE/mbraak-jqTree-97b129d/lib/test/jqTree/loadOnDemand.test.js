...
context("when a node has load_on_demand in the data", function () {
    ...
    beforeAll(function () {
        server = node_1.setupServer(
            msw_1.rest.get("/tree/", function (request, response, ctx) {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [
                                4 /*yield*/,
                                dom_1.screen.findByText("loaded-on-demand"),
                            ];
                        case 1:
                            _a.sent();
                            expect(given.$tree).toHaveTreeStructure([
    ...
    context("with autoOpen is true", function () {
        ...
        it("loads the node on demand", function () {
            return __awaiter(void 0, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
    ...
    context("with a saved state with an opened node", function () {
        ...
        it("opens the node and loads its children on demand", function () {
            return __awaiter(void 0, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
