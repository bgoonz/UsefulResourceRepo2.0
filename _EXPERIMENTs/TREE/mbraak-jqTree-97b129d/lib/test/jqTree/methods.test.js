...
describe("loadData", function () {
    ...
    context("with a node parameter which has a selected child", function () {
        ...
        context("when the selected node doesn't have an id", function () {
            ...
            context(
                "when the selected child is under another node",
                function () {
...
describe("loadDataFromUrl", function () {
    ...
    var server = null;
    beforeAll(function () {
        server = node_1.setupServer(
            msw_1.rest.get("/tree/", function (_request, response, ctx) {
    ...
    context("with url parameter", function () {
        ...
        context("with parent node", function () {
            ...
            it("loads a subtree", function () {
                return __awaiter(void 0, void 0, void 0, function () {
                    var parentNode;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                parentNode = given.$tree.tree(
    ...
    context("without url parameter", function () {
        it("loads the data from dataUrl", function () {
            return __awaiter(void 0, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
...
describe("reload", function () {
    ...
    beforeAll(function () {
        server = node_1.setupServer(
            msw_1.rest.get("/tree/", function (_request, response, ctx) {
                return response(
                    ctx.status(200),
                    ctx.json(exampleData_1["default"])
                );
            })
        );
        server.listen();
    ...
    it("reloads the data from the server", function () {
        return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
...
describe("toJson", function () {
    ...
    it("returns nodes as json", function () {
        expect(JSON.parse(given.$tree.tree("toJson"))).toEqual(
            exampleData_1["default"]
        );
    });
});
describe("updateNode", function () {
    ...
    context("when the node was selected", function () {
        ...
        it("keeps the focus on the node", function () {
            ...
            expect(
                given.$tree.tree("getNodeByHtmlElement", document.activeElement)
            ).not.toBeNil();
        });
    });
});
