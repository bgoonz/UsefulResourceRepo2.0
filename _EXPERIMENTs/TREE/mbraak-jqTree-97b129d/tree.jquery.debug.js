...
var jqtree = (function (exports, jQueryProxy) {
    ...
    ***************************************************************************** */
        ...
        */
        ...
        Node.prototype.addParent = function (nodeInfo) {
            if (!this.parent) {
                ...
                for (
                    var _i = 0, _a = originalParent.children;
                    _i < _a.length;
                    _i++
                ) {
                    var child = _a[_i];
        ...
        Node.prototype.removeChildren = function () {
            ...
            this.iterate(function (child) {
                var _a;
                (_a = _this.tree) === null || _a === void 0
                    ? void 0
                    : _a.removeNodeFromIndex(child);
                return true;
            });
            this.children = [];
        };
        ...
        Node.prototype.initFromData = function (data) {
            ...
            var addChildren = function (childrenData) {
                for (
                    var _i = 0, childrenData_1 = childrenData;
                    _i < childrenData_1.length;
                    _i++
                ) {
        ...
        Node.prototype.setParent = function (parent) {
            ...
            (_a = this.tree) === null || _a === void 0
                ? void 0
                : _a.addNodeToIndex(this);
        };
        ...
        Node.prototype.getNodeClass = function () {
            ...
            return (
                this.nodeClass ||
                ((_a =
                    this === null || this === void 0 ? void 0 : this.tree) ===
                    null || _a === void 0
                    ? void 0
                    : _a.nodeClass) ||
                Node
    ...
    var DragAndDropHandler = /** @class */ (function () {
        ...
        DragAndDropHandler.prototype.mouseStart = function (positionInfo) {
            ...
            this.dragElement = new DragElement(
                ...
                (_a = this.treeWidget.options.autoEscape) !== null &&
                _a !== void 0
                    ? _a
                    : true
            );
        ...
        DragAndDropHandler.prototype.generateHitAreas = function () {
            if (!this.currentItem) {
                ...
                var hitAreasGenerator = new HitAreasGenerator(
        ...
        DragAndDropHandler.prototype.updateDropHint = function () {
            ...
            this.removeDropHint();
            // add new drop hint
            var nodeElement = this.treeWidget._getNodeElementForNode(
                this.hoveredArea.node
            );
            this.previousGhost = nodeElement.addDropHint(
        ...
        DragAndDropHandler.prototype.startOpenFolderTimer = function (folder) {
            ...
            var openFolder = function () {
                _this.treeWidget._openNode(
                    folder,
                    _this.treeWidget.options.slide,
                    function () {
                        _this.refresh();
        ...
        DragAndDropHandler.prototype.moveItem = function (positionInfo) {
            ...
            if (
                ...
                var doMove = function () {
                    _this.treeWidget.tree.moveNode(
                        movedNode_1,
                        targetNode_1,
                        position_1
                    );
    ...
    var HitAreasGenerator = /** @class */ (function (_super) {
        ...
        HitAreasGenerator.prototype.handleClosedFolder = function (
            node,
            nextNode,
            $element
        ) {
        ...
        HitAreasGenerator.prototype.handleFirstNode = function (node) {
            if (node !== this.currentNode) {
                this.addPosition(
                    node,
                    Position.Before,
                    this.getTop(jQuery$2(node.element))
                );
            }
        };
        HitAreasGenerator.prototype.handleAfterOpenFolder = function (
            node,
            nextNode
        ) {
        ...
        HitAreasGenerator.prototype.handleNode = function (
            node,
            nextNode,
            $element
        ) {
        ...
        HitAreasGenerator.prototype.addPosition = function (
            node,
            position,
            top
        ) {
        ...
        HitAreasGenerator.prototype.generateHitAreasForGroup = function (
            hitAreas,
            positionsInGroup,
            top,
            bottom
    ...
    var DragElement = /** @class */ (function () {
        function DragElement(nodeName, offsetX, offsetY, $tree, autoEscape) {
            ...
            this.$element = jQuery$2("<span>").addClass(
    ...
    var ElementsRenderer = /** @class */ (function () {
        ...
        ElementsRenderer.prototype.createDomElements = function (
            element,
            children,
            isRootNode,
            level
        ...
        ElementsRenderer.prototype.createFolderLi = function (
            node,
            level,
            isSelected
        ) {
        ...
        ElementsRenderer.prototype.createNodeLi = function (
            node,
            level,
            isSelected
        ) {
        ...
        ElementsRenderer.prototype.createTitleSpan = function (
            nodeName,
            level,
            isSelected,
            isOpen,
        ...
        ElementsRenderer.prototype.getFolderClasses = function (
            node,
            isSelected
        ) {
    ...
    var DataLoader = /** @class */ (function () {
        ...
        DataLoader.prototype.loadFromUrl = function (
            urlInfo,
            parentNode,
            onFinished
        ) {
        ...
        DataLoader.prototype.submitRequest = function (
            urlInfoInput,
            handleSuccess,
            handleError
        ) {
            ...
            ajaxSettings.method =
                ((_a = ajaxSettings.method) === null || _a === void 0
                    ? void 0
                    : _a.toUpperCase()) || "GET";
    ...
    var register = function (widgetClass, widgetName) {
        var getDataKey = function () {
            return "simple_widget_" + widgetName;
        };
    ...
    var getPositionInfoFromMouseEvent = function (e) {
        return {
            pageX: e.pageX,
            pageY: e.pageY,
            target: e.target,
    ...
    var getPositionInfoFromTouch = function (touch, e) {
        return {
            pageX: touch.pageX,
            pageY: touch.pageY,
            target: touch.target,
    ...
    var MouseWidget = /** @class */ (function (_super) {
        ...
        function MouseWidget() {
            ...
            _this.mouseDown = function (e) {
                ...
                var result = _this.handleMouseDown(
                    getPositionInfoFromMouseEvent(e)
                );
        ...
        MouseWidget.prototype.handleMouseMove = function (e, positionInfo) {
            ...
            if (this.mouseDownInfo) {
                this.isMouseStarted =
                    this.mouseStart(this.mouseDownInfo) !== false;
            }
            if (this.isMouseStarted) {
                this.mouseDrag(positionInfo);
                if (e.cancelable) {
    ...
    var SaveStateHandler = /** @class */ (function () {
        ...
        */
        ...
        SaveStateHandler.prototype.setInitialStateOnDemand = function (
            state,
            cbFinished
        ) {
            if (state) {
        ...
        SaveStateHandler.prototype.doSetInitialStateOnDemand = function (
            nodeIdsParam,
            selectedNodes,
            cbFinished
        ) {
    ...
    var ScrollHandler = /** @class */ (function () {
        ...
        ScrollHandler.prototype.initScrollParent = function () {
            ...
            var getParentWithOverflow = function () {
                ...
                var hasOverFlow = function ($el) {
                    for (
                        var _i = 0, cssAttributes_1 = cssAttributes;
                        _i < cssAttributes_1.length;
                        _i++
                    ) {
                ...
                for (
                    var _i = 0, _a = _this.treeWidget.$el.parents().get();
                    _i < _a.length;
                    _i++
                ) {
                    var el = _a[_i];
        ...
        ScrollHandler.prototype.handleVerticalScrollingWithScrollParent =
            function (area) {
        ...
        ScrollHandler.prototype.handleVerticalScrollingWithDocument = function (
            area
        ) {
        ...
        ScrollHandler.prototype.handleHorizontalScrollingWithParent = function (
            positionInfo
        ) {
            if (
                positionInfo.pageX === undefined ||
        ...
        ScrollHandler.prototype.handleHorizontalScrollingWithDocument =
    ...
    var NodeElement = /** @class */ (function () {
        ...
        NodeElement.prototype.select = function (mustSetFocus) {
            ...
            $span.attr(
                "tabindex",
                (_a = this.treeWidget.options.tabIndex) !== null &&
                    _a !== void 0
                    ? _a
                    : null
            );
    ...
    var FolderElement = /** @class */ (function (_super) {
        ...
        FolderElement.prototype.open = function (
            onFinished,
            slide,
            animationSpeed
        ) {
    ...
    var JqTreeWidget = /** @class */ (function (_super) {
        ...
        function JqTreeWidget() {
            ...
            _this.handleDblclick = function (e) {
                var clickTarget = _this.getClickTarget(e.target);
                if (
                    (clickTarget === null || clickTarget === void 0
                        ? void 0
                        : clickTarget.type) === "label"
                ) {
            ...
            _this.handleContextmenu = function (e) {
                var $div = jQuery$1(e.target).closest(
        ...
        JqTreeWidget.prototype.toggle = function (node, slideParam) {
            ...
            var slide =
                slideParam !== null && slideParam !== void 0
                    ? slideParam
                    : this.options.slide;
            if (node.is_open) {
        ...
        */
        JqTreeWidget.prototype.loadDataFromUrl = function (
            param1,
            param2,
            param3
        ) {
            if (typeof param1 === "string") {
                ...
                this.doLoadDataFromUrl(
                    param1,
                    param2,
                    param3 !== null && param3 !== void 0 ? param3 : null
                );
            } else {
        ...
        JqTreeWidget.prototype.openNode = function (node, param1, param2) {
            ...
            var parseParams = function () {
                ...
                if (slide == null) {
                    slide =
                        (_a = _this.options.slide) !== null && _a !== void 0
                            ? _a
                            : false;
                }
        ...
        JqTreeWidget.prototype.addNodeAfter = function (
            newNodeInfo,
            existingNode
        ) {
        ...
        JqTreeWidget.prototype.addNodeBefore = function (
            newNodeInfo,
            existingNode
        ) {
            if (!existingNode) {
        ...
        JqTreeWidget.prototype.addParentNode = function (
            newNodeInfo,
            existingNode
        ) {
            if (!existingNode) {
        ...
        JqTreeWidget.prototype.appendNode = function (
            newNodeInfo,
            parentNodeParam
        ) {
        ...
        JqTreeWidget.prototype.prependNode = function (
            newNodeInfo,
            parentNodeParam
        ) {
            var parentNode =
                parentNodeParam !== null && parentNodeParam !== void 0
                    ? parentNodeParam
                    : this.tree;
        ...
        JqTreeWidget.prototype.moveNode = function (
            node,
            targetNode,
            position
        ) {
        ...
        */
        ...
        JqTreeWidget.prototype.getMouseDelay = function () {
            var _a;
            return (_a = this.options.startDndDelay) !== null && _a !== void 0
                ? _a
                : 0;
        };
        ...
        JqTreeWidget.prototype.setInitialState = function () {
            ...
            var restoreState = function () {
                ...
                if (!_this.options.saveState) {
                    ...
                    if (!state) {
                        ...
                        var mustLoadOnDemand_1 =
                            _this.saveStateHandler.setInitialState(state);
            ...
            var _a = restoreState(),
                isRestored = _a[0],
                mustLoadOnDemand = _a[1]; // eslint-disable-line prefer-const
            if (!isRestored) {
            ...
            var restoreState = function () {
                if (!_this.options.saveState) {
                    ...
                    if (!state) {
                        ...
                        _this.saveStateHandler.setInitialStateOnDemand(
                            state,
                            cbFinished
                        );
                        return true;
        ...
        JqTreeWidget.prototype.deselectNodes = function (parentNode) {
            var selectedNodesUnderParent =
                this.selectNodeHandler.getSelectedNodesUnder(parentNode);
            for (
                var _i = 0,
                    selectedNodesUnderParent_1 = selectedNodesUnderParent;
                _i < selectedNodesUnderParent_1.length;
                _i++
            ) {
        ...
        JqTreeWidget.prototype.doLoadDataFromUrl = function (
            urlInfoParam,
            parentNode,
            onFinished
        ) {
        ...
        JqTreeWidget.prototype.loadFolderOnDemand = function (
            node,
            slide,
            onFinished
        ) {
