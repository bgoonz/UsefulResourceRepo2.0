...
exports.dragAndDrop =
    exports.getTreeStructure =
    exports.selectNode =
    exports.openNode =
    exports.findNodeElement =
    exports.findTitleElement =
    exports.expectToBeClosed =
    exports.expectToBeOpen =
    exports.expectToBeSelected =
        void 0;
var expectToBeSelected = function (handle) {
    return __awaiter(void 0, void 0, void 0, function () {
        var isSelected;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    return [4 /*yield*/, isNodeSelected(handle)];
                case 1:
                    isSelected = _a.sent();
...
var expectToBeOpen = function (handle) {
    return __awaiter(void 0, void 0, void 0, function () {
        var isOpen;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    return [4 /*yield*/, isNodeOpen(handle)];
                case 1:
                    isOpen = _a.sent();
...
var expectToBeClosed = function (handle) {
    return __awaiter(void 0, void 0, void 0, function () {
        var isOpen;
        return __generator(this, function (_a) {
            switch (_a.label) {
...
var findTitleElement = function (title) {
    return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
...
var findNodeElement = function (title) {
    return __awaiter(void 0, void 0, void 0, function () {
        var titleElement;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    return [4 /*yield*/, exports.findTitleElement(title)];
                case 1:
                    titleElement = _a.sent();
                    return [
                        4 /*yield*/,
                        titleElement.evaluateHandle(function (el) {
...
var openNode = function (handle) {
    return __awaiter(void 0, void 0, void 0, function () {
        var toggler;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    return [4 /*yield*/, findToggler(handle)];
                case 1:
                    toggler = _a.sent();
...
var findToggler = function (handle) {
    return __awaiter(void 0, void 0, void 0, function () {
        var toggler;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    return [4 /*yield*/, handle.$(".jqtree-toggler")];
                case 1:
                    toggler = _a.sent();
                    if (!toggler) {
...
var isNodeOpen = function (handle) {
    return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [
                2 /*return*/,
...
var isNodeSelected = function (handle) {
    return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [
                2 /*return*/,
...
var selectNode = function (handle) {
    return __awaiter(void 0, void 0, void 0, function () {
        var titleHandle;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    return [4 /*yield*/, handle.$(".jqtree-title")];
                case 1:
                    titleHandle = _a.sent();
                    return [
                        4 /*yield*/,
                        titleHandle === null || titleHandle === void 0
                            ? void 0
                            : titleHandle.click(),
                    ];
                case 2:
...
var getRect = function (handle) {
    return __awaiter(void 0, void 0, void 0, function () {
        var boundingBox;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    return [4 /*yield*/, handle.boundingBox()];
                case 1:
                    boundingBox = _a.sent();
                    if (!boundingBox) {
...
var dragAndDrop = function (from, to) {
    return __awaiter(void 0, void 0, void 0, function () {
        var fromRect, toRect;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    return [
                        4 /*yield*/,
                        exports.findTitleElement(from).then(getRect),
                    ];
                case 1:
                    fromRect = _a.sent();
                    return [
                        4 /*yield*/,
                        exports.findTitleElement(to).then(getRect),
                    ];
                case 2:
                    toRect = _a.sent();
                    return [
