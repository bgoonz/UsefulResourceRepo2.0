...
var matchScreenshot = function (testName) {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    if (!!fs_1.existsSync(expectedImagePath))
                        return [3 /*break*/, 3];
                    return [
                        4 /*yield*/,
                        saveFile(expectedImagePath, screenshotBuffer),
                    ];
                case 2:
                    _b.sent();
                    return [2 /*return*/];
                case 3:
                    return [4 /*yield*/, readPng(expectedImagePath)];
                case 4:
                    expectedImage = _b.sent();
                    screenshot = pngjs_1.PNG.sync.read(screenshotBuffer);
                    (_a = getImagesOfEqualSize(expectedImage, screenshot)),
                        (adjustedExpectedImage = _a[0]),
                        (adjustedScreenshot = _a[1]);
                    (width = adjustedExpectedImage.width),
                        (height = adjustedExpectedImage.height);
                    ...
                    percentage = Math.pow(
                        mismatchedPixels / diff.width / diff.height,
                        0.5
                    );
                    ...
                    return [
                        ...
                        saveFile(
                            ...
                            pngjs_1.PNG.sync.write(adjustedScreenshot)
                        ),
                    ];
                case 5:
                    _b.sent();
...
var saveFile = function (filePath, buffer) {
    return __awaiter(void 0, void 0, void 0, function () {
        var file;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    return [4 /*yield*/, promises_1.open(filePath, "w")];
                case 1:
                    file = _a.sent();
                    _a.label = 2;
                case 2:
                    ...
                    return [
                        4 /*yield*/,
                        promises_1.writeFile(filePath, buffer),
                    ];
                case 3:
                    _a.sent();
                    return [3 /*break*/, 6];
...
var readPng = function (filePath) {
    return __awaiter(void 0, void 0, void 0, function () {
        var buffer;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    return [4 /*yield*/, promises_1.readFile(filePath)];
                case 1:
                    buffer = _a.sent();
