...
describe("addAfter", function () {
    ...
    given("tree", function () {
        return new node_1.Node().loadFromData(exampleData_1["default"]);
    });
...
describe("addChildAtPosition", function () {
    ...
    given("child", function () {
        return new node_1.Node("new");
    });
    given("node", function () {
        return new node_1.Node("new").loadFromData(["child1", "child2"]);
    });
    beforeEach(function () {
...
describe("addParent", function () {
    var given = givens_1["default"]();
    given("node1", function () {
        return new node_1.Node("node1");
    });
    given("tree", function () {
        return new node_1.Node({}, true);
    });
    beforeEach(function () {
...
describe("constructor", function () {
    var given = givens_1["default"]();
    given("node", function () {
        return given.params === undefined
            ? new node_1.Node()
            : new node_1.Node(given.params);
    });
...
describe("getNodeByCallback", function () {
    ...
    context("when a matching node exists", function () {
        it("returns the node", function () {
            expect(
                given.tree.getNodeByCallback(function (node) {
    ...
    context("when no matching node exists", function () {
        it("returns null", function () {
            expect(
                given.tree.getNodeByCallback(function () {
                    return false;
                })
            ).toBeNull();
        });
