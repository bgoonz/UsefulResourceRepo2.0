...
var titleSpan = function (liNode) {
    return exports.singleChild(nodeElement(liNode), "span.jqtree-title");
};
exports.titleSpan = titleSpan;
var togglerLink = function (liNode) {
    return exports.singleChild(nodeElement(liNode), "a.jqtree-toggler");
};
exports.togglerLink = togglerLink;
var nodeElement = function (liNode) {
    return exports.singleChild(jQuery(liNode), "div.jqtree-element ");
};
