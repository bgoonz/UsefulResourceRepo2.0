...
var jqtree = (function (e, t) {
    ...
    var l = {
        ...
        d = function (e) {
            for (var t in l)
                if (Object.prototype.hasOwnProperty.call(l, t) && l[t] === e)
                    return t;
            return "";
        },
        h = (function () {
            ...
            return (
                ...
                (e.prototype.getData = function (e) {
                    ...
                    var t = function (e) {
                        return e.map(function (e) {
                            ...
                            return (
                                e.hasChildren() && (o.children = t(e.children)),
                                o
                            );
                        });
                    };
                ...
                (e.prototype.getNodeClass = function () {
                    ...
                    return (
                        this.nodeClass ||
                        (null === (t = null == this ? void 0 : this.tree) ||
                        void 0 === t
                            ? void 0
                            : t.nodeClass) ||
                        e
        ...
        p = (function () {
            ...
            return (
                ...
                (e.prototype.mustOpenFolderTimer = function (e) {
                    var t = e.node;
                    return (
                        t.isFolder() && !t.is_open && e.position === s.Inside
                    );
                }),
        ...
        c = (function (e) {
            ...
            return (
                ...
                (t.prototype.handleClosedFolder = function (e, t, o) {
                    var n = this.getTop(o);
                    e === this.currentNode
                        ? this.addPosition(e, s.None, n)
                        : (this.addPosition(e, s.Inside, n),
                          t !== this.currentNode &&
                              this.addPosition(e, s.After, n));
                }),
                        ...
                        var e = this,
                            ...
                            o = function (n, r) {
                                var i =
                                    ...
                                    s = null;
                                if (n.element) {
                                    if (!(s = u(n.element)).is(":visible"))
                                        return;
                                    t && (e.handleFirstNode(n), (t = !1)),
                                        n.hasChildren()
                                            ? n.is_open
                                                ? e.handleOpenFolder(n, s) ||
                                                  (i = !1)
                                                : e.handleClosedFolder(n, r, s)
                                            : e.handleNode(n, r, s);
                                }
                                if (i) {
            ...
            return (
                ...
                (e.prototype.createUl = function (e) {
                    ...
                    e
                        ...
                        : ((t = ""), (o = "group")),
                        this.treeWidget.options.dragAndDrop &&
                            (t += " jqtree-dnd");
                ...
                (e.prototype.createLi = function (e, t) {
                    var o = Boolean(
                        ...
                        n =
                            e.isFolder() ||
                            (e.isEmptyFolder &&
                                this.treeWidget.options.showEmptyFolder)
                ...
                (e.prototype.createFolderLi = function (e, t, o) {
                    ...
                    return (
                        ...
                        a.appendChild(
                            this.createTitleSpan(e.name, t, o, e.is_open, !0)
                        ),
                        this.treeWidget.options.buttonLeft || a.appendChild(l),
                        s
                    );
                ...
                (e.prototype.createNodeLi = function (e, t, o) {
                    ...
                    return (
                        ...
                        i.appendChild(s),
                        s.appendChild(
                            this.createTitleSpan(e.name, t, o, e.is_open, !1)
                        ),
                        i
                    );
                }),
                (e.prototype.createTitleSpan = function (e, t, o, n, r) {
                    ...
                    if (
                        ...
                        i.setAttribute("aria-selected", g(o)),
                        i.setAttribute("aria-expanded", g(n)),
                        o)
                    ) {
            ...
            return (
                (e.prototype.loadFromUrl = function (e, t, o) {
                    ...
                    if (e) {
                        ...
                        this.submitRequest(
                            ...
                            function (e) {
                                i(),
                                    n.treeWidget.options.onLoadFailed &&
                                        n.treeWidget.options.onLoadFailed(e);
                            }
                        );
                    }
                }),
                ...
                (e.prototype.notifyLoading = function (e, t, o) {
                    this.treeWidget.options.onLoading &&
                        this.treeWidget.options.onLoading(e, t, o),
            ...
            return (
                ...
                (e.prototype.setInitialState = function (e) {
                    if (e) {
                        ...
                        return (
                            e.open_nodes &&
                                (t = this.openInitialNodes(e.open_nodes)),
                            e.selected_node &&
                                (this.resetSelection(),
                ...
                (e.prototype.parseState = function (e) {
                    ...
                    return (
                        o &&
                            o.selected_node &&
                            "number" == typeof (t = o.selected_node) &&
                            t % 1 == 0 &&
                            (o.selected_node = [o.selected_node]),
                        o
                    );
                }),
                            ...
                            for (var e = [], s = 0, l = i; s < l.length; s++) {
                                ...
                                h
                                    ? h.is_loading ||
                                      (h.load_on_demand
                                          ? a(h)
                                          : n.treeWidget._openNode(h, !1, null))
                                    : e.push(d);
                            }
                            (i = e),
                                n.selectInitialNodes(t) &&
            ...
            return (
                ...
                (e.prototype.initScrollParent = function () {
                    ...
                    var o = (function () {
                        ...
                        for (
                            var n = 0, r = e.treeWidget.$el.parents().get();
                            n < r.length;
                            n++
                        ) {
                            var i = r[n],
        ...
        j = (function () {
            ...
            return (
                ...
                (e.prototype.getSelectedNodes = function () {
                    ...
                    var t = [];
                    return (
                        this.selectedNodes.forEach(function (o) {
            ...
            return (
                ...
                (e.prototype.addDropHint = function (e) {
                    return this.mustShowBorderDropHint(e)
                        ? new b(this.$element, this.treeWidget._getScrollLeft())
                        : new T(this.node, this.$element, e);
                }),
                (e.prototype.select = function (e) {
                    var t,
                        o = this.getLi();
                    o.addClass("jqtree-selected"),
                        o.attr("aria-selected", "true");
                    var n = this.getSpan();
                    n.attr(
                        "tabindex",
                        null !== (t = this.treeWidget.options.tabIndex) &&
                            void 0 !== t
                            ? t
                            : null
                    ),
        ...
        w = n.default || n,
        L = "Node parameter is empty",
        H = "Parameter is empty: ",
        A = (function (e) {
            function t() {
                var t = (null !== e && e.apply(this, arguments)) || this;
                return (
            ...
            return (
                ...
                (t.prototype.loadDataFromUrl = function (e, t, o) {
                    return (
                        "string" == typeof e
                            ? this.doLoadDataFromUrl(e, t, null != o ? o : null)
                ...
                (t.prototype.addToSelection = function (e, t) {
                    ...
                    return (
                        ...
                        this._getNodeElementForNode(e).select(
                            void 0 === t || t
                        ),
                        this.saveState(),
                        this.element
                ...
                (t.prototype.init = function () {
                    e.prototype.init.call(this),
                        ...
                        (this.renderer = new v(this)),
                        (this.dataLoader = new m(this)),
                        (this.saveStateHandler = new E(this)),
                        (this.selectNodeHandler = new j(this)),
                        (this.dndHandler = new p(this)),
                        (this.scrollHandler = new C(this)),
                        (this.keyHandler = new y(this)),
                        this.initData(),
                ...
                (t.prototype.getMouseDelay = function () {
                    var e;
                    return null !== (e = this.options.startDndDelay) &&
                        void 0 !== e
                        ? e
                        : 0;
                }),
                ...
                (t.prototype.initTree = function (e) {
                    ...
                    if (this.options.nodeClass) {
                        ...
                        this._refreshElements(null),
                            n ? this.setInitialStateOnDemand(o) : o();
                    }
                }),
                    ...
                    var e = this,
                        t = (function () {
                            if (e.options.saveState) {
                                var t =
                                    e.saveStateHandler.getStateFromStorage();
                                return t
                                    ? [
                                          !0,
                                          e.saveStateHandler.setInitialState(t),
                                      ]
                                    : [!1, !1];
                            }
                            return [!1, !1];
                ...
                (t.prototype.setInitialStateOnDemand = function (e) {
                    ...
                    (function () {
                        if (r.options.saveState) {
                            ...
                            return (
                                !!t &&
                                (r.saveStateHandler.setInitialStateOnDemand(
                                    t,
                                    e
                                ),
                                !0)
                ...
                (t.prototype.doSelectNode = function (e, t) {
                    ...
                    var r = a(
                        a({}, { mustSetFocus: !0, mustToggle: !0 }),
                        t || {}
                    );
                    if (
                        o.options.onCanSelectNode
                            ? !0 === o.options.selectable &&
                        ...
                        if (this.selectNodeHandler.isNodeSelected(e))
                            ...
                            this.deselectCurrentNode(),
                                this.addToSelection(e, r.mustSetFocus),
                                this._triggerEvent("tree.select", {
                                    node: e,
                                    deselected_node: i,
                                }),
                ...
                (t.prototype.deselectNodes = function (e) {
                    for (
                        var t = 0,
                            o = this.selectNodeHandler.getSelectedNodesUnder(e);
                        t < o.length;
                        t++
                    ) {
                        var n = o[t];
