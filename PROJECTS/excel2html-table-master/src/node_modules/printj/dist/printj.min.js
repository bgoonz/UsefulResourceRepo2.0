    ...
    for (var i = 0; i < t.length; ++i) {
      ...
      switch (c) {
        ...
        case 115:
          ...
          if (width > O.length || -width > O.length) {
            if (
              ...
              pad =
                width - O.length >= 0
                  ? padstr["0"].substr(0, width - O.length)
                  : "";
              O = pad + O;
            } else {
              pad =
                width - O.length >= 0
                  ? padstr[" "].substr(0, width - O.length)
                  : "";
        ...
        case 110:
          if (arg) {
            arg.len = 0;
            for (var oo = 0; oo < o.length; ++oo) arg.len += o[oo].length;
          }
          continue;
        case 109:
      ...
      if (isnum == -1) {
        ...
        switch (bytes) {
          case 1:
            Vnum = Vnum & 255;
            if (sign && Vnum > 127) Vnum -= 255 + 1;
            break;
          case 2:
            Vnum = Vnum & 65535;
            if (sign && Vnum > 32767) Vnum -= 65535 + 1;
            break;
          case 4:
        ...
        if (bytes > 4 && Vnum < 0 && !sign) {
          if (radix == 16 || radix == -16) {
            ...
            O =
              (Vnum >>> 0).toString(16) +
              (8 - O.length >= 0 ? padstr["0"].substr(0, 8 - O.length) : "") +
              O;
            O =
              (16 - O.length >= 0 ? padstr["f"].substr(0, 16 - O.length) : "") +
              O;
            if (radix == 16) O = O.toUpperCase();
          } else if (radix == 8) {
            O = (Vnum >>> 0).toString(8);
            O =
              (10 - O.length >= 0 ? padstr["0"].substr(0, 10 - O.length) : "") +
              O;
            Vnum = Math.floor(
              (Vnum - ((Vnum >>> 0) & 1073741823)) / Math.pow(2, 30)
            );
            O = (Vnum >>> 0).toString(8) + O.substr(O.length - 10);
            O = O.substr(O.length - 20);
            O =
              "1" +
              (21 - O.length >= 0 ? padstr["7"].substr(0, 21 - O.length) : "") +
              O;
          } else {
            Vnum = -Vnum % 1e16;
            var d1 = [
        ...
        if (prec === 0 && O == "0" && !(radix == 8 && alt)) O = "";
          ...
          if (O.length < prec + (O.substr(0, 1) == "-" ? 1 : 0)) {
            if (O.substr(0, 1) != "-")
              O =
                (prec - O.length >= 0
                  ? padstr["0"].substr(0, prec - O.length)
                  : "") + O;
            else
              O =
                O.substr(0, 1) +
                (prec + 1 - O.length >= 0
                  ? padstr["0"].substr(0, prec + 1 - O.length)
                  : "") +
                O.substr(1);
          }
          if (!sign && alt && Vnum !== 0)
        ...
        if (width > 0) {
          if (O.length < width) {
            if (flags.indexOf("-") > -1) {
              ...
              pad =
                width - O.length >= 0
                  ? padstr[prec > 0 ? " " : "0"].substr(0, width - O.length)
                  : "";
          ...
          switch (isnum) {
            ...
            case 11:
              ...
              O =
                O +
                (E - O.length + 1 >= 0
                  ? padstr["0"].substr(0, E - O.length + 1)
                  : "");
              if (alt || (prec > 0 && isnum !== 11))
                O = O + "." + (prec >= 0 ? padstr["0"].substr(0, prec) : "");
              break;
            case 2:
            case 12:
                  ...
                  if (O.length < prec + 2) {
                    if (O.charCodeAt(0) < 48)
                      O =
                        O.charAt(0) +
                        (prec + 2 - O.length >= 0
                          ? padstr["0"].substr(0, prec + 2 - O.length)
                          : "") +
                        O.substr(1);
                    else
                      O +=
