...
<p>
  The Node.js Streams is jointly governed by a Working Group (WG) that is
...
<p>
  ...
  <a href="./README.md#current-project-team-members">README.md</a>.
</p>
<h3 id="collaborators">Collaborators</h3>
<p>
  The readable-stream GitHub repository is maintained by the WG and additional
...
<p>
  <em>Note:</em> If you make a significant contribution and are not considered
  for commit-access log an issue or contact a WG member directly and it will be
  brought up in the next WG meeting.
</p>
<p>
  Modifications of the contents of the readable-stream repository are made on a
  ...
  expertise who is able to take full responsibility for the change. In the case
  of pull requests proposed by an existing Collaborator, an additional
  Collaborator is required for sign-off. Consensus should be sought if
  additional Collaborators participate and there is disagreement around a
  particular modification. See <em>Consensus Seeking Process</em> below for
...
<p>
  ...
  assigning the <strong><em>WG-agenda</em></strong> tag to a pull request or
  issue. The WG should serve as the final arbiter where required.
</p>
<p>
  For the current list of Collaborators, see the project
  <a href="./README.md#members">README.md</a>.
</p>
...
<p>
  Changes to WG membership should be posted in the agenda, and may be suggested
  as any other agenda item (see “WG Meetings” below).
</p>
<p>
  ...
  agenda for the subsequent meeting. This is to ensure that all members are
  given the opportunity to participate in all membership decisions. If a WG
  member is unable to attend a meeting where a planned membership decision is
  being made, then their consent is assumed.
</p>
<p>
  No more than 1/3 of the WG members may be affiliated with the same employer.
  If removal or resignation of a WG member, or a change of employment by a WG
  member, creates a situation where more than 1/3 of the WG membership shares an
  employer, then the situation must be immediately remedied by the resignation
  or removal of one or more WG members affiliated with the over-represented
  employer(s).
</p>
...
<p>
  Any community member or contributor can ask that something be added to the
  next meeting’s agenda by logging a GitHub Issue. Any Collaborator, WG member
  or the moderator can add the item to the agenda by adding the
  <strong><em>WG-agenda</em></strong> tag to the issue.
</p>
<p>
  Prior to each WG meeting the moderator will share the Agenda with members of
  the WG. WG members can add any items they like to the agenda at the beginning
  of each meeting. The moderator and the WG cannot veto or remove items.
</p>
<p>
...
<p>
  The moderator is responsible for summarizing the discussion of each agenda
  item and sends it as a pull request after the meeting.
</p>
<h3 id="consensus-seeking-process">Consensus Seeking Process</h3>
<p>
  The WG follows a
  <a href="http://en.wikipedia.org/wiki/Consensus-seeking_decision-making"
    >Consensus Seeking</a
  >
...
<p>
  Note that changes to WG membership require a majority consensus. See “WG
  Membership” above.
</p>
