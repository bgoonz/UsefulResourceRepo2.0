...
console.log(
  "So ".italic + "are".underline + " styles! ".bold + "inverse".inverse
...
console.log(
  colors.italic("So ") +
    colors.underline("are") +
    colors.bold(" styles! ") +
    colors.inverse("inverse")
); // styles not widely supported
console.log(
  colors.bold(
    colors.italic(colors.underline(colors.red("Chains are also cool.")))
  )
); // styles not widely supported
...
console.log(
  "So apparently I've been to Mars, with all the little green men. But you know, I don't recall."
    .random
);
