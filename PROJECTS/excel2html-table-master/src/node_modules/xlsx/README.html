  ...
  <tbody>
    <tr class="odd">
      <td style="text-align: left">
        <strong>Excel Worksheet/Workbook Formats</strong>
      </td>
    ...
    <tr class="even">
      <td style="text-align: left">
        <strong>Excel Supported Text Formats</strong>
      </td>
      <td style="text-align: center">:—–:</td>
      <td style="text-align: center">:—–:</td>
    </tr>
    ...
    <tr class="even">
      <td style="text-align: left">
        <strong>Other Workbook/Worksheet Formats</strong>
      </td>
      <td style="text-align: center">:—–:</td>
      <td style="text-align: center">:—–:</td>
    </tr>
    ...
    <tr class="even">
      <td style="text-align: left">
        <strong>Other Common Spreadsheet Output Formats</strong>
      </td>
      <td style="text-align: center">:—–:</td>
      <td style="text-align: center">:—–:</td>
    </tr>
...
<p>
  Demo:
  <a href="http://oss.sheetjs.com/js-xlsx" class="uri"
    >http://oss.sheetjs.com/js-xlsx</a
  >
</p>
<p>Source: <a href="http://git.io/xlsx" class="uri">http://git.io/xlsx</a></p>
<p>
  Paid support available through the
  <a href="http://sheetjs.com/reinforcements">reinforcements program</a>
</p>
...
<div class="sourceCode" id="cb1">
  ...
  ><code class="sourceCode bash"><a class="sourceLine" id="cb1-1" title="1">$ <span class="ex">npm</span> install xlsx</a></code></pre>
</div>
<p>In the browser:</p>
<div class="sourceCode" id="cb2">
  <pre
    class="sourceCode html"
  ><code class="sourceCode html"><a class="sourceLine" id="cb2-1" title="1"><span class="kw">&lt;script</span><span class="ot"> lang=</span><span class="st">&quot;javascript&quot;</span><span class="ot"> src=</span><span class="st">&quot;dist/xlsx.core.min.js&quot;</span><span class="kw">&gt;&lt;/script&gt;</span></a></code></pre>
</div>
<p>With <a href="http://bower.io/search/?q=js-xlsx">bower</a>:</p>
<div class="sourceCode" id="cb3">
  <pre
    class="sourceCode bash"
  ><code class="sourceCode bash"><a class="sourceLine" id="cb3-1" title="1">$ <span class="ex">bower</span> install js-xlsx</a></code></pre>
</div>
<p>
  CDNjs automatically pulls the latest version and makes all versions available
  at
  <a href="http://cdnjs.com/libraries/xlsx" class="uri"
...
<div class="sourceCode" id="cb4">
  <pre
    class="sourceCode html"
  ><code class="sourceCode html"><a class="sourceLine" id="cb4-1" title="1"><span class="co">&lt;!-- international support from js-codepage --&gt;</span></a>
...
<a class="sourceLine" id="cb4-4" title="4"><span class="kw">&lt;script</span><span class="ot"> src=</span><span class="st">&quot;dist/ods.js&quot;</span><span class="kw">&gt;&lt;/script&gt;</span></a></code></pre>
</div>
<p>
...
<ul>
  <li>
    <a href="http://browserify.org/"><code>browserify</code></a>
  </li>
  <li>
    <a href="http://requirejs.org/"><code>requirejs</code></a>
  </li>
  <li>
    <a href="https://webpack.js.org/"><code>webpack</code></a>
  </li>
</ul>
<h3 id="ecmascript-5-compatibility">ECMAScript 5 Compatibility</h3>
<p>
  Since xlsx.js uses ES5 functions like <code>Array#forEach</code>, older
  browsers require <a href="http://git.io/QVh77g">Polyfills</a>. This repo and
  the gh-pages branch include
  <a href="https://github.com/SheetJS/js-xlsx/blob/master/shim.js">a shim</a>
</p>
<p>To use the shim, add the shim before the script tag that loads xlsx.js:</p>
<div class="sourceCode" id="cb5">
  <pre
    class="sourceCode html"
  ><code class="sourceCode html"><a class="sourceLine" id="cb5-1" title="1"><span class="kw">&lt;script</span><span class="ot"> type=</span><span class="st">&quot;text/javascript&quot;</span><span class="ot"> src=</span><span class="st">&quot;/path/to/shim.js&quot;</span><span class="kw">&gt;&lt;/script&gt;</span></a></code></pre>
</div>
...
<div class="sourceCode" id="cb6">
  <pre
    class="sourceCode js"
  ><code class="sourceCode javascript"><a class="sourceLine" id="cb6-1" title="1"><span class="cf">if</span>(<span class="kw">typeof</span> require <span class="op">!==</span> <span class="st">&#39;undefined&#39;</span>) XLSX <span class="op">=</span> <span class="at">require</span>(<span class="st">&#39;xlsx&#39;</span>)<span class="op">;</span></a>
...
<a class="sourceLine" id="cb6-3" title="3"><span class="co">/* DO SOMETHING WITH workbook HERE */</span></a></code></pre>
</div>
<ul>
  <li>
    ajax (for a more complete example that works in older browsers, check the
    demo at
    <a href="http://oss.sheetjs.com/js-xlsx/ajax.html" class="uri"
...
<div class="sourceCode" id="cb7">
  <pre
    class="sourceCode js"
  ><code class="sourceCode javascript"><a class="sourceLine" id="cb7-1" title="1"><span class="co">/* set up XMLHttpRequest */</span></a>
...
<a class="sourceLine" id="cb7-22" title="22"><span class="va">oReq</span>.<span class="at">send</span>()<span class="op">;</span></a></code></pre>
</div>
<ul>
  <li>
    HTML5 drag-and-drop using readAsBinaryString or readAsArrayBuffer: note:
    readAsBinaryString and readAsArrayBuffer may not be available in every
...
<div class="sourceCode" id="cb8">
  <pre
    class="sourceCode js"
  ><code class="sourceCode javascript"><a class="sourceLine" id="cb8-1" title="1"><span class="co">/* processing array buffers, only required for readAsArrayBuffer */</span></a>
...
<a class="sourceLine" id="cb8-39" title="39"><span class="va">drop_dom_element</span>.<span class="at">addEventListener</span>(<span class="st">&#39;drop&#39;</span><span class="op">,</span> handleDrop<span class="op">,</span> <span class="kw">false</span>)<span class="op">;</span></a></code></pre>
</div>
<ul>
  <li>
...
<div class="sourceCode" id="cb9">
  <pre
    class="sourceCode js"
  ><code class="sourceCode javascript"><a class="sourceLine" id="cb9-1" title="1"><span class="co">/* fixdata and rABS are defined in the drag and drop example */</span></a>
...
<a class="sourceLine" id="cb9-27" title="27"><span class="va">input_dom_element</span>.<span class="at">addEventListener</span>(<span class="st">&#39;change&#39;</span><span class="op">,</span> handleFile<span class="op">,</span> <span class="kw">false</span>)<span class="op">;</span></a></code></pre>
</div>
...
<div class="sourceCode" id="cb10">
  <pre
    class="sourceCode js"
  ><code class="sourceCode javascript"><a class="sourceLine" id="cb10-1" title="1"><span class="kw">var</span> first_sheet_name <span class="op">=</span> <span class="va">workbook</span>.<span class="at">SheetNames</span>[<span class="dv">0</span>]<span class="op">;</span></a>
...
<a class="sourceLine" id="cb10-11" title="11"><span class="kw">var</span> desired_value <span class="op">=</span> <span class="va">desired_cell</span>.<span class="at">v</span><span class="op">;</span></a></code></pre>
</div>
<p>
...
<div class="sourceCode" id="cb11">
  <pre
    class="sourceCode js"
  ><code class="sourceCode javascript"><a class="sourceLine" id="cb11-1" title="1"><span class="kw">var</span> sheet_name_list <span class="op">=</span> <span class="va">workbook</span>.<span class="at">SheetNames</span><span class="op">;</span></a>
...
<p>
  Note that older versions of IE do not support HTML5 File API, so the base64
  mode is used for testing. On OSX you can get the base64 encoding with:
</p>
<div class="sourceCode" id="cb12">
  <pre
    class="sourceCode bash"
  ><code class="sourceCode bash"><a class="sourceLine" id="cb12-1" title="1">$ <span class="op">&lt;</span><span class="ex">target_file</span> base64 <span class="kw">|</span> <span class="ex">pbcopy</span></a></code></pre>
</div>
<p>
...
<pre
  class="cmd"
><code>&gt; certutil -encode target_file target_file.b64</code></pre>
...
<ul>
  ...
  <li>
    <p>
      <a
        href="https://github.com/SheetJS/js-xlsx/blob/master/bin/xlsx.njs"
        class="uri"
...
<p>
  The node version installs a command line tool <code>xlsx</code> which can read
  spreadsheet files and output the contents in various formats. The source is
  available at <code>xlsx.njs</code> in the bin directory.
</p>
<p>
  Some helper functions in <code>XLSX.utils</code> generate different views of
  the sheets:
</p>
<ul>
...
<p>
  ...
  <code>write</code> and <code>writeFile</code> will produce the data in various
  formats suitable for dissemination. The second step is to actual share the
  data with the end point. Assuming <code>workbook</code> is a workbook object:
</p>
<ul>
...
<div class="sourceCode" id="cb14">
  <pre
    class="sourceCode js"
  ><code class="sourceCode javascript"><a class="sourceLine" id="cb14-1" title="1"><span class="co">/* output format determined by filename */</span></a>
...
<a class="sourceLine" id="cb14-3" title="3"><span class="co">/* at this point, out.xlsx is a file that you can distribute */</span></a></code></pre>
</div>
<ul>
  <li>
    browser generate binary blob and “download” to client (using
    <a href="https://github.com/eligrey/FileSaver.js/">FileSaver.js</a> for
    download):
  </li>
</ul>
<div class="sourceCode" id="cb15">
  <pre
    class="sourceCode js"
  ><code class="sourceCode javascript"><a class="sourceLine" id="cb15-1" title="1"><span class="co">/* bookType can be &#39;xlsx&#39; or &#39;xlsm&#39; or &#39;xlsb&#39; or &#39;ods&#39; */</span></a>
...
<ul>
  <li>
    <a href="http://sheetjs.com/demos/writexlsx.html" class="uri"
      >http://sheetjs.com/demos/writexlsx.html</a
    >
    generates a simple file
  </li>
  <li>
    <a href="http://git.io/WEK88Q" class="uri">http://git.io/WEK88Q</a> writing
    an array of arrays in nodejs
  </li>
  <li>
    <a href="http://sheetjs.com/demos/table.html" class="uri"
...
<p>
  <code>XLSX</code> is the exposed variable in the browser and the exported node
  variable
</p>
<p>
  <code>XLSX.version</code> is the version of the library (added by the build
  script).
</p>
<p>
...
<p>
  <code>XLSX.read(data, read_opts)</code> attempts to parse <code>data</code>.
</p>
<p>
...
<p>
  ...
  <code>wb</code> to <code>filename</code>
</p>
...
<ul>
  <li>
    <code>sheet_to_json</code> converts a worksheet object to an array of JSON
    objects. <code>sheet_to_row_object_array</code> is an alias that will be
  ...
  <li>
    <code>sheet_to_formulae</code> generates a list of the formulae (with value
    fallbacks).
  </li>
</ul>
<p>
...
<ul>
  <li>
    <code>format_cell</code> generates the text value for a cell (using number
    formats)
  </li>
  <li>
    <code>{en,de}code_{row,col}</code> convert between 0-indexed rows/cols and
    A1 forms.
  </li>
  <li><code>{en,de}code_cell</code> converts cell addresses</li>
  <li><code>{en,de}code_range</code> converts cell ranges</li>
</ul>
<h2 id="workbook-worksheet-cell-object-description">
...
<p>
  ...
  respectively. For example, the cell address <code>B5</code> is represented by
  the object <code>{c:1, r:4}</code>.
</p>
<p>
  Cell range objects are stored as <code>{s:S, e:E}</code> where
  <code>S</code> is the first cell and <code>E</code> is the last cell in the
  range. The ranges are inclusive. For example, the range <code>A3:B7</code> is
  represented by the object <code>{s:{c:0, r:2}, e:{c:1, r:6}}</code>. Utils use
  the following pattern to walk each of the cells in a range:
</p>
...
<table>
  ...
  <tbody>
    ...
    <tr class="odd">
      <td><code>t</code></td>
      <td>
        cell type: <code>b</code> Boolean, <code>n</code> Number,
        <code>e</code> error, <code>s</code> String, <code>d</code> Date
      </td>
    </tr>
    <tr class="even">
      <td><code>f</code></td>
...
<p>
  ...
  <code>w</code> text if it is available. To change a value, be sure to delete
  <code>cell.w</code> (or set it to <code>undefined</code>) before attempting to
  export. The utilities will regenerate the <code>w</code> text from the number
  format (<code>cell.z</code>) and the raw value if possible.
</p>
<p>
  The actual array formula is stored in the <code>f</code> field of the first
  cell in the array range. Other cells in the range will omit the
  <code>f</code> field.
</p>
<h3 id="data-types">Data Types</h3>
<p>
  The raw value is stored in the <code>v</code> field, interpreted based on the
  <code>t</code> field.
</p>
<p>
  Type <code>b</code> is the Boolean type. <code>v</code> is interpreted
  according to JS truth tables
</p>
<p>
  Type <code>e</code> is the Error type. <code>v</code> holds the number and
  <code>w</code> holds the common name:
</p>
<table>
  <thead>
    <tr class="header">
...
<p>
  Type <code>n</code> is the Number type. This includes all forms of data that
  Excel stores as numbers, such as dates/times and Boolean fields. Excel
  exclusively uses data that can be fit in an IEEE754 floating point number,
  just like JS Number, so the <code>v</code> field holds the raw number. The
  <code>w</code> field holds formatted text.
</p>
<p>
  ...
  type, parsers are generally expected to store ISO 8601 Date strings like you
  would get from <code>date.toISOString()</code>. On the other hand, writers and
  exporters should be able to handle date strings and JS Date objects. Note that
  Excel disregards timezone modifiers and treats all dates in the local
  timezone. js-xlsx does not correct for this error.
</p>
<p>
  Type <code>s</code> is the String type. <code>v</code> should be explicitly
  stored as a string to avoid possible confusion.
</p>
<h3 id="formulae">Formulae</h3>
<p>
  The A1-style formula string is stored in the <code>f</code> field. Even though
  different file formats store the formulae in different ways, the formats are
  converted.
</p>
<p>Shared formulae are decompressed and each cell has the correct formula.</p>
<p>
  Array formulae are stored in the top-left cell of the array block. All cells
  of an array formula have a <code>F</code> field corresponding to the range. A
  single-cell formula can be distinguished from a plain formula by the presence
  of <code>F</code> field.
</p>
<p>
  The <code>sheet_to_formulae</code> method generates one line per formula or
  array formula. Array formulae are rendered in the form
  <code>range=formula</code> while plain cells are rendered in the form
  <code>cell=formula or value</code>.
</p>
...
<p>
  <code>worksheet[address]</code> returns the cell object for the specified
  address.
</p>
<p>
  Special worksheet keys (accessible as <code>worksheet[key]</code>, each
  starting with <code>!</code>):
</p>
<ul>
  <li>
    <p>
      <code>ws['!ref']</code>: A-1 based range representing the worksheet range.
      Functions that work with sheets should use this parameter to determine the
      range. Cells that are assigned outside of the range are not processed. In
      particular, when writing a worksheet by hand, be sure to update the range.
      For a longer discussion, see
      <a href="http://git.io/KIaNKQ" class="uri">http://git.io/KIaNKQ</a>
    </p>
    <p>
      Functions that handle worksheets should test for the presence of
      <code>!ref</code> field. If the <code>!ref</code> is omitted or is not a
      valid range, functions are free to treat the sheet as empty or attempt to
      guess the range. The standard utilities that ship with this library treat
      sheets as empty (for example, the CSV output is empty string).
    </p>
    <p>
      When reading a worksheet with the <code>sheetRows</code> property set, the
      ref parameter will use the restricted range. The original range is set at
      <code>ws['!fullref']</code>
    </p>
  </li>
  <li>
    <p>
      <code>ws['!cols']</code>: array of column properties objects. Column
      widths are actually stored in files in a normalized manner, measured in
      terms of the “Maximum Digit Width” (the largest width of the rendered
      digits 0-9, in pixels). When parsed, the column objects store the pixel
      width in the <code>wpx</code> field, character width in the
  ...
  <li>
    <p>
      <code>ws['!merges']</code>: array of range objects corresponding to the
      merged cells in the worksheet. Plaintext utilities are unaware of merge
      cells. CSV export will write all cells in the merge range if they exist,
      so be sure that only the first cell (upper-left) in the range is set.
    </p>
  </li>
</ul>
...
<p>
  ...
  properties deviate from the XLSX standard, XLS parsing stores core properties
  in both places. .
</p>
<h2 id="parsing-options">Parsing Options</h2>
<p>
  The exported <code>read</code> and <code>readFile</code> functions accept an
  options argument:
</p>
<table>
  <thead>
  ...
  <tbody>
    ...
    <tr class="even">
      ...
      <td style="text-align: left">
        If &gt;0, read the first <code>sheetRows</code> rows **
      </td>
    </tr>
    <tr class="odd">
    ...
    <tr class="odd">
      ...
      <td style="text-align: right">false</td>
      <td style="text-align: left">
        If true, expose vbaProject.bin to <code>vbaraw</code> field **
      </td>
    </tr>
    <tr class="even">
...
<ul>
  <li>
    <code>cellFormula</code> option only applies to formats that require extra
    processing to parse formulae (XLS/XLSB).
  </li>
  <li>
    Even if <code>cellNF</code> is false, formatted text will be generated and
    saved to <code>.w</code>
  </li>
  <li>
  ...
  <li>
    <code>bookSheets</code> and <code>bookProps</code> combine to give both sets
    of information
  </li>
  <li>
    <code>Deps</code> will be an empty object if <code>bookDeps</code> is falsy
  </li>
  <li>
  ...
  <li>
    <code>bookVBA</code> merely exposes the raw vba object. It does not parse
    the data.
  </li>
  <li>
    <code>cellDates</code> currently does not convert numerical dates to JS
    dates.
  </li>
  <li>
...
<p>
  Strings can be interpreted in multiple ways. The <code>type</code> parameter
  for <code>read</code> tells the library how to parse the data argument:
</p>
<table>
  <thead>
    <tr class="header">
  ...
  <tbody>
    ...
    <tr class="even">
      ...
      <td>
        string: binary string (<code>n</code>-th byte is
    ...
    <tr class="even">
      ...
      <td>
        array: array of 8-bit unsigned int (<code>n</code>-th byte is
        <code>data[n]</code>)
      </td>
    </tr>
    <tr class="odd">
...
<p>
  ...
  files with the <code>.xls</code> extension will tell your computer to use
  Excel to open the file but Excel will know how to handle it. This library
...
<table>
  ...
  <tbody>
    ...
    <tr class="odd">
      ...
      <td style="text-align: left">
        SpreadsheetML or Flat ODS or UOS1 or HTML
      </td>
    </tr>
    <tr class="even">
...
<p>
  The exported <code>write</code> and <code>writeFile</code> functions accept an
  options argument:
</p>
<table>
  <thead>
...
<ul>
  ...
  <li>
    <code>cellDates</code> only applies to XLSX output and is not guaranteed to
    work with third-party readers. Excel itself does not usually write cells
    with type <code>d</code> so non-Excel tools may ignore the data or blow up
    in the presence of dates.
  </li>
</ul>
...
<ul>
  ...
  <li>
    Formats that only support a single sheet require a <code>sheet</code> option
    specifying the worksheet. If the string is empty, the first worksheet is
    used.
  </li>
</ul>
...
<p>
  Despite the fact that the name of the library is <code>xlsx</code>, it
  supports numerous non-XLSX file formats:
</p>
...
<p>
  ...
  the concept of a workbook (<code>XLW</code> files) but also had single-sheet
  <code>XLS</code> format. The structure is largely similar to the Lotus 1-2-3
  file formats. BIFF5/8/12 extended the format in various ways but largely stuck
  to the same record format.
</p>
<p>
  There is no official specification for any of these formats. Excel 95 can
  write files in these formats, so record lengths and fields were backsolved by
  writing in all of the supported formats and comparing files. Excel 2016 can
  generate BIFF5 files, enabling a full suite of file tests starting from XLSX
  or BIFF2.
</p>
<h3 id="excel-97-2004-binary-biff8">Excel 97-2004 Binary (BIFF8)</h3>
<p>
  BIFF8 exclusively uses the Compound File Binary container format, splitting
  some content into streams within the file. At its core, it still uses an
  extended version of the binary record format from older versions of BIFF.
</p>
<p>
  The <code>MS-XLS</code> specification covers the basics of the file format,
  and other specifications expand on serialization of features like properties.
</p>
...
<p>
  The <code>MS-XLSB</code> specification covers the basics of the file format,
  and other specifications expand on serialization of features like properties.
</p>
<h3 id="opendocument-spreadsheet-odsfods-and-uniform-office-spreadsheet-uos12">
...
<p>
  ...
  <code>mso-number-format</code> is a localized string containing the number
  format. Despite the metadata the output is valid HTML, although it does accept
  bare <code>&amp;</code> symbols.
</p>
...
<ul>
  <li>
    <a href="https://travis-ci.org/SheetJS/js-xlsx" class="uri"
      >https://travis-ci.org/SheetJS/js-xlsx</a
    >
    for XLSX module in nodejs
  </li>
  <li>
    <a href="https://travis-ci.org/SheetJS/SheetJS.github.io" class="uri"
      >https://travis-ci.org/SheetJS/SheetJS.github.io</a
    >
    for XLS* modules
  </li>
  <li>
    <a href="https://saucelabs.com/u/sheetjs" class="uri"
...
<p>
  ...
  <code>test_files</code> submodule and get the files.
</p>
<h2 id="testing">Testing</h2>
<p>
  <code>make test</code> will run the node-based tests. To run the in-browser
  tests, clone
  <a href="https://github.com/SheetJS/SheetJS.github.io"
    >the oss.sheetjs.com repo</a
  >
  and replace the xlsx.js file (then fire up the browser and go to
  <code>stress.html</code>):
</p>
<div class="sourceCode" id="cb17">
  <pre
    class="sourceCode bash"
  ><code class="sourceCode bash"><a class="sourceLine" id="cb17-1" title="1">$ <span class="fu">cp</span> xlsx.js ../SheetJS.github.io</a>
...
<a class="sourceLine" id="cb17-4" title="4">$ <span class="ex">open</span> -a Chromium.app http://localhost:8000/stress.html</a></code></pre>
</div>
...
<p>
  ...
  <code>bits</code> subdirectory. The build script (run <code>make</code>) will
  concatenate the individual bits to produce the script. Before submitting a
  contribution, ensure that running make will produce the xlsx.js file exactly.
  The simplest way to test is to move the script:
</p>
<div class="sourceCode" id="cb18">
  <pre
    class="sourceCode bash"
  ><code class="sourceCode bash"><a class="sourceLine" id="cb18-1" title="1">$ <span class="fu">mv</span> xlsx.js xlsx.new.js</a>
<a class="sourceLine" id="cb18-2" title="2">$ <span class="fu">make</span></a>
<a class="sourceLine" id="cb18-3" title="3">$ <span class="fu">diff</span> xlsx.js xlsx.new.js</a></code></pre>
</div>
<p>
  To produce the dist files, run <code>make dist</code>. The dist files are
  updated in each version release and should not be committed between versions.
</p>
...
<p>
  It is the opinion of the Original Author that this code conforms to the terms
  of the Microsoft Open Specifications Promise, falling under the same terms as
  OpenOffice (which is governed by the Apache License v2). Given the vagaries of
  the promise, the Original Author makes no legal claim that in fact end users
  are protected from future actions. It is highly recommended that, for
  commercial uses, you consult a lawyer before proceeding.
</p>
...
<ul>
  ...
  <li>
    [MS-XLSX]: Excel (.xlsx) Extensions to the Office Open XML SpreadsheetML
    File Format
  </li>
  <li></li>
  <li></li>
...
<p>
  <a href="https://saucelabs.com/u/xlsx"
    ><img
      src="https://saucelabs.com/browser-matrix/xlsx.svg"
      alt="Build Status"
  /></a>
</p>
<p>
  <a href="https://travis-ci.org/SheetJS/js-xlsx"
    ><img
      src="https://travis-ci.org/SheetJS/js-xlsx.svg?branch=master"
      alt="Build Status"
  /></a>
</p>
<p>
  <a href="https://coveralls.io/r/SheetJS/js-xlsx?branch=master"
    ><img
      src="http://img.shields.io/coveralls/SheetJS/js-xlsx/master.svg"
      alt="Coverage Status"
  /></a>
</p>
<p>
...
<p>
  <a href="https://david-dm.org/sheetjs/js-xlsx"
    ><img
      src="https://david-dm.org/sheetjs/js-xlsx/status.svg"
      alt="Dependencies Status"
  /></a>
</p>
<p>
  <a href="https://ghit.me/repo/sheetjs/js-xlsx"
    ><img src="https://ghit.me/badge.svg?repo=sheetjs/js-xlsx" alt="ghit.me"
  /></a>
</p>
<p>
  <a href="https://github.com/SheetJS/js-xlsx"
    ><img
      src="https://ga-beacon.appspot.com/UA-36810333-1/SheetJS/js-xlsx?pixel"
      alt="Analytics"
  /></a>
</p>
