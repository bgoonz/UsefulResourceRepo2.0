...
(function make_xlsx(XLSX) {
  ...
  if (typeof module !== "undefined" && typeof require !== "undefined") {
    if (typeof cptable === "undefined") cptable = require("xlsx/dist/cpexcel");
  ...
  var CFB = (function _CFB() {
    ...
    function readFileSync(filename, options) {
      if (fs === undefined) fs = require("xlsx/node_modules/fs");
  ...
  if (typeof exports !== "undefined") {
    if (typeof module !== "undefined" && module.exports) {
      if (typeof jszip === "undefined") jszip = require("xlsx/jszip");
      _fs = require("xlsx/node_modules/fs");
    }
  }
  var attregexg = /([\w:]+)=((?:")([^"]*)(?:")|(?:')([^']*)(?:'))/g;
  var tagregex = /<[^>]*>/g;
  ...
  var make_offcrypto = function (O, _crypto) {
    ...
    if (typeof _crypto !== "undefined") crypto = _crypto;
      ...
      try {
        crypto = require("xlsx/node_modules/crypto");
      } catch (e) {
        crypto = null;
      }
    }
          ...
          if (last_sp >= 0) {
            switch (formula[0][last_sp][1][0]) {
              ...
              default:
                ...
                if (opts.WTF)
                  throw new Error(
                    "Unexpected PtgSpace type " + formula[0][last_sp][1][0]
                  );
            }
            e2 = e2 + sp;
            last_sp = -1;
      ...
      if (last_sp >= 0 && PtgNonDisp.indexOf(formula[0][ff][0]) == -1) {
        ...
        switch (f[1][0]) {
          ...
          default:
            sp = "";
            if (opts.WTF)
              throw new Error("Unexpected PtgSpace type " + f[1][0]);
        }
...
*/
          ...
          case "Array":
            {
              ...
              if (options.cellFormula && out[last_cell]) {
                out[last_cell].f = stringify_formula(
                  last_formula.formula,
                  range,
                  last_formula.cell,
                  supbooks,
          ...
          case "ShrFmla":
            {
              ...
              if (last_cell) {
                ...
                (out[encode_cell(last_formula.cell)] || {}).f =
  ...
  function write_ws_biff_cell(ba, cell, R, C, opts) {
    switch (cell.t) {
      case "n":
        ...
        else write_biff_rec(ba, 0x0003, write_BIFF2NUMBER(R, C, cell.v));
        break;
      case "b":
      case "e":
  ...
  function parse_fods(data, opts) {
    get_ods();
    if (typeof ODS === "undefined" || !ODS.parse_fods)
      throw new Error("Unsupported ODS");
