...
<p>
  The various API functions take an <code>opts</code> argument which control
  parsing. The default options are described below:
</p>
<div class="sourceCode" id="cb1">
  <pre
    class="sourceCode js&gt;tmp/10_opts.js"
  ><code class="sourceCode javascript"><a class="sourceLine" id="cb1-1" title="1"><span class="co">/* Options */</span></a>
<a class="sourceLine" id="cb1-2" title="2"><span class="kw">var</span> opts_fmt <span class="op">=</span> [</a></code></pre>
</div>
<p>
  There are two commonly-recognized date code formats: - 1900 mode (where date=0
  is 1899-12-31) - 1904 mode (where date=0 is 1904-01-01)
</p>
<p>
...
<p>
  ...
  control the output, set the <code>output</code> variable:
</p>
<ul>
  <li><code>text</code>: no color (default)</li>
  <li><code>html</code>: html output using</li>
  <li>
    <code>ansi</code>: ansi color codes (requires <code>colors</code> module)
  </li>
</ul>
...
<p>
  Semicolons can be escaped with the <code>\</code> character, so we need to
  split on those semicolons that aren’t prefaced by a slash or within a quoted
  string:
</p>
<div class="sourceCode" id="cb5">
  <pre
    class="sourceCode js&gt;tmp/80_split.js"
  ><code class="sourceCode javascript"><a class="sourceLine" id="cb5-1" title="1"><span class="kw">function</span> <span class="at">split_fmt</span>(fmt) <span class="op">{</span></a>
...
<a class="sourceLine" id="cb5-17" title="17"><span class="va">SSF</span>.<span class="at">_split</span> <span class="op">=</span> split_fmt<span class="op">;</span></a></code></pre>
</div>
...
<blockquote>
  <p>
    ...
    <code>&lt;=</code> Less than or equal to, and <code>&lt;&gt;</code> Not
    equal to.
  </p>
</blockquote>
<p>
...
<pre
  class="&gt;"
><code>[Red][&lt;-25]General;[Blue][&gt;25]General;[Green][&lt;&gt;0]General;[Yellow]General</code></pre>
<p>
  One would expect that the format code would color all numbers that are
  <code>&lt; -25</code> in red, all numbers <code>&gt; 25</code> in blue,
  nonzero numbers between <code>-25</code> and <code>25</code> in green, and
  color <code>0</code> and text in yellow. Excel doesn’t do that.
</p>
<p>
...
<pre
  class="&gt;"
><code>[Red][&lt;-25]General;[Blue][&gt;25]General;[Green]General;[Yellow]General</code></pre>
<p>
  will render values below <code>-25</code> as Red, above <code>25</code> as
  Blue, Green for other numbers, and Yellow for text.
</p>
<p>
  Only the text case is allowed to have the <code>@</code> text sigil. Excel
  interprets it as the last format.
</p>
<h2 id="utility-functions">Utility Functions</h2>
<div class="sourceCode" id="cb8">
  <pre
    class="sourceCode js&gt;tmp/02_utilities.js"
...
<a class="sourceLine" id="cb8-2" title="2"><span class="kw">function</span> <span class="at">fill</span>(c<span class="op">,</span>l) <span class="op">{</span> <span class="kw">var</span> o <span class="op">=</span> <span class="st">&quot;&quot;</span><span class="op">;</span> <span class="cf">while</span>(<span class="va">o</span>.<span class="at">length</span> <span class="op">&lt;</span> l) o<span class="op">+=</span>c<span class="op">;</span> <span class="cf">return</span> o<span class="op">;</span> <span class="op">}</span></a></code></pre>
</div>
<p>
  The next few helpers break up the general <code>pad</code> function into
  special cases:
</p>
...
<p>
  ...
  context-sensitive and the implementation tries to follow the format to the
  best of its abilities given the knowledge.
</p>
<p>
...
<div class="sourceCode" id="cb11">
  <pre
    class="sourceCode js&gt;tmp/40_general.js"
  ><code class="sourceCode javascript"><a class="sourceLine" id="cb11-1" title="1"><span class="kw">function</span> <span class="at">general_fmt_int</span>(v<span class="op">,</span> opts) <span class="op">{</span> <span class="cf">return</span> <span class="st">&quot;&quot;</span><span class="op">+</span>v<span class="op">;</span> <span class="op">}</span></a>
<a class="sourceLine" id="cb11-2" title="2"><span class="va">SSF</span>.<span class="at">_general_int</span> <span class="op">=</span> general_fmt_int<span class="op">;</span></a></code></pre>
</div>
...
<div class="sourceCode" id="cb13">
  <pre
    class="sourceCode js&gt;tmp/40_general.js"
  ><code class="sourceCode javascript"><a class="sourceLine" id="cb13-1" title="1"><span class="kw">function</span> <span class="at">general_fmt</span>(v<span class="op">,</span> opts) <span class="op">{</span></a>
<a class="sourceLine" id="cb13-2" title="2">  <span class="cf">switch</span>(<span class="kw">typeof</span> v) <span class="op">{</span></a></code></pre>
</div>
...
<p>
  These are the commonly-used formats that have a special implied code. None of
  the international formats are included here.
</p>
<div class="sourceCode" id="cb18">
  <pre
    class="sourceCode js&gt;tmp/20_consts.js"
  ><code class="sourceCode javascript"><a class="sourceLine" id="cb18-1" title="1"><span class="kw">var</span> table_fmt <span class="op">=</span> <span class="op">{</span></a>
...
<a class="sourceLine" id="cb18-11" title="11">  <span class="dv">13</span><span class="op">:</span> <span class="st">&#39;# ??/??&#39;</span><span class="op">,</span></a></code></pre>
</div>
<p>
  Now Excel and other formats treat code 14 as <code>m/d/yy</code> (with
  slashes). Given that the spec gives no internationalization considerations,
  erring on the side of the applications makes sense here:
</p>
<pre><code>  14: &#39;m/d/yy&#39;,
  15: &#39;d-mmm-yy&#39;,
  16: &#39;d-mmm&#39;,
...
<p>
  The code <code>ddd</code> displays short day-of-week and
  <code>dddd</code> shows long day-of-week:
</p>
<div class="sourceCode" id="cb22">
  <pre
    class="sourceCode js&gt;tmp/20_consts.js"
  ><code class="sourceCode javascript"><a class="sourceLine" id="cb22-1" title="1"><span class="kw">var</span> days <span class="op">=</span> [</a>
...
<a class="sourceLine" id="cb22-9" title="9">]<span class="op">;</span></a></code></pre>
</div>
<p>
  <code>mmm</code> shows short month, <code>mmmm</code> shows long month, and
  <code>mmmmm</code> shows one char:
</p>
<pre><code>var months = [
  [&#39;J&#39;, &#39;Jan&#39;, &#39;January&#39;],
  [&#39;F&#39;, &#39;Feb&#39;, &#39;February&#39;],
...
<p>
  Most spreadsheet formats store dates and times as floating point numbers
  (where the integer part is a day code based on a format and the fractional
  part is the portion of a 24 hour day).
</p>
<p>
  Excel supports the alternative Hijri calendar (indicated with
  <code>b2</code>):
</p>
<div class="sourceCode" id="cb24">
  <pre
    class="sourceCode js&gt;tmp/50_date.js"
  ><code class="sourceCode javascript"><a class="sourceLine" id="cb24-1" title="1"><span class="kw">function</span> <span class="at">parse_date_code</span>(v<span class="op">,</span>opts<span class="op">,</span>b2) <span class="op">{</span></a></code></pre>
</div>
...
<p>
  ...
  abomination as a <code>Date</code>, so the easiest way is to store the data as
  a tuple.
</p>
<p>
  February 29, 1900 (date <code>60</code>) is recognized as a Wednesday. Date
  <code>0</code> is treated as January 0, 1900 rather than December 31, 1899.
</p>
...
<p>
  ...
  example, date code <code>55</code> is “Friday, February 24, 1900” when in fact
  it was a Saturday. The “right” thing to do is to keep the DOW consistent and
  just break the fact that there are two Wednesdays in that “week”.
</p>
...
<div class="sourceCode" id="cb34">
  <pre
    class="sourceCode js&gt;tmp/45_hijri.js"
  ><code class="sourceCode javascript"><a class="sourceLine" id="cb34-1" title="1"><span class="kw">function</span> <span class="at">fix_hijri</span>(date<span class="op">,</span> o) <span class="op">{</span> <span class="cf">return</span> <span class="dv">0</span><span class="op">;</span> <span class="op">}</span></a></code></pre>
</div>
...
<div class="sourceCode" id="cb35">
  <pre
    class="sourceCode js&gt;tmp/56_commaify.js"
  ><code class="sourceCode javascript"><a class="sourceLine" id="cb35-1" title="1"><span class="kw">function</span> <span class="at">commaify</span>(s) <span class="op">{</span></a>
...
<a class="sourceLine" id="cb35-6" title="6"><span class="op">}</span></a></code></pre>
</div>
<p>
  <code>write_num</code> is broken into sub-functions to help with optimization:
</p>
<div class="sourceCode" id="cb36">
  <pre
    class="sourceCode js&gt;tmp/57_numhead.js"
  ><code class="sourceCode javascript"><a class="sourceLine" id="cb36-1" title="1"><span class="kw">var</span> write_num <span class="op">=</span> (<span class="kw">function</span> <span class="at">make_write_num</span>()<span class="op">{</span></a></code></pre>
</div>
...
<div class="sourceCode" id="cb37">
  <pre
    class="sourceCode js&gt;tmp/59_numhelp.js"
  ><code class="sourceCode javascript"><a class="sourceLine" id="cb37-1" title="1"><span class="kw">var</span> pct1 <span class="op">=</span> <span class="ss">/%/g</span><span class="op">;</span></a>
...
<a class="sourceLine" id="cb37-5" title="5"><span class="op">}</span></a></code></pre>
</div>
...
<div class="sourceCode" id="cb38">
  <pre
    class="sourceCode js&gt;tmp/60_number.js"
  ><code class="sourceCode javascript"><a class="sourceLine" id="cb38-1" title="1"><span class="kw">function</span> <span class="at">write_num_cm</span>(type<span class="op">,</span> fmt<span class="op">,</span> val)<span class="op">{</span></a>
...
<a class="sourceLine" id="cb38-5" title="5"><span class="op">}</span></a></code></pre>
</div>
...
<a class="sourceLine" id="cb45-5" title="5">  <span class="op">}</span></a></code></pre>
</div>
<p>
  Helpers are used for: - Percentage values - Trailing commas - Exponentials
</p>
...
<a class="sourceLine" id="cb46-3" title="3">  <span class="cf">if</span>(<span class="va">fmt</span>.<span class="at">indexOf</span>(<span class="st">&#39;E&#39;</span>) <span class="op">!==</span> <span class="dv">-1</span>) <span class="cf">return</span> <span class="at">write_num_exp</span>(fmt<span class="op">,</span> val)<span class="op">;</span></a></code></pre>
</div>
...
<p>
  The next few simplifications ignore leading optional sigils (<code>#</code>):
</p>
...
<p>
  The <code>Zip Code + 4</code> format needs to treat an interstitial hyphen as
  a character:
</p>
...
<p>
  The general class <code>/^[#0?]+$/</code> treats the ‘0’ as literal, ‘#’ as
  noop, ‘?’ as space:
</p>
...
<a class="sourceLine" id="cb56-2" title="2">    ri <span class="op">=</span> <span class="at">dec</span>(val<span class="op">,</span> r[<span class="dv">1</span>].<span class="at">length</span>)<span class="op">;</span></a></code></pre>
</div>
...
<div class="sourceCode" id="cb58">
  <pre
    class="sourceCode js&gt;tmp/60_number.js"
  ><code class="sourceCode javascript"><a class="sourceLine" id="cb58-1" title="1">    <span class="im">default</span><span class="op">:</span></a>
...
<a class="sourceLine" id="cb58-4" title="4">}</a></code></pre>
</div>
...
<div class="sourceCode" id="cb61">
  <pre
    class="sourceCode js&gt;tmp/82_eval.js"
  ><code class="sourceCode javascript"><a class="sourceLine" id="cb61-1" title="1"><span class="kw">var</span> abstime <span class="op">=</span> <span class="ss">/</span><span class="sc">\[[HhMmSs]*\]</span><span class="ss">/</span><span class="op">;</span></a>
...
<a class="sourceLine" id="cb61-7" title="7">    <span class="cf">switch</span>((c <span class="op">=</span> fmt[i])) <span class="op">{</span></a></code></pre>
</div>
<p>
...
<p>
  Text between double-quotes are treated literally, and individual characters
  are literal if they are preceded by a slash.
</p>
<p>
  The additional <code>i &lt; fmt.length</code> guard was added due to
  potentially unterminated strings generated by LO:
</p>
...
<p>
  ...
  Excel does not allow for ‘@’ and non-literal text to appear in the same
  format. It seems as if they only support one mode. (clearly this is a TODO for
  excel mode but I’m not convinced that’s the right approach)
</p>
<pre><code>      case &#39;@&#39;: /* Text Placeholder */
        out[out.length] = {t:&#39;T&#39;, v:v}; ++i; break;</code></pre>
<p>
  <code>B1</code> and <code>B2</code> specify which calendar to use, while
  <code>b</code> is the buddhist year. It acts just like <code>y</code> except
  the year is shifted:
</p>
...
<p>
  The date codes <code>m,d,y,h,s</code> are standard. There are some special
  formats like <code>e / g</code> (era year) that have different behaviors in
...
<p>
  Only the forward corrections are made here. The reverse corrections are made
  later:
</p>
...
<p>
  The (poorly documented) rule regarding <code>A/P</code> and
  <code>AM/PM</code> is that if they show up in the format then
  <em>all</em> instances of <code>h</code> are considered 12-hour and not
  24-hour format (even in cases like <code>hh AM/PM hh hh hh</code>).
</p>
<p>
  However, the undocumented <code>H</code> and <code>HH</code> do appear to
  reset the <code>AM/PM</code> indicator. It is not implemented at the moment
  because I am not 100% sure of the rules with the HH/hh jazz. TODO: investigate
  this further.
</p>
<pre><code>      case &#39;A&#39;:
        q={t:c, v:&quot;A&quot;};
...
<p>
  ...
  pseudo-type <code>Z</code> is used to capture absolute time blocks:
</p>
<pre><code>      case &#39;[&#39;:
        o = c;
        ...
        break;</code></pre>
<p>
  Number blocks (following the general pattern <code>[0#?][0#?.,E+-%]*</code>)
  are grouped together. Literal hyphens are swallowed as well. Since
  <code>.000</code> is a valid term (for tenths/hundredths/thousandths of a
  second), it must be handled separately:
</p>
<pre><code>      /* Numbers */
      case &#39;.&#39;:
        if(dt != null) {
...
<p>
  The fraction question mark characters present their own challenges. For
  example, the number 123.456 under format
  <code>|??| / |???| |???| foo</code> is <code>|15432| / |125| | | foo</code>:
</p>
<pre><code>      case &#39;?&#39;:
...
<p>
  The open and close parens <code>()</code> also has special meaning (for
  negative numbers):
</p>
...
<p>
  The default magic characters are listed in subsubsections 18.8.30-31 of
  ECMA376:
</p>
...
<p>
  In order to identify cases like <code>MMSS</code>, where the fact that this is
  a minute appears after the minute itself, scan backwards. At the same time, we
  can identify the smallest time unit (0 = no time, 1 = hour, 2 = minute, 3 =
  second) and the required number of digits for the sub-seconds:
</p>
...
<p>
  ...
  positive when there is an explicit hyphen before it
  (e.g. <code>#,##0.0;-#,##0.0</code>):
</p>
...
<p>
  There is some overloading of the <code>m</code> character. According to the
  spec:
</p>
<blockquote>
  <p>
    If “m” or “mm” code is used immediately after the “h” or “hh” code (for
    hours) or immediately before the “ss” code (for seconds), the application
    shall display minutes instead of the month.
  </p>
</blockquote>
<div class="sourceCode" id="cb88">
  <pre
    class="sourceCode js&gt;tmp/50_date.js"
  ><code class="sourceCode javascript"><a class="sourceLine" id="cb88-1" title="1"><span class="co">/*jshint -W086 */</span></a>
...
<a class="sourceLine" id="cb88-4" title="4">  <span class="cf">switch</span>(type) <span class="op">{</span></a></code></pre>
</div>
<p>
  <code>b</code> years are shifted by 543 (<code>y</code> 1900 ==
  <code>b</code> 2443):
</p>
...
<p>
  ...
  terms. That is passed via the <code>ss0</code> parameter:
</p>
...
<p>
  The <code>e</code> format behavior in excel diverges from the spec. It claims
  that <code>ee</code> should be a two-digit year, but <code>ee</code> in excel
  is actually the four-digit year:
</p>
<pre><code>    case 101: /* &#39;e&#39; era */
      out = y; outl = 1;</code></pre>
<p>
  There is no input to the function that ends up triggering the default
  behavior: it is not exported and is only called when the type is in
  <code>ymdhHMsZe</code>
</p>
<pre><code>  }
...
<p>
  Based on the value, <code>choose_fmt</code> picks the right format string. If
  formats have explicit negative specifications, those values should be passed
  as positive:
</p>
<div class="sourceCode" id="cb98">
  <pre
    class="sourceCode js&gt;tmp/90_main.js"
  ><code class="sourceCode javascript"><a class="sourceLine" id="cb98-1" title="1"><span class="kw">function</span> <span class="at">choose_fmt</span>(f<span class="op">,</span> v) <span class="op">{</span></a>
...
<a class="sourceLine" id="cb98-5" title="5">  <span class="cf">if</span>(<span class="va">fmt</span>.<span class="at">length</span> <span class="op">&gt;</span> <span class="dv">4</span>) <span class="cf">throw</span> <span class="st">&quot;cannot find right format for |&quot;</span> <span class="op">+</span> fmt <span class="op">+</span> <span class="st">&quot;|&quot;</span><span class="op">;</span></a></code></pre>
</div>
...
<p>
  In the case of 2 or 3 formats, if an <code>@</code> appears in the last field
  of the format it is treated as the text format
</p>
...
<div class="sourceCode" id="cb102">
  <pre
    class="sourceCode js&gt;tmp/88_cond.js"
  ><code class="sourceCode javascript"><a class="sourceLine" id="cb102-1" title="1"><span class="kw">var</span> cfregex <span class="op">=</span> <span class="ss">/</span><span class="sc">\[[=&lt;&gt;]</span><span class="ss">/</span><span class="op">;</span></a>
...
<a class="sourceLine" id="cb102-15" title="15"><span class="op">}</span></a></code></pre>
</div>
...
<a class="sourceLine" id="cb103-9" title="9">}</a></code></pre>
</div>
...
<p>
  The methods beginning with an underscore are subject to change and should not
  be used directly in programs.
</p>
<div class="sourceCode" id="cb109">
  <pre
    class="sourceCode js&gt;tmp/98_exports.js"
  ><code class="sourceCode javascript"><a class="sourceLine" id="cb109-1" title="1"><span class="va">SSF</span>.<span class="at">_table</span> <span class="op">=</span> table_fmt<span class="op">;</span></a>
...
<a class="sourceLine" id="cb109-3" title="3"><span class="va">SSF</span>.<span class="at">format</span> <span class="op">=</span> format<span class="op">;</span></a></code></pre>
</div>
...
<p>
  ...
  <a href="https://github.com/SheetJS/frac/">our frac library</a>:
</p>
<div class="sourceCode" id="cb111">
  <pre
    class="sourceCode js&gt;tmp/30_frac.js"
  ><code class="sourceCode javascript"><a class="sourceLine" id="cb111-1" title="1"><span class="kw">function</span> <span class="at">frac</span>(x<span class="op">,</span> D<span class="op">,</span> mixed) <span class="op">{</span></a>
...
<a class="sourceLine" id="cb111-22" title="22"><span class="op">}</span></a></code></pre>
</div>
<h2 id="js-boilerplate">JS Boilerplate</h2>
<div class="sourceCode" id="cb112">
  <pre
    class="sourceCode js&gt;tmp/00_header.js"
  ><code class="sourceCode javascript"><a class="sourceLine" id="cb112-1" title="1"><span class="co">/* ssf.js (C) 2013-2014 SheetJS -- http://sheetjs.com */</span></a>
...
<a class="sourceLine" id="cb112-4" title="4"><span class="kw">var</span> make_ssf <span class="op">=</span> <span class="kw">function</span> <span class="at">make_ssf</span>(SSF)<span class="op">{</span></a></code></pre>
</div>
<div class="sourceCode" id="cb113">
  <pre
    class="sourceCode js&gt;tmp/99_footer.js"
  ><code class="sourceCode javascript"><a class="sourceLine" id="cb113-1" title="1">}<span class="op">;</span></a>
...
<div class="sourceCode" id="cb114">
  <pre
    class="sourceCode bash&gt;tmp/post.sh"
  ><code class="sourceCode bash"><a class="sourceLine" id="cb114-1" title="1"><span class="co">#!/bin/bash</span></a>
...
<a class="sourceLine" id="cb114-4" title="4"><span class="fu">cat</span> tmp/*.js <span class="op">&gt;</span> ssf.js</a></code></pre>
</div>
...
<div class="sourceCode" id="cb121">
  <pre
    class="sourceCode json&gt;package.json"
  ><code class="sourceCode json"><a class="sourceLine" id="cb121-1" title="1"><span class="fu">{</span></a>
...
<a class="sourceLine" id="cb121-31" title="31"><span class="fu">}</span></a></code></pre>
</div>
<h1 id="test-driver">Test Driver</h1>
<p>Travis CI is used for node testing:</p>
<div class="sourceCode" id="cb122">
  <pre
    class="sourceCode &gt;.travis.yml"
  ><code class="sourceCode yaml"><a class="sourceLine" id="cb122-1" title="1"><span class="fu">language:</span><span class="at"> node_js</span></a>
...
<a class="sourceLine" id="cb122-11" title="11">  <span class="kw">-</span> <span class="st">&quot;make coveralls&quot;</span></a></code></pre>
</div>
<p>The mocha test driver tests the implied formats:</p>
<div class="sourceCode" id="cb123">
  <pre
    class="sourceCode js&gt;test/implied.js"
  ><code class="sourceCode javascript"><a class="sourceLine" id="cb123-1" title="1"><span class="kw">var</span> SSF <span class="op">=</span> <span class="at">require</span>(<span class="st">&#39;../&#39;</span>)<span class="op">;</span></a>
...
<a class="sourceLine" id="cb123-15" title="15"><span class="op">}</span>)<span class="op">;</span></a></code></pre>
</div>
<p>The general test driver tests the General format:</p>
<div class="sourceCode" id="cb124">
  <pre
    class="sourceCode js&gt;test/general.js"
  ><code class="sourceCode javascript"><a class="sourceLine" id="cb124-1" title="1"><span class="co">/* vim: set ts=2: */</span></a>
...
<a class="sourceLine" id="cb124-18" title="18"><span class="op">}</span>)<span class="op">;</span></a></code></pre>
</div>
<p>The fraction test driver tests fractional formats:</p>
<div class="sourceCode" id="cb125">
  <pre
    class="sourceCode js&gt;test/fraction.js"
  ><code class="sourceCode javascript"><a class="sourceLine" id="cb125-1" title="1"><span class="co">/* vim: set ts=2: */</span></a>
...
<a class="sourceLine" id="cb125-14" title="14"><span class="op">}</span>)<span class="op">;</span></a></code></pre>
</div>
<p>The dates test driver tests the date and time formats:</p>
<div class="sourceCode" id="cb126">
  <pre
    class="sourceCode js&gt;test/date.js"
  ><code class="sourceCode javascript"><a class="sourceLine" id="cb126-1" title="1"><span class="co">/* vim: set ts=2: */</span></a>
...
<a class="sourceLine" id="cb126-36" title="36"><span class="op">}</span>)<span class="op">;</span></a></code></pre>
</div>
<p>
...
<div class="sourceCode" id="cb127">
  <pre
    class="sourceCode js&gt;test/exp.js"
  ><code class="sourceCode javascript"><a class="sourceLine" id="cb127-1" title="1"><span class="co">/* vim: set ts=2: */</span></a>
...
<a class="sourceLine" id="cb127-21" title="21"><span class="op">}</span>)<span class="op">;</span></a></code></pre>
</div>
<p>The oddities test driver tests random odd formats</p>
<div class="sourceCode" id="cb128">
  <pre
    class="sourceCode js&gt;test/oddities.js"
  ><code class="sourceCode javascript"><a class="sourceLine" id="cb128-1" title="1"><span class="co">/* vim: set ts=2: */</span></a>
...
<a class="sourceLine" id="cb128-22" title="22"><span class="op">}</span>)<span class="op">;</span></a></code></pre>
</div>
