...
<div class="sourceCode" id="cb1">
  ...
  ><code class="sourceCode bash"><a class="sourceLine" id="cb1-1" title="1">$ <span class="ex">npm</span> install adler-32</a></code></pre>
</div>
<p>In the browser:</p>
<div class="sourceCode" id="cb2">
  <pre
    class="sourceCode html"
  ><code class="sourceCode html"><a class="sourceLine" id="cb2-1" title="1"><span class="kw">&lt;script</span><span class="ot"> src=</span><span class="st">&quot;adler32.js&quot;</span><span class="kw">&gt;&lt;/script&gt;</span></a></code></pre>
</div>
<p>The browser exposes a variable <code>ADLER32</code>.</p>
<p>
  When installed globally, npm installs a script <code>adler32</code> that
...
<ul>
  <li>
    <p>
      <code>ADLER32.buf(byte array or buffer[, seed])</code> assumes the
      argument is a sequence of 8-bit unsigned integers (nodejs
      <code>Buffer</code>, <code>Uint8Array</code> or array of bytes).
    </p>
  </li>
  <li>
    <p>
      <code>ADLER32.bstr(binary string[, seed])</code> assumes the argument is a
  ...
  <li>
    <p>
      <code>ADLER32.str(string)</code> assumes the argument is a standard JS
      string and calculates the hash of the UTF-8 encoding.
    </p>
  </li>
</ul>
<p>For example:</p>
<div class="sourceCode" id="cb3">
  <pre
    class="sourceCode js"
  ><code class="sourceCode javascript"><a class="sourceLine" id="cb3-1" title="1"><span class="co">// var ADLER32 = require(&#39;adler-32&#39;);           // uncomment if in node</span></a>
...
<a class="sourceLine" id="cb3-12" title="12">[<span class="va">ADLER32</span>.<span class="at">buf</span>([<span class="bn">0x2603</span>])<span class="op">,</span>  <span class="va">ADLER32</span>.<span class="at">buf</span>([<span class="bn">0x0003</span>])]  <span class="co">// [ 262148,   262148 ]</span></a></code></pre>
</div>
...
<p>
  To generate the bits file, use the <code>adler32</code> function from python
  <code>zlib</code>:
</p>
<div class="sourceCode" id="cb4">
  <pre
    class="sourceCode python"
  ><code class="sourceCode python"><a class="sourceLine" id="cb4-1" title="1"><span class="op">&gt;&gt;&gt;</span> <span class="im">from</span> zlib <span class="im">import</span> adler32</a>
...
<a class="sourceLine" id="cb4-8" title="8"><span class="dv">2023497376</span></a></code></pre>
</div>
<p>
  The included <code>adler32.njs</code> script can process files or standard
  input:
</p>
...
<a class="sourceLine" id="cb5-3" title="3"><span class="ex">726861088</span></a></code></pre>
</div>
<p>
  For comparison, the included <code>adler32.py</code> script uses python
  <code>zlib</code>:
</p>
<div class="sourceCode" id="cb6">
  <pre
    class="sourceCode bash"
  ><code class="sourceCode bash"><a class="sourceLine" id="cb6-1" title="1">$ <span class="ex">bin/adler32.py</span> t.txt</a>
<a class="sourceLine" id="cb6-2" title="2"><span class="ex">726861088</span></a></code></pre>
</div>
...
<p>
  Bit twiddling is much faster than taking the mod in Safari and Firefox
  browsers. Instead of taking the literal mod 65521, it is faster to keep it in
  the integers by bit-shifting: <code>65536 ~ 15 mod 65521</code> so for
  nonnegative integer <code>a</code>:
</p>
<pre><code>    a = (a &gt;&gt;&gt; 16) * 65536 + (a &amp; 65535)            [equality]
    a ~ (a &gt;&gt;&gt; 16) * 15    + (a &amp; 65535) mod 65521</code></pre>
<p>
  The mod is taken at the very end, since the intermediate result may exceed
  65521
</p>
...
<a class="sourceLine" id="cb8-3" title="3"><span class="fu">F</span>[<span class="dv">127</span>] (* ascii: <span class="fu">x</span> \[<span class="fu">Element</span>] <span class="fu">Integers</span> &amp;&amp; <span class="dv">1</span> &lt;= <span class="fu">x</span> &lt;= <span class="dv">5321</span> *)</a></code></pre>
</div>
...
<p>
  <a href="https://saucelabs.com/u/adler32"
    ><img
      src="https://saucelabs.com/browser-matrix/adler32.svg"
      alt="Sauce Test Status"
  /></a>
</p>
<p>
  <a href="https://travis-ci.org/SheetJS/js-adler32"
    ><img
      src="https://travis-ci.org/SheetJS/js-adler32.svg?branch=master"
      alt="Build Status"
  /></a>
</p>
<p>
  <a href="https://coveralls.io/r/SheetJS/js-adler32?branch=master"
    ><img
      src="http://img.shields.io/coveralls/SheetJS/js-adler32/master.svg"
      alt="Coverage Status"
  /></a>
</p>
<p>
  <a href="https://github.com/SheetJS/js-adler32"
    ><img
      src="https://ga-beacon.appspot.com/UA-36810333-1/SheetJS/js-adler32?pixel"
      alt="Analytics"
  /></a>
</p>
