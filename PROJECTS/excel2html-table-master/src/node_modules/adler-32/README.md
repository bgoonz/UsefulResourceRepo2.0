...
ADLER32.bstr("JS", adler32)[(ADLER32.str("\u2603"), ADLER32.str("\u0003"))][ // 176947863  "SheetJS" // [ 73138686, 262148 ]
  (ADLER32.bstr("\u2603"), ADLER32.bstr("\u0003"))
][(ADLER32.buf([0x2603]), ADLER32.buf([0x0003]))]; // [ 262148,   262148 ] // [ 262148,   262148 ]
```
