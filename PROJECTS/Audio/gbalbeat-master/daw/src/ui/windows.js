...
window.UIwindowsSetPos = function( winId, x, y, wmin, hmin, w, h, icon, title ) {
...
window.UIwindowsBtn = function( winId, b ) {
	DOM.winBtnsMap.get( winId ).classList.toggle( "winBtn-open", b );
}

window.UIwindowsAppendContent = function( UIwindows ) {
