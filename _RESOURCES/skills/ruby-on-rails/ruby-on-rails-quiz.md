...
- [✅] `model.errors[:address] << "This address is invalid"` [Reference: Custom Validator](https://guides.rubyonrails.org/v5.2/active_record_validations.html#custom-validators)
...
- [ ] `Coffee_Orders`
- [ ] `Coffee_Order`
- [✅] `CoffeeOrder` [Reference](https://guides.rubyonrails.org/active_record_basics.html#naming-conventions)
