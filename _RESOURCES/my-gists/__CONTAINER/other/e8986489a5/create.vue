  ...
  <div class="full-page-takeover-window">
    <div class="full-page-takeover-page">
      ...
      <div class="course-create full-page-takeover-container">
        <div class="container">
          <CourseCreateStep1
            ref="CourseCreateStep1"
            v-show="activeComponent === 'CourseCreateStep1'"
            @stepUpdated="mergeFormData"
          />
          <CourseCreateStep2
            ref="CourseCreateStep2"
            v-show="activeComponent === 'CourseCreateStep2'"
            @stepUpdated="mergeFormData"
          />
        </div>
...
export default {
  ...
  methods: {
    _nextStep() {
      ...
      this.$nextTick(() => {
        debugger;
        this.canProceed = this.$refs[this.activeComponent].isValid;
      });
    },
    _previousStep() {
      this.previousStep();
