...
class Purchase extends Component {
  constructor() {
    ...
    this.state = {
      // CHANGES: can only upate input where product is selected
      activeInputs: [0],
      company: "",
      product: "",
      batch: "",
      ...
      currentOption: "",
      dependedOption: "",
      // CHANGES: create uniqe batches for each input
      batches: { 0: [] },
      options: [
        {
          product: "vicks",
  ...
  handleChangeProd = (index) => (evt) => {
    ...
    // CHANGES: on product change, push active INPUT
    // TODO: Remove duplicates, array can contain same indexes
  ...
  onChange = (index) => (event) => {
    ...
    // CHANGES: add current batches to batches at specific index
    // Iterate batches with this index only
            ...
            <div className="form-group">
              <tr key={index}>
                ...
                <td>
                  ...
                  >
                    <option value="">Select one...</option>
                    {/* CHANGES: Iterate unnique batches on index */}
