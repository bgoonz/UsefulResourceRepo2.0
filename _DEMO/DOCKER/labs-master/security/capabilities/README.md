...
In the output above, **Current** is multiple sets separated by spaces. Multiple capabilities within the same _set_ are separated by commas `,`. The letters following the `+` at the end of each set are as follows:
