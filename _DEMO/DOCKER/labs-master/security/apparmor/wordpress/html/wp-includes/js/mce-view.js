  ...
  _.extend(wp.mce.View.prototype, {
    ...
    render: function (content, force) {
      ...
      if (content) {
        this.setContent(
          content,
          function (editor, node, contentNode) {
        ...
        $(editor.getBody())
          ...
          .each(function () {
            callback.call(
              ...
              editor,
              this,
              $(this).find(".wpview-content").get(0)
            );
          });
      });
    },
      ...
      this.getMarkers(function (editor, node) {
        ...
        $viewNode = editor.$(
          '<div class="wpview-wrap" data-wpview-text="' +
            ...
            '<div class="wpview-content wpview-type-' +
            this.type +
            '"></div>' +
            "</div>" +
      ...
      if (_.isObject(content) && content.body.indexOf("<script") !== -1) {
        ...
        this.getNodes(function (editor, node, contentNode) {
          ...
          contentNode.appendChild(
            _.isString(content) ? editor.dom.createFragment(content) : content
          );
     ...
     */
    remove: function (editor, node) {
      this.unbindNode.call(
        this,
        editor,
        node,
        $(node).find(".wpview-content").get(0)
      );
      $(node).trigger("wp-mce-view-unbind");
