...
(function ($, _, wp) {
  ...
  api.MenusCustomizerPreview = {
    ...
    onChangeNavMenuItemSetting: function (to, from) {
      if (
        from &&
        from.nav_menu_term_id &&
        (!to || from.nav_menu_term_id !== to.nav_menu_term_id)
      ) {
    ...
    refreshMenu: function (menuId) {
      ...
      _.each(
        settings.navMenuInstanceArgs,
        function (navMenuArgs, instanceNumber) {
          if (
            menuId === navMenuArgs.menu ||
            -1 !== _.indexOf(assignedLocations, navMenuArgs.theme_location)
          ) {
    ...
    refreshMenuInstance: function (instanceNumber) {
      ...
      containerInstanceClassName =
        "partial-refreshable-nav-menu-" + String(instanceNumber);
      container = $("." + containerInstanceClassName);

      if (_.isNumber(instance.menu)) {
        menuId = instance.menu;
      } else if (
        instance.theme_location &&
        api.has("nav_menu_locations[" + instance.theme_location + "]")
      ) {
        menuId = api(
          "nav_menu_locations[" + instance.theme_location + "]"
        ).get();
      }
      ...
      api.each(function (setting, id) {
        ...
        shouldSend =
          shouldSend ||
          (/^nav_menu_item\[/.test(id) &&
            (false === value || menuId === value.nav_menu_term_id));
      ...
      request.done(function (data) {
        ...
        container.addClass(
          "partial-refreshable-nav-menu customize-partial-refreshing"
        );
