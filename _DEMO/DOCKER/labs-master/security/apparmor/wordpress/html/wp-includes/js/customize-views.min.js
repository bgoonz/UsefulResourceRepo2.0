      ...
      getHeight: function () {
        ...
        return e.length
          ? (this.$el.find(".inner").hide(),
            (a = this.model.get("savedHeight")),
            (b = e.height() || a),
            b ||
              ((c = d.get().header_image_data),
              (b = c && c.width && c.height ? (260 / c.width) * c.height : 40)),
            b)
          : (this.$el.find(".inner").show(), 40);
      },
      setPlaceholder: function (a) {
        var b = a || this.getHeight();
        this.model.set("savedHeight", b),
          this.$el.add(this.$el.find(".placeholder")).height(b);
      },
      setButtons: function () {
