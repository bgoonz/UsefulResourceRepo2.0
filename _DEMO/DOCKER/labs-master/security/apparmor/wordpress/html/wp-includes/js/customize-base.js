...
(function (exports, $) {
  ...
  api.Values = api.Class.extend({
    ...
    add: function (id, value) {
      if (this.has(id)) return this.value(id);

      this._value[id] = value;
      value.parent = this;

      // Propagate a 'change' event on an item up to the collection.
      if (value.extended(api.Value)) value.bind(this._change);

      this.trigger("add", value);

      // If a deferred object exists for this item,
      // resolve it.
      if (this._deferreds[id]) this._deferreds[id].resolve();
    ...
    remove: function (id) {
      ...
      if (this.has(id)) {
        ...
        if (value.extended(api.Value)) value.unbind(this._change);
        delete value.parent;
      }
  ...
  api.Element = api.Value.extend({
    initialize: function (element, options) {
      ...
      this.update = function (to) {
        if (to !== refresh.call(self)) update.apply(this, arguments);
      };
