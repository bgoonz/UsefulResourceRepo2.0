          ...
          (l = (function () {
            ...
            return {
              exec: function (t, n, i, r) {
                return l[n] &&
                  (e[t] || (e[t] = { context: this, instance: new l[n]() }),
                  e[t].instance[i])
          ...
          e.extend(this, w, {
            ...
            send: function (n, r) {
              ...
              this.withCredentials ||
                (this.withCredentials =
                  H.required_caps &&
                  H.required_caps.send_browser_cookies &&
                  !L),
        ...
        function l() {
          ...
          t.extend(this, {
            ...
            loadFromImage: function (e, t) {
              (this.meta = e.meta),
                (x = new o(null, { name: e.name, size: e.size, type: e.type })),
                h.call(
                  this,
                  t ? (b = e.getAsBinaryString()) : e.getAsDataURL()
                );
            },
            getInfo: function () {
              var t = this.getRuntime(),
