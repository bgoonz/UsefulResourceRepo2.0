...
(function (api, wp, $) {
  ...
  api.Menus.AvailableMenuItemsPanelView = wp.Backbone.View.extend({
    ...
    initialize: function () {
      ...
      this.sectionContent.scroll(function () {
        var totalHeight = self.$el
            .find(".accordion-section.open .accordion-section-content")
            .prop("scrollHeight"),
    ...
    doSearch: function (page) {
      ...
      self.currentRequest.fail(function (data) {
        ...
        if (data.message) {
          $content
            .empty()
            .append($('<p class="nothing-found"></p>').text(data.message));
    ...
    loadItems: function (type, object) {
      ...
      availableMenuItemContainer = $(
        "#available-menu-items-" + type + "-" + object
      );
      availableMenuItemContainer
      ...
      request.done(function (data) {
        ...
        self.collection.add(items.models);
        typeInner = availableMenuItemContainer.find(
  ...
  api.Menus.MenuSection = api.Section.extend({
          ...
          menuNameControlId,
          {
            params: {
              ...
              content:
                ...
                section.id.replace("[", "-").replace("]", "") +
                '-name" class="customize-control customize-control-nav_menu_name"></li>', // @todo core should do this for us; see #30741
        ...
        menuControl = new api.controlConstructor.nav_menu(section.id, {
          params: {
            ...
            content:
              '<li id="customize-control-' +
              section.id.replace("[", "-").replace("]", "") +
              '" class="customize-control customize-control-nav_menu"></li>', // @todo core should do this for us; see #30741
            section: section.id,
            priority: 998,
            active: true,
            settings: {
          ...
          menuAutoAddControlId,
          {
            params: {
              ...
              content:
                '<li id="customize-control-' +
                section.id.replace("[", "-").replace("]", "") +
                '-auto-add" class="customize-control customize-control-nav_menu_auto_add"></li>', // @todo core should do this for us
              label: "",
              active: true,
              section: section.id,
              priority: 999,
    ...
    updateAssignedLocationsInSectionTitle: function (themeLocations) {
      ...
      _.each(themeLocations, function (themeLocation) {
        ...
        $label.text(
          api.Menus.data.l10n.menuLocation.replace("%s", themeLocation)
        );
        $title.append($label);
      });
    ...
    onChangeExpanded: function (expanded, args) {
      ...
      if (expanded) {
        wpNavMenu.menuList = section.container.find(
  ...
  api.Menus.NewMenuSection = api.Section.extend({
    ...
    onChangeExpanded: function (expanded) {
      var section = this,
        ...
        customizer = section.container.closest(
    ...
    addItemToMenu: function (item) {
      ...
      menuItemControl = new api.controlConstructor.nav_menu_item(customizeId, {
        params: {
          type: "nav_menu_item",
          content:
            '<li id="customize-control-nav_menu_item-' +
            String(placeholderId) +
            '" class="customize-control customize-control-nav_menu_item"></li>',
