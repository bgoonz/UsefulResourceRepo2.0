    ...
    init: function (b, c) {
      ...
      a.extend(this, c || {}),
        ...
        a(".meta-box-sortables").sortable({
          ...
          stop: function () {
            var c = a(this);
            return c.find("#dashboard_browser_nag").is(":visible") &&
              "dashboard_browser_nag" != this.firstChild.id
              ? void c.sortable("cancel")
              : void postboxes.save_order(b);
          },
          receive: function (b, c) {
            "dashboard_browser_nag" == c.item[0].id &&
              a(c.sender).sortable("cancel"),
              postboxes._mark_area();
          },
        }),
        d &&
