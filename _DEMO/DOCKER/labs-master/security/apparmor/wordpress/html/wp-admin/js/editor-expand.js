(function (window, $, undefined) {
  ...
  $(function () {
    var $wrap = $("#postdivrich"),
      ...
      $textEditor = $("#content"),
      $textEditorClone = $(
        '<div id="content-textarea-clone" class="wp-exclude-emoji"></div>'
      ),
    ...
    function adjust(event) {
      ...
      if (
        ...
        heights.windowWidth > 600 && // sidebar position is changed with @media from CSS, make sure it is on the side
        ...
        // the editor is taller than the viewport
