    ...
    get: function (total, num) {
      ...
      $.post(ajaxurl, data, function (r) {
        ...
        if ("object" == typeof r && r.responses[0]) {
          ...
          else $("#show-comments").show().children("a").html(postL10n.showcomm);
...
jQuery(document).ready(function ($) {
  ...
  if ($("#tagsdiv-post_tag").length) {
    ...
    $("#side-sortables, #normal-sortables, #advanced-sortables")
  ...
  $(".categorydiv").each(function () {
    ...
    if (taxonomy == "category") settingName = "cats";
    ...
    $("a", "#" + taxonomy + "-tabs").click(function (e) {
      ...
      $("#" + taxonomy + "-tabs")
        ...
        .hide();
      $(t).show();
      if ("#" + taxonomy + "-all" == t) deleteUserSetting(settingName);
      else setUserSetting(settingName, "pop");
    });
    ...
    catAddBefore = function (s) {
      if (!$("#new" + taxonomy).val()) return false;
