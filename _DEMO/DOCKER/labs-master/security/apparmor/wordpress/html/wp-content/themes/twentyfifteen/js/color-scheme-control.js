...
(function (api) {
  ...
  function updateCSS() {
    ...
    colors.secondary_sidebar_textcolor = Color(colors.sidebar_textcolor).toCSS(
      "rgba",
      0.7
    );
    colors.sidebar_border_color = Color(colors.sidebar_textcolor).toCSS(
      "rgba",
      0.1
    );
    colors.sidebar_border_focus_color = Color(colors.sidebar_textcolor).toCSS(
      "rgba",
      0.3
    );
