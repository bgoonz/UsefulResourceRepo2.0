...
Using your terminal, navigate to the _app_ directory (where the docker-compose.yml file is located) and start up the application:
...
A JSON file will be created and displayed (on the filesystem this file is located at _app/.vscode/launch.json_). Replace its contents with the following
