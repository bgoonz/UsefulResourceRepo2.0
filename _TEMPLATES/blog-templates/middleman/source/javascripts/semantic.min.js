          ...
          (F = {
            initialize: function () {
              F.get.settings(),
                d
                  ...
                  : (F.verbose("Initializing form validation", D, x),
                    F.bindEvents(),
                    F.set.defaults(),
                    F.instantiate());
            },
            ...
            bindEvents: function () {
              F.verbose("Attaching form events"),
                ...
                x.keyboardShortcuts &&
                  D.on("keydown" + E, k.field, F.event.field.keydown),
                f.each(function () {
                  var t = e(this),
                    n = t.prop("type"),
            ...
            event: {
              field: {
                keydown: function (t) {
                  ...
                  i == o.escape &&
                    (F.verbose("Escape key pressed blurring field"), n.blur()),
                    !t.ctrlKey &&
                      i == o.enter &&
                      n.is(k.input) &&
                ...
                change: function (t) {
                  var n = e(this),
                    i = n.closest(g);
                  ("change" == x.on || (i.hasClass(S.error) && x.revalidate)) &&
            ...
            get: {
              ...
              prompt: function (e, t) {
                ...
                return (
                  ...
                  e.prompt ||
                    F.verbose("Using default validation prompt for type", s, a),
                  s
                );
              },
              settings: function () {
              ...
              field: function (t) {
                return (
                  ...
                  f.filter("#" + t).length > 0
                    ...
                    : f.filter('[name="' + t + '[]"]').length > 0
                    ? f.filter('[name="' + t + '[]"]')
                    : f.filter("[data-" + w.validate + '="' + t + '"]').length >
                      0
                    ? f.filter("[data-" + w.validate + '="' + t + '"]')
                    : e("<input/>")
                );
              },
              fields: function (t) {
              ...
              field: function (e) {
                return (
                  ...
                  f.filter("#" + e).length > 0
                    ...
                    ? !0
                    : f.filter("[data-" + w.validate + '="' + e + '"]').length >
                      0
                    ? !0
                    : !1
                );
              ...
              field: function (t, n) {
                ...
                return (
                  t.identifier ||
                    ...
                    (t.identifier = o)),
                  a.prop("disabled")
                    ? (F.debug("Field is disabled. Skipping", o), (r = !0))
                    : t.optional && "" === e.trim(a.val())
                    ? (F.debug("Field is optional and empty. Skipping", o),
                      (r = !0))
                    : t.rules !== i &&
                  ...
                  r
                    ? (F.remove.prompt(o, s), x.onValid.call(a), !0)
                    : ((q = q.concat(s)),
                      F.add.prompt(o, s),
          ...
          creditCard: function (t, n) {
            ...
            if ("string" == typeof t && 0 !== t.length) {
              ...
              for (
                ...
                (m += d[u][parseInt(t.charAt(l), 10)]), (u ^= 1);
              return m % 10 === 0 && m > 0;
            }
          },
          ...
          (m = {
            ...
            open: function (t) {
              var n =
                ...
                s = r || a;
              return s
                ? void m.debug("Accordion already open, skipping", o)
            ...
            closeOthers: function (t) {
              var n,
                o,
                a,
                r = t !== i ? w.eq(t) : e(this).closest(v.title),
              ...
              f.closeNested
                ...
                : ((n = c.find(l).not(s)),
                  ...
                  (a = n.next(k))),
                n.length > 0 &&
                  (m.debug("Exclusive enabled, closing other content", n),
                  n.removeClass(g.active),
            ...
            internal: function (t, n) {
              return (
                ...
                n === i
                  ? m[t]
                  : void (e.isPlainObject(t) ? e.extend(!0, m, t) : (m[t] = n))
              );
            },
            debug: function () {
              f.debug &&
            ...
            event: {
              click: function (t) {
                ...
                return n.is(h.input)
                  ...
                  : (f.toggle(), k.focus(), void t.preventDefault());
              },
              keydown: function (e) {
                var t = e.which,
                  n = {
              ...
              checked: function () {
                return (
                  ...
                  !f.is.indeterminate() && f.is.checked()
                    ...
                    : (f.verbose("Setting state to checked", S),
              ...
              events: function () {
                f.verbose("Attaching checkbox events"),
                  C.on("click" + y, f.event.click)
                    .on("keydown" + y, h.input, f.event.keydown)
                    .on("keyup" + y, h.input, f.event.keyup);
              },
            },
            unbind: {
              events: function () {
        ...
        a.each(function () {
          ...
          (f = {
            preinitialize: function () {
              f.is.dimmer()
                ...
                : ((m = k),
                  (d = f.has.dimmer()
                    ? g.dimmerName
                      ? m.find(p.dimmer).filter("." + g.dimmerName)
                      : m.find(p.dimmer)
                    : f.create()));
            },
            initialize: function () {
            ...
            bind: {
              events: function () {
                "hover" == g.on
                  ? m.on("mouseenter" + y, f.show).on("mouseleave" + y, f.hide)
            ...
            create: function () {
              ...
              return (
                g.variation &&
                  (f.debug("Creating dimmer with variation", g.variation),
            ...
            show: function (t) {
              (t = e.isFunction(t) ? t : function () {}),
                ...
                (f.is.dimmed() && !f.is.animating()) || !f.is.enabled()
                  ...
                  : (f.animate.show(t), g.onShow.call(S), g.onChange.call(S));
            },
            hide: function (t) {
              (t = e.isFunction(t) ? t : function () {}),
        ...
        r.each(function (p) {
          ...
          (w = {
            ...
            select: {
              firstUnfiltered: function () {
                w.verbose("Selecting first non-filtered element"),
                  ...
                  B.not(D.unselectable).eq(0).addClass(S.selected);
              },
                  ...
                  H.parent(D.dropdown).length > 0
                    ...
                    : (w.debug("Creating entire dropdown from select"),
                      ...
                      H.hasClass(S.multiple) &&
                        H.prop("multiple") === !1 &&
                        (w.error(O.missingMultiple), H.prop("multiple", !0)),
                      H.is("[multiple]") && w.set.multiple(),
                      H.prop("disabled") &&
                        (w.debug("Disabling dropdown"), I.addClass(S.disabled)),
            ...
            bind: {
              ...
              touchEvents: function () {
                w.debug(
                  ...
                  W.on("touchstart" + j, D.item, w.event.item.mouseenter);
              },
              keyboardEvents: function () {
                w.verbose("Binding keyboard events"),
                  I.on("keydown" + j, w.event.keydown),
                  w.has.search() &&
                    I.on(w.get.inputEvent() + j, D.search, w.event.input),
                  w.is.multiple() &&
              ...
              mouseEvents: function () {
                w.verbose("Binding mouse events"),
                  w.is.multiple() &&
                    I.on("click" + j, D.label, w.event.label.click).on(
                      "click" + j,
                      D.remove,
                      w.event.remove.click
                    ),
                  w.is.searchSelection()
                    ? (I.on("mousedown" + j, D.menu, w.event.menu.mousedown)
                        .on("mouseup" + j, D.menu, w.event.menu.mouseup)
                        .on("click" + j, D.icon, w.event.icon.click)
                        .on("click" + j, D.search, w.show)
                        .on("focus" + j, D.search, w.event.search.focus)
                        .on("blur" + j, D.search, w.event.search.blur)
                        .on("click" + j, D.text, w.event.text.focus),
                      w.is.multiple() && I.on("click" + j, w.event.click))
                    : ("click" == k.on
                        ? I.on("click" + j, D.icon, w.event.icon.click).on(
                            "click" + j,
                            w.event.test.toggle
                          )
                        : "hover" == k.on
                  ...
                  W.on("mouseenter" + j, D.item, w.event.item.mouseenter)
                    .on("mouseleave" + j, D.item, w.event.item.mouseleave)
                    .on("click" + j, D.item, w.event.item.click);
              },
              intent: function () {
            ...
            event: {
              ...
              blur: function (e) {
                (h = n.activeElement === this),
                  Q || h || (w.remove.activeLabel(), w.hide());
              },
              mousedown: function () {
                Q = !0;
              },
              ...
              search: {
                ...
                blur: function (e) {
                  (h = n.activeElement === this),
                    X || h
                      ? h && k.forceSelection && w.forceSelection()
                      : w.is.multiple()
                    ...
                    t == R.leftArrow
                      ? (!f && !g) || s
                        ? s &&
                          ...
                          l && !c
                            ? o.addClass(S.active)
                            : o.prev(D.siblingLabel).addClass(S.active).end(),
                          e.preventDefault())
                        : (w.verbose("Selecting previous label"),
                          i.last().addClass(S.active))
                      : t == R.rightArrow
                      ? (f && !s && i.first().addClass(S.active),
                        s &&
                          (e.shiftKey
                          ...
                          u
                            ? d
                              ? m
                                ...
                                : w.focusSearch()
                              : c
                              ? o.next(D.siblingLabel).addClass(S.active)
                              : o.addClass(S.active)
                            : o.next(D.siblingLabel).addClass(S.active),
                          e.preventDefault()))
                      ...
                      ? s
                        ? (w.verbose("Removing active labels"),
                          u && d && !m && w.focusSearch(),
                          o.last().next(D.siblingLabel).addClass(S.active),
              ...
              keydown: function (e) {
                ...
                if (n) {
                  var i,
                    ...
                    c =
                      s.length > 0
                        ? s.siblings(":not(." + S.filtered + ")").andSelf()
                  ...
                  if (w.is.visible()) {
                    if (
                      ((t == R.enter || p) &&
                        (t == R.enter && f && m && !k.allowCategorySelection
                          ? (w.verbose(
                      ...
                      t == R.leftArrow &&
                        ...
                        o &&
                          ...
                          u.closest(D.item).addClass(S.selected),
                          e.preventDefault())),
                      t == R.rightArrow &&
                        m &&
                        ...
                        w.animate.show(!1, l),
                        s.removeClass(S.selected),
                        l.find(D.item).eq(0).addClass(S.selected),
                        e.preventDefault()),
                      t == R.upArrow)
                    ) {
                      if (
            ...
            restore: {
              ...
              labels: function () {
                k.allowAdditions &&
                  (k.useLabels || (w.error(O.labels), (k.useLabels = !0)),
            ...
            set: {
              ...
              tabbable: function () {
                w.has.search()
                  ...
                  : (w.debug("Added tabindex to dropdown"),
                    I.attr("tabindex") === i &&
                      (I.attr("tabindex", 0), W.attr("tabindex", -1)));
              },
              initialLoad: function () {
              ...
              text: function (e) {
                "select" !== k.action &&
                  ("combo" == k.action
                    ? (w.debug("Changing combo button text", e, U),
                      k.preserveHTML ? U.html(e) : U.text(e))
              ...
              value: function (e, t, n) {
                ...
                if (o) {
                  ...
                  w.verbose("Storing value in metadata", e, H),
                ...
                if (!k.useLabels || !w.has.maxSelections()) {
                  ...
                  B.removeClass(S.selected),
                    a
                      ...
                      : ((n = w.create.userChoice(e)),
                        n.prependTo(W).addClass(S.selected),
                        w.verbose(
            ...
            remove: {
              ...
              filteredItem: function () {
                (k.useLabels && w.has.maxSelections()) ||
                  (k.useLabels && w.is.multiple()
                    ? B.not("." + S.active).removeClass(S.filtered)
              ...
              activeLabels: function (e) {
                (e = e || I.find(D.label).filter("." + S.active)),
                ...
                (t = t || I.find(D.label)),
                  ...
                  t.each(function () {
                    ...
                    return k.onLabelRemove.call(t, n) === !1
                      ? void w.debug("Label remove callback cancelled removal")
                      : void (a
                          ? (w.remove.value(o), w.remove.label(o))
                          : w.remove.selected(o));
                  });
              },
              tabbable: function () {
          ...
          (m = {
            ...
            bind: {
              events: function () {
                m.has.placeholder() &&
                  ...
                  k
                    .on("click" + C, g.placeholder, m.createAndShow)
                    .on("click" + C, g.icon, m.createAndShow));
              },
            },
            create: function () {
            ...
            determine: {
              ...
              url: function () {
                ...
                return (
                  (e = v[n] !== i ? v[n].url.replace("{id}", t) : !1),
                  e && k.data(b.url, e),
                  e
                );
              },
            ...
            generate: {
              embed: function (e) {
                ...
                return (
                  (e = m.get.url(e)),
                  e
                    ? ((n = m.generate.parameters(i)), (t = x.iframe(e, n)))
                    : m.error(h.noURL, k),
                  t
                );
              },
            ...
            should: {
              autoplay: function () {
                return "auto" === f.autoplay
                  ? f.placeholder || k.data(b.placeholder) !== i
                  : f.autoplay;
              },
            },
            is: {
          ...
          (a = {
            ...
            storage: {
              ...
              get: function (n, o) {
                var r;
                return (
                  "localstorage" == m.storageMethod && t.localStorage !== i
        ...
        r.each(function () {
          ...
          (y = {
            ...
            refresh: function () {
              x.popup
                ? (n = e(x.popup).eq(0))
                : x.inline && ((n = F.nextAll(C.popup).eq(0)), (x.popup = n)),
                x.popup
            ...
            create: function () {
              ...
              t || o || i
                ...
                ? (y.verbose("Pre-existing popup found"),
                  (x.inline = !0),
                  (x.popups = F.next(C.popup).data(S.activator, E)),
                  y.refresh(),
                  x.hoverable && y.bind.popup())
                : x.popup
            ...
            get: {
              ...
              content: function () {
                return (
                  ...
                  E.data(S.content) || E.attr("title") || x.content
                );
              },
              variation: function () {
                return (
                  E.removeData(S.variation), E.data(S.variation) || x.variation
                );
              },
              popup: function () {
                return n;
            ...
            set: {
              position: function (e, t) {
                ...
                if (
                  ...
                  0 === r.width &&
                    0 === r.height &&
                    !(r.element instanceof SVGGraphicsElement))
                )
            ...
            bind: {
              events: function () {
                y.debug("Binding popup events to module"),
                  "click" == x.on && E.on("click" + A, y.toggle),
                  "hover" == x.on &&
                    d &&
                    E.on("touchstart" + A, y.event.touchstart),
                  y.get.startEvent() &&
                    E.on(y.get.startEvent() + A, y.event.start).on(
                      y.get.endEvent() + A,
                      y.event.end
                    ),
              ...
              close: function () {
                (x.hideOnScroll === !0 ||
                  ...
                  (s.one(y.get.scrollEvent() + h, y.event.hideGracefully),
                  P.one(y.get.scrollEvent() + h, y.event.hideGracefully)),
                  "hover" == x.on &&
                    q &&
            ...
            unbind: {
              close: function () {
                (x.hideOnScroll === !0 ||
                  ("auto" == x.hideOnScroll && "click" != x.on)) &&
                  (s.off("scroll" + h, y.hide), P.off("scroll" + h, y.hide)),
                  "hover" == x.on && q && (s.off("touchstart" + h), (q = !1)),
                  "click" == x.on &&
                    x.closable &&
          ...
          (m = {
            ...
            read: {
              metadata: function () {
                ...
                e.percent &&
                  ...
                  e.total &&
                    ...
                    m.set.total(e.total)),
                  e.value &&
                    (m.debug("Current value set from metadata", e.value),
                    m.set.value(e.value),
              ...
              settings: function () {
                f.total !== !1 &&
                  ...
                  f.percent !== !1 &&
                    (m.debug("Current percent set in settings", f.percent),
            ...
            increment: function (e) {
              ...
              m.has.total()
                ? ((n = m.get.value()),
                  ...
                  i > t &&
                    (m.debug("Value cannot increment above total", t), (i = t)))
                : ((n = m.get.percent()),
            ...
            decrement: function (e) {
              ...
              i
                ...
                0 > n && (m.debug("Value cannot decrement below 0"), (n = 0)),
                m.set.progress(n);
            },
            has: {
              total: function () {
            ...
            get: {
              ...
              displayPercent: function () {
                ...
                return f.precision > 0
                  ? Math.round(10 * i * f.precision) / (10 * f.precision)
                  : Math.round(i);
              },
              percent: function () {
                return m.percent || 0;
            ...
            set: {
              ...
              percent: function (e) {
                (e = "string" == typeof e ? +e.replace("%", "") : e),
                  (e =
                    f.precision > 0
                      ? Math.round(10 * e * f.precision) / (10 * f.precision)
                      : Math.round(e)),
                  (m.percent = e),
                  m.has.total() ||
                    ((m.value =
                      f.precision > 0
                        ? Math.round((e / 100) * m.total * 10 * f.precision) /
                          (10 * f.precision)
                        : Math.round((e / 100) * m.total * 10) / 10),
                    f.limitValues &&
                      (m.value =
                        m.value > 100 ? 100 : m.value < 0 ? 0 : m.value)),
                  m.set.barWidth(e),
                  m.set.labelInterval(),
                  m.set.labels(),
              ...
              state: function (e) {
                (e = e !== i ? e : m.percent),
                  100 === e
                    ? !f.autoSuccess || m.is.warning() || m.is.error()
                      ? (m.verbose("Reached 100% removing active state"),
                        m.remove.active())
                      : (m.set.success(),
                        m.debug("Automatically triggering success at 100%"))
                    : e > 0
                    ? (m.verbose("Adjusting active progress bar label", e),
                      m.set.active())
              ...
              barLabel: function (e) {
                e !== i
                  ...
                  : "percent" == f.label &&
                    (m.debug("Adding percentage to bar label"),
            ...
            bind: {
              events: function () {
                f.verbose("Binding events to search"),
                  g.automatic &&
                    (S.on(f.get.inputEvent() + w, y.prompt, f.event.input),
                    T.attr("autocomplete", "off")),
                  S.on("focus" + w, y.prompt, f.event.focus)
                    .on("blur" + w, y.prompt, f.event.blur)
                    .on("keydown" + w, y.prompt, f.handleKeyboard)
                    .on("click" + w, y.searchButton, f.query)
                    .on("mousedown" + w, y.results, f.event.result.mousedown)
                    .on("mouseup" + w, y.results, f.event.result.mouseup)
                    .on("click" + w, y.result, f.event.result.click);
              },
            },
            determine: {
                ...
                t ||
                  (f.resultsClicked
                    ? (f.debug(
                      ...
                      S.one("click", y.results, function (e) {
              ...
              if (
                ...
                if (r == s.enter) {
                  if (
                    ...
                    return (
                      f.event.result.click.call(n.filter("." + p.active), e),
                      e.preventDefault(),
                      !1
                    );
                } else
                    ...
                    ? (f.debug("Finding result that matches", t),
                      e.each(n, function (n, i) {
                        return e.isArray(i.results) &&
                          (a = f.search.object(t, i.results, o)[0])
                          ? !1
                          : void 0;
                      }))
              ...
              cache: function (e) {
                ...
                e
                  ? e &&
                    ...
                    delete t[e],
                    S.data(v.cache, t))
                  : (f.debug("Clearing cache", e), S.removeData(v.cache));
              },
            },
            read: {
              cache: function (e) {
              ...
              id: function (e, t) {
                ...
                return (
                  t !== i
                    ...
                    : ((o = a), f.verbose("Creating result id", o)),
                  o
                );
              },
              results: function () {
            ...
            addResults: function (t) {
              return e.isFunction(g.onResultsAdd) &&
                ...
                ? (f.debug("onResultsAdd callback cancelled default action"),
                  !1)
                : (R.html(t), void (f.can.show() && f.showResults()));
            },
            ...
            generateResults: function (t) {
              ...
              return (
                i || o
                  ? (g.maxResults > 0 &&
                      (i
                        ? "standard" == g.type && f.error(x.maxResults)
                        : (t[b.results] = t[b.results].slice(0, g.maxResults))),
                    e.isFunction(n) ? (a = n(t, b)) : f.error(x.noTemplate, !1))
                  : (a = f.displayMessage(x.noResults, "empty")),
      ...
      return (
        r.each(function () {
          ...
          (g = {
            ...
            set: {
              ...
              nextSide: function (e) {
                (A = e),
                  (f = T.filter(e)),
                  (A = T.index(f)),
                  0 === f.length && (g.set.defaultSide(), g.error(y.side)),
            ...
            flip: {
              up: function () {
                return !g.is.complete() || g.is.animating() || v.allowRepeats
                  ? void (g.is.animating()
                      ? g.queue("flip up")
          ...
          (w = {
            ...
            show: function (t) {
              if (((t = e.isFunction(t) ? t : function () {}), w.is.hidden())) {
                if (
                  (w.refreshSidebars(),
                  k.overlay && (w.error(E.overlay), (k.transition = "overlay")),
                  w.refresh(),
                  w.othersActive())
                )
                  if (
            ...
            is: {
              ...
              rtl: function () {
                return (
                  w.cache.rtl === i &&
                    (w.cache.rtl = "rtl" == D.css("direction")),
                  w.cache.rtl
                );
              },
            },
          ...
          (b = {
              ...
              (n = b.utilities.arrayToPath(r)),
                e.each(r, function (t, i) {
                  ...
                  if ((b.verbose("Looking for tab", i), f)) {
                    if (
                      ...
                      return (
                        o
                          ...
                          : (b.activate.navigation(m), b.fetch.content(m, n)),
                        !1
                      );
                    ...
                    if (-1 != n.search("/") || "" === n)
                      return b.error(S.missingTab, R, g, m), !1;
                    if (
                      ((s = e("#" + n + ', a[name="' + n + '"]')),
            ...
            utilities: {
              ...
              pathToArray: function (e) {
                return (
                  e === i && (e = v), "string" == typeof e ? e.split("/") : [e]
                );
              },
            ...
            remove: {
              ...
              looping: function () {
                C.debug("Transitions are no longer looping"),
                  C.is.looping() && (C.reset(), w.removeClass(v.looping));
              },
              transition: function () {
            ...
            get: {
              ...
              displayType: function () {
                return f.displayType
                  ? f.displayType
                  : (w.data(h.displayType) === i && C.can.transition(!0),
            ...
            (v = {
              ...
              bind: {
                events: function () {
                  var e = v.get.event();
                  e
                    ? (v.verbose("Attaching API events to element", e),
                      T.on(e + k, v.event.trigger))
                    : "now" == h.on &&
                      (v.debug("Querying API endpoint immediately"), v.query());
                },
              },
              decode: {
                json: function (e) {
              ...
              write: {
                cachedResponse: function (n, o) {
                  return o && "" === o
                    ? void v.debug("Response empty, not caching", o)
                    : t.Storage === i
                    ? void v.error(C.noStorage)
              ...
              query: function () {
                ...
                return (
                  h.defaultData && e.extend(!0, h.urlData, v.get.defaultData()),
                  h.serializeForm && (h.data = v.add.formData(h.data)),
                  (m = v.get.settings()),
                  m === !1
                    ? ((v.cancelled = !0), void v.error(C.beforeSend))
                    : ((v.cancelled = !1),
                        ...
                        ? ((f = v.add.urlData(f)),
                          f || v.is.mocked()
                            ? ((m.url = h.base + f),
                              ...
                              "local" === h.cache && v.read.cachedResponse(f)
                                ? (v.debug(
                                    "Response returned from local cache"
                                  ),
                                  (v.request = v.create.request()),
                                  void v.request.resolveWith(P, [
                                    v.read.cachedResponse(f),
                                  ]))
                                : void (h.throttle
                                    ? h.throttleFirstRequest || v.timer
                                      ? (v.debug(
                                          "Throttling request",
                                          h.throttle
                                        ),
                                      ...
                                      : (v.debug(
                                        ...
                                        (v.timer = setTimeout(function () {},
                                        h.throttle)))
                                    : (v.debug("Sending request", g, a.method),
                                      v.send.request())))
                            : void 0)
              ...
              is: {
                ...
                abortedRequest: function (e) {
                  return e && e.readyState !== i && 0 === e.readyState
                    ? (v.verbose("XHR request determined to be aborted"), !0)
                    : (v.verbose("XHR request was not aborted"), !1);
                },
                validResponse: function (t) {
                  return ("json" !== h.dataType && "jsonp" !== h.dataType) ||
                    ...
                    : (v.debug(
                      ...
                      h.successTest(t)
                        ? (v.debug("Response passed success test", t), !0)
                        : (v.debug("Response failed success test", t), !1));
                },
              },
              was: {
                cancelled: function () {
                ...
                urlData: function (t, n) {
                  ...
                  return (
                    t &&
                      ...
                      (n = n || h.urlData),
                      o &&
                        (v.debug("Looking for required URL variables", o),
                          ...
                          var r =
                            ...
                            s =
                              e.isPlainObject(n) && n[r] !== i
                                ...
                                : n[r];
                          return s === i
                            ? (v.error(C.requiredParameter, r, t), (t = !1), !1)
                            : (v.verbose("Found required variable", r, s),
                              (s = h.encodeParameters
                                ? v.get.urlEncodedValue(s)
                                : s),
                              (t = t.replace(a, s)),
                              void 0);
                        })),
                      a &&
                        (v.debug("Looking for optional URL variables", o),
                          ...
                          var r =
                            ...
                            s =
                              e.isPlainObject(n) && n[r] !== i
                                ...
                                : n[r];
                          s !== i
                            ? (v.verbose("Optional variable Found", r, s),
                              (t = t.replace(a, s)))
                            : (v.verbose("Optional variable not found", r),
                              (t =
                                -1 !== t.indexOf("/" + a)
                                  ? t.replace("/" + a, "")
                                  : t.replace(a, "")));
                    ...
                    n
                      ? o
                        ...
                        : (v.error(C.missingSerialize),
                          ...
                          (t = a))
                      : (v.debug("Adding form data", a), (t = a)),
                    t
                  );
                },
              },
              send: {
                request: function () {
                  v.set.loading(),
                    (v.request = v.create.request()),
                    v.is.mocked()
                      ? (v.mockedXHR = v.create.mockedXHR())
                      : (v.xhr = v.create.xhr()),
                  ...
                  always: function () {},
                    ...
                    var o = this,
                      ...
                      s = e.isFunction(h.onResponse)
                        ? h.onResponse.call(o, e.extend(!0, {}, t))
                        : !1;
                    (r = r > 0 ? r : 0),
                      s &&
                        (v.debug(
                      ...
                      setTimeout(function () {
                        v.is.validResponse(t)
                          ? v.request.resolveWith(o, [t, i])
                          : v.request.rejectWith(o, [i, "invalid"]);
                      }, r);
                  },
                  fail: function (e, t, n) {
                    var i = this,
                    ...
                    (a = a > 0 ? a : 0),
                      ...
                      setTimeout(function () {
                        v.is.abortedRequest(e)
                          ? v.request.rejectWith(i, [e, "aborted", n])
                          : v.request.rejectWith(i, [e, "error", t, n]);
                      }, a);
                  },
                },
                request: {
                  ...
                  fail: function (e, t, n) {
                    ...
                    "aborted" == t
                      ...
                      : "error" == t &&
                        e !== i &&
                        (v.debug("XHR produced a server error", t, n),
                        200 != e.status &&
                          n !== i &&
                          "" !== n &&
                          v.error(C.statusMessage + n, a.url),
                      ...
                      h.errorDuration &&
                        ...
                        v.should.removeError() &&
                          setTimeout(v.remove.error, h.errorDuration)),
              ...
              create: {
                ...
                mockedXHR: function () {
                  ...
                  return (
                    ...
                    s
                      ? (e.isFunction(s)
                          ? (v.debug("Using specified synchronous callback", s),
                            (n = s.call(P, m)))
                          : (v.debug("Using settings specified response", s),
                            (n = s)),
                        i.resolveWith(P, [
                          n,
                          o,
                      ...
                      : e.isFunction(c) &&
                        ...
                        v.debug("Using specified async response callback", c),
                        c.call(P, m, t)),
                    i
                  );
                },
              ...
              get: {
                ...
                settings: function () {
                  ...
                  return (
                    ...
                    t &&
                      (t.success !== i &&
                        (v.debug("Legacy success callback detected", t),
                        v.error(C.legacyParameters, t.success),
                        (t.onSuccess = t.success)),
                      t.failure !== i &&
                        (v.debug("Legacy failure callback detected", t),
                        v.error(C.legacyParameters, t.failure),
                        (t.onFailure = t.failure)),
                      t.complete !== i &&
                        (v.debug("Legacy complete callback detected", t),
                        v.error(C.legacyParameters, t.complete),
                        (t.onComplete = t.complete))),
                    t === i && v.error(C.noReturnedValue),
                    t !== i ? e.extend(!0, {}, t) : e.extend(!0, {}, h)
                  );
                },
                ...
                templatedURL: function (e) {
                  if (
                    ((e = e || T.data(y.action) || h.action || !1),
                    (f = T.data(y.url) || h.url || !1))
                  )
                    return v.debug("Using specified url", f), f;
                  if (e) {
                    if (
                      (v.debug("Looking up url for action", e, h.api),
                    ...
                    v.is.form() &&
                      ((f = T.attr("action") || R.attr("action") || !1),
                      v.debug(
              ...
              abort: function () {
                ...
                e &&
                  "resolved" !== e.state() &&
                  (v.debug("Cancelling API request"), e.abort());
              },
              reset: function () {
              ...
              u
                ...
                : (F !== i && F.invoke("destroy"), v.initialize());
          }),
          o !== i ? o : this
        );
      }),
          ...
          (n = {
            ...
            sync: function () {
              n.verbose("Syncing other buttons to current state"),
                a.not(C).state(n.is.active() ? "activate" : "deactivate");
            },
            get: {
              text: function () {
              ...
              text: function (e) {
                ...
                e && e !== t
                  ? (n.debug("Updating text", e),
                    m.selector.text
                      ? C.data(g.storedText, e).find(m.selector.text).text(e)
            ...
            checkVisibility: function (e) {
              g.verbose("Checking visibility of element", g.cache.element),
                !E &&
                  ...
                  g.bottomPassed(),
                  p.onUpdate &&
                    p.onUpdate.call(R, g.get.elementCalculations()));
            },
            passed: function (t, n) {
                ...
                e &&
                  (p.continuous
                    ? (g.debug("Callback being called continuously", t, n),
                      e.call(R, n, i))
                    : g.get.occurred(t) ||
                      (g.debug("Conditions met", t, n), e.call(R, n, i))),
                g.save.occurred(t);
            },
            remove: {
              fixed: function () {
