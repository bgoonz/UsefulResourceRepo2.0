  ...
  .config([
    ...
    function ($routeProvider, $locationProvider, $authProvider) {
      ...
      $authProvider.google({
        url: "/auth/google",
        clientId:
          "631036554609-v5hm2amv4pvico3asfi97f54sc51ji4o.apps.googleusercontent.com",
      });
...
angular.module("MyApp").controller("ForgotCtrl", [
  "$scope",
  "Account",
...
angular.module("MyApp").controller("ProfileCtrl", [
  ...
  "$auth",
  "Account",
  function ($scope, $rootScope, $location, $window, $auth, Account) {
...
angular.module("MyApp").controller("ResetCtrl", [
  "$scope",
  "Account",
  function ($scope, Account) {
    Account.forgotPassword($scope.user)
