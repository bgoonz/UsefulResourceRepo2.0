...
!((e) => {
  (e.fn.poptrox_disableSelection = function () {
    ...
    (e.fn.poptrox = function (o) {
      ...
      var r = e(this);
      var n = e("body");
      var a = e(`<div class="${s.overlayClass}"></div>`);
      var l = e(window);
      var u = [];
      var d = 0;
      var h = !1;
      ...
      var v = x.find(".pic");
      var w = e();
      var b = x.find(s.popupLoaderSelector);
      var m = x.find(s.popupCaptionSelector);
      var C = x.find(s.popupCloserSelector);
      var y = x.find(s.popupNavNextSelector);
      var S = x.find(s.popupNavPreviousSelector);
      var P = y.add(S);
      if (
      ...
      return (
        l.on("resize orientationchange", () => {
          f();
        }),
        m.on("update", (e, o) => {
          (o && 0 != o.length) || (o = s.popupBlankCaptionText), m.html(o);
        }),
        C.css("cursor", "pointer").on("click", (e) => {
          return (
            e.preventDefault(),
            e.stopPropagation(),
        ...
        a
          ...
          .append(
            `<div style="position:absolute;left:0;top:0;width:100%;height:100%;background:${
              s.overlayColor
            };opacity:${s.overlayOpacity};filter:alpha(opacity=${
        ...
        x
          ...
          .on("poptrox_open", (e, o) => {
            return (
              ...
              x.addClass("loading"),
              void a.fadeTo(s.fadeSpeed, 1, () => {
                x.trigger("poptrox_switch", [o, !0]);
              }))
            );
          })
          .on("poptrox_switch", (o, t, p) => {
            var i;
            if (!p && h) return !0;
            if (
              ((h = !0),
        ...
        s.usePopupEasyClose
          ? (m.on("click", "a", (e) => {
            ...
            x.css("cursor", "pointer").on("click", (e) => {
              e.stopPropagation(),
                e.preventDefault(),
                x.trigger("poptrox_close");
            }))
            ...
            switch (((p = t.src.match(/\/\/[a-z0-9\.]+\/(.*)/)), t.type)) {
              ...
              case "soundcloud":
                (t.object = e(
                  ...
                  (t.src = `//w.soundcloud.com/player/?url=${escape(t.src)}${
                    t.options ? `&${t.options}` : ""
                  }`),
                  (t.width = "600"),
                  (t.height = "166");
              ...
              case "youtube":
                (t.object = e(
                  ...
                  (t.src = `//www.youtube.com/embed/${p[1]}${
                    t.options ? `?${t.options}` : ""
                  }`),
                  (t.width && t.height) ||
              ...
              case "vimeo":
                (t.object = e(
                  ...
                  (t.src = `//player.vimeo.com/video/${p[1]}${
                    t.options ? `?${t.options}` : ""
                  }`),
                  (t.width && t.height) ||
                    ((t.width = "800"), (t.height = "480"));
