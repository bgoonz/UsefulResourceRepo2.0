  ...
  var thychart = {
    pie: function (node) {
      ...
      var drawArcs = function ($svg, pieData) {
        ...
        for (var i = 0; i < sectorAngleArr.length; i++) {
          ...
          x1 = parseInt(
            Math.round(200 + 195 * Math.cos((Math.PI * startAngle) / 180))
          );
          y1 = parseInt(
            Math.round(200 + 195 * Math.sin((Math.PI * startAngle) / 180))
          );

          x2 = parseInt(
            Math.round(200 + 195 * Math.cos((Math.PI * endAngle) / 180))
          );
          y2 = parseInt(
            Math.round(200 + 195 * Math.sin((Math.PI * endAngle) / 180))
          );
    ...
    line: function (node) {
      ...
      var drawSVG = function (type, val, height, index) {
        ...
        if (type) {
          $svg = $(
            '<div class="svgCont"><svg class="svg" viewBox="0 0 ' +
              width +
              " " +
              height +
              '"><path class="path" d=""></path></svg></div>'
          );
        ...
        var addPoint = function (points, counter, isFirst) {
          ...
          $chart
            ...
            .attr(
              "d",
              $chart.parent().find($svg).find("path").attr("d") + "" + new_point
            );
          counter++;
