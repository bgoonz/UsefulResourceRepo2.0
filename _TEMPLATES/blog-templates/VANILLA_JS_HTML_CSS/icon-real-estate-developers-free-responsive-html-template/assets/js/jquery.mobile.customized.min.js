  ...
  (function (a, b) {
    ...
    a.Widget.prototype = {
      ...
      _trigger: function (b, c, d) {
        ...
        return !(
          (a.isFunction(e) && e.call(this.element[0], c, d) === false) ||
  ...
  (function (a, b) {
    ...
    a.extend(a.support, {
      ...
      cssTransitions:
        ...
        k("transition", "height 100ms linear"),
    ...
    a.mobile.ajaxBlacklist =
      (window.blackberry && !window.WebKitPoint) || g || n;
    if (n) {
      a(function () {
      ...
      setup: function () {
        ...
        d.bind(f, function (b) {
          function j(b) {
            ...
            if (
              Math.abs(f.coords[0] - i.coords[0]) >
          ...
          d.bind(h, j).one(g, function (b) {
            ...
            if (f && i) {
              if (
                ...
                Math.abs(f.coords[1] - i.coords[1]) <
                  a.event.special.swipe.verticalDistanceThreshold
              ) {
                f.origin
                  .trigger("swipe")
                  .trigger(
                    f.coords[0] > i.coords[0] ? "swipeleft" : "swiperight"
                  );
              }
            }
            f = i = c;
      ...
      {},
      {
        ...
        gradeA: function () {
          return (
            ...
            (a.mobile.browser.ie && a.mobile.browser.ie >= 7)
          );
        },
        keyCode: {
          ALT: 18,
