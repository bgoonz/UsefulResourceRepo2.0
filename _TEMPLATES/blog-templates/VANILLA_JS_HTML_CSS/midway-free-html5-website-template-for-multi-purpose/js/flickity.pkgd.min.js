...
!(function (t) {
  ...
  function i(t) {
    ...
    function o(e, i) {
      t.fn[e] = function (o) {
        if ("string" == typeof o) {
          for (
            var r = n.call(arguments, 1), l = 0, a = this.length;
            a > l;
            l++
          ) {
            var h = this[l],
    ...
    function o(i) {
      ...
      function l(t) {
        if (
          ...
          for (
            var l = (s.isBorderBox = !(!c || !i[c] || "border-box" !== i[c])),
              u = 0,
              p = r.length;
            p > u;
            u++
          ...
          var E = e(i.height);
          return (
            E !== !1 && (s.height = E + (w ? 0 : y + S)),
            (s.innerWidth = s.width - (m + C)),
            (s.innerHeight = s.height - (y + S)),
            (s.outerWidth = s.width + x),
  ...
  (function (t, e) {
    "function" == typeof define && define.amd
      ...
      : (t.utils = e(t, t.docReady, t.matchesSelector));
        ...
        for (var n = [], s = 0, r = t.length; r > s; s++) {
          ...
          if (o.isElement(l))
            if (e) {
              i(l, e) && n.push(l);
              for (
                var a = l.querySelectorAll(e), h = 0, c = a.length;
                c > h;
                h++
              )
                n.push(a[h]);
  ...
  (function (t, e) {
    "function" == typeof define && define.amd
      ? define("flickity/js/prev-next-button", ["./utils"], function (i) {
          return e(t, i);
        })
      : "object" == typeof exports
      ? (module.exports = e(t, require("./utils")))
  ...
  (function (t, e) {
    "function" == typeof define && define.amd
      ? define(
          ...
          ["eventie/eventie", "./utils"],
          function (i, n) {
            return e(t, i, n);
          }
        )
      : "object" == typeof exports
      ? (module.exports = e(t, require("eventie"), require("./utils")))
      : ((t.Flickity = t.Flickity || {}),
  ...
  (function (t, e) {
    "function" == typeof define && define.amd
      ...
      : "object" == typeof exports
      ? (module.exports = e())
      : ((t.Flickity = t.Flickity || {}), (t.Flickity.Player = e()));
  })(window, function () {
    function t(t) {
  ...
  (function (t, e) {
    "function" == typeof define && define.amd
      ? define("flickity/js/unipointer", ["eventie/eventie"], function (i) {
          return e(t, i);
        })
      : "object" == typeof exports
      ? (module.exports = e(t, require("eventie")))
      : (t.Unipointer = e(t, t.eventie));
  })(window, function (t, e) {
    function i() {}
    function n() {}
    function o() {
    ...
    (n.prototype.handleEvent = function (t) {
      ...
      (n.prototype.bindMSPointer = function (t, i) {
        var n = i ? "bind" : "unbind";
        e[n](t, "MSPointerDown", this),
          (t.style.msTouchAction = i ? "none" : "");
      }),
    ...
    (n.prototype.onmousedown = function (t) {
      ...
      (n.prototype.onMSPointerDown = n.prototype.onpointerdown =
        function (t) {
    ...
    return (
      (n.prototype._pointerDown = function (e, i) {
        this.isPointerDown ||
          ...
          this.pointerDown(e, i),
          this.emitEvent("pointerDown", [this, e, i]));
      }),
      (n.prototype.pointerDown = i),
      (n.prototype._bindPostStartEvents = function (t) {
      ...
      (n.prototype.onMSPointerMove = n.prototype.onpointermove =
        function (t) {
      ...
      (n.prototype.pointerMove = i),
      (n.prototype.onmouseup = function (t) {
        this._pointerUp(t, t);
      }),
      (n.prototype.onMSPointerUp = n.prototype.onpointerup =
        function (t) {
      ...
      (n.prototype.pointerUp = i),
      (n.prototype.onMSPointerCancel = n.prototype.onpointercancel =
        function (t) {
          t.pointerId == this.pointerIdentifier && this._pointerUp(t, t);
        }),
  ...
  (function (t, e) {
    "function" == typeof define && define.amd
      ? define(
          "flickity/js/drag",
          ["./unipointer", "classie/classie", "eventie/eventie", "./utils"],
          function (i, n, o) {
            return e(t, i, n, o);
          }
        )
    ...
    var r = {};
    o.extend(r, e.prototype),
      (r.bindDrag = function () {
        this.options.draggable &&
          ((this.handles = [this.viewport]),
          this.bindHandles(),
          n.bind(this.viewport, "click", this));
      }),
      (r.unbindDrag = function () {
        this.options.draggable &&
          (this.bindHandles(!1), n.unbind(this.viewport, "click", this));
      });
    ...
    return (
      (r.pointerDown = function (t, n) {
        ...
        h && h.blur && h != this.element && h.blur(),
          this.options.accessibility && "INPUT" != o && this.element.focus(),
          (this.velocity = 0),
          (this.pointerDownPoint = e.getPointerPoint(n)),
          this.player.stop(),
          i.add(this.viewport, "is-pointer-down");
      }),
      (r.pointerMove = function (t, i) {
        var n = e.getPointerPoint(i),
          o = n.x - this.pointerDownPoint.x;
        !this.isDragging && Math.abs(o) > 3 && this.dragStart(t, i),
          this.dragMove(n, t, i);
      }),
      (r.pointerUp = function (t, e) {
        this.isDragging ? this.dragEnd(t, e) : this.staticClick(t, e),
          i.remove(this.viewport, "is-pointer-down");
      }),
      ...
      (r.dragMove = function (t, e, i) {
        if (this.isDragging) {
          ...
          (this.previousDragMoveTime = this.dragMoveTime),
            ...
            this.dispatchEvent("dragMove", e, [i]);
        }
      }),
  ...
  (function (t, e) {
    "function" == typeof define && define.amd
      ? define(
          "flickity/js/animate",
          ["get-style-property/get-style-property", "./utils"],
          function (i, n) {
            return e(t, i, n);
          }
        )
      ...
      : ((t.Flickity = t.Flickity || {}),
        (t.Flickity.animatePrototype = e(t, t.getStyleProperty, t.utils)));
  })(window, function (t, e, i) {
    for (
      var n,
        o = 0,
    ...
    return (
      ...
      (h.applySelectedAttraction = function () {
        if (!this.isPointerDown && !this.isFreeScrolling && this.cells.length) {
          var t = this.cells[this.selectedIndex],
            e = this.options.wrapAround
              ? this.slideableWidth *
                Math.floor(this.selectedIndex / this.cells.length)
              : 0,
  ...
  (function (t, e) {
    "function" == typeof define && define.amd
      ? define("flickity/js/cell-change", ["./utils"], function (i) {
          return e(t, i);
        })
      : "object" == typeof exports
      ? (module.exports = e(t, require("./utils")))
      : ((t.Flickity = t.Flickity || {}),
        (t.Flickity.cellChangePrototype = e(t, t.utils)));
  })(window, function (t, e) {
    function i(t) {
      for (
  ...
  (function (t, e) {
    if ("function" == typeof define && define.amd)
      ...
      ], function (i, n, o, s, r, l, a, h, c, d, u, p) {
    ...
    function f(t, e) {
      ...
      return i
        ? ((this.element = i),
          ...
          this.option(e),
          void this._create())
        : void (m && m.error("Bad element for Flickity: " + (i || t)));
    }
    var v = t.jQuery,
    ...
    (f.defaults = {
      ...
      s.extend(f.prototype, i.prototype),
      (f.prototype._create = function () {
        ...
        (this.element.flickityGUID = e),
          ...
          this.options.pageDots && (this.pageDots = new a(this)),
          (this.player = new h(this)),
          (this.options.resizeBound || this.options.watchCSS) &&
            n.bind(t, "resize", this),
      ...
      (f.prototype.activate = function () {
        this.isActive ||
          ...
          p(this.element, this.slider),
          this.viewport.appendChild(this.slider),
          this.element.appendChild(this.viewport),
          this.getSize(),
          this.reloadCells(),
          this.setContainerSize(),
          this.prevButton && this.prevButton.activate(),
          this.nextButton && this.nextButton.activate(),
          this.pageDots && this.pageDots.activate(),
          this.options.autoPlay &&
            (this.player.play(), n.bind(this.element, "mouseenter", this)),
      ...
      (f.prototype._makeCells = function (t) {
        for (
          var e = s.filterFindElements(t, this.options.cellSelector),
            i = [],
            n = 0,
            o = e.length;
          o > n;
        ...
        if (this.options.contain && !this.options.wrapAround)
          for (
            var t = this.getLastCell(),
              ...
              i = this.slideableWidth - t.size[e],
            ...
            var r = this.cells[o];
            r.setDefaultTarget(),
              (r.target = Math.max(r.target, this.cursorPosition)),
              (r.target = Math.min(r.target, n));
          }
      }),
        ...
        this.isActive &&
          (this.options.wrapAround &&
            (0 > t
              ...
              : t >= this.cells.length && (this.x += this.slideableWidth)),
          (this.options.wrapAround || e) &&
            (t = s.modulo(t, this.cells.length)),
          this.cells[t] &&
    ...
    return (
      ...
      (f.prototype.destroy = function () {
        this.deactivate(),
          (this.options.resizeBound || this.options.watch) &&
            n.unbind(t, "resize", this),
          delete this.element.flickityGUID,
          delete b[this.guid];
      }),
      s.extend(f.prototype, c),
      s.extend(f.prototype, d),
      s.extend(f.prototype, u),
      (f.data = function (t) {
