...
def extract_data(data_dir):
    ...
    if not os.path.exists(GEFCom_zipfile):
        sys.exit(
            "Download GEFCom2014.zip from https://www.dropbox.com/s/pqenrr2mcvl0hk9/GEFCom2014.zip?dl=0 and save it to the '{}' directory.".format(
                data_dir
            )
        )
    ...
    data = pd.read_excel(
        os.path.join(data_dir, "GEFCom2014-E", "GEFCom2014-E.xlsx"), parse_date="Date"
    )
