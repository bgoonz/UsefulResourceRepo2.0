 ...
 * 
 */
public class DummyJBossMBean implements DynamicMBean
{
    /**
     * <p>
        ...
        mbai = new MBeanAttributeInfo[]
          {
              ...
              new MBeanAttributeInfo("serverVendor", String.class.getName(), "server vendor", true, true, false),
              new MBeanAttributeInfo("serverVersion", String.class.getName(), "server version", true, true, false)
          };
        properties = new HashMap<String, Object>();
        properties.put("Name", this.getClass().getName());
        properties.put("objectName", "Domain:jeeType=J2EEServer");
        properties.put("serverVendor", "JBoss");
        properties.put("serverVersion", "99.99.99");
    }
    ...
    public MBeanInfo getMBeanInfo() 
    {
        return new MBeanInfo(this.getClass().getName(),
                "Dummy JBoss Mean",mbai,null,null,null);
    }
