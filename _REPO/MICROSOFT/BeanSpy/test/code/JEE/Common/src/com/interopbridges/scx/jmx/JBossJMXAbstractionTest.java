...
/**
 * <p>
 * Simple unit-tests to verify JBossJMXAbstraction constructor.
 * </p>
 * 
 * @author Jinlong Li
 * 
 */
public class JBossJMXAbstractionTest {
   /**
    * <p>
   ...
   /**
    * <p>
    * A positive test case for test_JBossJMXAbstraction_NoSuchMethod.
    * </p>
    */
    @Test
    public void test_JBossJMXAbstraction_ConnectSuccuss_Test() 
    {
        try 
        {    
            JmxStores.clearListOfJmxStores();
            JBossJMXAbstraction jmxStoreAbstraction = new JBossJMXAbstraction("org.jboss.mx.util.MockMBeanServerLocator"); 
   ...
   /**
    * <p>
    * Verify that if the locateJBossMethod  function is missing in the class,
    * a scxException would be thrown. 
    * </p>
    */
    @Test
    public void test_JBossJMXAbstraction_NoSuchMethod() 
    {
        try 
        {
            JmxStores.clearListOfJmxStores();
            JBossJMXAbstraction jmxStoreAbstraction = new JBossJMXAbstraction("org.jboss.mx.util.MockMBeanNoLocateJBossMethod");
