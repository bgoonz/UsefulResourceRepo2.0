 ...
 * 
 */
public class MockMBeanServer implements javax.management.MBeanServer
{
    /**
     * <p>
     ...
     * </p>
     */
    static MockMBeanServer _this=null;
     ...
     */
    public static MockMBeanServer getInstance()
    {
        if (_this==null)
        {
            _this = new MockMBeanServer();
        }
        return _this;
    }
