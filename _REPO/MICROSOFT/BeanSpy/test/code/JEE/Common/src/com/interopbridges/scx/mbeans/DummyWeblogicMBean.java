...
/**
 * <p>
 * Simple MBean that emulates a Weblogic info MBean. The primary intention of this
 * class is to mock up a MBean that contains the WeblogicVersion attribute. 
 ...
 * 
 */
public class DummyWeblogicMBean implements DynamicMBean
{
    /**
     * <p>
     ...
     * </p>
     */
    public DummyWeblogicMBean()
    {
        this._logger = LoggingFactory.getLogger();
 
        mbai = new MBeanAttributeInfo[]
          {
              new MBeanAttributeInfo("Name", String.class.getName(), "AdminServer", true, true, false),
              new MBeanAttributeInfo("WeblogicVersion", String.class.getName(), "Version", true, true, false),
          };
        properties = new HashMap<String, Object>();
        properties.put("Name", this.getClass().getName());
        properties.put("WeblogicVersion", "WebLogic Server 10.3.2.0 Tue Oct 20 12:16:15 PDT 2009 1267925");
    }
    ...
    public MBeanInfo getMBeanInfo() 
    {
        return new MBeanInfo(this.getClass().getName(),
                "Dummy Weblogic MBean",mbai,null,null,null);
    }
