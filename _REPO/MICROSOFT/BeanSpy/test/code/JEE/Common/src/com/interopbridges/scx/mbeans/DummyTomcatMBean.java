...
/**
 * <p>
 * Simple MBean that emulates a Tomcat info MBean. The primary intention of this
 * class is to mock up a MBean that contains the serverInfo attribute. 
 * This class is used in the unit tests for verifying that the MBean can be represented as XML.
 * </p>
 * 
 * @author Geoff Erasmus
 * 
 */
public class DummyTomcatMBean implements DynamicMBean
{
    /**
     * <p>
        ...
        mbai = new MBeanAttributeInfo[]
          {
              ...
              new MBeanAttributeInfo("objectName", String.class.getName(), "Catalina:type=Server,*", true, true, false),
              new MBeanAttributeInfo("serverInfo", String.class.getName(), "server Info", true, true, false),
          };
        properties = new HashMap<String, Object>();
        properties.put("Name", this.getClass().getName());
        properties.put("objectName", "Catalina:type=Server,*");
        properties.put("serverInfo", "Tomcat Ver 6.0");
    }
    ...
    public MBeanInfo getMBeanInfo() 
    {
        return new MBeanInfo(this.getClass().getName(),
                "Dummy Tomcat MBean",mbai,null,null,null);
    }
