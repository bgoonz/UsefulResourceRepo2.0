...
namespace MQInstallExample
{
	...
	public class Form1 : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			// messageQueue1
			// 
			this.messageQueue1.Path = "alien\\Private$\\InstallExample";
		...
		{
			using ( System.Messaging.Message msg = new System.Messaging.Message( textBox1.Text ) )
			{
