...
function Cannon() {
  ThreeColorGameObject.call(
    this,
    sprites.cannon_red,
    sprites.cannon_green,
    sprites.cannon_blue
  );
...
Cannon.prototype.handleInputMouse = function (delta) {
  if (Keyboard.pressed(Keys.R)) this.currentColor = this.colorRed;
  else if (Keyboard.pressed(Keys.G)) this.currentColor = this.colorGreen;
  else if (Keyboard.pressed(Keys.B)) this.currentColor = this.colorBlue;
...
Cannon.prototype.handleInputTouch = function (delta) {
  ...
  if (Touch.containsTouchPress(rect)) {
    ...
    else this.currentColor = this.colorRed;
