...
powerupjs.Game.loadAssets = function () {
  var loadSprite = function (sprite) {
    return new powerupjs.SpriteSheet(
      "../../assets/PenguinPairs/sprites/" + sprite
    );
  };

  var loadSound = function (sound, looping) {
    return new powerupjs.Sound(
      "../../assets/PenguinPairs/sounds/" + sound,
      looping
    );
  };
  ...
  else sprites.level_finished = loadSprite("spr_level_finished_click.png");
...
powerupjs.Game.initialize = function () {
  ...
  ID.game_state_options = powerupjs.GameStateManager.add(
    new OptionsMenuState()
  );
  ID.game_state_playing = powerupjs.GameStateManager.add(new PlayingState());
  ID.game_state_levelselect = powerupjs.GameStateManager.add(
    new LevelMenuState()
  );
  ID.game_state_levelfinished = powerupjs.GameStateManager.add(
    new LevelFinishedState()
  );
