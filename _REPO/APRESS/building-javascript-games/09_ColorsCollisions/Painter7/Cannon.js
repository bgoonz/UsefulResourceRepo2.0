...
Object.defineProperty(Cannon.prototype, "color", {
  get: function () {
    ...
    else if (this.currentColor === sprites.cannon_green) return Color.green;
    else return Color.blue;
  },
  set: function (value) {
    if (value === Color.red) this.currentColor = sprites.cannon_red;
    else if (value === Color.green) this.currentColor = sprites.cannon_green;
    else if (value === Color.blue) this.currentColor = sprites.cannon_blue;
  },
});
...
Cannon.prototype.handleInput = function (delta) {
  if (Keyboard.keyDown === Keys.R) this.color = Color.red;
  else if (Keyboard.keyDown === Keys.G) this.color = Color.green;
  else if (Keyboard.keyDown === Keys.B) this.color = Color.blue;
