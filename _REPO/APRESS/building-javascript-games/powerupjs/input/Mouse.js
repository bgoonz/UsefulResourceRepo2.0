...
var powerupjs = (function (powerupjs) {
  ...
  function handleMouseDown(evt) {
    ...
    if (evt.which === 1) {
      if (!powerupjs.Mouse._left.down) powerupjs.Mouse._left.pressed = true;
      powerupjs.Mouse._left.down = true;
    } else if (evt.which === 2) {
      if (!powerupjs.Mouse._middle.down) powerupjs.Mouse._middle.pressed = true;
      powerupjs.Mouse._middle.down = true;
    } else if (evt.which === 3) {
      if (!powerupjs.Mouse._right.down) powerupjs.Mouse._right.pressed = true;
  ...
  function handleMouseUp(evt) {
    ...
    if (evt.which === 1) powerupjs.Mouse._left.down = false;
    else if (evt.which === 2) powerupjs.Mouse._middle.down = false;
    else if (evt.which === 3) powerupjs.Mouse._right.down = false;
  }
