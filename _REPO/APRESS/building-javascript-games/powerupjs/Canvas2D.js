...
var powerupjs = (function (powerupjs) {
  ...
  Object.defineProperty(Canvas2D_Singleton.prototype, "scale", {
    get: function () {
      return new powerupjs.Vector2(
        this._canvas.width / powerupjs.Game.size.x,
  ...
  Canvas2D_Singleton.prototype.drawImage = function (
    ...
    position =
      typeof position !== "undefined" ? position : powerupjs.Vector2.zero;
    rotation = typeof rotation !== "undefined" ? rotation : 0;
    scale = typeof scale !== "undefined" ? scale : 1;
    origin = typeof origin !== "undefined" ? origin : powerupjs.Vector2.zero;
    sourceRect =
      typeof sourceRect !== "undefined"
        ? sourceRect
        : new powerupjs.Rectangle(0, 0, sprite.width, sprite.height);

    this._canvasContext.save();
    if (mirror) {
      this._canvasContext.scale(
        scale * canvasScale.x * -1,
        scale * canvasScale.y
      );
