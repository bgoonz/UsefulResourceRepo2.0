...
var powerupjs = (function (powerupjs) {
  ...
  Rectangle.prototype.calculateIntersectionDepth = function (rect) {
    ...
    if (distance.x > 0) depth.x = minDistance.x - distance.x;
    else depth.x = -minDistance.x - distance.x;
    if (distance.y > 0) depth.y = minDistance.y - distance.y;
    else depth.y = -minDistance.y - distance.y;
    return depth;
  };
