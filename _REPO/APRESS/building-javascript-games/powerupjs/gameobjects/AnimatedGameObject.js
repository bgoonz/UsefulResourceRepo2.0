...
var powerupjs = (function (powerupjs) {
  ...
  AnimatedGameObject.prototype.loadAnimation = function (
    ...
    this._animations[id] = new powerupjs.Animation(
      animname,
      looping,
      frametime
    );
  ...
  AnimatedGameObject.prototype.playAnimation = function (id) {
    if (this._current === this._animations[id]) return;
    this._sheetIndex = 0;
    this._time = 0;
  ...
  AnimatedGameObject.prototype.update = function (delta) {
    ...
    while (this._time > this._current.frameTime) {
      ...
      if (this._sheetIndex > this.sprite.nrSheetElements - 1)
        if (this._current.looping) this._sheetIndex = 0;
        else this._sheetIndex = this.sprite.nrSheetElements - 1;
    }
