...
var powerupjs = (function (powerupjs) {
  ...
  Object.defineProperty(SpriteGameObject.prototype, "sheetIndex", {
    ...
    set: function (value) {
      if (value >= 0) this._sheetIndex = value % this.sprite.nrSheetElements;
    },
  });
  ...
  SpriteGameObject.prototype.collidesWith = function (obj) {
    ...
    var local = intersect.position.subtractFrom(
      this.worldPosition.subtractFrom(this.origin)
    );
    var objLocal = intersect.position.subtractFrom(
      obj.worldPosition.subtractFrom(obj.origin)
    );
