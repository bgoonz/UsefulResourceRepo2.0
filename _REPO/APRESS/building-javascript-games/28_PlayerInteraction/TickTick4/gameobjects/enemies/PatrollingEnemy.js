...
PatrollingEnemy.prototype = Object.create(
...
PatrollingEnemy.prototype.checkPlayerCollision = function () {
  ...
  if (this.collidesWith(player)) player.die(false);
};

PatrollingEnemy.prototype.turnAround = function () {
  this.mirror = !this.mirror;
  this.velocity.x = 120;
  if (this.mirror) this.velocity.x = -this.velocity.x;
};
