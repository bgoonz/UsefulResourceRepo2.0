...
function TitleMenuState(layer) {
  ...
  // the title screen
  var titleScreen = new powerupjs.SpriteGameObject(
    sprites.background_title,
    ID.layer_background
  );
  ...
  this.playButton.position = new powerupjs.Vector2(
    this.playButton.screenCenterX,
    540
  );
  this.add(this.playButton);

  // add a help button
  this.helpButton = new powerupjs.Button(
    sprites.button_help,
    ID.layer_overlays
  );
  this.helpButton.position = new powerupjs.Vector2(
    this.helpButton.screenCenterX,
    600
  );
