    ...
    class SaltSolo < Base
      ...
      def install_command
        ...
        if windows_os?
            ...
            # Don't really need this in windows
            #omnibus_download_dir = config[:omnibus_cachier] ? "c/tmp/vagrant-cache/omnibus_chef" : "c/tmp"
            ...
            info("Preparing download chef omnibus on Linux")
