...
2.  1.  Public
    ...
    7.  <a href="/jobs/companies?so_medium=StackOverflow&amp;so_source=SiteNav" id="nav-companies" class="js-gps-track nav-links--link"></a>
        Companies
...
<a href="/questions/tagged/javascript" class="post-tag js-gps-track" title="show questions tagged &#39;javascript&#39;">javascript</a> <a href="/questions/tagged/jquery" class="post-tag js-gps-track" title="show questions tagged &#39;jquery&#39;">jquery</a>
...
<a href="/a/2218334/15158587" class="js-share-link js-gps-track" title="Short permalink to this answer">Share</a>
...
<a href="/posts/3189444/revisions" id="history-3189444" title="show revision history for this post">3 revs, 2 users 72%<br />
</a>[Rixius](/users/212307)

<span class="d-none" itemprop="commentCount"></span>

<a href="#" class="js-add-link comments-link disabled-link" title="Use comments to ask for more information or suggest improvements. Avoid comments like “+1” or “thanks”.">Add a comment</a> <span class="js-link-separator dno"> | </span> <a href="#" class="js-show-link comments-link dno" title="Expand to show all comments on this post"></a>

<span id="5410587"></span>
...
The [data function](http://api.jquery.com/data/) has been mentioned before. With it, you are able to associate data with DOM elements.

Recently the jQuery team has added support for [HTML5 custom data-\* attributes](http://dev.w3.org/html5/spec/elements.html#embedding-custom-non-visible-data-with-the-data-attributes). And as if that wasn't enough; they've force-fed the data function with steroids, which means that you are able to store complex objects in the form of JSON, directly in your markup.  
...
<a href="/a/5410587/15158587" class="js-share-link js-gps-track" title="Short permalink to this answer">Share</a>
...
<a href="/posts/5410587/revisions" class="js-gps-track" title="show all edits to this post">edited <span class="relativetime" title="2011-03-23 19:53:25Z">Mar 23 '11 at 19:53</span></a>

<span class="community-wiki" title="This post is community owned as of Mar 23 '11 at 19:30. Votes do not generate reputation, and it can be edited by users with 100 rep"> community wiki </span>

  

<a href="/posts/5410587/revisions" id="history-5410587" title="show revision history for this post">3 revs<br />
</a>[roosteronacid](/users/20946)
...
Not the answer you're looking for? Browse other questions tagged <a href="/questions/tagged/javascript" class="post-tag" title="show questions tagged &#39;javascript&#39;">javascript</a> <a href="/questions/tagged/jquery" class="post-tag" title="show questions tagged &#39;jquery&#39;">jquery</a> or [ask your own question](/questions/ask).
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

-   

    <a href="https://stackoverflow.blog/2021/04/05/a-look-under-the-hood-how-branches-work-in-git/?cb=1" class="js-gps-track">A look under the hood: how branches work in Git</a>

-   

    <a href="https://stackoverflow.blog/2021/04/07/what-international-tech-recruitment-looks-like-post-covid-19/?cb=1" class="js-gps-track">What international tech recruitment looks like post-COVID-19</a>

-   

    <a href="https://meta.stackexchange.com/questions/362203/stack-overflow-for-teams-is-now-free-for-up-to-50-users-forever?cb=1" class="js-gps-track">Stack Overflow for Teams is now free for up to 50 users, forever</a>

-   

    <a href="https://meta.stackoverflow.com/questions/406675/outdated-answers-results-from-use-case-survey?cb=1" class="js-gps-track">Outdated Answers: results from use-case survey</a>

-   <span class="fc-black-500" title="Vote score (upvotes - downvotes)">15</span>

    <a href="https://meta.stackoverflow.com/questions/406631/retag-scriplets-tag?cb=1" class="js-gps-track">Retag [scriplets] tag</a>

-   <span class="fc-black-500" title="Vote score (upvotes - downvotes)">19</span>

    <a href="https://meta.stackoverflow.com/questions/406661/do-we-do-anything-to-network-error-questions?cb=1" class="js-gps-track">Do we do anything to “network error” questions?</a>

-   <span class="fc-black-500" title="Vote score (upvotes - downvotes)">5</span>

    <a href="https://meta.stackoverflow.com/questions/406645/shouldnt-close-voters-names-be-hidden-also-from-the-timeline?cb=1" class="js-gps-track">Shouldn't close voters' names be hidden also from the timeline?</a>

#### Linked

[](https://stackoverflow.com/q/1229259?lq=1 "Vote score (upvotes - downvotes)")

211

<a href="https://stackoverflow.com/questions/1229259/jquery-pitfalls-to-avoid?noredirect=1&amp;lq=1" class="question-hyperlink">jQuery pitfalls to avoid</a>

[](https://stackoverflow.com/q/708105?lq=1 "Vote score (upvotes - downvotes)")

34

<a href="https://stackoverflow.com/questions/708105/jquery-map-practical-uses-for-the-function?noredirect=1&amp;lq=1" class="question-hyperlink">jQuery.map - Practical uses for the function?</a>

[](https://stackoverflow.com/q/1587375?lq=1 "Vote score (upvotes - downvotes)")

12

<a href="https://stackoverflow.com/questions/1587375/what-are-some-quick-tips-for-increasing-jquery-performance?noredirect=1&amp;lq=1" class="question-hyperlink">What are some quick tips for increasing jQuery performance?</a>

[](https://stackoverflow.com/q/9025294?lq=1 "Vote score (upvotes - downvotes)")

21

<a href="https://stackoverflow.com/questions/9025294/jquery-passing-this-to-named-function-event-handler?noredirect=1&amp;lq=1" class="question-hyperlink">jQuery: passing $(this) to named function event handler</a>

[](https://stackoverflow.com/q/382301?lq=1 "Vote score (upvotes - downvotes)")

11

<a href="https://stackoverflow.com/questions/382301/jquery-accordion-close-then-open?noredirect=1&amp;lq=1" class="question-hyperlink">Jquery Accordion Close then Open</a>

[](https://stackoverflow.com/q/1865965?lq=1 "Vote score (upvotes - downvotes)")

4

<a href="https://stackoverflow.com/questions/1865965/does-jquery-this-need-to-be-cached?noredirect=1&amp;lq=1" class="question-hyperlink">Does jQuery $(this) need to be cached</a>

[](https://stackoverflow.com/q/4363902?lq=1 "Vote score (upvotes - downvotes)")

5

<a href="https://stackoverflow.com/questions/4363902/how-do-i-display-an-image-when-a-user-hovers-over-a-link-using-jquery?noredirect=1&amp;lq=1" class="question-hyperlink">How do I display an image when a user hovers over a link using JQuery</a>

[](https://stackoverflow.com/q/5467181?lq=1 "Vote score (upvotes - downvotes)")

2

<a href="https://stackoverflow.com/questions/5467181/jquery-code-critque?noredirect=1&amp;lq=1" class="question-hyperlink">jQuery code critque</a>

[](https://stackoverflow.com/q/31918841?lq=1 "Vote score (upvotes - downvotes)")

3

<a href="https://stackoverflow.com/questions/31918841/can-we-use-any-other-symbol-instead-of-jquery-and-symbol-in-jquery?noredirect=1&amp;lq=1" class="question-hyperlink">Can we use any other symbol instead of jQuery and $ symbol in jquery</a>

[](https://stackoverflow.com/q/1576182?lq=1 "Vote score (upvotes - downvotes)")

0

<a href="https://stackoverflow.com/questions/1576182/getting-elements-that-exceed-the-maxium-value-javascript-jquery?noredirect=1&amp;lq=1" class="question-hyperlink">Getting elements that exceed the maxium value. JAVASCRIPT/JQUERY</a>

[See more linked questions](https://stackoverflow.com/questions/linked/182630?lq=1)

#### Related

[](https://stackoverflow.com/q/31044?rq=1 "Vote score (upvotes - downvotes)")

2895

<a href="https://stackoverflow.com/questions/31044/is-there-an-exists-function-for-jquery?rq=1" class="question-hyperlink">Is there an “exists” function for jQuery?</a>

[](https://stackoverflow.com/q/171027?rq=1 "Vote score (upvotes - downvotes)")

2524

<a href="https://stackoverflow.com/questions/171027/add-table-row-in-jquery?rq=1" class="question-hyperlink">Add table row in jQuery</a>

[](https://stackoverflow.com/q/178325?rq=1 "Vote score (upvotes - downvotes)")
...
[](https://stackoverflow.com/q/426258?rq=1 "Vote score (upvotes - downvotes)")

4285

<a href="https://stackoverflow.com/questions/426258/setting-checked-for-a-checkbox-with-jquery?rq=1" class="question-hyperlink">Setting “checked” for a checkbox with jQuery</a>

[](https://stackoverflow.com/q/762011?rq=1 "Vote score (upvotes - downvotes)")

5058

<a href="https://stackoverflow.com/questions/762011/whats-the-difference-between-using-let-and-var?rq=1" class="question-hyperlink">What's the difference between using “let” and “var”?</a>

[](https://stackoverflow.com/q/901712?rq=1 "Vote score (upvotes - downvotes)")

4808

<a href="https://stackoverflow.com/questions/901712/how-do-i-check-whether-a-checkbox-is-checked-in-jquery?rq=1" class="question-hyperlink">How do I check whether a checkbox is checked in jQuery?</a>

[](https://stackoverflow.com/q/1335851?rq=1 "Vote score (upvotes - downvotes)")

7813

<a href="https://stackoverflow.com/questions/1335851/what-does-use-strict-do-in-javascript-and-what-is-the-reasoning-behind-it?rq=1" class="question-hyperlink">What does “use strict” do in JavaScript, and what is the reasoning behind it?</a>

[](https://stackoverflow.com/q/5404839?rq=1 "Vote score (upvotes - downvotes)")

2559

<a href="https://stackoverflow.com/questions/5404839/how-can-i-refresh-a-page-with-jquery?rq=1" class="question-hyperlink">How can I refresh a page with jQuery?</a>

[](https://stackoverflow.com/q/6677035?rq=1 "Vote score (upvotes - downvotes)")

2467

<a href="https://stackoverflow.com/questions/6677035/jquery-scroll-to-element?rq=1" class="question-hyperlink">jQuery scroll to element</a>

#### <a href="https://stackexchange.com/questions?tab=hot" class="js-gps-track s-link s-link__inherit">Hot Network Questions</a>

-   

    <a href="https://academia.stackexchange.com/questions/165972/what-is-inappropriate-about-this-email-and-how-can-i-fix-it" class="js-gps-track question-hyperlink mb0">What is inappropriate about this email, and how can I fix it?</a>
-   

    <a href="https://sqa.stackexchange.com/questions/47251/how-does-the-qa-team-lead-role-change-in-a-cross-functional-agile-teams-structur" class="js-gps-track question-hyperlink mb0">How does the QA Team Lead role change in a cross-functional agile teams structure?</a>
-   

    <a href="https://blender.stackexchange.com/questions/218837/how-to-apply-nodes-to-object" class="js-gps-track question-hyperlink mb0">How to apply nodes to object</a>
-   

    <a href="https://retrocomputing.stackexchange.com/questions/19531/how-many-transistors-in-the-cdc-1604" class="js-gps-track question-hyperlink mb0">How many transistors in the CDC 1604?</a>
-   

    <a href="https://electronics.stackexchange.com/questions/558946/rc-oscillator-with-op-amps" class="js-gps-track question-hyperlink mb0">RC oscillator with op amps</a>
-   

    <a href="https://tex.stackexchange.com/questions/591915/how-to-add-square-bracket-in-this-matrix" class="js-gps-track question-hyperlink mb0">How to add square bracket in this matrix?</a>
-   

    <a href="https://puzzling.stackexchange.com/questions/109318/deriving-a-3x3-grid-from-another-one" class="js-gps-track question-hyperlink mb0">Deriving a 3x3 grid from another one</a>
-   

    <a href="https://scifi.stackexchange.com/questions/245568/why-did-loki-attempt-this-at-the-beginning-of-infinity-war" class="js-gps-track question-hyperlink mb0">Why did Loki attempt this at the beginning of Infinity War?</a>
-   

    <a href="https://money.stackexchange.com/questions/139561/how-can-i-finance-a-car-at-17-years-old-with-no-credit-or-co-signer" class="js-gps-track question-hyperlink mb0">How can I finance a car at 17 years old with no credit or co-signer?</a>
-   

    <a href="https://codegolf.stackexchange.com/questions/223040/fastest-draw-in-the-west" class="js-gps-track question-hyperlink mb0">Fastest draw in the west!</a>
-   

    <a href="https://english.stackexchange.com/questions/564422/why-is-it-called-a-four-poster-bed-and-not-a-four-post-bed" class="js-gps-track question-hyperlink mb0">Why is it called a Four-Poster Bed, and not a Four-Post Bed</a>
-   

    <a href="https://german.stackexchange.com/questions/64609/low-german-upper-german-bavarian-where-are-these-dialects-spoken" class="js-gps-track question-hyperlink mb0">Low German, Upper German, Bavarian ... Where are these dialects spoken?</a>
-   

    <a href="https://electronics.stackexchange.com/questions/558808/differences-between-oscilloscope-multimeter-and-power-supply-voltage-readings" class="js-gps-track question-hyperlink mb0">Differences between oscilloscope, multimeter, and power supply voltage readings</a>
-   

    <a href="https://law.stackexchange.com/questions/63893/why-did-the-supreme-court-vacate-the-ruling-that-trump-could-not-block-twitter-u" class="js-gps-track question-hyperlink mb0">Why did the Supreme Court vacate the ruling that Trump could not block Twitter users?</a>
-   

    <a href="https://physics.stackexchange.com/questions/627935/what-are-the-physical-processes-involved-in-feeling-warm-from-the-sunlight" class="js-gps-track question-hyperlink mb0">What are the physical processes involved in feeling warm from the sunlight?</a>
-   

    <a href="https://academia.stackexchange.com/questions/165968/making-friends-in-academia-and-building-connections" class="js-gps-track question-hyperlink mb0">Making friends in academia and building connections</a>
-   

    <a href="https://rpg.stackexchange.com/questions/183727/does-this-lake-event-in-the-icewind-dale-rime-of-the-frostmaiden-adventure-al" class="js-gps-track question-hyperlink mb0">Does this lake event in the "Icewind Dale: Rime of the Frostmaiden" adventure allow a grapple as an opportunity attack?</a>
-   

    <a href="https://politics.stackexchange.com/questions/63344/how-is-it-possible-to-travel-to-countries-that-dont-recognize-the-issuing-count" class="js-gps-track question-hyperlink mb0">How is it possible to travel to countries that don't recognize the issuing country of one's passport?</a>
-   

    <a href="https://codereview.stackexchange.com/questions/259119/counting-the-number-of-unique-ip-addresses-in-a-very-large-file" class="js-gps-track question-hyperlink mb0">Counting the number of unique IP addresses in a very large file</a>
-   

    <a href="https://electronics.stackexchange.com/questions/558898/what-is-the-purpose-of-transformers-on-the-output-side-of-a-dc-power-suppply" class="js-gps-track question-hyperlink mb0">What is the purpose of transformers on the output side of a DC power suppply?</a>
-   

    <a href="https://codegolf.stackexchange.com/questions/222988/overwrite-a-string-on-a-tape" class="js-gps-track question-hyperlink mb0">Overwrite a string on a tape</a>
-   

    <a href="https://stats.stackexchange.com/questions/518344/why-the-p-value-of-t-test-is-not-statistically-significant-when-mean-values-lo" class="js-gps-track question-hyperlink mb0">Why the p-value of t.test() is not statistically significant when mean values look really different</a>
-   

    <a href="https://astronomy.stackexchange.com/questions/43299/does-general-relativity-really-predict-black-holes" class="js-gps-track question-hyperlink mb0">Does General Relativity really predict Black Holes?</a>
-   

    <a href="https://cs.stackexchange.com/questions/138685/decidable-if-a-turing-machine-m-on-input-w-will-m-ever-move-its-read-write-he" class="js-gps-track question-hyperlink mb0">Decidable? If a Turing Machine M, on input w, will M ever move its read/write head to the left?</a>

<img src="/posts/182630/ivc/2f8a" class="dno" width="0" height="0" />

lang-js

##### <a href="https://stackoverflow.com" class="js-gps-track">Stack Overflow</a>

-   <a href="/questions" class="js-gps-track -link">Questions</a>
-   <a href="https://stackoverflow.com/jobs" class="js-gps-track -link">Jobs</a>
-   <a href="https://stackoverflow.com/jobs/directory/developer-jobs" class="js-gps-track -link">Developer Jobs Directory</a>
-   <a href="https://stackoverflow.com/jobs/salary" class="js-gps-track -link">Salary Calculator</a>
-   <a href="/help" class="js-gps-track -link">Help</a>
-   <span class="js-gps-track -link">Mobile</span>
-   <span class="-link">Disable Responsiveness</span>

##### <a href="https://stackoverflowbusiness.com" class="js-gps-track">Products</a>

-   <a href="https://stackoverflow.com/teams" class="js-gps-track -link">Teams</a>
-   <a href="https://stackoverflow.com/talent" class="js-gps-track -link">Talent</a>
-   <a href="https://stackoverflow.com/advertising" class="js-gps-track -link">Advertising</a>
-   <a href="https://stackoverflow.com/enterprise" class="js-gps-track -link">Enterprise</a>
...
-   <a href="https://stackoverflow.com/company/work-here" class="js-gps-track -link">Work Here</a>
...
-   <a href="https://stackoverflow.com/legal/terms-of-service" class="js-gps-track -link">Terms of Service</a>
-   <a href="https://stackoverflow.com/company/contact" class="js-gps-track -link">Contact Us</a>
-   <span id="consent-footer-link"><a href="#" class="js-gps-track -link js-cookie-settings">Cookie Settings</a></span>
-   <a href="https://stackoverflow.com/legal/cookie-policy" class="js-gps-track -link">Cookie Policy</a>
...
-   <a href="https://salesforce.stackexchange.com" class="-link js-gps-track" title="Salesforce administrators, implementation experts, developers and anybody in-between">Salesforce</a>
...
-   <a href="https://photo.stackexchange.com" class="-link js-gps-track" title="professional, enthusiast and amateur photographers">Photography</a>
...
-   <a href="https://chinese.stackexchange.com" class="-link js-gps-track" title="students, teachers, and linguists wanting to discuss the finer points of the Chinese language">Chinese Language</a>
...
-   <a href="https://mathoverflow.net" class="-link js-gps-track" title="professional mathematicians">MathOverflow</a>
...
site design / logo © 2021 Stack Exchange Inc; user contributions licensed under [cc by-sa](https://stackoverflow.com/help/licensing). <span id="svnrev">rev 2021.4.7.39017</span>

Stack Overflow works best with JavaScript enabled <img src="https://pixel.quantserve.com/pixel/p-c1rF4kxgLUzNc.gif" class="dno" />

 

<span style="margin: 0px auto; border: 2px dotted rgb(0, 0, 0); position: absolute; z-index: 2147483647; visibility: hidden; left: 542px; width: 0px; top: 1233px; height: 0px;"></span><span style="z-index: 2147483647; position: absolute; visibility: hidden; left: 527px; width: 50px; top: 1218px; height: 20px; font-size: 10px; color: black;"></span>
