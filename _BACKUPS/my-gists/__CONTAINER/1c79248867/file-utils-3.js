    ...
    },
    {
      ...
      value: function rimraf(dirPath, callback) {
        ...
        return (0, _pathExists2.default)(dirPath).then(function (exists) {
          ...
          return _ChildProcessUtilities2.default.spawn(
            process.execPath,
            args,
            {},
            function (err) {
...
function resolveSymbolicLink(filePath) {
  ...
  var isSymlink = lstat.isSymbolicLink()
    ? _path2.default.resolve(
        _path2.default.dirname(filePath),
        _fsExtra2.default.readlinkSync(filePath)
      )
    : false;
  ...
  if (lstat.isFile() && !isSymlink) {
    try {
      return _path2.default.resolve(
        _path2.default.dirname(filePath),
        _readCmdShim2.default.sync(filePath)
      );
    } catch (e) {
      return false;
    }
