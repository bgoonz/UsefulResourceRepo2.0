...
gulp.task("scripts-dev", function () {
  return gulp
    .src(paths.vendorJavascript.concat(paths.appJavascript, paths.appTemplates))
...
gulp.task("styles-dev", function () {
  return gulp
    .src(paths.vendorCss.concat(paths.appMainSass))
...
gulp.task("images-prod", function () {
  return gulp.src(paths.appImages).pipe(gulp.dest(paths.distImages));
});
...
gulp.task("lint", function () {
  return gulp
    .src(paths.appJavascript.concat(paths.specFolder))
    .pipe(plugins.jshint())
...
gulp.task("testem", function () {
  return gulp
    .src([""]) // We don't need files, that is managed on testem.json
    .pipe(
      plugins.testem({
