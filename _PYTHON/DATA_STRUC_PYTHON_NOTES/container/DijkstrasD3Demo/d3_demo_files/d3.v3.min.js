!(function () {
  ...
  function Lr(n, t) {
    ...
    arguments.length
      ...
      : ((n = 1), (e = t / 4)),
    r => {
      return 1 + n * 2 ** (-10 * r) * Math.sin(((r - e) * Ho) / t);
    };
  }
  function qr(n) {
    return n || (n = 1.70158),
  ...
  function Ki(n, t) {
    ...
    const e = Yi(n);
    const r = e[1] - e[0];
    let i = 10 ** Math.floor(Math.log(r / t) / Math.LN10);
    const u = (t / r) * i;
    return (
  ...
  (Go.brighter = function (n) {
    return (n = 0.7 ** (arguments.length ? n : 1)),
  ...
  (ao.timer = function(...args) {
    ...
    (ao.round = (n, t) => {
      return t ? Math.round(n * (t = 10 ** t)) / t : Math.round(n);
    });
  const sa = [
    "y",
    "z",
