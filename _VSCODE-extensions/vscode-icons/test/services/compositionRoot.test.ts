...
describe('CompositionRootService: tests', function () {
  context('ensures that', function () {
    ...
    let languageResourceManagerStub: sinon.SinonStubbedInstance<models.ILanguageResourceManager>;
    ...
    let extensionManagerStub: sinon.SinonStubbedInstance<models.IExtensionManager>;
    ...
    beforeEach(function () {
      ...
      languageResourceManagerStub =
        sandbox.createStubInstance<models.ILanguageResourceManager>(
      ...
      extensionManagerStub =
        sandbox.createStubInstance<models.IExtensionManager>(ExtensionManager);
    });
