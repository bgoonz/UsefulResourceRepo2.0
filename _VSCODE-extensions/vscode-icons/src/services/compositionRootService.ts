...
export class CompositionRootService {
  ...
  private register(context: IVSCodeExtensionContext): void {
    ...
    const languageResourceManager: ILanguageResourceManager =
      this.bind<ILanguageResourceManager>(
    ...
    const notificationManager: INotificationManager =
      this.bind<INotificationManager>(
        SYMBOLS.INotificationManager,
        NotificationManager,
        vscodeManager,
        languageResourceManager,
      );
    const projectAutoDetectionManager: IProjectAutoDetectionManager =
      this.bind<IProjectAutoDetectionManager>(
