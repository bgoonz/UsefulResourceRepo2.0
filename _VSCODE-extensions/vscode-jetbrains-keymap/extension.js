...
class View {
  constructor(updateSetting, editorConfig) {
    ...
    this.messages = {
      ...
      prompt:
        "New features are available for JetBrains Keymap. Do you want to enable the new features?",
  ...
  showMessage() {
    const ans = showInformationMessage(
...
function activate(context) {
  ...
  console.log(
    'Congratulations, your extension "vscode-jetbrains-keybindings" is now active!'
  );
