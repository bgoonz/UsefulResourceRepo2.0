...
export const DidSaveTextDocumentNotificationType = new NotificationType<
  IDidSaveTextDocumentParams,
  void
...
export class RemoteFilesFeature implements IFeature {
  ...
  constructor() {
    ...
    this.tempSessionPathPrefix = path.join(os.tmpdir(), "PSES-").toLowerCase();
