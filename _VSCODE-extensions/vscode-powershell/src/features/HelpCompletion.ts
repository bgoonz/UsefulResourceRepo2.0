...
export const CommentHelpRequestType = new RequestType<any, any, void, void>(
...
class HelpCompletionProvider {
  ...
  public async complete(): Promise<void> {
    ...
    const result = await this.langClient.sendRequest(CommentHelpRequestType, {
      ...
      blockComment:
        this.settings.helpCompletion === Settings.HelpCompletion.BlockComment,
    });
