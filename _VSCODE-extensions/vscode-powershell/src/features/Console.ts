...
export const EvaluateRequestType = new RequestType<
  ...
  void
>("evaluate");
export const OutputNotificationType = new NotificationType<
  IOutputNotificationBody,
  void
>("output");
export const ExecutionStatusChangedNotificationType = new NotificationType<
  IExecutionStatusDetails,
  void
...
function showInputPrompt(
  ...
  client: LanguageClient
): Thenable<IShowInputPromptResponseBody> {
  const resultThenable = vscode.window
    .showInputBox({
...
function onItemsSelected(
  chosenItems: ICheckboxQuickPickItem[]
): IShowChoicePromptResponseBody {
...
function onItemSelected(
  chosenItem: vscode.QuickPickItem
): IShowChoicePromptResponseBody {
...
export class ConsoleFeature implements IFeature {
  ...
  public setLanguageClient(languageClient: LanguageClient) {
    ...
    this.languageClient.onRequest(ShowInputPromptRequestType, (promptDetails) =>
      showInputPrompt(promptDetails, this.languageClient)
    );
