...
(function (DidChangeConfigurationEvent) {
  DidChangeConfigurationEvent.type = {
    event: "workspace/didChangeConfiguration",
  };
})(
  (DidChangeConfigurationEvent =
    exports.DidChangeConfigurationEvent ||
    (exports.DidChangeConfigurationEvent = {}))
);
var MessageSeverity;
...
(function (ShowMessageEvent) {
  ...
  (ShowMessageEvent =
    exports.ShowMessageEvent || (exports.ShowMessageEvent = {}))
);
var LogMessageEvent;
...
(function (DidOpenDocumentEvent) {
  ...
  (DidOpenDocumentEvent =
    exports.DidOpenDocumentEvent || (exports.DidOpenDocumentEvent = {}))
);
var DidChangeDocumentEvent;
(function (DidChangeDocumentEvent) {
  DidChangeDocumentEvent.type = { event: "document/didChange" };
})(
  (DidChangeDocumentEvent =
    exports.DidChangeDocumentEvent || (exports.DidChangeDocumentEvent = {}))
);
var DidCloseDocumentEvent;
(function (DidCloseDocumentEvent) {
  DidCloseDocumentEvent.type = { event: "document/didClose" };
})(
  (DidCloseDocumentEvent =
    exports.DidCloseDocumentEvent || (exports.DidCloseDocumentEvent = {}))
);
/**
 */
...
(function (DidChangeFilesEvent) {
  ...
  (DidChangeFilesEvent =
    exports.DidChangeFilesEvent || (exports.DidChangeFilesEvent = {}))
);
var FileChangeType;
...
(function (PublishDiagnosticsEvent) {
  ...
  (PublishDiagnosticsEvent =
    exports.PublishDiagnosticsEvent || (exports.PublishDiagnosticsEvent = {}))
);
var Severity;
(function (Severity) {
  Severity.Error = 1;
