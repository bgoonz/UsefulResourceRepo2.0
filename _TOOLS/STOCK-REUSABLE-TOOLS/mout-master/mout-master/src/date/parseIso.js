define(["../array/some"], function (some) {
    ...
    let ORD_DATE = /^([0-9]{4})-?([0-9]{3})$/; // YYYY-DDD
    ...
    let DATE_TIME = /^(.+)T(.+)$/;
    let TIME_ZONE = /^(.+)([+\-])([0-9]{2}):?([0-9]{2})$/;

    function matchAll(str, patterns) {
        let match;
        let found = some(patterns, function (pattern) {
    ...
    function parseTime(str) {
        ...
        let hours = match[1] === void 0 ? 0 : +match[1],
