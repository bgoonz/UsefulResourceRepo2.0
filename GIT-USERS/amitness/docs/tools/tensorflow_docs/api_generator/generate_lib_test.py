...
class GenerateTest(absltest.TestCase):
    ...
    def test_write(self):
        ...
        generate_lib.write_docs(output_dir, parser_config, yaml_toc=True, site_path="")
        ...
        self.assertEqual(
            ...
            [
                ...
                "-",
                "from:",
                "/api_docs/python/tf/test_function",
                "to:",
        ...
        self.assertTrue(os.path.exists(os.path.join(output_dir, "tf/TestModule.md")))
        self.assertFalse(
            os.path.exists(os.path.join(output_dir, "tf/test_function.md"))
        )
        self.assertTrue(
            os.path.exists(os.path.join(output_dir, "tf/TestModule/TestClass.md"))
        )
        self.assertTrue(
            os.path.exists(
                os.path.join(output_dir, "tf/TestModule/TestClass/ChildClass.md")
            )
        )
        self.assertTrue(
            os.path.exists(
        ...
        self.assertTrue(
            os.path.exists(os.path.join(output_dir, "tf/TestModule/test_function.md"))
        )
    ...
    def test_replace_refes(self):
        ...
        generate_lib.replace_refs(test_in_dir, test_out_dir, reference_resolver, "*.md")
