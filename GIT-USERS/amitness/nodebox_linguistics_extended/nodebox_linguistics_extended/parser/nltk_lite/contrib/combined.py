...
from nodebox_linguistics_extended.parser.nltk_lite.contrib.marshal import MarshalDefault

Default = MarshalDefault
from nodebox_linguistics_extended.parser.nltk_lite.contrib.marshal import MarshalUnigram

Unigram = MarshalUnigram
from nodebox_linguistics_extended.parser.nltk_lite.contrib.marshal import MarshalAffix

Affix = MarshalAffix
from nodebox_linguistics_extended.parser.nltk_lite.contrib.marshal import MarshalNgram
