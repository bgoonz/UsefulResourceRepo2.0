...
DATABASE_URL = os.environ.get(
    "DATABASE_URL", "postgresql://wazimap_np:wazimap_np@localhost/wazimap_np"
)
...
WAZIMAP["levels"] = {
    ...
    "province": {"plural": "provinces", "children": ["district"]},  # 7 provinces
    "district": {"plural": "districts", "children": ["local"]},  # 77 districts
    ...
    "local": {"plural": "locals", "children": []},  # 753 local bodies
}
