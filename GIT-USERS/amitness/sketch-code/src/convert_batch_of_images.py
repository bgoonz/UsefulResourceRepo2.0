...
def build_parser():
    ...
    parser.add_argument(
        ...
        type=str,
        dest="pngs_path",
        help="png folder to convert into HTML",
        required=True,
    )
    parser.add_argument(
        "--output_folder",
    ...
    parser.add_argument(
        "--original_guis_filepath",
        type=str,
        dest="original_guis_filepath",
        help="if getting BLEU score, provide original guis folder filepath",
        default=None,
    )
    parser.add_argument(
        "--style",
...
def main():
    ...
    # Create sampler
    sampler = Sampler(
        model_json_path=model_json_file, model_weights_path=model_weights_file
    )
    ...
    sampler.convert_batch_of_images(
        output_folder,
        pngs_path=pngs_path,
        get_corpus_bleu=print_bleu_score,
        original_guis_filepath=original_guis_filepath,
        style=style,
    )
