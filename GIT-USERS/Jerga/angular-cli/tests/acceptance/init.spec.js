...
describe("Acceptance: ng init", function () {
  ...
  it("ng init", function () {
    return ng(["init", "--skip-npm"]).then(confirmBlueprinted);
  });
  ...
  it("ng init can run in created folder", function () {
    return tmp
      ...
      .then(function () {
        return ng(["init", "--skip-npm", "--name", "tmp"]);
      })
  ...
  it("ng init --inline-template does not generate a template file", () => {
    return ng(["init", "--skip-npm", "--skip-git", "--inline-template"]).then(
      () => {
  ...
  it("ng init --inline-style does not gener a style file", () => {
    return ng(["init", "--skip-npm", "--skip-git", "--inline-style"]).then(
      () => {
