...
export default function () {
  return (
    writeMultipleFiles({
      ...
      .then(() =>
        updateJsonFile("angular-cli.json", (configJson) => {
          ...
          app["scripts"] = [
            ...
            {
              input: "pre-rename-lazy-script.js",
              output: "renamed-lazy-script",
              lazy: true,
            },
      ...
      .then(() =>
        expectFileToMatch("dist/lazy-script.bundle.js", "lazy-script")
      )
      .then(() =>
        expectFileToMatch("dist/renamed-script.bundle.js", "pre-rename-script")
      )
      .then(() =>
        expectFileToMatch(
          "dist/renamed-lazy-script.bundle.js",
