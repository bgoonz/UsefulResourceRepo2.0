...
export default function () {
  return (
    writeMultipleFiles({
      ...
      .then(() =>
        expectFileToMatch("dist/renamed-style.bundle.css", ".pre-rename-style")
      )
      .then(() =>
        expectFileToMatch(
      ...
      .then(() =>
        expectFileToMatch("dist/common-entry.bundle.css", ".common-entry-style")
      )
      .then(() =>
        expectFileToMatch("dist/common-entry.bundle.js", "common-entry-script")
      )
      // there are no js entry points for css only bundles
      .then(() =>
        expectToFail(() => expectFileToExist("dist/styles.bundle.js"))
      )
      .then(() =>
        expectToFail(() => expectFileToExist("dist/lazy-styles.bundle.js"))
      )
      .then(() =>
        expectToFail(() => expectFileToExist("dist/renamed-styles.bundle.js"))
      )
      .then(() =>
        expectToFail(() =>
          expectFileToExist("dist/renamed-lazy-styles.bundle.js")
        )
      )
