...
export default function () {
  ...
  return (
    ng("generate", "component", "Upper-Dir/test-component")
      .then(() => expectFileToExist(componentDir))
      .then(() =>
        expectFileToExist(join(componentDir, "test-component.component.ts"))
      )
      .then(() =>
        expectFileToExist(
      ...
      .then(() =>
        expectFileToExist(join(componentDir, "test-component.component.html"))
      )
      .then(() =>
        expectFileToExist(join(componentDir, "test-component.component.css"))
      )
