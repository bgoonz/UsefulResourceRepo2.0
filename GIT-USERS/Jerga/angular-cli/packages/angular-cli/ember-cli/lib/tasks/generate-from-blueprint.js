...
module.exports = Task.extend({
  ...
  run: function (options) {
    ...
    if (
      noAddonBlueprint.indexOf(name) < 0 &&
      !addonBlueprint &&
      mainBlueprint &&
      mainBlueprint.supportsAddon() &&
      options.args[1]
    ) {
    ...
    return mainBlueprint[this.blueprintFunction](blueprintOptions)
      .then(function () {
        ...
        var testBlueprintOptions = merge({}, blueprintOptions, {
          installingTest: true,
        });
      ...
      .then(
        function () {
          ...
          if (
            ...
            blueprintOptions.inRepoAddon === null
          ) {
            return;
          }
          ...
          var addonBlueprintOptions = merge({}, blueprintOptions, {
