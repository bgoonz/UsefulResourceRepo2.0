...
describe("route utils", () => {
  describe("insertImport", () => {
    ...
    it("inserts as last import if not present", () => {
      ...
      return editedFile
        ...
        .then(() =>
          nru
            .insertImport(sourceFile, "Router", "@angular/router")
            .apply(NodeHost)
        )
    ...
    it("inserts subcomponent in win32 environment", () => {
      ...
      return nru
        .insertImport(sourceFile, "level2", content)
        .apply(NodeHost)
        .then(() => readFile(sourceFile, "utf8"))
        .then((newContent) => {
  ...
  describe("bootstrapItem", () => {
    ...
    it("adds a provideRouter import if not there already", () => {
      return nru
        .applyChanges(nru.bootstrapItem(mainFile, routes, toBootstrap))
    ...
    xit("does not add a provideRouter import if it exits already", () => {
      return nru
        .insertImport(mainFile, "provideRouter", "@angular/router")
        .apply(NodeHost)
        .then(() =>
          nru.applyChanges(nru.bootstrapItem(mainFile, routes, toBootstrap))
        )
        .then(() => readFile(mainFile, "utf8"))
        .then((content) => {
          expect(content).toEqual(
  ...
  bootstrap(AppComponent, [ provideRouter(routes) ]);`
    ...
    xit("does not duplicate import to route.ts ", () => {
      let editedFile = new InsertChange(
        mainFile,
        100,
        `\nimport routes from './routes';`
      );
      ...
      return editedFile
        ...
        .catch((e) =>
          expect(e.message).toEqual(
            "Did not bootstrap provideRouter in" +
      ...
      return editedFile
        ...
        .then(() => {
          ...
          return nru.applyChanges(
            nru.addPathToRoutes(
              routesFile,
              _.merge({ route: "home/about/:id" }, options)
            )
          );
        })
        .then(() => readFile(routesFile, "utf8"))
      ...
      return editedFile
        ...
        .then(() => {
          ...
          return nru.applyChanges(
            nru.addPathToRoutes(
              routesFile,
              _.merge({ route: "home/about/details" }, options)
            )
          );
        })
        .then(() => readFile(routesFile, "utf8"))
    ...
    children: [
      ...
      return editedFile
        ...
        .then((content) => {
          // tslint:disable-next-line
          expect(content)
            .toEqual(`import { AboutComponent_1 } from './app/home/about/about.component';
export default [
  { path: 'main', component: MainComponent }
  { path: 'home', component: HomeComponent,
    children: [
    ...
    it("throws error if repeating child, mid", () => {
      ...
      return editedFile
        ...
        .then(() => {
          ...
          return nru.addPathToRoutes(
            routesFile,
            _.merge({ route: "home/about/" }, options)
          );
        })
        .catch((e) => {
          expect(e.message).toEqual(
    ...
    it("throws error if repeating child, deep", () => {
      ...
      return editedFile
        ...
        .then(() => {
          ...
          return nru.addPathToRoutes(
            routesFile,
            _.merge({ route: "home/about/more" }, options)
          );
        })
        .catch((e) => {
          expect(e.message).toEqual(
    ...
    it("does not report false repeat", () => {
      ...
      return editedFile
        ...
        .then(() => {
          ...
          options.component = "MoreComponent";
          return nru.applyChanges(
            nru.addPathToRoutes(routesFile, _.merge({ route: "more" }, options))
          );
        })
        .then(() => readFile(routesFile, "utf8"))
        .then((content) => {
      ...
      return editedFile
        ...
        .then(() => {
          ...
          return nru.applyChanges(
            nru.addPathToRoutes(
              routesFile,
              _.merge({ route: "home/trap-queen" }, options)
            )
          );
        })
        .then(() => readFile(routesFile, "utf8"))
      ...
      return editedFile
        ...
        .then(() => {
          ...
          return nru.applyChanges(
            nru.addPathToRoutes(
              routesFile,
              _.merge({ route: "home/home" }, options)
            )
          );
        })
        .then(() => readFile(routesFile, "utf8"))
...
import { DetailsComponent as DetailsComponent_1 } from './app/about/description/details.component;\n`
        ...
        .then(() => {
          ...
          expect(() =>
            nru.addPathToRoutes(
              routesFile,
              _.merge({ route: "about/details" }, options)
            )
          ).toThrowError();
        });
    });
    ...
    it("adds guard to parent route: addItemsToRouteProperties", () => {
      ...
      return editedFile
        ...
        .then(() => {
          ...
          return nru.applyChanges(
            nru.addItemsToRouteProperties(routesFile, toInsert)
          );
        })
        .then(() => readFile(routesFile, "utf8"))
        .then((content) => {
      ...
      return editedFile
        ...
        .then(() => {
          ...
          return nru.applyChanges(
            nru.addPathToRoutes(
              routesFile,
              _.merge({ route: "home/more" }, options)
            )
          );
        })
        .then(() => {
          return nru.applyChanges(
            nru.addItemsToRouteProperties(routesFile, {
...
export default [
  ...
  describe("validators", () => {
    ...
    it("accepts component name with 'component' suffix: resolveComponentPath", () => {
      let fileName = nru.resolveComponentPath(
        projectRoot,
        "src/app",
        "about.component"
      );
    ...
    it("finds component name: confirmComponentExport", () => {
      let exportExists = nru.confirmComponentExport(
        componentFile,
        "AboutComponent"
      );
