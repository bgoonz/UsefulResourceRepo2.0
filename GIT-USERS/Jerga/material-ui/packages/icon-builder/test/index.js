...
const MUI_ICONS_ROOT = path.join(
  __dirname,
  "./fixtures/material-design-icons/"
);
...
describe("--svg-dir, --innerPath, --fileSuffix", function () {
  ...
  it("script outputs to directory", function (done) {
    builder.main(options, function () {
      ...
      jsxExampleOutputPath = path.join(
        tempPath,
        "delapouite",
        "dice",
        "svg",
...
describe("Template rendering", function () {
  ...
  it("should produce the expected output", function (done) {
    builder.main(options, function () {
      ...
      exampleFilePath = path.join(
        MUI_ICONS_ROOT,
        "jsx/action/accessibility.jsx"
      );
