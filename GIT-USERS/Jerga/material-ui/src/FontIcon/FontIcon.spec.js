...
describe("<FontIcon />", () => {
  ...
  it("renders className", () => {
    ...
    assert.ok(
      wrapper.is(".muidocs-icon-action-home"),
  ...
  it("renders children and color", () => {
    ...
    assert.ok(wrapper.contains("home"), "should contain the children");
    assert.equal(
      wrapper.node.props.style.color,
      "red",
      "should have color set to red"
    );
  });
  ...
  it("renders children and hoverColor when mouseEnter", () => {
    ...
    assert.equal(
      wrapper.node.props.style.color,
      "green",
      "should have color set to green after hover"
    );
    assert.equal(
      onMouseEnter.calledOnce,
      true,
  ...
  it("renders children and call onMouseEnter callback", () => {
    const onMouseEnter = spy();
    const wrapper = shallowWithContext(
      <FontIcon className="material-icons" onMouseEnter={onMouseEnter}>
        home
      </FontIcon>
    );
  ...
  it("renders children and call onMouseLeave callback", () => {
    ...
    const wrapper = shallowWithContext(
      <FontIcon className="material-icons" onMouseLeave={onMouseLeave}>
        home
      </FontIcon>
    );
