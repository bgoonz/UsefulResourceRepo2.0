...
describe("<Checkbox />", () => {
  ...
  describe("props: defaultChecked", () => {
    it("should display checkmark when checked by default", () => {
      const wrapper = shallowWithContext(<Checkbox defaultChecked={true} />);
    ...
    describe("when initially unchecked", () => {
      ...
      beforeEach(() => {
        wrapper = mountWithContext(<Checkbox defaultChecked={false} />);
      });
