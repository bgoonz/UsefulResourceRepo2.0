...
describe("<GridTile />", () => {
  ...
  describe("prop: children", () => {
    it("should renders children by default", () => {
      ...
      const wrapper = shallowWithContext(<GridTile>{testChildren}</GridTile>);
  ...
  describe("prop: className", () => {
    it("should renders className", () => {
      const wrapper = shallowWithContext(<GridTile className="foo" />);
  ...
  describe("prop: title", () => {
    it("should renders title", () => {
      const wrapper = shallowWithContext(<GridTile title={tileData.title} />);
  ...
  describe("prop: titleStyle", () => {
    it("should overwrite styles", () => {
      ...
      assert.strictEqual(
        wrapper.find("div > div > div > div").props().style.fontSize,
        titleStyle.fontSize,
        "should overwrite title fontSize"
      );
    });
  });
});
