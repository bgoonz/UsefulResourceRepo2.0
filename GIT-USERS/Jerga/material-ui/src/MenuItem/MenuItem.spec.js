...
describe("<MenuItem />", () => {
  ...
  it("should pass hoverColor from the theme to the <ListItem />", () => {
    ...
    const muiThemeWithHoverColor = getMuiTheme({
      menuItem: { hoverColor: testColor },
    });
    const shallowWithHoverColor = (node) =>
      shallow(node, { context: { muiTheme: muiThemeWithHoverColor } });
