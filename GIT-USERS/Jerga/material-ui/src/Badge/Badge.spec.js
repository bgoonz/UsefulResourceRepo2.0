...
describe("<Badge />", () => {
  ...
  it("renders children and overwrite badge styles", () => {
    ...
    const wrapper = shallowWithContext(
      <Badge badgeContent={10} badgeStyle={badgeStyle}>
        {testChildren}
      </Badge>
    );
    ...
    assert.ok(wrapper.contains(testChildren), "should contain the children");
    assert.equal(
      wrapper.find("span").node.props.style.backgroundColor,
  ...
  it("renders children and have primary styles", () => {
    const wrapper = shallowWithContext(
      <Badge badgeContent={10} primary={true}>
        {testChildren}
      </Badge>
    );
    ...
    assert.equal(
      wrapper.find("span").node.props.style.backgroundColor,
      badgeTheme.primaryColor,
      "should have primary badge backgroundColor"
    );
    assert.equal(
      wrapper.find("span").node.props.style.color,
      badgeTheme.primaryTextColor,
      "should have primary badge text color"
    );
  });
  ...
  it("renders children and have secondary styles", () => {
    ...
    assert.equal(
      wrapper.find("span").node.props.style.backgroundColor,
      badgeTheme.secondaryColor,
      "should have secondary badge backgroundColor"
    );
    assert.equal(
      wrapper.find("span").node.props.style.color,
      badgeTheme.secondaryTextColor,
      "should have secondary badge text color"
    );
  });
