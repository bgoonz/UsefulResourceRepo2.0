...
class CardTitle extends Component {
  ...
  render() {
    ...
    const extendedSubtitleStyle = Object.assign(
      {},
      styles.subtitle,
      subtitleStyle
    );
    ...
    return (
      <div {...other} style={prepareStyles(rootStyle)}>
        <span style={prepareStyles(extendedTitleStyle)}>{title}</span>
        <span style={prepareStyles(extendedSubtitleStyle)}>{subtitle}</span>
        {children}
      </div>
    );
  }
