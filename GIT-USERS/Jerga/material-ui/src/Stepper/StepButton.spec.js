...
describe("<StepButton />", () => {
  ...
  it("should render an EnhancedButton with a StepLabel", () => {
    const wrapper = themedShallow(<StepButton>Step One</StepButton>);
  ...
  it("should pass iconContainerStyle to StepLabel", () => {
    ...
    const iconContainerStyle = wrapper
      .find(StepLabel)
  ...
  describe("event handlers", () => {
    describe("handleMouseEnter/Leave", () => {
      ...
      it("should set the hovered state", () => {
        ...
        assert.strictEqual(
          handleMouseEnter.callCount,
          1,
          "should call handleMouseEnter once"
        );
        ...
        assert.strictEqual(
          handleMouseLeave.callCount,
          1,
          "should call handleMouseLeave once"
        );
      });
      ...
      it("should set the EnhancedButton backgroundColor on hover", () => {
        ...
        assert.strictEqual(
          ...
          muiTheme.stepper.backgroundColor
        );
        wrapper.setState({ hovered: true });
        assert.strictEqual(
          wrapper.prop("style").backgroundColor,
          muiTheme.stepper.hoverBackgroundColor
        );
      });
    });
    ...
    describe("handleTouchStart", () => {
      ...
      it("should set the touched state", () => {
        ...
        assert.strictEqual(
          handleTouchStart.callCount,
          1,
          "should call handleTouchStart once"
        );
      });
    ...
    it("should bubble callbacks used internally", () => {
      ...
      assert.strictEqual(
        handleMouseEnter.callCount,
        2,
        "should call handleMouseEnter twice"
      );
      assert.strictEqual(
        handleMouseLeave.callCount,
        1,
      ...
      assert.strictEqual(
        handleTouchStart.callCount,
        2,
        "should call handleTouchStart twice"
      );
    });
  });
});
