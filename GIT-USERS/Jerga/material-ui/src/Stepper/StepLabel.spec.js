...
describe("<StepLabel />", () => {
  ...
  describe("label content", () => {
    ...
    it("renders the custom icon", () => {
      ...
      assert.strictEqual(
        wrapper.find(".my-icon").length,
        1,
        "should have the custom icon"
      );
    });
  });
  ...
  describe("prop: completed = true", () => {
    ...
    it("renders a check circle with the standard coloring", () => {
      const wrapper = shallowWithContext(
        <StepLabel completed={true} icon={1}>
          Step One
        </StepLabel>
      );
      assert.strictEqual(
  ...
  describe("prop combinations", () => {
    ...
    it("renders with disabled styling when disabled", () => {
      const wrapper = shallowWithContext(
        <StepLabel icon={1} disabled={true}>
          Step One
        </StepLabel>
      );
      assert.strictEqual(
    ...
    it("renders with a check icon and active styling when completed", () => {
      const wrapper = shallowWithContext(
        <StepLabel icon={1} completed={true}>
          Step One
        </StepLabel>
      );
      assert.strictEqual(
    ...
    it("renders with a check icon and disabled when disabled and completed", () => {
      const wrapper = shallowWithContext(
        <StepLabel icon={1} disabled={true} completed={true}>
          Step One
        </StepLabel>
      );
      assert.strictEqual(
