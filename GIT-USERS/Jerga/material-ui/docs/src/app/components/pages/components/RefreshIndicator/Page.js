...
const descriptions = {
  ready:
    "The `ready` status can be used in response to a pull-to-refresh action, with the `percentage` tracking " +
  ...
  loading:
    "The `loading` status displays an indeterminate indicator, intended to to be used while content is " +
