...
const descriptions = {
  avatar:
    "A `Card` containing each of the card components: `CardHeader` (with avatar), `CardMedia` (with overlay), " +
    "`CardTitle`, `CardText` & `CardActions`.",
  simple:
    "An expandable `Card` with `CardHeader`, `CardText` and `CardActions`. " +
    "Use the icon to expand the card.",
  controlled:
    "A controlled expandable `Card`. Use the icon, the toggle or the " +
...
const CardPage = () => (
  <div>
    ...
    <PropTypeDescription
      code={cardActionsCode}
      header="### CardActions properties"
    />
    <PropTypeDescription
      code={cardHeaderCode}
      header="### CardHeader properties"
    />
    <PropTypeDescription
      code={cardMediaCode}
      header="### CardMedia properties"
    />
    <PropTypeDescription code={cardTextCode} header="### CardText properties" />
    <PropTypeDescription
      code={cardTitleCode}
      header="### CardTitle properties"
    />
  </div>
);
