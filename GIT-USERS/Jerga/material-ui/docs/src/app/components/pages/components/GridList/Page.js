...
const GridListPage = () => (
  <div>
    ...
    <CodeExample title="Simple example" code={gridListExampleSimpleCode}>
      <GridListExampleSimple />
    </CodeExample>
    <CodeExample title="Complex example" code={gridListExampleComplexCode}>
      <GridListExampleComplex />
    </CodeExample>
    <CodeExample title="One line example" code={gridListExampleSingleLineCode}>
