      ...
      <FullWidthSection style={styles.root}>
        ...
        <div style={styles.tagline}>
          ...
          <h2 style={styles.h2}>
            ...
            <span style={styles.nowrap}>Google&apos;s Material Design</span>
          </h2>
          <RaisedButton
  ...
  homePurpose() {
    ...
    return (
      ...
      >
        ...
        <a href="https://www.call-em-all.com/Careers">Call-Em-All</a> and plan
        on adding to it and making it better in the coming months.
      </FullWidthSection>
    );
  }
