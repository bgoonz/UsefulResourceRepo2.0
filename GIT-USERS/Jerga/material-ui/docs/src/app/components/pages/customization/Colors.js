...
class ColorsPage extends Component {
  ...
  getStyles() {
    ...
    if (this.props.width === LARGE) {
      styles.colorGroup = Object.assign(
        styles.colorGroup,
    ...
    return (
      <ul style={colorGroupStyle}>
        {React.Children.toArray(
          this.getColorBlock(styles, cssColor, 500, color)
        )}
  ...
  getColorBlock(styles, colorName, colorValue, colorTitle) {
    ...
    if (colorTitle) {
      blockTitle = <span style={styles.name}>{colorTitle}</span>;
    }
    ...
    return (
      <div>
        ...
        <p>
          ...
          <a href="https://www.google.com/design/spec/style/color.html#color-ui-color-palette">
            UI Color Palette
          </a>
          . They are stored in{" "}
          <a href="https://github.com/callemall/material-ui/blob/master/src/styles/colors.js">
            styles/colors.js
          </a>
          .
        </p>
        <ClearFix>
          ...
          <div>{React.Children.toArray(neutralGroups)}</div>
        </ClearFix>
      </div>
    );
  }
