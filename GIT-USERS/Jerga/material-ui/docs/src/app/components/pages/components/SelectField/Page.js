...
const SelectFieldPage = () => (
  <div>
    ...
    <CodeExample title="Simple examples" code={selectFieldExampleSimpleCode}>
      <SelectFieldExampleSimple />
    </CodeExample>
    <CodeExample title="Nullable select" code={SelectFieldExampleNullableCode}>
      <SelectFieldExampleNullable />
    </CodeExample>
    <CodeExample title="Long example" code={selectFieldLongMenuExampleCode}>
      <SelectFieldLongMenuExample />
    </CodeExample>
    <CodeExample title="Label example" code={selectFieldExampleCustomLabelCode}>
    ...
    <CodeExample title="ErrorText example" code={selectFieldExampleErrorCode}>
