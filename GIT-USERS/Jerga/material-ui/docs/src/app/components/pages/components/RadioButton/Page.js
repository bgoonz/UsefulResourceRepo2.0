...
const description =
  "The second button is selected by default using the `defaultSelected` property of " +
...
const RadioButtonPage = () => (
  <div>
    ...
    <PropTypeDescription
      header="### RadioButton Properties"
      code={radioButtonCode}
    />
    <PropTypeDescription
      header="### RadioButtonGroup Properties"
      code={radioButtonGroupCode}
    />
  </div>
);
