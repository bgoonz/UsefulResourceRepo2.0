...
const SliderPage = () => (
  <div>
    ...
    <CodeExample title="Simple examples" code={sliderExampleSimpleCode}>
      <SliderExampleSimple />
    </CodeExample>
    <CodeExample title="Disabled examples" code={sliderExampleDisabledCode}>
      <SliderExampleDisabled />
    </CodeExample>
    <CodeExample title="Stepped example" code={sliderExampleStepCode}>
      <SliderExampleStep />
    </CodeExample>
    <CodeExample title="Controlled Examples" code={sliderExampleControlledCode}>
      <SliderExampleControlled />
    </CodeExample>
    <CodeExample title="Alternative Axis Examples" code={sliderExampleAxisCode}>
      <SliderExampleAxis />
    </CodeExample>
