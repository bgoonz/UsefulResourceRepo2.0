...
module.exports = function createRouter(
  ...
  if (process.env.NODE_ENV === "production") {
    ...
    router.get(
      "*",
      serverSideRendering(indexFile, (req, res) => res.sendFile(indexPath))
    );
    ...
    const loadAndCacheFile = (requestedPath) => {
      ...
      if (!devMiddleware.fileSystem.existsSync(filePath)) {
        ...
        devMiddleware.fileSystem.writeFileSync(
          filePath,
    ...
    router.get(
      "*",
      serverSideRendering(loadAndCacheFile(indexPath), (req, res) => {
