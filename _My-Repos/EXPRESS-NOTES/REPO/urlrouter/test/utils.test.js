      ...
      var cases = [
        ...
        [
          ...
          [
            ...
            ["/user/mk2", { id: "mk2" }],
            [
              "/user/mk2.123@$qwe,.xml-_hdhd",
              { id: "mk2.123@$qwe,.xml-_hdhd" },
            ],
            ["/user/中文", { id: "中文" }],
        ...
        [
          ...
          [
            ...
            [
              "/user/mk-2005_bac/status/783972",
              { name: "mk-2005_bac", id: "783972" },
            ],
          ],
        ...
        [
          "/files/*",
          ["/files/jquery.js", "/files/javascripts/jquery.js"],
          ["/files/", "/files"],
        ],
        [
          "/files/*.*",
        ...
        [
          ...
          [
            ["/user/1", { id: "1" }],
            ["/user/1/edit", { id: "1", operation: "edit" }],
          ],
        ],
        [
          "/products.:format",
