    ...
    describe("when disabled", function () {
      before(function () {
        ...
        this.server = createServer(
          setup,
          { proxy: false, cookie: { secure: true } },
          respond
        );
      });
  ...
  describe("cookie option", function () {
    describe('when "path" set to "/foo/bar"', function () {
      ...
      describe('when mounted at "/foo"', function () {
        before(function () {
          this.server = createServer(mountAt("/foo"), {
            cookie: { path: "/foo/bar" },
          });
        });
      ...
      describe(".*", function () {
        ...
        it("should preserve cookies set before writeHead is called", function (done) {
          var server = createServer(null, function (req, res) {
            ...
            res.setHeader(
              "Set-Cookie",
              cookie.serialize("previous", "cookieValue")
            );
            res.end();
          });
