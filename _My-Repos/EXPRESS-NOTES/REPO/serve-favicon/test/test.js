...
describe("favicon()", function () {
  describe("arguments", function () {
    describe("path", function () {
      ...
      it("should accept file path", function () {
        assert.doesNotThrow(
          favicon.bind(null, path.join(FIXTURES_PATH, "favicon.ico"))
        );
      });
      ...
      it("should exist", function () {
        assert.throws(
          favicon.bind(null, path.join(FIXTURES_PATH, "nothing")),
          /ENOENT.*nothing/
        );
      });
  ...
  describe("requests", function () {
    ...
    it("should ignore non-favicon requests", function (done) {
      request(this.server).get("/").expect(404, "oops", done);
    });
  ...
  describe("icon", function () {
    describe("file", function () {
      ...
      it("should be read on first request", function (done) {
        ...
        request(server).get("/favicon.ico").expect(200, icon.data, done);
      });
