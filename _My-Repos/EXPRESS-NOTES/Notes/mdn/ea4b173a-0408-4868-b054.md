...
### [Validation and sanitization](https://developer.mozilla.org/en-US/docs/Learn/Server-side/Express_Nodejs/forms#validation_and_sanitization "Permalink to Validation and sanitization")
