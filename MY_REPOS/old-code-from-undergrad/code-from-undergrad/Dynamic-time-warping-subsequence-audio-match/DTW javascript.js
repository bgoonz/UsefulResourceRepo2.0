...
module.exports = DTW;
VM439: 5 Uncaught ReferenceError: require is not defined
at < anonymous >: 5: 13( anonymous ) @ VM439: 5
var DTW = require( 'dtw' );
var s = [ 1, 1, 2, 3, 2, 0 ];
var t = [ 0, 1, 1, 2, 3, 2, 1 ];
var dtw = new DTW();
...
console.log( 'Path: ' );
console.log( path );
VM443: 1 Uncaught ReferenceError: require is not defined
at < anonymous >: 1: 11( anonymous ) @ VM443: 1
