  ...
  [1],
  {
      ...
      (e.__esModule = !0),
        (e.formatUrl = function (t) {
          ...
          return (
            ...
            (f = f.replace("#", "%23")),
            "".concat(a).concat(s).concat(i).concat(f).concat(u)
          );
        });
      var n = r("prCu"),
    ...
    L9lV: function (t, e, r) {
      ...
      (e.__esModule = !0),
        ...
        (e.default = void 0);
      var c,
        s = (c = r("YBsB")) && c.__esModule ? c : { default: c },
        f = r("fvxO"),
        l = r("Lko9"),
        h = r("TBBy"),
        p = r("uChv"),
      ...
      function x(t, e, r) {
        return { url: b(_(t.pathname, e)), as: r ? b(_(t.pathname, r)) : r };
      }
      function S(t) {
        try {
        ...
        function t(e, r, n, o) {
          ...
          i(this, t),
            ...
            (this.onPopState = function (t) {
              if (t.state) {
                var e = t.state,
                  ...
                  o = e.options;
                if (e.__N) {
                  var i = (0, d.parseRelativeUrl)(r).pathname;
                ...
                a.changeState(
                  "replaceState",
                  (0, f.formatWithValidation)({ pathname: b(u), query: c }),
                  (0, f.getURL)()
                );
              }
            }),
            ...
            "//" !== n.substr(0, 2) &&
              this.changeState(
                "replaceState",
                (0, f.formatWithValidation)({ pathname: b(e), query: r }),
                (0, f.getURL)()
              ),
                ...
                value: (function () {
                  var e = a(
                    o.mark(function e(r, n, a, i) {
                      var u, c, s, m, g, b, _, x, P, k, R, E, C, O;
                      return o.wrap(
                        function (e) {
                          for (;;)
                            switch ((e.prev = e.next)) {
                              ...
                              case 16:
                                if (
                                  ...
                                  (s = s
                                    ? (0, y.removePathTrailingSlash)(w(s))
                                    : s),
                                  this.urlIsNew(u) || (r = "replaceState"),
                                  (b = (0, y.removePathTrailingSlash)(s)),
                                  (_ = i.shallow),
                                  (x = void 0 !== _ && _),
                                ...
                                if (
                                  ...
                                  (k = P.pathname),
                                  (R = (0, p.getRouteRegex)(b)),
                                  (E = (0, h.getRouteMatcher)(R)(k)))
                                ) {
                                  e.next = 33;
                                  break;
                                }
                              ...
                              case 45:
                                ...
                                throw (
                                  (t.events.emit("routeChangeError", O, u), O)
                                );
                              case 48:
                                return (
              ...
              },
              {
                ...
                value: function (t) {
                  ...
                  return this.sdc[r]
                    ...
                    : P(t, this.isSsr).then(function (t) {
                        return (e.sdc[r] = t), t;
                      });
                },
              },
