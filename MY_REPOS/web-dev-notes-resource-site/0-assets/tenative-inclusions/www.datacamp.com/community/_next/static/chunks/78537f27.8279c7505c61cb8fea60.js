      ...
      !(function (t, n) {
        ...
        function be(e, t, n, r, i) {
          ...
          for (f.textContent = "", d = 0; (o = p[d++]); )
            if (r && C.inArray(o, r) > -1) i && i.push(o);
              ...
              ((l = ae(o)), (a = ye(f.appendChild(o), "script")), l && me(a), n)
            )
          ...
          special: {
            ...
            click: {
              ...
              trigger: function (e) {
                var t = this || e;
                return (
                  de.test(t.type) && t.click && D(t, "input") && Ne(t, "click"),
                  !0
                );
              },
              _default: function (e) {
        ...
        function Me(e, t, n, r) {
          ...
          if (
            ...
            for (s = (a = C.map(ye(i, "script"), He)).length; f < p; f++)
              (l = i),
                f !== d &&
                  ((l = C.clone(l, !0, !0)), s && C.merge(a, ye(l, "script"))),
                n.call(e[f], l, f);
            if (s)
              for (
        ...
        C.extend({
          ...
          clone: function (e, t, n) {
            ...
            return (
              (a = ye(s, "script")).length > 0 && me(a, !u && ye(e, "script")),
              s
            );
          },
        ...
        C.extend(C.event, {
          trigger: function (e, t, r, i) {
            ...
            if (
              ...
              if (!i && !f.noBubble && !m(r)) {
                for (
                  u = f.delegateType || g, bt.test(u + g) || (a = a.parentNode);
                  a;
                  a = a.parentNode
                )
                  h.push(a), (s = a);
        ...
        C.ajaxSetup({
          ...
          C.each(["top", "left"], function (e, t) {
            C.cssHooks[t] = ze(v.pixelPosition, function (e, n) {
              if (n)
                return (
                  (n = _e(e, t)), We.test(n) ? C(e).position()[t] + "px" : n
                );
            });
          }),
        ...
        return (
          (C.noConflict = function (e) {
            return (
              n.$ === C && (n.$ = Yt), e && n.jQuery === C && (n.jQuery = Gt), C
            );
          }),
          "undefined" === typeof i && (n.jQuery = n.$ = C),
          C
        );
      });
    },
