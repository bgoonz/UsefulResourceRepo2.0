...
Here's a screenshot of `traceroute .io` from my terminal:
...
`.io` resolves to more than one IP address. This is common for popular
...
Because of load balancing, your connection to `.io` isn't guaranteed
to be the same each time. Try running `traceroute .io` again - do you
