...
(function (global) {
  ...
  function createPat(_) {
    ...
    function isOption(x) {
      x = x || {};
      return typeof x.isSome === "function";
    }
    ...
    function matchFirstArguments(pattern, args) {
      ...
      var lengthOk = lengthMustMatch
        ? pattern.args.length === args.length
        : true;
      ...
      if (!lengthOk) {
        ...
        var matchResults = _.map(
          _.zip(pattern.args, patternArgs),
          function (zipped) {
            var patt = zipped[0],
              arg = zipped[1];
  ...
  (function () {
    ...
    if (typeof module !== "undefined" && module !== null) {
      ...
      // window.pat
      if (typeof global._ !== "undefined" && global._ !== null) {
        global.pat = createPat(global._);
      }
    }
  })();
})(this);
