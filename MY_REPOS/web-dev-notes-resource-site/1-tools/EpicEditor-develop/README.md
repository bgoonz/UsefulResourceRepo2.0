      ...
      <body>
        <div id="epiceditor-wrapper">
            ...
            <html>
              <head>
                <link
                  type="text/css"
                  rel="stylesheet"
                  href="epiceditor/themes/editor/epic-dark.css"
                  media="screen"
                />
              </head>
            ...
            <html>
              <head>
                <link
                  type="text/css"
                  rel="stylesheet"
                  href="epiceditor/themes/preview/github.css"
                  media="screen"
                />
              </head>
              <body>
          ...
          <div id="epiceditor-utilbar">
            <img
              width="16"
              src="epiceditor/images/preview.png"
              class="epiceditor-toggle-btn"
            />
            <img
              width="16"
              src="epiceditor/images/fullscreen.png"
              class="epiceditor-fullscreen-btn"
            />
          </div>
        </div>
      </body>
