...
$(function () {
  ...
  $("#wrapper").before(
    '<div id="toc"><h2><a href="#">EpicEditor</a></h2><ul id="toc-list"></ul></div>'
  );
  ...
  $("#why").before(
    '<h2 id="download">Download</h2><p class="btn"><a class="zip" href="' +
      zipUrl +
      '">EpicEditor v' +
      EpicEditor.version +
      "</a></p>"
  ...
  $("#quick-start").before(
    '<p class="btn btn-small"><a id="try-it">Try it!</a></p><div id="epiceditor"></div>'
  );
  $("#an-embeddable-javascript-markdown-editor + p").after(
    '<div class="epiceditors" id="example-1"></div>'
  );
  $("#step-1-download + p").html(
    '<a href="#download">Download the latest release (' +
      EpicEditor.version +
      ")</a> or clone the repo:"
  );
  ...
  $(["OscarGodson", "johnmdonahue", "adam_bickford", "sebnitu"]).each(function (
    idx,
    val
  ) {
    ...
    $("#avatars").append(
      '<a href="' + twlink + '"><img class="avatar" src="' + twimg + '">'
    );
  });
