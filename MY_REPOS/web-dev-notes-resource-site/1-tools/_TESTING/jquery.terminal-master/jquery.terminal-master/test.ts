...
(function () {
  ...
  // :: login
  // -------------------------------------------------------------------------
  term.login(function (username, password, callback) {}).clear();
  term.login(function (username, password) {}).clear();
  term
    .login(
  ...
  term.echo(Promise.resolve(["foo"]));
  term.echo(
    Promise.resolve(function (): string {
      return "foo";
    })
  );
  term.echo(
