...
declare namespace JQueryTerminal {
  ...
  type terminalObjectFunction = (
    ...args: (string | number | RegExp)[]
  ) => void | TypeOrPromise<echoValue>;
  ...
  type LessArgument =
    | string
    | ((cols: number, cb: (text: string) => void) => void)
    | string[];
  ...
  type FormatterFunction = ((
    ...
    FormatterFunctionPropsInterface;
  ...
  type Formatter =
    | [RegExp, FormaterRegExpReplacement]
    | [RegExp, FormaterRegExpReplacement, FormatterArrayOptions]
    | FormatterFunction;
  type keymapFunctionOptionalArg = (
    event: JQueryKeyEventObject,
    original?: keymapFunction
  ) => any;

  type keymapFunction<T = JQueryTerminal> = (
    this: T,
    event: JQueryKeyEventObject,
    original: keymapFunctionOptionalArg
  ) => any;
  ...
  type greetingsArg =
    | ((
        this: JQueryTerminal,
        setGreeting: setEchoValueFunction
      ) => void | TypeOrPromise<JQueryTerminal.echoValue>)
    | string
    | null;
  type cmdPrompt<T = Cmd> =
    | ((this: Cmd, setPrompt: setStringFunction) => void)
    | string;

  type ExtendedPrompt =
    | ((
        this: JQueryTerminal,
        setPrompt: setStringFunction
      ) => void | PromiseLike<string>)
    | string;
  ...
  type KeyEventHandler<T = JQueryTerminal> = (
    this: T,
    event: JQueryKeyEventObject
  ) => boolean | void;
  ...
  type ExceptionHandler = (
    this: JQueryTerminal,
    e: Error | TerminalException,
    label: string
  ) => void;
  type processRPCResponseFunction = (
    this: JQueryTerminal,
    result: JSONObject,
    term: JQueryTerminal
  ) => void;
  ...
  type PushPopCallback = (
    this: JQueryTerminal,
    before: JQueryTerminal.InterpreterItem,
    after: JQueryTerminal.InterpreterItem,
    term: JQueryTerminal
  ) => void;
...
interface JQuery<TElement = HTMLElement> {
  ...
  // plugins
  less(
    text: JQueryTerminal.LessArgument,
    options?: {
      formatters?: boolean;
      wrap?: boolean;
      keepWords?: boolean;
...
interface JQueryStatic {
  ...
  jrpc(
    ...
    method: string,
    params: any[],
    success?: (json: JSONObject, status: string, jqxhr: JQuery.jqXHR) => void,
    error?: (jqxhr: JQuery.jqXHR, status: string) => void
  ): void;
...
interface JQueryTerminalStatic {
  ...
  tracking_replace(
    str: string,
    rex: RegExp,
    replacement: string | JQueryTerminal.RegExpReplacementFunction,
    position: number
  ): [string, number];
  ...
  pipe(
    obj: JQueryTerminal.ObjectInterpreter
...
type TerminalOptions = {
  ...
  renderHandler?: (
    ...
    term: JQueryTerminal
  ) => void | string | Element | JQuery<Element> | false;
  onAjaxError?: (
    this: JQueryTerminal,
    xhr: JQuery.jqXHR,
    status: string,
  ...
  onPaste?: (
    this: JQueryTerminal,
    value: string
  ) => TypeOrPromise<string | Blob> | void;
  onCommandChange?: (
    this: JQueryTerminal,
    command: string,
    term: JQueryTerminal
  ...
  onBeforeEcho?: (
    this: JQueryTerminal,
    value: JQueryTerminal.echoValue
  ) => boolean | void;
...
interface JQueryTerminal<TElement = HTMLElement> extends JQuery<TElement> {
  ...
  // be created by user
  login(
    auth: JQueryTerminal.LoginFunction,
    infinite?: boolean,
    success?: () => void,
    error?: () => void
  ): JQueryTerminal;
  ...
  complete(
    commands: string[],
    options?: JQueryTerminal.CompleteOptions
  ): boolean;
  ...
  update(
    line: number,
    str: string,
    options?: JQueryTerminal.EchoOptions
  ): JQueryTerminal;
  // options for remove_line is useless but that's how API look like
  remove_line(line: number): JQueryTerminal;
  last_index(): number;
  echo<TValue = JQueryTerminal.echoValue>(
    arg: TypeOrPromise<TValue>,
    options?: JQueryTerminal.EchoOptions
  ): JQueryTerminal;
  error(
    arg: JQueryTerminal.errorArgument,
    options?: JQueryTerminal.EchoOptions
  ): JQueryTerminal;
  ...
  push(
    interpreter: TypeOrArray<JQueryTerminal.Interpreter>,
    options?: JQueryTerminal.pushOptions
  ): JQueryTerminal;
  ...
  keymap(
    shortcut: string,
    callback: JQueryTerminal.keymapFunction
  ): JQueryTerminal;
  keymap(shortcut: string): JQueryTerminal.keymapFunctionOptionalArg;
