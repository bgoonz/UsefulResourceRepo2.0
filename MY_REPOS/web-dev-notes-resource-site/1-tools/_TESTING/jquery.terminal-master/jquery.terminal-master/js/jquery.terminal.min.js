...
(function (r, i) {
  var n = typeof window !== "undefined" ? window : self || global;
  ...
  $.fn.cmd = function (e) {
    ...
    var U;
    var W = {
      "ALT+D": K({ clipboard: true }),
      "HOLD+ALT+D": K({ clipboard: true, hold: true }),
      "HOLD+DELETE": K({ clipboard: false, hold: true }),
      "HOLD+SHIFT+DELETE": K({ clipboard: false, hold: true }),
      ENTER: function () {
        if (
          _ &&
          S &&
          !x.mask &&
          ((is_function(x.historyFilter) && x.historyFilter(S)) ||
            (x.historyFilter instanceof RegExp && S.match(x.historyFilter)) ||
            !x.historyFilter)
        ) {
          _.append(S);
        }
      ...
      "SHIFT+INSERT": Y,
      "CTRL+SHIFT+T": Q,
      "CTRL+W": J({ clipboard: true, hold: false }),
      "HOLD+BACKSPACE": J({ clipboard: false, hold: true }),
      "HOLD+SHIFT+BACKSPACE": J({ clipboard: false, hold: true }),
      "CTRL+H": function () {
        if (S !== "" && R > 0) {
          k["delete"](-1);
        }
    ...
    function Fe(e, t) {
      var n = $.terminal.encode(Ee(e), { tabs: x.tabs, before: t });
      ...
      return function () {
        ...
        if (xe(t)) {
          ...
          if (o === 0 && a.length === 1) {
            ...
            y(a[0], { length: a.length, position: n, prompt: T });
            E(a.slice(1));
          } else if (n === o) {
            C.before(b(a[0], T));
            y(a[1] || "", {
            ...
            if (f <= c) {
              ...
              y(s, { length: a.length, position: D, last: true });
            } else {
              var p;
              var m;
              D = n;
    ...
    var Se = (function () {
      function t(e) {
        ...
        var n = { char_width: x.char_width };
        T = t[t.length - 1];
        var r = $.terminal.encode(t[t.length - 1], { tabs: x.tabs });
        ...
        var u = t
          ...
          .map(function (e) {
            ...
            return (
              '<span class="cmd-line">' + $.terminal.format(e, n) + "</span>"
            );
          })
          .concat([i])
          .join("\n");
    ...
    function Ze(e) {
      ...
      try {
        if (!e.fake) {
          Ie = Ye(e);
          ze = String(e.key).toLowerCase() === "unidentified";
          Me = Qe(e);
        }
      } catch (e) {}
    ...
    function ut() {
      ...
      if ((Ne || He || ((Pe || Le) && !We && (Ie || ze) && !Me)) && e !== S) {
        var t = R;
        if (Ne) {
          var n = Ke;
  ...
  function process_command(e, t) {
    ...
    if (n.length) {
      ...
      return { command: e, name: r, args: i, args_quotes: u, rest: a };
    } else {
  ...
  $.terminal = {
    ...
    iterate_formatting: function e(t, n) {
      ...
      function l() {
        var e = s(w);
        if (e.length > 1 && $.terminal.length(w) > 1) {
          return e.length - 1;
        }
        return 0;
      }
      function f() {
        return r(E) && (x || k) && ((g === -1 && C !== E) || g !== -1);
      }
      var c = false;
      function D() {
        if (E === t.length - 1 && !c) {
    ...
    format: function i(e, t) {
      ...
      function i(e, t, n, r, i, u, a) {
        ...
        if ($.terminal.valid_color(n)) {
          f +=
            ["color:" + n, "--color:" + n, "--original-color:" + n].join(";") +
            ";";
          if (t.indexOf("!") !== -1) {
            f += "--link-color:" + n + ";";
          }
  ...
  $.fn.terminal = function (e, t) {
      ...
      return function (e, t) {
        ...
        if (i === "function") {
          if (o && r.length !== n.args.length) {
            ne.error(
              "&#91;Arity&#93; " +
                sprintf(te().wrongArity, n.name, r.length, n.args.length)
            );
          } else {
            ...
            if ($.isPlainObject(i) && typeof i.name === "string") {
              t[i.name] = function () {
                ...
                if (ke.checkArity && i.params && i.params.length !== n) {
                  ne.error(
                    "&#91;Arity&#93; " +
                      sprintf(te().wrongArity, i.name, i.params.length, n)
                  );
                } else {
                  ne.pause(ke.softPause);
                  if (e) {
    ...
    function l(t, a, n) {
      ...
      if (e === "array") {
        ...
        n({ interpreter: d(t, ke.checkArity, a), completion: Object.keys(t) });
      } else {
        if (e === "undefined") {
          t = $.noop;
        } else if (e !== "function") {
    ...
    function F(e, t, n) {
      ...
      function o(e, t) {
        ...
        var r = { line: $.terminal.format(e, u), newline: t };
        if (a) {
          b.set(n, r);
        }
        return r;
      ...
      C.push({ finalize: n.finalize, index: t });
    }
    function E(e) {
    ...
    function w(e, t) {
      return (
        ...
        ((ke.wrap === true && t.wrap === undefined) ||
          (ke.wrap === false && t.wrap === true))
      );
    }
    var x;
    if ("Map" in root) {
          ...
          if (!n.raw) {
            ...
            if (n.exec) {
              ...
              e = $.map(i, function (e) {
                if (
                  e &&
                  e.match(format_exec_re) &&
                  !$.terminal.is_formatting(e)
                ) {
                  e = e.replace(/^\[\[|\]\]$/g, "");
                  if (n.exec) {
                    var t = e.trim();
            ...
            e = $.terminal.encode(e, { tabs: ke.tabs });
            var u;
    ...
    function T() {
      if (ke.greetings === undefined) {
        ne.echo(ne.signature, { finalize: a11y_hide, formatters: false });
    ...
    function R() {
      return We.outerWidth() !== ne.outerWidth();
    }
    function j(e) {
    ...
    function z(n, e, t) {
      ...
      try {
        ...
        if (!Y()) {
          if (
            t &&
            ((is_function(ke.historyFilter) && ke.historyFilter(n)) ||
              n.match(ke.historyFilter))
          ) {
            ze.history().append(n);
          }
        }
    ...
    var V = {
      ...
      TAB: function (e, t) {
        ...
        if (
          ke.completion &&
          get_type(ke.completion) !== "boolean" &&
    ...
    if (this.length > 1) {
      return this.each(function () {
        $.fn.terminal.call($(this), e, $.extend({ name: ne.selector }, t));
      });
    }
    var re;
    if (ne.is("body,html")) {
      ...
      $.omap(
        {
            ...
            ne.push(
              function (n) {
                ne.set_mask(ke.maskChar).push(
                  ...
                  { prompt: te().password + ": ", name: "password" }
                );
              },
              { prompt: te().login + ": ", name: "login" }
            );
            return ne;
          },
          settings: function () {
          ...
          pause: function (t) {
            Ce(function e() {
              Ee();
              Le = true;
              ze.disable(t || is_android);
              if (!t) {
                ze.find(".cmd-prompt").hidden();
              }
              U("onPause");
            });
            return ne;
          ...
          get_prompt: function () {
            return Pe.top().prompt;
          },
          set_mask: function (t) {
            _e(function e() {
              ze.mask(t === true ? ke.maskChar : t);
            });
            return ne;
          },
          ...
          resize: function (e, t) {
            if (!ne.is(":visible")) {
              ...
              t = ne.height();
              if (
                typeof ke.numChars !== "undefined" ||
                typeof ke.numRows !== "undefined"
              ) {
                ze.resize(ke.numChars);
                ne.refresh();
                U("onResize");
                return;
              }
            ...
            _e(function e() {
              ...
              if (!Se[r]) {
                ...
                unpromise(t, function (e) {
                  ...
                  var n = k({ value: e, index: r, options: Se[r][1] });
                  unpromise(n, function () {
                    ne.flush({ scroll: false, update: true });
                  });
                });
              }
            });
            ...
            function t(r) {
              try {
                ...
                unpromise(e, function (e) {
                  ...
                  var t = k({ value: e, options: i, index: Se.length });
                  if (t && t.then) {
                    var n = new DelayQueue();
                    ae = ee(n);
                  }
                  Se.push([e, $.extend({ exec: false }, i)]);
              ...
              l(a, o.login, function (e) {
                ...
                if (r.completion === true) {
                  if ($.isArray(e.completion)) {
                    Pe.top().completion = e.completion;
                  } else if (!e.completion) {
                    Pe.top().completion = false;
                  }
                }
                if (r.login) {
                  var t;
          ...
          keymap: function (e, n) {
            ...
            if (typeof n === "undefined") {
              if (typeof e === "string") {
                ...
                ze.keymap(null).keymap(e);
              }
            } else if (typeof n === "function") {
              var r = e;
              if (!tt[r]) {
                ze.keymap(r, n.bind(ne));
              } else {
                ze.keymap(r, function (e, t) {
    ...
    var ke = $.extend(
      {},
      $.terminal.defaults,
      { name: ne.selector, exit: !!((t && t.login) || !t) },
      t || {}
    );
    ...
    var qe = $('<div class="terminal-wrapper"/>').appendTo(ne);
    $(broken_image).hide().appendTo(qe);
    var Ue = $('<div class="terminal-font">&nbsp;</div>').appendTo(ne);
    var We = $('<div class="terminal-fill"/>').appendTo(ne);
    fe = $("<div>")
      .addClass("terminal-output")
      .attr("role", "log")
      .appendTo(qe);
    ne.addClass("terminal");
    if (ke.login && U("onBeforeLogin") === false) {
      Ie = false;
    }
    var Ke;
    if (typeof e === "string") {
    ...
    l(e, ke.login, function (e) {
      if (
        (ke.completion && typeof ke.completion !== "boolean") ||
        !ke.completion
      ) {
      ...
      ne.oneTime(100, function () {
        $(document)
          .bind("click.terminal_" + ne.id(), n)
          .bind("contextmenu.terminal_" + ne.id(), n);
      });
      var r = $(window);
      ...
      if (is_mobile) {
        ...
        r.on("focus.terminal_" + ne.id(), Ge).on(
          "blur.terminal_" + ne.id(),
          Ve
        );
        (function () {
          var t = 0;
        ...
        (function () {
          ...
          ne.on(e, function (e) {
            if (get_selected_html() === "" && d(e)) {
              ...
              var n = ze.offset();
              var r = ze[0].getBoundingClientRect();
              var i = ne.offset();
              var u = i.top - n.top;
              ...
              m.css({ left: o, top: a, width: l, height: s });
              if (!m.is(":focus")) {
                m.focus();
              }
              ...
              ne.everyTime(20, "selection", function () {
                if (m[0].selection !== m[0].value) {
                  if (get_textarea_selection(m[0])) {
                    ...
                    select(
                      ne.find(".terminal-output")[0],
                      ne.find(".cmd div:last-of-type")[0]
                    );
                    ne.stopTime("selection");
                  }
                }
      ...
      function i() {
        ...
        Ae = get_char_size(ne);
        if (e !== Ae.width) {
          ze.option("char_width", Ae.width).refresh();
        }
      }
      u();
      function u() {
      ...
      function a() {
        ...
        Ue.resizer("unbind").resizer(function () {
          i();
          ne.resize();
        }, e);
      }
      ...
      function s() {
        if (window.IntersectionObserver) {
          ...
          var t = e;
          if (ke.scrollBottomOffset !== -1) {
            t = $("<div/>").css({ height: ke.scrollBottomOffset }).appendTo(e);
          }
      ...
      function l() {
        ...
        if (window.IntersectionObserver && ne.css("position") !== "fixed") {
          Me = new IntersectionObserver(n, { root: null });
          Me.observe(ne[0]);
        } else {
      ...
      if (c) {
        ...
        He.observe(document.body, { childList: true });
      }
      if (f) {
        l();
      }
      ...
      (function () {
        var i = false;
        $(document)
          .bind("keydown.terminal_" + ne.id(), function (e) {
            if (e.shiftKey) {
              i = true;
            }
          })
        ...
        ne.touch_scroll(function (e) {
          ...
          css(ne[0], { "--terminal-scroll": ne.prop("scrollTop") });
          if (n === true) {
            return;
          }
          return false;
