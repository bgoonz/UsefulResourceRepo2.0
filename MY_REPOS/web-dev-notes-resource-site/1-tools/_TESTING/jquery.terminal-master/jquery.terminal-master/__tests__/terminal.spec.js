...
(function () {
  var style_descriptor = Object.getOwnPropertyDescriptor(
...
describe("Terminal utils", function () {
  var command =
    'test "foo bar" baz /^asd [x]/ str\\ str 10 1e10 "" foo"bar" \'foo\'';
  ...
  describe("$.terminal.from_ansi", function () {
    var ansi_string =
      "\x1b[38;5;12mHello\x1b[2;31;46mFoo\x1b[1;3;4;32;45mB[[sb;;]a]r\x1b[0m\x1b[7mBaz\x1b[0;48;2;255;255;0;38;2;0;100;0mQuux\x1b[m";
    ...
    it("should render ANSI art", function () {
      return Promise.all(
        ["nf-marble.ans", "bs-pacis.ans"].map((fname) => {
  ...
  describe("$.terminal.substring", function () {
    var input =
      "[[;;]Lorem ipsum dolor sit amet], [[;;]consectetur adipiscing elit]. [[;;]Maecenas ac massa tellus. Sed ac feugiat leo].";
    ...
    it("should create formatting for each character", function () {
      var formatting =
        "[[b;;;token number]10][[b;;;token operator]+][[b;;;token number]10]";
    ...
    it("should return substring when ending at length or larger", function () {
      var tests = [
        ...
        [
          10,
          "[[;;]m dolor sit amet], [[;;]consectetur adipiscing elit]. [[;;]Maecenas ac massa tellus. Sed ac feugiat leo].",
        ],
        [
          27,
          " [[;;]consectetur adipiscing elit]. [[;;]Maecenas ac massa tellus. Sed ac feugiat leo].",
        ],
        [
          30,
          "[[;;]nsectetur adipiscing elit]. [[;;]Maecenas ac massa tellus. Sed ac feugiat leo].",
        ],
      ];
      tests.forEach(function (spec) {
  ...
  describe("$.terminal.apply_formatters", function () {
    ...
    it("should apply __meta__ and array formatter", function () {
      ...
      expect($.terminal.apply_formatters(input)).toEqual(
        "[[;;]lorem] [[;;]ipsum]"
      );
    ...
    it("should throw except", function () {
      ...
      expect(function () {
        ...
        $.terminal.Exception(
          "Error in formatter [" + (formatters.length - 1) + "]"
        )
      );
    ...
    describe("terminal", function () {
      ...
      function test(spec) {
        ...
        expect(term.find(".cmd-prompt").nextAll().text().trim()).toEqual(
          command[1]
        );
      }
  ...
  describe("$.terminal.split_equal", function () {
    ...
    it("should keep formatting if it span across multiple lines", function () {
      var array = [
        "[[bui;#fff;;;Lorem ipsum dolor sit amet, consectetur adipisc" +
          ...
          "to. Do]",
        "[[bui;#fff;;;Lorem ipsum dolor sit amet, consectet" +
          ...
          "is. Nam a volutp]",
        "[[bui;#fff;;;Lorem ipsum dolor sit amet," +
        ...
        "[[bui;#fff;;;Lorem ipsum dolor" +
          ...
          "s.]",
        "[[b;;#f00;;consequat nunc, quis blandit elit odio eu a" +
          ...
          "a aliquam]tortor malesuada aliquam] eget ut l",
        "acus. Nam ut" +
          " vestibulum est. Praesent volutpat tellus in eros dapibus el" +
          "ementum. Nam laoreet risus n",
        "on nulla mollis ac luctus [[u" +
        ...
        "[[ub;#fff;;;felis dapibus. Pellentesque mattis elementum aug" +
          ...
          "smod nulla, ac auctor dia]",
        "[[ub;#fff;;;felis dapibus. Pell" +
    ...
    it("should keep formatting if span across line with newline characters", function () {
      ...
      $.terminal.split_equal(text, 100).forEach(function (line, i) {
        if (!line.match(formatting)) {
          throw new Error(
            "Line nr " + i + " " + line + " don't have correct " + "formatting"
          );
        }
      });
    });
      ...
      var test = [
        {
          ...
          output: [
            [
              "[[bui;#fff;;;Lorem ipsum dolor sit amet,]Lorem ipsum dol",
        ...
        },
        {
          ...
          output: [
            "[[bui;#fff;;;Lorem ipsum dolor sit amet, consectetur adi" +
              "piscing elit.]Lorem ipsum dolor si]",
            "[[bui;#fff;;;Lorem" +
              " ipsum dolor sit amet, consectetur adipiscing elit.]t am" +
              "et, consectetur ]",
            "[[bui;#fff;;;Lorem ipsum dolor sit a" +
              "met, consectetur adipiscing elit.]adipiscing elit.]",
            "[[" +
              "bui;#fff;;;Lorem ipsum dolor sit amet, consectetur adipi" +
              "scing elit.]Lorem ipsum dolor si]",
            "[[bui;#fff;;;Lorem i" +
              "psum dolor sit amet, consectetur adipiscing elit.]t amet" +
              ", consectetur ]",
            "[[bui;#fff;;;Lorem ipsum dolor sit ame" +
              "t, consectetur adipiscing elit.]adipiscing elit.]",
            "[[bu" +
              "i;#fff;;;Lorem ipsum dolor sit amet, consectetur adipisc" +
              "ing elit.]Lorem ipsum dolor si]",
            "[[bui;#fff;;;Lorem ips" +
            ...
            "[[bui;" +
              ...
              "g elit.]Lorem ipsum dolor si]",
            "[[bui;#fff;;;Lorem ipsum" +
              " dolor sit amet, consectetur adipiscing elit.]t amet, co" +
              "nsectetur ]",
            "[[bui;#fff;;;Lorem ipsum dolor sit amet, c" +
    ...
    it("should split normal text with brackets", function () {
      var text =
        "jcubic@gitwebterm:/git [gh-pages] xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx";
      test_lenghts(text, function (line) {
        return $("<div>" + line + "</div>").text();
      });
  ...
  describe("Stack", function () {
    ...
    describe("map", function () {
      it("should map over data", function () {
        ...
        var result = stack.map(function (n) {
          return n + 1;
        });
  ...
  describe("$.terminal.formatter", function () {
    ...
    it("should split formatting", function () {
      expect("[[;;]foo]bar[[;;]baz]".split(t)).toEqual([
        "[[;;]foo]",
        "bar",
        "[[;;]baz]",
      ]);
  ...
  describe("$.terminal.less", function () {
    ...
    it("should find inside formatting", function () {
      ...
      search("bar");
      var spans = term.find(
        '[data-index="0"] > div:first-child span[data-text]'
      );
  ...
  describe("$.terminal.pipe", function () {
    ...
    it("should filter lines", function () {
      ...
      return term
        ...
        .then(() => {
          ...
          return term
            .exec(
              'output "foo\\nquux\\nbaz\\nfoo\\nbar" | grep /foo|bar/ | input'
            )
            .then(() => {
              expect(get_lines(term)).toEqual(["0:foo", "1:foo", "2:bar"]);
            });
        });
    });
    ...
    it("should show errors", function () {
      ...
      return term.exec("push | new").then(() => {
        ...
        expect(last_divs(term).last().find(".terminal-error").length).toEqual(
          1
        );
        return term.exec("hello | baz").then(() => {
          ...
          return term.exec("quux").then(() => {
            expect(get_lines(term)).toEqual([
              sprintf(strings.commandNotFound, "quux"),
            ]);
            expect(
              last_divs(term).last().find(".terminal-error").length
            ).toEqual(1);
            var fn = jest.fn();
    ...
    describe("redirects", function () {
      ...
      it("should pipe with redirect", function () {
        ...
        return term
          .exec('input <echo "hello" world 10 | grep /^[0-9]:h/')
          .then(() => {
            expect(get_lines(term)).toEqual(["0:hello"]);
            return term
              .exec('input <promise "hello" world | grep /^[0-9]:h/')
              .then(() => {
                expect(get_lines(term)).toEqual(["0:hello"]);
                return term
                  .exec('input <promise "hello" world | grep /^h/ <echo "hi"')
                  .then(() => {
    ...
    describe("formatting", function () {
      ...
      it("should have proper formatting", function () {
        ...
        tests.forEach(function (spec) {
          ...
          expect(
            cmd.find(".cmd-wrapper div [data-text]:not(.end)").text()
          ).toEqual(nbsp(output));
          cmd.set("");
        });
      });
    ...
    describe("display_position", function () {
      ...
      it("should have correct position on text after emoji", async function () {
        ...
        for (var i in specs) {
          ...
          cmd.set(spec[0]);
          var output = cmd
            .find(".cmd-wrapper div [data-text]:not(.end)")
            .text();
...
describe("Terminal plugin", function () {
  describe("jQuery Terminal options", function () {
    ...
    describe("maskChar", function () {
      function text(term) {
        ...
        return term
          .find(
            ".cmd .cmd-cursor-line span[data-text]:not(.cmd-cursor):not(.end)"
          )
          .text();
      }
    ...
    describe("wrap", function () {
      ...
      it("should not wrap text", function () {
        var line =
          "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras ultrices rhoncus hendrerit. Nunc ligula eros, tincidunt posuere tristique quis, iaculis non elit.";
        term.echo(line);
      ...
      it("should not wrap formatting", function () {
        ...
        var line =
          "[[;#fff;]Lorem ipsum dolor sit amet], consectetur adipiscing elit. [[;#fee;]Cras ultrices rhoncus hendrerit.] Nunc ligula eros, tincidunt posuere tristique quis, [[;#fff;]iaculis non elit.]";
        term.echo(line);
        var output = last_div(term);
  ...
  describe("events", function () {
    describe("click", function () {
      ...
      it(
        "should ignore formatting inside cmd",
        without_formatters(function () {
      ...
      it("should move cursor when text have emoji", function () {
        ...
        term.insert(text).focus();
        expect(
          term.find(".cmd .cmd-wrapper div span[data-text]:not(.end)").length
        ).toBe(chars.length);
        // indexes of emoji
        [0, 7, 14].forEach(function (pos) {
          ...
          var char = chars[pos];
          expect(
            cmd.find(".cmd-cursor [data-text] span").text().length
          ).toEqual(char.length);
      ...
      function test_click(spec) {
        ...
        for (
          var pos = 0, len = $.terminal.length(input_str);
          pos < len;
          ++pos
        ) {
          var node = cmd.find(".cmd-wrapper div span[data-text]").eq(pos);
      ...
      it(
        "should move cursor when over formatting",
        without_formatters(function () {
          false &&
            ($.terminal.defaults.formatters = [
              function (string, options) {
                var result = [string, options.position];
                ["\u0038\ufe0f\u20e3", "\u263a\ufe0f"].forEach(function (
                  emoji
                ) {
      ...
      it("should move cursor on text with backspaces", function () {
        ...
        function get_count(i) {
          return (
            output.slice(0, i + 1).reduce(function (acc, line) {
  ...
  describe("JSON-RPC", function () {
    ...
    describe("No system.describe", function () {
      ...
      it("should call login function", function () {
        ...
        spy(options, "login");
        spy(object, "echo");
        term = $("<div/>").appendTo("body").terminal("/no_describe", options);
        if (term.token()) {
          term.logout();
        }
        enter(term, "test");
      ...
      it("should display error on invalid JSON", function (done) {
        var term = $("<div/>")
          .appendTo("body")
          .terminal("/not-json", { greetings: false });
        setTimeout(function () {
          enter(term, "foo");
          setTimeout(function () {
            var output = [
  ...
  describe("nested object interpreter", function () {
    ...
    it("should call fallback function", function () {
      ...
      term = $("<div/>")
        .appendTo("body")
        .terminal([interpereter, fallback.interpreter], {
          checkArity: false,
        });
      enter(term, "baz");
    ...
    it("should call json-rpc", function () {
      ...
      var new_term = $("<div/>")
        .appendTo("body")
        .terminal([interpereter, "/test", fallback.interpreter]);
      new_term.focus();
  ...
  describe("jQuery Terminal methods", function () {
    ...
    describe("exec", function () {
      ...
      function text_echoed() {
        return term
          .find(".terminal-output > div:not(.terminal-command)")
          .map(function () {
            return $(this).text();
          })
          .get()
      ...
      it("should return settings even when option is not defined", function () {
        ...
        for (var key in settings) {
          ...
          if (
            ...
            expect([key, $.terminal.defaults[key]]).toEqual([
              key,
              settings[key],
            ]);
          }
    ...
    describe("last_index", function () {
      ...
      it("should return proper index", function () {
        ...
        term.echo("Quux");
        term.echo("Lorem");
        expect(term.last_index()).toEqual(
          term.find(".terminal-output div div").length - 1
        );
        var last_line = term.find(
          ".terminal-output > div:eq(" + term.last_index() + ") div"
        );
    ...
    describe("echo", function () {
      ...
      it("should call finalize with container div", function () {
        ...
        var line = term.find(
          ".terminal-output > div:eq(" + term.last_index() + ")"
        );
      ...
      it("should not break words", function () {
        var line =
          "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras ultrices rhoncus hendrerit. Nunc ligula eros, tincidunt posuere tristique quis, iaculis non elit.";
        var lines = [
          "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras ultrices rhoncus hendrerit. Nunc",
          "ligula eros, tincidunt posuere tristique quis, iaculis non elit.",
        ];
      ...
      describe("extended commands", function () {
        ...
        beforeEach(function () {
          ...
          $.terminal.defaults.formatters = [[/\x1bfoo/g, "[[ foo ]]"]];
        ...
        it("should invoke terminal method with arguments", function () {
          global.foo = 10;
          term.echo(
            '[[ terminal::echo("xxx", {finalize: function() { foo = 20; }}) ]]'
          );
        ...
        it("should not execute command by typing", function () {
          ...
          expect(a0(term.find(".terminal-command").text())).toEqual(
            "> [[ foo ]]"
          );
        });
        it("should not execute command when overwrting exec", function () {
          ...
          expect(interpreter.foo).not.toHaveBeenCalled();
          expect(
            a0(term.find(".terminal-output > div:last-child").text())
          ).toEqual("[[ foo ]]");
        });
        ...
        it("should show error on recursive exec", function () {
          ...
          expect(a0(term.find(".terminal-error").text())).toEqual(
    ...
    describe("error", function () {
      ...
      it("should echo error", function () {
        spy(term, "echo");
        term.error("Message");
        expect(term.echo).toHaveBeenCalledWith(
      ...
      it("should handle url", function () {
        ...
        expect(term.find(".terminal-output a").attr("href")).toEqual(
          "https://jcubic.pl"
        );
      });
    ...
    describe("exception", function () {
      ...
      it("should show exception", function () {
        ...
        if (error.fileName) {
          message +=
            "]" + error.fileName + "[[;;;terminal-error]: " + error.message;
        } else {
    ...
    describe("prefix_name", function () {
      ...
      it("should return name for nested intepters", function () {
        ...
        expect(term.prefix_name(true)).toEqual(
          "test_" + term.id() + "_" + names.join("_")
        );
      });
    ...
    describe("push", function () {
      ...
      it("should keep asking for login when infiniteLogin option is set to true", function () {
        ...
        expect(term.find(".terminal-output > div:last-child").text()).toEqual(
          error
        );
        expect(term.get_prompt()).toEqual("login: ");
        enter(term, "foo");
    ...
    describe("update", function () {
      ...
      it("should update terminal output", function () {
        ...
        expect(term.find(".terminal-output").text()).toEqual(
          nbsp("Hello, World!")
        );
        term.clear();
        term.echo("Foo");
