...
(function ($) {
  ...
  function get_char_size() {
    var temp = $(
      '<div class="dialog temp"><div class="box"><span>' +
        "&nbsp;</span></div></div>"
    ).appendTo("body");
  ...
  $.fn.dialog = function (fn, options) {
    ...
    var title = $(
      '<div class="title"><span>' + settings.title + "</span></div>"
    ).appendTo(box);
    ...
    if (settings.message) {
      ...
      chunks(settings.message, size).forEach(function (line) {
        ...
        $line.append('<span class="left light">' + chars.ver + "&nbsp;</span>");
        $("<span>" + line + "</span>")
          .width(width)
          .appendTo($line);
        $line.append('<span class="left dark">&nbsp;' + chars.ver + "</span>");
      });
    }
    ...
    $('<div class="left light">' + chars.ver + "&nbsp;</div>").appendTo(
      input_line
    );
    $('<div class="left dark">' + chars.ver + "</div>").appendTo(input_line);
    fn = fn.bind(self);
    ...
    $('<div class="right light">' + chars.ver + "</div>").appendTo(input_line);
    $('<div class="right dark">&nbsp;' + chars.ver + "</div>").appendTo(
      input_line
    );
    ...
    $('<div class="left light">' + chars.ver + "</div>").appendTo(button_line);
    ...
    $(
      '<button class="ok active">' + tag($.dialog.strings.ok) + "</button>"
    ).appendTo(buttons);
    $(
      '<button class="cancel">' + tag($.dialog.strings.cancel) + "</button>"
    ).appendTo(buttons);
    $('<div class="right dark">' + chars.ver + "</div>").appendTo(button_line);
