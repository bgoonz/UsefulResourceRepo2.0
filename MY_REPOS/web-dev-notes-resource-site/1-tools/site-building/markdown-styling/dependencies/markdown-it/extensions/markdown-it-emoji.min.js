/*! markdown-it-emoji 1.4.0 https://github.com//markdown-it/markdown-it-emoji @license MIT */ (function (
  f
) {
  ...
  })(
    {
      ...
      3: [
        function (require, module, exports) {
          ...
          module.exports = function normalize_opts(options) {
            ...
            shortcuts = Object.keys(options.shortcuts).reduce(function (
              acc,
              key
            ) {
      ...
      4: [
        function (require, module, exports) {
          ...
          module.exports = function emoji_html(
            tokens,
            idx /*, options, env */
          ) {
        ...
        function (require, module, exports) {
          ...
          module.exports = function emoji_plugin(md, options) {
            ...
            var opts = normalize_opts(
              md.utils.assign({}, defaults, options || {})
            );
