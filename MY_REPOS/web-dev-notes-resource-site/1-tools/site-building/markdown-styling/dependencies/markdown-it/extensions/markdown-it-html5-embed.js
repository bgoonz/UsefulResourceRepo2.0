  ...
  })(
    {
      1: [
        function (require, module, exports) {
          ...
          function isAllowedMimeType(parsed, options) {
            return (
              parsed.mediaType !== null &&
              (!options.isAllowedMimeType ||
                options.isAllowedMimeType([parsed.mimeType, parsed.mediaType]))
            );
          }
          ...
          function isAllowedToEmbed(parsed, options) {
            return (
              isAllowedMimeType(parsed, options) &&
          ...
          module.exports = function html5_embed_plugin(md, options) {
              ...
              md.block.ruler.before(
                ...
                function (state, startLine, endLine, silent) {
                  return findDirective(
                    ...
                    endLine,
                    silent,
                    options.embedPlaceDirectiveRegexp,
                    function () {
            ...
            translate =
              typeof options.translateFn == "function"
      ...
      2: [
        function (require, module, exports) {
           ...
           *  ```
           **/
          Mimoza.prototype.register = function register(
            mimeType,
            extensions,
            overrideDefault
          ) {
            ...
            if (
              overrideDefault ||
              typeof this.extensions[mimeType.toLowerCase()] === "undefined"
            ) {
              this.extensions[mimeType.toLowerCase()] = normalize(
                extensions[0]
              );
            }
          };
