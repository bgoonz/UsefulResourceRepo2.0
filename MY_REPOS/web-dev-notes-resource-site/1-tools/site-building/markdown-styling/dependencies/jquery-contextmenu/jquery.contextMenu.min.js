      ...
      o.each(function () {
        ...
        switch (
          ("label" === r &&
            ...
            ((o = c.text()),
            (r = (l = (c = c.children().first()).get(
              0
            )).nodeName.toLowerCase())),
          r)
        ) {
          case "menu":
            (i = { name: c.attr("label"), items: {} }),
              (s = a(i.items, c.children(), s));
            break;
          case "a":
          case "button":
            i = {
    ...
    f = {
        ...
        if (
          ...
          !(
            ...
            !(
              ...
              !t.data ||
              ("left" === t.data.trigger && 0 === t.mouseButton) ||
          ...
          for (var i in t.data.items)
            if (t.data.items.hasOwnProperty(i)) {
              (e.isFunction(t.data.items[i].visible)
                ? t.data.items[i].visible.call(e(t.currentTarget), i, t.data)
                : void 0 === t.data.items[i] ||
                  !t.data.items[i].visible ||
                  !0 === t.data.items[i].visible) && (s = !0);
            }
          s && h.show.call(n, t.data, t.pageX, t.pageY);
        }
      },
      click: function (t) {
        t.preventDefault(),
      ...
      mouseenter: function (t) {
        ...
        a.is(".context-menu-list") ||
          ...
          (m.pageY = t.pageY),
          (m.data = t.data),
          s.on("mousemove.contextMenuShow", f.mousemove),
              ...
              if (o.reposition && u)
                if (document.elementFromPoint) {
                  ...
                  a.top <= t.pageY &&
                    ((a.left += r.scrollLeft()),
                    a.left <= t.pageX &&
                      ((a.bottom = a.top + o.$trigger.outerHeight()),
                      a.bottom >= t.pageY &&
                        ((a.right = a.left + o.$trigger.outerWidth()),
                        a.right >= t.pageX))))
                )
                  return void o.position.call(o.$trigger, o, c, l);
              n &&
                u &&
                o.$trigger.one("contextmenu:hidden", function () {
            ...
            default:
              ...
              if (t.accesskeys && t.accesskeys[c])
                return void t.accesskeys[c].$node.trigger(
                  t.accesskeys[c].$menu ? "contextmenu:focus" : "mouseup"
                );
          }
          e.stopPropagation(),
            void 0 !== t.$selected &&
      ...
      itemMouseleave: function (t) {
        ...
        if (s !== o && s.$layer && s.$layer.is(t.relatedTarget))
          return (
            ...
            t.preventDefault(),
            t.stopImmediatePropagation(),
            void (s.$selected = o.$selected = o.$node)
          );
      ...
      itemClick: function (t) {
        ...
        if (
          !(
            ...
            a.is(
              "." +
                i.classNames.disabled +
                ", .context-menu-separator, ." +
                i.classNames.notSelectable
            ) ||
            (a.is(".context-menu-submenu") && !1 === i.selectableSubMenu)
          )
        ) {
          if (
            (t.preventDefault(),
            t.stopImmediatePropagation(),
            e.isFunction(s.callbacks[c]) &&
              Object.prototype.hasOwnProperty.call(s.callbacks, c))
          )
            n = s.callbacks[c];
          else {
          ...
          !1 !== n.call(i.$trigger, c, i, t)
            ? i.$menu.trigger("contextmenu:hide")
            : i.$menu.parent().length && h.update.call(i.$trigger, i);
        }
      },
      ...
      focusItem: function (t) {
        ...
        n.hasClass(s.classNames.disabled) ||
          ...
          o &&
            ...
            o.$node.addClass(s.classNames.hover),
      ...
      blurItem: function (t) {
        ...
        var n = e(this),
          ...
          o = a.contextMenu,
          s = a.contextMenuRoot;
        o.autoHide && n.removeClass(s.classNames.visible),
          n.removeClass(s.classNames.hover),
          (o.$selected = null);
      },
    },
    h = {
      show: function (t, n, a) {
        ...
        if (
          ...
          h.layer.call(t.$menu, t, i.zIndex),
      ...
      hide: function (t, n) {
        ...
        if (
          ...
          n || !t.events || !1 !== t.events.hide.call(a, t))
        ) {
          if (
      ...
      create: function (n, a) {
        function o(t) {
          ...
          if (t._accesskey)
            t._beforeAccesskey &&
              n.append(document.createTextNode(t._beforeAccesskey)),
              e("<span></span>")
                .addClass("context-menu-accesskey")
                .text(t._accesskey)
                .appendTo(n),
              t._afterAccesskey &&
                n.append(document.createTextNode(t._afterAccesskey));
        ...
        void 0 === a && (a = n),
          ...
          e.each(n.items, function (s, i) {
            var c = e('<li class="context-menu-item"></li>').addClass(
                i.className || ""
              ),
              l = null,
              r = null;
            if (
              (c.on("click", e.noop),
              ("string" != typeof i && "cm_separator" !== i.type) ||
                (i = { type: "cm_seperator" }),
              (i.$node = c.data({
                contextMenu: n,
                contextMenuRoot: a,
              ...
              for (var d, m = t(i.accesskey), p = 0; (d = m[p]); p++)
                if (!a.accesskeys[d]) {
                  ...
                  v &&
                    ((i._beforeAccesskey = v[1]),
                    (i._accesskey = v[2]),
                    (i._afterAccesskey = v[3]));
                  break;
                }
            if (i.type && u[i.type])
              u[i.type].call(c, i, n, a),
                e.each([n, a], function (t, a) {
                  (a.commands[s] = i),
                    !e.isFunction(i.callback) ||
                      (void 0 !== a.callbacks[s] && void 0 !== n.type) ||
                      (a.callbacks[s] = i.callback);
                });
            else {
              switch (
                ("cm_seperator" === i.type
                  ? c.addClass(
                      "context-menu-separator " + a.classNames.notSelectable
                    )
                  : "html" === i.type
                  ? c.addClass(
                      "context-menu-html " + a.classNames.notSelectable
                    )
                  : "sub" === i.type ||
                    (i.type
                      ? ((l = e("<label></label>").appendTo(c)),
                        o(i).appendTo(l),
                ...
                case "text":
                  r = e('<input type="text" value="1" name="" />')
                    .attr("name", "context-menu-input-" + s)
                    .val(i.value || "")
                    .appendTo(l);
                  break;
                case "textarea":
                ...
                case "checkbox":
                  r = e('<input type="checkbox" value="1" name="" />')
                    .attr("name", "context-menu-input-" + s)
                    .val(i.value || "")
                    .prop("checked", !!i.selected)
                    .prependTo(l);
                  break;
                case "radio":
                  r = e('<input type="radio" value="1" name="" />')
                    .attr("name", "context-menu-input-" + i.radio)
                    .val(i.value || "")
                    .prop("checked", !!i.selected)
                    .prependTo(l);
                  break;
                ...
                case "sub":
                  o(i).appendTo(c),
                    (i.appendTo = i.$node),
                    c.data("contextMenu", i).addClass("context-menu-submenu"),
                    (i.callback = null),
                    "function" == typeof i.items.then
                      ? h.processPromises(i, a, i.items)
                      : h.create(i, a);
                  break;
                case "html":
                  e(i.html).appendTo(c);
              ...
              i.type &&
                ...
                "html" !== i.type &&
                "cm_seperator" !== i.type &&
                (r.on("focus", f.focusInput).on("blur", f.blurInput),
                i.events && r.on(i.events, n)),
                i.icon &&
                  (e.isFunction(i.icon)
                    ? (i._icon = i.icon.call(this, this, c, s, i))
                    : "string" == typeof i.icon &&
                      "fa-" === i.icon.substring(0, 3)
                    ? (i._icon =
                        a.classNames.icon +
                        " " +
                        a.classNames.icon +
            ...
            (i.$input = r),
              ...
              !n.hasTypes &&
                ...
                c.on("selectstart.disableTextSelect", f.abortevent);
          }),
          n.$node ||
      ...
      update: function (t, n) {
        var a = this;
        void 0 === n && ((n = t), h.resize(t.$menu)),
          t.$menu.children().each(function () {
            var o,
              s = e(this),
              i = s.data("contextMenuKey"),
              c = t.items[i],
              l =
                (e.isFunction(c.disabled) && c.disabled.call(a, i, n)) ||
                !0 === c.disabled;
            if (
              ((o = e.isFunction(c.visible)
                ? c.visible.call(a, i, n)
                : void 0 === c.visible || !0 === c.visible),
              s[o ? "show" : "hide"](),
              s[l ? "addClass" : "removeClass"](n.classNames.disabled),
              e.isFunction(c.icon) &&
                (s.removeClass(c._icon),
                (c._icon = c.icon.call(this, a, s, i, c)),
                s.addClass(c._icon)),
              c.type)
            )
              switch (
                (s.find("input, select, textarea").prop("disabled", l), c.type)
              ) {
                case "text":
                case "textarea":
                  c.$input.val(c.value || "");
      ...
      layer: function (t, n) {
        ...
        return (
          void 0 === document.body.style.maxWidth &&
            a.css({ position: "absolute", height: e(document).height() }),
          a
        );
      },
      ...
      activated: function (t) {
        ...
        i > o
          ...
          : (a.top < s || a.top + i > s + o) && n.css({ top: "0px" });
      },
    };
  (e.fn.contextMenu = function (t) {
    ...
    (e.contextMenu = function (t, n) {
      "string" != typeof t && ((n = t), (t = "create")),
        "string" == typeof n ? (n = { selector: n }) : void 0 === n && (n = {});
      ...
      switch (
        ...
        case "update":
          if (u) h.update(i);
          else for (var m in r) r.hasOwnProperty(m) && h.update(r[m]);
          break;
        case "create":
          ...
          if (
            ...
            (v[p] = f.itemClick),
              o
                ...
                .on("mouseup.contextMenu", ".context-menu-input", f.inputClick)
                .on(v, ".context-menu-item"),
              (s = !0);
          }
          switch (
            (i.on("contextmenu" + a.ns, a.selector, a, f.contextmenu),
            u &&
              i.on("remove" + a.ns, function () {
                e(this).contextMenu("destroy");
              }),
            a.trigger)
          ) {
            case "hover":
              i.on("mouseenter" + a.ns, a.selector, a, f.mouseenter).on(
                "mouseleave" + a.ns,
                a.selector,
                a,
                f.mouseleave
            ...
            case "left":
              ...
              break;
            case "touchstart":
              i.on("touchstart" + a.ns, a.selector, a, f.click);
          }
          a.build || h.create(a);
          break;
        case "destroy":
          ...
          if (u) {
            ...
            e.each(r, function (t, n) {
              ...
              (x = e(".context-menu-list").filter(":visible")).length &&
                x
                  .data()
                  .contextMenuRoot.$trigger.is(e(n.context).find(n.selector)) &&
                x.trigger("contextmenu:hide", { force: !0 });
              try {
                r[n.ns].$menu && r[n.ns].$menu.remove(), delete r[n.ns];
              } catch (e) {
                r[n.ns] = null;
              }
            ...
            if (l[a.selector]) {
              (x = e(".context-menu-list").filter(":visible")).length &&
                x.data().contextMenuRoot.$trigger.is(a.selector) &&
                x.trigger("contextmenu:hide", { force: !0 });
              try {
                r[l[a.selector]].$menu && r[l[a.selector]].$menu.remove(),
                  delete r[l[a.selector]];
              } catch (e) {
                r[l[a.selector]] = null;
              }
              o.off(l[a.selector]);
