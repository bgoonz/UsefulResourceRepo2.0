  ...
  return (function (t) {
          ...
          if (this.next) {
            ...
            if ("right" === this.next_direction) {
              ...
              this.next.isPositioned ||
                ...
                (function e() {
                  for (
                    var r, s = !1, o = 0, h = t.chart.symbols.length;
                    o < h;
                    o++
                  ) {
                    r = t.chart.symbols[o];
                    ...
                    if (
                      r.getCenter().y > t.next.getCenter().y &&
                      n <= t.next.width / 2
                    ) {
                      s = !0;
                      break;
              ...
              var r = this.getLeft();
              this.next.isPositioned ||
                (this.next.setY(r.y - this.next.height / 2),
                this.next.shiftX(-(this.group.getBBox().x + this.width + i)),
                (function e() {
                  for (
                    var r, s = !1, o = 0, h = t.chart.symbols.length;
              ...
              this.next.isPositioned ||
                ...
                this.next.setX(s.x - this.next.width / 2),
                (this.next.isPositioned = !0),
                this.next.render());
            }
          }
          ...
          if ((e && "bottom" !== e) || !m || !b)
            if ((e && "right" !== e) || !u || !w)
              if ((e && "left" !== e) || !u || !v)
                      ...
                      if ((e && "bottom" !== e) || !w || !b)
                        if ((e && "bottom" !== e) || !w)
                          ...
                          (r = o(
                            ...
                            [
                              { x: l.x, y: l.y + B / 2 },
                              { x: l.x + (l.x - c.x) / 2, y: l.y + B / 2 },
                              { x: l.x + (l.x - c.x) / 2, y: c.y - B / 2 },
                              { x: c.x, y: c.y - B / 2 },
                              { x: c.x, y: c.y },
                            ],
                            i
                ...
                (r = o(this.chart, y, f, i)),
                  (this.leftStart = !0),
                  (t.rightEnd = !0),
                  (k = f.x);
            else
              (r = o(this.chart, a, d, i)),
                (this.rightStart = !0),
                (t.leftEnd = !0),
                (k = d.x);
          else
            (r = o(this.chart, l, c, i)),
              (this.bottomStart = !0),
              (t.topEnd = !0),
              (k = l.x);
          if (
            ...
            for (var O = 0, L = this.chart.lines.length; O < L; O++)
              for (
                ...
                var E = [];
                E.push(["M", S[Y][1], S[Y][2]]),
                  E.push(["L", S[Y + 1][1], S[Y + 1][2]]);
                for (
                  var j = E[0][1],
                    z = E[0][2],
                    R = E[1][1],
                  ...
                  var W = [];
                  W.push(["M", C[I][1], C[I][2]]),
                    W.push(["L", C[I + 1][1], C[I + 1][2]]);
                  var V = W[0][1],
                    q = W[0][2],
                    G = W[1][1],
                    Q = W[1][2],
            ...
            this.chart.lines.push(r),
              (void 0 === this.chart.minXFromSymbols ||
                this.chart.minXFromSymbols > y.x) &&
                (this.chart.minXFromSymbols = y.x);
          }
    ...
    function (t, i) {
      function e(t, i, e) {
        ...
        n.attr("stroke", t.options["element-color"]),
          n.attr("stroke-width", t.options["line-width"]);
        var a = t.options.font,
          l = t.options["font-family"],
          p = t.options["font-weight"];
        return (
          a && n.attr({ font: a }),
          l && n.attr({ "font-family": l }),
          p && n.attr({ "font-weight": p }),
          n
        );
      }
      function r(t, i, e, r) {
        ...
        var h = "M{0},{1}";
        for (s = 2, o = 2 * e.length + 2; s < o; s += 2)
          h += " L{" + s + "},{" + (s + 1) + "}";
        var n = [i.x, i.y];
        ...
        if (
          ...
          var d = 0,
            m = 0;
          x
            ? ((d = i.x > f.x ? i.x - (i.x - f.x) / 2 : f.x - (f.x - i.x) / 2),
              (m = i.y > f.y ? i.y - (i.y - f.y) / 2 : f.y - (f.y - i.y) / 2),
              c
                ? ((d -= g.getBBox().width / 2),
                  (m -= t.options["text-margin"]))
                : ((d += t.options["text-margin"]),
                  (m -= g.getBBox().height / 2)))
            : ((d = i.x),
              (m = i.y),
              c
                ? ((d += t.options["text-margin"] / 2),
                  (m -= t.options["text-margin"]))
                : ((d += t.options["text-margin"] / 2),
                  (m += t.options["text-margin"]),
                  i.y > f.y && (m -= 2 * t.options["text-margin"]))),
            g.attr({
              "text-anchor": "start",
                ...
                !(function t(i, s, o) {
                  ...
                  return (
                    ...
                    h.pathOk
                      ? h
                      : (h instanceof p
                          ? (i.yes && t(i.yes, h, i), i.no && t(i.no, h, i))
                          : h instanceof y
                          ? (i.path1 && t(i.path1, h, i),
                            i.path2 && t(i.path2, h, i),
                            i.path3 && t(i.path3, h, i))
                          : i.next && t(i.next, h, i),
                        h)
                  );
                })(this.start),
          ...
          if (w.indexOf("=>") >= 0) {
            ...
            if (
              (B.symbolType.indexOf(": ") >= 0 &&
                ((M = B.symbolType.split(": ")),
                (B.symbolType = M.shift()),
                (B.text = M.join(": "))),
              ...
              var T = B.link.indexOf("[") + 1,
                S = B.link.indexOf("]");
              T >= 0 &&
                S >= 0 &&
                ((B.target = B.link.substring(T, S)),
                (B.link = B.link.substring(0, T - 1)));
            }
            ...
            for (var Y = w.split("->"), O = 0, P = Y.length; O < P; O++) {
              var E = Y[O],
                j = e(E);
              ("true" !== j && "false" !== j) ||
                ((E = E.replace("true", "yes")),
                (E = E.replace("false", "no")));
              var z = r(E),
                R = x(E),
                F = null;
              if (R.indexOf(",") >= 0) {
        ...
        (i = i || {}),
          ...
          i.yes && i.direction_yes && i.no && !i.direction_no
            ...
            : i.yes &&
              ...
              i.no &&
              i.direction_no &&
              i.direction_no !== i.direction_yes
            ? "right" === i.direction_yes
              ? ((this.no_direction = "bottom"), (this.yes_direction = "right"))
              : "top" === i.direction_yes
              ? ((this.no_direction = "right"), (this.yes_direction = "top"))
        ...
        (r.prototype.render = function () {
          ...
          if (this.right_symbol) {
            ...
            if (!this.right_symbol.isPositioned) {
              ...
              !(function i() {
                for (
                  var e, s = !1, o = 0, h = r.chart.symbols.length;
                  o < h;
                  o++
                )
                  if (
        ...
        (r.prototype.render = function () {
          ...
          if (this.left_symbol) {
            ...
            this.left_symbol.isPositioned ||
              (this.left_symbol.setY(s.y - this.left_symbol.height / 2),
              ...
              (function i() {
                for (
                  ...
                  if (
                    ...
                    var n = Math.abs(
                      e.getCenter().x - r.left_symbol.getCenter().x
                    );
                    if (
                      e.getCenter().y > r.left_symbol.getCenter().y &&
                      n <= r.left_symbol.width / 2
                    ) {
                      s = !0;
                      break;
                    }
          ...
          if (this.right_symbol) {
            ...
            this.right_symbol.isPositioned ||
              (this.right_symbol.setY(o.y - this.right_symbol.height / 2),
      ...
      (r.prototype.handle = function (t) {
        ...
        (r.prototype.render = function () {
          var t,
            ...
            a = 0,
            l = 0;
          for (s = 0, o = this.symbols.length; s < o; s++)
            (t = this.symbols[s]),
              t.width > e && (e = t.width),
          ...
          for (this.start.render(), s = 0, o = this.symbols.length; s < o; s++)
          ...
          var d = h + f - a,
            m = n + f - l;
          this.paper.setSize(d * c, m * c),
            this.paper.setViewBox(a, l, d, m, !0);
        }),
    ...
    function (t, i, e) {
      function r(t, i) {
        ...
        var e = this.text.getBBox().width + 4 * this.textMargin,
          ...
          a = { x: o, y: h },
          l = [
            { x: o - this.textMargin, y: r },
            { x: o - this.textMargin + e, y: r },
            { x: o - this.textMargin + e + 2 * this.textMargin, y: 0 },
            { x: o - this.textMargin + 2 * this.textMargin, y: 0 },
            { x: o, y: h },
          ],
          p = n(t, a, l);
        p.attr({
    ...
    function (t, i, e) {
      function r(t, i) {
        ...
        o && r.attr({ font: o }),
          h && r.attr({ "font-family": h }),
          n && r.attr({ "font-weight": n }),
