  ...
  [3],
  {
    ...
    172: function (t, e, a) {
      ...
      t.exports = function (t) {
        t.params({ partner: { fallback: o(u.val, u, "partner") } }),
          ...
          t.define("scribeInteraction", function (t, e, a) {
            ...
            (r.action = t.type),
              "url" === r.element &&
                (r.element = n.clickEventElement(t.target)),
              this.scribe(r, e, a);
          });
      };
    },
    ...
    219: function (t, e, a) {
      ...
      t.exports = n.couple(a(172), a(173), function (t) {
        t.params({
          ...
          lang: { required: !0, transform: h.matchLanguage, fallback: "en" },
    ...
    250: function (t, e, a) {
      ...
      t.exports = m.couple(a(172), a(173), function (t) {
        t.params({
          ...
          size: { fallback: "medium", transform: D },
          type: { fallback: "share", validate: k },
          text: { transform: A },
          screenName: { transform: h.screenName },
          buttonHashtag: { transform: z },
          partner: { fallback: f(i.val, i, "partner") },
          via: {},
          related: {},
          hashtags: {},
          url: {},
