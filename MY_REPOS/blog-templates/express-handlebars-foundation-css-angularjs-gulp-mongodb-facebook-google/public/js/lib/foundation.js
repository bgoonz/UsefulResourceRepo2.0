            ...
            .on("keydown.zf.drilldown", function (e) {
              ...
              Foundation.Keyboard.handleKey(e, "Drilldown", {
                ...
                previous: function () {
                  ...
                  $element
                    .parent("ul")
                    .on(Foundation.transitionend($element), function () {
                      setTimeout(function () {
    ...
    _createClass(Dropdown, [
      ...
      },
      {
        ...
        value: function getPositionClass() {
          var position =
            this.$element[0].className.match(/\b(top|left|right)\b/g);
          ...
          if (winPos + this.winHeight === this.docHeight) {
            ...
            var isDown = this.scrollPos < winPos,
              ...
              curVisible = this.points.filter(function (p, i) {
                return isDown
                  ? p <= winPos
                  : p - _this.options.threshold <= winPos; //&& winPos >= _this.points[i -1] - _this.options.threshold;
              });
    ...
    _createClass(Reveal, [
      {
        ...
        value: function _init() {
          ...
          if (this.$anchor.length) {
            var anchorId =
              this.$anchor[0].id || Foundation.GetYoDigits(6, "reveal");
      ...
      },
      {
        ...
        value: function open() {
          ...
          $("body")
            ...
            .attr(
              "aria-hidden",
              this.options.overlay || this.options.fullScreen ? true : false
            );
