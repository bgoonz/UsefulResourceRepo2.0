...
(function () {
  ...
  var CSHARP_KEYWORDS =
    "as base by byte checked decimal delegate descending " +
...
function PR_isIE6() {
  var isIE6 =
    navigator && navigator.userAgent && /\bMSIE 6\./.test(navigator.userAgent);
  PR_isIE6 = function () {
    return isIE6;
  };
  return isIE6;
...
/** Given triples of [style, pattern, context] returns a lexing function,
  ...
  */
function PR_createSimpleLexer(shortcutStylePatterns, fallthroughStylePatterns) {
  var shortcuts = {};
  (function () {
  ...
  return function (sourceCode, opt_basePos) {
    ...
    while (tail.length) {
      ...
      if (style !== PR_COMMENT && /\S/.test(token)) {
        lastToken = token;
      }
    }
    return decorations;
