...
(function (aY, H) {
    ...
    bn.fn = bn.prototype = {
          ...
          if (bK && (bK[1] || !bM)) {
            if (bK[1]) {
              ...
              if (bJ) {
                ...
                bI = (bJ.cacheable ? bn.clone(bJ.fragment) : bJ.fragment)
                  .childNodes;
              }
      ...
      slice: function () {
        return this.pushStack(
          ...
          "slice",
          bt.call(arguments).join(",")
        );
      },
      map: function (bI) {
        return this.pushStack(
          bn.map(this, function (bK, bJ) {
    ...
    bn.extend({
      ...
      isPlainObject: function (bJ) {
        ...
        if (
          ...
          !bo.call(bJ.constructor.prototype, "isPrototypeOf")
        ) {
          return false;
        }
        var bI;
      ...
      trim: bx
        ...
        : function (bI) {
            return bI == null
              ? ""
              : bI.toString().replace(br, "").replace(bm, "");
          },
      ...
      _Deferred: function () {
        var bL = [],
          ...
          bI = {
            ...
            resolve: function () {
              bI.resolveWith(
                bn.isFunction(this.promise) ? this.promise() : this,
                arguments
              );
              return this;
            },
  ...
  a.fn.extend({
    ...
    hasClass: function (e) {
      ...
      for (var be = 0, bd = this.length; be < bd; be++) {
        if (
          (" " + this[be].className + " ").replace(aC, " ").indexOf(bf) > -1
        ) {
          return true;
        }
      }
      ...
      if (!arguments.length) {
        ...
        if (be) {
          ...
          if (a.nodeName(be, "select")) {
            ...
            for (
              var bf = bh ? bi : 0, bj = bh ? bi + 1 : bm.length;
              bf < bj;
              bf++
            ) {
              var bg = bm[bf];
              if (
                ...
                (a.support.optDisabled
                  ? !bg.disabled
                  : bg.getAttribute("disabled") === null) &&
                (!bg.parentNode.disabled ||
                  !a.nodeName(bg.parentNode, "optgroup"))
              ) {
                bk = a(bg).val();
                if (bh) {
                  return bk;
      ...
      if (bd.nodeType === 1) {
        ...
        if ((e in bd || bd[e] !== H) && be && !bg) {
          ...
          if (e === "tabIndex") {
            ...
            return bk && bk.specified
              ? bk.value
              : C.test(bd.nodeName) || (k.test(bd.nodeName) && bd.href)
              ? 0
              : H;
          }
          return bd[e];
        ...
        var bf =
          !a.support.hrefNormalized && be && bg
            ? bd.getAttribute(e, 2)
            : bd.getAttribute(e);
        return bf === null ? H : bf;
      }
  ...
  a.event = {
      ...
      if (!bj) {
        bm.handle = bj = function () {
          return typeof a !== "undefined" && !a.event.triggered
            ? a.event.handle.apply(bj.elem, arguments)
            : H;
        };
      }
      bj.elem = bg;
    ...
    trigger: function (bd, bi, bf) {
      ...
      if (!bd.isPropagationStopped() && bo) {
        ...
        if (!bd.isDefaultPrevented()) {
          ...
          if (
            (!bl._default || bl._default.call(bf, bd) === false) &&
            !bp &&
            !(bk && bk.nodeName && a.noData[bk.nodeName.toLowerCase()])
          ) {
            try {
              if (bk[e]) {
                be = bk["on" + e];
    ...
    fix: function (bf) {
      ...
      if (!bf.relatedTarget && bf.fromElement) {
        bf.relatedTarget =
          bf.fromElement === bf.target ? bf.toElement : bf.fromElement;
      }
      ...
      if (!bf.which && bf.button !== H) {
        bf.which =
          bf.button & 1 ? 1 : bf.button & 2 ? 3 : bf.button & 4 ? 2 : 0;
      }
      return bf;
    },
    guid: 100000000,
    ...
    special: {
      ...
      live: {
        add: function (e) {
          a.event.add(
            this,
            n(e.origType, e.selector),
            a.extend({}, e, { handler: af, guid: e.handler.guid })
          );
        },
        remove: function (e) {
      ...
      filters: {
        ...
        keydown: function (bf) {
          var be = bf.target,
            bd = be.type;
          if (
            (bf.keyCode === 13 && be.nodeName.toLowerCase() !== "textarea") ||
  ...
  function af(bn) {
    ...
    for (bo = 0, bl = bh.length; bo < bl; bo++) {
      ...
      for (bm = 0; bm < be.length; bm++) {
        e = be[bm];
        if (
          bj.selector === e.selector &&
          (!bi || bi.test(e.namespace)) &&
          !bj.elem.disabled
        ) {
          bp = bj.elem;
          bt = null;
  ...
  function n(bd, e) {
    return (
      (bd && bd !== "*" ? bd + "." : "") + e.replace(K, "`").replace(aa, "&")
    );
  }
  a.each(
  ...
  (function () {
          ...
          if (e && e.nodeType === 1) {
            for (bC = 0; bL[bC] != null; bC++) {
              if (
                bL[bC] &&
                (bL[bC] === true ||
                  (bL[bC].nodeType === 1 && bf.contains(e, bL[bC])))
              ) {
                bD.push(bI[bC]);
              }
            }
    ...
    var bk = (bf.selectors = {
        ...
        "+": function (bB, bw) {
          ...
          for (var bx = 0, e = bB.length, bz; bx < e; bx++) {
            if ((bz = bB[bx])) {
              ...
              bB[bx] =
                bC || (bz && bz.nodeName.toLowerCase() === bw)
                  ? bz || false
                  : bz === bw;
            }
          }
      ...
      filter: {
        ...
        TAG: function (bw, e) {
          return (
            (e === "*" && bw.nodeType === 1) || bw.nodeName.toLowerCase() === e
          );
        },
        CLASS: function (bw, e) {
          return (
            (" " + (bw.className || bw.getAttribute("class")) + " ").indexOf(
              e
            ) > -1
          );
        },
        ATTR: function (bA, by) {
          ...
          return e == null
            ...
            ? bB.indexOf(bw) === 0
            : bz === "$="
            ? bB.substr(bB.length - bw.length) === bw
            : bz === "|="
            ? bB === bw || bB.substr(0, bw.length + 1) === bw + "-"
            : false;
        },
    ...
    for (var bg in bk.match) {
      bk.match[bg] = new RegExp(
        bk.match[bg].source + /(?![^\[]*\])(?![^\(]*\))/.source
      );
      bk.leftMatch[bg] = new RegExp(
    ...
    (function () {
      ...
      if (al.getElementById(bx)) {
            ...
            return by
              ? by.id === bz[1] ||
                (typeof by.getAttributeNode !== "undefined" &&
                  by.getAttributeNode("id").nodeValue === bz[1])
                ? [by]
                : H
              : [];
          }
        ...
        bk.filter.ID = function (bA, by) {
          var bz =
            typeof bA.getAttributeNode !== "undefined" &&
      ...
      if (a.isArray(bm)) {
        ...
        if (bl && bm.length) {
          for (bg = 0, be = bm.length; bg < be; bg++) {
            bf = bm[bg];
            if (!bh[bf]) {
              bh[bf] = a.expr.match.POS.test(bf)
                ? a(bf, bd || this.context)
                : bf;
            }
          }
  ...
  a.each(
    {
      ...
      contents: function (e) {
        return a.nodeName(e, "iframe")
          ? e.contentDocument || e.contentWindow.document
          : a.makeArray(e.childNodes);
      },
    },
    function (e, bd) {
    ...
    text: function (e) {
      ...
      if (typeof e !== "object" && e !== H) {
        return this.empty().append(
          ((this[0] && this[0].ownerDocument) || al).createTextNode(e)
        );
      }
      return a.text(this);
    },
      ...
      if (this[0]) {
        ...
        if (bg) {
          ...
          for (var be = 0, e = this.length, bh = e - 1; be < e; be++) {
            bm.call(
              bn ? aX(this[be], bg) : this[be],
              bf.cacheable || (e > 1 && be < bh) ? a.clone(bi, true, true) : bi
            );
          }
        }
        if (bd.length) {
      ...
      if (bk) {
        ...
        for (var bh in bk) {
          for (var be = 0, bd = bk[bh].length; be < bd; be++) {
            a.event.add(
              bj,
              bh + (bk[bh][be].namespace ? "." : "") + bk[bh][be].namespace,
              bk[bh][be],
              bk[bh][be].data
            );
          }
  ...
  a.buildFragment = function (bh, bf, bd) {
    var bg,
      e,
      be,
      bi = bf && bf[0] ? bf[0].ownerDocument || bf[0] : al;
    if (
      bh.length === 1 &&
      typeof bh[0] === "string" &&
      bh[0].length < 512 &&
          ...
          if (typeof bh === "string") {
            ...
            if (!a.support.tbody) {
              var e = v.test(bh),
                bk =
                  bp === "table" && !e
                    ? bd.firstChild && bd.firstChild.childNodes
                    : bf[1] === "<table>" && !e
                    ? bd.childNodes
                    : [];
      ...
      if (bn) {
        for (bm = 0; bo[bm]; bm++) {
          if (
            ...
            (!bo[bm].type || bo[bm].type.toLowerCase() === "text/javascript")
          ) {
            bi.push(
              bo[bm].parentNode ? bo[bm].parentNode.removeChild(bo[bm]) : bo[bm]
            );
          } else {
            if (bo[bm].nodeType === 1) {
              bo.splice.apply(
                bo,
                [bm + 1, 0].concat(
                  a.makeArray(bo[bm].getElementsByTagName("script"))
                )
              );
            }
  ...
  var ae = /alpha\([^)]*\)/i,
    ...
    aZ = /^-?\d+(?:px)?$/i,
    a7 = /^-?\d/,
    aV = { position: "absolute", visibility: "hidden", display: "block" },
    ag = ["Left", "Right"],
    aR = ["Top", "Bottom"],
    U,
    ay,
  ...
  if (!a.support.opacity) {
    a.cssHooks.opacity = {
      get: function (bd, e) {
        return ak.test(
          (e && bd.currentStyle ? bd.currentStyle.filter : bd.style.filter) ||
            ""
        )
  ...
  if (al.documentElement.currentStyle) {
    aL = function (bg, be) {
      var bh,
        bd = bg.currentStyle && bg.currentStyle[be],
  ...
  if (a.expr && a.expr.filters) {
    a.expr.filters.hidden = function (be) {
      ...
      return (
        (bd === 0 && e === 0) ||
        (!a.support.reliableHiddenOffsets &&
          (be.style.display || a.css(be, "display")) === "none")
      );
    };
      ...
      return this.map(function () {
        ...
        .filter(function () {
          return (
            this.name &&
            !this.disabled &&
            (this.checked || p.test(this.nodeName) || aO.test(this.type))
          );
        })
        .map(function (e, bd) {
          var be = a(this).val();
    ...
    ajax: function (bh, bf) {
      ...
      if (!bl.hasContent) {
        ...
        if (bl.cache === false) {
          ...
          bl.url =
            bw +
            (bw === bl.url ? (I.test(bl.url) ? "&" : "?") + "_=" + bd : "");
        }
      }
      if (
        (bl.data && bl.hasContent && bl.contentType !== false) ||
        bf.contentType
      ) {
      ...
      bp.Accept =
        bl.dataTypes[0] && bl.accepts[bl.dataTypes[0]]
          ? bl.accepts[bl.dataTypes[0]] +
  ...
  a.ajaxPrefilter("json jsonp", function (bm, bi, bl) {
    ...
    if (
      bm.dataTypes[0] === "jsonp" ||
      bi.jsonpCallback ||
      bi.jsonp != null ||
      (bm.jsonp !== false && (t.test(bm.url) || (bk && t.test(bm.data))))
    ) {
      var bj,
        be = (bm.jsonpCallback = a.isFunction(bm.jsonpCallback)
          ? bm.jsonpCallback()
          : bm.jsonpCallback),
        bh = aY[be],
        e = bm.url,
  ...
  a.ajaxTransport("script", function (be) {
    if (be.crossDomain) {
      var e,
        bd =
          al.head || al.getElementsByTagName("head")[0] || al.documentElement;
      return {
        send: function (bf, bg) {
  ...
  if ("getBoundingClientRect" in al.documentElement) {
    a.fn.offset = function (bq) {
      ...
      var bk = bp.body,
        ...
        bd =
          bl.pageYOffset ||
          (a.support.boxModel && be.scrollTop) ||
          bk.scrollTop,
        bh =
          bl.pageXOffset ||
          (a.support.boxModel && be.scrollLeft) ||
          bk.scrollLeft,
        bo = bj.top + bd - bi,
        bf = bj.left + bh - bm;
      ...
      while ((bh = bh.parentNode) && bh !== bi && bh !== bf) {
        ...
        if (bh === be) {
          ...
          if (
            ...
            !(a.offset.doesAddBorderForTableAndCells && S.test(bh.nodeName))
          ) {
  ...
  a.fn.extend({
    position: function () {
      ...
      var be = this[0],
        ...
        bf = this.offset(),
        e = Y.test(bd[0].nodeName) ? { top: 0, left: 0 } : bd.offset();
    ...
    a.fn[be] = function (bh) {
      ...
      if (bh !== H) {
        return this.each(function () {
          ...
          if (bg) {
            bg.scrollTo(
              !bd ? bh : a(bg).scrollLeft(),
              bd ? bh : a(bg).scrollTop()
            );
          } else {
            this[be] = bh;
          }
        ...
        return bg
          ? "pageXOffset" in bg
            ? bg[bd ? "pageYOffset" : "pageXOffset"]
            : (a.support.boxModel && bg.document.documentElement[be]) ||
              bg.document.body[be]
          : bf[be];
      }
    };
  ...
  a.each(["Height", "Width"], function (bd, e) {
    ...
    a.fn["outer" + e] = function (bf) {
      return this[0]
        ? parseFloat(a.css(this[0], be, bf ? "margin" : "border"))
        : null;
    };
    a.fn[be] = function (bg) {
      var bh = this[0];
      ...
      if (a.isWindow(bh)) {
        ...
        return (
          (bh.document.compatMode === "CSS1Compat" && bi) ||
          bh.document.body["client" + e] ||
          bi
        );
      } else {
        if (bh.nodeType === 9) {
          return Math.max(
            bh.documentElement["client" + e],
            bh.body["scroll" + e],
            bh.documentElement["scroll" + e],
            bh.body["offset" + e],
