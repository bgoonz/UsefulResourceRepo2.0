...
(window.Platform = window.Platform || {}),
  ...
  (function (a) {
    ...
    if (c)
      for (var d, e = c.attributes, f = 0; f < e.length; f++)
        (d = e[f]), "src" !== d.name && (b[d.name] = d.value || !0);
    b.log &&
      b.log.split(",").forEach(function (a) {
        window.logFlags[a] = !0;
      }),
      (b.shadow = b.shadow || b.shadowdom || b.polyfill),
      (b.shadow =
        "native" === b.shadow
          ? !1
          : b.shadow || !HTMLElement.prototype.createShadowRoot),
      b.shadow &&
      ...
      b.register &&
        ...
        (window.CustomElements.flags.register = b.register)),
      b.imports &&
        ((window.HTMLImports = window.HTMLImports || { flags: {} }),
        (window.HTMLImports.flags.imports = b.imports)),
      (a.flags = b);
  })(Platform),
    ...
    !(function () {
      ...
      (c.prototype = {
        set: function (b, c) {
          ...
          d && d[0] === b
            ? (d[1] = c)
            : a(b, this.name, { value: [b, c], writable: !0 });
        },
        get: function (a) {
          var b;
  ...
  (function (global) {
    ...
    function detectObjectObserve() {
      ...
      if (
        "function" != typeof Object.observe ||
        "function" != typeof Array.observe
      )
        return !1;
      var b = [],
        c = {},
      ...
      return (
        ...
        5 !== b.length
          ...
          : "add" != b[0].type ||
            ...
            "splice" != b[4].type
          ? !1
          : (Object.unobserve(c, a), Array.unobserve(d, a), !0)
      );
    }
    function detectEval() {
      if (
    ...
    function isPathValid(a) {
      return "string" != typeof a
        ? !1
        : ((a = a.trim()),
          "" == a ? !0 : "." == a[0] ? !1 : pathRegExp.test(a));
    }
    function Path(a, b) {
      if (b !== constructorIsPrivate)
    ...
    function dirtyCheck(a) {
      ...
      return (
        global.testingExposeCycleCount && (global.dirtyCheckCycleCount = b),
        b > 0
      );
    }
    ...
    function diffIsEmpty(a) {
      return (
        objectIsEmpty(a.added) &&
        objectIsEmpty(a.removed) &&
        objectIsEmpty(a.changed)
      );
    }
    function diffObjectFromOldObject(a, b) {
      ...
      for (var f in b) {
        var g = a[f];
        (void 0 === g || g !== b[f]) &&
          (f in a ? g !== b[f] && (e[f] = g) : (d[f] = void 0));
      }
      for (var f in a) f in b || (c[f] = a[f]);
      return (
        Array.isArray(a) && a.length !== b.length && (e.length = a.length),
        { added: c, removed: d, changed: e }
      );
    }
    ...
    function newObservedSet() {
      function a(b, f) {
        b &&
          (b === d && (e[f] = !0),
          h.indexOf(b) < 0 && (h.push(b), Object.observe(b, c)),
          a(Object.getPrototypeOf(b), f));
      }
      function b(a) {
        for (var b = 0; b < a.length; b++) {
          var c = a[b];
          if (c.object !== d || e[c.name] || "setPrototype" === c.type)
            return !1;
        }
        return !0;
      }
      function c(c) {
        if (!b(c)) {
          for (var d, e = 0; e < g.length; e++)
            (d = g[e]), d.state_ == OPENED && d.iterateObjects_(a);
          for (var e = 0; e < g.length; e++)
            (d = g[e]), d.state_ == OPENED && d.check_();
        }
      }
      var d,
        e,
          ...
          close: function () {
            if ((f--, !(f > 0))) {
              for (var a = 0; a < h.length; a++)
                Object.unobserve(h[a], c), Observer.unobservedCount++;
              (g.length = 0),
                (h.length = 0),
                (d = void 0),
                (e = void 0),
    ...
    function getObservedSet(a, b) {
      return (
        (lastObservedSet && lastObservedSet.object === b) ||
          ((lastObservedSet = observedSetCache.pop() || newObservedSet()),
          (lastObservedSet.object = b)),
        lastObservedSet.open(a, b),
        lastObservedSet
      );
    }
    function Observer() {
    ...
    function PathObserver(a, b) {
      Observer.call(this),
        (this.object_ = a),
        (this.path_ = getPath(b)),
        (this.directObserver_ = void 0);
    }
    function CompoundObserver(a) {
      Observer.call(this),
        (this.reportChangesOnOpen_ = a),
        (this.value_ = []),
        (this.directObserver_ = void 0),
        (this.observed_ = []);
    }
    ...
    function ObserverTransform(a, b, c, d) {
      (this.callback_ = void 0),
        ...
        (this.value_ = void 0),
        (this.observable_ = a),
        (this.getValueFn_ = b || identFn),
        (this.setValueFn_ = c || identFn),
        (this.dontPassThroughSet_ = d);
    }
    function notify(a, b, c, d) {
      if (
        ...
        var e = a.notifier_;
        e || (e = a.notifier_ = Object.getNotifier(a)),
          (updateRecord.object = a),
          (updateRecord.name = b),
          (updateRecord.oldValue = d),
          e.notify(updateRecord);
      }
    }
    function diffObjectFromChangeRecords(a, b, c) {
      for (var d = {}, e = {}, f = 0; f < b.length; f++) {
        var g = b[f];
        expectedRecordTypes[g.type]
          ? (g.name in c || (c[g.name] = g.oldValue),
            "update" != g.type &&
              ("add" != g.type
                ? g.name in d
                  ? (delete d[g.name], delete c[g.name])
                  : (e[g.name] = !0)
                : g.name in e
                ? delete e[g.name]
                : (d[g.name] = !0)))
          : (console.error("Unknown changeRecord type: " + g.type),
            console.error(g));
      }
    ...
    function mergeSplice(a, b, c, d) {
      for (
        var e = newSplice(b, c, d), f = !1, g = 0, h = 0;
        h < a.length;
        h++
      ) {
        var i = a[h];
        if (((i.index += g), !f)) {
          var j = intersect(
            e.index,
            e.index + e.removed.length,
            i.index,
            i.index + i.addedCount
          );
          if (j >= 0) {
            a.splice(h, 1),
              h--,
              (g -= i.addedCount - i.removed.length),
              (e.addedCount += i.addedCount - j);
    ...
    function projectArraySplices(a, b) {
      var c = [];
      return (
        createInitialSplices(a, b).forEach(function (b) {
          return 1 == b.addedCount && 1 == b.removed.length
            ? void (b.removed[0] !== a[b.index] && c.push(b))
            : void (c = c.concat(
                calcSplices(
                  a,
                  b.index,
                  b.index + b.addedCount,
                  b.removed,
                  0,
                  b.removed.length
                )
    ...
    Observer.prototype = {
      ...
      report_: function (a) {
        try {
          ...
          (Observer._errorThrownDuringCallback = !0),
            console.error(
              "Exception caught during observer callback: " + (b.stack || b)
            );
        }
      },
    ...
    (global.Platform = global.Platform || {}),
          ...
          if (collectObservers) {
            ...
            do {
              ...
              for (var i = 0; i < toCheck.length; i++) {
                ...
                observer.state_ == OPENED &&
                  (observer.check_() && (anyChanged = !0),
      ...
      (ObjectObserver.prototype = createObject({
        ...
        check_: function (a) {
          ...
          if (hasObserve) {
            ...
            (c = this.oldObject_),
              (b = diffObjectFromOldObject(this.value_, this.oldObject_));
          return diffIsEmpty(b)
            ? !1
            : (hasObserve || (this.oldObject_ = this.copyObject(this.value_)),
              this.report_([
                b.added || {},
                b.removed || {},
                b.changed || {},
        ...
        disconnect_: function () {
          hasObserve
            ? (this.directObserver_.close(), (this.directObserver_ = void 0))
            : (this.oldObject_ = void 0);
        },
        deliver: function () {
          this.state_ == OPENED &&
            (hasObserve ? this.directObserver_.deliver(!1) : dirtyCheck(this));
        },
        discardChanges: function () {
          return (
            this.directObserver_
              ? this.directObserver_.deliver(!0)
              : (this.oldObject_ = this.copyObject(this.value_)),
            this.value_
          );
        },
      ...
      (ArrayObserver.applySplices = function (a, b, c) {
        c.forEach(function (c) {
          for (
            var d = [c.index, c.removed.length], e = c.index;
            e < c.index + c.addedCount;
      ...
      (PathObserver.prototype = createObject({
        ...
        check_: function (a, b) {
          ...
          return (
            ...
            b || areSameValue(this.value_, c)
              ? !1
              : (this.report_([this.value_, c]), !0)
          );
        },
        setValue: function (a) {
    ...
    (CompoundObserver.prototype = createObject({
      ...
      disconnect_: function () {
        for (var a = 0; a < this.observed_.length; a += 2)
          this.observed_[a] === observerSentinel &&
            this.observed_[a + 1].close();
        (this.observed_.length = 0),
          (this.value_.length = 0),
          this.directObserver_ &&
            (this.directObserver_.close(this), (this.directObserver_ = void 0));
      },
      ...
      addObserver: function (a) {
        ...
        if (
          (this.observed_.push(observerSentinel, a), this.reportChangesOnOpen_)
        ) {
      ...
      iterateObjects_: function (a) {
        for (var b, c = 0; c < this.observed_.length; c += 2)
          (b = this.observed_[c]),
            b !== observerSentinel &&
              this.observed_[c + 1].iterateObjects(b, a);
      },
      check_: function (a, b) {
        for (var c, d = 0; d < this.observed_.length; d += 2) {
          ...
          if (f === observerSentinel) {
            ...
            e =
              this.state_ === UNOPENED
                ? h.open(this.deliver, this)
                : h.discardChanges();
          } else e = g.getValueFrom(f);
          b
            ? (this.value_[d / 2] = e)
            : areSameValue(e, this.value_[d / 2]) ||
              ((c = c || []),
              (c[d / 2] = this.value_[d / 2]),
              (this.value_[d / 2] = e));
        }
      ...
      (ObserverTransform.prototype = {
        ...
        observedCallback_: function (a) {
          if (((a = this.getValueFn_(a)), !areSameValue(a, this.value_))) {
            var b = this.value_;
            (this.value_ = a),
              this.callback_.call(this.target_, this.value_, b);
          }
        },
        discardChanges: function () {
          return (
        ...
        setValue: function (a) {
          return (
            (a = this.setValueFn_(a)),
            !this.dontPassThroughSet_ && this.observable_.setValue
              ? this.observable_.setValue(a)
              : void 0
          );
        },
        close: function () {
          this.observable_ && this.observable_.close(),
            (this.callback_ = void 0),
            (this.target_ = void 0),
            (this.observable_ = void 0),
            (this.value_ = void 0),
            (this.getValueFn_ = void 0),
            (this.setValueFn_ = void 0);
        },
      });
    var expectedRecordTypes = { add: !0, update: !0, delete: !0 },
      updateRecord = {
        object: void 0,
        type: "update",
        name: void 0,
    ...
    ArraySplice.prototype = {
      calcEditDistances: function (a, b, c, d, e, f) {
        for (
          var g = f - e + 1, h = c - b + 1, i = new Array(g), j = 0;
          g > j;
          j++
        )
          (i[j] = new Array(h)), (i[j][0] = j);
        for (var k = 0; h > k; k++) i[0][k] = k;
        for (var j = 1; g > j; j++)
          for (var k = 1; h > k; k++)
            if (this.equals(a[b + k - 1], d[e + j - 1]))
              i[j][k] = i[j - 1][k - 1];
            else {
              var l = i[j - 1][k] + 1,
                m = i[j][k - 1] + 1;
      ...
      spliceOperationsFromEditDistances: function (a) {
        for (
          var b = a.length - 1, c = a[0].length - 1, d = a[b][c], e = [];
          b > 0 || c > 0;
          ...
          if (0 != b)
            if (0 != c) {
              var f,
                ...
                h = a[b - 1][c],
                i = a[b][c - 1];
              (f = i > h ? (g > h ? h : g) : g > i ? i : g),
                f == g
                  ? (g == d
                      ? e.push(EDIT_LEAVE)
                      : (e.push(EDIT_UPDATE), (d = g)),
                    b--,
                    c--)
                  : f == h
                  ? (e.push(EDIT_DELETE), b--, (d = h))
                  : (e.push(EDIT_ADD), c--, (d = i));
      ...
      calcSplices: function (a, b, c, d, e, f) {
        var g = 0,
          ...
          i = Math.min(c - b, f - e);
        if (
          (0 == b && 0 == e && (g = this.sharedPrefix(a, d, i)),
          c == a.length &&
            f == d.length &&
            (h = this.sharedSuffix(a, d, i - g)),
          (b += g),
          (e += g),
          (c -= h),
          (f -= h),
        ...
        for (
          var k = this.spliceOperationsFromEditDistances(
              this.calcEditDistances(a, b, c, d, e, f)
            ),
            j = void 0,
            l = [],
            m = b,
      ...
      sharedSuffix: function (a, b, c) {
        for (
          var d = a.length, e = b.length, f = 0;
          c > f && this.equals(a[--d], b[--e]);
  ...
  Platform.flags.shadow
    ? ((window.ShadowDOMPolyfill = {}),
      (function (a) {
        ...
        function l(a) {
          return I && k(a)
            ? new Function("return this.impl." + a)
            : function () {
                return this.impl[a];
              };
        }
        ...
        function p(b, c, d) {
          for (var e = M(b), f = 0; f < e.length; f++) {
            ...
            if (
              "polymerBlackList_" !== g &&
              !(g in c || (b.polymerBlackList_ && b.polymerBlackList_[g]))
            ) {
              ...
              if (d && "function" == typeof k.value) c[g] = n(g);
                ...
                var p = j(g);
                (h = p ? a.getEventHandlerGetter(g) : l(g)),
                  (k.writable || k.set) &&
                    (i = p ? a.getEventHandlerSetter(g) : m(g)),
                  L(c, g, {
                    get: h,
                    set: i,
        ...
        function v(a) {
          return (
            a instanceof H.EventTarget ||
            a instanceof H.Event ||
            a instanceof H.Range ||
            a instanceof H.DOMImplementation ||
            a instanceof H.CanvasRenderingContext2D ||
            (H.WebGLRenderingContext && a instanceof H.WebGLRenderingContext)
          );
        }
        function w(a) {
          return (
        ...
        function x(a) {
          return null === a
            ? null
            : (b(w(a)),
              a.polymerWrapper_ || (a.polymerWrapper_ = new (g(a))(a)));
        }
        function y(a) {
        ...
        function B(a, c) {
          null !== c &&
            (b(w(a)), b(void 0 === c || v(c)), (a.polymerWrapper_ = c));
        }
        function C(a, b, c) {
        ...
        var L = Object.defineProperty,
          ...
          O = { value: void 0, configurable: !0, enumerable: !1, writable: !0 };
        M(window);
        var P = /Firefox/.test(navigator.userAgent),
          ...
          $ = { get: void 0, configurable: !0, enumerable: !0 };
        (a.assert = b),
          (a.constructorTable = F),
          (a.defineGetter = C),
          (a.defineWrapGetter = D),
          (a.forwardMethodsToWrapper = E),
          (a.isWrapper = v),
          (a.isWrapperFor = s),
          (a.mixin = c),
          (a.nativePrototypeTable = G),
          (a.oneOf = e),
          (a.registerObject = t),
          (a.registerWrapper = q),
          (a.rewrap = B),
      ...
      (function (a) {
        ...
        function d(a, b) {
          (this.type = a),
            (this.target = b),
            (this.addedNodes = new m.NodeList()),
            (this.removedNodes = new m.NodeList()),
        ...
        function g(a, c, e) {
          for (
            var f = Object.create(null), g = Object.create(null), h = a;
            h;
            h = h.parentNode
          ) {
            var i = n.get(h);
                ...
                if (
                  ...
                  !(
                    ...
                    ("attributes" === c &&
                      l.attributeFilter &&
                      (null !== e.namespace ||
                        -1 === l.attributeFilter.indexOf(e.name))) ||
                    ("characterData" === c && !l.characterData) ||
                    ("childList" === c && !l.childList)
                  )
                ) {
                  var m = k.observer;
                  (f[m.uid_] = m),
                    (("attributes" === c && l.attributeOldValue) ||
                      ("characterData" === c && l.characterDataOldValue)) &&
                      (g[m.uid_] = e.oldValue);
                }
              }
          }
          ...
          for (var p in f) {
            ...
            "name" in e &&
              "namespace" in e &&
              ((q.attributeName = e.name),
              (q.attributeNamespace = e.namespace)),
              e.addedNodes && (q.addedNodes = e.addedNodes),
              e.removedNodes && (q.removedNodes = e.removedNodes),
              e.previousSibling && (q.previousSibling = e.previousSibling),
              e.nextSibling && (q.nextSibling = e.nextSibling),
              void 0 !== g[p] && (q.oldValue = g[p]),
              m.records_.push(q),
              (o = !0);
          }
          o && b();
        ...
        function h(a) {
          if (
            ((this.childList = !!a.childList),
            (this.subtree = !!a.subtree),
            (this.attributes =
              "attributes" in a ||
              !("attributeOldValue" in a || "attributeFilter" in a)
                ? !!a.attributes
                : !0),
            (this.characterData =
              "characterDataOldValue" in a && !("characterData" in a)
                ? !0
                : !!a.characterData),
            (!this.attributes &&
              (a.attributeOldValue || "attributeFilter" in a)) ||
              (!this.characterData && a.characterDataOldValue))
          )
            throw new TypeError();
          if (
            ((this.characterData = !!a.characterData),
            (this.attributeOldValue = !!a.attributeOldValue),
            (this.characterDataOldValue = !!a.characterDataOldValue),
            "attributeFilter" in a)
          ) {
            if (
              null == a.attributeFilter ||
        ...
        (i.prototype = {
          observe: function (a, b) {
            ...
            for (var f = 0; f < e.length; f++)
              e[f].observer === this &&
                ((c = e[f]), c.removeTransientObservers(), (c.options = d));
          ...
          (a.enqueueMutation = g),
          (a.registerTransientObservers = e),
          (a.wrappers.MutationObserver = i),
          (a.wrappers.MutationRecord = d);
      })(window.ShadowDOMPolyfill),
      (function (a) {
        "use strict";
        function b(a, b) {
        ...
        function c(a, b) {
          if (a.treeScope_ !== b) {
            a.treeScope_ = b;
            for (var d = a.shadowRoot; d; d = d.olderShadowRoot)
              d.treeScope_.parent = b;
        ...
        (b.prototype = {
          get renderer() {
            return this.root instanceof a.wrappers.ShadowRoot
              ? a.getRendererForHost(this.root.host)
              : null;
          },
          contains: function (a) {
      ...
      (function (a) {
        ...
        function f(f, g, h) {
          ...
          if (g && c(f)) {
            ...
            if (l && d(l))
              for (
                var m = a.getShadowTrees(l), n = j(g), k = 0;
                k < m.length;
                k++
              )
        ...
        function g(a) {
          for (var d = [], e = a, g = [], i = []; e; ) {
            ...
            var l = d[d.length - 1];
            g.push({ target: l, currentTarget: e }),
              b(e) && d.pop(),
              (e = f(e, j, i));
          }
          return g;
        ...
        function h(a) {
          for (var b = a.length - 1; b >= 0; b--) if (!c(a[b])) return a[b];
          return null;
        }
        function i(a, d) {
          for (var e = []; a; ) {
        ...
        function o(b, c) {
          ...
          return (
            2 === d.length &&
              d[0].target instanceof R.Document &&
              n(b) &&
              d.shift(),
            ab.set(b, d),
            p(b, d) && q(b, d) && r(b, d),
        ...
        function s(a, b, c) {
          ...
          for (var n = 0; n < f.length; n++) {
            ...
            if (o.removed) m = !0;
              ...
              !(
                o.type !== l ||
                (!o.capture && c === u.CAPTURING_PHASE) ||
                (o.capture && c === u.BUBBLING_PHASE)
              )
            )
              try {
                if (
        ...
        function u(a, b) {
          ...
          var c = a;
          return mb || "beforeunload" !== c.type
            ? void (this.impl = c)
            : new z(c);
        }
        function v(a) {
          return a && a.relatedTarget
            ? Object.create(a, { relatedTarget: { value: P(a.relatedTarget) } })
            : a;
        }
        function w(a, b, c) {
          var d = window[a],
        ...
        function F(a, b) {
          for (var c = P(a); c; c = c.parentNode) if (E(Q(c), b)) return !0;
          return !1;
        }
        function G(a) {
          L(a, ob);
        ...
        function H(b, c, d, e) {
          a.renderAllPending();
          for (
            var f = Q(pb.call(c.impl, d, e)), h = g(f, this), i = 0;
            i < h.length;
            i++
          ) {
            var j = h[i];
        ...
        function J(a) {
          ...
          return function (c) {
            ...
            var e = d[a];
            if (
              (e && this.removeEventListener(b, e.wrapped, !1),
              "function" == typeof c)
            ) {
              var f = function (b) {
                var d = c.call(this, b);
              ...
              this.addEventListener(b, f, !1),
                (d[a] = { value: c, wrapped: f });
            }
          };
        }
        var K,
          L = a.forwardMethodsToWrapper,
          M = a.getTreeScope,
          N = a.mixin,
          O = a.registerWrapper,
          P = a.unwrap,
        ...
        var bb = window.Event;
        (bb.prototype.polymerBlackList_ = { returnValue: !0, keyLocation: !0 }),
          (u.prototype = {
            get target() {
              return V.get(this);
            },
            ...
            get path() {
              ...
              if (b) {
                for (
                  var c = 0, d = b.length - 1, e = M(W.get(this)), f = 0;
                  d >= f;
                  f++
                ) {
        ...
        var cb = w("UIEvent", u),
          ...
          fb = N({ initMouseEvent: x("initMouseEvent", 14) }, eb),
          gb = N({ initFocusEvent: x("initFocusEvent", 5) }, eb),
        ...
        if (!kb) {
          ...
          lb("Event", { bubbles: !1, cancelable: !1 }),
            lb("CustomEvent", { detail: null }, "Event"),
            lb("UIEvent", { view: null, detail: 0 }, "Event"),
            lb(
              "MouseEvent",
              {
                screenX: 0,
            ...
            lb("FocusEvent", { relatedTarget: null }, "UIEvent");
        }
        ...
        [Node, Window].forEach(function (a) {
          ...
          (C.prototype = {
            ...
            removeEventListener: function (a, b, c) {
              ...
              var d = S.get(this);
              if (d) {
                for (var e = 0, f = !1, g = 0; g < d.length; g++)
                  d[g].type === a &&
                    d[g].capture === c &&
                    (e++, d[g].handler === b && ((f = !0), d[g].remove()));
                if (f && 1 === e) {
                  var h = D(this);
            ...
            dispatchEvent: function (b) {
              ...
              var e;
              F(this, d) ||
                ((e = function () {}), this.addEventListener(d, e, !0));
              try {
        ...
        (a.adjustRelatedTarget = i),
          (a.elementFromPoint = H),
          (a.getEventHandlerGetter = I),
          (a.getEventHandlerSetter = J),
          (a.wrapEventTargetMethods = G),
          (a.wrappers.BeforeUnloadEvent = z),
          (a.wrappers.CustomEvent = db),
          (a.wrappers.Event = u),
          (a.wrappers.EventTarget = C),
          (a.wrappers.FocusEvent = ib),
          (a.wrappers.MouseEvent = hb),
          (a.wrappers.UIEvent = cb);
      })(window.ShadowDOMPolyfill),
      (function (a) {
        "use strict";
        function b(a, b) {
        ...
        (c.prototype = {
          ...
          b(c.prototype, "item"),
          (a.wrappers.NodeList = c),
          (a.addWrapNodeListMethod = e),
          (a.wrapNodeList = d);
      })(window.ShadowDOMPolyfill),
      (function (a) {
        "use strict";
        (a.wrapHTMLCollection = a.wrapNodeList),
          (a.wrappers.HTMLCollection = a.wrappers.NodeList);
      })(window.ShadowDOMPolyfill),
      (function (a) {
        "use strict";
        function b(a) {
        ...
        function f(a, b, d, e) {
          if (a instanceof DocumentFragment) {
            ...
            for (var g = f.length - 1; g >= 0; g--)
              a.removeChild(f[g]), (f[g].parentNode_ = b);
            O = !1;
            for (var g = 0; g < f.length; g++)
              (f[g].previousSibling_ = f[g - 1] || d),
                (f[g].nextSibling_ = f[g + 1] || e);
            return (
              d && (d.nextSibling_ = f[0]),
              e && (e.previousSibling_ = f[f.length - 1]),
              f
            );
          }
          var f = c(a),
          ...
          return (
            i && i.removeChild(a),
            (a.parentNode_ = b),
            (a.previousSibling_ = d),
            (a.nextSibling_ = e),
            d && (d.nextSibling_ = a),
            e && (e.previousSibling_ = a),
            f
          );
        }
        function g(a) {
        ...
        function h(a) {
          for (var b = new y(), c = 0, d = a.firstChild; d; d = d.nextSibling)
            b[c++] = d;
        ...
        function p(a, b) {
          ...
          if (1 === c) return J(b[0]);
          for (
            var d = J(a.ownerDocument.createDocumentFragment()), e = 0;
            c > e;
            e++
          )
            d.appendChild(J(b[e]));
        ...
        function q(a) {
          if (void 0 !== a.firstChild_)
            for (var b = a.firstChild_; b; ) {
              var c = b;
              (b = b.nextSibling_),
                (c.parentNode_ = c.previousSibling_ = c.nextSibling_ = void 0);
            }
          ...
          if (a.invalidateShadowRenderer()) {
            for (var b = a.firstChild; b; ) {
              ...
              var c = b.nextSibling,
                ...
                e = d.parentNode;
              e && V.call(e, d),
                (b.previousSibling_ = b.nextSibling_ = b.parentNode_ = null),
                (b = c);
            }
            a.firstChild_ = a.lastChild_ = null;
          } else
            for (var c, f = J(a), g = f.firstChild; g; )
              (c = g.nextSibling), V.call(f, g), (g = c);
        }
        function s(a) {
          var b = a.parentNode;
        ...
        function u(a, b, c) {
          ...
          if (((d = L(c ? P.call(c, a.impl, !1) : Q.call(a.impl, !1))), b)) {
            for (var e = a.firstChild; e; e = e.nextSibling)
              d.appendChild(u(e, !0, c));
            if (a instanceof N.HTMLTemplateElement)
              for (
                var f = d.content, e = a.content.firstChild;
                e;
                e = e.nextSibling
              )
                f.appendChild(u(e, !0, c));
          }
          return d;
        }
        function v(a, b) {
          ...
          F(w.prototype, {
            ...
            insertBefore: function (a, c) {
              ...
              c
                ? E(c)
                  ...
                  : ((d = c), (c = L(d)))
                : ((c = null), (d = null)),
                c && A(c.parentNode === this);
              var e,
                h = c ? c.previousSibling : this.lastChild,
                i = !this.invalidateShadowRenderer() && !s(a);
              if (((e = i ? g(a) : f(a, this, h, c)), i))
                n(this, a), q(this), U.call(this.impl, J(a), d);
              else {
                h || (this.firstChild_ = e[0]),
                  c || (this.lastChild_ = e[e.length - 1]);
            ...
            removeChild: function (a) {
              if ((b(a), a.parentNode !== this)) {
                for (
                  var d = !1, e = (this.childNodes, this.firstChild);
                  e;
                  e = e.nextSibling
                )
                  if (e === a) {
              ...
              if (this.invalidateShadowRenderer()) {
                var i = this.firstChild,
                  ...
                  k = f.parentNode;
                k && Y(k, f),
                  i === a && (this.firstChild_ = g),
                  j === a && (this.lastChild_ = h),
                  h && (h.nextSibling_ = g),
                  g && (g.previousSibling_ = h),
                  (a.previousSibling_ =
                    a.nextSibling_ =
                    a.parentNode_ =
                      void 0);
            ...
            replaceChild: function (a, d) {
              ...
              return (
                m
                  ? (h = g(a))
                  : (i === a && (i = a.nextSibling), (h = f(a, this, j, i))),
                m
                  ? (n(this, a), q(this), W.call(this.impl, J(a), e))
                  : (this.firstChild === d && (this.firstChild_ = h[0]),
                    this.lastChild === d && (this.lastChild_ = h[h.length - 1]),
                    (d.previousSibling_ =
                      d.nextSibling_ =
                      d.parentNode_ =
                        void 0),
                    e.parentNode && W.call(e.parentNode, p(this, h), e)),
                C(this, "childList", {
                  addedNodes: h,
                  removedNodes: c(d),
                  nextSibling: i,
            ...
            get textContent() {
              for (var a = "", b = this.firstChild; b; b = b.nextSibling)
                b.nodeType != w.COMMENT_NODE && (a += b.textContent);
              return a;
            },
            set textContent(a) {
              ...
              C(this, "childList", { addedNodes: d, removedNodes: b }),
                m(b),
                k(d, this);
            },
            get childNodes() {
              for (
                var a = new y(), b = 0, c = this.firstChild;
                c;
                c = c.nextSibling
              )
                a[b++] = c;
            ...
            normalize: function () {
              for (
                var a, b, c = i(this.childNodes), d = [], e = "", f = 0;
                f < c.length;
                f++
              )
                (b = c[f]),
                  b.nodeType === w.TEXT_NODE
                    ? a || b.data.length
                      ? a
                        ? ((e += b.data), d.push(b))
                        : (a = b)
                      : this.removeNode(b)
                    : (a && d.length && ((a.data += e), cleanUpNodes(d)),
                      (d = []),
                      (e = ""),
                      (a = null),
                      b.childNodes.length && b.normalize());
              a && d.length && ((a.data += e), t(d));
            },
          }),
          B(w, "ownerDocument"),
          H(R, w, document.createDocumentFragment()),
          delete w.prototype.querySelector,
          delete w.prototype.querySelectorAll,
          (w.prototype = F(Object.create(x.prototype), w.prototype)),
          (a.cloneNode = u),
          (a.nodeWasAdded = j),
          (a.nodeWasRemoved = l),
          (a.nodesWereAdded = k),
          (a.nodesWereRemoved = m),
          (a.snapshotNodeList = i),
          (a.wrappers.Node = w);
      })(window.ShadowDOMPolyfill),
      (function (a) {
        "use strict";
        ...
        function i(a, b, c, d, e) {
          for (var f = a.firstElementChild; f; )
            c(f, d, e) && (b[b.length++] = f),
              i(f, b, c, d, e),
          ...
          n = {
            ...
            getElementsByTagNameNS: function (a, b) {
              ...
              if ("" === a) a = null;
                ...
                return "*" === b ? i(this, c, e) : i(this, c, f, b);
        ...
        var d = a.wrappers.NodeList,
          e = {
            ...
            get childElementCount() {
              for (
                var a = 0, b = this.firstElementChild;
                b;
            ...
            get children() {
              for (
                var a = new d(), b = 0, c = this.firstElementChild;
                c;
        ...
        (b.prototype = Object.create(d.prototype)),
          f(b.prototype, {
            ...
            set data(a) {
              ...
              e(this, "characterData", { oldValue: b }), (this.impl.data = a);
            },
          }),
          f(b.prototype, c),
          g(h, b, document.createTextNode("")),
          (a.wrappers.CharacterData = b);
      })(window.ShadowDOMPolyfill),
      (function (a) {
        "use strict";
        function b(a) {
      ...
      (function (a) {
        ...
        (d.prototype = Object.create(h.prototype)),
          ...
          o.prototype.webkitCreateShadowRoot &&
            (d.prototype.webkitCreateShadowRoot = d.prototype.createShadowRoot),
          e(d.prototype, "id"),
          e(d.prototype, "className", "class"),
          l(d.prototype, f),
          l(d.prototype, g),
          l(d.prototype, i),
          l(d.prototype, j),
          m(o, d, document.createElementNS(null, "x")),
          (a.matchesNames = p),
          (a.wrappers.Element = d);
      })(window.ShadowDOMPolyfill),
      (function (a) {
        "use strict";
        function b(a) {
        ...
        function j(a, b) {
          ...
          c.innerHTML = b;
          for (
            var d, e = w(document.createDocumentFragment());
            (d = c.firstChild);
        ...
        function n(b) {
          Object.defineProperty(i.prototype, b, {
            value: function () {
              return (
                a.renderAllPending(), this.impl[b].apply(this.impl, arguments)
              );
            },
            configurable: !0,
            enumerable: !0,
        ...
        (i.prototype = Object.create(o.prototype)),
          r(i.prototype, {
            ...
            set innerHTML(a) {
              ...
              this.invalidateShadowRenderer()
                ? this instanceof y.HTMLTemplateElement
                  ? h(this.content, a)
                  : h(this, a, this.tagName)
                : !F && this instanceof y.HTMLTemplateElement
                ? h(this.content, a)
                : (this.impl.innerHTML = a);
              var c = v(this.childNodes);
              q(this, "childList", { addedNodes: c, removedNodes: b }),
                t(b),
                s(c, this);
            },
            get outerHTML() {
          ...
          ["scrollLeft", "scrollTop"].forEach(m),
          ["getBoundingClientRect", "getClientRects", "scrollIntoView"].forEach(
            n
          ),
          u(E, i, document.createElement("b")),
          (a.wrappers.HTMLElement = i),
          (a.getInnerHTML = g),
          (a.setInnerHTML = h);
      })(window.ShadowDOMPolyfill),
      (function (a) {
        ...
        (b.prototype = Object.create(c.prototype)),
          ...
          e(g, b, document.createElement("canvas")),
          (a.wrappers.HTMLCanvasElement = b);
      })(window.ShadowDOMPolyfill),
      (function (a) {
        "use strict";
        function b(a) {
        ...
        (b.prototype = Object.create(c.prototype)),
          d(b.prototype, {
            ...
            setAttribute: function (a, b) {
              c.prototype.setAttribute.call(this, a, b),
                "select" === String(a).toLowerCase() &&
                  this.invalidateShadowRenderer(!0);
            },
          }),
          f && e(f, b),
          (a.wrappers.HTMLContentElement = b);
      })(window.ShadowDOMPolyfill),
      (function (a) {
        "use strict";
        function b(a) {
        ...
        (b.prototype = Object.create(d.prototype)),
          e(h, b, document.createElement("img")),
          (c.prototype = b.prototype),
          (a.wrappers.HTMLImageElement = b),
          (a.wrappers.Image = c);
      })(window.ShadowDOMPolyfill),
      (function (a) {
        "use strict";
        ...
        (b.prototype = Object.create(c.prototype)),
          d(b.prototype, {}),
          f && e(f, b),
          (a.wrappers.HTMLShadowElement = b);
      })(window.ShadowDOMPolyfill),
      (function (a) {
        "use strict";
        function b(a) {
          ...
          var b = k.get(a);
          if (!b) {
            for (b = a.implementation.createHTMLDocument(""); b.lastChild; )
        ...
        function c(a) {
          for (
            var c, d = b(a.ownerDocument), e = h(d.createDocumentFragment());
            (c = a.firstChild);
        ...
        (d.prototype = Object.create(e.prototype)),
          ...
          l && g(l, d),
          (a.wrappers.HTMLTemplateElement = d);
      })(window.ShadowDOMPolyfill),
      (function (a) {
        "use strict";
        function b(a) {
        ...
        (b.prototype = Object.create(c.prototype)),
          d(e, b, document.createElement("audio")),
          (a.wrappers.HTMLMediaElement = b);
      })(window.ShadowDOMPolyfill),
      (function (a) {
        "use strict";
        function b(a) {
        ...
        (b.prototype = Object.create(d.prototype)),
          e(h, b, document.createElement("audio")),
          (c.prototype = b.prototype),
          (a.wrappers.HTMLAudioElement = b),
          (a.wrappers.Audio = c);
      })(window.ShadowDOMPolyfill),
      (function (a) {
        "use strict";
        ...
        function d(a, b, c, f) {
          ...
          e.call(this, g),
            h(g, this),
            void 0 !== a && (g.text = a),
            void 0 !== b && g.setAttribute("value", b),
            c === !0 && g.setAttribute("selected", ""),
            (g.selected = f === !0);
        }
        var e = a.wrappers.HTMLElement,
          f = a.mixin,
        ...
        (c.prototype = Object.create(e.prototype)),
          ...
          g(k, c, document.createElement("option")),
          (d.prototype = c.prototype),
          (a.wrappers.HTMLOptionElement = c),
          (a.wrappers.Option = d);
      })(window.ShadowDOMPolyfill),
      (function (a) {
        "use strict";
        ...
        (b.prototype = Object.create(c.prototype)),
          d(b.prototype, {
            ...
            remove: function (a) {
              return void 0 === a
                ? void c.prototype.remove.call(this)
                : ("object" == typeof a && (a = f(a)), void f(this).remove(a));
            },
            get form() {
              return g(f(this).form);
            },
          }),
          e(h, b, document.createElement("select")),
          (a.wrappers.HTMLSelectElement = b);
      })(window.ShadowDOMPolyfill),
      (function (a) {
        "use strict";
        function b(a) {
        ...
        (b.prototype = Object.create(c.prototype)),
          ...
          e(i, b, document.createElement("table")),
          (a.wrappers.HTMLTableElement = b);
      })(window.ShadowDOMPolyfill),
      (function (a) {
        "use strict";
        function b(a) {
        ...
        (b.prototype = Object.create(c.prototype)),
          ...
          e(i, b, document.createElement("thead")),
          (a.wrappers.HTMLTableSectionElement = b);
      })(window.ShadowDOMPolyfill),
      (function (a) {
        "use strict";
        function b(a) {
        ...
        (b.prototype = Object.create(c.prototype)),
          ...
          e(i, b, document.createElement("tr")),
          (a.wrappers.HTMLTableRowElement = b);
      })(window.ShadowDOMPolyfill),
      (function (a) {
        "use strict";
        function b(a) {
        ...
        (b.prototype = Object.create(d.prototype)),
          g(h, b),
          (a.wrappers.HTMLUnknownElement = b);
      })(window.ShadowDOMPolyfill),
      (function (a) {
        "use strict";
      ...
      (function (a) {
        ...
        g &&
          ...
          e(g, b),
          (a.wrappers.SVGElementInstance = b));
      })(window.ShadowDOMPolyfill),
      (function (a) {
        "use strict";
        function b(a) {
        ...
        c(b.prototype, {
          ...
          createPattern: function () {
            return (
              ...
              this.impl.createPattern.apply(this.impl, arguments)
            );
          },
        }),
          d(h, b, document.createElement("canvas").getContext("2d")),
          (a.wrappers.CanvasRenderingContext2D = b);
      })(window.ShadowDOMPolyfill),
      (function (a) {
        "use strict";
        function b(a) {
        ...
        if (g) {
          c(b.prototype, {
            ...
            texImage2D: function () {
              (arguments[5] = e(arguments[5])),
                this.impl.texImage2D.apply(this.impl, arguments);
            },
            texSubImage2D: function () {
              (arguments[6] = e(arguments[6])),
      ...
      (function (a) {
        ...
        (b.prototype = {
          ...
          g.prototype.createContextualFragment &&
            (b.prototype.createContextualFragment = function (a) {
              return f(this.impl.createContextualFragment(a));
            }),
          c(window.Range, b, document.createRange()),
          (a.wrappers.Range = b);
      })(window.ShadowDOMPolyfill),
      (function (a) {
        "use strict";
      ...
      (function (a) {
        "use strict";
        function b(a) {
          (a.previousSibling_ = a.previousSibling),
            (a.nextSibling_ = a.nextSibling),
            (a.parentNode_ = a.parentNode);
        }
        function c(a, c, e) {
          var f = G(a),
            g = G(c),
            h = e ? G(e) : null;
          if ((d(c), b(c), e))
            a.firstChild === e && (a.firstChild_ = e),
              (e.previousSibling_ = e.previousSibling);
          else {
            (a.lastChild_ = a.lastChild),
              a.lastChild === a.firstChild && (a.firstChild_ = a.firstChild);
            var i = H(f.lastChild);
        ...
        function d(a) {
          ...
          if (d) {
            var e = H(d);
            b(a),
              a.previousSibling && (a.previousSibling.nextSibling_ = a),
              a.nextSibling && (a.nextSibling.previousSibling_ = a),
              e.lastChild === a && (e.lastChild_ = a),
              e.firstChild === a && (e.firstChild_ = a),
              d.removeChild(c);
          }
        }
        function e(a, b) {
        ...
        function h(a) {
          for (var b = [], c = 0, d = a.firstChild; d; d = d.nextSibling)
            b[c++] = d;
          return b;
        }
        function i(a, b, c) {
        ...
        function w(a) {
          for (var b = [], c = a.shadowRoot; c; c = c.olderShadowRoot)
            b.push(c);
          return b;
        }
        function x(a, b) {
        ...
        (Q.equals = function (a, b) {
            ...
            sync: function (a) {
              if (!this.skip) {
                for (
                  ...
                  for (
                    var r = n.addedCount, s = f[k] && H(f[k]), p = 0;
                    r > p;
                    p++
                  ) {
                    var t = e[j++],
          ...
          (q.prototype = {
            render: function (a) {
              if (this.dirty) {
                ...
                for (
                  var d = !e, e = a || new p(b), f = c.firstChild;
                  f;
                  f = f.nextSibling
                )
                  this.renderNode(c, e, f, !1);
            ...
            renderNode: function (a, b, c, d) {
              if (v(c)) {
                ...
                r(c)
                  ...
                  : t(c)
                  ? this.renderShadowInsertionPoint(a, b, c)
            ...
            renderInsertionPoint: function (a, b, c, d) {
              ...
              if (e.length) {
                ...
                for (var f = 0; f < e.length; f++) {
                  var h = e[f];
                  r(h) && d
                    ? this.renderInsertionPoint(a, b, h, d)
                    : this.renderAsAnyDomTree(a, b, h, d);
                }
            ...
            renderFallbackContent: function (a, b, c) {
              ...
              for (var d = c.firstChild; d; d = d.nextSibling)
                this.renderAsAnyDomTree(a, b, d, !1);
            },
            ...
            treeComposition: function () {
              for (
                var a = this.host, b = a.shadowRoot, c = [], d = a.firstChild;
                d;
                d = d.nextSibling
              )
                if (r(d)) {
          ...
          (B.prototype.nodeIsInserted_ = A.prototype.nodeIsInserted_ =
            function () {
              this.invalidateShadowRenderer();
              var a,
                b = n(this);
              b && (a = o(b)),
                (this.impl.polymerShadowRenderer_ = a),
                a && a.invalidate();
            }),
          (a.eventParentsTable = J),
          (a.getRendererForHost = m),
          (a.getShadowTrees = w),
          (a.insertionParentTable = K),
          (a.renderAllPending = k),
          (a.visual = { insertBefore: c, remove: d });
      })(window.ShadowDOMPolyfill),
      (function (a) {
        "use strict";
        function b(b) {
          if (window[b]) {
            ...
            (i.prototype = Object.create(c.prototype)),
              ...
              f(window[b], i, document.createElement(b.slice(4, -7))),
              (a.wrappers[b] = i);
          }
        }
        var c = a.wrappers.HTMLElement,
      ...
      (function (a) {
        ...
        (b.prototype = {
          ...
          c(window.Selection, b, window.getSelection()),
          (a.wrappers.Selection = b);
      })(window.ShadowDOMPolyfill),
      (function (a) {
        "use strict";
        function b(a) {
          ...
          (b.prototype.registerElement = function (b, c) {
            function d(a) {
              return a
                ? void (this.impl = a)
                : f
                ? document.createElement(f, b)
                : document.createElement(b);
            }
            var e, f;
            if (
              (void 0 !== c && ((e = c.prototype), (f = c.extends)),
              e || (e = Object.create(HTMLElement.prototype)),
              a.nativePrototypeTable.get(e))
            )
              throw new Error("NotSupportedError");
            for (
              var g, h = Object.getPrototypeOf(e), i = [];
              h && !(g = a.nativePrototypeTable.get(h));

            )
              i.push(h), (h = Object.getPrototypeOf(h));
            if (!g) throw new Error("NotSupportedError");
            for (var j = Object.create(g), k = i.length - 1; k >= 0; k--)
              j = Object.create(j);
            [
              "createdCallback",
              "attachedCallback",
            ...
            f && (l.extends = f),
              ...
              a.constructorTable.set(j, d),
              a.nativePrototypeTable.set(e, j);
            F.call(z(this), b, l);
            return d;
          }),
        ...
        t(
          ...
          v(b.prototype, {
            get implementation() {
              ...
              return a
                ? a
                : ((a = new g(z(this).implementation)), C.set(this, a), a);
            },
          }),
          w(window.Document, b, document.implementation.createHTMLDocument("")),
          window.HTMLDocument && w(window.HTMLDocument, b),
          B([
            window.HTMLBodyElement,
            window.HTMLDocument || window.Document,
            window.HTMLHeadElement,
          ]),
          h(g, "createDocumentType"),
          h(g, "createDocument"),
          h(g, "createHTMLDocument"),
          i(g, "hasFeature"),
          w(window.DOMImplementation, g),
          t(
          ...
          (a.adoptNodeNoRemove = d),
          (a.wrappers.DOMImplementation = g),
          (a.wrappers.Document = b);
      })(window.ShadowDOMPolyfill),
      (function (a) {
        "use strict";
        function b(a) {
        ...
        (b.prototype = Object.create(c.prototype)),
          (k.prototype.getComputedStyle = function (a, b) {
      ...
      (function (a) {
        ...
        Object.keys(c).forEach(b),
          Object.getOwnPropertyNames(a.wrappers).forEach(function (b) {
      ...
      (function (a) {
        ...
        var k = {
            ...
            shimStyling: function (a, c, d) {
              var e = this.prepareRoot(a, c, d),
                ...
                h = b(e, !0);
              (h = this.scopeCssText(h, g)),
                a && (a.shimmedStyle = h),
                this.addCssToDocument(h, c);
            },
            ...
            prepareRoot: function (a, b, c) {
              ...
              return (
                this.replaceTextInStyles(d.rootStyles, this.insertDirectives),
                this.removeStyles(a, d.rootStyles),
            ...
            registerRoot: function (a, b, c) {
              var d = (this.registry[b] = { root: a, name: b, extendsName: c }),
                e = this.findStyles(a);
              (d.rootStyles = e), (d.scopeStyles = d.rootStyles);
              var f = this.registry[d.extendsName];
              return (
                f && (d.scopeStyles = f.scopeStyles.concat(d.scopeStyles)), d
              );
            },
            ...
            scopeCssText: function (a, b) {
              ...
              if (
                ((a = this.insertPolyfillHostInCssText(a)),
                (a = this.convertColonHost(a)),
                (a = this.convertColonHostContext(a)),
                (a = this.convertCombinators(a)),
                b)
              ) {
                var a,
                  d = this;
            ...
            extractUnscopedRulesFromCssText: function (a) {
              for (var b, c = ""; (b = q.exec(a)); )
                c += b[1].slice(0, -1) + "\n\n";
              for (; (b = r.exec(a)); )
                c += b[0].replace(b[2], "").replace(b[1], b[3]) + "\n\n";
              return c;
            },
            ...
            convertColonRule: function (a, b, c) {
              return a.replace(b, function (a, b, d, e) {
                if (((b = polyfillHostNoCombinator), d)) {
                  for (
                    var f, g = d.split(","), h = [], i = 0, j = g.length;
                    j > i && (f = g[i]);
                    i++
                  )
                    (f = f.trim()), h.push(c(b, f, e));
                  return h.join(",");
                }
                return b + e;
              });
            ...
            colonHostContextPartReplacer: function (a, b, c) {
              return b.match(s)
                ? this.colonHostPartReplacer(a, b, c)
                : a + b + c + ", " + b + " " + a + c;
            },
            ...
            convertCombinators: function (a) {
              for (var b = 0; b < combinatorsRe.length; b++)
                a = a.replace(combinatorsRe[b], " ");
              return a;
            },
              ...
              return (
                a &&
                  Array.prototype.forEach.call(
                    a,
                    function (a) {
                      a.selectorText && a.style && a.style.cssText
                        ? ((c +=
                            this.scopeSelector(
                              a.selectorText,
                              b,
                        ...
                        ? ((c += "@media " + a.media.mediaText + " {\n"),
                          (c += this.scopeRules(a.cssRules, b)),
                          (c += "\n}\n\n"))
            ...
            scopeSelector: function (a, b, c) {
              ...
              return (
                e.forEach(function (a) {
                  (a = a.trim()),
                    this.selectorNeedsScoping(a, b) &&
                      (a =
                        c && !a.match(polyfillHostNoCombinator)
                          ? this.applyStrictSelectorScope(a, b)
                          : this.applySelectorScope(a, b)),
                    d.push(a);
                }, this),
                d.join(", ")
              );
            ...
            makeScopeMatcher: function (a) {
              return (
                ...
                new RegExp("^(" + a + ")" + selectorReSuffix, "m")
              );
            },
            applySelectorScope: function (a, b) {
              return Array.isArray(b)
                ? this.applySelectorScopeList(a, b)
                : this.applySimpleSelectorScope(a, b);
            },
            applySelectorScopeList: function (a, b) {
              for (var c, d = [], e = 0; (c = b[e]); e++)
                d.push(this.applySimpleSelectorScope(a, c));
              return d.join(", ");
            },
            applySimpleSelectorScope: function (a, b) {
              return a.match(polyfillHostRe)
                ? ((a = a.replace(polyfillHostNoCombinator, b)),
                  a.replace(polyfillHostRe, b + " "))
                : b + " " + a;
            },
            ...
            propertiesFromRule: function (a) {
              ...
              a.style.content &&
                !a.style.content.match(/['"]+|attr/) &&
                (b = b.replace(
                  /content:[^;]*;/g,
                  "content: '" + a.style.content + "';"
                ));
              var c = a.style;
          ...
          m = /\/\*\s*@polyfill ([^*]*\*+([^/*][^*]*\*+)*\/)([^{]*?){/gim,
          n =
            /polyfill-next-selector[^}]*content\:[\s]*'([^']*)'[^}]*}([^{]*?){/gim,
          o = /\/\*\s@polyfill-rule([^*]*\*+([^/*][^*]*\*+)*)\//gim,
          p = /(polyfill-rule)[^}]*(content\:[\s]*'([^']*)'[^;]*;)[^}]*}/gim,
          q = /\/\*\s@polyfill-unscoped-rule([^*]*\*+([^/*][^*]*\*+)*)\//gim,
          r =
            /(polyfill-unscoped-rule)[^}]*(content\:[\s]*'([^']*)'[^;]*;)[^}]*}/gim,
          s = "-shadowcsshost",
          t = "-shadowcsscontext",
          u = ")(?:\\(((?:\\([^)(]*\\)|[^)(]*)+?)\\))?([^,{]*)";
        (cssColonHostRe = new RegExp("(" + s + u, "gim")),
          (cssColonHostContextRe = new RegExp("(" + t + u, "gim")),
          (selectorReSuffix = "([>\\s~+[.,{:][\\s\\S]*)?$"),
          (colonHostRe = /\:host/gim),
          (colonHostContextRe = /\:host-context/gim),
          (polyfillHostNoCombinator = s + "-no-combinator"),
          (polyfillHostRe = new RegExp(s, "gim")),
          (polyfillHostContextRe = new RegExp(t, "gim")),
          (combinatorsRe = [
            /\^\^/g,
            /\^/g,
            /\/shadow\//g,
        ...
        var w,
          x = navigator.userAgent.match("Chrome"),
          y = "shim-shadowdom",
        ...
        if (window.ShadowDOMPolyfill) {
          ...
          C.insertBefore(j(), C.childNodes[0]),
            document.addEventListener("DOMContentLoaded", function () {
              var b = a.urlResolver;
              if (window.HTMLImports && !HTMLImports.useNative) {
                var c = "link[rel=stylesheet][" + y + "]",
                  d = "style[" + y + "]";
                (HTMLImports.importer.documentPreloadSelectors += "," + c),
                  (HTMLImports.importer.importsPreloadSelectors += "," + c),
                  ...
                  if (!a[z]) {
                    ...
                    a.__resource
                      ? ((c = a.ownerDocument.createElement("style")),
                        (c.textContent = b.resolveCssText(
                          a.__resource,
                          a.href
                        )))
                      : b.resolveStyle(c),
                      (c.textContent = k.shimStyle(c)),
                      c.removeAttribute(y, ""),
                      c.setAttribute(z, ""),
                      (c[z] = !0),
                      c.parentNode !== C &&
          ...
          (window.templateContent = function (a) {
            if (
              (window.HTMLTemplateElement &&
                ...
                HTMLTemplateElement.bootstrap(a),
              !a.content && !a._content)
            ) {
  ...
  (function (a) {
    ...
    function e(a) {
      ...
      return b > 32 && 127 > b && -1 == [34, 35, 60, 62, 63, 96].indexOf(b)
        ? a
        : encodeURIComponent(a);
    }
    function f(a) {
      var b = a.charCodeAt(0);
      return b > 32 && 127 > b && -1 == [34, 35, 60, 62, 96].indexOf(b)
        ? a
        : encodeURIComponent(a);
    }
    function g(a, g, h) {
        ...
        switch (j) {
          ...
          case "scheme":
            if (u && q.test(u)) l += u.toLowerCase();
              ...
              b(this._scheme) && (this._isRelative = !0),
                (j =
                  "file" == this._scheme
                    ? "relative"
                    : this._isRelative && h && h._scheme == this._scheme
          ...
          case "scheme data":
            "?" == u
              ? ((query = "?"), (j = "query"))
              : "#" == u
              ? ((this._fragment = "#"), (j = "fragment"))
              : o != u &&
                "	" != u &&
                "\n" != u &&
                "\r" != u &&
                (this._schemeData += e(u));
            break;
          case "no scheme":
            if (h && b(h._scheme)) {
              j = "relative";
          ...
          case "relative slash":
            if ("/" != u && "\\" != u) {
              "file" != this._scheme &&
                ((this._host = h._host), (this._port = h._port)),
                (j = "relative path");
              continue;
            }
            "\\" == u && i("\\ is an invalid code point."),
          ...
          case "file host":
            if (o == u || "/" == u || "\\" == u || "?" == u || "#" == u) {
              2 != l.length || !p.test(l[0]) || (":" != l[1] && "|" != l[1])
                ? 0 == l.length
                  ? (j = "relative path start")
                  : ((this._host = d.call(this, l)),
                    (l = ""),
                    (j = "relative path start"))
                : (j = "relative path");
              continue;
          ...
          case "hostname":
            if (":" != u || s) {
              ...
              "	" != u && "\n" != u && "\r" != u
                ? ("[" == u ? (s = !0) : "]" == u && (s = !1), (l += u))
                : i("Invalid code point in host/hostname: " + u);
            } else if (
              ((this._host = d.call(this, l)),
              (l = ""),
              (j = "port"),
          ...
          case "port":
            if (/[0-9]/.test(u)) l += u;
              ...
              "	" == u || "\n" == u || "\r" == u
                ? i("Invalid code point in port: " + u)
                : c.call(this);
            }
            break;
          case "relative path start":
            if (
              ("\\" == u && i("'\\' not allowed in path."),
              (j = "relative path"),
              "/" != u && "\\" != u)
            )
              continue;
    ...
    if (!j) {
      ...
      (i.prototype = {
        ...
        set pathname(a) {
          !this._isInvalid &&
            this._isRelative &&
            ((this._path = []), g.call(this, a, "relative path start"));
        },
        get search() {
  ...
  (function (a) {
    ...
    function b(a, b, c) {
      var d =
        "string" == typeof a ? document.createElement(a) : a.cloneNode(!0);
    ...
    (DOMTokenList.prototype.add = function () {
      ...
      (DOMTokenList.prototype.toggle = function (a, b) {
        1 == arguments.length && (b = !this.contains(a)),
    ...
    if (
      ((NodeList.prototype.array = e),
      (f.prototype.array = e),
      (HTMLCollection.prototype.array = e),
      !window.performance)
    ) {
      var g = Date.now();
      window.performance = {
    ...
    (window.Polymer = i),
      (a.deliverDeclarations = function () {
        return (
          (a.deliverDeclarations = function () {
  ...
  (function (a) {
    ...
    window.sinspect = function (a, d) {
      b ||
        ((b = window.open("", "ShadowDOM Inspector", null, !0)),
        b.document.write(c),
        (b.api = { shadowize: shadowize })),
    ...
    var c = [
      ...
      f = function (a, c) {
        ...
        d.push(g),
          e(),
          (f.body.querySelector("#tree").innerHTML =
            "<pre>" + j(a, a.childNodes) + "</pre>");
      },
      g = Array.prototype.forEach.call.bind(Array.prototype.forEach),
      h = { STYLE: 1, SCRIPT: 1, "#comment": 1, TEMPLATE: 1 },
      i = function (a) {
        return h[a.nodeName];
      },
      j = function (a, b, c) {
      ...
      l = function (a) {
        ...
        return (
          a.webkitShadowRoot || a.shadowRoot
            ? ((b +=
                ' <button idx="' +
                k.length +
    ...
    (shadowize = function () {
      var a = Number(this.attributes.idx.value),
        b = k[a];
      b
        ? f(b.webkitShadowRoot || b.shadowRoot, b)
        : (console.log("bad shadowize node"), console.dir(this));
    }),
      (a.output = j);
  })(window.Inspector),
  (function () {
  ...
  (function (a) {
    ...
    function d(a) {
      var b = document.location,
        c = new URL(a, b);
      return c.host === b.host && c.port === b.port && c.protocol === b.protocol
        ? e(b.pathname, c.pathname)
        : a;
    }
    function e(a, b) {
    ...
    var f = {
        resolveDom: function (a, b) {
          (b = b || a.ownerDocument.baseURI),
            this.resolveAttributes(a, b),
            this.resolveStyles(a, b);
          var c = a.querySelectorAll("template");
          if (c)
            for (var d, e = 0, f = c.length; f > e && (d = c[e]); e++)
              d.content && this.resolveDom(d.content, b);
        },
        ...
        resolveStyles: function (a, b) {
          ...
          if (c)
            for (var d, e = 0, f = c.length; f > e && (d = c[e]); e++)
              this.resolveStyle(d, b);
        },
        resolveStyle: function (a, b) {
          (b = b || a.ownerDocument.baseURI),
            (a.textContent = this.resolveCssText(a.textContent, b));
        },
        ...
        resolveAttributes: function (a, b) {
          a.hasAttributes &&
            a.hasAttributes() &&
            this.resolveElementAttributes(a, b);
          var c = a && a.querySelectorAll(j);
          if (c)
            for (var d, e = 0, f = c.length; f > e && (d = c[e]); e++)
              this.resolveElementAttributes(d, b);
        },
        resolveElementAttributes: function (a, d) {
          (d = d || a.ownerDocument.baseURI),
            i.forEach(function (e) {
              ...
              i &&
                i.search(k) < 0 &&
                ((f = "style" === e ? b(i, d, g) : c(d, i)), (h.value = f));
            });
        },
      },
      g = /(url\()([^)]*)(\))/g,
  ...
  (function (a) {
    ...
    function c(a) {
      return (
        (window.ShadowDOMPolyfill &&
          window.ShadowDOMPolyfill.wrapIfNeeded(a)) ||
        a
      );
    }
    function d() {
    ...
    function i(a) {
      ...
      return (
        (b.addedNodes = a.addedNodes.slice()),
        (b.removedNodes = a.removedNodes.slice()),
        (b.previousSibling = a.previousSibling),
        (b.nextSibling = a.nextSibling),
        (b.attributeName = a.attributeName),
        (b.attributeNamespace = a.attributeNamespace),
    ...
    g.prototype = {
      observe: function (a, b) {
        if (
          ((a = c(a)),
          (!b.childList && !b.attributes && !b.characterData) ||
            (b.attributeOldValue && !b.attributes) ||
            (b.attributeFilter && b.attributeFilter.length && !b.attributes) ||
            (b.characterDataOldValue && !b.characterData))
        )
        ...
        e || ((e = new o(this, a, b)), d.push(e), this.nodes_.push(a)),
          e.addListeners();
      },
      disconnect: function () {
        this.nodes_.forEach(function (a) {
    ...
    (o.prototype = {
      ...
      addListeners_: function (a) {
        ...
        b.attributes && a.addEventListener("DOMAttrModified", this, !0),
          b.characterData &&
            a.addEventListener("DOMCharacterDataModified", this, !0),
          b.childList && a.addEventListener("DOMNodeInserted", this, !0),
          (b.childList || b.subtree) &&
            a.addEventListener("DOMNodeRemoved", this, !0);
      },
      ...
      removeListeners_: function (a) {
        ...
        b.attributes && a.removeEventListener("DOMAttrModified", this, !0),
          b.characterData &&
            a.removeEventListener("DOMCharacterDataModified", this, !0),
          b.childList && a.removeEventListener("DOMNodeInserted", this, !0),
          (b.childList || b.subtree) &&
            a.removeEventListener("DOMNodeRemoved", this, !0);
      },
      addTransientObserver: function (a) {
        if (a !== this.target) {
      ...
      handleEvent: function (a) {
        switch ((a.stopImmediatePropagation(), a.type)) {
          case "DOMAttrModified":
            ...
            var g =
              a.attrChange === MutationEvent.ADDITION ? null : a.prevValue;
            f(d, function (a) {
              return !a.attributes ||
                (a.attributeFilter &&
                  a.attributeFilter.length &&
                  -1 === a.attributeFilter.indexOf(b) &&
                  -1 === a.attributeFilter.indexOf(c))
                ? void 0
                : a.attributeOldValue
                ? k(g)
                : e;
      ...
      a.MutationObserver || (a.MutationObserver = g);
  })(this),
  (window.HTMLImports = window.HTMLImports || { flags: {} }),
  (function (a) {
    var b = (a.path, a.xhr),
    ...
    (d.prototype = {
      addNodes: function (a) {
        ...
        for (var b, c = 0, d = a.length; d > c && (b = a[c]); c++)
          this.require(b);
        this.checkDone();
      },
      addNode: function (a) {
      ...
      fetch: function (a, d) {
        if ((c.load && console.log("fetch", a, d), a.match(/^data:/))) {
          var e = a.split(","),
            f = e[0],
            g = e[1];
          (g = f.indexOf(";base64") > -1 ? atob(g) : decodeURIComponent(g)),
            setTimeout(
              function () {
      ...
      receive: function (a, b, c, d) {
        this.cache[a] = d;
        for (
          var e, f = this.pending[a], g = 0, h = f.length;
          h > g && (e = f[g]);
          g++
        )
          this.onload(a, e, d), this.tail();
        this.pending[a] = null;
      },
      tail: function () {
    ...
    var g = "import",
      ...
      k = {
        ...
        parse: function (a) {
          if (this.isParsed(a))
            return void (
              h.parse && console.log("[%s] is already parsed", a.localName)
            );
        ...
        markParsingComplete: function (a) {
          (a.__importParsed = !0),
            a.__importElement && (a.__importElement.__importParsed = !0),
            (this.parsingElement = null),
            h.parse && console.log("completed", a),
            this.parseNext();
        },
        parseImport: function (a) {
          if (
            ((a.import.__importParsed = !0),
            HTMLImports.__importsParsingHook &&
              HTMLImports.__importsParsingHook(a),
            a.dispatchEvent(
              a.__resource
        ...
        parseLink: function (a) {
          b(a)
            ? this.parseImport(a)
            : ((a.href = a.href), this.parseGeneric(a));
        },
        ...
        trackElement: function (a, b) {
          ...
          if (
            ...
            if (-1 == a.textContent.indexOf("@import")) e = !0;
              ...
              e = !0;
              for (
                var f, g = a.sheet.cssRules, h = g ? g.length : 0, j = 0;
                h > j && (f = g[j]);
                j++
              )
                f.type === CSSRule.IMPORT_RULE &&
                  (e = e && Boolean(f.styleSheet));
            }
        ...
        parseScript: function (b) {
          ...
          (d.__importElement = b),
            (d.src = b.src ? b.src : c(b)),
            (a.currentScript = b),
            this.trackElement(d, function () {
        ...
        nextToParseInDoc: function (a, c) {
          for (
            var d,
              e = a.querySelectorAll(this.parseSelectorsForNode(a)),
              f = 0,
              g = e.length;
            g > f && (d = e[f]);
            f++
            ...
            if (!this.isParsed(d))
              return this.hasResource(d)
                ? b(d)
                  ? this.nextToParseInDoc(d.import, d)
                  : d
                : void 0;
          return c;
        },
  ...
  (function (a) {
    ...
    function d(a, b) {
      ...
      c instanceof Document ||
        (c = document.implementation.createHTMLDocument(m)),
        (c._URL = b);
    ...
    function g(a, b) {
      if (f(b)) a && a();
        ...
        var c = function () {
          ("complete" === b.readyState || b.readyState === u) &&
            (b.removeEventListener(v, c), g(a, b));
        };
    ...
    function h(a, b) {
      ...
      var e = b.querySelectorAll("link[rel=import]"),
        ...
        g = e.length;
      if (g)
        for (var h, j = 0; g > j && (h = e[j]); j++)
          i(h)
            ? d.call(h)
            : (h.addEventListener("load", d), h.addEventListener("error", d));
      else c();
    }
    function i(a) {
      return k
    ...
    var j = "import" in document.createElement("link"),
      ...
      n = window.ShadowDOMPolyfill
        ? ShadowDOMPolyfill.wrapIfNeeded(document)
        : document;
    if (k) var o = {};
    else
      var p = (a.xhr, a.Loader),
        q = a.parser,
        o = {
          documents: {},
          ...
          loaded: function (a, c, e) {
            if (
              (l.load && console.log("loaded", a, c), (c.__resource = e), b(c))
            ) {
    ...
    if (
      (Object.defineProperty(document, "_currentScript", s),
      Object.defineProperty(n, "_currentScript", s),
      !document.baseURI)
    ) {
      var t = {
        get: function () {
      ...
      Object.defineProperty(document, "baseURI", t),
    ...
    (a.hasNative = j),
      (a.useNative = k),
      (a.importer = o),
      (a.whenImportsReady = e),
      (a.IMPORT_LINK_TYPE = m),
      (a.isImportLoaded = i),
      (a.importLoader = r);
  })(window.HTMLImports),
  (function (a) {
    function b(a) {
      for (var b, d = 0, e = a.length; e > d && (b = a[d]); d++)
        "childList" === b.type && b.addedNodes.length && c(b.addedNodes);
    }
    function c(a) {
      for (var b, e = 0, g = a.length; g > e && (b = a[e]); e++)
        d(b) && f.loadNode(b), b.children && b.children.length && c(b.children);
    }
    function d(a) {
      return 1 === a.nodeType && g.call(a, f.loadSelectorsForNode(a));
    }
    function e(a) {
      h.observe(a, { childList: !0, subtree: !0 });
    }
  ...
  (function () {
    ...
    var b = window.ShadowDOMPolyfill
      ? window.ShadowDOMPolyfill.wrapIfNeeded(document)
      : document;
    HTMLImports.whenImportsReady(function () {
      (HTMLImports.ready = !0),
        (HTMLImports.readyTime = new Date().getTime()),
        b.dispatchEvent(new CustomEvent("HTMLImportsLoaded", { bubbles: !0 }));
    }),
  ...
  (function (a) {
    ...
    function h(b) {
      if (!b.__upgraded__ && b.nodeType === Node.ELEMENT_NODE) {
        ...
        if (d)
          return (
            A.dom && console.group("upgrade:", b.localName),
            a.upgrade(b),
    ...
    function j(a) {
      if ((E.push(a), !D)) {
        D = !0;
        var b =
          (window.Platform && window.Platform.endOfMicrotask) || setTimeout;
        b(k);
      }
    }
    function k() {
    ...
    function m(a) {
      (a.attachedCallback || a.detachedCallback || (a.__upgraded__ && A.dom)) &&
        (A.dom && console.group("inserted:", a.localName),
        r(a) &&
          ((a.__inserted = (a.__inserted || 0) + 1),
          a.__inserted < 1 && (a.__inserted = 1),
          a.__inserted > 1
            ? A.dom &&
              console.warn(
                "inserted:",
            ...
            : a.attachedCallback &&
              (A.dom && console.log("inserted:", a.localName),
              a.attachedCallback())),
        A.dom && console.groupEnd());
    }
    function n(a) {
    ...
    function p(a) {
      (a.attachedCallback || a.detachedCallback || (a.__upgraded__ && A.dom)) &&
        (A.dom && console.group("removed:", a.localName),
        r(a) ||
          ((a.__inserted = (a.__inserted || 0) - 1),
          a.__inserted > 0 && (a.__inserted = 0),
          a.__inserted < 0
            ? A.dom &&
              console.warn(
                "removed:",
            ...
            : a.detachedCallback && a.detachedCallback()),
        A.dom && console.groupEnd());
    }
    function q(a) {
      ...
      if (A.dom) {
        ...
        if (b && "childList" === b.type && b.addedNodes && b.addedNodes) {
          for (var c = b.addedNodes[0]; c && c !== document && !c.host; )
            c = c.parentNode;
          var d =
            (c && (c.URL || c._URL || (c.host && c.host.localName))) || "";
    ...
    function y(a) {
      A.dom && console.group("upgradeDocument: ", a.baseURI.split("/").pop()),
        g(a),
        A.dom && console.groupEnd();
    }
    function z(a) {
      ...
      for (
        var b,
          c = a.querySelectorAll("link[rel=" + B + "]"),
          d = 0,
          e = c.length;
        e > d && (b = c[d]);
        d++
      )
        b.import && b.import.__parsed && z(b.import);
      y(a);
    }
    ...
    var D = !1,
      ...
      G = Array.prototype.forEach.call.bind(Array.prototype.forEach);
    (a.IMPORT_LINK_TYPE = B),
      (a.watchShadow = s),
      (a.upgradeDocumentTree = z),
      (a.upgradeAll = g),
      (a.upgradeSubtree = f),
      (a.insertedNode = i),
      (a.observeDocument = x),
  ...
  (function (a) {
    function b(b, g) {
      ...
      return (
        (h.__name = b.toLowerCase()),
        (h.lifecycle = h.lifecycle || {}),
        (h.ancestry = d(h.extends)),
        e(h),
        f(h),
        l(h.prototype),
        o(h.__name, h),
        (h.ctor = p(h)),
        (h.ctor.prototype = h.prototype),
        (h.prototype.constructor = h.ctor),
        a.ready && a.upgradeDocumentTree(document),
        h.ctor
      );
    }
    function c(a) {
    ...
    function i(a, b) {
      Object.__proto__
        ...
        : (j(a, b.prototype, b.native), (a.__proto__ = b.prototype));
    }
    function j(a, b, c) {
      for (var d = {}, e = b; e !== c && e !== HTMLElement.prototype; ) {
        for (var f, g = Object.getOwnPropertyNames(e), h = 0; (f = g[h]); h++)
          d[f] ||
            (Object.defineProperty(a, f, Object.getOwnPropertyDescriptor(e, f)),
            (d[f] = 1));
    ...
    function m(a, b, c) {
      ...
      this.attributeChangedCallback &&
        e !== d &&
        this.attributeChangedCallback(a, d, e);
    }
    function n(a) {
    ...
    if (w) {
      ...
      (document.registerElement = b),
        (document.createElement = r),
        (document.createElementNS = q),
        (Node.prototype.cloneNode = t),
        (a.registry = z),
        (a.upgrade = s);
    }
    var E;
        ...
        parse: function (a) {
          if (!a.__parsed) {
            ...
            e(b, function (a) {
              ...
              CustomElements.upgradeDocument(a),
              CustomElements.observeDocument(a);
          }
        },
        parseLink: function (a) {
  ...
  (function (a) {
    function b() {
      ...
      a(function () {
        (CustomElements.ready = !0),
          ...
          window.HTMLImports &&
            (HTMLImports.__importsParsingHook = function (a) {
    ...
    if (
      ("function" != typeof window.CustomEvent &&
        (window.CustomEvent = function (a) {
          var b = document.createEvent("HTMLEvents");
          return b.initEvent(a, !0, !0), b;
        }),
      "complete" === document.readyState || a.flags.eager)
    )
      b();
    else if (
  ...
  (function (a) {
    ...
    (b.prototype = {
      extractUrls: function (a, b) {
        for (var c, d, e = []; (c = this.regex.exec(a)); )
          (d = new URL(c[1], b)), e.push({ matched: c[0], url: d.href });
        return e;
      },
      ...
      fetch: function (a, b, d) {
        ...
        for (
          ...
          (f = a[k]),
            ...
            b[h]
              ? c(i)
              : ((g = this.xhr(h, j, this)), (g.match = f), (b[h] = g));
      },
      xhr: function (a, b, c) {
  ...
  (function (a) {
    ...
    b.prototype = {
      ...
      flatten: function (a, b, d) {
        for (
          var e, f, g, h = this.loader.extractUrls(a, b), i = 0;
          i < h.length;
          i++
        )
          (e = h[i]),
            (f = e.url),
            (g = c.resolveCssText(d[f], f)),
            (g = this.flatten(g, b, d)),
            (a = a.replace(e.matched, g));
        return a;
      },
      loadStyles: function (a, b) {
        ...
        for (var d, e = 0, f = a.length, g = 0; f > g && (d = a[g]); g++)
          this.resolveNode(d, c);
      },
    };
    var e = new b();
    a.styleResolver = e;
  ...
  (function () {
    ...
    function g(a, b, c, e) {
      return c
        ? void (e ? a.setAttribute(b, "") : a.removeAttribute(b))
        : void a.setAttribute(b, d(e));
    }
    function h(a, b, c) {
      return function (d) {
        g(a, b, c, d);
    ...
    function o(b) {
      if (b.form)
        return s(b.form.elements, function (a) {
          return (
            a != b &&
            "INPUT" == a.tagName &&
            "radio" == a.type &&
    ...
    function q(a, b) {
      ...
      g instanceof HTMLSelectElement &&
        g.bindings_ &&
        g.bindings_.value &&
        ((c = g), (e = c.bindings_.value), (f = c.value)),
        (a.value = d(b)),
        c &&
          c.value != f &&
          (e.observable_.setValue(c.value),
          e.observable_.discardChanges(),
          Platform.performMicrotaskCheckpoint());
    }
    function r(a) {
      return function (b) {
    ...
    Object.defineProperty(Platform, "enableBindingsReflection", {
      ...
      (Element.prototype.bind = function (a, b, c) {
        var d = "?" == a[a.length - 1];
        if ((d && (this.removeAttribute(a), (a = a.slice(0, -1))), c))
          return g(this, a, d, b);
        var e = b;
    ...
    !(function () {
      ...
      (HTMLInputElement.prototype.bind = function (a, c, e) {
        if ("value" !== a && "checked" !== a)
          return HTMLElement.prototype.bind.call(this, a, c, e);
      ...
      (HTMLTextAreaElement.prototype.bind = function (a, b, c) {
        if ("value" !== a)
          return HTMLElement.prototype.bind.call(this, a, b, c);
      ...
      (HTMLSelectElement.prototype.bind = function (a, c, d) {
        if (
          ("selectedindex" === a && (a = "selectedIndex"),
          "selectedIndex" !== a && "value" !== a)
        )
          return HTMLElement.prototype.bind.call(this, a, c, d);
  ...
  (function (a) {
    ...
    function d(a, b) {
      if (b) {
        for (
          ...
          ((a = c(a)),
          a.protoContent_
            ? (d = a.protoContent_.querySelector(e))
            : a.getElementById && (d = a.getElementById(b)),
          !d && a.templateCreator_);

        )
          a = a.templateCreator_;
        return d;
      }
    }
    function e(a) {
    ...
    function h(a) {
      return (
        void 0 === a.isTemplate_ &&
          (a.isTemplate_ = "TEMPLATE" == a.tagName || g(a)),
        a.isTemplate_
      );
    }
    function i(a, b) {
    ...
    function l(a) {
      ...
      if (!c) {
        for (c = b.implementation.createHTMLDocument(""); c.lastChild; )
    ...
    function m(a) {
      if (!a.stagingDocument_) {
        ...
        if (!b.stagingDocument_) {
          (b.stagingDocument_ = b.implementation.createHTMLDocument("")),
            (b.stagingDocument_.isStagingDocument = !0);
          var c = b.stagingDocument_.createElement("base");
          (c.href = document.baseURI),
            b.stagingDocument_.head.appendChild(c),
            (b.stagingDocument_.stagingDocument_ = b.stagingDocument_);
        }
    ...
    function n(a) {
      ...
      for (var c = a.attributes, d = c.length; d-- > 0; ) {
        var e = c[d];
        K[e.name] &&
          ("template" !== e.name && b.setAttribute(e.name, e.value),
    ...
    function q(a) {
      P
        ? (a.__proto__ = HTMLTemplateElement.prototype)
        : k(a, HTMLTemplateElement.prototype);
    }
    function r(a) {
      a.setModelFn_ ||
        (a.setModelFn_ = function () {
          a.setModelFnScheduled_ = !1;
          var b = z(a, a.delegate_ && a.delegate_.prepareBinding);
          w(a, b, a.model_);
        }),
        a.setModelFnScheduled_ ||
          ((a.setModelFnScheduled_ = !0), Observer.runEOM_(a.setModelFn_));
    }
    function s(a, b, c, d) {
      if (a && a.length) {
        for (var e, f = a.length, g = 0, h = 0, i = 0, j = !0; f > h; ) {
          var g = a.indexOf("{{", h),
            ...
            m = "}}";
          if (
            (k >= 0 && (0 > g || g > k) && ((g = k), (l = !0), (m = "]]")),
            (i = 0 > g ? -1 : a.indexOf(m, g + 2)),
            0 > i)
          ) {
            if (!e) return;
            e.push(a.slice(h));
        ...
        return (
          h === f && e.push(""),
          (e.hasOnePath = 5 === e.length),
          (e.isSimplePath = e.hasOnePath && "" == e[0] && "" == e[4]),
          (e.onlyOneTime = j),
          (e.combinator = function (a) {
    ...
    function y(a, c) {
      ...
      for (var d = [], e = 0; e < a.attributes.length; e++) {
        for (var f = a.attributes[e], g = f.name, i = f.value; "_" === g[0]; )
          g = g.substring(1);
        if (!h(a) || (g !== J && g !== H && g !== I)) {
          var j = s(i, g, a, c);
          j && d.push(g, j);
      ...
      return (
        h(a) &&
          ...
          (d.bind = x(a, H, c)),
          (d.repeat = x(a, I, c)),
          !d.if || d.bind || d.repeat || (d.bind = s("{{}}", H, a, c))),
        d
      );
    }
    function z(a, b) {
    ...
    function A(a, b, c, d, e, f, g) {
      for (
        var h = b.appendChild(c.importNode(a, !1)), i = 0, j = a.firstChild;
        j;
        j = j.nextSibling
      )
        A(j, h, c, d.children[i++], e, f, g);
      return (
        d.isTemplate &&
          (HTMLTemplateElement.decorate(h, a), f && h.setDelegate_(f)),
        w(h, d, e, g),
        h
      );
    }
    function B(a, b) {
      var c = z(a, b);
      c.children = {};
      for (var d = 0, e = a.firstChild; e; e = e.nextSibling)
        c.children[d++] = B(e, b);
      return c;
    }
    function C(a) {
    ...
    function E(a) {
      (this.closed = !1),
        (this.templateElement_ = a),
        (this.instances = []),
        (this.deps = void 0),
        (this.iteratedValue = []),
        (this.presentValue = void 0),
        (this.arrayObserver = void 0);
    }
    var F,
      G = Array.prototype.forEach.call.bind(Array.prototype.forEach);
    a.Map && "function" == typeof a.Map.prototype.forEach
      ? (F = a.Map)
      : ((F = function () {
        ...
        (F.prototype = {
          ...
          delete: function (a) {
            ...
            return 0 > b
              ? !1
              : (this.keys.splice(b, 1), this.values.splice(b, 1), !0);
          },
          forEach: function (a, b) {
            for (var c = 0; c < this.keys.length; c++)
              a.call(b || this, this.values[c], this.keys[c], this);
          },
        }));
    "function" != typeof document.contains &&
      (Document.prototype.contains = function (a) {
        return a === this || a.parentNode === this
          ? !0
          : this.documentElement.contains(a);
      });
    var H = "bind",
      I = "repeat",
      J = "if",
      K = { template: !0, repeat: !0, bind: !0, ref: !0 },
      L = {
        THEAD: !0,
        TBODY: !0,
        TFOOT: !0,
    ...
    document.addEventListener(
      ...
      M ||
        (a.HTMLTemplateElement = function () {
    ...
    "function" == typeof MutationObserver &&
      ...
      (HTMLTemplateElement.decorate = function (a, c) {
          ...
          (h ||
            (g(d)
              ? (b(!c),
                ...
                (h = M),
                (m = !0))
              : e(d) && ((d = o(a)), (d.templateIsDecorated_ = !0), (h = M))),
          !h)
        ) {
          q(d);
          var r = l(d);
        ...
        return (
          c ? (d.instanceRef_ = c) : k ? p(d, a, m) : i && j(d.content), !0
        );
      }),
    ...
    M ||
      ((HTMLTemplateElement.prototype = Object.create(Q.prototype)),
      Object.defineProperty(HTMLTemplateElement.prototype, "content", R)),
      k(HTMLTemplateElement.prototype, {
        ...
        processBindingDirectives_: function (a) {
          return (
            this.iterator_ && this.iterator_.closeDeps(),
            a.if || a.bind || a.repeat
              ? (this.iterator_ || (this.iterator_ = new E(this)),
                this.iterator_.updateDependencies(a, this.model_),
                O &&
                  O.observe(this, { attributes: !0, attributeFilter: ["ref"] }),
                this.iterator_)
              : void (
                  this.iterator_ &&
                  (this.iterator_.close(), (this.iterator_ = void 0))
                )
          );
        },
        createInstance: function (a, b, c) {
          b ? (c = this.newDelegate_(b)) : c || (c = this.delegate_),
            this.refContent_ || (this.refContent_ = this.ref_.content);
          var d = this.refContent_;
          if (null === d.firstChild) return T;
          var e = D(d, c),
            f = m(this),
            g = f.createDocumentFragment();
          (g.templateCreator_ = this),
            (g.protoContent_ = d),
            (g.bindings_ = []),
            (g.terminator_ = null);
          for (
            var h = (g.templateInstance_ = {
                firstNode: null,
                lastNode: null,
                model: a,
              }),
          ...
          return (
            (h.firstNode = g.firstChild),
            (h.lastNode = g.lastChild),
            (g.templateCreator_ = void 0),
            (g.protoContent_ = void 0),
            g
          );
        },
        get model() {
        ...
        refChanged_: function () {
          this.iterator_ &&
            ...
            ((this.refContent_ = void 0),
            this.iterator_.valueChanged(),
            this.iterator_.updateIteratedValue());
        },
        clear: function () {
          (this.model_ = void 0),
            (this.delegate_ = void 0),
            this.bindings_ && this.bindings_.ref && this.bindings_.ref.close(),
            (this.refContent_ = void 0),
            this.iterator_ &&
              (this.iterator_.valueChanged(),
        ...
        setDelegate_: function (a) {
          (this.delegate_ = a),
            (this.bindingMap_ = void 0),
            this.iterator_ &&
              ((this.iterator_.instancePositionChangedFn_ = void 0),
        ...
        newDelegate_: function (a) {
          ...
          if (a)
            return {
              ...
              prepareInstancePositionChanged: b(
        ...
        set bindingDelegate(a) {
          if (this.delegate_)
            throw Error(
              "Template must be cleared before a new bindingDelegate can be assigned"
            );
    ...
    (T.bindings_ = []),
      ...
      (E.prototype = {
        closeDeps: function () {
          var a = this.deps;
          a &&
            (a.ifOneTime === !1 && a.ifValue.close(),
            a.oneTime === !1 && a.value.close());
        },
        updateDependencies: function (a, b) {
          ...
          if (a.if) {
            if (
              ((c.hasIf = !0),
              (c.ifOneTime = a.if.onlyOneTime),
              (c.ifValue = v(J, a.if, d, b)),
              c.ifOneTime && !c.ifValue)
            )
              return void this.updateIteratedValue();
            c.ifOneTime || c.ifValue.open(this.updateIteratedValue, this);
          }
          a.repeat
            ? ((c.repeat = !0),
              (c.oneTime = a.repeat.onlyOneTime),
              (c.value = v(I, a.repeat, d, b)))
            : ((c.repeat = !1),
              (c.oneTime = a.bind.onlyOneTime),
              (c.value = v(H, a.bind, d, b))),
            c.oneTime || c.value.open(this.updateIteratedValue, this),
            this.updateIteratedValue();
        },
        updateIteratedValue: function () {
          if (this.deps.hasIf) {
            var a = this.deps.ifValue;
            if ((this.deps.ifOneTime || (a = a.discardChanges()), !a))
              return void this.valueChanged();
          }
          var b = this.deps.value;
          this.deps.oneTime || (b = b.discardChanges()),
            this.deps.repeat || (b = [b]);
          var c = this.deps.repeat && !this.deps.oneTime && Array.isArray(b);
          this.valueChanged(b, c);
        },
        valueChanged: function (a, b) {
          Array.isArray(a) || (a = []),
            a !== this.iteratedValue &&
              (this.unobserve(),
              (this.presentValue = a),
              b &&
              ...
              this.handleSplices(
                ArrayObserver.calculateSplices(
                  this.presentValue,
                  this.iteratedValue
                )
              ));
        ...
        getLastInstanceNode: function (a) {
          ...
          if (c.nodeType !== Node.ELEMENT_NODE || this.templateElement_ === c)
            return c;
          var d = c.iterator_;
        ...
        extractInstanceAt: function (a) {
          for (
            var b = this.getLastInstanceNode(a - 1),
              c = this.getLastInstanceNode(a),
              d = this.templateElement_.parentNode,
              e = this.instances.splice(a, 1)[0];
            c !== b;
        ...
        handleSplices: function (a) {
          if (!this.closed && a.length) {
            ...
            var c = b.delegate_;
            void 0 === this.instanceModelFn_ &&
              (this.instanceModelFn_ = this.getDelegateFn(
                c && c.prepareInstanceModel
              )),
              void 0 === this.instancePositionChangedFn_ &&
                (this.instancePositionChangedFn_ = this.getDelegateFn(
                  c && c.prepareInstancePositionChanged
                ));
            ...
            for (var f = 0; f < a.length; f++)
              for (var g = a[f], l = g.index; l < g.index + g.addedCount; l++) {
                ...
                k
                  ? d.delete(j)
                  : (this.instanceModelFn_ && (j = this.instanceModelFn_(j)),
                    (k = void 0 === j ? T : b.createInstance(j, void 0, c))),
                  this.insertInstanceAt(l, k);
              }
            d.forEach(function (a) {
              this.closeInstanceBindings(a);
            }, this),
              this.instancePositionChangedFn_ && this.reportInstancesMoved(a);
          }
        },
        ...
        reportInstancesMoved: function (a) {
          for (var b = 0, c = 0, d = 0; d < a.length; d++) {
            var e = a[d];
            if (0 != c) for (; b < e.index; ) this.reportInstanceMoved(b), b++;
            else b = e.index;
            for (; b < e.index + e.addedCount; )
              this.reportInstanceMoved(b), b++;
            c += e.addedCount - e.removed.length;
          }
          if (0 != c)
            for (var f = this.instances.length; f > b; )
              this.reportInstanceMoved(b), b++;
        },
        ...
        unobserve: function () {
          this.arrayObserver &&
            (this.arrayObserver.close(), (this.arrayObserver = void 0));
        },
        close: function () {
          if (!this.closed) {
            this.unobserve();
            for (var a = 0; a < this.instances.length; a++)
              this.closeInstanceBindings(this.instances[a]);
            (this.instances.length = 0),
              this.closeDeps(),
              (this.templateElement_.iterator_ = void 0),
              (this.closed = !0);
          }
        },
      }),
  ...
  (function (a) {
    function b() {
      e ||
        ((e = !0),
        a.endOfMicrotask(function () {
          (e = !1),
            logFlags.data && console.group("Platform.flush()"),
            a.performMicrotaskCheckpoint(),
