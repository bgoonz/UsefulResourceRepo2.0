...
function schedPlay(time) {
  ...
  if (!isPlaying) {
    ...
    if (isPaused) {
      ...
      activeSources.forEach(function (element, index) {
        var percent =
          (current16thNote - element.sourceStartBar) /
          (element.sourceNode.buffer.duration / (secondsPerBeat * 0.25));
...
function resetCanvas(e) {
  ...
  timelineWidth =
    (0.7446808510638297 * window.innerWidth - 20) * 0.829787234042553 - 20;
