...
window.PolymerGestures = {},
  function ( a ) {
    ...
    a.targetFinding = b, a.findTarget = b.findTarget.bind( b ), a.deepContains = b.deepContains.bind( b ), a.insideNode = b.insideNode
  }( window.PolymerGestures ),
  function () {
    function a( a ) {
  ...
  function ( a ) {
    var b = [ "bubbles", "cancelable", "view", "detail", "screenX", "screenY", "clientX", "clientY", "ctrlKey", "altKey", "shiftKey", "metaKey", "button", "relatedTarget", "pageX", "pageY" ],
      ...
      e = {
        ...
        makePointerEvent: function ( a, d ) {
          ...
          var h = 0;
          return h = d.pressure ? d.pressure : f.buttons ? .5 : 0, f.x = f.clientX, f.y = f.clientY, f.pointerId = d.pointerId || 0, f.width = d.width || 0, f.height = d.height || 0, f.pressure = h, f.tiltX = d.tiltX || 0, f.tiltY = d.tiltY || 0, f.pointerType = d.pointerType || "", f.hwTimestamp = d.hwTimestamp || 0, f.isPrimary = d.isPrimary || !1, f
        }
      };
    a.eventFactory = e
  }( window.PolymerGestures ),
  ...
  function ( a ) {
    var b = [ "bubbles", "cancelable", "view", "detail", "screenX", "screenY", "clientX", "clientY", "ctrlKey", "altKey", "shiftKey", "metaKey", "button", "relatedTarget", "buttons", "pointerId", "width", "height", "pressure", "tiltX", "tiltY", "pointerType", "hwTimestamp", "isPrimary", "type", "target", "currentTarget", "which", "pageX", "pageY", "timeStamp", "preventTap", "tapPrevented" ],
      c = [ !1, !1, null, null, 0, 0, 0, 0, !1, !1, !1, !1, 0, null, 0, 0, 0, 0, 0, 0, 0, "", 0, !1, "", null, null, 0, 0, 0, 0, function () {}, !1 ],
      ...
      f = {
        ...
        makeEvent: function ( a, b ) {
          ...
          return c.preventDefault = b.preventDefault, c._target = c._target || b.target, c
        },
        ...
        cloneEvent: function ( a ) {
          for ( var e, f = Object.create( null ), g = 0; g < b.length; g++ ) e = b[ g ], f[ e ] = a[ e ] || c[ g ], !d || "target" !== e && "relatedTarget" !== e || f[ e ] instanceof SVGElementInstance && ( f[ e ] = f[ e ].correspondingUseElement );
        ...
        gestureTrigger: function () {
          for ( var a, b = 0; b < this.gestureQueue.length; b++ ) {
            ...
            for ( var c, d = 0; d < this.gestures.length; d++ ) c = this.gestures[ d ], c.events.indexOf( a.type ) >= 0 && c[ a.type ].call( c, a )
          }
          this.gestureQueue.length = 0
        },
        fillGestureQueue: function ( a ) {
          this.gestureQueue.length || requestAnimationFrame( this.boundGestureTrigger ), this.gestureQueue.push( a )
        }
      };
    f.boundHandler = f.eventHandler.bind( f ), f.boundGestureTrigger = f.gestureTrigger.bind( f ), a.dispatcher = f, a.register = f.register.bind( f ), a.unregister = f.unregister.bind( f )
  }( window.PolymerGestures ),
  function ( a ) {
    function b( a, b, c, d ) {
  ...
  function ( a ) {
    ...
    var h = {
      ...
      prepareEvent: function ( a ) {
        ...
        return c.pointerId = this.POINTER_ID, c.isPrimary = !0, c.pointerType = this.POINTER_TYPE, f || ( c.buttons = e[ c.which ] || 0 ), c
      },
      ...
      mouseup: function ( a ) {
        if ( !this.isEventSimulatedFromTouch( a ) ) {
          var d = this.prepareEvent( a );
          d.target = c.get( this.POINTER_ID ), d.relatedTarget = a.target, b.up( d ), this.cleanupMouse()
        }
      },
  ...
  function ( a ) {
    var b, c = a.dispatcher,
      ...
      j = {
        ...
        elementAdded: function ( a ) {
          ...
          e && ( a._scrollType = e, c.listen( a, this.events ), d( a ).forEach( function ( a ) {
            a._scrollType = e, c.listen( a, this.events )
          }, this ) )
        },
        elementRemoved: function ( a ) {
          a._scrollType = void 0, c.unlisten( a, this.events ), d( a ).forEach( function ( a ) {
        ...
        elementChanged: function ( a, b ) {
          ...
          e && f ? ( a._scrollType = e, d( a ).forEach( function ( a ) {
            a._scrollType = e
          }, this ) ) : f ? this.elementRemoved( a ) : e && this.elementAdded( a )
        },
        scrollTypes: {
          EMITTER: "none",
          XSCROLLER: "pan-x",
        ...
        setPrimaryTouch: function ( a ) {
          ( 0 === e.pointers() || 1 === e.pointers() && e.has( 1 ) ) && ( this.firstTouch = a.identifier, this.firstXY = {
            X: a.clientX,
            Y: a.clientY
        ...
        findTarget: function ( b, c ) {
          return "touchstart" === this.currentTouchEvent.type ? a.findTarget( b ) : e.get( c )
        },
        touchToPointer: function ( a ) {
          var b = this.currentTouchEvent,
            d = c.cloneEvent( a ),
            e = d.pointerId = a.identifier + 2;
          d.target = this.findTarget( a, e ), d.bubbles = !0, d.cancelable = !0, d.detail = this.clickCount, d.buttons = this.typeToButtons( b.type ), d.width = a.webkitRadiusX || a.radiusX || 0, d.height = a.webkitRadiusY || a.radiusY || 0, d.pressure = a.webkitForce || a.force || .5, d.isPrimary = this.isPrimaryTouch( a ), d.pointerType = this.POINTER_TYPE;
          var f = this;
        ...
        touchmove: function ( a ) {
          i ? this.processTouches( a, this.move ) : this.scrolling || ( this.shouldScroll( a ) ? ( this.scrolling = !0, this.touchcancel( a ) ) : ( a.preventDefault(), this.processTouches( a, this.move ) ) )
        },
        move: function ( a ) {
        ...
        up: function ( b ) {
          this.scrolling || ( b.relatedTarget = a.findTarget( b ), c.up( b ) ), this.cleanUpPointer( b )
        },
    ...
    i || ( b = new a.Installer( j.elementAdded, j.elementRemoved, j.elementChanged, j ) ), a.touchEvents = j
  }( window.PolymerGestures ),
  function ( a ) {
    var b = a.dispatcher,
      c = b.pointermap,
      ...
      e = {
        ...
        MSPointerUp: function ( a ) {
          var d = this.prepareEvent( a );
          d.target = c.get( a.pointerId ), d.relatedTarget = a.target, b.up( d ), this.cleanup( a.pointerId )
        },
  ...
  function ( a ) {
    var b = a.dispatcher;
    window.PointerEvent ? b.registerSource( "pointer", a.pointerEvents ) : window.navigator.msPointerEnabled ? b.registerSource( "ms", a.msEvents ) : ( b.registerSource( "mouse", a.mouseEvents ), void 0 !== window.ontouchstart && b.registerSource( "touch", a.touchEvents ) ), b.register( document )
  }( window.PolymerGestures ),
  function ( a ) {
    var b = a.dispatcher,
      c = a.eventFactory,
  ...
  function ( a ) {
    ...
    function f( a, b, c ) {
      "[" == c && b instanceof d && Path.get( b.value ).valid && ( c = ".", b = new e( b.value ) ), this.dynamicDeps = "function" == typeof a || a.dynamic, this.dynamic = "function" == typeof b || b.dynamic || "[" == c, this.simplePath = !this.dynamic && !this.dynamicDeps && b instanceof e && ( a instanceof f || a instanceof e ), this.object = this.simplePath ? a : i( a ), this.property = "." == c ? b : i( b )
    }
    ...
    function q( a, b, c ) {
      ...
      return d = w[ d ] || d,
        function ( b, e, f ) {
          ...
          var h, i, j;
          return j = "function" == typeof c.resolveEventHandler ? function ( d ) {
            h = h || c.resolveEventHandler( b, a, e ), h && ( h( d, d.detail, d.currentTarget ), Platform && "function" == typeof Platform.flush && Platform.flush() )
          } : function ( c ) {
            h = h || a.getValueFrom( b ), i = i || p( b, a, e ), h && ( h.apply( i, [ c, c.detail, c.currentTarget ] ), Platform && "function" == typeof Platform.flush && Platform.flush() )
          }, e.addEventListener( d, j ), f ? void 0 : {
            open: g,
            discardChanges: g,
            close: function () {
    ...
    d.prototype = {
      ...
      setValue: function ( a, b ) {
        return 1 == this.path.length, a = o( a, this.path[ 0 ] ), this.path.setValueFrom( a, b )
      }
    }, f.prototype = {
      get fullPath() {
        if ( !this.fullPath_ ) {
          var a = this.object instanceof e ? this.object.name : this.object.fullPath;
      ...
      transform: function ( a, b, c, d, e ) {
        var f = c[ this.name ],
          g = d;
        if ( f ) g = void 0;
        else if ( f = g[ this.name ], !f ) return void console.error( "Cannot find filter: " + this.name );
        if ( b ? f = f.toModel : "function" == typeof f.toDOM && ( f = f.toDOM ), "function" != typeof f ) return void console.error( "No " + ( b ? "toModel" : "toDOM" ) + " found on" + this.name );
    ...
    s.prototype = {
      ...
      prepareBinding: function ( a, c, d ) {
        var e = Path.get( a );
        if ( n( c ) ) return e.valid ? q( e, c, this ) : void console.error( "on-* bindings must be simple path expressions" ); {
    ...
    }, a.PolymerExpressions = s, a.exposeGetExpression && ( a.getExpression_ = c ), a.PolymerExpressions.prepareEventBinding = q
  }( this ), Polymer = {}, "function" == typeof window.Polymer && ( Polymer = {} ),
  function ( a ) {
    function b( a, b ) {
  ...
  function ( a ) {
    function b( a ) {
      var c = b.caller,
        g = c.nom,
        h = c._super;
      if ( h || ( g || ( g = c.nom = e.call( this, c ) ), g || console.warn( "called super() on a method not installed declaratively (has no .nom property)" ), h = d( c, g, f( this ) ) ), h ) {
        var i = h[ g ];
    ...
    function d( a, b, d ) {
      return a._super = c( d, b, a ), a._super && ( a._super[ b ].nom = b ), a._super
    }
    ...
    var b = window.logFlags || {},
      ...
      d = {
        ...
        addHostListeners: function () {
          ...
          var d, e, f = this;
          for ( var g in a ) e = c + g, ( d = PolymerExpressions.prepareEventBinding( Path.get( a[ g ] ), e, {
  ...
  function ( a ) {
    var b = {
      ...
      takeAttributes: function () {
        if ( this._publishLC )
          for ( var a, b = 0, c = this.attributes, d = c.length;
            ( a = c[ b ] ) && d > b; b++ ) this.attributeToProperty( a.name, a.value )
      },
  ...
  function ( a ) {
    function b( a, b, e ) {
      return d.bind && console.log( f, e.path_, inPath, a.localName, b ), Observer.bindToInstance( a, b, e, c )
    }
    ...
    var d = window.logFlags || {},
      e = {
        ...
        notifyPropertyChanges: function ( a, b, c ) {
          var d, e, f = {};
          for ( var g in b ) d = c[ 2 * g + 1 ], e = this.observe[ d ], e && ( this.observeArrayValue( d, a[ g ], b[ g ] ), f[ e ] || ( f[ e ] = !0, this.invokeMethod( e, [ b[ g ], a[ g ], arguments ] ) ) )
        },
        ...
        closeObservers: function () {
          for ( var a = 0, b = this._observers.length; b > a; a++ ) this.closeObserverArray( this._observers[ a ] );
          this._observers = []
        },
        closeObserverArray: function ( a ) {
          for ( var b, c = 0, d = a.length; d > c; c++ ) b = a[ c ], b && b.close && b.close()
        },
        ...
        closeNamedObservers: function () {
          if ( this._namedObservers ) {
            for ( var a, b, c = Object.keys( this._namedObservers ), d = 0, e = c.length; e > d && ( a = c[ d ] ); d++ ) b = this._namedObservers[ a ], b.close();
      ...
      c = {
        ...
        bind: function ( a, b, c ) {
          ...
          if ( d ) {
            ...
            return Platform.enableBindingsReflection && e && ( e.path = b.path_, this.bindings_ = this.bindings_ || {}, this.bindings_[ d ] = e ), this.reflect[ d ] && this.reflectPropertyToAttribute( d ), e
          }
  ...
  function ( a ) {
    ...
    var d = {
      ...
      createdCallback: function () {
        this.templateInstance && this.templateInstance.model && console.warn( "Attributes on " + this.localName + " were data bound prior to Polymer upgrading the element. This may result in incorrect binding types." ), this.created(), this.prepareElement(), ( !this.ownerDocument.isStagingDocument || window.ShadowDOMPolyfill ) && this.makeElementReady()
      },
      ...
      makeElementReady: function () {
        this._readied || ( this._readied = !0, this.parseDeclarations( this.__proto__ ), this.removeAttribute( "unresolved" ), this.ready() )
      },
      attachedCallback: function () {
        this.cancelUnbindAll(), this.attached && this.attached(), this.enteredView && this.enteredView(), this.hasBeenAttached || ( this.hasBeenAttached = !0, this.domReady && this.async( "domReady" ) )
      },
      ...
      marshalNodeReferences: function ( a ) {
        var b = this.$ = this.$ || {};
        if ( a )
          for ( var c, d = a.querySelectorAll( "[id]" ), e = 0, f = d.length; f > e && ( c = d[ e ] ); e++ ) b[ c.id ] = c
      },
      ...
      f = {
        ...
        installControllerStyles: function () {
          ...
          if ( a && !this.scopeHasNamedStyle( a, this.localName ) ) {
            for ( var c = b( this ), d = ""; c && c.element; ) d += c.element.cssTextForScope( e ), c = b( c );
        ...
        installScopeStyle: function ( a, b, c ) {
          ...
          if ( c && !this.scopeHasNamedStyle( c, this.localName + b ) ) {
            ...
            if ( a instanceof Array )
              for ( var e, f = 0, g = a.length; g > f && ( e = a[ f ] ); f++ ) d += e.textContent + "\n\n";
        ...
        installScopeCssText: function ( a, b, d ) {
          if ( b = b || this.findStyleScope(), d = d || "", b ) {
            ...
            Polymer.applyStyleToScope( f, b ), b._scopeStyles[ this.localName + d ] = !0
          }
        },
  ...
  function ( a ) {
    function b( a, b ) {
      if ( 1 === arguments.length && "string" != typeof arguments[ 0 ] ) {
        ...
        if ( a = c && c.parentNode && c.parentNode.getAttribute ? c.parentNode.getAttribute( "name" ) : "", !a ) throw "Element name could not be inferred."
      }
    ...
    if ( j )
      for ( var k, l = 0, m = j.length; m > l && ( k = j[ l ] ); l++ ) b.apply( null, k )
  }( Polymer ),
  function ( a ) {
    var b = {
  ...
  function ( a ) {
    ...
    function c( a, b ) {
      if ( a ) {
        b === document && ( b = document.head ), window.ShadowDOMPolyfill && ( b = document.head );
    ...
    var g = ( window.logFlags || {}, a.api.instance.styles ),
      ...
      n = {
        ...
        convertSheetsToStyles: function ( a ) {
          for ( var c, e, f = a.querySelectorAll( k ), g = 0, h = f.length; h > g && ( c = f[ g ] ); g++ ) e = d( b( c, this.ownerDocument.baseURI ), this.ownerDocument ), this.copySheetAttributes( e, c ), c.parentNode.replaceChild( e, c )
        },
        copySheetAttributes: function ( a, b ) {
          for ( var c, d = 0, e = b.attributes, f = e.length;
            ( c = e[ d ] ) && f > d; d++ ) "rel" !== c.name && "href" !== c.name && a.setAttribute( c.name, c.value )
        },
        findLoadableStyles: function ( a ) {
          var b = [];
          if ( a )
            for ( var c, d = a.querySelectorAll( i ), e = 0, f = d.length; f > e && ( c = d[ e ] ); e++ ) c.textContent.match( j ) && b.push( c );
          return b
        },
        ...
        cacheSheets: function () {
          this.sheets = this.findNodes( k ), this.sheets.forEach( function ( a ) {
            a.parentNode && a.parentNode.removeChild( a )
          } )
        },
        cacheStyles: function () {
          this.styles = this.findNodes( i + "[" + m + "]" ), this.styles.forEach( function ( a ) {
            a.parentNode && a.parentNode.removeChild( a )
          } )
        },
      ...
      p = o.matches || o.matchesSelector || o.webkitMatchesSelector || o.mozMatchesSelector;
  ...
  function ( a ) {
    var b = {
      inferObservers: function ( a ) {
        var b, c = a.observe;
        for ( var d in a ) "Changed" === d.slice( -7 ) && ( c || ( c = a.observe = {} ), b = d.slice( 0, -7 ), c[ b ] = c[ b ] || d )
      },
      ...
      requireProperties: function ( a, b, c ) {
        b.reflect = b.reflect || {};
        for ( var d in a ) this.valueReflects( a[ d ] ) && ( b.reflect[ d ] = !0 ), void 0 === b[ d ] && void 0 === c[ d ] && ( b[ d ] = this.valueForProperty( a[ d ] ) )
      },
      valueForProperty: function ( a ) {
        return "object" == typeof a && null !== a ? void 0 !== a.value ? a.value : null : a
      },
      ...
      createPropertyAccessors: function ( a ) {
        var b = a._publishNames;
        if ( b && b.length )
          for ( var c, d = 0, e = b.length; e > d && ( c = b[ d ] ); d++ ) Observer.createBindablePrototypeAccessor( a, c )
      }
    };
    ...
    var b = "attributes",
      ...
      d = {
        ...
        publishAttributes: function ( a, d ) {
          ...
          if ( e )
            for ( var f, g = a.publish || ( a.publish = {} ), h = e.split( c ), i = 0, j = h.length; j > i; i++ ) f = h[ i ].trim(), f && void 0 === g[ f ] && void 0 === d[ f ] && ( g[ f ] = null )
        },
  ...
  function ( a ) {
    ...
    var c = a.api,
      ...
      g = {};
    f.chainObject = Object.__proto__ ? function ( a, b ) {
  ...
  function ( a ) {
    ...
    function d( a ) {
      e.waitToReady = !0, CustomElements.ready = !1, HTMLImports.whenImportsReady( function () {
        e.addReadyCallback( a ), e.waitToReady = !1, e.check()
      } )
    }
    var e = {
        wait: function ( a, b, c ) {
          return -1 === this.indexOf( a ) && ( this.add( a ), a.__check = b, a.__go = c ), 0 !== this.indexOf( a )
        },
        add: function ( a ) {
          b( a ).push( a )
        },
        indexOf: function ( a ) {
          var c = b( a ).indexOf( a );
          return c >= 0 && document.contains( a ) && ( c += HTMLImports.useNative || HTMLImports.ready ? f.length : 1e9 ), c
        },
        go: function ( a ) {
          var b = this.remove( a );
        ...
        check: function () {
          ...
          return a && a.__check.call( a ), this.canReady() ? ( this.ready(), !0 ) : void 0
        },
        ...
        ready: function () {
          if ( CustomElements.ready === !1 && ( CustomElements.upgradeDocumentTree( document ), CustomElements.ready = !0 ), h )
    ...
    } ), a.queue = e, a.whenPolymerReady = d
  }( Polymer ),
  function ( a ) {
    function b( a, b ) {
  ...
  function ( a ) {
    ...
    var d = a.extend,
      ...
      j = d( Object.create( HTMLElement.prototype ), {
        ...
        init: function () {
          this.name = this.getAttribute( "name" ), this.extends = this.getAttribute( "extends" ), this.loadResources(), this.registerWhenReady()
        },
        ...
        handleNoScript: function ( a ) {
          if ( this.hasAttribute( "noscript" ) && !this.noscript )
            if ( this.noscript = !0, window.CustomElements && !CustomElements.useNative ) Polymer( a );
            else {
