      ...
      ! function o( t, i, n ) {
        ...
        6: [ function ( e, t, o ) {
          ...
          d.prototype = function () {}, i.extend( d, {
            ...
            updateArrows: function () {
              var e = this;
              e.options.arrowsControl && ( e.$arrowNext.toggleClass( "instashow-gallery-control-arrow-disabled", !e.viewsCastled && !e.hasNextView() ), e.$arrowPrevious.toggleClass( "instashow-gallery-control-arrow-disabled", !e.viewsCastled && !e.hasPreviousView() ) )
            },
            watch: function () {
              var e = this;
              ...
              return i.isArray( e ) || ( e = [ e ] ), e.filter( function ( e ) {
                ...
                return i.each( t.filters, function ( t, i ) {
                  if ( o ) switch ( e.tags || ( e.tags = [] ), i.logic ) {
                    case "only":
                      "user" === i.type ? o = e.user.username === i.name : "tag" === i.type ? o = !!~e.tags.map( function ( e ) {
                        return e.toLowerCase ? e.toLowerCase() : e
                      } ).indexOf( i.name ) : "specific_media_shortcode" === i.type ? o = !!~e.link.indexOf( i.name ) : "specific_media_id" === i.type && ( o = e.id === i.name );
                      break;
                    case "except":
                      "user" === i.type ? o = e.user.username !== i.name : "tag" === i.type ? o = !~e.tags.map( function ( e ) {
                        return e.toLowerCase ? e.toLowerCase() : e
        ...
        24: [ function ( e, t, o ) {
          ...
          i.extend( p, {
            ...
            open: function ( e ) {
              var t = this;
              return !t.showing && !t.busy && ( t.$body.css( "overflow", "hidden" ), t.busy = !0, t.findMediaId( e ).done( function ( e ) {
            ...
            createMedia: function ( e ) {
              ...
              return t.core.instapi.client.isAlternativeApi() && !A.length && o && p.hasClass( "instashow-popup-media-has-comments" ) && ( u = p.find( ".instashow-popup-media-info-content" ), u.length || ( u = i( '<div class="instashow-popup-media-info-content"></div>' ), u.appendTo( p.find( ".instashow-popup-media-info" ) ) ), d = new l( t.core.instapi.client, "specific_media_shortcode", e.code, [] ), t.core.instapi.client.setDisplayErrors( !1 ), d.fetch().done( function ( o ) {
                ...
                var A = i( n.popup.mediaComments( {
                  list: l
                } ) );
                u.append( A ), t.core.instapi.client.setDisplayErrors( !0 )
              } ) ), p
            },
            ...
            moveToMedia: function ( e, t, o ) {
              ...
              return n.isBusy() || !c ? o.reject() : ( n.busy = !0, n.core.options.popupDeepLinking && ( window.location.hash = "#!is" + n.core.id + "/$" + c.code ), n.preloadImage( c.images.standard_resolution.url ).done( function () {
                r = n.createMedia( c ), s = i().add( p ).add( r ), r.toggleClass( "instashow-popup-media-hr", p.hasClass( "instashow-popup-media-hr" ) ), s.css( {
            ...
            watch: function () {
              ...
              a.isTouchDevice() && ( e.$root.on( "touchstart", function ( i ) {
                ...
                if ( !e.isBusy() ) {
                  ...
                  i && ( n > t ? e.moveToPreviousMedia() : n < t && e.moveToNextMedia() )
                }
        ...
        26: [ function ( e, t, o ) {
          ...
          t.exports = {
            slide: function ( e, t, o, n ) {
              ...
              A = e <= 1 ? -e * o * p : -p + ( 1 - e ) * o * p, l = a.isHorizontal() ? "translate3d(" + A + "px, 0, 0)" : "translate3d(0, " + A + "px, 0)", a.$container.css( "transform", l ), a.translationPrevProgress = e
            },
