( function ( f, e ) {
  ...
  function j( h, b, c ) {
    ...
    if ( b.constructor == String ) switch ( b ) {
      ...
      var p = b,
        b = f( h ).data( "cycle.opts" );
      if ( !b ) return a( "options not found, can not advance slide" ),
        !1;
  ...
  function u( h, b, o, j, p ) {
    var i, d = f.extend( {}, f.fn.cycle.defaults, j || {}, f.metadata ? h.metadata() : f.meta ? h.data() : {} ),
      k = f.isFunction( h.data ) ? h.data( d.metaAttr ) :
      null;
    k && ( d = f.extend( d, k ) );
    ...
    d.startingSlide !== e ? ( d.startingSlide = parseInt( d.startingSlide, 10 ), d.startingSlide >= o.length || 0 > d.startSlide ? d.startingSlide = 0 : i = !0 ) : d.startingSlide =
      d.backwards ? o.length - 1 : 0;
    if ( d.random ) {
      d.randomMap = [];
    ...
    b.each( function () {
      var b = f( this );
      this.cycleH = d.fit && d.height ? d.height : b.height() || this.offsetHeight ||
        this.height || b.attr( "height" ) || 0;
      ...
      if ( b.is( "img" ) ) {
        ...
        if ( f.browser.msie && this.cycleW == 28 && this.cycleH == 30 && !this.complete || b || h || c ) {
          if ( p.s && d.requeueOnImageNotLoaded && ++j.requeueAttempts <
            100 ) {
    ...
    d.random ? ( ++d.randomIndex == o.length && ( d.randomIndex = 0 ), d.nextSlide = d.randomMap[ d.randomIndex ] ) : d.nextSlide = d.backwards ? 0 === d.startingSlide ?
      o.length - 1 : d.startingSlide - 1 : d.startingSlide >= o.length - 1 ? 0 : d.startingSlide + 1;
    if ( !d.multiFx )
  ...
  function r( a, b, c, j ) {
    ...
    if ( b.busy ) g( "transition active, ignoring new tx request" );
    else if ( !( i.cycleStop != b.stopCount || 0 === i.cycleTimeout &&
        !c ) )
      if ( !c && !i.cyclePause && !b.bounce && ( b.autostop && 0 >= --b.countdown || b.nowrap && !b.random && b.nextSlide < b.currSlide ) ) b.end && b.end( b );
        ...
        if ( ( c || !i.cyclePause ) && b.nextSlide != b.currSlide ) {
          ...
          b.oneTimeFx &&
            ( s = b.oneTimeFx, b.oneTimeFx = null );
          ...
          else f.fn.cycle.custom( d,
            k, b, t, j, c && b.fastOnEvent )
        } else l();
        if ( u || b.nextSlide == b.currSlide )
          ...
          } else b.backwards ? ( c = 0 > b.nextSlide - 1 ) && b.bounce ? ( b.backwards = !b.backwards, b.nextSlide = 1, b.currSlide = 0 ) : ( b.nextSlide = c ? a.length - 1 : b.nextSlide - 1, b.currSlide =
            c ? 0 : b.nextSlide + 1 ) : ( c = b.nextSlide + 1 == a.length ) && b.bounce ? ( b.backwards = !b.backwards, b.nextSlide = a.length - 2, b.currSlide = a.length - 1 ) : ( b.nextSlide = c ? 0 : b.nextSlide + 1, b.currSlide = c ? a.length - 1 : b.nextSlide - 1 );
  ...
  function v( a, b ) {
    ...
    f.isFunction( e ) &&
      e( 0 < c, a.nextSlide, j[ a.nextSlide ] );
    r( j, a, 1, b );
    return !1
  }
...
( function ( f ) {
  ...
  f.fn.cycle.transitions.shuffle = function ( e, g, a ) {
    ...
    a.fxFn = function ( a, e, c, g, r ) {
      ...
      n.animate( c.shuffle, c.speedIn, c.easeIn, function () {
        for ( var e = f.fn.cycle.hopsFromLast( c, r ), j = 0; j < e; j++ ) r ? c.els.push( c.els.shift() ) :
          c.els.unshift( c.els.pop() );
        if ( r ) {
          e = 0;
  ...
  f.fn.cycle.transitions.cover = function ( e, g, a ) {
    ...
    a.before.push( function ( a, e, g ) {
      ...
      "right" == l ? g.cssBefore.left = -j : "up" == l ? g.cssBefore.top =
        c : "down" == l ? g.cssBefore.top = -c : g.cssBefore.left = j
    } );
    a.animIn.left = 0;
    a.animIn.top = 0;
    a.cssBefore.top = 0;
  ...
  f.fn.cycle.transitions.wipe = function ( e, g, a ) {
    ...
    var c;
    a.clip && ( /l2r/.test( a.clip ) ? c = "rect(0px 0px " + j + "px 0px)" : /r2l/.test( a.clip ) ?
      c = "rect(0px " + l + "px " + j + "px " + l + "px)" : /t2b/.test( a.clip ) ? c = "rect(0px " + l + "px 0px 0px)" : /b2t/.test( a.clip ) ? c = "rect(" + j + "px " + l + "px " + j + "px 0px)" : /zoom/.test( a.clip ) && ( e = parseInt( j / 2, 10 ), g = parseInt( l / 2, 10 ), c = "rect(" + e + "px " + g + "px " + e + "px " + g + "px)" ) );
