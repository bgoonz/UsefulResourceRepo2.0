...
function debounce( t, e ) {
  ...
  function i( t ) {
    ...
    function n( e, i ) {
      t.fn[ e ] = function ( n ) {
        if ( "string" == typeof n ) {
          for ( var r = o.call( arguments, 1 ), a = 0, s = this.length; s > a; a++ ) {
            var u = this[ a ],
              l = t.data( u, e );
...
function () {
  ...
  o.getListeners = function ( t ) {
    ...
    var i, o, n, r, a = this.getListenersAsObject( t );
    for ( n in a )
      if ( a.hasOwnProperty( n ) )
        for ( o = a[ n ].length; o--; ) i = a[ n ][ o ], i.once === !0 && this.removeListener( t, i.listener ), r = i.listener.apply( this, e || [] ), r === this._getOnceReturnValue() && this.removeListener( t, i.listener );
    return this
    ...
    function r( e ) {
      ...
      function r( t ) {
        if ( o(), "string" == typeof t && ( t = document.querySelector( t ) ), t && "object" == typeof t && t.nodeType ) {
          ...
          for ( var a = r.isBorderBox = !( !d || !e[ d ] || "border-box" !== e[ d ] ), h = 0, p = s.length; p > h; h++ ) {
            var f = s[ h ],
              m = e[ f ];
            m = u( t, m );
            var g = parseFloat( m );
          ...
          var C = i( e.height );
          return C !== !1 && ( r.height = C + ( x ? 0 : v + T ) ), r.innerWidth = r.width - ( y + b ), r.innerHeight = r.height - ( v + T ), r.outerWidth = r.width + _, r.outerHeight = r.height + w, r
        }
      }
      ...
      function u( e, i ) {
        ...
        var o = e.style,
          ...
          r = e.runtimeStyle,
          a = r && r.left;
        return a && ( r.left = e.currentStyle.left ), o.left = i, i = o.pixelLeft, o.left = n, a && ( r.left = a ), i
      }
      var l, d, c, h = !1;
      return r
    }
    var a = "undefined" == typeof console ? o : function ( t ) {
        console.error( t )
      },
  ...
  function ( t, e ) {
    ...
    o.isArray = function ( t ) {
      ...
      for ( var n = [], r = 0, a = t.length; a > r; r++ ) {
        ...
        if ( o.isElement( s ) )
          if ( e ) {
            i( s, e ) && n.push( s );
            for ( var u = s.querySelectorAll( e ), l = 0, d = u.length; d > l; l++ ) n.push( u[ l ] )
          } else n.push( s )
      }
      return n
    ...
    return o.htmlInit = function ( i, n ) {
      e( function () {
        for ( var e = o.toDashed( n ), a = document.querySelectorAll( ".js-" + e ), s = "data-" + e + "-options", u = 0, l = a.length; l > u; u++ ) {
          var d, c = a[ u ],
            h = c.getAttribute( s );
          try {
            d = h && JSON.parse( h )
          } catch ( p ) {
            r && r.error( "Error parsing " + s + " on " + c.nodeName.toLowerCase() + ( c.id ? "#" + c.id : "" ) + ": " + p );
            continue
          }
          var f = new i( c, d ),
            m = t.jQuery;
  ...
  function ( t, e ) {
    ...
    n.extend( a.prototype, e.prototype ), a.prototype._create = function () {
      this._transn = {
        ingProperties: {},
        clean: {},
        onEnd: {}
      ...
      s = isNaN( s ) ? 0 : s, u = isNaN( u ) ? 0 : u, s -= i ? a.paddingLeft : a.paddingRight, u -= o ? a.paddingTop : a.paddingBottom, this.position.x = s, this.position.y = u
      ...
      i[ u ] = this.getYValue( d ), i[ l ] = "", this.css( i ), this.emitEvent( "layout", [ this ] )
  ...
  function ( t, e ) {
    "use strict";
    "function" == typeof define && define.amd ? define( "outlayer/outlayer", [ "eventie/eventie", "eventEmitter/EventEmitter", "get-size/get-size", "fizzy-ui-utils/utils", "./item" ], function ( i, o, n, r, a ) {
    ...
    return a.namespace = "outlayer", a.Item = r, a.defaults = {
    ...
    }, n.extend( a.prototype, i.prototype ), a.prototype.option = function ( t ) {
      n.extend( this.options, t )
    }, a.prototype._create = function () {
      this.reloadItems(), n.extend( this.element.style, this.options.containerStyle ), this.options.isResizeBound && this.bindResize()
      ...
      return Object.create ? i.prototype = Object.create( a.prototype ) : n.extend( i.prototype, a.prototype ), i.prototype.constructor = i, i.defaults = n.extend( {}, a.defaults ), n.extend( i.defaults, e ), i.prototype.settings = {}, i.namespace = t, i.data = a.data, i.Item = function () {
  ...
  function ( t, e ) {
    ...
    function i( t ) {
      this.TG_Layout = t, t && ( this.options = t.options[ this.namespace ], this.element = t.element, this.items = t.filteredItems, this.size = t.size )
    }
    return function () {
      function t( t ) {
        return function () {
      ...
      for ( var o = [ "_resetLayout", "_getItemLayoutPosition", "_getContainerSize", "_getElementOffset", "needsResizeLayout" ], n = 0, r = o.length; r > n; n++ ) {
        var a = o[ n ];
        i.prototype[ a ] = t( a )
      }
  ...
  function ( t, e ) {
    ...
    return o.prototype._resetLayout = function () {
      ...
      if ( this.options.isFitRows ) {
        ...
        0 !== this.x && u + this.x > l && ( this.x = 0, this.y = this.maxY )
      } else this.x = this.columnWidth * s, this.y = a;
      var d = {
        x: this.x,
        y: this.y
      };
      this.options.isFitRows && ( this.maxY = Math.max( this.maxY, this.y + t.size.outerHeight + this.gutter ), this.x += u );
      for ( var c = a + t.size.outerHeight + this.gutter, h = this.cols + 1 - r.length, p = 0; h > p; p++ ) this.colYs[ s + p ] = c;
      return d
  ...
  function ( t, e ) {
    ...
    i( o.prototype, e.prototype ), o.prototype._getElementOffset = n, o.prototype.layout = r, o.prototype._getMeasurement = a;
  ...
  function ( t, e ) {
    "use strict";
    "function" == typeof define && define.amd ? define( [ "outlayer/outlayer", "get-size/get-size", "matches-selector/matches-selector", "fizzy-ui-utils/utils", "TG_Layout/js/item", "TG_Layout/js/layout-mode", "TG_Layout/js/layout-modes/masonry" ], function ( i, o, n, r, a, s ) {
    ...
    h.Item = r, h.LayoutMode = a, h.prototype._create = function () {
      ...
      e = e || "*";
      for ( var i = [], o = [], n = [], r = this._getFilterTest( e ), a = 0, s = t.length; s > a; a++ ) {
        var u = t[ a ];
        if ( !u.isIgnored ) {
          var l = r( u );
          l && i.push( u ), l && u.isHidden ? o.push( u ) : l || u.isHidden || n.push( u )
        }
      }
      return {
        matches: i,
  ...
  function ( t, e ) {
    ...
    return e.Rect = t, t.defaults = {
      ...
      return this.y < e.y && ( i = new t( {
        ...
        width: this.width,
        height: e.y - this.y
      } ), o.push( i ) ), n > a && ( i = new t( {
        x: a,
        y: this.y,
        width: n - a,
        height: this.height
      } ), o.push( i ) ), r > s && ( i = new t( {
        x: this.x,
        y: s,
        width: this.width,
        height: r - s
  ...
  function ( t, e ) {
    ...
    return u.Item = r, u.prototype._create = function () {
      ...
      var o = e( t ),
        n = o.outerWidth,
        r = o.outerHeight;
      ( n || r ) && ( n = this._applyGridGutter( n, this.columnWidth ), r = this._applyGridGutter( r, this.rowHeight ) ), i.width = Math.min( n, this.packer.width ), i.height = Math.min( r, this.packer.height )
  ...
  function ( t, e ) {
    ...
    o( n.prototype, e.prototype ), n.prototype._getElementOffset = r, n.prototype._getMeasurement = a;
  ...
  function ( t ) {
    ...
    "function" == typeof define && define.amd ? define( [ "TG_Layout/js/TG_Layout-mode" ], cellsByRowDefinition ) : e( t.TG_Layout.LayoutMode )
  }( window ),
  function ( t ) {
  ...
  function ( t, e, i ) {
    ...
    function o( e, f, m ) {
      function x( e ) {
        ...
        if ( !n ) return !1;
        if ( ct = lt.width(), gt = ft.width(), ht = dt.outerWidth(), bt.length = 0, pt.start = 0, pt.end = E( ht - ct, 0 ), Et ) {
          i = xt.length, Tt = dt.children( at.itemSelector ), xt.length = 0;
          for ( var a, s = l( dt, at.horizontal ? "paddingLeft" : "paddingTop" ), u = l( dt, at.horizontal ? "paddingRight" : "paddingBottom" ), c = "border-box" === t( Tt ).css( "boxSizing" ), h = n.filteredItems, p = 0, f = 0, m = 0, g = [], y = [], v = 0; v < h.length; v++ ) {
            var _ = parseFloat( getComputedStyle( h[ v ].element ).width ) + r,
              w = h[ v ].position.x;
            m = w + _ > m ? w + _ : m, g.push( w )
          }
          g.push( m ), g.sort( function ( t, e ) {
            return t - e
          } );
          for ( var v = 1; v < g.length; v++ ) y.push( g[ v ] - g[ v - 1 ] );
          ht = 0, t( h ).each( function ( t, e ) {
            var i = r / 2,
              o = r / 2,
              n = {};
            n.el = e, n.size = y[ t ], n.half = n.size / 2, n.start = ht - i, n.center = n.start - G( ct / 2 - n.size / 2 ), n.end = n.start - ct + n.size, t || ( ht += s ), ht += n.size, at.horizontal || o && i && t > 0 && ( ht -= k( i, o ) ), t === f && ( n.end += u, ht += u, p = o ), n.size && ( xt.push( n ), a = n )
          } ), dt[ 0 ].style[ at.horizontal ? "width" : "height" ] = ( c ? ht : ht - s - u ) + "px", ht -= p, xt.length ? ( pt.start = xt[ 0 ][ Pt ? "center" : "start" ], pt.end = Pt ? a.center : ht > ct ? a.end : pt.start ) : pt.start = pt.end = 0
        }
        if ( pt.center = G( pt.end / 2 + pt.start / 2 ), A(), !ut && ct > 0 ) {
          var b = pt.start,
            T = "";
          if ( Et ) t.each( xt, function ( t, e ) {
            Pt ? bt.push( e.center ) : e.start + e.size > b && b <= pt.end && ( b = e.start, bt.push( e.size < ct && "justified" === n.options.layoutMode ? e.start + ( e.size - ct ) / 2 : e.start ), b += ct, b > pt.end && b < pt.end + ct && bt.push( pt.end ) )
          } );
          else
            for ( ; b - ct < pt.end; ) bt.push( b ), b += ct;
          if ( _t[ 0 ] && o !== bt.length ) {
            for ( var v = 0; v < bt.length; v++ ) T += at.pageBuilder.call( st, v );
            1 === bt.length && ( T = null ), wt = _t.html( T ).children(), wt.eq( zt.activePage ).addClass( at.activeClass )
          }
        }
        if ( zt.slideeSize = ht, zt.frameSize = ct, zt.sbSize = gt, zt.handleSize = yt, Et ) {
          e && null != at.startAt && st[ Gt ? "toCenter" : "toStart" ]( at.startAt );
      ...
      function M( t, e, i ) {
        if ( Et && Nt.released && !i ) {
          ...
          Gt ? ( n && ( t = xt[ o.centerItem ].center ), Pt && at.activateMiddle && activate( o.centerItem ) ) : n && ( t = xt[ o.firstItem ].start )
        }
        Nt.init && Nt.slidee && at.elasticBounds ? t > pt.end ? t = pt.end + ( t - pt.end ) / 6 : t < pt.start && ( t = pt.start + ( t - pt.start ) / 6 ) : t = d( t, pt.start, pt.end ), Ht.start = +new Date, Ht.time = 0, Ht.from = pt.cur, Ht.to = t, Ht.delta = t - pt.cur, Ht.tweesing = Nt.tweese || Nt.init && !Nt.slidee, Ht.immediate = !Ht.tweesing && ( e || Nt.init && Nt.slidee || !at.speed ), Nt.tweese = 0, t !== pt.dest && ( pt.dest = t, ot( "change" ), Yt || R() ), N(), A(), H(), D()
      }

      function R() {
        if ( st.initialized ) {
          if ( !Yt ) return Yt = v( R ), void( Nt.released && ot( "moveStart" ) );
          Ht.immediate ? pt.cur = Ht.to : Ht.tweesing ? ( Ht.tweeseDelta = Ht.to - pt.cur, S( Ht.tweeseDelta ) < .1 ? pt.cur = Ht.to : pt.cur += Ht.tweeseDelta * ( Nt.released ? at.swingSpeed : at.syncSpeed ) ) : ( Ht.time = k( +new Date - Ht.start, at.speed ), pt.cur = Ht.from + Ht.delta * t.easing[ at.easing ]( Ht.time / at.speed, Ht.time, 0, 1, at.speed ) ), Ht.to === pt.cur ? ( pt.cur = Ht.to, Nt.tweese = Yt = 0 ) : Yt = v( R ), ot( "move" ), ut || ( h ? dt[ 0 ].style[ h ] = p + ( at.horizontal ? "translateX" : "translateY" ) + "(" + -pt.cur + "px)" : dt[ 0 ].style[ at.horizontal ? "left" : "top" ] = -G( pt.cur ) + "px" ), !Yt && Nt.released && ot( "moveEnd" )
        }
      }

      function D() {
        wt[ 0 ] && At.page !== zt.activePage && ( At.page = zt.activePage, wt.removeClass( at.activeClass ).eq( zt.activePage ).addClass( at.activeClass ), ot( "activePage", At.page ) )
      }

      function O() {
        Ft.speed && pt.cur !== ( Ft.speed > 0 ? pt.end : pt.start ) || st.stop(), Vt = Nt.init ? v( O ) : 0, Ft.now = +new Date, Ft.pos = pt.cur + ( Ft.now - Ft.lastTime ) / 1e3 * Ft.speed, M( Nt.init ? Ft.pos : G( Ft.pos ) ), Nt.init || pt.cur !== pt.dest || ot( "moveEnd" ), Ft.lastTime = Ft.now
      }
      ...
      function B( t ) {
        return null != t ? u( t ) ? t >= 0 && t < xt.length ? t : -1 : Tt.index( t ) : -1
      }
      ...
      function q( t ) {
        ...
        if ( Et ) {
          for ( var r = !1, a = !1, s = !1, l = 0, c = xt.length; c > l; l++ )
            if ( r === !1 && t <= xt[ l ].start + xt[ l ].half && ( r = l ), s === !1 && t <= xt[ l ].center + xt[ l ].half && ( s = l ), l === c - 1 || t <= xt[ l ].end + xt[ l ].half ) {
              a = l;
              break
            } e.firstItem = u( r ) ? r : 0, e.centerItem = u( s ) ? s : e.firstItem, e.lastItem = u( a ) ? a : e.centerItem
        }
        return e
      }
      ...
      function H() {
        var t = pt.dest <= pt.start,
          e = pt.dest >= pt.end,
          i = ( t ? 1 : 0 ) | ( e ? 2 : 0 );
        if ( At.slideePosState !== i && ( At.slideePosState = i, Wt.is( "button,input" ) && Wt.prop( "disabled", t ), Bt.is( "button,input" ) && Bt.prop( "disabled", e ), Wt.add( Rt )[ t ? "addClass" : "removeClass" ]( at.disabledClass ), Bt.add( Mt )[ e ? "addClass" : "removeClass" ]( at.disabledClass ) ), At.fwdbwdState !== i && Nt.released && ( At.fwdbwdState = i, Rt.is( "button,input" ) && Rt.prop( "disabled", t ), Mt.is( "button,input" ) && Mt.prop( "disabled", e ) ), Et && null != zt.activeItem ) {
          var o = 0 === zt.activeItem,
            n = zt.activeItem >= xt.length - 1,
            r = ( o ? 1 : 0 ) | ( n ? 2 : 0 );
          At.itemsButtonState !== r && ( At.itemsButtonState = r, Dt.is( "button,input" ) && Dt.prop( "disabled", o ), Ot.is( "button,input" ) && Ot.prop( "disabled", n ), Dt[ o ? "addClass" : "removeClass" ]( at.disabledClass ), Ot[ n ? "addClass" : "removeClass" ]( at.disabledClass ) )
        }
      }
      ...
      function Y( t ) {
        return G( d( t, vt.start, vt.end ) / vt.end * ( pt.end - pt.start ) ) + pt.start
      }
      ...
      function V( e ) {
        var i = "touchstart" === e.type,
          o = e.data.source,
          n = "slidee" === o;
        Nt.init || !i && Z( e.target ) || ( "handle" !== o || at.dragHandle && vt.start !== vt.end ) && ( !n || ( i ? at.touchDragging : at.mouseDragging && e.which < 2 ) ) && ( i || r( e ), X( o ), Nt.init = 0, Nt.$source = t( e.target ), Nt.touch = i, Nt.pointer = i ? e.originalEvent.touches[ 0 ] : e, Nt.initX = Nt.pointer.pageX, Nt.initY = Nt.pointer.pageY, Nt.initPos = n ? pt.cur : vt.cur, Nt.start = +new Date, Nt.time = 0, Nt.path = 0, Nt.delta = 0, Nt.locked = 0, Nt.history = [ 0, 0, 0, 0 ], Nt.pathToLock = n ? i ? 30 : 10 : 0, _.on( i ? T : b, U ), st.pause( 1 ), ( n ? dt : mt ).addClass( at.draggedClass ), ot( "moveStart" ), n && ( Qt = setInterval( Q, 10 ) ) )
      }

      function U( t ) {
        if ( Nt.released = "mouseup" === t.type || "touchend" === t.type, Nt.pointer = Nt.touch ? t.originalEvent[ Nt.released ? "changedTouches" : "touches" ][ 0 ] : t, Nt.pathX = Nt.pointer.pageX - Nt.initX, Nt.pathY = Nt.pointer.pageY - Nt.initY, Nt.path = j( P( Nt.pathX, 2 ) + P( Nt.pathY, 2 ) ), Nt.delta = at.horizontal ? Nt.pathX : Nt.pathY, Nt.released || !( Nt.path < 1 ) ) {
          if ( !Nt.init ) {
            if ( !( at.horizontal ? S( Nt.pathX ) > S( Nt.pathY ) : S( Nt.pathX ) < S( Nt.pathY ) ) ) return $();
            Nt.init = 1
          }
          r( t ), !Nt.locked && Nt.path > Nt.pathToLock && Nt.slidee && ( Nt.locked = 1, Nt.$source.on( z, a ) ), Nt.released && ( $(), at.releaseSwing && Nt.slidee && ( Nt.swing = ( Nt.delta - Nt.history[ 0 ] ) / 40 * 300, Nt.delta += Nt.swing, Nt.tweese = S( Nt.swing ) > 10 ) ), M( Nt.slidee ? G( Nt.initPos - Nt.delta ) : Y( Nt.initPos + Nt.delta ) )
        }
      }

      function $() {
        clearInterval( Qt ), Nt.released = !0, _.off( Nt.touch ? T : b, U ), ( Nt.slidee ? dt : mt ).removeClass( at.draggedClass ), setTimeout( function () {
          Nt.$source.off( z, a )
        } ), pt.cur === pt.dest && Nt.init && ot( "moveEnd" ), st.resume( 1 ), Nt.init = 0
      }
      ...
      function tt( t ) {
        if ( at.keyboardNavBy ) switch ( t.which ) {
          case at.horizontal ? 37:
            38: r( t ), st[ "pages" === at.keyboardNavBy ? "prevPage" : "prev" ]();
            break;
          case at.horizontal ? 39:
            40: r( t ), st[ "pages" === at.keyboardNavBy ? "nextPage" : "next" ]()
        }
      }
      ...
      function ot( t, e ) {
        if ( qt[ t ] ) {
          for ( rt = qt[ t ].length, I.length = 0, nt = 0; rt > nt; nt++ ) I.push( qt[ t ][ nt ] );
          for ( nt = 0; rt > nt; nt++ ) I[ nt ].call( st, t, e )
        }
      }
      var nt, rt, at = t.extend( {}, o.defaults, f ),
        st = this,
        ut = u( e ),
        lt = t( e ),
        ...
        Et = !ut && ( jt || Gt || Pt ),
        kt = ( at.scrollSource ? t( at.scrollSource ) : lt, at.dragSource ? t( at.dragSource ) : lt ),
        Mt = t( at.forward ),
        Rt = t( at.backward ),
        Dt = t( at.prev ),
        Ot = t( at.next ),
        ...
        Xt = 0,
        Vt = 0;
      ut || ( e = lt[ 0 ] ), st.initialized = 0, st.frame = e, st.slidee = dt[ 0 ], st.pos = pt, st.rel = zt, st.items = xt, st.pages = bt, st.isPaused = 0, st.options = at, st.dragging = Nt, st.reload = function () {
        x()
        ...
        if ( i[ 0 ] ) {
          var o = at.horizontal ? i.offset().left - dt.offset().left : i.offset().top - dt.offset().top,
        ...
        Ft.speed = t, !Nt.init && Ft.speed && pt.cur !== ( Ft.speed > 0 ? pt.end : pt.start ) && ( Ft.lastTime = +new Date, Ft.startPos = pt.cur, X( "button" ), Nt.init = 1, ot( "moveStart" ), y( Vt ), O() )
      }, st.stop = function () {
        ...
        t && ( Et ? st[ Gt ? "toCenter" : "toStart" ]( d( ( Gt ? zt.centerItem : zt.firstItem ) + at.scrollBy * t, 0, xt.length ) ) : M( pt.dest + t, e ) )
        ...
        W( "center", t, e )
      }, st.getIndex = B, st.activatePage = function ( t, e ) {
        u( t ) && M( bt[ d( t, 0, bt.length - 1 ) ], e )
      }, st.resume = function ( t ) {
        at.cycleBy && at.cycleInterval && ( "items" !== at.cycleBy || xt[ 0 ] && null != zt.activeItem ) && !( t < st.isPaused ) && ( st.isPaused = 0, Xt ? Xt = clearTimeout( Xt ) : ot( "resume" ), Xt = setTimeout( function () {
        ...
        t < st.isPaused || ( st.isPaused = t || 100, Xt && ( Xt = clearTimeout( Xt ), ot( "pause" ) ) )
      }, st.toggle = function () {
        st[ Xt ? "pause" : "resume" ]()
      }, st.on = function ( t, e ) {
        if ( "object" === n( t ) )
          ...
          for ( var o = t.split( " " ), r = 0, a = o.length; a > r; r++ ) qt[ o[ r ] ] = qt[ o[ r ] ] || [], -1 === F( o[ r ], e ) && qt[ o[ r ] ].push( e );
        else if ( "array" === n( e ) )
        ...
        if ( !st.initialized ) {
          ...
          Ct.save.apply( Ct, t ), It.save.apply( It, t ), Lt.save.apply( Lt, e ), St.save.apply( St, e );
          var i = mt;
          return ut || ( i = i.add( dt ), lt.css( "overflow", "hidden" ), h || "static" !== lt.css( "position" ) || lt.css( "position", "relative" ) ), h ? p && i.css( h, p ) : ( "static" === ft.css( "position" ) && ft.css( "position", "relative" ), i.css( {
            position: "absolute"
          } ) ), at.forward && Mt.on( C, K ), at.backward && Rt.on( C, K ), at.prev && Dt.on( z, K ), at.next && Ot.on( z, K ), at.prevPage && Wt.on( z, K ), at.nextPage && Bt.on( z, K ), _t[ 0 ] && at.activatePageOn && _t.on( at.activatePageOn + "." + g, "*", et ), kt.on( w, {
            source: "slidee"
          }, V ), mt && mt.on( w, {
            source: "handle"
          }, V ), _.on( "keydown", tt ), ut || ( lt.on( "mouseenter." + g + " mouseleave." + g, it ), lt.on( "scroll." + g, s ) ), st.initialized = 1, x( !0 ), at.cycleBy && !ut && st[ at.startPaused ? "pause" : "resume" ](), st
        }
      }
    }
    ...
    var h, p, f = "TG_Slider",
      ...
      x = ( document.implementation.hasFeature( "Event.wheel", "3.0" ) ? "wheel." : "mousewheel." ) + g,
      z = "click." + g,
      C = "mousedown." + g,
    ...
    _.on( x, function ( t ) {
      ...
      function ( t ) {
        ...
        var i = ( new Date ).getTime(),
          o = t.cancelAnimationFrame || t.webkitCancelAnimationFrame || t.clearTimeout;
        y = function ( e ) {
          o.call( t, e )
        }
      }( window ),
      ...
      }(), e[ m ] = o, t.fn[ f ] = function ( e, i ) {
        var r, a;
        return t.isPlainObject( e ) || ( ( "string" === n( e ) || e === !1 ) && ( r = e === !1 ? "destroy" : e, a = Array.prototype.slice.call( arguments, 1 ) ), e = {} ), this.each( function ( n, s ) {
          var u = t.data( s, g );
          u || r ? u && r && u[ r ] && u[ r ].apply( u, a ) : u = t.data( s, g, new o( s, e, i ).init() )
        } )
      }
...
! function ( t ) {
  ...
  function e() {
    var e, i, o, n, r, a, s = window.navigator.userAgent.indexOf( "Edge/" ),
      u = "ontouchstart" in window || navigator.msMaxTouchPoints,
      l = "div:not(.tg-item-gallery-holder) > .tg-item-image, .tg-item-media-poster, .tg-item-audio-poster, .tg-item-gallery-holder",
      d = .4,
      c = 0;
    !u && !t( "body" ).hasClass( "is-ie" ) && 0 > s && t( document ).on( "mousemove", ".tg-panZ", function ( s ) {
      e = t( this ), n = e.width(), o = e.height(), i = e.closest( ".tg-item" ).offset();
      var u = Date.now();
      u > c + 80 && ( c = u, window.requestAnimationFrame( function () {
        r = .08 * -( s.pageX - i.left - n / 2 ) * d, a = .08 * -( s.pageY - i.top - o / 2 ) * d, t( s.target ).closest( ".tg-item" ).find( l ).css( {
  ...
  function o() {
    function e( t, e ) {
      var i = s.scrollTop || a.scrollTop,
        ...
        v = d > l ? d / l * 2 : 1,
        _ = 3 * l * v,
        w = "perspective(" + _ + "px) rotateX(" + y + "deg) rotateY(" + g + "deg) scale3d(1.03,1.03,1.03)";
      e.css( "transform", w + " translateX(" + 2 * h * ( 2.5 / c ) + "px) translateY(" + 1 * p * ( 2.5 / c ) + "px)" )
    }
    ...
    function o( t ) {
      t.removeClass( "over" ), setTimeout( function () {
    ...
    u || t( document ).on( "mousemove", ".tg-atv-anim", function ( i ) {
      var o = t( this ),
        n = Date.now();
      n > r + l && ( r = n, window.requestAnimationFrame( function () {
        e( i, o )
      } ) )
    ...
    return this.each( function () {
      ...
      function i( e ) {
        for ( var i = 0; i < t( e ).length; i++ )
          for ( var o, n, r = t( e ).eq( i ), a = r.get( 0 ).attributes, s = 0; s < a.length; s++ ) o = a[ s ].name, n = a[ s ].value, 0 === o.indexOf( "data-" ) && "data-row" !== o && "data-col" !== o && ( r.removeAttr( o ), r.data( o.replace( "data-", "" ), n ), s-- )
      }

      function o( e ) {
        if ( !Y ) return !1;
        var i;
        nt.removeClass( "tg-item-index" ), st.val( "" ), vt.filterComb ? ( i = [], q = "*" === e.data( "filter" ) ? e.nextAll( "[data-filter]" ).removeClass( "tg-filter-active" ) : e.prevAll( '[data-filter="*"]' ).removeClass( "tg-filter-active" ), q = "*" === e.data( "filter" ) ? e.closest( "select" ).find( "option" ).prop( "selected", !1 ) : e.closest( "select" ).find( '[data-filter="*"]' ).prop( "selected", !0 ), e.toggleClass( "tg-filter-active" ), $.find( ".tg-filter-active" ).each( function () {
          "*" != t( this ).data( "filter" ) && i.push( t( this ).data( "filter" ) )
        } ), i = "AND" === vt.filterLogic ? n( i ) : i.join( ", " ) ) : ( i = e.data( "filter" ), at.removeClass( "tg-filter-active" ), e.addClass( "tg-filter-active" ) ), q = !i && $.find( '[data-filter="*"]' ).addClass( "tg-filter-active" ), r(), A.TG_Layout( {
          filter: i
        } ), t.TG_Pause_Players()
      }
      ...
      function r() {
        rt.each( function ( e, i ) {
          ...
          q = 0 === o && t( this ).find( '[data-filter="*"]' ).addClass( "tg-filter-active" )
        } )
      }

      function a( t ) {
        return Y ? ( C = "none" === t.data( "value" ) ? "" : t.data( "value" ), L = t.text(), F = ct.data( "asc" ), nt.removeClass( "tg-item-index" ), lt.find( ".tg-dropdown-value" ).text( L ), void A.TG_Layout( {
          sortAscending: F,
          sortBy: C
        } ) ) : !1
      }
      ...
      function u() {
        if ( vt.gallery ) {
          var e;
          d(), !The_Grid.galleryInt && t( The_Grid.gallery ).length > 0 && ( The_Grid.galleryInt = setInterval( function () {
            I = Math.floor( Math.random() * H.length ), S = S === I && H.length > 0 ? l( H, I + 1 ) : I, e = t( The_Grid.gallery ).eq( S ), j = H.length > 0 ? l( H[ S ], e.find( ".show" ).index() - 1 + 2 ) : 0, e.find( The_Grid.itemImg ).removeClass( "show" ), e.find( The_Grid.itemImg ).eq( j ).addClass( "show" )
          }, 3500 ) )
        }
      }
      ...
      function c() {
        for ( var t = 0; t < at.length; t++ ) {
          ...
          at.eq( t ).find( The_Grid.tooltip ).html( o ), q = at.eq( t ).find( "span:first-child" ).data( "count" ) && at.eq( t ).find( "span:first-child" ).data( "tooltip", o ), q = 0 === o ? at.eq( t ).removeClass( "tg-show-filter" ) : at.eq( t ).addClass( "tg-show-filter" )
        }
      }

      function h() {
        if ( tt.length > 0 )
          if ( N = tt.data( "item-tt" ) ? tt.data( "item-tt" ) - nt.length : 99999, 0 >= N ) tt.addClass( "tg-no-more" ), tt.find( "span" ).html( tt.data( "no-more" ) ), setTimeout( function () {
            tt.fadeOut( 500 )
          }, 3e3 );
          else {
            var t = tt.data( "button" );
            q = tt.data( "remain" ) ? tt.find( "span" ).html( t + " (" + N + ")" ) : tt.find( "span" ).html( t )
          }
      }
      ...
      function p() {
        var e, i = 0,
          o = A.data( "TG_Layout" );
        q = 0 === mt.length ? K.remove() : K.hide(), $.removeClass( "tg-grid-loading" ), x = o.filteredItems, x.length > 0 ? e = window.tgInterval( function () {
          A.closest( "body" ).length > 0 && ( t( x[ i ].element ).removeClass( "tg-item-reveal" ), q = vt.itemDelay && A.TG_Layout( "reveal", [ x[ i ] ] ), i !== x.length - 1 && vt.itemDelay || ( Y = !0, nt.removeClass( "tg-item-reveal" ), $.addClass( "tg-grid-loaded" ), q = !vt.itemDelay && A.TG_Layout( "reveal", x ), e.clear() ), i++ )
        }, vt.itemDelay ) : ( Y = !0, nt.removeClass( "tg-item-reveal" ), $.addClass( "tg-grid-loaded" ) )
      }

      function f() {
        for ( var e = "justified" !== vt.style ? vt.cols : vt.rows, i = m().width, o = 0, n = e.length; n > o && e[ o ][ 0 ] >= i; o++ ) R = e[ o ][ 1 ], G = vt.gutters[ o ][ 1 ];
        if ( ot.width( G ), "justified" !== vt.style ) {
          var r = $.width();
          if ( D = r / R - G, "vertical" === vt.layout && ( A.width( "" ), W = ( R - 1 ) * G, D = ( r - W ) / R, D = D % 1 !== 0 ? Math.ceil( D ) : D, B = R * D + W, A.css( "left", -( B - A.width() ) / 2 + "px" ), A.width( B ) ), vt.fullHeight && "horizontal" === vt.layout ) {
            var a = t( "#wpadminbar" ).height();
            O = 0 === Z.length ? ( t( window ).height() - a - G * ( vt.row - 1 ) ) / vt.row : Z.height() / vt.row
        ...
        if ( "justified" !== vt.style ) {
          ...
          for ( var t = 0; t < nt.length; t++ ) {
            var e = nt.eq( t ).data( "col" ),
              i = nt.eq( t ).data( "row" );
            i = "horizontal" === vt.layout && i > vt.row ? vt.row : i, 1 === R ? ( E = D, k = O ) : e > R ? ( M = Math.round( R / ( e / i ) ), M = 1 >= M ? 1 : M, E = R * D + ( R - 1 ) * G, k = 1 === M ? O : M * O + ( M - 1 ) * G ) : ( E = e * D + ( e - 1 ) * G, k = i * O + ( i - 1 ) * G ), nt.eq( t ).width( E ), q = "grid" === vt.style ? nt.eq( t ).height( k ) : null
          }
        }
      }
      ...
      function y() {
        if ( "horizontal" === vt.layout ) {
          var e;
          "masonry" === vt.style ? ( $.removeClass( "tg-grid-loading" ), e = Math.max.apply( null, nt.map( function () {
            return t( this ).height()
          } ).get() ), A.add( J ).height( e ) ) : ( e = O * vt.row + G * ( vt.row - 1 ), A.add( J ).height( e ) )
        }
      }

      function v() {
        var t, e, o = !1;
        "horizontal" === vt.layout ? ( o = !0, t = e = "grid" === vt.style ? "packery" : "justified" === vt.style ? "justified" : "horizontal" ) : t = e = "grid" === vt.style ? "packery" : vt.style;
        var n = {};
        n[ e ] = {}, n.hiddenStyle = {}, n.visibleStyle = {}, n.layoutMode = t, n.filter = vt.filterLoad, "none" !== vt.sortByLoad && ( n.sortBy = vt.sortByLoad ), n.sortAscending = vt.orderLoad, n.isOriginLeft = vt.rtl, n.itemSelector = The_Grid.item, n[ e ].gutter = ot[ 0 ], n[ e ].rowHeight = it[ 0 ], n[ e ].columnWidth = it[ 0 ], n[ e ].isHorizontal = o, n[ e ].isFitRows = vt.fitrows, n[ e ].image = The_Grid.itemImg, n[ e ].row = vt.row, n[ e ].previewMode = Z, n.hiddenStyle.opacity = 0, n.visibleStyle.opacity = 1, n.hiddenStyle.transform = vt.animation.hidden, n.visibleStyle.transform = vt.animation.visible, n.transitionDuration = vt.transition, n.getSortData = The_Grid.sortData, A.TG_Layout( n ), i( nt )
      }
      ...
      function _() {
        if ( "horizontal" === vt.layout ) {
          var e = A.data( "TG_Layout" ),
            i = e.filteredItems,
            o = vt.startAt = vt.startAt - 1 > i.length ? i.length : vt.startAt;
          "forceCentered" === vt.itemNav && 0 === ft.length && ( ft = t( t( '<div class="tg-slider-bullets"></div>' ) ).appendTo( $ ).hide() ), P = new TG_Slider( J, {
          ...
          } ).init(), J.data( "slider", P ).trigger( "tg-slider-init" ), "forceCentered" === vt.itemNav && ( t( i[ o - 1 ].element ).addClass( "tg-active-item" ), P.on( "load activePage", function ( o ) {
            o = this.rel.activePage, e = A.data( "TG_Layout" ), i = e.filteredItems, nt.removeClass( "tg-active-item" ), q = i[ o ] && t( i[ o ].element ).addClass( "tg-active-item" )
          } ) )
        }
      }

      function w( e ) {
        if ( V && ( 3 == V.readyState || 2 == V.readyState || 1 == V.readyState ) ) return !1;
        var o = {
        ...
        V = t.ajax( {
          ...
          data: o,
          beforeSend: function () {
            Q = !0, X += 1, q = tt.data( "loading" ) && !tt.hasClass( "tg-no-more" ) && tt.find( "span" ).html( tt.data( "loading" ) ), q = t( et ).length > 0 && 0 === tt.length && t( et ).addClass( "tg-loading" )
          },
          success: function ( o ) {
            var n = o.success,
              r = o.message,
            ...
            if ( e.data( "ajax", s ), !n ) return tt.add( t( et ) ).add( mt ).removeClass( "tg-loading" ), K.find( "> div" ).html( r ), tt.find( "span" ).html( r ), t( et ).children( "div" ).html( r ), X -= 1, !1;
            if ( !a ) return tt.data( "item-tt", -1 ), h(), t( et ).children( "div" ).html( t( et ).children( "div" ).data( "no-more" ) ), setTimeout( function () {
              t( et ).fadeOut( 400 )
            }, 1e3 ), X -= 1, !1;
            var f = t( a );
            q = 0 === mt.length && f.addClass( "tg-item-index" ), f.find( The_Grid.grid ).length > 0 && ( f = f.find( The_Grid.item ).removeClass( "tg-item-reveal" ) ), e.append( f ), nt = e.find( The_Grid.item ), f.hide(), g(), t.TG_media_init(), c(), d(), u(), T(), f = t( t.grep( f, function ( t ) {
            ...
            f.the_grid_images_loaded( {
              complete: function () {
                var n, r = 0;
                K.hide(), q = o && t( et ).removeClass( "tg-loading" ), q = "horizontal" === vt.layout && e.css( "min-height", "" ), q = "masonry" === vt.style && "horizontal" === vt.layout && y(), n = window.tgInterval( function () {
                  if ( e.closest( "body" ).length > 0 ) {
                    if ( q = vt.ajaxDelay && e.TG_Layout( "appended", f.eq( r ) ), q = "horizontal" === vt.layout && P.reload(), m === r || !vt.ajaxDelay ) return c(), h(), q = !vt.ajaxDelay && e.TG_Layout( "appended", f ), q = "horizontal" === vt.layout && P.reload(), mt.removeClass( "tg-loading" ), Q = !1, n.clear(), q = "undefined" != typeof FOOBOX && t.isFunction( FOOBOX.init ) && FOOBOX.init(), q = t().fancybox && t( ".tg-item a.fancybox" ).fancybox(), q = t().prettyPhoto && t( '.tg-item  a[rel^="prettyPhoto"]' ).prettyPhoto(), i( nt ), !1;
                    r++
                  }
                }, vt.ajaxDelay )
              }
      ...
      function b() {
        return Z.length > 0 ? new TG_metaData( t( "#the_grid_metabox .tomb-row" ) ) : void 0
      }

      function T() {
        Z.length > 0 && TG_excludeItem()
      }
      var x, z, C, L, I, S, j, P, G, E, k, M, R, D, O, W, B, q, A = t( this ),
        H = [],
        F = !0,
        N = !0,
        Y = !1,
        ...
        $ = t( '[id="' + U + '"]' ).length > 1 ? A.closest( The_Grid.wrapper ) : t( "#" + U ),
      ...
      vt.cols.sort( function ( t, e ) {
        ...
        return e[ 0 ] - t[ 0 ]
      } ), vt.rtl = vt.rtl ? !1 : !0, vt.ajaxDelay = mt.length > 0 ? vt.itemDelay : vt.ajaxDelay;
      for ( var _t = t.map( gt, function ( t, e ) {
          return e
        } ), wt = 0; wt < _t.length; wt++ ) A.removeAttr( "data-" + _t[ wt ] );
      s(), f( A ), g(), u(), c(), "masonry" === vt.style || "justified" === vt.style || vt.preloader || "horizontal" === vt.layout ? nt.the_grid_images_loaded( {
        complete: function () {
          y(), v(), _(), q = vt.preloader && p(), q = "horizontal" === vt.layout && A.TG_Layout( "on", "arrangeComplete", function ( t ) {
            e( t )
          } )
        }
      } ) : ( v(), _(), q = "horizontal" === vt.layout && A.TG_Layout( "on", "arrangeComplete", function ( t ) {
        e( t )
      } ) ), Y = !vt.preloader && !0, q = Y && $.addClass( "tg-grid-loaded" ), at.on( "click", function ( e ) {
        var i = t( this );
        i.is( "select" ) ? at.one( "change", function () {
          o( i.find( "option:selected" ) )
        } ) : o( i )
      } ), tg_is_mobile ? dt.on( "change", function () {
        ...
        if ( !Y ) return !1;
        var e = t( this );
        F = e.data( "asc" ) === !0 ? !1 : !0, e.data( "asc", F ).attr( "data-asc", F ), nt.removeClass( "tg-item-index" ), A.TG_Layout( {
          sortAscending: F
        } )
      } );
      var bt = st.keyup( debounce( function () {
        if ( !Y ) return !1;
        var e = new RegExp( bt.val(), "gi" );
        nt.removeClass( "tg-item-index" ), at.removeClass( "tg-filter-active" ), A.TG_Layout( {
          filter: function () {
            var i = t( this ),
              o = e ? i.text().match( e ) : !0,
              n = z ? i.is( z ) : !0;
            return t( '.tg-filter[data-filter="*"]' ).addClass( "tg-filter-active" ), o && n
          }
        } ), t.TG_Pause_Players()
      }, 200 ) );
      ut.on( "click", function () {
        ...
        s(), f(), g(), y(), q = Y && A.closest( "body" ).length > 0 && A.TG_Layout( "layout" ), q = "horizontal" === vt.layout && A.TG_Layout( "once", "layoutComplete", function ( t ) {
          e( t )
        } )
      } ), mt.on( "click", function ( e ) {
        e.preventDefault();
        var i = t( this );
        X = i.data( "page" ), i.is( ".tg-page-current" ) || V && ( !V || 4 != V.readyState ) || Q || !Y || ( lt.find( ".tg-dropdown-value" ).text( "" ), st.val( "" ), at.removeClass( "tg-filter-active" ), t( '.tg-filter[data-filter="*"]' ).addClass( "tg-filter-active" ), mt.removeClass( "tg-page-current" ).addClass( "tg-loading" ), i.addClass( "tg-page-current" ), t( ".tg-item-hidden" ).addClass( "tg-item-removed" ), t.TG_media_destroy( A ), A.css( "min-height", 250 ).TG_Layout( "remove", nt ).TG_Layout( {
          filter: "*"
      ...
      } ), "on_scroll" == vt.ajaxMethod && t( window ).on( "mousewheel resize scroll", function () {
        q = N && $.length && $[ 0 ].getBoundingClientRect().bottom < t( this ).height() && Y === !0 && w( A )
      } )
    } )
  };
  var n = [];
  t.fn.the_grid_images_loaded = function () {
    ...
    o.find( "*" ).filter( function () {
      i = t( this ).css( "background-image" ), i = /^url\((['"]?)(.*)\1\)$/.exec( i ), i = i ? i[ 2 ] : null, i = !i && t( this ).is( "img" ) ? t( this ).attr( "src" ) : i, i = i && ( i.match( /\.(jpg|jpeg|png|bmp|gif|tif|tiff|jif|jfif)/g ) || i.indexOf( "external.xx.fbcdn" ) >= 0 || i.indexOf( "drscdn.500px.org" ) >= 0 ) ? i : null, i && -1 == t.inArray( i, n ) && ( s.push( i ), n.push( i ) )
    } );
    for ( var u = [], l = 0; l < s.length; l++ ) u[ l ] = new Image, u[ l ].onload = e, u[ l ].onerror = e, u[ l ].onabort = e, u[ l ].src = s[ l ];
    ...
    function i( e ) {
      var i = e.parent().offset(),
        o = e.parent().height(),
        n = "relative" === t( "body" ).css( "position" ) ? t( window ).scrollTop() + t( "body" )[ 0 ].getBoundingClientRect().top : null,
    ...
    var o, n = "tg-dropdown-holder-animation";
    tg_is_mobile || ( t( document ).on( "mouseenter", ".tg-dropdown-holder", function ( e ) {
      ...
      o = r.find( "ul" );
      var s = o.clone( !0 ).addClass( "tg-list-appended" ).attr( "style", "" ).appendTo( "body" );
      ...
      var i = t( this );
      return i.data( "list-DOM" ) ? ( clearTimeout( i.data( "list-timer" ) ), i.data( "list-DOM" ).addClass( n ), !1 ) : void 0
      ...
      var e = t( this ).closest( "ul" ),
        o = e.data( "filter-DOM" );
      o.find( '[data-filter="' + t( this ).data( "filter" ) + '"]' ).trigger( "click" ), o.find( '[data-value="' + t( this ).data( "value" ) + '"]' ).trigger( "click" ), e.width( o.outerWidth() ), e.css( "left", o.offset().left );
      var n = i( o );
      n.top !== e.position().top ? e.css( "top", n.top ) : ( e.find( "li" ).removeClass( "tg-filter-active" ), o.find( ".tg-filter-active" ).each( function ( i ) {
    ...
    t( document ).on( "mouseenter", t( this ).selector, function () {
      ...
      if ( n.data( i ) ) return clearTimeout( n.data( o ) ), n.data( i ).addClass( e.hoverClass.split( "." ).join( "" ) ), !1;
      var r = t( '<div class="' + e.appendClass.split( "." ).join( "" ) + '"></div>' ).appendTo( "body" );
      n.data( i, r );
      var a = n.data( e.data ),
        s = n.offset(),
        u = "relative" === t( "body" ).css( "position" ) ? t( window ).scrollTop() + t( "body" )[ 0 ].getBoundingClientRect().top : null,
        l = s.top - u,
        d = s.left,
        c = n.outerWidth( !0 );
      r.html( a ).css( {
  ...
  var r = "tg-media-init",
    ...
    s = function () {
      ...
      do e.innerHTML = "<!--[if gt IE " + ++t + "]><i></i><![endif]-->"; while ( i[ 0 ] );
      return t > 4 ? t : document.documentMode
    }();
  s && t( "body" ).addClass( "is-ie" ), t.fn.TG_SoundCloud = function () {
    return this.each( function () {
      ...
      if ( !e.hasClass( r ) && "about:blank" !== i ) {
        ...
        o.bind( SC.Widget.Events.READY, function () {
          ( !o.getCurrentSound && tg_is_mobile || !tg_is_mobile ) && o.play(), t.TG_Media_Ready( e, o, "STD" ), o.bind( SC.Widget.Events.PLAY, function () {
            t.TG_Media_Play( e )
  ...
  t.fn.TG_Youtube = function () {
    return this.each( function () {
      ...
      if ( !e.hasClass( r ) && "about:blank" !== i ) {
        ...
        u[ o ] = new YT.Player( o, {
          events: {
            onReady: function ( i ) {
              tg_is_mobile || i.target.playVideo(), t.TG_Media_Ready( e, i.target, "YT" )
            },
            onStateChange: function ( i ) {
              1 === i.data && t.TG_Media_Play( e ), ( 2 === i.data || 0 === i.data ) && t.TG_Media_Pause( e )
            }
          }
        } )
      }
    ...
    return this.each( function () {
      var e = t( this ).closest( a ),
        i = t( this ).attr( "src" );
      if ( 9 >= s && ( t( this ).remove(), e.find( ".tg-media-button" ).remove() ), !e.hasClass( r ) && "about:blank" !== i ) {
        t( this ).attr( "src", t( this ).attr( "src" ) );
        var o = $f( this );
        o.addEvent( "ready", function () {
          tg_is_mobile || o.api( "play" ), t.TG_Media_Ready( e, o, "VM" ), o.addEvent( "play", function () {
            t.TG_Media_Play( e )
    ...
    return this.each( function () {
      var e = t( this ).closest( a ),
        i = t( this ).attr( "src" );
      e.hasClass( r ) || "about:blank" === i || t( this ).load( function () {
        var i = t( this )[ 0 ].wistiaApi,
          o = !1,
          n = !1,
          r = !1;
        t.TG_Media_Ready( e, i, "STD" ), i && ( i.play(), i.bind( "seek", function () {
          n = !0
    ...
    return this.each( function () {
      ...
      if ( !e.hasClass( r ) ) {
        var i = t( this )[ 0 ];
        i.addEventListener && ( t.TG_Media_Ready( e, i, "STD" ), i.addEventListener( "play", function () {
          t.TG_Media_Play( e )
    ...
    e.hasClass( "tg-force-play" ) || t.TG_Pause_Players(), e.addClass( "tg-is-playing" ), t( a ).removeClass( "tg-force-play" )
    ...
    var i = t( e.target );
    t( ".tg-item-media" ).removeClass( "tg-item-media-fullscreen" ), i && i.hasClass( "tg-item-media" ) && i.addClass( "tg-item-media-fullscreen" )
  } ), t( document ).on( "click", ".tg-item:not(.tg-media-init) .tg-item-button-play", function ( e ) {
    e.preventDefault();
    var i = t( this ).closest( ".tg-item" ),
      o = i.find( "iframe" );
    o.attr( "src", o.data( "src" ) ), t.TG_Pause_Players(), t.TG_media_init(), i.addClass( "tg-force-play" )
  } ), t( document ).on( "click", ".tg-item.tg-media-init .tg-item-button-play", function ( e ) {
    e.preventDefault();
    var i = t( this ).closest( ".tg-item" ),
      o = i.data( "pause-method" ),
      n = i.data( "media-player" );
    if ( i.is( ".tg-force-play, .tg-is-playing" ) ) return t.TG_Pause_Players(), !1;
    if ( n && i.hasClass( r ) ) switch ( i.find( ".tg-item-media" ).show(), t.TG_Pause_Players(), t( a ).removeClass( "tg-force-play tg-play-error" ), i.addClass( "tg-force-play" ), o ) {
      case "STD":
    ...
    if ( t( ".g-ytsubscribe" ).length && ( e = document.createElement( "script" ), e.src = "https://apis.google.com/js/platform.js", e.id = "tg-youtube-subscribe-api", r = document.getElementsByTagName( "script" )[ 0 ], r.parentNode.insertBefore( e, r ) ), 0 === t( ".tg-item-media" ).length ) return !1;
    i = {
      youtube: function () {
    ...
    for ( var s = 0; s < a.length; s++ ) n = a[ s ].ID, t( '[data-api="1"].tg-item-' + n ).length > 0 && ( o = a[ s ].url, 0 === t( "#tg-" + n + "-api" ).length ? ( e = document.createElement( "script" ), e.src = a[ s ].url, e.id = "tg-" + n + "-api", r = document.getElementsByTagName( "script" )[ 0 ], r.parentNode.insertBefore( e, r ), function ( t, e ) {
      t.onload = function () {
        i[ e ]()
      }
    }( e, n ) ) : i[ n ]() );
    t( document ).ready( function () {
      t( ".tg-item .tg-item-audio-player" ).attr( "width", "100%" ), t( ".tg-item-video-player,.tg-item-audio-player" ).TG_HTML_Player(), tg_global_var.mediaelement && ( t( ".tg-item-video-player:not(.tg-mediaelement-init), .tg-item-audio-player:not(.tg-mediaelement-init)" ).mediaelementplayer( {
    ...
    } ), e = e ? e.find( ".tg-item video, .tg-item audio" ) : t( ".tg-item video, .tg-item audio" ), e.each( function () {
      var e = t( this ),
        i = e.data( "mediaelementplayer" );
      e.closest( a ).removeClass( "tg-force-play tg-is-playing" ), e.length && ( i ? ( i = e.data( "mediaelementplayer" ), i.pause(), i.setSrc( "about:blank" ), e.children( "source" ).prop( "src", "" ), i.remove() ) : ( e[ 0 ].pause(), e[ 0 ].src = "about:blank", e.children( "source" ).prop( "src", "" ), e.remove().length = 0 ) )
    ...
    function e() {
      ...
      for ( z = e.length, i = 0; z > i; i++ ) {
        var o = e.eq( i );
        L[ i ] = {}, L[ i ].type = o.data( "tolb-type" ), L[ i ].src = o.data( "tolb-src" ), L[ i ].alt = o.data( "tolb-alt" ), L[ i ].poster = o.data( "tolb-poster" ), o.data( W, i )
      }
      z > 1 ? t( R + "," + D ).show() : t( R + "," + D ).hide()
    }

    function o( e ) {
      switch ( t( S ).addClass( B + " " + A ), y = e.data( W ), T = L[ y ].type, _ = L[ y ].src, w = L[ y ].alt, h(), T ) {
        case "image":
          b = t( '<img class="tolb-img" src="' + _ + '" alt="' + w + '"></img>' ), v = new Image, v.onload = a, v.onerror = a, v.src = _;
          break;
        case "youtube":
          _ = "//www.youtube.com/embed/" + _ + "?html5=1&controls=1&autohide=1&rel=0&showinfo=0&autoplay=" + F, b = t( '<iframe class="tolb-video" src="' + _ + '" allowfullscreen></iframe>' ), u();
          break;
        case "vimeo":
          _ = "//player.vimeo.com/video/" + _ + "?title=0&amp;byline=0&amp;portrait=0&amp;autoplay=" + F, b = t( '<iframe class="tolb-video" src="' + _ + '" allowfullscreen></iframe>' ), u();
          break;
        case "wistia":
          _ = "//fast.wistia.net/embed/iframe/" + _ + "?title=0&amp;byline=0&amp;portrait=0&amp;autoPlay=" + F, b = t( '<iframe class="tolb-video" src="' + _ + '" allowfullscreen></iframe>' ), u();
          break;
        case "video":
          for ( var i = "", o = 0; o < _.length; o++ ) i += '<source src="' + _[ o ][ 0 ].source + '" type="video/' + _[ o ][ 0 ].type + '" width="100%" height="100%"></source>';
          x = L[ y ].poster, x = x ? ' poster="' + x + '"' : "";
          var n = F ? " autoplay" : "";
          b = t( '<video class="tolb-video" controls' + x + n + ">" + i + "</video>" ), s()
      }
    }
    ...
    function r() {
      t( S ).addClass( q ), m = "iframe" !== T ? t( P ).html( "" ) : t( P ).find( "*" ).not( b ).remove(), m = "image" !== T ? t( S ).addClass( H ) : t( S ).removeClass( H ), m = "iframe" !== T && t( P ).append( b ), d(), c(), b.show(), t( S ).removeClass( A )
    }
    ...
    function s() {
      tg_is_mobile ? ( m = g && g.setSrc( "about:blank" ), n() ) : ( b.one( "loadeddata", function () {
        m = g && g.setSrc( "about:blank" ), tg_global_var.mediaelement ? l() : n()
    ...
    function u() {
      T = "iframe", t( P ).append( b.hide() ), b.one( "load", function () {
        n()
      } )
    }
    ...
    function l() {
      b.mediaelementplayer( {
        ...
        success: function ( e, i ) {
          g = e, b = t( i ).closest( ".mejs-container" ), n(), g.addEventListener( "ended", function () {
    ...
    function d() {
      t( E ).css( "max-height", t( window ).height() - 80 - t( "#wpadminbar" ).height() )
    }
    ...
    function f() {
      t( S ).removeClass( B + " " + A + " " + q ), setTimeout( function () {
        t( S ).find( "iframe" ).length > 0 ? t( S ).find( "iframe" ).attr( "src", "about:blank" ).one( "load", function () {
          t( P ).html( "" )
        } ) : t( P ).html( "" )
      }, 300 )
    }
    var m, g, y, v, _, w, b, T, x, z, C = '<div class="tolb-holder"><div class="tolb-loader"></div><div class="tolb-inner"><figure><div class="tolb-close tg-icon-close"></div><div class="tolb-content"></div><figcaption><div class="tolb-title"></div><div class="tolb-counter"></div></figcaption></figure></div><div class="tolb-prev"><i class="tg-icon-arrow-prev-thin"></i></div><div class="tolb-next"><i class="tg-icon-arrow-next-thin"></i></div></div>',
      L = [],
    ...
    t( window ).on( "resize", function () {
      ...
      return i.preventDefault(), t.TG_Pause_Players(), t( G + "," + E ).remove(), e(), o( t( this ) ), !1
    } ), t( document ).on( "click touchend", R + "," + D, function () {
      return o( t( this ) ), !1
    } ), t( document ).on( "keydown", throttle( function ( e ) {
      t( S ).hasClass( B ) && ( 37 == e.keyCode ? t( D ).trigger( "click" ) : 39 == e.keyCode ? t( R ).trigger( "click" ) : 27 == e.keyCode && f() )
    }, 300 ) ), t( document ).on( "click touchend", j + "," + O, function ( e ) {
      return e.stopPropagation(), ( t( e.target ).is( j ) || t( e.target ).is( O ) ) && f(), !1
    } ), t( "body" ).append( t( C ) )
  }, t( document ).on( "click", "[data-tolb-id]", function ( e ) {
    e.preventDefault();
    var i = t( this ).data( "tolb-id" );
    i && t( "#" + i ).trigger( "click" )
  } ), e(), o(), t( document ).on( "click", ".tg-social-share:not(.tg-social-disabled)", function ( e ) {
    e.preventDefault();
    var i = t( this )[ 0 ].href,
      o = Math.round( window.screenX + ( window.outerWidth - 626 ) / 2 ),
      n = Math.round( window.screenY + ( window.outerHeight - 436 ) / 2 );
    return i && window.open( i, "tg_share", "status=0,resizable=1,location=1,toolbar=0,width=626,height=436,top=" + n + ",left=" + o ), !1
  } ), t.TG_media_init(), t( document ).ready( function () {
    t( ".tg-grid-preloader-styles, .tg-grid-styles" ).removeAttr( "scoped" ), t( ".tg-grid-holder" ).The_Grid(), t.TO_Lightbox()
  } );
  var l, d, c, h = t.event;
...
function () {
...
}, tg_global_var.mediaelement_ex && ( ! function ( t ) {
  t.extend( mejs.MepDefaults, {
    ...
    buildsourcechooser: function ( e, i, o, n ) {
      var r = this;
      e.sourcechooserButton = t( '<div class="mejs-button mejs-sourcechooser-button"><button type="button" aria-controls="' + r.id + '" title="' + r.options.sourcechooserText + '" aria-label="' + r.options.sourcechooserText + '"></button><div class="mejs-sourcechooser-selector"><ul></ul></div></div>' ).appendTo( i ).delegate( "input[type=checkbox]", "click", function () {
        var e = this.value;
        t( this ).closest( ".mejs-sourcechooser-selector" ).find( "input" ).removeAttr( "checked" ), t( this ).closest( ".mejs-sourcechooser-selector" ).find( "label" ).removeClass( "active" ), t( this ).next( "label" ).addClass( "active" ), n.currentSrc != e && ( currentTime = n.currentTime, paused = n.paused, n.setSrc( e ), n.load(), n.addEventListener( "loadedmetadata", function () {
          this.currentTime = currentTime
        }, !0 ), n.addEventListener( "canplay", function () {
          paused || this.play()
        }, !0 ) )
      } );
      for ( var a in n.children ) {
        var s = n.children[ a ];
        "SOURCE" !== s.nodeName || "probably" != n.canPlayType( s.type ) && "maybe" != n.canPlayType( s.type ) || e.addSourceButton( s.src, s.title, s.type, n.src == s.src )
      }
    },
    addSourceButton: function ( e, i, o, n ) {
      var r = this;
      ( "" === i || void 0 == i ) && ( i = e ), o = o.split( "/" )[ 1 ], r.sourcechooserButton.find( "ul" ).append( t( '<li><input type="checkbox" name="' + r.id + '_sourcechooser" id="' + r.id + "_sourcechooser_" + o + '" value="' + e + '" ' + ( n ? 'checked="checked"' : "" ) + ' /><label for="' + r.id + "_sourcechooser_" + o + '">' + o + "</label></li>" ) ), r.adjustSourcechooserBox()
    },
    adjustSourcechooserBox: function () {
      var t = this;
      t.sourcechooserButton.find( ".mejs-sourcechooser-selector" ).height( t.sourcechooserButton.find( ".mejs-sourcechooser-selector ul" ).outerHeight( !0 ) )
    }
  } )
}( mejs.$ ), function ( t ) {
  t.extend( MediaElementPlayer.prototype, {
    buildloop: function ( e, i ) {
      var o = this,
        n = t( '<div class="mejs-button mejs-loop-button ' + ( e.options.loop ? "mejs-loop-on" : "mejs-loop-off" ) + '"><button type="button" aria-controls="' + o.id + '" title="Toggle Loop" aria-label="Toggle Loop"></button></div>' ).appendTo( i ).click( function () {
          e.options.loop = !e.options.loop, e.options.loop ? n.removeClass( "mejs-loop-off" ).addClass( "mejs-loop-on" ) : n.removeClass( "mejs-loop-on" ).addClass( "mejs-loop-off" )
        } )
    }
  } )
}( mejs.$ ) );
