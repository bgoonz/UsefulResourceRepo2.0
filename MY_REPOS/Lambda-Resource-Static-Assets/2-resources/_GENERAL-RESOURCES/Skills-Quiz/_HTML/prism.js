  ...
  if ('undefined' != typeof self && self.Prism && self.document) {
    ...
    var e = !(r.plugins.fileHighlight = {
      highlight: function (e) {
        for (var t, n = (e || document).querySelectorAll(p), i = 0; (t = n[i++]); )
        ...
        if (a && /pre/i.test(a.nodeName)) {
          var t,
            s =
              ...
              r[e.language] ||
              ((t = e.language)
                ? (t.substring(0, 1).toUpperCase() + t.substring(1)).replace(/s(?=cript)/, 'S')
                : t);
          if (s) {
                ...
                !t && u(a)
                  ...
                  : (!t && e.loading) ||
                    ...
                    (function (e, a, r) {
                      ...
                      (function (e) {
                        return (
                          o.languages_path + 'prism-' + e + (o.use_minified ? '.min' : '') + '.js'
                        );
                      })(a),
                      function () {
...
'undefined' != typeof self &&
  ...
  Prism.plugins.toolbar.registerButton('download-file', function (t) {
    ...
    if (
      ...
      return (
        (n.textContent = e.getAttribute('data-download-link-label') || 'Download'),
