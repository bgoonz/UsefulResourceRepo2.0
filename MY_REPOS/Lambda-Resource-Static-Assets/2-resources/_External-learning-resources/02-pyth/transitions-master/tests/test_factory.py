...
class TestFactory(TestCase):
    ...
    def test_mixins(self):
        ...
        self.assertEqual(
            locked_nested_cls.__getattribute__, locked_cls.__getattribute__
        )
        ...
        self.assertNotEqual(
            nested_cls._create_transition, graph_nested_cls._create_transition
        )

        locked_nested_graph_cls = self.factory.get_predefined(
            nested=True, locked=True, graph=True
        )
        self.assertNotEqual(
            locked_nested_graph_cls._create_event, graph_cls._create_event
        )
