...
Stopwatch.prototype.drawHands = function (hour, second, minute, millisecond) {
  ...
  this.context.translate(
    this.config.container.width / 2,
    this.config.container.height / 2
  );
  this.context.rotate(
    Math.PI * (2.0 * ((minute + millisecond / 1000.0) / 60) - 0.5)
  );
  ...
  this.context.translate(
    this.config.container.width / 2,
    this.config.container.height / 3.5
  );
...
Stopwatch.prototype.drawTime = function (minute, second, millisecond) {
  ...
  this.context.translate(
    this.config.container.width / 2,
    this.config.container.height / 1.3
  );
