...
var RightJS = (function (a, b, c, d, e, f, g, h, i) {
  function cL(a, b, c, d) {
    var e = {},
      f = a.marginLeft.toFloat() || 0,
      g = a.marginTop.toFloat() || 0,
      h = c === "right",
      i = c === "bottom",
      j = c === "top" || i;
    d === "out"
      ? ((e[j ? "height" : "width"] = "0px"),
        h
          ? (e.marginLeft = f + b.x + "px")
          : i && (e.marginTop = g + b.y + "px"))
      : (j
          ? ((e.height = b.y + "px"), (a.height = "0px"))
          : ((e.width = b.x + "px"), (a.width = "0px")),
        h
          ? ((e.marginLeft = f + "px"), (a.marginLeft = f + b.x + "px"))
          : i && ((e.marginTop = g + "px"), (a.marginTop = g + b.y + "px")));
    return e;
  }
  function cK(a, b, c) {
    var d = a
  ...
  function cI(a, b, c) {
    ...
    for (d in c)
      (d == "width" || d == "height") &&
        b[d] == "auto" &&
        (b[d] = a._["offset" + d.capitalize()] + "px");
    bu && c.filter && !b.filter && (b.filter = "alpha(opacity=100)"),
      cG(a, b, c);
    for (d in c) {
      if (c[d] !== b[d] && /color/i.test(d)) {
        bq &&
          ((c[d] = c[d].replace(/"/g, "")), (b[d] = b[d].replace(/"/g, ""))),
          cF(c[d]) || (c[d] = c[d].toRgb()),
          cF(b[d]) || (b[d] = b[d].toRgb());
        if (!c[d] || !b[d]) c[d] = b[d] = "";
      }
      /\d/.test(c[d]) &&
        !/\d/.test(b[d]) &&
        (b[d] = c[d].replace(/[\d\.\-]+/g, "0"));
      if (c[d] === b[d] || !/\d/.test(b[d]) || !/\d/.test(c[d]))
        delete c[d], delete b[d];
    }
  }
  function cH(a) {
    var b = {},
    ...
    for (d in a)
      if (d.startsWith("border"))
        ...
        d === "margin" || d === "padding"
          ...
          ? cD(b, "background", ["Color", "Position", "PositionX", "PositionY"])
          : d === "opacity" && bu
          ? b.push("filter")
          : b.push(d);
    return b;
  ...
  function cB(a) {
    ...
    this.onFinish(g).onCancel(function () {
      ...
      (e[cx] = "all"),
      (e[cy] = (cg.Durations[b.duration] || b.duration) + "ms"),
      (e[cz] = cA[b.transition] || b.transition),
      setTimeout(function () {
        d.setStyle(a);
      }, 0);
  }
  ...
  function ct(a, b) {
    function q(a) {
      ...
      while (c < 5) {
        d = n(b) - a;
        if (h.abs(d) < 0.001) break;
        (b = b - d / p(b)), c++;
      }
      return b;
    }
    function p(a) {
      return d + a * (2 * e + a * 3 * f) + 0.001;
    }
    function o(a) {
      return a * (g + a * (i + a * j));
    }
  ...
  function cb(a) {
    var b = J(a),
      ...
      e;
    y(c)
      ? ((d[c] = b.slice(2)), B(d[c][0]) && (d[c] = d[c][0].map(N)))
      : (d = c);
  ...
  function b_() {
    bX &&
      ((bX = !1),
      br
        ? (b.attachEvent("onmouseover", bZ), a.attachEvent("blur", b$))
        : (b.addEventListener("mouseover", bZ, !1),
          a.addEventListener("blur", b$, !1)));
  }
  function b$(a) {
  ...
  function bZ(a) {
    ...
    while (d.nodeType === 1)
      (g = I(d)),
        bW[g] === i && bY(a, d, g, (bW[g] = !0)),
        d === c && (e = !0),
        f.push(d),
        (d = d.parentNode);
    if (c && !e)
      while (c !== null && c.nodeType === 1 && f.indexOf(c) === -1)
        (g = I(c)), bW[g] !== i && bY(a, c, g, (bW[g] = i)), (c = c.parentNode);
  }
  function bY(a, b, c, d) {
    var e = new bE(a);
    (e.type = d === !0 ? "mouseenter" : "mouseleave"),
      (e.bubbles = !1),
      (e.stopped = !0),
      (e.target = bA(b)),
      (e.find = function (a) {
  ...
  function bV(a) {
    var b = new bE(a),
      c = b.target,
      d = c.parent && c.parent();
    (b.type = a.type === "focusin" || a.type === "focus" ? "focus" : "blur"),
      d && d.fire(b);
  }
  function bS(a) {
  ...
  function bR(a, b) {
    ...
    if (b === "opacity")
      return bu
        ? (/opacity=(\d+)/i.exec(a.filter || "") || ["", "100"])[1].toInt() /
            100 +
            ""
        : a[b].replace(",", ".");
  ...
  function bQ(a, b) {
    if (typeof b === "string") {
      ...
      for (var g = 0, h = b.length, i; g < h; g++)
        (i = b[b.length === h ? g : 0]),
          bO.appendChild(i instanceof bG ? i._ : i);
    return bO;
  }
  function bL(a, b, c) {
    var d = a._,
      ...
      g = !c;
    while ((d = d[b]))
      d.nodeType === 1 && (g || bA(d).match(c)) && (e[f++] = bA(d));
    return e;
  }
  function bK(a, b, c) {
    if (typeof b === "string") {
  ...
  function bz(a, b) {
    typeof a === "string" &&
      ...
      (this.target = bA(
        a.target != null && "nodeType" in a.target && a.target.nodeType === 3
          ? a.target.parentNode
          : a.target
      )),
      (this.currentTarget = bA(a.currentTarget)),
      (this.relatedTarget = bA(a.relatedTarget)),
      (this.pageX = a.pageX),
      (this.pageY = a.pageY);
    if (bt && "srcElement" in a) {
      (this.which = a.button === 2 ? 3 : a.button === 4 ? 2 : 1),
        (this.target = bA(a.srcElement) || b),
        (this.relatedTarget =
          this.target._ === a.fromElement ? bA(a.toElement) : this.target),
  ...
  function by(a, b) {
    ...
    e !== i &&
      ((c = new e(d, b)),
      "$listeners" in this && (c.$listeners = this.$listeners)),
      (q[f] = c);
    return c;
  }
  function bx() {
  ...
  function bo(a, b, c, d) {
    if (A(b)) for (var e in b) a.stopObserving(e, b[e]);
    else
      y(b) || ((c = b), (b = null)),
        y(c) && (c = a[c]),
  ...
  function bn(a, b, c) {
    ...
    if (y(e))
      switch (typeof f) {
        ...
        case "function":
          ("$listeners" in a ? a.$listeners : (a.$listeners = [])).push(
            c({ e: e, f: f, a: d, r: g || !1, t: a })
          );
          break;
        default:
          if (B(f))
            for (var h = 0; h < f.length; h++)
              a.on.apply(a, [e].concat(N(f[h])).concat(d));
      }
    else {
      d = n.call(b, 1);
  ...
  function bf(a, b) {
    return c.without.apply(
      c,
      [a].concat(
        be.concat(b ? H("prototype parent ancestors") : ["constructor"])
      )
    );
  }
  function bb(a, b) {
  ...
  function Z(a, b) {
    ...
    typeof c === "string"
      ? ((f = c),
        b.length !== 0 && typeof b[0][f] === "function"
          ? (c = function (a) {
    ...
    return s(a, {
      ...
      include: function () {
        for (var b = 0, c = arguments.length; b < c; b++)
          A(arguments[b]) &&
            (s(a.prototype, arguments[b]), s(a.Methods, arguments[b]));
      },
    });
  }
  var j = function (a) {
  ...
  (j.version = "2.3.1"),
    (j.modules = ["core", "dom", "form", "events", "xhr", "fx", "cookie"]);
  var k = d.prototype,
    ...
    t = (j.$eval = function (b) {
      b &&
        ("execScript" in a
          ? bC.win()._.execScript(b)
          : G("script", { text: b }).insertTo(o));
    }),
    u = (j.$break = function () {
      throw new $();
    }),
  ...
  k.map ||
    ...
    A(o) &&
      (A = j.isHash =
        function (a) {
          return (
            m.call(a) === "[object Object]" &&
            a != null &&
            a.hasOwnProperty != null
          );
        });
  for (
    var L = 0, M = "Array Function Number String Date RegExp".split(" ");
    L < M.length;
    L++
  )
    j[M[L]] = K(new f("return " + M[L])());
  (j.Object = c),
    (j.Math = h),
    s(
      c,
      {
        ...
        merge: function () {
          ...
          for (; b < e; b++)
            if (A(d[b]))
              for (f in d[b])
                a[f] =
                  A(d[b][f]) && !(d[b][f] instanceof bc)
                    ? c.merge(f in a ? a[f] : {}, d[b][f])
                    : d[b][f];
          return a;
        },
        toQueryString: function (a) {
          ...
          for (; c < b.length; c++)
            d.push(
              encodeURIComponent(b[c][0]) +
                "=" +
                encodeURIComponent("" + b[c][1])
            );
          return d.join("&");
        },
      },
    ...
    S =
      ...
      function (a, b) {
        for (var c = [], d = 0, e = 0, f = this.length; e < f; e++)
          a.call(b, this[e], e, this) && (c[d++] = this[e]);
        return c;
      },
    T = function (a, b) {
      for (var c = [], d = 0, e = 0, f = this.length; e < f; e++)
  ...
  d.include({
    indexOf:
      ...
      function (a, b) {
        for (
          var c = b < 0 ? h.max(0, this.length + b) : b || 0, d = this.length;
          c < d;
          c++
        )
    ...
    e.include({
      ...
      underscored: function () {
        return this.replace(/([a-z\d])([A-Z]+)/g, "$1_$2")
          .replace(/\-/g, "_")
          .toLowerCase();
      },
      capitalize: function () {
      ...
      startsWith: function (a, b) {
        return (
          (b !== !0
            ? this.indexOf(a)
            : this.toLowerCase().indexOf(a.toLowerCase())) === 0
        );
      },
      endsWith: function (a, b) {
        return (
          this.length -
            (b !== !0
              ? this.lastIndexOf(a)
              : this.toLowerCase().lastIndexOf(a.toLowerCase())) ===
          a.length
        );
      },
      toInt: function (a) {
      ...
      toFloat: function (a) {
        return parseFloat(
          a === !0 ? this : this.replace(",", ".").replace(/(\d)-(\d)/, "$1.$2")
        );
      },
    }),
    (e.prototype.include = e.prototype.includes),
    f.include({
      bind: function () {
        var a = J(arguments),
          b = a.shift(),
        ...
        return function () {
          return c.apply(
            b,
            a.length !== 0 || arguments.length !== 0
              ? a.concat(J(arguments))
              : a
          );
        };
      },
    ...
    g.include({
      ...
      to: function (a, b, c) {
        ...
        if (e > d) for (; g <= e; g++) f.push(b.call(c, g));
        else for (; g >= e; g--) f.push(b.call(c, g));
        return f;
      },
      abs: function () {
        return h.abs(this);
      ...
      (a.JSON = (function () {
        ...
        function d(a) {
          return a.replace(c, function (a) {
            return (
              b[a] || "\\u" + ("0000" + a.charCodeAt(0).toString(16)).slice(-4)
            );
          });
        }
        var a =
  ...
  var bc = (j.Class = function () {
      var a = J(arguments).slice(0, 2),
        ...
        e = function () {};
      !a.length && !A(b) && ((c = b), (b = {})),
        !d && c && (c === bw || c.ancestors.include(bw)) && (d = bx()),
        (d = s(
          d ||
            function () {
              bi(this);
  ...
  var bj = (j.Options = {
      setOptions: function (a) {
        ...
        if (x(this.on))
          for (e in b)
            if ((d = e.match(/on([A-Z][A-Za-z]+)/)))
              this.on(d[1].toLowerCase(), b[e]), delete b[e];
        return this;
      },
    ...
    bm = (bk.createShortcuts = function (a, b) {
      (b || []).each(function (b) {
        var c =
          "on" +
          b.replace(/(^|_|:)([a-z])/g, function (a, b, c) {
  ...
  var bB = (j.Document = new bc(bw, {
    ...
    bD = (j.Window = new bc(bw, {
      ...
      size: function () {
        ...
        return a.innerWidth
          ? { x: a.innerWidth, y: a.innerHeight }
      ...
      scrollTo: function (a, b, c) {
        var d = a,
          e = b,
          f = z(a) ? null : E(a);
        f instanceof bG && (a = f.position()),
          A(a) && ((e = a.y), (d = a.x)),
          A((c = c || b)) && j.Fx
            ? new cg.Scroll(this, c).start({ x: d, y: e })
            : this._.scrollTo(d, e);
        return this;
      },
    })),
  ...
  bt &&
    ...
    bG.include({
      ...
      next: function (a) {
        return !a && this._.nextElementSibling !== i
          ? bA(this._.nextElementSibling)
          : this.nextSiblings(a)[0];
      },
      prev: function (a) {
        return !a && this._.previousElementSibling !== i
          ? bA(this._.previousElementSibling)
          : this.prevSiblings(a)[0];
      },
      remove: function () {
        var a = this._,
          b = a.parentNode;
      ...
      insert: function (a, b) {
        ...
        (b = b === i ? "bottom" : b),
          typeof a !== "object"
            ? (c = a = "" + a)
            : a instanceof bG && (a = a._),
          bM[b](
            d,
            a.nodeType === i
              ? bQ(b === "bottom" || b === "top" ? d : d.parentNode, a)
              : a
          ),
          c !== null && c.evalScripts();
        return this;
      },
      ...
      text: function (a) {
        return a === i
          ? this._.textContent === i
            ? this._.innerText
            : this._.textContent
          : this.update(this.doc()._.createTextNode(a));
      },
      replace: function (a) {
  ...
  bG.include({
    setStyle: function (a, b) {
      ...
      b !== i
        ...
        : y(a) &&
          ...
          (a = e));
      for (c in a)
        (d = c.indexOf("-") < 0 ? c : c.camelize()),
          bu && c === "opacity"
            ? (f.filter = "alpha(opacity=" + a[c] * 100 + ")")
            : c === "float" && (d = br ? "styleFloat" : "cssFloat"),
          (f[d] = a[c]);
      return this;
    },
    getStyle: function (a) {
    ...
    computedStyles: o.currentStyle
      ...
      : function () {
          return this._.ownerDocument.defaultView.getComputedStyle(
            this._,
            null
          );
        },
    ...
    bG.include({
      set: function (a, b) {
        ...
        for (d in a)
          d === "style"
            ? this.setStyle(a[d])
            : (d in e || e.setAttribute(d, "" + a[d]),
              d.substr(0, 5) !== "data-" && (e[d] = a[d]));
        return this;
      },
      get: function (a) {
        var b = this._,
      ...
      show: function () {
        if (this.hidden()) {
          var a = this._,
            ...
            c;
          if (!b || b === "none")
            (c = G(a.tagName).insertTo(o)),
              (b = c.getStyle("display")),
              c.remove();
      ...
      data: function (a, b) {
        var c, d, e, f, g, h;
        if (A(a)) for (c in a) b = this.data(c, a[c]);
        else if (b === i) {
          a = "data-" + ("" + a).dasherize();
          for (
            d = {}, e = !1, f = this._.attributes, h = 0;
            h < f.length;
            h++
          ) {
            b = f[h].value;
            ...
            f[h].name.indexOf(a) === 0 &&
              ((d[f[h].name.substring(a.length + 1).camelize()] = b), (e = !0));
          }
          b = e ? d : null;
        } else {
          (a = "data-" + ("" + a).dasherize()), A(b) || (b = { "": b });
          for (c in b)
            (g = c.blank() ? a : a + "-" + c.dasherize()),
              b[c] === null
                ? this._.removeAttribute(g)
                : this._.setAttribute(g, y(b[c]) ? b[c] : JSON.stringify(b[c]));
          b = this;
        }
        return b;
      },
    ...
    [bG, bB, bD].each(
      ...
      s(bl({}), {
        on: function () {
          bn(this, arguments, function (a) {
            a.e === "mouseenter" || a.e === "mouseleave"
              ? (b_(), (a.n = a.e), (a.w = function () {}))
              : (a.e === "contextmenu" && bs.Konqueror
                  ? (a.n = "rightclick")
                  : a.e === "mousewheel" && bs.Gecko
                  ? (a.n = "DOMMouseScroll")
                  : (a.n = a.e),
                (a.w = function (b) {
                  (b = new bE(b, a.t)),
                    a.f.apply(a.t, (a.r ? [] : [b]).concat(a.a)) === !1 &&
                      b.stop();
                }),
                bt
                  ? a.t._.attachEvent("on" + a.n, a.w)
                  : a.t._.addEventListener(a.n, a.w, !1));
            return a;
          });
          return this;
        },
        stopObserving: function (a, b) {
          bo(this, a, b, function (a) {
            bt
              ? a.t._.detachEvent("on" + a.n, a.w)
              : a.t._.removeEventListener(a.n, a.w, !1);
          });
          return this;
        },
        fire: function (a, b) {
          var c = this.parent && this.parent();
          a instanceof bE || (a = new bE(a, s({ target: this._ }, b))),
            (a.currentTarget = this),
            (this.$listeners || []).each(function (b) {
              b.e === a.type &&
                b.f.apply(this, (b.r ? [] : [a]).concat(b.a)) === !1 &&
                a.stop();
            }, this),
            c && c.fire && !a.stopped && c.fire(a);
          return this;
        },
        stopEvent: function () {
          return !1;
    ...
    bm(bD.prototype, H("blur focus scroll resize load")),
    bS(
    ...
    [bG, bB].each("include", {
      first: function (a) {
        return bA(
          a === i && this._.firstElementChild !== i
            ? this._.firstElementChild
            : this._.querySelector(a || "*")
        );
      },
      find: function (a, b) {
      ...
      match: function (a) {
        var c = this._,
          ...
          e,
          f = !1;
        while (d.parentNode !== null && d.parentNode.nodeType !== 11)
          d = d.parentNode;
        c === d && ((d = b.createElement("div")), d.appendChild(c), (f = !0)),
          (e = bA(d).find(a, !0).indexOf(c) !== -1),
          f && d.removeChild(c);
        return e;
      },
    }),
    bB.include({
      on: function (a) {
        if (a === "ready" && !this._iR) {
          ...
          "readyState" in b
            ? (function () {
                ["loaded", "complete"].include(b.readyState)
                  ? c()
      ...
      new bc(bG, {
        initialize: function (a) {
          var b = a || {},
            d = "remote" in b,
            e = b;
          A(b) && !C(b) && ((e = "form"), (b = c.without(b, "remote"))),
            this.$super(e, b),
            d && this.remotize();
        },
        elements: function () {
        ...
        inputs: function () {
          return this.elements().filter(function (a) {
            return !["submit", "button", "reset", "image", null].include(
              a._.type
            );
          });
        },
    ...
    bH.OPTGROUP =
      new bc(bG, {
        initialize: function (a, b) {
          if (!a || (A(a) && !C(a)))
            (b = a || {}),
              /textarea|select/.test(b.type || "")
                ? ((a = b.type), delete b.type)
                : (a = "input");
          this.$super(a, b);
        },
        form: function () {
        ...
        getValue: function () {
          return this._.type == "select-multiple"
            ? this.find("option")
                .map(function (a) {
        ...
        focus: function () {
          this._.focus(),
            (this.focused = !0),
            br && this.fire("focus", { bubbles: !1 });
          return this;
        },
        blur: function () {
          this._.blur(),
            (this.focused = !1),
            br && this.fire("blur", { bubbles: !1 });
          return this;
        },
        select: function () {
          this._.select();
  ...
  bt
    ? (b.attachEvent("onfocusin", bV), b.attachEvent("onfocusout", bV))
    : (b.addEventListener("focus", bV, !0), b.addEventListener("blur", bV, !0));
  var bW = [],
    bX = !0;
  bS("mouseenter mouseleave"),
    [bG, bB].each("include", {
      delegate: function (a) {
        var b = cb(arguments),
          c,
          ...
          f;
        for (c in b)
          for (d = 0, f = b[c]; d < f.length; d++)
            this.on(a, ca(c, f[d], this)),
              s(this.$listeners.last(), { dr: c, dc: f[d][0] });
        return this;
      },
    ...
    c.each(
      { on: "delegate", stopObserving: "undelegate", observes: "delegates" },
      function (a, b) {
  ...
  (e.prototype.on = function (a) {
    if (A(a)) for (var b in a) cd.apply(this, [b].concat([a[b]]));
  ...
  var ce = (j.Xhr = new bc(bk, {
    ...
    initialize: function (a, b) {
      this.initCallbacks(),
        (this.url = a),
        s(this.$super(b), this.options),
        this.params != ce.Options.params &&
          (this.params = this.prepareData(ce.Options.params, this.params)),
        ce.Options.spinner &&
          E(this.spinner) === E(ce.Options.spinner) &&
          (this.spinner = null);
    },
    ...
    send: function (a) {
      ...
      this.urlEncoded &&
        ...
        this.setHeader(
          "Content-type",
          "application/x-www-form-urlencoded;charset=" + this.encoding
        ),
        d == "get" &&
          (h && (c += (c.include("?") ? "&" : "?") + h), (h = null)),
        (g = this.xhr = this.createXhr()),
        this.fire("create"),
        g.open(d, c, this.async),
        (g.onreadystatechange = this.stateChanged.bind(this));
    ...
    createXhr: function () {
      return this.jsonp
        ? new ce.JSONP(this)
        : this.form && this.form.first("input[type=file]")
        ? new ce.IFramed(this.form)
        : "ActiveXObject" in a
    ...
    stateChanged: function () {
      ...
      if (a.readyState == 4 && !a.canceled) {
        ...
        (this.text = this.responseText = a.responseText),
          (this.xml = this.responseXML = a.responseXML),
    ...
    tryScripts: function (a) {
      ...
      c && (this.json = this.responseJSON = this.headerJSON = JSON.parse(c)),
        this.evalResponse || (this.evalJS && /(ecma|java)script/i.test(b))
          ? t(this.text)
          : /json/.test(b) && this.evalJSON
          ? (this.json = this.responseJSON = JSON.parse(this.text))
          : this.evalScripts && this.text.evalScripts();
    },
  ...
  }).on({ create: "countIn", complete: "countOut", cancel: "countOut" }),
    bT.include({
      send: function (a) {
        (a = a || {}),
          (a.method = a.method || this._.method || "post"),
          (this.xhr = new ce(
            this._.action || b.location.href,
            s({ spinner: this.first(".spinner") }, a)
          )
            .onComplete(this.enable.bind(this))
            .onCancel(this.enable.bind(this))
            .send(this)),
          this.disable.bind(this).delay(1);
        return this;
      },
      cancelXhr: function () {
    ...
    (ce.IFramed = new bc({
      ...
      initialize: function (a) {
        (this.form = a),
          ...
          E(this.id).on("load", this.onLoad.bind(this));
      },
      send: function () {
    ...
    (ce.JSONP = new bc({
      ...
      initialize: function (a) {
        (this.xhr = a),
          ...
          (this.param = (y(a.jsonp) ? a.jsonp : "callback") + "=" + this.name),
          (this.script = G("script", { charset: a.encoding, async: a.async }));
      },
      open: function (a, b, c) {
        (this.url = b), (this.method = a);
      },
      send: function (b) {
        (a[this.name] = this.finish.bind(this)),
          this.script
            .set(
              "src",
              this.url +
            ...
            .insertTo(F("script").last(), "after");
      },
      finish: function (a) {
        (this.status = 200),
          (this.readyState = 4),
          (this.xhr.json = this.xhr.responseJSON = a),
          this.onreadystatechange();
      },
      abort: function () {
  ...
  (e.COLORS = {
    ...
    e.include({
      ...
      toRgb: function (a) {
        ...
        b &&
          ((b = b.slice(1).map("toInt", 16)), (b = a ? b : "rgb(" + b + ")"));
        return b;
      },
    }),
    bG.include({
      ...
      remove: function (a, b) {
        return a && this.visible()
          ? cu(this, a, [
              "out",
              s(b || {}, { onFinish: this.$super.bind(this) }),
            ])
          : this.$super();
      },
      morph: function (a, b) {
  ...
  (cg.Options.engine = cv === i || bq ? "javascript" : "native"),
    (cg.Morph = new bc(cg, {
      prepare: function (a) {
        if (this.options.engine === "native" && cv !== i)
          (this.render = this.transition = function () {}), cB.call(this, a);
        else {
          var b = cE(a),
            c = cJ(this.element, b),
  ...
  (cg.Highlight = new bc(cg.Morph, {
    extend: {
      Options: c.merge(cg.Options, { color: "#FF8", transition: "Exp" }),
    },
    ...
    (cg.Slide = new bc(cg.Twin, {
      extend: { Options: c.merge(cg.Options, { direction: "top" }) },
      prepare: function (a) {
        function f() {
    ...
    (cg.Fade = new bc(cg.Twin, {
      prepare: function (a) {
        this.setHow(a),
          this.how === "in" &&
            bG.prototype.show.call(this.element.setStyle({ opacity: 0 }));
    ...
    (cg.Scroll = new bc(cg.Attr, {
      initialize: function (a, b) {
        (a = E(a)),
          this.$super(
            a instanceof bD
              ? a._.document[bs.WebKit ? "body" : "documentElement"]
              : a,
            b
          );
      },
      prepare: function (a) {
        var b = {};
        "x" in a && (b.scrollLeft = a.x),
          "y" in a && (b.scrollTop = a.y),
          this.$super(b);
      },
    }));
  var cM = (j.Cookie = new bc({
    ...
    set: function (a) {
      ...
      if (c.duration) {
        var d = new Date();
        d.setTime(d.getTime() + c.duration * 24 * 60 * 60 * 1e3),
...
RightJS.Browser.OLD &&
  (function (a) {
    var b = a.createElement("script"),
      ...
      d = c[c.length - 1];
    (b.src = d.src.replace(/(^|\/)(right)([^\/]+)$/, "$1$2-olds$3")),
