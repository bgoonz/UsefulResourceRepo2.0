...
onload = function () {
  ...
  var version = navigator.appVersion.substr(
    navigator.appVersion.lastIndexOf("Chrome/") + 7
  );
  ...
  document.querySelector("#clear-data-ok").onclick = function () {
    ...
    if (majorVersion >= 44 || (majorVersion == 43 && buildVersion >= 2350)) {
      clearDataType["cache"] =
        getAndResetCheckedValueBySelector("#clear-cache");
    }
  ...
  document.querySelector("#clear-data-cancel").onclick =
    hideClearDataConfirmation;
