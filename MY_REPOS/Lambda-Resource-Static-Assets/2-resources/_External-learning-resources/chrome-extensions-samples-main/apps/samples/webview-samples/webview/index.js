onload = function () {
  ...
  ["text", "range"].map(function (inputtype) {
    $('.width .css_value input[type="' + inputtype + '"]').addEventListener(
      "change",
      changeProperty.bind(this, "width", true)
    );
    $('.height .css_value input[type="' + inputtype + '"]').addEventListener(
      "change",
      changeProperty.bind(this, "height", true)
    );
    $('.width .min input[type="' + inputtype + '"]').addEventListener(
      "change",
      changeProperty.bind(this, "minwidth", false)
    );
    $('.height .min input[type="' + inputtype + '"]').addEventListener(
      "change",
      changeProperty.bind(this, "minheight", false)
    );
    $('.width .max input[type="' + inputtype + '"]').addEventListener(
      "change",
      changeProperty.bind(this, "maxwidth", false)
    );
    $('.height .max input[type="' + inputtype + '"]').addEventListener(
      "change",
