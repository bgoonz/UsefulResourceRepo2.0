...
var config = {
  ...
  popupConfirmBox: {
    innerHTML:
      'This webpage would like to open a window at <span class="popup-url"></span> Would you like to allow this popup? <a href="#popup-allow" class="popup-allow">Allow</a> <a href="#popup-deny" class="popup-deny">Deny</a>',
