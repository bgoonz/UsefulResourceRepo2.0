  ...
  loadShaders(
    ...
    function (shaders) {
      ...
      oagImage.onload = function () {
        ...
        postproc.gl.texImage2D(
          postproc.gl.TEXTURE_2D,
          0,
          postproc.gl.RGBA,
          postproc.gl.RGBA,
          postproc.gl.UNSIGNED_BYTE,
          canvas
        );
      };
      ...
      function flake() {
        postproc.callProgram(flakeProgram, [oagTexture], output, {
    ...
    reader.readEntries(function (results) {
      if (results.length) {
        ...
        entries.sort(function (a, b) {
          return (
            parseFloat(b.name.substr("image-".length)) -
            parseFloat(a.name.substr("image-".length))
          );
        });
