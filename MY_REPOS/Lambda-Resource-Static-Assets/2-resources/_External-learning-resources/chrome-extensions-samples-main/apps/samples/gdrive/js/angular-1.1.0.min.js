...
(function (T, aa, s) {
  ...
  function xa() {
    for (var b = Y.length, a; b; ) {
      ...
      if (a == 90) Y[b] = "0";
      else return (Y[b] = String.fromCharCode(a + 1)), Y.join("");
    }
    Y.unshift("0");
    return Y.join("");
  }
  ...
  function U(b, a) {
    if (oa(b) || (b && b.$evalAsync && b.$watch))
      throw y("Can't copy Window or Scope");
    if (a) {
  ...
  function ga(b, a) {
    ...
    if (c == typeof a && c == "object")
      if (K(b)) {
        ...
        c = {};
        for (d in b) {
          if (d.charAt(0) !== "$" && !L(b[d]) && !ga(b[d], a[d])) return !1;
          c[d] = !0;
        }
  ...
  function Wa(b, a) {
    ...
    return L(a) && !(a instanceof RegExp)
      ? c.length
        ? function () {
  ...
  function qa(b, a, c) {
    if (!b)
      throw new y("Argument '" + (a || "?") + "' is " + (c || "required"));
    return b;
  }
  function ra(b, a, c) {
  ...
  function O(b) {
    ...
    if (!(this instanceof O)) {
      if (F(b) && b.charAt(0) != "<") throw y("selectors not implemented");
      return new O(b);
    }
    if (F(b)) {
  ...
  function ca(b, a, c) {
    var d = b[Aa],
      d = Ba[d || -1];
    if (x(c)) d || ((b[Aa] = d = ++pc), (d = Ba[d] = {})), (d[a] = c);
    else return d && d[a];
  }
  function vb(b, a, c) {
    var d = ca(b, "data"),
  ...
  function cb(b, a) {
    if (a)
      for (
        var a = !a.nodeName && x(a.length) && !oa(a) ? a : [a], c = 0;
        c < a.length;
        c++
      )
        b.push(a[c]);
  ...
  function rb(b) {
    ...
    function c(a, b) {
      L(b) && (b = l.instantiate(b));
      if (!b.$get)
        throw y("Provider " + a + " must define $get factory method.");
      return (k[a + f] = b);
    }
    function d(a, b) {
      return c(a, { $get: b });
    ...
    function g(a, b) {
      function c(d) {
        ...
        if (a.hasOwnProperty(d)) {
          if (a[d] === h) throw y("Circular dependency: " + i.join(" <- "));
          return a[d];
        } else
          try {
      ...
      function d(a, b, e) {
        ...
        for (j = g.length; h < j; h++)
          (o = g[h]), f.push(e && e.hasOwnProperty(o) ? e[o] : c(o, i));
        a.$inject || (a = a[j]);
        switch (b ? -1 : f.length) {
          case 0:
            return a();
    ...
    var h = {},
      ...
      l = (k.$injector = g(k, function () {
        throw y("Unknown provider: " + i.join(" <- "));
      })),
      n = {},
      p = (n.$injector = g(n, function (a) {
        a = l.get(a + f);
  ...
  function wc(b, a, c, d) {
          ...
          return (
            ...
            d.history
              ? b
                ...
                : (k.pushState(null, "", a), E.attr("href", E.attr("href")))
              : b
              ? j.replace(a)
              : (j.href = a),
            f
    ...
    f.cookies = function (a, b) {
      ...
      if (a)
        if (b === s)
          ...
          if (F(b))
            (d =
              (i.cookie = escape(a) + "=" + escape(b) + ";path=" + M).length +
              1),
              d > 4096 &&
                c.warn(
                  "Cookie '" +
    ...
    f.defer.cancel = function (a) {
      return p[a] ? (delete p[a], n(a), e(C), !0) : !1;
    };
  }
  function xc() {
    this.$get = [
  ...
  function Cb(b) {
    ...
    this.$get = [
      ...
      function (b, i, j, k, l, n, p, o) {
        ...
        function r(a, b, c, d) {
          function e(a, c, d, g) {
            for (var j, i, n, k, l, o = 0, p = 0, q = f.length; o < q; p++)
              (n = c[p]),
                (j = f[o++]),
                (i = f[o++]),
                j
                  ? (j.scope
                      ? ((k = a.$new(I(j.scope))), u(n).data("$scope", k))
                      : (k = a),
                    (l = j.transclude) || (!g && b)
                      ? j(
                          i,
                      ...
                      : j(i, k, n, s, g))
                  : i && i(a, n.childNodes, s, g);
          }
          for (var f = [], g, j, i, n = 0; n < a.length; n++)
            (j = new ea()),
              (g = da(a[n], [], j, d)),
              (j =
                (g = g.length ? E(g, a[n], j, b, c) : null) && g.terminal
                  ? null
                  : r(a[n].childNodes, g ? g.transclude : b)),
              f.push(g),
              f.push(j),
              (i = i || g || j);
          return i ? e : null;
        ...
        function da(a, b, c, f) {
          ...
          switch (a.nodeType) {
            case 1:
              w(b, fa(Db(a).toLowerCase()), "E", f);
              var i, n, k;
              j = a.attributes;
              for (var l = 0, o = j && j.length; l < o; l++)
                if (((i = j[l]), i.specified))
                  (n = i.name),
                    (k = fa(n.toLowerCase())),
                    (g[k] = n),
                    (c[k] = i =
        ...
        function E(a, b, c, d, e) {
          function f(a, b) {
            if (a) (a.require = A.require), o.push(a);
            if (b) (b.require = A.require), $.push(b);
          }
          function i(a, b) {
            var c,
              d = "data",
          ...
          function k(a, d, e, f, g) {
            var l, q, P, t, Ha;
            l = b === e ? c : ic(c, new ea(u(e), c.$attr));
            q = l.$$element;
            if (r && I(r.scope)) {
              var E = /^\s*([@=&])\s*(\w*)\s*$/,
                z = d.$parent || d;
              m(r.scope, function (a, b) {
                var c = a.match(E) || [],
                  e = c[2] || b,
                  f,
                  g,
                ...
                switch (c[1]) {
                  ...
                  case "=":
                    ...
                    j =
                      ...
                      function () {
                        f = d[b] = g(z);
                        throw y(Eb + l[e] + " (directive: " + r.name + ")");
                      };
                    f = d[b] = g(z);
                    d.$watch(function () {
                      var a = g(z);
                      a !== d[b] &&
                        (a !== f ? (f = d[b] = a) : j(z, (f = d[b])));
                      return a;
                    });
                    break;
                  case "&":
            ...
            x &&
              m(x, function (a) {
                ...
                Ha = a.controller;
                Ha == "@" && (Ha = l[a.name]);
                q.data("$" + a.name + "Controller", p(Ha, b));
              });
            f = 0;
            for (P = o.length; f < P; f++)
              try {
                (t = o[f]), t(d, q, l, t.require && i(t.require, q));
              } catch (w) {
                j(w, pa(q));
              }
            ...
            for (P = $.length; f < P; f++)
              try {
                (t = $[f]), t(d, q, l, t.require && i(t.require, q));
              } catch (Ia) {
                j(Ia, pa(q));
              }
          }
          for (
            ...
            A = a[B];
            W = s;
            if (l > A.priority) break;
            if ((X = A.scope))
              M("isolated scope", E, A, z),
                I(X) && (q(z, "ng-isolate-scope"), (E = A)),
                q(z, "ng-scope"),
                (r = r || A);
            H = A.name;
            if ((X = A.controller))
              (x = x || {}),
                M("'" + H + "' controller", x[H], A, z),
                (x[H] = A);
            if ((X = A.transclude))
              M("transclusion", C, A, z),
                (C = A),
                (l = A.priority),
                X == "element"
                  ? ((W = u(b)),
                    ...
                    Ga(e, u(W[0]), b),
                    (v = t(W, d, l)))
                  : ((W = u(db(b)).contents()), z.html(""), (v = t(W, d)));
            if ((X = A.template))
              if ((M("template", w, A, z), (w = A), (X = Ia(X)), A.replace)) {
                W = u("<div>" + Q(X) + "</div>").contents();
                b = W[0];
                if (W.length != 1 || b.nodeType !== 1) throw new y(g + X);
                Ga(e, z, b);
                H = { $attr: {} };
                a = a.concat(da(b, a.splice(B + 1, a.length - (B + 1)), H));
                P(c, H);
                G = a.length;
              } else z.html(X);
            if (A.templateUrl)
              M("template", w, A, z),
                (w = A),
                (k = V(a.splice(B, a.length - B), k, z, c, e, A.replace, v)),
                (G = a.length);
            else if (A.compile)
              try {
                (D = A.compile(z, c, v)),
                  L(D) ? f(null, D) : D && f(D.pre, D.post);
              } catch (J) {
                j(J, pa(z));
              }
            if (A.terminal) (k.terminal = !0), (l = Math.max(l, A.priority));
          }
          k.scope = r && r.scope;
          k.transclude = C && v;
          return k;
          ...
          if (a.hasOwnProperty(e))
            for (var k, e = b.get(e + c), l = 0, o = e.length; l < o; l++)
              try {
                if (
                  ((k = e[l]),
                  (i === s || i > k.priority) && k.restrict.indexOf(g) != -1)
                )
                  d.push(k), (n = !0);
              } catch (p) {
                j(p);
        ...
        function V(a, b, c, d, e, f, j) {
          ...
          k.get(q.templateUrl, { cache: l })
            .success(function (k) {
              ...
              if (f) {
                ...
                l = q[0];
                if (q.length != 1 || l.nodeType !== 1) throw new y(g + k);
                k = { $attr: {} };
                Ga(e, c, l);
                da(l, a, k);
                P(d, k);
              ...
              a.unshift(t);
              n = E(a, c, d, j);
              for (o = r(c.contents(), j); i.length; ) {
                var $ = i.pop(),
                  k = i.pop();
                q = i.pop();
                var z = i.pop(),
                  m = l;
                q !== p && ((m = db(l)), Ga(k, u(q), m));
                n(
                  function () {
                    b(o, z, m, e, $);
                  },
          ...
          return function (a, c, d, e, f) {
            i
              ? (i.push(c), i.push(d), i.push(e), i.push(f))
              : n(
                  function () {
                    b(o, c, d, e, f);
                  },
        ...
        var C = i.startSymbol(),
          ...
          Ia =
            C == "{{" || $ == "}}"
              ? ma
              : function (a) {
                  return a.replace(/\{\{/g, C).replace(/}}/g, $);
                };
        return t;
      },
    ];
  ...
  function Ec() {
    ...
    this.$get = [
      ...
      function (c, d) {
        function e(e, i) {
          for (var j, k, l = 0, n = [], p = e.length, o = !1, t = []; l < p; )
            (j = e.indexOf(b, l)) != -1 && (k = e.indexOf(a, j + g)) != -1
              ? (l != j && n.push(e.substring(l, j)),
                n.push((l = c((o = e.substring(j + g, k))))),
                (l.exp = o),
                (l = k + h),
                (o = !0))
              : (l != p && n.push(e.substring(l)), (l = p));
          if (!(p = n.length)) n.push(""), (p = 1);
          if (!i || o)
            return (
              (t.length = p),
              (l = function (a) {
                try {
                  for (var b = 0, c = p, g; b < c; b++) {
                    if (typeof (g = n[b]) == "function")
                      (g = g(a)),
                        g == null || g == s
                          ? (g = "")
                          : typeof g != "string" && (g = ba(g));
                    t[b] = g;
                  }
                  return t.join("");
                } catch (j) {
                  (a = new y(
                    "Error while interpolating: " + e + "\n" + j.toString()
                  )),
                    d(a);
                }
              }),
  ...
  function Gc(b, a, c) {
    ...
    if (decodeURIComponent(d.path) == a) return b;
      ...
      if (d.path.indexOf(h) !== 0)
        throw y('Invalid url "' + b + '", missing path prefix "' + h + '" !');
  ...
  function hb(b, a, c) {
    ...
    this.$$parse = function (b) {
      ...
      if (c.path.indexOf(a) !== 0)
        throw y('Invalid url "' + b + '", missing path prefix "' + a + '" !');
  ...
  function Ja(b, a, c) {
    ...
    this.$$parse = function (b) {
      ...
      if (c.hash && c.hash.indexOf(a) !== 0)
        throw y('Invalid url "' + b + '", missing hash prefix "' + a + '" !');
      ...
      function (c, d, e, g) {
        ...
        a
          ? ((i = d.baseHref() || "/"),
            ...
            (f = e.history
              ? new hb(Fc(k, i, b), j, l)
              : new Ib(Gc(k, i, b), b, l, i.substr(j.length + 1))))
          : ((l =
        ...
        g.bind("click", function (a) {
          if (!a.ctrlKey && !(a.metaKey || a.which == 2)) {
            for (var b = u(a.target); B(b[0].nodeName) !== "a"; )
            ...
            n++,
              c.$evalAsync(function () {
                c.$broadcast("$locationChangeStart", f.absUrl(), a)
                  .defaultPrevented
                  ? f.$$parse(a)
                  : (d.url(f.absUrl(), f.$$replace), (f.$$replace = !1), h(a));
              });
          return n;
        });
        return f;
  ...
  function Kc(b, a) {
    ...
    for (var n = [], p, o = 0, t = [], q, r = ":"; o < b.length; ) {
      ...
      if (c("\"'")) l(q);
        ...
        if (
          (k(), "{,".indexOf(r) != -1 && t[0] == "{" && (p = n[n.length - 1]))
        )
          p.json = p.text.indexOf(".") == -1;
      } else if (c("(){}[].,;:"))
        n.push({
          index: o,
          text: q,
          json: (":[,".indexOf(r) != -1 && c("{[")) || c("}]:,"),
        }),
          c("{[") && t.unshift(q),
          c("}]") && t.shift(),
          o++;
        ...
        var m = q + d(),
          ...
          w = La[m];
        w
          ? (n.push({ index: o, text: m, fn: w }), (o += 2))
          : E
          ? (n.push({
              index: o,
              text: q,
            ...
            (o += 1))
          : i("Unexpected next character ", o, o + 1);
      }
      r = q;
    }
    return n;
  ...
  function Mc(b, a, c, d) {
    ...
    function g() {
      if (M.length === 0) throw y("Unexpected end of expression: " + b);
      return M[0];
    }
    function h(a, b, c, d) {
      if (M.length > 0) {
    ...
    function f(b, c, d, f) {
      return (b = h(b, c, d, f))
        ? (a && !b.json && e("is not valid json", b), M.shift(), b)
        : !1;
    }
    function i(a) {
    ...
    this.$get = [
      ...
      function (a, c, d, e, g, h, f) {
          ...
          if (
            ...
            (n = !1),
              ...
              (p.current = b) &&
                b.redirectTo &&
                (F(b.redirectTo)
                  ? c.path(k(b.redirectTo, b.params)).search(b.params).replace()
                  : c
        ...
        function j() {
          ...
          m(b, function (b, e) {
            if (!d && (a = l(c.path(), e)))
              (d = ya(b, { params: D({}, c.search(), a), pathParams: a })),
                (d.$route = b);
          });
  ...
  function Sc() {
    ...
    this.$get = [
      ...
      function (a, c, d) {
        ...
        function g(a) {
          if (i.$$phase) throw y(i.$$phase + " already in progress");
          i.$$phase = a;
        }
        function h(a, b) {
          var c = d(a);
        ...
        e.prototype = {
          ...
          $emit: function (a, b) {
            var d = [],
              ...
              h = [i].concat(ha.call(arguments, 1)),
              m,
              s;
            do {
              e = f.$$listeners[a] || d;
  ...
  function Tc() {
    this.$get = [
      ...
      function (b, a) {
        var c = {},
          d = G((/android (\d+)/.exec(B(b.navigator.userAgent)) || [])[1]),
          e = a[0];
        return {
          history: !(!b.history || !b.history.pushState || d < 4),
          hashchange:
            "onhashchange" in b && (!e.documentMode || e.documentMode > 7),
          hasEvent: function (a) {
  ...
  function Vc() {
    var b = /^\s*(\[|\{[^\{])/,
      ...
      d = (this.defaults = {
        ...
        transformRequest: [
          function (a) {
            return I(a) && Ta.apply(a) !== "[object File]" ? ba(a) : a;
          },
        ],
        headers: {
          common: {
    ...
    this.$get = [
      ...
      function (a, b, c, i, j, k) {
        function l(a) {
          function c(a) {
            var b = D({}, a, { data: Pb(a.data, a.headers, f) });
        ...
        function n(b, c, d) {
          function e(a, b, c) {
            m && (200 <= a && a < 300 ? m.put(s, [a, b, Nb(c)]) : m.remove(s));
            f(b, a, c);
            i.$apply();
          }
          function f(a, c, d) {
          ...
          if (m)
            if ((t = m.get(s)))
              if (t.then) return t.then(h, h), t;
              else K(t) ? f(t[1], t[0], U(t[2])) : f(t, 200, {});
            else m.put(s, n);
          t ||
            a(
              b.method,
  ...
  function Xc(b, a, c, d, e, g) {
    ...
    return function (e, i, j, k, l, n, p, o) {
      function t(a, c, d, e) {
        c = (i.match(Gb) || ["", g])[1] == "file" ? (d ? 200 : 404) : c;
        a(c == 1223 ? 204 : c, d, e);
      ...
      if (B(e) == "jsonp") {
        ...
        h(i.replace("JSON_CALLBACK", "angular.callbacks." + q), function () {
          d[q].data ? t(k, 200, d[q].data) : t(k, -2);
          delete d[q];
        });
      } else {
        var r = new a();
  ...
  function Sb(b) {
    ...
    return function (c, e) {
      ...
      for (; e; )
        (i = gd.exec(e))
          ? ((h = h.concat(ha.call(i, 1))), (e = h.pop()))
          : (h.push(e), (e = null));
      m(h, function (a) {
        f = hd[a];
        g += f
  ...
  function Ra(b, a, c, d, e, g) {
    ...
    var i = c.ngPattern,
      j = function (a, b) {
        return S(b) || a.test(b)
          ...
          : (d.$setValidity("pattern", !1), s);
      };
    i &&
      (i.match(/^\/(.*)\/$/)
        ? ((i = RegExp(i.substr(1, i.length - 2))),
          (e = function (a) {
            return j(i, a);
          }))
        : (e = function (a) {
            var c = b.$eval(i);
            if (!c || !c.test)
              throw new y("Expected " + i + " to be a RegExp but was " + c);
            return j(c, a);
          }),
      d.$formatters.push(e),
      d.$parsers.push(e));
    if (c.ngMinlength) {
      var k = G(c.ngMinlength),
        e = function (a) {
          return !S(a) && a.length < k
            ? (d.$setValidity("minlength", !1), s)
  ...
  var B = function (b) {
    ...
    y = T.Error,
    Z = G((/msie (\d+)/.exec(B(navigator.userAgent)) || [])[1]),
    u,
    ia,
    ha = [].slice,
    Sa = [].push,
  ...
  var lc = /[A-Z]/g,
    ...
    Ba = (O.cache = {}),
    Aa = (O.expando = "ng-" + new Date().getTime()),
    pc = 1,
  ...
  m(
    {
      ...
      attr: function (b, a, c) {
        ...
        if (Ea[d])
          ...
          return (b = b.getAttribute(a, 2)), b === null ? s : b;
      },
      prop: function (b, a, c) {
        if (x(c)) b[a] = c;
        else return b[a];
  ...
  var Pa = { $addControl: C, $removeControl: C, $setValidity: C, $setDirty: C };
  ...
  var Sa = function (a) {
      ...
      email: function (a, c, d, e, g, h) {
        ...
        a = function (a) {
          return S(a) || nd.test(a)
            ...
            : (e.$setValidity("email", !1), s);
        };
        e.$formatters.push(a);
        e.$parsers.push(a);
      },
      radio: function (a, c, d, e) {
        v(d.name) && c.attr("name", xa());
      ...
      function (a, c) {
        return {
          ...
          link: function (d, e, g, h) {
            h && (bc[B(g.type)] || bc.text)(d, e, g, h, c, a);
          },
        };
      },
    ],
    ...
    pd = [
      ...
      function (a, c, d, e, g) {
        ...
        var g = g(d.ngModel),
          f = g.assign;
        if (!f) throw y(Eb + d.ngModel + " (" + pa(e) + ")");
        this.$render = C;
        var i = e.inheritedData("$formController") || Pa,
          j = 0,
          k = (this.$error = {});
        e.addClass(Qa);
        h(!0);
          ...
          link: function (e, g, h) {
            ...
            e.$watch(
              function () {
                ...
                return isNaN(c)
                  ? ""
                  : (k[c] || (c = a.pluralCat(c - j)), l[c](e, g, !0));
              },
              function (a) {
                g.text(a);
              }
        ...
        return function (a, c, h) {
          ...
          a.$watch(function (a) {
            ...
            if (K(h)) v = h || [];
              ...
              v = [];
              for (u in h)
                h.hasOwnProperty(u) && u.charAt(0) != "$" && v.push(u);
              v.sort();
            }
            e = 0;
            for (f = v.length; e < f; e++) {
              ...
              if ((x = l.shift(w))) {
                r = x.scope;
                s.push(w, x);
                if (e !== x.index) (x.index = e), z.after(x.element);
                z = x.element;
              } else r = a.$new();
              r[j] = w;
              k && (r[k] = u);
            ...
            for (u in l)
              if (l.hasOwnProperty(u))
                for (v = l[u]; v.length; )
                  (w = v.pop()), w.element.remove(), w.scope.$destroy();
            l = s;
          });
        };
      },
            ...
            function l(e, f, g) {
                ...
                for (x = c.length; w < x; w++) {
                  ...
                  if (p.length <= w)
                    (t = {
                      ...
                      p.push(u),
                      f.append(t.element);
                  else if (((u = p[w]), (t = u[0]), t.label != d))
                    t.element.attr("label", (t.label = d));
                  A = null;
                  y = 0;
                  for (z = h.length; y < z; y++)
                    if (((d = h[y]), (v = u[y + 1]))) {
                      A = v.element;
                      if (v.label !== d.label) A.text((v.label = d.label));
                      if (v.id !== d.id) A.val((v.id = d.id));
                      if (v.element.selected !== d.selected)
                        A.prop("selected", (v.selected = d.selected));
                    } else
                      d.id === "" && q
                        ? (B = q)
                        : (B = C.clone())
                        ...
                        A ? A.after(B) : t.element.append(B),
                        (A = B);
                  for (y++; u.length > y; ) u.pop().element.remove();
                }
              ...
              f.bind("change", function () {
                e.$apply(function () {
                  ...
                  } else (h = f.val()), h == "?" ? (i = s) : h == "" ? (i = null) : ((d[k] = c[h]), l && (d[l] = h), (i = n(e, d)));
                  g.$setViewValue(i);
                });
              });
              g.$render = i;
            ...
            if (i[1]) {
              for (
                var n = i[0],
                  ...
                  q = !1,
                  r,
                  C = u(aa.createElement("option")),
                  D = u(aa.createElement("optgroup")),
                  w = C.clone(),
                  i = 0,
                  B = h.children(),
                  F = B.length;
              ...
              if (o && (f.required || f.ngRequired)) {
                ...
                p.$parsers.push(z);
                p.$formatters.unshift(z);
                f.$observe("required", function () {
                  z(p.$viewValue);
                });
              }
              t ? l(e, h, p) : o ? k(e, h, p) : j(e, h, p, n);
            }
          },
        };
      },
