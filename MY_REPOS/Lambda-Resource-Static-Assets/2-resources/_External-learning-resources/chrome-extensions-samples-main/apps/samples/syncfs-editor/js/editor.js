Editor = function (filesystem, container, filer) {
  ...
  function appendEditor(editor) {
    ...
    $("#editor-content").addEventListener(
      "keydown",
      function () {
        if (!this.isScratch()) $("#editor-save").disabled = false;
      }.bind(this)
    );
...
Editor.prototype.showDialog = function (dialogOptions) {
  ...
  if (dialogOptions.dialogLabel) {
    dialog.appendChild(
      createElement("div", { innerText: dialogOptions.dialogLabel })
    );
  }
  ...
  if (dialogOptions.inputLabel) {
    dialog.appendChild(
      createElement("span", { innerText: dialogOptions.inputLabel })
    );
    dialog.appendChild(
      createElement("input", {
  ...
  if (dialogOptions.inputLabel) {
    ...
    $("#editor-dialog-input").addEventListener(
      "keydown",
      function (e) {
        if (e.keyCode == 13) {
  ...
  $("#editor-dialog-submit").addEventListener(
    "click",
    function () {
      dialogOptions.submitCallback(getInputValue());
      dialog.parentNode.removeChild(dialog);
  ...
  $("#editor-dialog-cancel").addEventListener(
    "click",
    function () {
