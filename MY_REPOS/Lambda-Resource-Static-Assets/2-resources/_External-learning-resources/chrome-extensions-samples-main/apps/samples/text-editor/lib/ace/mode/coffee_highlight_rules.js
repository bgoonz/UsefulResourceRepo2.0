...
define(function (require, exports, module) {
  ...
  function CoffeeHighlightRules() {
    ...
    var langConstant = lang.arrayToMap("true|false|null|undefined".split("|"));
    ...
    var supportClass = lang.arrayToMap(
      (
        ...
        "RangeError|String|SyntaxError|Error|EvalError|TypeError|URIError"
      ).split("|")
    );
    ...
    var supportFunction = lang.arrayToMap(
      (
        ...
        "SyntaxError|Error|EvalError|TypeError|URIError"
      ).split("|")
    );
      ...
      start: [
        ...
        },
        {
          token: function (value) {
            ...
            else if (illegal.hasOwnProperty(value)) return "invalid.illegal";
