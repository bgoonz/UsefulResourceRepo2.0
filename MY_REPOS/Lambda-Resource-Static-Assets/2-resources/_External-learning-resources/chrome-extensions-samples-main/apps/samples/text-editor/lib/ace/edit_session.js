...
define(function (require, exports, module) {
  ...
  var EditSession = function (text, mode) {
    ...
    else this.setMode(new TextMode());
  };
  ...
  (function () {
    ...
    this.setAnnotations = function (annotations) {
      ...
      for (var i = 0; i < annotations.length; i++) {
        ...
        if (this.$annotations[row]) this.$annotations[row].push(annotation);
        else this.$annotations[row] = [annotation];
      }
    ...
    this._loadMode = function (mode, callback) {
      ...
      function fetch(callback) {
        ...
        var filename =
          config.get("modePath") + "/mode-" + base + config.get("suffix");
    ...
    this.$getStringScreenWidth = function (str, maxScreenColumn, screenColumn) {
      ...
      if (maxScreenColumn == null) {
        maxScreenColumn =
          screenColumn + str.length * Math.max(this.getTabSize(), 2);
      }
