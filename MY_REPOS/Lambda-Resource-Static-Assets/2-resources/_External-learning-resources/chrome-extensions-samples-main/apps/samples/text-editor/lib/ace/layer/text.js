...
define(function (require, exports, module) {
  ...
  (function () {
    ...
    this.$renderToken = function (stringBuilder, screenColumn, token, value) {
      ...
      var replaceFunc = function (c, a, b, tabIdx, idx4) {
        if (c.charCodeAt(0) == 32) {
          ...
          if (useragent.isOldGecko) return "&";
          else return "&amp;";
        } else if (c == "<") {
          return "&lt;";
        } else if (c == "\u3000") {
    ...
    this.$renderLineCore = function (
      ...
      if (!splits || splits.length == 0) splitChars = Number.MAX_VALUE;
      else splitChars = splits[0];
      ...
      if (this.showInvisibles) {
        if (lastRow !== this.session.getLength() - 1)
          stringBuilder.push(
            "<span class='ace_invisible'>" + this.EOL_CHAR + "</span>"
          );
        else
          stringBuilder.push(
            "<span class='ace_invisible'>" + this.EOF_CHAR + "</span>"
          );
      }
    ...
    this.$renderFoldLine = function (stringBuilder, row, tokens, onlyContents) {
      ...
      var splits = this.session.$useWrapMode
        ? this.session.$wrapData[row]
        : null;
      this.$renderLineCore(
        stringBuilder,
        row,
