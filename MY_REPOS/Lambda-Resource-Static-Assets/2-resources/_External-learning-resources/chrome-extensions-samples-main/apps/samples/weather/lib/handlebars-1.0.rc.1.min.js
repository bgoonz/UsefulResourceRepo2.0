        ...
        if (t && typeof t == "object")
          if (t instanceof Array)
            for (var a = t.length; s < a; s++)
              u && (u.index = s), (o += r(t[s], { data: u }));
          else
            for (var f in t)
              t.hasOwnProperty(f) &&
                (u && (u.key = f), (o += r(t[f], { data: u })), s++);
      ...
      return (
        ...
        (e.performAction = function (t, n, r, i) {
          ...
          switch (r) {
            ...
            case 2:
              return (
                n.yytext.slice(-1) !== "\\" && this.popState(),
                n.yytext.slice(-1) === "\\" &&
                  (n.yytext = n.yytext.substr(0, n.yyleng - 1)),
                14
              );
  ...
  (exports.main = function (t) {
    ...
    return (
      typeof process != "undefined"
        ? (n = require("fs").readFileSync(
            require("path").resolve(t[1]),
            "utf8"
          ))
        : (n = require("file")
    ...
    var e = function (e, t) {
      if (e.original !== t.original)
        throw new Handlebars.Exception(
          e.original + " doesn't match " + t.original
        );
    };
...
(Handlebars.Exception = function (e) {
  ...
  (function (e, t) {
          ...
          (n = e[t]),
            this.options.stringParams
              ? (n.depth && this.addDepth(n.depth),
                ...
                this.opcode("pushStringParam", n.string))
              : this[n.type](n);
      },
    ...
    t.prototype = {
      nameLookup: function (e, n, r) {
        return /^[0-9]+$/.test(n)
          ? e + "[" + n + "]"
          : t.isValidJavaScriptVariableName(n)
          ? e + "." + n
          : e + "['" + n + "']";
      },
      ...
      compile: function (e, t, n, r) {
        (this.environment = e),
          ...
          (this.isChild = !!n),
          (this.context = n || { programs: [], aliases: {} }),
          this.preamble(),
          (this.stackSlot = 0),
          (this.stackVars = []),
          (this.registers = { list: [] }),
        ...
        var i = e.opcodes,
          s;
        this.i = 0;
        for (o = i.length; this.i < o; this.i++)
          (s = i[this.i]),
            s.opcode === "DECLARE"
              ? (this[s.name] = s.value)
      ...
      preamble: function () {
        ...
        if (!this.isChild) {
          ...
          this.environment.usePartial &&
            (n = n + " partials = partials || " + t + ".partials;"),
      ...
      appendEscaped: function () {
        ...
        (this.context.aliases.escapeExpression = "this.escapeExpression"),
          e &&
            e.opcode === "appendContent" &&
            ((t = " + " + this.quotedString(e.args[0])), this.eat(e)),
          this.source.push(
            this.appendToBuffer("escapeExpression(" + this.popStack() + ")" + t)
          );
      },
      ...
      programExpression: function (e) {
        ...
        return n.length === 0
          ? "self.program(" + i.join(", ") + ")"
          : (i.shift(), "self.programWithDepth(" + i.join(", ") + ")");
      },
      ...
      pushStack: function (e) {
        return (
          this.source.push(this.incrStack() + " = " + e + ";"),
      ...
      replaceStack: function (e) {
        ...
        return (
          this.source.push(this.topStack() + " = " + t + ";"),
          "stack" + this.stackSlot
        );
      },
      ...
      setupHelper: function (e, t) {
        ...
        return {
          ...
          helperMissingParams: ["depth0", this.quotedString(t)]
            .concat(n)
            .join(", "),
        };
      },
      setupParams: function (e, t) {
        ...
        return (
          this.options.stringParams && n.push("contexts:[" + r.join(",") + "]"),
  ...
  (Handlebars.VM = {
    template: function (e) {
      var t = {
        ...
        program: function (e, t, n) {
          ...
          return n
            ? Handlebars.VM.program(t, n)
            : r
            ? r
            : ((r = this.programs[e] = Handlebars.VM.program(t)), r);
        },
      ...
      return function (n, r) {
        return (
          (r = r || {}), e.call(t, Handlebars, n, r.helpers, r.partials, r.data)
        );
      };
    },
    ...
    invokePartial: function (e, t, n, r, i, s) {
      ...
      if (e === undefined)
        throw new Handlebars.Exception(
          "The partial " + t + " could not be found"
        );
      ...
      return (
        (i[t] = Handlebars.compile(e, { data: s !== undefined })), i[t](n, o)
      );
    },
  }),
