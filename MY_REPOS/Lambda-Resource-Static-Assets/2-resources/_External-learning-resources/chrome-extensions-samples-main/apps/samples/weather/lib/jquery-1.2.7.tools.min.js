...
(function (d, D) {
  ...
  function T(b, a) {
    function j(a, t, c) {
      ...
      C.trigger(c, [a]);
      c.isDefaultPrevented() ||
        (b.val(N(t.formatter, a, t.format, t.lang)),
        (c.type = "change"),
        C.trigger(c),
        b.data("date", a),
        f.hide(c));
    ...
    function g(a) {
      ...
      d(document).on("keydown.d", function (a) {
        ...
        if (0 <= d(Q).index(e)) {
          ...
          41 < g
            ? (f.addMonth(), (j = d("#" + c.weeks + " a:eq(" + (g - 42) + ")")))
            : 0 > g
            ? (f.addMonth(-1),
              (j = d("#" + c.weeks + " a:eq(" + (g + 42) + ")")))
            : (j = h.eq(g));
          j.addClass(c.focus);
    ...
    var C = b.add(f);
    if (!i.length) {
      i = d("<div><div><a/><div/><a/></div><div><div/><div/></div></div>")
        .hide()
    ...
    d.extend(f, {
      show: function (e) {
        if (!b.attr("readonly") && !b.attr("disabled") && !u) {
          ...
          if (!e.isDefaultPrevented()) {
            ...
            i.css({
              top: t.top + b.outerHeight({ margins: true }) + a.offset[0],
      ...
      setValue: function (e, b, g) {
        var h =
          l(b) >= -1
            ? new Date(l(e), l(b), l(g == D || isNaN(g) ? 1 : g))
            : e || o;
        h < n ? (h = n) : h > p && (h = p);
        ...
        if (a.selectors) {
          ...
          d.each(F.months, function (a, b) {
            n < new Date(e, a + 1, 1) &&
              p > new Date(e, a, 0) &&
              x.append(d("<option/>").html(b).attr("value", a));
          });
          y.empty();
          for (
            var h = q.getFullYear(), m = h + a.yearRange[0];
            m < h + a.yearRange[1];
            m++
          )
            n < new Date(m + 1, 0, 1) &&
              p > new Date(m, 0, 0) &&
              y.append(d("<option/>").text(m));
          x.val(b);
          y.val(e);
        ...
        for (var m = !g ? -7 : 0, s, v; m < (!g ? 35 : 42); m++) {
          ...
          if (m < g) {
            ...
            h = new Date(e, b, v);
            P(o, h)
              ? s.attr("id", c.current).addClass(c.focus)
              : P(q, h) && s.attr("id", c.today);
          }
    ...
    a.editable ||
      b.on("focus.d click.d", f.show).keydown(function (a) {
        ...
        (c == 8 || c == 46) && b.val("");
        return a.shiftKey || a.ctrlKey || a.altKey || c == 9
          ? true
          : a.preventDefault();
      });
    w(b.val()) && j(o, a);
    ...
    b.extend(d, {
      load: function (a) {
        ...
        typeof j == "string" &&
          (j =
            j == "center"
              ? Math.max((n.height() - m) / 2, 0)
              : (parseInt(j, 10) / 100) * n.height());
...
(function (h) {
  ...
  i.addEffect(
    ...
    function (a, e) {
      ...
      d.fixed
        ? ((j -= f.scrollTop()), (k -= f.scrollLeft()))
        : ((a.top += f.scrollTop()), (a.left += f.scrollLeft()));
      c.css({
        position: "absolute",
        top: j,
        left: k,
  ...
  function A(c, b) {
    function e(a, d, f, e) {
      ...
      if (
        ...
        void 0 !== k &&
        !h &&
        ((a.type = "onSlide"), w.trigger(a, [f, d]), a.isDefaultPrevented())
      )
        return g;
      e = h ? b.speed : 0;
      h = h
      ...
      n
        ? (j.animate({ top: d }, e, h),
          b.progress && x.animate({ height: i - d + j.height() / 2 }, e))
        : (j.animate({ left: d }, e, h),
          b.progress && x.animate({ width: d + j.width() / 2 }, e));
      k = f;
      c.val(f);
      return g;
    }
    function o() {
      (n = b.vertical || m(h, "height") > m(h, "width"))
        ? ((i = m(h, "height") - m(j, "height")), (l = h.offset().top + i))
        : ((i = m(h, "width") - m(j, "width")), (l = h.offset().left));
    }
    function q() {
      o();
    ...
    var v = b.max - b.min,
      ...
      r = b.precision;
    void 0 === r &&
      ((r = s.toString().split(".")), (r = 2 === r.length ? r[1].length : 0));
...
(function (d) {
  ...
  function u(f, b) {
    ...
    if (b.circular) {
      ...
      o.length
        ? (o.show(), c.seekTo(0, 0, function () {}), o.hide())
...
(function (d) {
  function n(c, a, b) {
    ...
    d.extend(this, {
      click: function (a, h) {
        ...
        if (!h.isDefaultPrevented())
          return (
            m[j ? (b.initialEffect && b.effect) || "default" : b.effect].call(
              e,
              a,
              function () {
                i = a;
    ...
    b.history &&
      d.fn.history &&
      (d.tools.history.init(g), (b.event = "history"));
    g.each(function (a) {
    ...
    c.find('[href="' + location.hash + '"]').length
      ...
      : (0 === b.initialIndex || 0 < b.initialIndex) && e.click(b.initialIndex);
  }
  d.tools = d.tools || { version: "@VERSION" };
  d.tools.tabs = {
    conf: {
...
(function (d) {
  function n(c, a) {
    ...
    d.each(
      ["onBeforePlay", "onPlay", "onBeforePause", "onPause"],
      function (e, c) {
    ...
    a.autopause &&
      e.getTabs().add(m).add(k).add(e.getPanes()).hover(b.pause, b.resume);
    a.autoplay && b.play();
    a.clickable &&
  ...
  b.mask = {
    load: function (a, f) {
      ...
      f &&
        ...
        b.each(f, function () {
          var a = b(this);
          /relative|absolute|fixed/i.test(a.css("position")) ||
...
(function () {
  ...
  function l(a, b, c) {
    if (e.isSupported(b.version)) a.innerHTML = e.getHTML(b, c);
      ...
      a.innerHTML = e.getHTML(h(b, { src: b.expressInstall }), {
  ...
  window.flashembed = function (a, b, c) {
    ...
    if (a)
      return (
        "string" == typeof b && (b = { src: b }), new l(a, h(h({}, g), b), c)
      );
  };
      ...
      getHTML: function (a, b) {
        var a = h({}, a),
          c =
            ...
            '"';
        a.cachebusting &&
          (a.src += (-1 != a.src.indexOf("?") ? "&" : "?") + Math.random());
        c =
          a.w3c || !i
            ? c + (' data="' + a.src + '" type="application/x-shockwave-flash"')
          ...
          for (var f in b)
            if (b[f]) {
              ...
              d +=
                ...
                "=" +
                encodeURIComponent(
                  /function|object/.test(typeof g) ? e.asString(g) : g
                ) +
                "&";
            }
          d = d.slice(0, -1);
...
(function (b) {
  ...
  var d = !b.browser.mozilla
    ? "mousewheel"
    : "DOMMouseScroll" + ("1.9" > b.browser.version ? " mousemove" : "");
})(jQuery);
(function (e) {
  function p(a, b, d) {
  ...
  var o = {
    ...
    fade: [
      ...
      function (a) {
        var b = this.getConf();
        !e.browser.msie || b.fadeIE
          ? this.getTip().fadeOut(b.fadeOutSpeed, a)
          : (this.getTip().hide(), a());
      },
    ],
  };
    ...
    this.each(function () {
      var h = c(this)
        ...
        .onBeforeShow(function (f, h) {
          ...
          b = [
            d.offset().top <= b.scrollTop(),
            g <= d.offset().left + d.width(),
            i <= d.offset().top + d.height(),
            b.scrollLeft() >= d.offset().left,
          ];
          a: {
            for (g = b.length; g--; )
              if (b[g]) {
          ...
          if (!g) {
            b[2] &&
              (c.extend(a, k.top), (a.position[0] = "top"), d.addClass(j[0]));
            b[3] &&
              (c.extend(a, k.right),
              (a.position[1] = "right"),
              d.addClass(j[1]));
            b[0] &&
              ...
              d.addClass(j[2]));
            b[1] &&
              (c.extend(a, k.left), (a.position[1] = "left"), d.addClass(j[3]));
...
(function (c) {
  ...
  function n(b, a, f) {
      ...
      invalidate: function (a, h) {
        if (!h) {
          ...
          c.each(a, function (a, f) {
            ...
            c.length &&
              (c.trigger("OI", [f]), d.push({ input: c, messages: [f] }));
          });
          a = d;
          h = c.Event();
        }
    ...
    c.each(
      ["onBeforeValidate", "onBeforeFail", "onFail", "onSuccess"],
      function (a, b) {
    ...
    b.filter(":checkbox, select")
      ...
      .on("change.V", function (a) {
        var b = c(this);
        (this.checked || (b.is("select") && c(this).val())) &&
          l[f.effect][1].call(e, b, a);
      });
      ...
      default: [
        function (b) {
          ...
          c.each(b, function (b, d) {
            ...
            g.outerWidth() == g.parent().width() &&
              g.add(g.find("p")).css({ display: "inline" });
            e = i(e, g, a);
            g.css({
              visibility: "visible",
              position: "absolute",
