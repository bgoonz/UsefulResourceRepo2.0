var main = (function () {
      ...
      function (chrcs) {
        ...
        chrcs.forEach(function (chrc) {
          ...
          if (chrc.uuid != BATTERY_LEVEL_UUID) {
            console.log(
              "Found unexpected characteristic: " +
                chrc.instanceId +
                " with UUID: " +
                chrc.uuid
            );
          ...
          console.log(
            "Setting Battery Level characteristic: " + chrc.instanceId
          );
          ...
          chrome.bluetoothLowEnergy.startCharacteristicNotifications(
            ...
            function () {
              if (
                ...
                console.log(
                  "Failed to enable Battery Level notifications: " +
              ...
              console.log(
                "Battery Level notifications enabled! Sending request to " +
              ...
              chrome.bluetoothLowEnergy.readCharacteristicValue(
                ...
                function (readChrc) {
                  ...
                  if (
                    readChrc.instanceId != self.batteryLevelChrc_.instanceId
                  ) {
                    return;
                  }
  ...
  BatteryLevelDemo.prototype.updateDiscoveryToggleState = function (
    discovering
  ) {
        ...
        devices.forEach(function (device) {
          ...
          chrome.bluetoothLowEnergy.getServices(
            ...
            function (services) {
              ...
              console.log(
                "Found device with Battery service: " + device.address
              );
