...
var gamepadSupport = {
  ...
  updateDisplay: function (gamepadId) {
    ...
    if (
      Date.now() - gamepadSupport.buttonPressedTime <
      gamepadSupport.BUTTON_THROTTLE_MILLISECOND
    ) {
      return;
    }
