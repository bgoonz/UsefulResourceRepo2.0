...
(function ($) {
  ...
  (function (reflectionData) {
      ...
      for (var property in descriptor) {
        ...
        if (firstChar === "+") {
          ...
          if (descriptor[property] == 1)
            descriptor[previousProperty].$reflectable = 1;
    ...
    function addStubs(
            ...
            f =
              (function () {
                ...
                if (result != null && typeof result != "function") {
                  throw new Error(
                    name +
                      ": expected value of type 'function' at index " +
                      0 +
                      " but got " +
                      typeof result
                  );
      ...
      for (var index = 0; index < array.length; index += 2) {
        ...
        f.$stubName = (function () {
          ...
          if (result != null && typeof result != "string") {
            throw new Error(
              name +
                ": expected value of type 'string' at index " +
                (index + 2) +
                " but got " +
                typeof result
            );
      ...
      var requiredParameterInfo = (function () {
        ...
        if (
          ...
          throw new Error(
            name +
              ": expected value of type 'int' at index " +
              0 +
              " but got " +
              typeof result
          );
      ...
      var functionTypeIndex = (function () {
        ...
        if (
          ...
          throw new Error(
            name +
              ": expected value of type 'function or int' at index " +
              2 +
              " but got " +
              typeof result
          );
    ...
    var tearOffGetter =
      typeof dart_precompiled == "function"
        ? tearOffGetterCsp
        : tearOffGetterNoCsp;
    ...
    [
      ...
      J,
      {
        ...
        getNativeInterceptor: function (object) {
          ...
          if (interceptor == null) return C.UnknownJavaScriptObject_methods;
          return interceptor;
        },
        Interceptor: {
          "": "Object;",
        ...
        JSArray: {
          ...
          toString$0: function (receiver) {
            return H.IterableMixinWorkaround_toStringIterable(
              receiver,
              "[",
              "]"
            );
          ...
          static: {
            JSArray_JSArray$fixed: function ($length, $E) {
              ...
              if (
                ...
                throw H.wrapException(
                  P.ArgumentError$(
                    "Length must be a non-negative integer: " + H.S($length)
                  )
                );
        ...
        JSNumber: {
          ...
          roundToDouble$0: function (receiver) {
            ...
            else return Math.round(receiver);
          },
          toString$0: function (receiver) {
          ...
          _tdivFast$1: function (receiver, other) {
            return (receiver | 0) === receiver
              ? (receiver / other) | 0
              : this.toInt$0(receiver / other);
          },
          _shrOtherPositive$1: function (receiver, other) {
            var t1;
            if (receiver > 0) t1 = other > 31 ? 0 : receiver >>> other;
            else {
        ...
        JSString: {
          ...
          codeUnitAt$1: function (receiver, index) {
            if (index < 0) throw H.wrapException(P.RangeError$value(index));
          ...
          substring$2: function (receiver, startIndex, endIndex) {
            if (endIndex == null) endIndex = receiver.length;
            if (
              typeof endIndex !== "number" ||
              Math.floor(endIndex) !== endIndex
            )
              H.throwExpression(P.ArgumentError$(endIndex));
            if (startIndex < 0)
              throw H.wrapException(P.RangeError$value(startIndex));
            if (typeof endIndex !== "number") return H.iae(endIndex);
    ...
    [
      ...
      H,
      {
        ...
        startRootIsolate: function (entry) {
          ...
          t1._Manager$1(entry);
          init.globalState = t1;
          if (init.globalState.isWorker === true) return;
          t1 = init.globalState;
          t2 = t1.nextIsolateId;
          t1.nextIsolateId = t2 + 1;
          rootContext = new H._IsolateContext(
            t2,
            P.LinkedHashMap_LinkedHashMap(
              null,
              null,
              null,
              J.JSInt,
            ...
            P.LinkedHashSet_LinkedHashSet(null, null, null, J.JSInt),
            new Isolate()
          );
          ...
          if (t2) rootContext.eval$1(new H.startRootIsolate_closure(entry));
          else {
            t1 = H.buildFunctionType(t1, [t1, t1])._isTest$1(entry);
            if (t1) rootContext.eval$1(new H.startRootIsolate_closure0(entry));
            else rootContext.eval$1(entry);
          }
          init.globalState.topEventLoop.run$0();
        },
        IsolateNatives_computeThisScript: function () {
          var currentScript = init.currentScript;
          if (currentScript != null) return String(currentScript.src);
          if (
        ...
        IsolateNatives_computeThisScriptD8: function () {
          ...
          matches = stack.match(
            new RegExp("^ *at [^(]*\\((.*):[0-9]*:[0-9]*\\)$", "m")
          );
          if (matches != null) return matches[1];
          matches = stack.match(new RegExp("^[^@]*@(.*):[0-9]*$", "m"));
          if (matches != null) return matches[1];
          throw H.wrapException(
            P.UnsupportedError$('Cannot extract URI from "' + stack + '"')
          );
        },
        IsolateNatives__processWorkerMessage: function (sender, e) {
          ...
          switch (t1.$index(msg, "command")) {
            case "start":
              ...
              entryPoint =
                functionName == null
                  ? init.globalState.entry
                  : init.globalFunctions[functionName]();
              ...
              init.globalState.topEventLoop.events._add$1(
                new H._IsolateEvent(
                  context,
                  new H.IsolateNatives__processWorkerMessage_closure(
                    entryPoint,
                    args,
                    message,
                    isSpawnUri,
            ...
            case "spawn-worker":
              ...
              if (uri == null) uri = $.get$IsolateNatives_thisScript();
              worker = new Worker(uri);
              worker.onmessage = function (e) {
                H.IsolateNatives__processWorkerMessage(worker, e);
              };
              t6 = init.globalState;
                ...
                H._serializeMessage(
                  H.fillLiteralMap(
                    [
                      ...
                      workerId,
                      "replyTo",
                      H._serializeMessage(t1),
                      "args",
                      t3,
                      "msg",
                      H._serializeMessage(t4),
                      "isSpawnUri",
                      t5,
                      "functionName",
                      t2,
        ...
        _Manager: {
          ...
          _Manager$1: function (entry) {
            ...
            this.isolates = P.LinkedHashMap_LinkedHashMap(
              null,
              null,
              null,
              J.JSInt,
            ...
            this.managers = P.LinkedHashMap_LinkedHashMap(
              null,
              null,
              null,
              J.JSInt,
            ...
            if (this.isWorker === true) {
              ...
              this.mainManager = t1;
              $function = function (e) {
                H.IsolateNatives__processWorkerMessage(t1, e);
              };
        ...
        _IsolateContext: {
          ...
          eval$1: function (code) {
            ...
            try {
              ...
              if (old != null) $ = old.get$isolateStatics();
            }
            return result;
          },
          ...
          _updateGlobalState$0: function () {
            ...
            t1 = this.id;
            if (
              this.ports._collection$_length -
                this.weakPorts._collection$_length >
              0
            ) {
        ...
        _EventLoop: {
          ...
          runIteration$0: function () {
            ...
            if ($event == null) {
              if (
                init.globalState.rootContext != null &&
                init.globalState.isolates.containsKey$1(
                  init.globalState.rootContext.id
                ) &&
                init.globalState.fromCommandLine === true &&
                init.globalState.rootContext.ports._collection$_length === 0
              )
                H.throwExpression(
                  P.Exception_Exception(
                    "Program exited with open ReceivePorts."
                  )
                );
              t1 = init.globalState;
              if (
                t1.isWorker === true &&
                t1.isolates._collection$_length === 0 &&
                t1.topEventLoop.activeTimerCount === 0
              ) {
                t1 = t1.mainManager;
                t2 = H._serializeMessage(
                  H.fillLiteralMap(
          ...
          _runHelper$0: function () {
            ...
            else for (; this.runIteration$0(); );
          },
          run$0: function () {
            var e, trace, exception, t1, t2;
            if (init.globalState.isWorker !== true) this._runHelper$0();
            else
              try {
                this._runHelper$0();
              } catch (exception) {
        ...
        _EventLoop__runHelper_next: {
          "": "Closure:0;this_0",
          call$0: function () {
            if (!this.this_0.runIteration$0()) return;
        ...
        IsolateNatives__processWorkerMessage_closure: {
          ...
          call$0: function () {
            ...
            $.Primitives_mirrorFunctionCacheName =
              $.Primitives_mirrorFunctionCacheName + ("_" + t4);
            $.Primitives_mirrorInvokeCacheName =
              $.Primitives_mirrorInvokeCacheName + ("_" + t4);
            ...
            $.controlPort = t4;
            this.replyTo_4.send$1([
              "spawned",
              new H._NativeJsSendPort(t5, init.globalState.currentContext.id),
            ]);
            if (this.isSpawnUri_3 !== true) t1.call$1(t3);
            else {
              t4 = H.getDynamicRuntimeType();
              t5 = H.buildFunctionType(t4, [t4, t4])._isTest$1(t1);
              if (t5) t1.call$2(t2, t3);
              else {
        ...
        _NativeJsSendPort: {
          ...
          send$1: function (message) {
            ...
            if (this._receivePort.get$_isClosed()) return;
            shouldSerialize =
              init.globalState.currentContext != null &&
              init.globalState.currentContext.id !== t3;
            t1.msg_0 = message;
            if (shouldSerialize) t1.msg_0 = H._serializeMessage(message);
            t2 = init.globalState.topEventLoop;
            t3 = "receive " + H.S(message);
            t2.events._add$1(
              new H._IsolateEvent(
                isolate,
                new H._NativeJsSendPort_send_closure(t1, this, shouldSerialize),
                t3
              )
            );
          },
          $eq: function (_, other) {
            ...
            return (
              typeof other === "object" &&
              other !== null &&
              !!t1.$is_NativeJsSendPort &&
              J.$eq(this._receivePort, other._receivePort)
            );
          },
          get$hashCode: function (_) {
        ...
        _WorkerSendPort: {
          ...
          send$1: function (message) {
            ...
            workerMessage = H._serializeMessage(
              H.fillLiteralMap(
                ["command", "message", "port", this, "msg", message],
                P.LinkedHashMap_LinkedHashMap(null, null, null, null, null)
              )
            );
            if (init.globalState.isWorker === true) {
              ...
              if (manager != null) manager.postMessage(workerMessage);
            }
          },
          $eq: function (_, other) {
            var t1;
            ...
            return (
              typeof other === "object" &&
              other !== null &&
              !!t1.$is_WorkerSendPort &&
              J.$eq(this._workerId, other._workerId) &&
              J.$eq(this._isolateId, other._isolateId) &&
              J.$eq(this._receivePortId, other._receivePortId)
            );
          },
          get$hashCode: function (_) {
            var t1, t2, t3;
            t1 = this._workerId;
            if (typeof t1 !== "number") return t1.$shl();
            t2 = this._isolateId;
            if (typeof t2 !== "number") return t2.$shl();
            t3 = this._receivePortId;
            if (typeof t3 !== "number") return H.iae(t3);
        ...
        ReceivePortImpl: {
          ...
          listen$4$cancelOnError$onDone$onError: function (
            onData,
            cancelOnError,
            onDone,
            onError
            ...
            t1.toString;
            return H.setRuntimeTypeInfo(new P._ControllerStream(t1), [
              null,
          ...
          ReceivePortImpl$fromRawReceivePort$1: function (_rawPort) {
            var t1 = P.StreamController_StreamController(
              this.get$close(this),
              null,
              null,
              null,
        ...
        _JsSerializer: {
          ...
          visitSendPort$1: function (x) {
            if (!!x.$is_NativeJsSendPort)
              return [
                "sendport",
                init.globalState.currentManagerId,
                x._isolateId,
                x._receivePort.get$_id(),
              ];
        ...
        _JsVisitedMap: {
          ...
          cleanup$0: function () {
            ...
            for ($length = this.tagged.length, i = 0; i < $length; ++i) {
              t1 = this.tagged;
              if (i >= t1.length) return H.ioore(t1, i);
        ...
        _MessageTraverser: {
          ...
          visitObject$1: function (x) {
            throw H.wrapException(
              "Message serialization: Illegal value " + H.S(x) + " passed"
            );
          },
        },
        _Copier: {
        ...
        _Serializer: {
          ...
          visitMap$1: function (map) {
            ...
            t1 = map.get$keys();
            keys = this._serializeList$1(
              P.List_List$from(
                t1,
                true,
                H.getRuntimeTypeArgument(t1, "IterableBase", 0)
              )
            );
          ...
          _serializeList$1: function (list) {
            ...
            for (i = 0; i < len; ++i) {
              ...
              if (i >= result.length) return H.ioore(result, i);
              result[i] = t2;
            }
            return result;
          },
        ...
        _Deserializer: {
          ...
          deserialize$1: function (x) {
            if (H._Deserializer_isPrimitive(x)) return x;
            this._deserialized = P.HashMap_HashMap(
              null,
              null,
              null,
              null,
          ...
          _deserializeList$1: function (x) {
            ...
            if (typeof len !== "number") return H.iae(len);
            i = 0;
            for (; i < len; ++i)
              t1.$indexSet(
                dartList,
                i,
                this._deserializeHelper$1(t1.$index(dartList, i))
              );
            return dartList;
          },
          _deserializeMap$1: function (x) {
            var result, t1, id, t2, keys, values, len, i;
            result = P.LinkedHashMap_LinkedHashMap(
              null,
              null,
              null,
              null,
            ...
            for (; i < len; ++i)
              result.$indexSet(
                result,
                this._deserializeHelper$1(t1.$index(keys, i)),
                this._deserializeHelper$1(t2.$index(values, i))
              );
            return result;
          },
        ...
        TimerImpl: {
          ...
          TimerImpl$2: function (milliseconds, callback) {
            ...
            if (milliseconds === 0)
              t1 =
                $.get$globalThis().setTimeout == null ||
                init.globalState.isWorker === true;
            else t1 = false;
            if (t1) {
              this._handle = 1;
              ...
              t1.events._add$1(
                new H._IsolateEvent(
                  t2,
                  new H.TimerImpl_internalCallback(this, callback),
                  "timer"
                )
              );
              ...
              if (t1.setTimeout != null) {
                ...
                this._handle = t1.setTimeout(
                  H.convertDartClosureToJS(
                    new H.TimerImpl_internalCallback0(this, callback),
                    0
                  ),
                  milliseconds
                );
                ...
                throw H.wrapException(
                  P.UnsupportedError$("Timer greater than 0.")
                );
            }
          },
          static: {
      ...
      H,
      {
        ...
        isJsIndexable: function (object, record) {
          ...
          return (
            ...
            object !== null &&
            !!t1.$isJavaScriptIndexingBehavior
          );
        },
        S: function (value) {
          var res;
        ...
        Primitives_objectTypeName: function (object) {
          ...
          if ($name === "Object") {
            decompiled = String(object.constructor).match(
              /^\s*function\s*(\S*)\s*\(/
            )[1];
        ...
        Primitives_stringFromCodePoints: function (codePoints) {
          ...
          for (
            ...
            if (i <= 65535) a.push(i);
              ...
              a.push(56320 + (i & 1023));
            } else throw H.wrapException(P.ArgumentError$(i));
          }
        ...
        Primitives_stringFromCharCodes: function (charCodes) {
          ...
          for (
            ...
            if (typeof i !== "number" || Math.floor(i) !== i)
              throw H.wrapException(P.ArgumentError$(i));
            if (i < 0) throw H.wrapException(P.ArgumentError$(i));
        ...
        Primitives_getHours: function (receiver) {
          return receiver.isUtc
            ? H.Primitives_lazyAsJsDate(receiver).getUTCHours() + 0
            : H.Primitives_lazyAsJsDate(receiver).getHours() + 0;
        },
        Primitives_getMinutes: function (receiver) {
          return receiver.isUtc
            ? H.Primitives_lazyAsJsDate(receiver).getUTCMinutes() + 0
            : H.Primitives_lazyAsJsDate(receiver).getMinutes() + 0;
        },
        Primitives_getSeconds: function (receiver) {
          return receiver.isUtc
            ? H.Primitives_lazyAsJsDate(receiver).getUTCSeconds() + 0
            : H.Primitives_lazyAsJsDate(receiver).getSeconds() + 0;
        },
        ...
        wrapException: function (ex) {
          ...
          if ("defineProperty" in Object) {
            Object.defineProperty(wrapper, "message", {
              get: H.toStringWrapper,
            });
            wrapper.name = "";
          } else wrapper.toString = H.toStringWrapper;
          return wrapper;
        },
        ...
        unwrapException: function (ex) {
          ...
          if ("dartException" in ex) return t1.call$1(ex.dartException);
          else if (!("message" in ex)) return ex;
          message = ex.message;
        ...
        invokeClosure: function (
          ...
          if (t1.$eq(numberOfArguments, 0))
            return H._callInIsolate(
              isolate,
              new H.invokeClosure_closure(closure)
            );
          else if (t1.$eq(numberOfArguments, 1))
            return H._callInIsolate(
              isolate,
              new H.invokeClosure_closure0(closure, arg1)
            );
          else if (t1.$eq(numberOfArguments, 2))
            return H._callInIsolate(
              isolate,
              new H.invokeClosure_closure1(closure, arg1, arg2)
            );
          else if (t1.$eq(numberOfArguments, 3))
            return H._callInIsolate(
              isolate,
              new H.invokeClosure_closure2(closure, arg1, arg2, arg3)
            );
          else if (t1.$eq(numberOfArguments, 4))
            return H._callInIsolate(
              isolate,
              new H.invokeClosure_closure3(closure, arg1, arg2, arg3, arg4)
            );
          else
            throw H.wrapException(
              P.Exception_Exception(
        ...
        Closure_fromTearOff: function (
          ...
          functionType =
            H.ReflectionInfo_ReflectionInfo($function).functionType;
          $prototype = isStatic
            ? Object.create(new H.TearOffClosure().constructor.prototype)
            : Object.create(
                new H.BoundClosure(null, null, null, null).constructor.prototype
              );
          ...
          if (typeof functionType == "number")
            ...
            getReceiver = isIntercepted
              ? H.BoundClosure_receiverOf
              : H.BoundClosure_selfOf;
            signatureFunction = (function (f, r) {
              return function () {
                return f.apply({ $receiver: r(this) }, arguments);
              };
            })(functionType, getReceiver);
          } else throw H.wrapException("Error in reflectionInfo.");
          ...
          for (t1 = functions.length, i = 1; i < t1; ++i) {
            ...
            if (stubCallName != null) {
              t2 = isStatic
                ? stub
                : H.Closure_forwardCallTo(stub, isIntercepted);
        ...
        Closure_forwardCallTo: function ($function, isIntercepted) {
          ...
          } else return H.Closure_cspForwardCall(arity, $function);
        },
        Closure_cspForwardInterceptedCall: function (arity, $name, $function) {
          ...
          switch (arity) {
            case 0:
              throw H.wrapException(
                H.RuntimeError$("Intercepted function with no arguments.")
              );
            case 1:
        ...
        Closure_forwardInterceptedCallTo: function ($function) {
          ...
          if (typeof dart_precompiled == "function")
            ...
            t1 =
              "return this." +
              H.S(H.BoundClosure_selfFieldName()) +
              "." +
              stubName +
              "(this." +
              H.S(H.BoundClosure_receiverFieldName()) +
              ");";
            t2 = $.Closure_functionCounter;
            $.Closure_functionCounter = J.$add$ns(t2, 1);
        ...
        throwCyclicInit: function (staticName) {
          throw H.wrapException(
            P.CyclicInitializationError$(
              "Cyclic initialization for static " + H.S(staticName)
            )
          );
        },
        buildFunctionType: function (
          returnType,
          parameterTypes,
          optionalParameterTypes
        ) {
          return new H.RuntimeFunctionType(
            returnType,
            parameterTypes,
            optionalParameterTypes,
            null
        ...
        setRuntimeTypeInfo: function (target, typeInfo) {
          if (target != null) target.$builtinTypeInfo = typeInfo;
          return target;
        },
        ...
        getRuntimeTypeArguments: function (target, substitutionName) {
          return H.substitute(
            target["$as" + H.S(substitutionName)],
            H.getRuntimeTypeInfo(target)
          );
        },
        ...
        runtimeTypeToString: function (type, onTypeVariable) {
          if (type == null) return "dynamic";
            ...
            return (
              type[0].builtin$cls + H.joinArguments(type, 1, onTypeVariable)
            );
          else if (typeof type == "function") return type.builtin$cls;
        ...
        joinArguments: function (types, startIndex, onTypeVariable) {
          ...
          for (
            index = startIndex, firstArgument = true, allDynamic = true;
            index < types.length;
            ++index
          ) {
            if (firstArgument) firstArgument = false;
            else buffer._contents = buffer._contents + ", ";
            argument = types[index];
            if (argument != null) allDynamic = false;
        ...
        substitute: function (substitution, $arguments) {
          if (
            ...
            substitution !== null &&
            substitution.constructor === Array
          )
        ...
        areSubtypes: function (s, t) {
          ...
          len = s.length;
          for (i = 0; i < len; ++i) if (!H.isSubtype(s[i], t[i])) return false;
          return true;
        },
        computeSignature: function (signature, context, contextName) {
          return H.invokeOn(
            signature,
            context,
            H.getRuntimeTypeArguments(context, contextName)
          );
        },
        isSubtype: function (s, t) {
          ...
          if ("func" in t) {
            if (!("func" in s)) {
              if ("$is_" + H.S(t.func) in s) return true;
          ...
          if (t.builtin$cls === "Function" && "func" in s) return true;
          ...
          if (typeOfT !== typeOfS) {
            if (!("$is" + H.S($name) in typeOfS)) return false;
            substitution =
              typeOfS["$as" + H.S(H.runtimeTypeToString(typeOfT, null))];
          } else substitution = null;
          if ((!t1 && substitution == null) || !t2) return true;
        ...
        areAssignable: function (s, t, allowShorter) {
          ...
          } else if (sLength !== tLength) return false;
          for (i = 0; i < tLength; ++i) {
            t1 = s[i];
            t2 = t[i];
            if (!(H.isSubtype(t1, t2) || H.isSubtype(t2, t1))) return false;
          }
          return true;
        },
        areAssignableMaps: function (s, t) {
          ...
          for (t1 = names.length, i = 0; i < t1; ++i) {
            $name = names[i];
            if (!Object.hasOwnProperty.call(s, $name)) return false;
            tType = t[$name];
            sType = s[$name];
        ...
        isFunctionSubtype: function (s, t) {
          var sReturnType,
            ...
            tPos,
            sPos;
          if (!("func" in s)) return false;
          if ("void" in s) {
            if (!("void" in t) && "ret" in t) return false;
          } else if (!("void" in t)) {
            sReturnType = s.ret;
            tReturnType = t.ret;
            if (
              !(
                H.isSubtype(sReturnType, tReturnType) ||
                H.isSubtype(tReturnType, sReturnType)
              )
            )
              return false;
          }
          ...
          sOptionalParametersLen =
            sOptionalParameterTypes != null
              ? sOptionalParameterTypes.length
              : 0;
          tOptionalParametersLen =
            tOptionalParameterTypes != null
              ? tOptionalParameterTypes.length
              : 0;
          if (sParametersLen > tParametersLen) return false;
          if (
            sParametersLen + sOptionalParametersLen <
        ...
        ReflectionInfo: {
          ...
          static: {
            "": "ReflectionInfo_REQUIRED_PARAMETERS_INFO,ReflectionInfo_OPTIONAL_PARAMETERS_INFO,ReflectionInfo_FUNCTION_TYPE_INDEX,ReflectionInfo_FIRST_DEFAULT_ARGUMENT",
            ReflectionInfo_ReflectionInfo: function (jsFunction) {
              ...
              return new H.ReflectionInfo(
                jsFunction,
                data,
                (requiredParametersInfo & 1) === 1,
                requiredParameterCount,
                optionalParametersInfo >> 1,
                (optionalParametersInfo & 1) === 1,
                data[2]
              );
            },
          },
          ...
          static: {
            ...
            TypeErrorDecoder_extractPattern: function (message) {
              ...
              return new H.TypeErrorDecoder(
                message
                  .replace("\\$arguments\\$", "((?:x|[^x])*)")
                  .replace("\\$argumentsExpr\\$", "((?:x|[^x])*)")
                  .replace("\\$expr\\$", "((?:x|[^x])*)")
                  .replace("\\$method\\$", "((?:x|[^x])*)")
                  .replace("\\$receiver\\$", "((?:x|[^x])*)"),
                $arguments,
                argumentsExpr,
                expr,
                method,
        ...
        NullError: {
          ...
          toString$0: function (_) {
            var t1 = this._method;
            if (t1 == null) return "NullError: " + H.S(this._message);
        ...
        JsNoSuchMethodError: {
          ...
          toString$0: function (_) {
            var t1, t2;
            t1 = this._method;
            if (t1 == null) return "NoSuchMethodError: " + H.S(this._message);
            t2 = this._receiver;
            if (t2 == null)
              return (
                'NoSuchMethodError: Cannot call "' +
                t1 +
                '" (' +
                H.S(this._message) +
                ")"
        ...
        UnknownJsTypeError: {
          ...
          toString$0: function (_) {
            ...
            return C.JSString_methods.get$isEmpty(t1)
              ? "Error"
              : "Error: " + t1;
          },
        },
          ...
          get$hashCode: function (_) {
            ...
            if (t1 == null)
              ...
              receiverHashCode =
                typeof t1 !== "object"
                  ? J.get$hashCode$(t1)
                  : H.Primitives_objectHashCode(t1);
            return (
              (receiverHashCode ^ H.Primitives_objectHashCode(this._target)) >>>
              0
            );
          },
          $isBoundClosure: true,
          static: {
            "": "BoundClosure_selfFieldNameCache,BoundClosure_receiverFieldNameCache",
        ...
        RuntimeFunctionType: {
          ...
          _isTest$1: function (expression) {
            var functionTypeObject =
              this._extractFunctionTypeObjectFrom$1(expression);
            return functionTypeObject == null
              ? false
              : H.isFunctionSubtype(functionTypeObject, this.toRti$0());
          },
          _extractFunctionTypeObjectFrom$1: function (o) {
            var interceptor = J.getInterceptor(o);
            return "$signature" in interceptor
          ...
          toRti$0: function () {
            ...
            if (
              typeof t1 === "object" &&
              t1 !== null &&
              !!t2.$isVoidRuntimeType
            )
              result.void = true;
            else if (
              typeof t1 !== "object" ||
              t1 === null ||
              !t2.$isDynamicRuntimeType
            )
          ...
          toString$0: function (_) {
            ...
            if (t1 != null)
              for (
                t2 = t1.length, result = "(", needsComma = false, i = 0;
                i < t2;
                ++i, needsComma = true
              ) {
                type = t1[i];
            ...
            if (t1 != null && t1.length !== 0) {
              ...
              for (
                t2 = t1.length, needsComma = false, i = 0;
                i < t2;
                ++i, needsComma = true
              ) {
                type = t1[i];
              ...
              if (t1 != null) {
                ...
                keys = H.extractKeys(t1);
                for (
                  t2 = keys.length, needsComma = false, i = 0;
                  i < t2;
                  ++i, needsComma = true
                ) {
                  $name = keys[i];
        ...
        TypeImpl: {
          ...
          toString$0: function (_) {
            ...
            unmangledName =
              unmangledName0 == null ? unmangledName : unmangledName0;
          ...
          $eq: function (_, other) {
            ...
            return (
              ...
              other !== null &&
              !!t1.$isTypeImpl &&
              J.$eq(this._typeName, other._typeName)
            );
          },
          $isTypeImpl: true,
        },
      ...
      Q,
      {
        ...
        main: [
          function () {
            ...
            t4 = new Q.Balls(
              null,
              P.DateTime$_now().millisecondsSinceEpoch,
              H.setRuntimeTypeInfo([], [Q.Ball])
            );
            t4.Balls$0();
        ...
        Balls: {
          ...
          tick$1: function (now) {
            ...
            if (typeof t2 !== "number") return H.iae(t2);
            t2 = 1000 / t2;
            t3 = $.fpsAverage;
            if (t3 == null) $.fpsAverage = t2;
            else {
              if (typeof t3 !== "number") return t3.$mul();
              $.fpsAverage = t2 * 0.05 + t3 * 0.95;
              document.querySelector("#notes").textContent =
                "" +
                C.JSInt_methods.toInt$0(
                  C.JSNumber_methods.toInt$0(J.roundToDouble$0$n($.fpsAverage))
                ) +
                " fps";
            }
            t1 = t1.$sub(now, this.lastTime);
            if (typeof t1 !== "number") return t1.$div();
            delta = P.min(t1 / 1000, 0.1);
            this.lastTime = now;
            H.IterableMixinWorkaround_removeWhereList(
              this.balls,
              new Q.Balls_tick_closure(delta)
            );
            this.collideBalls$1(delta);
          },
          collideBalls$1: function (delta) {
            H.IterableMixinWorkaround_forEach(
              this.balls,
              new Q.Balls_collideBalls_closure(this, delta)
            );
          },
          Balls$0: function () {
        ...
        Balls_collideBalls_closure: {
          ...
          call$1: function (b0) {
            ...
            H.IterableMixinWorkaround_forEach(
              t1.balls,
              new Q.Balls_collideBalls__closure(t1, this.delta_1, b0)
            );
          },
        },
        Balls_collideBalls__closure: {
          ...
          call$1: function (b1) {
            ...
            t5 = t4.get$x(b1);
            if (typeof t3 !== "number") return t3.$sub();
            if (typeof t5 !== "number") return H.iae(t5);
            dx = Math.abs(t3 - t5);
            t5 = t2.get$y(t1);
            t3 = t4.get$y(b1);
            if (typeof t5 !== "number") return t5.$sub();
            if (typeof t3 !== "number") return H.iae(t3);
            dy = Math.abs(t5 - t3);
            d2 = dx * dx + dy * dy;
            if (d2 < 196) {
              ...
              t6 = t1.y;
              t7 = t1.vy;
              if (typeof t6 !== "number") return t6.$add();
              t4 = t4.get$x(b1);
              t8 = b1.get$vx();
              if (typeof t4 !== "number") return t4.$add();
              t9 = b1.y;
              t10 = b1.vy;
              if (typeof t9 !== "number") return t9.$add();
              ndx = Math.abs(t2 + t5 * t3 - (t4 + t8 * t3));
              ndy = Math.abs(t6 + t7 * t3 - (t9 + t10 * t3));
              if (ndx * ndx + ndy * ndy > d2) return;
              d = Math.sqrt(d2);
              if (d === 0) return;
              dx /= d;
              dy /= d;
        ...
        Ball: {
          ...
          tick$1: function (delta) {
            ...
            this.vy = t2;
            t3 = this.x;
            if (typeof t3 !== "number") return t3.$add();
            t1 = t3 + t1 * delta;
            this.x = t1;
            t3 = this.y;
            if (typeof t3 !== "number") return t3.$add();
            ...
            if (!(t1 < 14)) {
              ...
              if (typeof t4 !== "number") return H.iae(t4);
              t4 = t1 > t4;
            } else t4 = true;
            if (t4) {
              t1 = this.elem;
              t2 = t1.parentNode;
              if (t2 != null) t2.removeChild(t1);
              return true;
            }
          ...
          Ball$4: function (root, x, y, color) {
            var t1;
            if (color >= 7) return H.ioore(C.List_8eb, color);
        ...
        CountDownClock: {
          ...
          updateTime$1: function (now) {
            if (H.Primitives_getHours(now) !== this.displayedHour) {
              this.setDigits$2(
                this.pad2$1(H.Primitives_getHours(now)),
                this.hours
              );
            ...
            if (H.Primitives_getMinutes(now) !== this.displayedMinute) {
              this.setDigits$2(
                this.pad2$1(H.Primitives_getMinutes(now)),
                this.minutes
              );
            ...
            if (H.Primitives_getSeconds(now) !== this.displayedSecond) {
              this.setDigits$2(
                this.pad2$1(H.Primitives_getSeconds(now)),
                this.seconds
              );
          ...
          setDigits$2: function (digits, numbers) {
            ...
            for (t1 = digits.length, i = 0; i < 2; ++i) {
              if (i >= t1) H.throwExpression(P.RangeError$value(i));
              t2 = digits.charCodeAt(i);
              digit = t2 - "0".charCodeAt(0);
              t2 = numbers[i];
              if (digit < 0 || digit >= 10) return H.ioore(C.List_e3I, digit);
          ...
          createNumbers$3: function ($parent, width, height) {
            ...
            if (typeof width !== "number") return width.$sub();
            x = (width - 627) / 2;
            if (typeof height !== "number") return height.$sub();
            y = (height - 133) / 3;
        ...
        ClockNumber: {
              ...
              for (x = 0; x < 4; ++x) {
                ...
                if (t2 != null)
                  if (t2[y][x] !== 0 && px[y][x] === 0)
                    P.scheduleMicrotask(
                      new Q.ClockNumber_setPixels_closure(this, img)
                    );
                if (px[y][x] !== 0) {
                  if (t1 >= 7) return H.ioore(C.List_8eb, t1);
                  t2 = C.List_8eb[t1];
                } else t2 = "images/ball-c9c9c9.png";
                J.set$src$x(img, t2);
              }
            this.pixels = px;
          },
          ClockNumber$3: function (app, pos, ballColor) {
            var t1, y, t2, x;
            this.imgs = H.setRuntimeTypeInfo(Array(7), [
              [J.JSArray, W.ImageElement],
            ]);
        ...
        Colon: {
          ...
          Colon$2: function (xpos, ypos) {
            ...
            dot = W.ImageElement_ImageElement(
              null,
      ...
      H,
      {
        ...
        IterableMixinWorkaround_removeWhereList: function (list, test) {
          ...
          for (t1 = $length, i = 0; i < $length; ++i) {
            if (i >= t1) return H.ioore(list, i);
            element = list[i];
            if (test.call$1(element) !== true) retained.push(element);
            t1 = list.length;
            if ($length !== t1)
        ...
        IterableMixinWorkaround_toStringIterable: function (
          iterable,
          leftDelimiter,
          rightDelimiter
        ) {
          ...
          for (
            i = 0;
            (t1 = $.get$IterableMixinWorkaround__toStringList()), i < t1.length;
            ++i
          )
            if (t1[i] === iterable)
          ...
          try {
            ...
            if (0 >= t1.length) return H.ioore(t1, 0);
            t1.pop();
          }
          return result.get$_contents();
        },
        IterableMixinWorkaround_setRangeList: function (
          list,
          start,
          end,
          from,
        ...
        MappedIterable: {
          ...
          static: {
            MappedIterable_MappedIterable: function (
              iterable,
              $function,
              $S,
              $T
              ...
              return H.setRuntimeTypeInfo(
                new H.EfficientLengthMappedIterable(iterable, $function),
                [$S, $T]
              );
            },
          },
    ...
    [
      ...
      P,
      {
        ...
        _invokeErrorHandler: function (errorHandler, error, stackTrace) {
          ...
          if (t1) return errorHandler.call$2(error, stackTrace);
          else return errorHandler.call$1(error);
        },
        _registerErrorHandler: function (errorHandler, zone) {
          var t1 = H.getDynamicRuntimeType();
          t1 = H.buildFunctionType(t1, [t1, t1])._isTest$1(errorHandler);
          zone.toString;
          if (t1) return errorHandler;
          ...
          function () {
            ...
            for (; (t1 = $.get$_asyncCallbacks()), t1._head !== t1._tail; ) {
              ...
              try {
                ...
                H.unwrapException(exception);
                milliseconds = C.JSInt_methods._tdivFast$1(
                  C.Duration_0._duration,
                  1000
                );
                H.TimerImpl$(
                  milliseconds < 0 ? 0 : milliseconds,
                  P._asyncRunCallback$closure()
                );
                throw exception;
              }
            }
        ...
        scheduleMicrotask: function (callback) {
          ...
          if (C.C__RootZone !== t1) f = t1.bindCallback$1(f);
          $.get$_asyncCallbacks()._add$1(f);
          if (!$._callbacksAreEnqueued) {
            milliseconds = C.JSInt_methods._tdivFast$1(
              C.Duration_0._duration,
        ...
        StreamController_StreamController: function (
          onCancel,
          onListen,
          onPause,
          onResume,
        ...
        _cancelAndError: function (subscription, future, error, stackTrace) {
          ...
          if (
            typeof cancelFuture === "object" &&
            cancelFuture !== null &&
            !!t1.$isFuture
          )
            cancelFuture.whenComplete$1(
              new P._cancelAndError_closure(future, error, stackTrace)
            );
          else future._completeError$2(error, stackTrace);
        },
        ...
        Timer_Timer: function (duration, callback) {
          ...
          return P._rootCreateTimer(
            t1,
            null,
            t1,
            duration,
            t1.bindCallback$2$runGuarded(callback, true)
          );
        },
        ...
        _rootHandleUncaughtError: function (
          $self,
          $parent,
          zone,
          error,
          ...
          P._rootRun(
            ...
            null,
            $self,
            new P._rootHandleUncaughtError_closure(error, stackTrace)
          );
        },
        _rootRun: function ($self, $parent, zone, f) {
          ...
          t1 = $.Zone__current;
          t2 = zone;
          if (t1 == null ? t2 == null : t1 === t2) return f.call$0();
          old = t1;
          try {
            $.Zone__current = zone;
            t1 = f.call$0();
        ...
        _rootRunUnary: function ($self, $parent, zone, f, arg) {
          ...
          t1 = $.Zone__current;
          t2 = zone;
          if (t1 == null ? t2 == null : t1 === t2) return f.call$1(arg);
          old = t1;
          try {
            $.Zone__current = zone;
            t1 = f.call$1(arg);
        ...
        _rootScheduleMicrotask: function ($self, $parent, zone, f) {
          P._scheduleAsyncCallback(
            C.C__RootZone !== zone ? zone.bindCallback$1(f) : f
          );
        },
        _rootCreateTimer: function ($self, $parent, zone, duration, callback) {
          return P._createTimer(
            duration,
            C.C__RootZone !== zone ? zone.bindCallback$1(callback) : callback
          );
        },
        _AsyncError: {
        ...
        _Future: {
          ...
          then$2$onError: function (f, onError) {
            ...
            result = H.setRuntimeTypeInfo(
              new P._Future(
                ...
                f,
                null,
                P._registerErrorHandler(onError, t1),
                null
              ),
              [null]
            );
          ...
          _addListener$1: function (listener) {
            ...
            if (this._state >= 4) {
              ...
              P._rootScheduleMicrotask(
                ...
                null,
                t1,
                new P._Future__addListener_closure(this, listener)
              );
            } else {
          ...
          _asyncComplete$1: function (value) {
            ...
            P._rootScheduleMicrotask(
              ...
              null,
              t1,
              new P._Future__asyncComplete_closure(this, value)
            );
          },
          $is_Future: true,
          $isFuture: true,
          static: {
            ...
            _Future__chainFutures: function (source, target) {
              ...
              if (
                ...
                else source._addListener$1(target);
              else
                source.then$2$onError(
                  new P._Future__chainFutures_closure(target),
                  new P._Future__chainFutures_closure0(target)
                );
            },
              ...
              for (t2 = source; true; ) {
                ...
                if (t2 == null ? t4 != null : t2 !== t4) {
                  ...
                  P._rootRun(
                    ...
                    null,
                    t4,
                    new P._Future__propagateToListeners_closure(t1, listeners)
                  );
                  return;
                }
                ...
                P._rootRun(
                  ...
                  null,
                  t4,
                  new P._Future__propagateToListeners_closure0(
                    t1,
                    t3,
                    hasError,
                    listeners
                ...
                if (t3.isPropagationAborted_3) return;
        ...
        _Future__propagateToListeners_closure: {
          ...
          call$0: function () {
            P._Future__propagateToListeners(
              this.box_2.source_4,
              this.listener_3
            );
          },
            ...
            try {
              ...
              if (!this.hasError_4) {
                ...
                if (t4) {
                  ...
                  t4 = this.box_1;
                  t4.listenerValueOrError_2 = P._invokeErrorHandler(
                    errorCallback,
                    J.get$error$x(asyncError),
                    asyncError.get$stackTrace()
                  );
              ...
              if (
                (t3._state === 2 ? null : t3._whenCompleteActionCallback) !=
                null
              ) {
                ...
                if (
                  ...
                  t1.completeResult_0.then$2$onError(
                    new P._Future__propagateToListeners__closure(t2, t3),
                    new P._Future__propagateToListeners__closure0(t1, t3)
                  );
              ...
              else t2.listenerValueOrError_2 = new P._AsyncError(e, s);
        ...
        Stream: {
          ...
          forEach$1: function (_, action) {
            ...
            t1.subscription_0 = this.listen$4$cancelOnError$onDone$onError(
              new P.Stream_forEach_closure(t1, this, action, future),
              true,
              new P.Stream_forEach_closure0(future),
          ...
          get$length: function (_) {
            ...
            this.listen$4$cancelOnError$onDone$onError(
              new P.Stream_length_closure(t1),
              true,
        ...
        Stream_forEach_closure: {
          ...
          call$1: function (element) {
            P._runUserCode(
              new P.Stream_forEach__closure(this.action_2, element),
              new P.Stream_forEach__closure0(),
              P._cancelAndErrorClosure(this.box_0.subscription_0, this.future_3)
            );
          },
          $signature: function () {
            return H.computeSignature(
              function (T) {
        ...
        _StreamController: {
          ...
          get$_subscription: function () {
            if ((this._state & 8) !== 0) return this._varData.get$varData();
          ...
          add$1: [
            function (_, value) {
              var t1 = this._state;
              if (t1 >= 4) throw H.wrapException(this._badEventState$0());
              if ((t1 & 1) !== 0) this._sendData$1(value);
              else if ((t1 & 3) === 0) {
          ...
          close$0: function (_) {
            var t1, t2;
            t1 = this._state;
            if ((t1 & 4) !== 0) return this._doneFuture;
            if (t1 >= 4) throw H.wrapException(this._badEventState$0());
            t1 |= 4;
            this._state = t1;
            if (this._doneFuture == null) {
              t2 = P._Future$(null);
              this._doneFuture = t2;
              if ((t1 & 2) !== 0) t2._complete$1(null);
            }
            t1 = this._state;
            if ((t1 & 1) !== 0) this._sendDone$0();
            else if ((t1 & 3) === 0) {
              t1 = this._ensurePendingEvents$0();
          ...
          _subscribe$1: function (cancelOnError) {
            ...
            if ((this._state & 3) !== 0)
              throw H.wrapException(
                new P.StateError("Stream has already been listened to.")
              );
            t1 = $.Zone__current;
            t2 = cancelOnError ? 1 : 0;
            subscription = H.setRuntimeTypeInfo(
              new P._ControllerSubscription(
                this,
                null,
                null,
                null,
            ...
            if ((t2 & 8) !== 0) {
              ...
              addState.resume$0();
            } else this._varData = subscription;
            subscription._setPendingEvents$1(pendingEvents);
            subscription._guardCallback$1(
              new P._StreamController__subscribe_closure(this)
            );
            return subscription;
          },
          _recordCancel$1: function (subscription) {
            var t1, future;
            if ((this._state & 8) !== 0) this._varData.cancel$0();
            this._varData = null;
            this._state = (this._state & 4294967286) | 2;
            t1 = new P._StreamController__recordCancel_complete(this);
            future = P._runGuarded(this.get$_onCancel());
            if (future != null) future = future.whenComplete$1(t1);
            else t1.call$0();
            return future;
          },
        },
        ...
        _StreamController__recordCancel_complete: {
          ...
          call$0: function () {
            ...
            if (t1 != null && t1._state === 0) t1._asyncComplete$1(null);
          },
        },
        ...
        _ControllerStream: {
          ...
          get$hashCode: function (_) {
            return (
              (H.Primitives_objectHashCode(this._async$_controller) ^
                892482866) >>>
              0
            );
          },
        ...
        _ControllerSubscription: {
          ...
          _onResume$0: [
            function () {
              ...
              if ((t1._state & 8) !== 0) t1._varData.resume$0();
        ...
        _BufferingStreamSubscription: {
          ...
          resume$0: function () {
            ...
            if (t1 >= 128) {
              ...
              if (t1 < 128) {
                ...
                if (t2) this._pending.schedule$1(this);
                else {
                  t1 = (t1 & 4294967291) >>> 0;
                  this._state = t1;
                  if ((t1 & 32) === 0)
          ...
          cancel$0: function () {
            ...
            this._state = t1;
            if ((t1 & 8) !== 0) return this._cancelFuture;
            this._cancel$0();
          ...
          _cancel$0: function () {
            ...
            this._state = t1;
            if ((t1 & 64) !== 0) this._pending.cancelSchedule$0();
            if ((this._state & 32) === 0) this._pending = null;
            this._cancelFuture = this._onCancel$0();
          },
          _async$_add$1: function (data) {
            var t1 = this._state;
            if ((t1 & 8) !== 0) return;
            if (t1 < 32) this._sendData$1(data);
            else this._addPending$1(new P._DelayedData(data, null));
          },
          _close$0: function () {
            var t1 = this._state;
            if ((t1 & 8) !== 0) return;
            t1 = (t1 | 2) >>> 0;
            this._state = t1;
            if (t1 < 32) this._sendDone$0();
            else this._addPending$1(C.C__DelayedDone);
          },
          _onPause$0: [function () {}, "call$0", "get$_onPause", 0, 0, 0],
          _onResume$0: [function () {}, "call$0", "get$_onResume", 0, 0, 0],
          _onCancel$0: function () {},
          _addPending$1: function ($event) {
            ...
            if ((t1 & 64) === 0) {
              t1 = (t1 | 64) >>> 0;
              this._state = t1;
              if (t1 < 128) this._pending.schedule$1(this);
            }
          },
          _sendData$1: function (data) {
            var t1 = this._state;
          ...
          _checkState$1: function (wasInputPaused) {
            ...
            for (; true; wasInputPaused = isInputPaused) {
              ...
              this._state = (t1 ^ 32) >>> 0;
              if (isInputPaused) this._onPause$0();
              else this._onResume$0();
              t1 = (this._state & 4294967263) >>> 0;
              this._state = t1;
            }
            if ((t1 & 64) !== 0 && t1 < 128) this._pending.schedule$1(this);
          },
          static: {
        ...
        _StreamImpl: {
          ...
          listen$4$cancelOnError$onDone$onError: function (
            ...
            var subscription = this._createSubscription$1(
              true === cancelOnError
            );
          ...
          _createSubscription$1: function (cancelOnError) {
            ...
            t1 = $.Zone__current;
            t2 = cancelOnError ? 1 : 0;
            return new P._BufferingStreamSubscription(
              null,
              null,
              null,
              t1,
        ...
        _PendingEvents: {
          ...
          schedule$1: function (dispatch) {
            ...
            P.scheduleMicrotask(
              new P._PendingEvents_schedule_closure(this, dispatch)
            );
            this._state = 1;
          },
        ...
        _StreamImplEvents: {
          ...
          handleNext$1: function (dispatch) {
            ...
            if (t1 == null) this.lastPendingEvent = null;
        ...
        _cancelAndError_closure: {
          ...
          call$0: function () {
            return this.future_0._completeError$2(
              this.error_1,
              this.stackTrace_2
            );
          },
        ...
        _BaseZone: {
          ...
          bindCallback$2$runGuarded: function (f, runGuarded) {
            ...
            else return new P._BaseZone_bindCallback_closure0(this, registered);
          },
          ...
          bindUnaryCallback$2$runGuarded: function (f, runGuarded) {
            ...
            if (runGuarded)
              return new P._BaseZone_bindUnaryCallback_closure(
                this,
                registered
              );
            else
              return new P._BaseZone_bindUnaryCallback_closure0(
                this,
                registered
              );
          },
        ...
        _rootHandleUncaughtError_closure: {
          ...
          call$0: function () {
            P._scheduleAsyncCallback(
              new P._rootHandleUncaughtError__closure(
                this.error_0,
                this.stackTrace_1
              )
            );
        ...
        _rootHandleUncaughtError__closure: {
          ...
          call$0: function () {
            ...
            if (t2) trace = t1.get$stackTrace();
            if (trace != null) P.print("Stack Trace: \n" + H.S(trace) + "\n");
        ...
        _RootZone: {
          ...
          handleUncaughtError$2: function (error, stackTrace) {
            return P._rootHandleUncaughtError(
              this,
              null,
              this,
              error,
    ...
    [
      ...
      P,
      {
        ...
        HashMap_HashMap: function (equals, hashCode, isValidKey, $K, $V) {
          return H.setRuntimeTypeInfo(
            new P._HashMap(0, null, null, null, null),
            [$K, $V]
          );
        },
        HashSet_HashSet$identity: function ($E) {
          return H.setRuntimeTypeInfo(
            new P._IdentityHashSet(0, null, null, null, null),
            [$E]
          );
        },
        _iterableToString: function (iterable) {
          ...
          if (t1.contains$1(t1, iterable)) return "(...)";
          t1 = $.get$_toStringVisiting();
        ...
        _iterablePartsToStrings: function (iterable, parts) {
          ...
          if (!it.moveNext$0()) {
            if (count <= 5) return;
            if (0 >= parts.length) return H.ioore(parts, 0);
        ...
        LinkedHashMap_LinkedHashMap: function (
          ...
          return H.setRuntimeTypeInfo(
            new P._LinkedHashMap(0, null, null, null, null, null, 0),
            [$K, $V]
          );
        },
        LinkedHashSet_LinkedHashSet: function (
          equals,
          hashCode,
          isValidKey,
          $E
          ...
          return H.setRuntimeTypeInfo(
            new P._LinkedHashSet(0, null, null, null, null, null, 0),
            [$E]
          );
        },
        ...
        _HashMap: {
          ...
          get$keys: function () {
            return H.setRuntimeTypeInfo(new P.HashMapKeyIterable(this), [
              H.getTypeArgumentByIndex(this, 0),
            ]);
          },
          get$values: function (_) {
            return H.MappedIterable_MappedIterable(
              H.setRuntimeTypeInfo(new P.HashMapKeyIterable(this), [
                H.getTypeArgumentByIndex(this, 0),
              ]),
              new P._HashMap_values_closure(this),
              H.getTypeArgumentByIndex(this, 0),
              H.getTypeArgumentByIndex(this, 1)
            );
          },
          $index: function (_, key) {
        ...
        _LinkedHashMap: {
          ...
          get$keys: function () {
            return H.setRuntimeTypeInfo(new P.LinkedHashMapKeyIterable(this), [
              H.getTypeArgumentByIndex(this, 0),
            ]);
          },
          get$values: function (_) {
            return H.MappedIterable_MappedIterable(
              H.setRuntimeTypeInfo(new P.LinkedHashMapKeyIterable(this), [
                H.getTypeArgumentByIndex(this, 0),
              ]),
              new P._LinkedHashMap_values_closure(this),
              H.getTypeArgumentByIndex(this, 0),
              H.getTypeArgumentByIndex(this, 1)
            );
          },
            ...
            if ((key & 0x3ffffff) === key) {
              ...
              return (
                this._findBucketIndex$2(
                  rest[this._computeHashCode$1(key)],
                  key
                ) >= 0
              );
            }
          ...
          $indexSet: function (_, key, value) {
            ...
            if (typeof key === "string" && key !== "__proto__") {
              ...
              if (bucket == null)
                ...
                index = this._findBucketIndex$2(bucket, key);
                if (index >= 0) bucket[index].set$_value(value);
                else bucket.push(this._newLinkedCell$2(key, value));
              }
            }
          },
          ...
          _addHashTableEntry$3: function (table, key, value) {
            var cell = table[key];
            if (cell == null) table[key] = this._newLinkedCell$2(key, value);
            else cell.set$_value(value);
          },
          ...
          _unlinkCell$1: function (cell) {
            ...
            next = cell.get$_next();
            if (previous == null) this._first = next;
            else previous.set$_next(next);
            if (next == null) this._last = previous;
            else next.set$_previous(previous);
            this._collection$_length = this._collection$_length - 1;
            this._modifications = (this._modifications + 1) & 67108863;
          },
          _computeHashCode$1: function (key) {
          ...
          _findBucketIndex$2: function (bucket, key) {
            ...
            $length = bucket.length;
            for (i = 0; i < $length; ++i)
              if (J.$eq(bucket[i].get$_key(), key)) return i;
            return -1;
          },
          toString$0: function (_) {
        ...
        LinkedHashMapKeyIterable: {
          ...
          get$iterator: function (_) {
            var t1, t2;
            t1 = this._map;
            t2 = new P.LinkedHashMapKeyIterator(
              t1,
              t1._modifications,
              null,
              null
        ...
        _HashSet: {
          "": "_HashSetBase;",
          get$iterator: function (_) {
            return new P.HashSetIterator(
              this,
              this._computeElements$0(),
              0,
              null
            );
          },
          ...
          lookup$1: function (object) {
            ...
            if (!(typeof object === "string" && object !== "__proto__"))
              t1 =
                typeof object === "number" && (object & 0x3ffffff) === object;
            else t1 = true;
            if (t1) return this.contains$1(this, object) ? object : null;
            rest = this._rest;
            if (rest == null) return;
          ...
          add$1: function (_, element) {
            ...
            bucket = rest[hash];
            if (bucket == null) rest[hash] = [element];
            else {
              if (this._findBucketIndex$2(bucket, element) >= 0) return false;
              bucket.push(element);
            }
            this._collection$_length = this._collection$_length + 1;
            this._elements = null;
          ...
          _findBucketIndex$2: function (bucket, element) {
            ...
            $length = bucket.length;
            for (i = 0; i < $length; ++i)
              if (J.$eq(bucket[i], element)) return i;
            return -1;
          },
          $as_HashSetBase: null,
        },
        ...
        _LinkedHashSet: {
          ...
          get$iterator: function (_) {
            var t1 = new P.LinkedHashSetIterator(
              this,
              this._modifications,
              null,
              null
          ...
          add$1: function (_, element) {
            ...
            if ((element & 0x3ffffff) === element) {
              ...
              hash = this._computeHashCode$1(element);
              bucket = rest[hash];
              if (bucket == null) rest[hash] = [this._newLinkedCell$1(element)];
              else {
                if (this._findBucketIndex$2(bucket, element) >= 0) return false;
          ...
          _findBucketIndex$2: function (bucket, element) {
            ...
            $length = bucket.length;
            for (i = 0; i < $length; ++i)
              if (bucket[i].get$_element() === element) return i;
            return -1;
          },
          $as_HashSetBase: null,
          static: {
        ...
        IterableBase: {
          ...
          elementAt$1: function (_, index) {
            ...
            if (index < 0) throw H.wrapException(P.RangeError$value(index));
            for (
              t1 = this.get$iterator(this), remaining = index;
              t1.moveNext$0();
        ...
        ListMixin: {
          ...
          toString$0: function (receiver) {
            var result, t1;
            t1 = $.get$_toStringVisiting();
            if (t1.contains$1(t1, receiver)) return "[...]";
            result = P.StringBuffer$("");
            try {
              t1 = $.get$_toStringVisiting();
        ...
        Maps_mapToString_closure: {
          ...
          call$2: function (k, v) {
            var t1 = this.box_0;
            if (!t1.first_0) this.result_1.write$1(", ");
            t1.first_0 = false;
            t1 = this.result_1;
            t1.write$1(k);
            t1.write$1(": ");
        ...
        ListQueue: {
          ...
          forEach$1: function (_, action) {
            ...
            for (
              ...
              t1 = this._table;
              if (i < 0 || i >= t1.length) return H.ioore(t1, i);
              action.call$1(t1[i]);
          ...
          _add$1: function (element) {
            ...
            if (this._head === t2) {
              t1 = Array(t3 * 2);
              t1.fixed$length = init;
              newTable = H.setRuntimeTypeInfo(t1, [
                H.getTypeArgumentByIndex(this, 0),
              ]);
              t1 = this._table;
              t2 = this._head;
              split = t1.length - t2;
              H.IterableMixinWorkaround_setRangeList(
                newTable,
                0,
                split,
                t1,
    ...
    [
      ...
      P,
      {
            ...
            for (t1 = object.length, i = 0, t2 = '"'; i < t1; ++i) {
              ...
              if (codeUnit <= 31)
                if (codeUnit === 10) {
                  ...
                  buffer._contents = t2;
                  if (codeUnit < 16) buffer._contents = t2 + "0";
                  else {
        ...
        List_List$filled: function ($length, fill, $E) {
          ...
          if ($length !== 0 && true)
            for (t1 = result.length, i = 0; i < t1; ++i) result[i] = fill;
          return result;
        },
        List_List$from: function (other, growable, $E) {
          ...
          for (
            t1 = list.length, t2 = fixedList.length, i = 0;
            i < $length;
            ++i
          ) {
            if (i >= t1) return H.ioore(list, i);
            t3 = list[i];
            if (i >= t2) return H.ioore(fixedList, i);
            fixedList[i] = t3;
          }
          return fixedList;
        },
        ...
        DateTime: {
          ...
          toString$0: function (_) {
            ...
            t2 = this.isUtc;
            t3 = t2
              ? H.Primitives_lazyAsJsDate(this).getUTCFullYear() + 0
              : H.Primitives_lazyAsJsDate(this).getFullYear() + 0;
            y = new P.DateTime_toString_fourDigits().call$1(t3);
            m = t1.call$1(
              t2
                ? H.Primitives_lazyAsJsDate(this).getUTCMonth() + 1
                : H.Primitives_lazyAsJsDate(this).getMonth() + 1
            );
            d = t1.call$1(
              t2
                ? H.Primitives_lazyAsJsDate(this).getUTCDate() + 0
                : H.Primitives_lazyAsJsDate(this).getDate() + 0
            );
            ...
            t1 = t2
              ? H.Primitives_lazyAsJsDate(this).getUTCMilliseconds() + 0
              : H.Primitives_lazyAsJsDate(this).getMilliseconds() + 0;
        ...
        DateTime_toString_fourDigits: {
          ...
          call$1: function (n) {
            ...
            if (absN >= 100) return sign + "0" + H.S(absN);
            if (absN >= 10) return sign + "00" + H.S(absN);
        ...
        Duration: {
          ...
          $add: function (_, other) {
            return P.Duration$(
              0,
              0,
              C.JSInt_methods.$add(this._duration, other.get$_duration()),
              0,
              0,
              0
            );
          ...
          $sub: function (_, other) {
            return P.Duration$(
              0,
              0,
              this._duration - other.get$_duration(),
              0,
              0,
              0
            );
          ...
          toString$0: function (_) {
            ...
            t2 = this._duration;
            if (t2 < 0) return "-" + H.S(P.Duration$(0, 0, -t2, 0, 0, 0));
            twoDigitMinutes = t1.call$1(
              C.JSInt_methods.remainder$1(
                C.JSInt_methods._tdivFast$1(t2, 60000000),
                60
              )
            );
            twoDigitSeconds = t1.call$1(
              C.JSInt_methods.remainder$1(
                C.JSInt_methods._tdivFast$1(t2, 1000000),
                60
              )
            );
            sixDigitUs = new P.Duration_toString_sixDigits().call$1(
              C.JSInt_methods.remainder$1(t2, 1000000)
            );
            return (
              "" +
        ...
        ArgumentError: {
          ...
          toString$0: function (_) {
            var t1 = this.message;
            if (t1 != null) return "Illegal argument(s): " + H.S(t1);
        ...
        Expando: {
          ...
          $index: function (_, object) {
            ...
            return values == null
              ? null
              : H.Primitives_getProperty(values, this._getKey$0());
          },
    ...
    [
      ...
      W,
      {
        ...
        _wrapZone: function (callback) {
          var t1 = $.Zone__current;
          if (t1 === C.C__RootZone) return callback;
        ...
        Node: {
          ...
          toString$0: function (receiver) {
            ...
            return t1 == null
              ? J.Interceptor.prototype.toString$0.call(this, receiver)
              : t1;
          },
        ...
        NodeList: {
          ...
          $indexSet: function (receiver, index, value) {
            throw H.wrapException(
              P.UnsupportedError$("Cannot assign element of immutable List.")
            );
          },
          elementAt$1: function (receiver, index) {
            if (index < 0 || index >= receiver.length)
        ...
        Window: {
          ...
          _requestAnimationFrame$1: function (receiver, callback) {
            return receiver.requestAnimationFrame(
              H.convertDartClosureToJS(callback, 1)
            );
          },
          _ensureRequestAnimationFrame$0: function (receiver) {
            if (
              !!(
                receiver.requestAnimationFrame && receiver.cancelAnimationFrame
              )
            )
              return;
            (function ($this) {
              ...
              for (
                var i = 0;
                i < vendors.length && !$this.requestAnimationFrame;
                ++i
              ) {
                $this.requestAnimationFrame =
                  $this[vendors[i] + "RequestAnimationFrame"];
          ...
          get$hashCode: function (receiver) {
            ...
            t4 = W._JenkinsSmiHash_combine(
              W._JenkinsSmiHash_combine(
                W._JenkinsSmiHash_combine(W._JenkinsSmiHash_combine(0, t1), t2),
                t3
              ),
              t4
            );
        ...
        ImmutableListMixin: {
          "": "Object;",
          get$iterator: function (receiver) {
            return new W.FixedSizeListIterator(
              receiver,
              this.get$length(receiver),
              -1,
              null
    ...
    [
      ...
      P,
      {
        ...
        min: function (a, b) {
          ...
          if (a === 0) t1 = b === 0 ? 1 / b < 0 : b < 0;
          else t1 = false;
          if (t1 || isNaN(b)) return b;
          return a;
        },
        _JSRandom: {
          "": "Object;",
      ...
      P,
      {
        ...
        TypedData: {
          ...
          _invalidIndex$2: function (receiver, index, $length) {
            ...
            if (t1.$lt(index, 0) || t1.$ge(index, $length))
              ...
              throw H.wrapException(
                P.ArgumentError$("Invalid list index " + H.S(index))
              );
          },
        ...
        Uint8List: {
          ...
          $index: function (receiver, index) {
            ...
            t1 = receiver.length;
            if (!(index >>> 0 != index)) {
              if (typeof index !== "number") return index.$ge();
              t2 = index >= t1;
            } else t2 = true;
            if (t2) this._invalidIndex$2(receiver, index, t1);
            return receiver[index];
          },
          $indexSet: function (receiver, index, value) {
            var t1 = receiver.length;
  ...
  C.List_8eb = Isolate.makeConstantList([
  ...
  C.List_Xdq = Isolate.makeConstantList([
    C.List_1_1_1_1,
    C.List_1_0_0_1,
    C.List_1_0_0_1,
    C.List_1_0_0_1,
  ...
  C.List_Xdq0 = Isolate.makeConstantList([
    C.List_0_0_0_1,
    C.List_0_0_0_1,
    C.List_0_0_0_1,
    C.List_0_0_0_1,
  ...
  C.List_Xdq1 = Isolate.makeConstantList([
    C.List_1_1_1_1,
    C.List_0_0_0_1,
    C.List_0_0_0_1,
    C.List_1_1_1_1,
  ...
  C.List_Xdq2 = Isolate.makeConstantList([
    C.List_1_1_1_1,
    C.List_0_0_0_1,
    C.List_0_0_0_1,
    C.List_1_1_1_1,
  ...
  C.List_Xdq3 = Isolate.makeConstantList([
    C.List_1_0_0_1,
    C.List_1_0_0_1,
    C.List_1_0_0_1,
    C.List_1_1_1_1,
  ...
  C.List_Xdq4 = Isolate.makeConstantList([
    C.List_1_1_1_1,
    C.List_1_0_0_0,
    C.List_1_0_0_0,
    C.List_1_1_1_1,
  ...
  C.List_Xdq5 = Isolate.makeConstantList([
    C.List_1_1_1_1,
    C.List_1_0_0_0,
    C.List_1_0_0_0,
    C.List_1_1_1_1,
  ...
  C.List_Xdq6 = Isolate.makeConstantList([
    C.List_1_1_1_1,
    C.List_0_0_0_1,
    C.List_0_0_0_1,
    C.List_0_0_0_1,
  ...
  C.List_Xdq7 = Isolate.makeConstantList([
    C.List_1_1_1_1,
    C.List_1_0_0_1,
    C.List_1_0_0_1,
    C.List_1_1_1_1,
  ...
  C.List_Xdq8 = Isolate.makeConstantList([
    C.List_1_1_1_1,
    C.List_1_0_0_1,
    C.List_1_0_0_1,
    C.List_1_1_1_1,
  ...
  C.List_e3I = Isolate.makeConstantList([
    C.List_Xdq,
    C.List_Xdq0,
    C.List_Xdq1,
    C.List_Xdq2,
  ...
  Isolate.$lazy(
    $,
    "workerIds",
    "IsolateNatives_workerIds",
    "get$IsolateNatives_workerIds",
    function () {
  ...
  Isolate.$lazy(
    $,
    "_toStringList",
    "IterableMixinWorkaround__toStringList",
    "get$IterableMixinWorkaround__toStringList",
    function () {
      return [];
    }
  );
  ...
  init.metadata = [
    ...
    {
      func: "void__dynamic__StackTrace",
      void: true,
      args: [null],
      opt: [P.StackTrace],
    },
  ...
  !(function () {
    ...
    for (var i = 0; ; i++) {
      ...
      if (i > 0) property = rootProperty + "_" + i;
      ...
      prototype[getterName] = function () {
        ...
        try {
          if (result === sentinelUndefined) {
            ...
            if (result === sentinelInProgress) H.throwCyclicInit(staticName);
          }
          return result;
        } finally {
          $[getterName] = function () {
...
function dart_precompiled($collectedClasses) {
  ...
  if (!"name" in BRElement) BRElement.name = "BRElement";
  $desc = $collectedClasses.BRElement;
  if ($desc instanceof Array) $desc = $desc[1];
  BRElement.prototype = $desc;
  function BaseElement() {}
  BaseElement.builtin$cls = "BaseElement";
  if (!"name" in BaseElement) BaseElement.name = "BaseElement";
  ...
  if (!"name" in BeforeLoadEvent) BeforeLoadEvent.name = "BeforeLoadEvent";
  ...
  if (!"name" in DataListElement) DataListElement.name = "DataListElement";
  $desc = $collectedClasses.DataListElement;
  if ($desc instanceof Array) $desc = $desc[1];
  DataListElement.prototype = $desc;
  function DetailsElement() {}
  DetailsElement.builtin$cls = "DetailsElement";
  if (!"name" in DetailsElement) DetailsElement.name = "DetailsElement";
  ...
  if (!"name" in ErrorEvent) ErrorEvent.name = "ErrorEvent";
  ...
  if (!"name" in ImageElement) ImageElement.name = "ImageElement";
  ...
  if (!"name" in InputElement) InputElement.name = "InputElement";
  ...
  if (!"name" in KeyboardEvent) KeyboardEvent.name = "KeyboardEvent";
  ...
  if (!"name" in MediaKeyEvent) MediaKeyEvent.name = "MediaKeyEvent";
  ...
  if (!"name" in MediaStream) MediaStream.name = "MediaStream";
  ...
  if (!"name" in MediaStreamEvent) MediaStreamEvent.name = "MediaStreamEvent";
  ...
  if (!"name" in OverflowEvent) OverflowEvent.name = "OverflowEvent";
  ...
  if (!"name" in ParagraphElement) ParagraphElement.name = "ParagraphElement";
  ...
  if (!"name" in ScriptElement) ScriptElement.name = "ScriptElement";
  ...
  if (!"name" in SelectElement) SelectElement.name = "SelectElement";
  ...
  if (!"name" in SpanElement) SpanElement.name = "SpanElement";
  ...
  if (!"name" in SpeechInputEvent) SpeechInputEvent.name = "SpeechInputEvent";
  ...
  if (!"name" in StorageEvent) StorageEvent.name = "StorageEvent";
  $desc = $collectedClasses.StorageEvent;
  if ($desc instanceof Array) $desc = $desc[1];
  StorageEvent.prototype = $desc;
  function StyleElement() {}
  StyleElement.builtin$cls = "StyleElement";
  if (!"name" in StyleElement) StyleElement.name = "StyleElement";
  ...
  if (!"name" in TableCellElement) TableCellElement.name = "TableCellElement";
  ...
  if (!"name" in TableColElement) TableColElement.name = "TableColElement";
  $desc = $collectedClasses.TableColElement;
  if ($desc instanceof Array) $desc = $desc[1];
  TableColElement.prototype = $desc;
  function TableElement() {}
  TableElement.builtin$cls = "TableElement";
  if (!"name" in TableElement) TableElement.name = "TableElement";
  ...
  if (!"name" in TableRowElement) TableRowElement.name = "TableRowElement";
  ...
  if (!"name" in _Entity) _Entity.name = "_Entity";
  ...
  if (!"name" in _HTMLFontElement) _HTMLFontElement.name = "_HTMLFontElement";
  ...
  if (!"name" in _MutationEvent) _MutationEvent.name = "_MutationEvent";
  $desc = $collectedClasses._MutationEvent;
  if ($desc instanceof Array) $desc = $desc[1];
  _MutationEvent.prototype = $desc;
  function _Notation() {}
  _Notation.builtin$cls = "_Notation";
  if (!"name" in _Notation) _Notation.name = "_Notation";
  ...
  if (!"name" in AnimatedLength) AnimatedLength.name = "AnimatedLength";
  ...
  if (!"name" in AnimatedNumber) AnimatedNumber.name = "AnimatedNumber";
  ...
  if (!"name" in FEBlendElement) FEBlendElement.name = "FEBlendElement";
  ...
  if (!"name" in FEFloodElement) FEFloodElement.name = "FEFloodElement";
  ...
  if (!"name" in FEFuncAElement) FEFuncAElement.name = "FEFuncAElement";
  ...
  if (!"name" in FEFuncBElement) FEFuncBElement.name = "FEFuncBElement";
  ...
  if (!"name" in FEFuncGElement) FEFuncGElement.name = "FEFuncGElement";
  ...
  if (!"name" in FEFuncRElement) FEFuncRElement.name = "FEFuncRElement";
  ...
  if (!"name" in FEImageElement) FEImageElement.name = "FEImageElement";
  ...
  if (!"name" in FEMergeElement) FEMergeElement.name = "FEMergeElement";
  ...
  if (!"name" in FEOffsetElement) FEOffsetElement.name = "FEOffsetElement";
  ...
  if (!"name" in FETileElement) FETileElement.name = "FETileElement";
  ...
  if (!"name" in FilterElement) FilterElement.name = "FilterElement";
  ...
  if (!"name" in ImageElement0) ImageElement0.name = "ImageElement0";
  ...
  if (!"name" in LineElement) LineElement.name = "LineElement";
  ...
  if (!"name" in MarkerElement) MarkerElement.name = "MarkerElement";
  $desc = $collectedClasses.MarkerElement;
  if ($desc instanceof Array) $desc = $desc[1];
  MarkerElement.prototype = $desc;
  function MaskElement() {}
  MaskElement.builtin$cls = "MaskElement";
  if (!"name" in MaskElement) MaskElement.name = "MaskElement";
  ...
  if (!"name" in PolygonElement) PolygonElement.name = "PolygonElement";
  ...
  if (!"name" in PolylineElement) PolylineElement.name = "PolylineElement";
  ...
  if (!"name" in RectElement) RectElement.name = "RectElement";
  ...
  if (!"name" in SwitchElement) SwitchElement.name = "SwitchElement";
  $desc = $collectedClasses.SwitchElement;
  if ($desc instanceof Array) $desc = $desc[1];
  SwitchElement.prototype = $desc;
  function SymbolElement() {}
  SymbolElement.builtin$cls = "SymbolElement";
  if (!"name" in SymbolElement) SymbolElement.name = "SymbolElement";
  ...
  if (!"name" in TSpanElement) TSpanElement.name = "TSpanElement";
  ...
  if (!"name" in TextElement) TextElement.name = "TextElement";
  ...
  if (!"name" in TextPathElement) TextPathElement.name = "TextPathElement";
  ...
  if (!"name" in TitleElement0) TitleElement0.name = "TitleElement0";
  $desc = $collectedClasses.TitleElement0;
  if ($desc instanceof Array) $desc = $desc[1];
  TitleElement0.prototype = $desc;
  function UseElement() {}
  UseElement.builtin$cls = "UseElement";
  if (!"name" in UseElement) UseElement.name = "UseElement";
  ...
  if (!"name" in ViewElement) ViewElement.name = "ViewElement";
  $desc = $collectedClasses.ViewElement;
  if ($desc instanceof Array) $desc = $desc[1];
  ViewElement.prototype = $desc;
  function ZoomEvent() {}
  ZoomEvent.builtin$cls = "ZoomEvent";
  if (!"name" in ZoomEvent) ZoomEvent.name = "ZoomEvent";
  ...
  if (!"name" in _GradientElement) _GradientElement.name = "_GradientElement";
  ...
  _SVGComponentTransferFunctionElement.builtin$cls =
    "_SVGComponentTransferFunctionElement";
  if (!"name" in _SVGComponentTransferFunctionElement)
    _SVGComponentTransferFunctionElement.name =
      "_SVGComponentTransferFunctionElement";
  ...
  if (!"name" in _SVGFontElement) _SVGFontElement.name = "_SVGFontElement";
  ...
  if (!"name" in _SVGGlyphElement) _SVGGlyphElement.name = "_SVGGlyphElement";
  ...
  if (!"name" in _SVGHKernElement) _SVGHKernElement.name = "_SVGHKernElement";
  ...
  if (!"name" in _SVGMPathElement) _SVGMPathElement.name = "_SVGMPathElement";
  ...
  if (!"name" in _SVGVKernElement) _SVGVKernElement.name = "_SVGVKernElement";
  ...
  if (!"name" in _Manager) _Manager.name = "_Manager";
  ...
  if (!"name" in _IsolateContext) _IsolateContext.name = "_IsolateContext";
  ...
  if (!"name" in _EventLoop) _EventLoop.name = "_EventLoop";
  ...
  if (!"name" in _IsolateEvent) _IsolateEvent.name = "_IsolateEvent";
  ...
  if (!"name" in _MainManagerStub) _MainManagerStub.name = "_MainManagerStub";
  $desc = $collectedClasses._MainManagerStub;
  if ($desc instanceof Array) $desc = $desc[1];
  _MainManagerStub.prototype = $desc;
  function IsolateNatives__processWorkerMessage_closure(
    entryPoint_0,
    args_1,
    message_2,
    isSpawnUri_3,
  ...
  IsolateNatives__processWorkerMessage_closure.builtin$cls =
    "IsolateNatives__processWorkerMessage_closure";
  if (!"name" in IsolateNatives__processWorkerMessage_closure)
    IsolateNatives__processWorkerMessage_closure.name =
      "IsolateNatives__processWorkerMessage_closure";
  ...
  if (!"name" in _BaseSendPort) _BaseSendPort.name = "_BaseSendPort";
  ...
  if (!"name" in _WorkerSendPort) _WorkerSendPort.name = "_WorkerSendPort";
  ...
  if (!"name" in ReceivePortImpl) ReceivePortImpl.name = "ReceivePortImpl";
  ...
  if (!"name" in _JsSerializer) _JsSerializer.name = "_JsSerializer";
  ...
  if (!"name" in _JsCopier) _JsCopier.name = "_JsCopier";
  ...
  if (!"name" in _JsDeserializer) _JsDeserializer.name = "_JsDeserializer";
  ...
  if (!"name" in _JsVisitedMap) _JsVisitedMap.name = "_JsVisitedMap";
  ...
  if (!"name" in _Copier) _Copier.name = "_Copier";
  ...
  if (!"name" in TimerImpl) TimerImpl.name = "TimerImpl";
  ...
  if (!"name" in ReflectionInfo) ReflectionInfo.name = "ReflectionInfo";
  $desc = $collectedClasses.ReflectionInfo;
  if ($desc instanceof Array) $desc = $desc[1];
  ReflectionInfo.prototype = $desc;
  function TypeErrorDecoder(
    _pattern,
    _arguments,
    _argumentsExpr,
    _expr,
  ...
  if (!"name" in TypeErrorDecoder) TypeErrorDecoder.name = "TypeErrorDecoder";
  ...
  if (!"name" in NullError) NullError.name = "NullError";
  ...
  if (!"name" in _StackTrace) _StackTrace.name = "_StackTrace";
  ...
  function invokeClosure_closure3(
    closure_10,
    arg1_11,
    arg2_12,
    arg3_13,
  ...
  if (!"name" in BoundClosure) BoundClosure.name = "BoundClosure";
  ...
  if (!"name" in RuntimeError) RuntimeError.name = "RuntimeError";
  $desc = $collectedClasses.RuntimeError;
  if ($desc instanceof Array) $desc = $desc[1];
  RuntimeError.prototype = $desc;
  function RuntimeType() {}
  RuntimeType.builtin$cls = "RuntimeType";
  if (!"name" in RuntimeType) RuntimeType.name = "RuntimeType";
  ...
  if (!"name" in TypeImpl) TypeImpl.name = "TypeImpl";
  ...
  if (!"name" in Balls) Balls.name = "Balls";
  ...
  if (!"name" in Ball) Ball.name = "Ball";
  ...
  if (!"name" in CountDownClock) CountDownClock.name = "CountDownClock";
  ...
  if (!"name" in ClockNumber) ClockNumber.name = "ClockNumber";
  ...
  if (!"name" in Colon) Colon.name = "Colon";
  ...
  if (!"name" in ListIterator) ListIterator.name = "ListIterator";
  ...
  if (!"name" in MappedIterable) MappedIterable.name = "MappedIterable";
  ...
  if (!"name" in MappedIterator) MappedIterator.name = "MappedIterator";
  ...
  if (!"name" in _AsyncError) _AsyncError.name = "_AsyncError";
  ...
  if (!"name" in Future) Future.name = "Future";
  ...
  if (!"name" in _Future) _Future.name = "_Future";
  ...
  _Future__propagateToListeners_closure0.builtin$cls =
    "_Future__propagateToListeners_closure0";
  if (!"name" in _Future__propagateToListeners_closure0)
    _Future__propagateToListeners_closure0.name =
      "_Future__propagateToListeners_closure0";
  ...
  _Future__propagateToListeners__closure.builtin$cls =
    "_Future__propagateToListeners__closure";
  if (!"name" in _Future__propagateToListeners__closure)
    _Future__propagateToListeners__closure.name =
      "_Future__propagateToListeners__closure";
  ...
  _Future__propagateToListeners__closure0.builtin$cls =
    "_Future__propagateToListeners__closure0";
  if (!"name" in _Future__propagateToListeners__closure0)
    _Future__propagateToListeners__closure0.name =
      "_Future__propagateToListeners__closure0";
  ...
  if (!"name" in Stream) Stream.name = "Stream";
  ...
  _StreamController__subscribe_closure.builtin$cls =
    "_StreamController__subscribe_closure";
  if (!"name" in _StreamController__subscribe_closure)
    _StreamController__subscribe_closure.name =
      "_StreamController__subscribe_closure";
  ...
  _StreamController__recordCancel_complete.builtin$cls =
    "_StreamController__recordCancel_complete";
  if (!"name" in _StreamController__recordCancel_complete)
    _StreamController__recordCancel_complete.name =
      "_StreamController__recordCancel_complete";
  ...
  _StreamController__AsyncStreamControllerDispatch.builtin$cls =
    "_StreamController__AsyncStreamControllerDispatch";
  if (!"name" in _StreamController__AsyncStreamControllerDispatch)
    _StreamController__AsyncStreamControllerDispatch.name =
      "_StreamController__AsyncStreamControllerDispatch";
  ...
  _StreamController__SyncStreamControllerDispatch.builtin$cls =
    "_StreamController__SyncStreamControllerDispatch";
  if (!"name" in _StreamController__SyncStreamControllerDispatch)
    _StreamController__SyncStreamControllerDispatch.name =
      "_StreamController__SyncStreamControllerDispatch";
  ...
  if (!"name" in _EventSink) _EventSink.name = "_EventSink";
  ...
  _BufferingStreamSubscription__sendDone_sendDone.builtin$cls =
    "_BufferingStreamSubscription__sendDone_sendDone";
  if (!"name" in _BufferingStreamSubscription__sendDone_sendDone)
    _BufferingStreamSubscription__sendDone_sendDone.name =
      "_BufferingStreamSubscription__sendDone_sendDone";
  ...
  if (!"name" in _StreamImpl) _StreamImpl.name = "_StreamImpl";
  ...
  if (!"name" in _DelayedEvent) _DelayedEvent.name = "_DelayedEvent";
  ...
  if (!"name" in _PendingEvents) _PendingEvents.name = "_PendingEvents";
  ...
  _PendingEvents_schedule_closure.builtin$cls =
    "_PendingEvents_schedule_closure";
  ...
  if (!"name" in _BaseZone) _BaseZone.name = "_BaseZone";
  ...
  _BaseZone_bindCallback_closure0.builtin$cls =
    "_BaseZone_bindCallback_closure0";
  ...
  _BaseZone_bindUnaryCallback_closure.builtin$cls =
    "_BaseZone_bindUnaryCallback_closure";
  if (!"name" in _BaseZone_bindUnaryCallback_closure)
    _BaseZone_bindUnaryCallback_closure.name =
      "_BaseZone_bindUnaryCallback_closure";
  ...
  _BaseZone_bindUnaryCallback_closure0.builtin$cls =
    "_BaseZone_bindUnaryCallback_closure0";
  if (!"name" in _BaseZone_bindUnaryCallback_closure0)
    _BaseZone_bindUnaryCallback_closure0.name =
      "_BaseZone_bindUnaryCallback_closure0";
  ...
  _rootHandleUncaughtError_closure.builtin$cls =
    "_rootHandleUncaughtError_closure";
  ...
  _rootHandleUncaughtError__closure.builtin$cls =
    "_rootHandleUncaughtError__closure";
  if (!"name" in _rootHandleUncaughtError__closure)
    _rootHandleUncaughtError__closure.name =
      "_rootHandleUncaughtError__closure";
  ...
  if (!"name" in _RootZone) _RootZone.name = "_RootZone";
  ...
  if (!"name" in _HashMap) _HashMap.name = "_HashMap";
  ...
  if (!"name" in _LinkedHashMap) _LinkedHashMap.name = "_LinkedHashMap";
  ...
  if (!"name" in _HashSet) _HashSet.name = "_HashSet";
  ...
  if (!"name" in _IdentityHashSet) _IdentityHashSet.name = "_IdentityHashSet";
  ...
  if (!"name" in HashSetIterator) HashSetIterator.name = "HashSetIterator";
  ...
  if (!"name" in _LinkedHashSet) _LinkedHashSet.name = "_LinkedHashSet";
  ...
  if (!"name" in ListQueue) ListQueue.name = "ListQueue";
  ...
  NoSuchMethodError_toString_closure.builtin$cls =
    "NoSuchMethodError_toString_closure";
  if (!"name" in NoSuchMethodError_toString_closure)
    NoSuchMethodError_toString_closure.name =
      "NoSuchMethodError_toString_closure";
  ...
  if (!"name" in DateTime) DateTime.name = "DateTime";
  ...
  if (!"name" in Duration) Duration.name = "Duration";
  ...
  if (!"name" in NullThrownError) NullThrownError.name = "NullThrownError";
  ...
  if (!"name" in ArgumentError) ArgumentError.name = "ArgumentError";
  ...
  if (!"name" in RangeError) RangeError.name = "RangeError";
  ...
  if (!"name" in UnsupportedError) UnsupportedError.name = "UnsupportedError";
  ...
  if (!"name" in StateError) StateError.name = "StateError";
  ...
  if (!"name" in StringBuffer) StringBuffer.name = "StringBuffer";
  ...
  Interceptor_ListMixin_ImmutableListMixin.builtin$cls =
    "Interceptor_ListMixin_ImmutableListMixin";
  if (!"name" in Interceptor_ListMixin_ImmutableListMixin)
    Interceptor_ListMixin_ImmutableListMixin.name =
      "Interceptor_ListMixin_ImmutableListMixin";
  ...
  if (!"name" in _JSRandom) _JSRandom.name = "_JSRandom";
  ...
  _NativeTypedArray_ListMixin_FixedLengthListMixin.builtin$cls =
    "_NativeTypedArray_ListMixin_FixedLengthListMixin";
  if (!"name" in _NativeTypedArray_ListMixin_FixedLengthListMixin)
    _NativeTypedArray_ListMixin_FixedLengthListMixin.name =
      "_NativeTypedArray_ListMixin_FixedLengthListMixin";
