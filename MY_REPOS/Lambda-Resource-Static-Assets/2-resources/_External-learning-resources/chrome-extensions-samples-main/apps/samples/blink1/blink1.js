  ...
  chrome.hid.connect(
    ...
    function (connectionInfo) {
      if (chrome.runtime.lastError) {
        console.warn(
          "Unable to connect device: " + chrome.runtime.lastError.message
        );
        cb(false);
        return;
      }
...
Blink1.prototype.disconnect = function (cb) {
  chrome.hid.disconnect(
    ...
    function () {
      if (chrome.runtime.lastError) {
        console.warn(
          "Unable to disconnect device: " + chrome.runtime.lastError.message
        );
        cb(false);
        return;
      }
...
Blink1.prototype.fadeRgb = function (r, g, b, fade_ms, led) {
  ...
  chrome.hid.sendFeatureReport(this.connection, 1, data.buffer, function () {
    if (chrome.runtime.lastError) {
      console.warn(
        "Unable to send fade command: " + chrome.runtime.lastError.message
      );
    }
  });
};
...
Blink1.prototype.getRgb = function (led, cb) {
  ...
  chrome.hid.sendFeatureReport(
    ...
    function () {
      if (chrome.runtime.lastError) {
        console.warn(
          "Unable to send get command: " + chrome.runtime.lastError.message
        );
      ...
      chrome.hid.receiveFeatureReport(this.connection, 1, function (buffer) {
        if (chrome.runtime.lastError) {
          console.warn(
            "Unable to read get response: " + chrome.runtime.lastError.message
          );
          cb(undefined, undefined, undefined);
          return;
        }
...
Blink1.prototype.getVersion = function (cb) {
  ...
  chrome.hid.sendFeatureReport(
    ...
    function () {
      if (chrome.runtime.lastError) {
        console.warn(
          "Unable to send version command: " + chrome.runtime.lastError.message
        );
        cb(undefined);
        return;
      }
      ...
      chrome.hid.receiveFeatureReport(this.connection, 1, function (buffer) {
        if (chrome.runtime.lastError) {
          console.warn(
            "Unable to read version response: " +
