...
chrome.app.runtime.onLaunched.addListener(function () {
  ...
  chrome.app.window.create(
    "presentation.html?presentme=true",
    {
      frame: "chrome",
      innerBounds: {
        left: left,
        ...
        minWidth: PRESENTATION_WIDTH,
        minHeight: PRESENTATION_HEIGHT,
        maxWidth: PRESENTATION_WIDTH,
        maxHeight: PRESENTATION_HEIGHT,
      },
    },
    function (w) {
...
var windowingApiDemo = {
  ...
  clear: function () {
    ...
    windowingApiDemo.windows.forEach(function (w) {
        ...
        chrome.app.window.create(
          ...
          function (copycatWindow) {
            ...
            windowingApiDemo.updateInterval = setInterval(function () {
              if (
                originalWindow.contentWindow.closed ||
                copycatWindow.contentWindow.closed
              ) {
                windowingApiDemo.clear();
                return;
              }

              copycatWindow.outerBounds.left =
                originalWindow.contentWindow.screenX +
                originalWindow.contentWindow.outerWidth +
                5;
              copycatWindow.outerBounds.top =
                originalWindow.contentWindow.screenY;
              copycatWindow.outerBounds.width =
                originalWindow.contentWindow.outerWidth;
              copycatWindow.outerBounds.height =
