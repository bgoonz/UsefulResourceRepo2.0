...
(function (a) {
  ...
  function D(a, b) {
    return a.isValid()
      ? ((b = E(b, a.lang())), Mb[b] || (Mb[b] = C(b)), Mb[b](a))
      : a.lang().invalidDate();
  }
  function E(a, b) {
    function c(a) {
    ...
    for (d = E(a._f, g).match(rb) || [], b = 0; b < d.length; b++)
      (e = d[b]),
        ...
        c &&
          ...
          (j += c.length)),
        Pb[e]
          ? (c ? (a._pf.empty = !1) : a._pf.unusedTokens.push(e), H(e, c, a))
  ...
  for (
    var bb,
      ...
      Fb = ["YYYY-MM-DD", "GGGG-[W]WW", "GGGG-[W]WW-E", "YYYY-DDD"],
      Gb = [
  ...
  for (
    Pb.DDDD = b(Pb.DDD, 3),
      ...
      bb.lang = function (a, b) {
        var c;
        return a
          ? (b ? y(x(a), b) : null === b ? (z(a), (a = "en")) : mb[a] || A(a),
    ...
    bb.normalizeUnits = function (a) {
      ...
      g((bb.fn = e.prototype), {
        ...
        isDSTShifted: function () {
          return this._a
            ? this.isValid() &&
                m(
                  this._a,
                  (this._isUTC ? bb.utc(this._a) : bb(this._a)).toArray()
                ) > 0
            : !1;
        },
        ...
        add: function (a, b) {
          var c;
          return (
            (c = "string" == typeof a ? bb.duration(+b, a) : bb.duration(a, b)),
            j(this, c, 1),
            this
          );
        },
        ...
        diff: function (a, b, c) {
          var d,
            e,
            f = this._isUTC ? bb(a).zone(this._offset || 0) : bb(a).local(),
                ...
                (e -=
                  (6e4 *
                    (this.zone() -
                      ...
                      (f.zone() - bb(f).startOf("month").zone()))) /
                  d),
                "year" === b && (e /= 12))
              : ((d = this - f),
                (e =
        ...
        dayOfYear: function (a) {
          var b =
            eb((bb(this).startOf("day") - bb(this).startOf("year")) / 864e5) +
            1;
  ...
  _("Weeks", 6048e5),
    ...
    nb
      ? ((module.exports = bb), ab(!0))
      : "function" == typeof define && define.amd
      ? define("moment", function (b, c, d) {
          return (
            d.config().noGlobal !== !0 && ab(d.config().noGlobal === a), bb
          );
        })
      : ab();
}.call(this));
