      ...
      c.split(/\s/).forEach(function (c) {
        ...
        (h.proxy = function (a) {
          ...
          "addEventListener" in b &&
            b.addEventListener(r(h.e), h.proxy, q(h, j));
      });
    }
        ...
        n(a, b, c, d).forEach(function (b) {
          delete h[f][b.i],
            "removeEventListener" in a &&
              a.removeEventListener(r(b.e), b.proxy, q(b, e));
        });
      });
    }
    function y(b, c) {
            ...
            j &&
              ...
              c &&
                (l = function (b) {
                  ...
                  if (g && g !== f)
                    return (
                      (d = a.extend(z(b), { currentTarget: g, liveFired: f })),
    ...
    function serializeData(a) {
      a.processData &&
        ...
        a.data &&
          ...
          ((a.url = appendQuery(a.url, a.data)), (a.data = undefined));
    }
      ...
      $.each(b, function (b, h) {
        (e = $.type(h)),
          d &&
            (b = c
              ? d
              : d + "[" + (g || e == "object" || e == "array" ? b : "") + "]"),
          !d && f
            ? a.add(h.name, h.value)
            : e == "array" || (!c && e == "object")
            ? serialize(a, h, c, b)
            : a.add(b, h);
      });
          ...
          return (
            ...
            $(e).on("load error", function (c, h) {
              clearTimeout(j),
                $(e).off().remove(),
                c.type == "error" || !g
                  ? ajaxError(null, h || "error", i, a, b)
                  : ajaxSuccess(g[0], i, a, b),
                (window[d] = f),
