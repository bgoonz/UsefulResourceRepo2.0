...
function onGetMetadataRequested(options, onSuccess, onError) {
  if (!METADATA[options.entryPath]) onError("NOT_FOUND");
  else onSuccess(METADATA[options.entryPath]);
}
...
function onReadFileRequested(options, onSuccess, onError) {
  ...
  var contents = METADATA[openedFiles[options.openRequestId]].contents;
  ...
  chrome.fileSystemProvider.mount(
    ...
    function () {
      if (chrome.runtime.lastError) {
        ...
        console.error(
          "Failed to mount because of: " + chrome.runtime.lastError.message
        );
        return;
      }
      onSuccess();
  ...
  chrome.fileSystemProvider.unmount(
    ...
    function () {
      if (chrome.runtime.lastError) {
        onError(chrome.runtime.lastError.message);
        console.error(
          "Failed to unmount because of: " + chrome.runtime.lastError.message
        );
        return;
      }
      onSuccess();
