...
handlers["setBackground"] = "document.body.style.backgroundColor='pink';";
...
chrome.runtime.onConnectExternal.addListener(function (port) {
  port.onMessage.addListener((msg) => {
    ...
    port.postMessage({
      code: handlers[msg.request],
      name: "ext_" + msg.request,
    });
  });
});
