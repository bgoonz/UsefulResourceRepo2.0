...
function createWebView(initScripts) {
  ...
  addEventListener("message", function (e) {
    if (e.source != webview.contentWindow) return;
...
function setUpExtensionHandlers() {
  ...
  document
    .getElementById("magnify_button")
    .addEventListener("click", function () {
      port.postMessage({ request: "magnify" });
    });
  document
    .getElementById("background_button")
    .addEventListener("click", function () {
      port.postMessage({ request: "setBackground" });
    });
  document
    .getElementById("add_div_button")
    .addEventListener("click", function () {
      port.postMessage({ request: "addDiv" });
    });
  document
    .getElementById("iframe_dataurl_button")
    .addEventListener("click", function () {
