...
var mockFunctionFactory = function (returnValue, logging) {
  ...
  funky.getCallList = function () {
    return called;
  };
  funky.getValue = function () {
    return returnValue;
  };
  return funky;
};
...
var proxyform = new Test.Unit.Runner(
  {
    setup: function () {
      ...
      this.clickEvent_.initMouseEvent(
        "click",
        true,
        true,
        window,
    ...
    testSingleProxyToggle: function () {
      var group = document.getElementById(ProxyFormController.ProxyTypes.FIXED);
    ...
    testSetupFormSystem: function () {
      ...
      this.wait(100, function () {
        this.assertEqual(6, chrome.proxy.settings.get.getCallList().length);
        this.assert(
          document
            .getElementById(ProxyFormController.ProxyTypes.SYSTEM)
    ...
    testSetupFormDirect: function () {
      ...
      // Wait for async calls to fire
      this.wait(100, function () {
        this.assertEqual(2, chrome.proxy.settings.get.getCallList().length);
        this.assert(
          document
            .getElementById(ProxyFormController.ProxyTypes.DIRECT)
            .classList.contains("active")
        );
      });
    },
    ...
    testSetupFormPac: function () {
      ...
      this.wait(100, function () {
        ...
        this.assert(
          document
            .getElementById(ProxyFormController.ProxyTypes.PAC)
            .classList.contains("active")
        );
      });
    },
    ...
    testSetupFormFixed: function () {
      ...
      this.wait(100, function () {
        ...
        this.assert(
          document
            .getElementById(ProxyFormController.ProxyTypes.FIXED)
            .classList.contains("active")
        );
      });
    },
    ...
    testRecalcFormValuesSingle: function () {
      ...
      this.assert(
        document
          .querySelector(
            "#" + ProxyFormController.ProxyTypes.FIXED + " > section"
          )
    ...
    testBypassList: function () {
      ...
      this.assertEnumEqual(this.controller_.bypassList, [
        "1.example.com",
        "2.example.com",
        "3.example.com",
      ]);
