...
function startRequest(params) {
  ...
  if (params && params.showLoadingAnimation) loadingAnimation.start();
...
function onWatchdog() {
  chrome.alarms.get("refresh", function (alarm) {
    if (alarm) {
      ...
      console.log(
        "Refresh alarm doesn't exist!? " + "Refreshing now and rescheduling."
      );
      startRequest({ scheduleRequest: true, showLoadingAnimation: false });
    }
  });
