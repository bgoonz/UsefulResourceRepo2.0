...
gulp.task("lint", function () {
  return gulp
    .src([__dirname + "/source/**/**.ts", __dirname + "/test/**/**.test.ts"])
    .pipe(tslint())
...
gulp.task("cover", function () {
  return gulp.src(__dirname + "/coverage/**/lcov.info").pipe(coveralls());
});
...
gulp.task("compress", function () {
  return gulp
    .src(__dirname + "/bundled/source/inversify.js")
...
gulp.task("header", function () {
  ...
  return gulp
    .src(__dirname + "/dist/inversify.js")
