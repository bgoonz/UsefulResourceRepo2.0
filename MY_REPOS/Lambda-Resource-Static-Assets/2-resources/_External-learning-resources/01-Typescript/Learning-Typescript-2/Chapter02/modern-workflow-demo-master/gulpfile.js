...
gulp.task("lint-json", function () {
  return gulp.src("./data/*.json").pipe(jsonlint()).pipe(jsonlint.reporter());
});

gulp.task("scss-lint", function () {
  return gulp.src("./source/scss/*.scss").pipe(scsslint());
});
