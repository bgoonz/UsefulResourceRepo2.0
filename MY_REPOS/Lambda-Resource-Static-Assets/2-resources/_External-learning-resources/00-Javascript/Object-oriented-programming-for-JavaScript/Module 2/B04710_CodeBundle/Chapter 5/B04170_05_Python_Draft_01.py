...
class AngryCatWizard(AngryCat, Wizard):
    ...
    def disappear_alien(self, alien):
        print(
            self.full_name
            + " uses his "
            + str(self.spell_power)
            + " to make the alien with "
            + str(alien.number_of_eyes)
            + " eyes disappear."
        )
...
class AngryCatKnight(AngryCat, Knight):
    def __init__(
        self, nick_name, age, full_name, initial_score, x, y, sword_power, sword_weight
    ):
        AngryCat.__init__(self, nick_name, age, full_name, initial_score, x, y)
    ...
    def unsheath_sword(self, target):
        ...
        if target is not None:
            print(
                "The sword targets an alien with "
                + str(target.number_of_eyes)
                + " eyes."
            )
