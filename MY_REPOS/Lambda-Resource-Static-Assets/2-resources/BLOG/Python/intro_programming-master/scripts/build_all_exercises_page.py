...
def add_contents(html_string):
    ...
    for line in html_string.split("\n"):
        if "<h1>" in line:
            ...
            if m:
                toc_string += (
                    '<h3 class="contents_level_two">%s<a href="#ex_ch_%d">%s</a></h3>\n'
...
def anchor_exercises(html_string):
    ...
    for line in html_string.split("\n"):
        ...
        if m:
            ...
            new_line = (
                '%s<h4 id="%s"><a href="all_exercises_challenges.html#%s">%s</a></h4>\n'
