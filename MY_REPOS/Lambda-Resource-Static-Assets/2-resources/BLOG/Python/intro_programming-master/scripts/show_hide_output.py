...
def generate_button(id_number):
    ...
    button_string += (
        "    <button id='show_output_%d' class='btn btn-success btn-xs show_output' target='%d'>show output</button>\n"
        % (id_number, id_number)
    )
    button_string += (
        "    <button id='hide_output_%d' class='btn btn-success btn-xs hide_output' target='%d'>hide output</button>\n"
        % (id_number, id_number)
    )
    button_string += "</div>\n"
