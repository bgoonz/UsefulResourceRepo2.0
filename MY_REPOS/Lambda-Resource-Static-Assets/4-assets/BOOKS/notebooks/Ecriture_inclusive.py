...
print(
    f"Cela a donné {len(set(nouveaux_mots_inclusifs_singuliers) - set(mots_inclusifs_singuliers))} nouveaux mots singuliers."
)
mots_inclusifs_singuliers = list(
    set(mots_inclusifs_singuliers + nouveaux_mots_inclusifs_singuliers)
)
...
# on garde les mots nouveaux
print(
    f"Cela a donné {len(set(nouveaux_mots_inclusifs_pluriels) - set(mots_inclusifs_pluriels))} nouveaux mots pluriels."
)
mots_inclusifs_pluriels = list(
    set(mots_inclusifs_pluriels + nouveaux_mots_inclusifs_pluriels)
)
...
del_alternatives(["matériau", "matérielle", "matériaux", "matérielles"])
