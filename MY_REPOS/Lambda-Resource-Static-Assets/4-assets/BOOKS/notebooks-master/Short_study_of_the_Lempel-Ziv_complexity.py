...
)  # 1 / 0 / 01 / 1110 / 1100 / 0010 / 000 / 010 / 10
...
def tests_3_functions(n, p=0.5, debug=True):
    ...
    assert (
        c1 == c2 == c3
    ), "Error: the sequence {} gave different values of the Lempel-Ziv complexity from 3 functions ({}, {}, {})...".format(
        s, c1, c2, c3
    )
    return c1
...
get_ipython().run_line_magic(
    "timeit",
    "lempel_ziv_complexity('10011110110000100000101000100100101010010111111011001111111110101001010110101010')",
)
get_ipython().run_line_magic(
    "timeit",
    "lempel_ziv_complexity_cython('10011110110000100000101000100100101010010111111011001111111110101001010110101010')",
)
get_ipython().run_line_magic(
    "timeit",
    "lempel_ziv_complexity_numba('10011110110000100000101000100100101010010111111011001111111110101001010110101010')",
)
