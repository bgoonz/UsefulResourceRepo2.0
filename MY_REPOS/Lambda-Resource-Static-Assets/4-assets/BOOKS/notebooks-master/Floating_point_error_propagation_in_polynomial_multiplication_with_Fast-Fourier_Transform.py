...
get_ipython().run_line_magic(
    "timeit",
    "np.polymul(random_polynomial(d=d, maxcoef=maxcoef), random_polynomial(d=d, maxcoef=maxcoef))",
)
get_ipython().run_line_magic(
    "timeit",
    "mypolymul(random_polynomial(d=d, maxcoef=maxcoef), random_polynomial(d=d, maxcoef=maxcoef))",
)
