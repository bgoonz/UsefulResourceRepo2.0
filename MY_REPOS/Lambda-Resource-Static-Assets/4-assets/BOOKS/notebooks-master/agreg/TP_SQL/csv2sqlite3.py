...
def ecrire_donnees():
    ...
    for fichier_csv in liste_fichiers_csv:
        if (
            "Alpha" in fichier_csv
            and fichier_csv.replace("Alpha", "Merite") in liste_fichiers_csv
        ):
            continue
...
def lire_donnees():
    ...
    for annee in annees:
        ...
        print(
            f"Pour l'année {annee}, il y avait {nombre_admissibles} admissibles à {nombre_admis} admis."
        )
