...
!(function (t, e) {
  ...
  function ve(t, e) {
    return (
      (t = _e(t)), H(e) ? t.innerHTML : we(t.hasChildNodes() ? ge(t) : t, e)
    );
  }
  function we(e, t) {
    return (
  ...
  function di(n) {
    ...
    return function (t, e) {
      if (H(e)) {
        ...
        return (
          (e =
            "auto" === (e = Ve((t = W(t)), n)) ? t["offset" + r] : j(e) || 0) -
          fi(t, n)
        );
      }
    ...
    return (
      ...
      Ve(i, "boxSizing") === e
        ? ri[t]
            ...
            .reduce(function (t, e) {
              return (
                t + j(Ve(i, "padding" + e)) + j(Ve(i, "border" + e + "Width"))
              );
            }, 0)
        : 0
    );
      ...
      (n.prototype.$create = function (t, e, i) {
        ...
        (n.prototype.$destroy = function (t) {
          ...
          i && this._callDisconnected(),
            ...
            i &&
              i[r] &&
              (delete i[r][n], O(i[r]) || delete i[r], t && ke(this.$el));
        }),
          ...
          return new se(function (t) {
            ...
            if (!d.queued || !H(c) || !d.hasAnimation || u.length < 2) i = e(u);
              ...
              var n = u.filter(function (t) {
                ...
                a = n[0],
                h =
                  (ni.inProgress(a) && Oe(a, "uk-animation-leave")) ||
                  (Ze.inProgress(a) && "0px" === a.style.height);
              (i = e(n)),
                h ||
                  (i = i.then(function () {
                    var t = e(r);
      ...
      events: [
        ...
        },
        {
          ...
          handler: function (t) {
            var e = t.target;
            this.$el === e
              ? ((gn = this.isActive() ? null : gn),
                Kt(this.$el, "updatearia"),
                this.tracker.cancel())
              : (gn =
                  null === gn && Rt(e, this.$el) && this.isToggled()
                    ? this
                    : gn);
          },
        },
              ...
              return (
                (i[n] = t.map(function (t, e) {
                  return 0 === n
                    ? 0
                    : j(i[n - 1][e]) +
                        (c - j(r[n - 1][e] && r[n - 1][e].offsetHeight));
                })),
      ...
      },
      {
        read: function (t) {
          ...
          return {
            scrolled:
              !!this.parallax &&
              Hi(this.$el, e ? e - ci(this.$el) : 0) * this.parallax,
          };
        },
        write: function (t) {
          var e = t.rows,
  ...
  function En(t) {
    ...
    return (
      o &&
        s &&
        (Ve(t, "minHeight", ""), (e = An(t)), (n = e.heights), (r = e.max)),
      {
      ...
      read: function (t) {
        ...
        if (this.expand) {
          if (
            ...
            return !1;
          i =
            ci(window) - (_n(document.documentElement) - _n(this.$el)) - n ||
            "";
        } else {
          ...
          !0 === this.offsetBottom
            ...
            : D(this.offsetBottom) &&
              (i += " - " + _n(xt(this.offsetBottom, this.$el)) + "px"),
            (i += (n ? " - " + n + "px" : "") + ")");
        }
  ...
  var Nn = {
      ...
      update: {
        ...
        write: function () {
          var t, e;
          (t = this.svgEl),
            (e = Bn(t)) && t.style.setProperty("--uk-animation-stroke", e);
        },
        type: ["resize"],
      },
      methods: {
  ...
  var On = {},
    ...
    Rn = {
      ...
      connected: function () {
        ...
        this.svg.then(function (t) {
          return (
            1 !== e.ratio && Ve(_e("circle", t), "strokeWidth", 1 / e.ratio)
          );
        }, et);
      },
    };
        ...
        : this.isImg &&
          ...
          Un(
            ...
            (function (t, e, i) {
              var n;
              i &&
                ((n = rt.ratio({ width: t, height: e }, "width", wi(Xn(i)))),
                (t = n.width),
                (e = n.height));
              return (
      ...
      load: function (t) {
        ...
        t.some(function (t) {
          ...
          ((this._data.image = de(
            ...
            return (
              Un(e.$el, Qn(t), t.srcset, t.sizes), (tr[e.cacheKey] = Qn(t)), t
            );
          }, et)),
          this.observer.disconnect());
      },
        ...
        },
        {
          ...
          handler: function () {
            ...
            li(window) - li(document) &&
              ...
              this.stack &&
                Ve(this.$el, "zIndex", Ve(this.$el, "zIndex") + or.length),
      ...
      return new se(function (i, n) {
        return Gt(r, "show hide", function () {
          ...
          var t = Gt(
              ...
              "transitionstart",
              function () {
                Gt(s, "transitionend transitioncancel", i, { self: !0 }),
                  clearTimeout(e);
              },
              { self: !0 }
            ),
      ...
      events: [
        ...
        },
        {
          ...
          handler: function () {
            var t;
            this.clsContainerAnimation &&
              ((t = dr()).content = t.content.replace(/,user-scalable=0$/, "")),
  ...
  var fr = {
    ...
    wr = {
      ...
      connected: function () {
        (this.placeholder =
          _e("+ .uk-sticky-placeholder", this.$el) ||
          _e('<div class="uk-sticky-placeholder"></div>')),
          (this.isFixed = !1),
          (this.isActive = !1);
      },
      disconnected: function () {
                ...
                xi.read(function () {
                  ...
                  n.isFixed &&
                    ...
                    Pi(
                      ...
                      t -
                        i -
                        (P(n.targetOffset) ? n.targetOffset : 0) -
                        n.offset
                    );
                });
            }
      ...
      update: [
        {
          ...
          write: function (t) {
            var e = t.height,
              ...
              n = this.placeholder;
            Ve(n, G({ height: e }, i)),
              Rt(n, document) || (xe(this.$el, n), ot(n, "hidden", "")),
          ...
          handler: function (t) {
            ...
            (Dt(t.target, 'a[href="#"], a[href=""]') ||
              ((e = Dt(t.target, "a[href]")) &&
                ((this.cls && !Oe(this.target, this.cls.split(" ")[0])) ||
                  !Ft(this.target) ||
    ...
    Er = {
      ...
      methods: {
        animate: function (t) {
          ...
          !(function () {
            if (Sr) return;
            (Sr = we(document.head, "<style>").sheet).insertRule(
              "." +
                Tr +
      ...
      },
      {
        ...
        methods: {
          start: function () {
            ...
            var e =
              "touchmove" != mt
                ? Yt(document, mt, this.move, { passive: !1 })
                : et;
            (this.unbindMove = function () {
              e(), (t.unbindMove = null);
            }),
              Yt(window, "scroll", this.unbindMove),
              Yt(document, gt, this.end, !0),
            ...
            if (this.unbindMove) {
              ...
              if (
                ...
                [this.index, this.prevIndex]
                  ...
                  l &&
                    (d || Kt(u, "itemhide", [this]), Kt(c, "itemshow", [this]));
              }
            }
          },
          end: function () {
        ...
        if ((void 0 === e && (e = !1), !this.dragging && this.length)) {
          ...
          if ((n[e ? "unshift" : "push"](t), !e && 1 < n.length))
            ...
            if (a !== u) {
              ...
              return (
                a && Kt(a, "itemhide", [this]), Kt(u, "itemshow", [this]), d
              );
            }
            o();
          }
          ...
          return {
            ...
            show: function (t, e, i) {
              ...
              return (
                ...
                se
                  .all([Ze.start(s, u[1], t, r), Ze.start(o, u[0], t, r)])
                  .then(function () {
                    n.reset(), c.resolve();
                  }, et),
                c.promise
            ...
            translate: function (t) {
              ...
              Ve(s, e[1]),
                Ve(o, e[0]),
                Lr(s, "itemtranslatein", { percent: t, dir: a }),
                Lr(o, "itemtranslateout", { percent: 1 - t, dir: a });
            },
            percent: function () {
              return i(o || s, s, a);
            },
              ...
              if ("image" === i || e.match(/\.(jpe?g|png|gif|svg|webp)($|\?)/i))
                ...
                ot(a, "src", e),
                  Gt(a, "error loadedmetadata", function (t) {
                    "error" === t
                      ? s.setError(r)
                      : (ot(a, { width: a.videoWidth, height: a.videoHeight }),
                        s.setItem(r, a));
                  });
                ...
                de(
                  ...
                  var e = t.width,
                    i = t.height;
                  120 === e && 90 === i
                    ? de("https://img.youtube.com/vi/" + h + "/0.jpg").then(
                        function (t) {
                          var e = t.width,
                            i = t.height;
                          return u(e, i);
      ...
      computed: {
        props: function (m, g) {
          ...
          return Gr.reduce(function (t, e) {
            ...
            s && Ve(g, e, ""),
              a.length < 2 &&
                a.unshift(("scale" === e ? 1 : s ? Ve(g, e) : 0) || 0);
          ...
          return {
            ...
            translate: function (t) {
              ...
              Ve(
                a,
                "transform",
                Pr(tt(e - e * t - u, -io(a), si(a).width) * (ct ? -1 : 1), "px")
              ),
            ...
            percent: function () {
              return Math.abs(
                (Ve(a, "transform").split(",")[4] * (ct ? -1 : 1) + i) / (u - i)
              );
            },
            getDistance: function () {
              return Math.abs(u - i);
      ...
      events: {
        beforeitemshow: function (t) {
          ...
          if (!this.dragging && 1 < e) {
            ...
            (this.duration =
              jr(this.avgWidth / this.velocity) *
              (si(
  ...
  var co,
    ...
    fo = G({}, Dr, {
      ...
      scale: {
        show: function () {
          return [
            { opacity: 0, transform: Or(1.5), zIndex: 0 },
            { zIndex: -1 },
          ];
        },
        percent: function (t) {
        ...
        translate: function (t) {
          return [
            { opacity: 1 - t, transform: Or(1 + 0.5 * t), zIndex: 0 },
            { zIndex: -1 },
          ];
        },
      },
        ...
        handles: {
          ...
          watch: function (t, e) {
            Ve(e, { touchAction: "", userSelect: "" }),
              Ve(t, { touchAction: ft ? "none" : "", userSelect: "none" });
          },
          immediate: !0,
        },
      },
      update: {
        write: function () {
          if (this.drag && Bt(this.placeholder)) {
            ...
            if (
              f &&
              !Rt(d, this.placeholder) &&
              (!m || (f.group && f.group === p.group))
            ) {
              if (
                ((d =
                  (f.$el === d.parentNode && d) ||
                  Ut(f.$el).filter(function (t) {
                    return Rt(d, t);
                  })[0]),
                m)
              )
      ...
      methods: {
        ...
        start: function (t) {
          ...
          this.drag =
            ...
            (i = this.placeholder),
            ot(
              (n = we(e, i.outerHTML.replace(/(^<)li|li(\/>$)/g, "$1div$2"))),
              "style",
