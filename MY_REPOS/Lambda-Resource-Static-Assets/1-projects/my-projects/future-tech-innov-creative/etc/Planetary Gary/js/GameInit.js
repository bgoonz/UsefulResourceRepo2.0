...
(function () {
  ...
  function playSoundFX() {
    ...
    createjs.Tween.get(delayNode.delayTime, { override: true })
      .to({ value: 1 })
      .to({ value: 0 }, 2200, createjs.Ease.bounceInOut);
  }
  ...
  function drawProgress(value) {
    progress.graphics
      .clear()
      .beginFill("#EB2")
      .drawRoundRect(-103, -13, 206, 26, 13)
      .beginBitmapFill(progressBmp)
      .drawRoundRect(-100, -10, (value * 200) | 0, 20, 10);
  }
