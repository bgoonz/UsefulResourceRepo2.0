    ...
    var f = (function () {
      ...
      p = function (h) {
        ...
        for (var n = ""; ++g < k; ) {
          ...
          if (!isFinite(b) || 0 > b || 1114111 < b || l(b) != b)
          ...
          if (g + 1 == k || 16384 < d.length)
            (n += e.apply(null, d)), (d.length = 0);
        }
        return n;
      };
    f
...
(function (f, e) {
  ...
  function d() {
    var a = g.value,
      ...
      x = !E.test(
        a.replace(/\\u([a-fA-F0-9]{4})/g, function (q, A) {
      ...
      u;
    B
      ? ((t = r = x || G.test(m) || H.test(m)) && (u = "'" + a + "'"), (y = !1))
      : h(a, c)
      ? (I.test(a) && (c = parseInt(a, 8)), (r = !1), (u = "'" + c + "'"))
      : (u = "'" + a.replace(J, "\\$&") + "'");
    ...
    B &&
      (console.log(B, m),
      x
        ? ((b.className = "show"), (n.className = ""))
        : ((b.className = ""), (n.className = t ? "show" : "")));
    z.innerHTML = y
