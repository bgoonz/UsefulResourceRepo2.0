...
function hasError(a) {
  if (!a) return "Missing element name.";
  if (/[A-Z]/.test(a))
  ...
  if (!isPotentialCustomElementName(a)) return "Invalid element name.";
  if (-1 !== reservedNames.indexOf(a))
