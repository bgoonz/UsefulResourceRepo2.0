/*! https://lambda-w-1-notes.netlify.app/13-web-tools/bacon v0.1.0 by @bgoonz | MIT license */ (function (
  root
) {
  ...
  const encode = function (string, options) {
    ...
    if (options && options.alphabet != null) {
      ...
      string = string.replace(/J/g, "I").replace(/V/g, "U");
    }
    let index = -1;
