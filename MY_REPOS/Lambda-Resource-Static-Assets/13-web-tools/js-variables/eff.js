...
(function (window, document) {
  var input = document.getElementsByTagName("input")[0],
    ...
    unicodeOld = document.getElementById("unicode"),
    browser = document.getElementById("browser"),
    reservedWord = document.getElementById("reserved-word"),
    immutableProp = document.getElementById("immutable-properties"),
  ...
  function update() {
    ...
    es5Warning = !regexIdentifierES5.test(
    ...
    if (
      (isReserved = regexES6ReservedWord.test(tmp)) ||
      !regexIdentifier.test(tmp)
    ) {
      ...
      es3.className =
        es5.className =
        browser.className =
        immutableProp.className =
          "";
      reservedWord.className = isReserved ? "show" : "";
    } else {
      output.innerHTML = "a valid";
      es3Warning = regexES3ReservedWordExclusive.test(tmp);
      if (!regexIdentifier.test(tmp)) {
        es5Warning = true;
        es3Warning = false;
      }
      unicodeWarning = !regexIdentifierUnicode5.test(tmp);
      ...
      es5.className = es5Warning ? "show" : "";
      es3.className = es3Warning ? "show" : "";
      zeroWidth.className = hasZeroWidth ? "show" : "";
      unicodeOld.className = unicodeWarning ? "show" : "";
  ...
  if (storage) {
    storage.jsVars && (input.value = storage.jsVars);
    update();
  }
