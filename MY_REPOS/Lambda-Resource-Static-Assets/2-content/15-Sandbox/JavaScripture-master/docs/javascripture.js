...
for (
  var apiSets = [
    ...
    noDescriptions = {
      ...
      RTCPeerConnection: !0,
      CloseEvent: !0,
      XRBoundedReferenceSpace: !0,
      XRFrame: !0,
      XRInputSourceEvent: !0,
      XRInputSourcesChangeEvent: !0,
      XRLayer: !0,
      XRReferenceSpace: !0,
      XRReferenceSpaceEvent: !0,
      XRRenderState: !0,
      XRSessionEvent: !0,
      XRSpace: !0,
      XRViewerPose: !0,
    ...
    apichooserList = document.querySelector("#apisets > ul"),
    related = document.getElementById("related-apis"),
  ...
  styleSheet.insertRule(
    "#rootObjs > ." + setName + " { display: none; }",
    styleSheet.cssRules.length
  ),
    styleSheet.insertRule(
      "#rootObjs." + setName + " > ." + setName + " { display: block; }",
      styleSheet.cssRules.length
    ),
    apichooserList.insertAdjacentHTML(
      "beforeend",
      "<li><label><input id='inc" +
        setName +
        "' type='checkbox'>" +
        setName +
        "</label></li>"
    );
  for (var inSet = !1, j = 1; j < set.length; j++)
    rootObjs.push({ name: set[j][0], set: setName }),
      "/" + set[j][0] === location.pathname.replace(".html", "") &&
        (inSet = !0);
  if (related && inSet)
    for (var j = 1; j < set.length; j++) {
      var typeName = set[j][0],
        className = setName;
      noDescriptions[typeName] && (className += " noDescription"),
        related.insertAdjacentHTML(
          ...
          "<a href='/" +
            ...
            className +
            "'" +
            (typeName.length > 15 ? ' title="' + typeName + '"' : "") +
            ">" +
            typeName +
            "</a>"
        );
...
rootObjs.sort(function (e, t) {
  return e.name.localeCompare(t.name);
});
var allList = document.getElementById("rootObjs");
rootObjs.forEach(function (e) {
  var t = e.set;
  noDescriptions[e.name] && (t += " noDescription"),
...
for (
  var possibilities,
    buildAutoCompleteList = function () {
      ...
      var n = "";
      if (
        (apiSets.forEach(function (r) {
          var a = r[0];
          document.getElementById("inc" + a).checked &&
            ((n += " " + a),
            t.push(a),
        ...
        "" === n && (n = "empty"),
        (n += " navgroup"),
        (document.getElementById("rootObjs").className = n),
        possibilities.sort(),
        t.length)
      ) {
        var r = { JavaScript: "JS" };
      ...
      var a = document.getElementById("selectedsets");
      (a.innerHTML = "include: " + t), (a.title = t);
    },
    openApiChooser = function () {
      var e = document.getElementById("apisets");
      e.style.display = "block";
      var t = document.getElementById("obscure");
    ...
    checkBoxes = document.querySelectorAll("#apisets input"),
    i = 0;
  i < checkBoxes.length;
  i++
) {
  for (
    var checkBox = checkBoxes[i],
      apiName = checkBox.id.substring(3),
      checked = !0,
      forceChecked = !1,
      j = 0;
    j < apiSets.length;
    ...
    if (set[0] === apiName)
      for (var k = 1; k < set.length; k++)
        "/" + set[k][0] === location.pathname && (forceChecked = !0);
  }
  forceChecked && localStorage.setItem(checkBox.id, !0);
  var storedState = localStorage.getItem(checkBox.id);
  storedState && (checked = "true" === storedState),
    (checked = checked || forceChecked),
    (checkBox.checked = Boolean(checked)),
    (checkBox.onchange = function (e) {
      _gaq.push(["_trackEvent", "APIChange", e.target.id]),
        localStorage && localStorage.setItem(e.target.id, e.target.checked),
...
var setSelected = function (e) {
    selectedItem && (selectedItem.className = ""),
      (selectedIndex = Math.max(0, Math.min(e, suggestions.length - 1))),
      (selectedItem = suggestions[selectedIndex]) &&
        (selectedItem.className = "selected");
  },
  createSuggestion = function (e, t) {
    var n = document.createElement("a");
    (n.innerHTML = e),
      (n.href = t),
      resultsBox.appendChild(n),
      suggestions.push(n),
  ...
  autocomplete = function (e) {
    if (e && 0 !== e.length) {
      ...
      var t = RegExp(
        ...
        n = possibilities.filter(function (e) {
          return t.test(e);
        });
      return (
        n.sort(function (e, n) {
          var r = e.match(t).index,
            a = n.match(t).index,
            o = 0 === r,
            i = 0 === a;
          if (o && !i) return -1;
          ...
          var E = -1 !== s,
            m = -1 !== l;
          return !E && m ? -1 : E && !m ? 1 : e.localeCompare(n);
        }),
        (n = n.slice(0, 15)),
        (resultsBox.innerHTML = ""),
        (suggestions = []),
        n.forEach(function (e) {
          createSuggestion(e, e.replace(".", "#"));
        }),
        e.length &&
          (createSuggestion(
            e + " - site search",
            "http://www.google.com/search?q=" +
              ...
              "&sitesearch=javascripture.com"
          ),
          createSuggestion(
            e + " - Google search",
            "http://www.google.com/search?q=" + encodeURIComponent(e)
          )),
        setSelected(0),
        n.length && 0 === n[0].match(t).index ? n[0] : void 0
      );
    }
    resultsBox.style.display = "none";
  },
  keyCodes = { BACKSPACE: 8, ENTER: 13, UP: 38, DOWN: 40, DELETE: 46, S: 83 };
searchBox.addEventListener("keydown", function (e) {
  var t;
  switch (e.keyCode) {
    case keyCodes.BACKSPACE:
    case keyCodes.DELETE:
      var n = searchBox.selectionStart,
        r = searchBox.selectionEnd;
      searchBox.selectionStart === searchBox.selectionEnd &&
        (e.keyCode === keyCodes.BACKSPACE ? n-- : r++),
        (t = searchBox.value.slice(0, n) + searchBox.value.slice(r)),
        autocomplete(t);
      break;
    case keyCodes.ENTER:
      return (
        selectedItem &&
          (_gaq.push([
            ...
            "Search",
            "Search",
            "text=" + searchBox.value + "&href=" + selectedItem.href,
          ]),
  ...
  searchBox.addEventListener("keypress", function (e) {
    if (0 !== e.charCode) {
      var t =
          searchBox.value.slice(0, searchBox.selectionStart) +
          String.fromCharCode(e.charCode) +
          searchBox.value.slice(searchBox.selectionEnd),
        n = autocomplete(t),
        r = searchBox.selectionStart;
      return n && searchBox.selectionEnd === searchBox.value.length
        ? ((searchBox.value = n),
          searchBox.setSelectionRange(r + 1, n.length),
          e.preventDefault(),
          !1)
        : void 0;
    }
...
var expandoClicked = function (e) {
    e.className.match(/expanded/)
  ...
  lastRun,
  recordRun = function (e) {
    init ||
      lastRun === e ||
      (_gaq.push(["_trackEvent", "Run", e, "ctrl-enter", inCtrlEnter ? 1 : 0]),
      (lastRun = e));
  },
  dumpObject = function (e, t) {
    if (t > 3) return "...";
    var n = e;
    if ("object" == typeof e) {
      ...
      for (var o in e)
        a || (n += ", "),
          (r && o == Number(o)) || (n += o + ": "),
          (n += dumpObject(e[o], t + 1)),
          (a = !1);
      n += r ? " ]" : " }";
    } else "string" == typeof e && (n = "'" + e + "'");
    return n;
  },
  executeExample = function (e, t) {
    recordRun(t);
    var n = e.getElementsByClassName("code")[0],
      r = e.getElementsByClassName("results")[0],
      a = e.getElementsByClassName("errormessage")[0];
    if (n && r && a) {
      var o = e.getElementsByTagName("iframe")[0];
      o &&
        ((o.contentWindow.console = void 0),
        (o.contentWindow.javascriptureReportError = void 0),
        o.parentNode.removeChild(o)),
        ((o = document.createElement("iframe")).style.position = "fixed"),
        (o.style.top = "-9999px"),
        (o.style.left = "-9999px"),
        (o.style.width = "1px"),
        (o.style.height = "1px"),
      ...
      !i && o.contentWindow && (i = o.contentWindow.document),
        (i = i || o.document),
        (r.innerHTML = ""),
        (a.style.display = "none"),
        i.open(),
        (o.contentWindow.console = {
          log: function () {
            for (var e = "", t = 0; t < arguments.length; t++)
              e.length && (e += " "), (e += escapeHTML(arguments[t]));
            r.insertAdjacentHTML("beforeend", e + "\n");
          },
          dir: function (e) {
            r.insertAdjacentHTML(
              "beforeend",
              escapeHTML(dumpObject(e, 0)) + "\n"
            );
          },
        }),
        (o.contentWindow.javascriptureReportError = function (e) {
          (a.innerHTML = escapeHTML(e)), (a.style.display = "block");
        }),
        i.writeln("<script>"),
        i.writeln(
          "window.onerror=function(err) { javascriptureReportError(err); };"
        ),
        i.writeln(
          'window.onunhandledrejection=function(evt) { javascriptureReportError("Promise rejected: " + evt.reason); evt.preventDefault(); };'
        ),
        i.writeln("</script>");
      var s;
      s = asyncFunctionsSupported
        ? "(async()=>{" +
          n.value +
          "\n})().catch(e=>javascriptureReportError(e))"
        : n.value;
      var l = new Blob([s], { type: "application/javascript" }),
        c = URL.createObjectURL(l);
      i.writeln('<script src="' + c + '">'),
        URL.revokeObjectURL(l),
        i.writeln("</script>"),
        i.close();
    }
  },
  executeHTMLExample = function (e, t) {
    recordRun(t);
    var n = e.getElementsByClassName("code")[0],
      r = e.getElementsByClassName("output")[0],
      a = e.getElementsByClassName("results")[0],
      o = e.getElementsByClassName("htmlerrormessage")[0];
    if (n && r && a && o) {
      ...
      var s = (r = i).contentDocument;
      !s && r.contentWindow && (s = r.contentWindow.document),
        (s = s || r.document),
        (a.innerHTML = ""),
        s.open(),
        ...
        (r.contentWindow.javascriptureReportError = function (e) {
          (o.innerHTML = escapeHTML(e)), (o.style.display = "block");
        }),
        s.writeln("<script>"),
        s.writeln(
          "window.onerror=function(err) { javascriptureReportError(err); };"
  ...
  requestExample = function (e, t) {
    _gaq.push(["_trackEvent", "RequestExample", t]),
      (e.href = ""),
      (e.textContent = "Requested!");
  },
  focusListener = function (e) {
    var t = e.target.parentNode.parentNode;
    -1 === t.className.indexOf("focus") && (t.className += " focus");
  },
  blurListener = function (e) {
    var t = e.target.parentNode.parentNode;
    t.className = t.className.replace(" focus", "").trim();
  };
document.addEventListener(
  ...
  function (e) {
    switch (e.keyCode) {
      case keyCodes.S:
        if (e.ctrlKey)
          return searchBox.focus(), e.preventDefault(), e.stopPropagation(), !1;
    }
  },
  !0
);
var inCtrlEnter = !1,
  makeCtrlEnterListener = function (e) {
    return function (e) {
      switch (e.keyCode) {
        case keyCodes.ENTER:
          if (e.ctrlKey) {
  ...
  exampleKeydownListener = makeCtrlEnterListener(executeExample),
  initExample = function (e) {
    var t = e.querySelector("textarea");
    t.addEventListener("focus", focusListener),
      t.addEventListener("blur", blurListener),
      t.addEventListener("keydown", exampleKeydownListener),
      executeExample(e);
  },
  htmlExampleKeydownListener = makeCtrlEnterListener(executeHTMLExample),
  initHTMLExample = function (e) {
    var t = e.querySelector("textarea");
    t.addEventListener("focus", focusListener),
      t.addEventListener("blur", blurListener),
      t.addEventListener("keydown", htmlExampleKeydownListener),
      executeHTMLExample(e);
  },
  init = !0,
  startTime = Date.now(),
  targetElementName = (window.location.hash || "").replace("#", ""),
  targetMember;
if (targetElementName) {
  var targetAnchor = document.querySelector(
    "a[name=" + targetElementName + "]"
  );
  targetAnchor && (targetMember = targetAnchor.parentNode);
}
for (
  var examplesNodeList = document.querySelectorAll(".example, .htmlexample"),
    examples = Array(examplesNodeList.length),
    initExampleIndex = 0,
    i = 0;
  i < examplesNodeList.length;
  i++
) {
  var example = examplesNodeList[i];
  (examples[i] = example),
    example.parentNode === targetMember && (initExampleIndex = i);
}
var loadTimeout = 100,
  loadExamples = function () {
    for (var e = Date.now(); ; ) {
      var t = examples[initExampleIndex];
      if (((examples[initExampleIndex] = void 0), !t)) {
        init = !1;
        break;
      }
      if (
        (-1 !== t.className.indexOf("htmlexample")
          ? initHTMLExample(t)
          : initExample(t),
        (initExampleIndex = (initExampleIndex + 1) % examples.length),
        Date.now() - e > loadTimeout)
      ) {
...
examples.length ? loadExamples() : (init = !1),
  localStorage.getItem("newCount") < 20 &&
    setTimeout(function () {
      var e = document.querySelector(".contribute"),
      ...
      (t.className = "popup"),
        ...
        localStorage.setItem(
          "newCount",
          (+localStorage.getItem("newCount") || 0) + 1
        );
    }, 2500);
for (
  var expanders = document.querySelectorAll(".expand-members"), i = 0;
  i < expanders.length;
  i++
) {
  ...
  expander.addEventListener("click", function (e) {
    ...
    var n = document.body.classList.contains("members-collapsed");
    (sessionStorage.collapsed = n), e.target.scrollIntoView(e.target);
    var r = e.target.getBoundingClientRect().top;
    (document.getElementsByClassName("content")[0].scrollTop += r - t),
      _gaq.push(["_trackEvent", "UI", "Toggle Collapse", "collapsed=" + n]);
  });
}
