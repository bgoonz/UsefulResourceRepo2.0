  ...
  */
  ...
  var Va = function ( a ) {
    ...
    Xa = function ( a ) {
      ...
      wa( Wa.test( a ), "%s does not match the safe URL pattern", a ) || ( a = "about:invalid#zClosurez" );
      return new y( a, Ua )
    },
    Ua = {};
  ...
  var cb = function ( a ) {
    Ka.test( a ) && ( -1 != a.indexOf( "&" ) && ( a = a.replace( Ea, "&amp;" ) ), -1 != a.indexOf( "<" ) && ( a = a.replace( Fa, "&lt;" ) ), -1 != a.indexOf( ">" ) && ( a = a.replace( Ga, "&gt;" ) ), -1 != a.indexOf( '"' ) && ( a = a.replace( Ha, "&quot;" ) ), -1 != a.indexOf( "'" ) && ( a = a.replace( Ia, "&#39;" ) ), -1 != a.indexOf( "\x00" ) && ( a = a.replace( Ja, "&#0;" ) ) );
    return a
  };
  var db = -1 != w.indexOf( "Opera" ),
    eb = -1 != w.indexOf( "Trident" ) || -1 != w.indexOf( "MSIE" ),
    fb = -1 != w.indexOf( "Edge" ),
    gb = -1 != w.indexOf( "Gecko" ) && !( -1 != w.toLowerCase().indexOf( "webkit" ) && -1 == w.indexOf( "Edge" ) ) && !( -1 != w.indexOf( "Trident" ) || -1 != w.indexOf( "MSIE" ) ) && -1 == w.indexOf( "Edge" ),
    ...
    Rc( "auth", {
      callback: function () {
        ...
        d.checkSessionState( e, function ( f ) {
          ...
          Yc( "savedUserState", g );
          ( h || k ) && dd( f ) && !Q( "disableRealtimeCallback" ) && d._pimf( f,
            !0 )
        } )
      }
    } );
