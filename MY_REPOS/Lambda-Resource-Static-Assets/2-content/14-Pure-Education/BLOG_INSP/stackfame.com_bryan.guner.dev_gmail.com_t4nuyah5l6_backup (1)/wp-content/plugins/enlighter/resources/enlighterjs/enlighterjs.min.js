...
var EnlighterJS = function ( e ) {
  ...
  function g( e, t, r ) {
    return ( g = l() ? Reflect.construct : function ( e, t, r ) {
      var n = [ null ];
      n.push.apply( n, t );
  ...
  function p( r ) {
    ...
    return function () {
      var e, t = s( r );
      return u( this, n ? ( e = s( this ).constructor, Reflect.construct( t, arguments, e ) ) : t.apply( this, arguments ) )
    }
  }
  ...
  function m( e, t, r ) {
    for ( var n = 2 < arguments.length && void 0 !== r ? r : "text", i = [], a = 0, s = 0; s < t.length; s++ ) {
      var o = t[ s ];
      if ( !o || !o.type || !o.regex ) return;
      for ( var l = void 0; null != ( l = o.regex.exec( e ) ); ) {
        ...
        if ( 0 != l[ 0 ].length ) {
          o.regex.lastIndex = l.index + 1 + l[ 0 ].length / 3;
          var g = Array.isArray( o.type ) ? o.type[ 0 ] : o.type,
            u = ( Array.isArray( o.filter ) ? o.filter[ 0 ] : o.filter ) || null;
          if ( 1 < l.length )
            for ( var p, c, y, f = 0, b = 1; b < l.length; b++ ) {
              l[ b ] && ( p = Array.isArray( o.type ) && o.type.length >= b ? o.type[ b - 1 ] : g, c = Array.isArray( o.filter ) && o.filter.length >= b ? o.filter[ b - 1 ] : u, f = y = l[ 0 ].indexOf( l[ b ], f ), i.push( C( l[ b ], p, c, l.index + y, s ) ) )
    ...
    for ( var d = [], h = 0, m = 0; m < i.length; m++ ) {
      if ( h < i[ m ].index && d.push( C( e.substring( h, i[ m ].index ), n, null, h ) ), i[ m ].filter )
        for ( var x = i[ m ].filter( i[ m ] ) || [], k = 0; k < x.length; k++ ) d.push( x[ k ] );
      else d.push( i[ m ] );
      h = i[ m ].end;
      for ( var v = !1, w = m + 1; w < i.length; w++ )
        if ( i[ w ].index >= h ) {
          m = w - 1, v = !0;
          break
        } if ( !1 === v ) break
    }
    return h < e.length && d.push( C( e.substring( h ), n, null, h ) ), d
  }
  var x = function () {
      function e() {
  ...
  function k( e, t, r ) {
    for ( var n, i = [], a = 0; null != ( n = t.exec( e.text ) ); ) {
      a < n.index && i.push( C( e.text.substring( a, n.index ), e.type, null, a ) );
      for ( var s = r( n, e.type ) || [], o = 0; o < s.length; o++ ) i.push( s[ o ] );
      a = n.index + n[ 0 ].length, t.lastIndex = a
    }
  ...
  var v = function () {
        ...
        value: function () {
          this.rules = [ h.dqStrings, h.poundComments, {
            ...
            filter: [ null, null, function ( e ) {
              return k( e, h.dqStrings.regex, function ( e ) {
                return [ C( e[ 0 ], "s0" ) ]
              } )
            }, null ]
          }, {
    ...
    L = function () {
      ...
      return i( t, [ {
        key: "setupLanguage",
        value: function () {
          var t = [ A.pseudoElements, A.idSelector, A.classSelector, A.elementSelector, h.dqStrings, h.sqStrings ];
          this.rules = [ {
            regex: /(?:^|}|\*\/|;|{)\s*([^{};/]+?)\s*{/g,
            type: "text",
            filter: function ( e ) {
    ...
    Z = function () {
      ...
      return i( t, [ {
        ...
        value: function () {
          ...
          var e = [ h.slashComments, A.pseudoElements, A.idSelector, A.classSelector, {
            regex: /\b([\w][\w-]+)\s*\(/gm,
            type: "m0"
          }, {
            regex: /@[\w-]+\b/g,
    ...
    le = function () {
      ...
      return i( t, [ {
        key: "setupLanguage",
        value: function () {
          this.rules = [ h.poundComments, h.blockComments, {
            regex: /--.*$/gm,
            type: "c0"
          }, h.null, h.sqStrings, {
            regex: /`\w+?`(?:\.`\w+?`)*/g,
      ...
      return i( t, [ {
        ...
        value: function () {
          this.rules = [ {
            ...
            type: [ "g1", "x1", "text", "g1" ],
            filter: [ null, null, function ( e ) {
              return k( e, /\b([^\s\0"'>/=]+)(\s*=\s*)((['"]).*?\4|[^'" \t]+)/gi, function ( e ) {
  ...
  function we( e ) {
    return e = ve( e = ( e || "" ).toLowerCase() ) || e, he[ e ] ? e : null
  }
  var Ce = {
    document: document,
    window: window
  ...
  function Le( e ) {
    return null != e && 0 < e.length ? Se().querySelectorAll( e ) : []
  }
          ...
          if ( void 0 !== s )
            if ( s.push )
              for ( var o = 0; o < s.length; o++ ) {
                var l = s[ o ];
                null !== l && !1 !== l && ( void 0 !== l ? l.appendChild ? i.appendChild( l ) : i.appendChild( n.createTextNode( l ) ) : i.appendChild( n.createTextNode( "#INVALID_ELEMENT#" ) ) )
              } else s.appendChild ? i.appendChild( s ) : i.appendChild( n.createTextNode( s ) );
  ...
  function De( e, t ) {
    ...
    if ( "function" != typeof e ) return Ne( e, t, n );
    var a = g( e, [ t || {} ].concat( n ) );
    return "function" == typeof a.render ? a.render() : a instanceof HTMLElement ? a : void Se().createTextNode( "#INVALID_JSX_ELEMENT#" )
  }
  ...
  function je() {
    var e;
    void 0 !== Fe.console && Fe.console.log && ( e = Fe.console ).log.apply( e, arguments )
  }
  var ze = Object.freeze( {
    ...
    getElement: function ( e ) {
      return null != e && 0 < e.length ? Se().querySelector( e ) : null
    },
    getElementDataAttribute: qe,
    getElementAttribute: Ie,
    insertBefore: We,
    createNode: Ne,
    createElement: De,
  ...
  function Be( e ) {
    var t = e.tokens,
      ...
      n = function ( e, t ) {
        ...
        return e.split( "," ).forEach( function ( e ) {
            ...
            if ( null != t ) {
              var r = parseInt( t[ 1 ] ) - a,
                n = parseInt( t[ 2 ] ) - a;
              if ( r < n )
                for ( var i = r; i <= n; i++ ) s[ "" + i ] = !0
    ...
    t.forEach( function ( t ) {
      ...
      1 === e.length ? a.push( [ t.type, t.text ] ) : ( a.push( [ t.type, e.shift() ] ), e.forEach( function ( e ) {
        i.push( a ), ( a = [] ).push( [ t.type, e ] )
      } ) )
    } ), i.push( a );
    var s = [];
    return 0 < r.lineoffset && s.push( "counter-reset: enlighter " + ( parseInt( r.lineoffset ) - 1 ) ), De( "div", {
      className: "enlighter",
      style: s.join( ";" )
    }, i.map( function ( e, t ) {
      return De( "div", {
        className: n( t + 1 ) ? "enlighter-special" : ""
      }, De( "div", null, e.map( function ( e ) {
        return De( "span", {
  ...
  function Me( e ) {
    var t = [ "enlighter-btn" ];
    return e.name && t.push( "enlighter-btn-" + e.name ), De( "div", {
      className: t.join( " " ),
      onClick: e.onClick,
      title: e.tooltip
    }, e.text || null )
      ...
      return De( Me, {
        ...
        onClick: function () {
          ! function ( e ) {
            ...
            r.getSelection().removeAllRanges(), Ae( n )
          }( e.getRawCode() )
        }
      } )
    },
  ...
  function Ve( e ) {
    ...
    return !0 === r.linehover && n.push( "enlighter-hover" ), !0 === r.linenumbers && n.push( "enlighter-linenumbers" ), "scroll" === r.textOverflow && n.push( "enlighter-overflow-scroll" ), !0 === r.collapse && n.push( "enlighter-collapse" ), 0 < r.cssClasses.length && n.push.apply( n, f( r.cssClasses ) ), t = De( Ze, {
      className: n
    }, De( Ge, {
      name: "top",
      layout: r.toolbarTop,
  ...
  function Xe( r ) {
    ...
    return i = r.dataset.map( function ( e, t ) {
      return De( Me, {
        onClick: function () {
          return e = t, Oe( i[ n ], "enlighter-active" ), $e( i[ e ], "enlighter-active" ), n = e, void r.onChange( e );
          var e
        },
        text: e.params.title || e.params.language
      } )
    } ), $e( i[ 0 ], "enlighter-active" ), De( Ze, {
  ...
  var Ye = Object.freeze( {
    ...
    inline: function ( e ) {
      ...
      return 0 < t.cssClasses.length && r.push.apply( r, f( t.cssClasses ) ), De( Ze, {
        className: r
      }, De( Je, {
        tokens: e[ 0 ].tokens,
        options: t
    ...
    codegroup: function ( e ) {
      ...
      function l( e ) {
        Ee( t[ i ], !1 ), Ee( t[ e ], !0 ), i = e
      }
      return !0 === n.linehover && a.push( "enlighter-hover" ), !0 === n.linenumbers && a.push( "enlighter-linenumbers" ), "scroll" === n.textOverflow && a.push( "enlighter-overflow-scroll" ), !0 === n.collapse && a.push( "enlighter-collapse" ), 0 < n.cssClasses.length && a.push.apply( a, f( n.cssClasses ) ), t = e.map( function ( e ) {
        return De( "div", {
          style: "display:none"
        }, De( Be, {
          tokens: e.tokens,
  ...
  function Qe( e ) {
    var t;
    return ( t = ( ( t = e[ 0 ].params.layout ) || "" ).toLowerCase(), Ye[ t ] ? Ye[ t ] : Ve )( e.map( function ( e ) {
      var t, r, n, i = e.code,
        a = e.params;
      if ( "string" != typeof i ) throw new TypeError( "EnlighterJS Engine requires string input" );
      return {
        tokens: ( t = a.language, r = c.language || null, n = we( t ) || we( r ) || "generic", xe[ n ] || ( xe[ n ] = new he[ n ] ), xe[ n ] ).analyze( i ),
        params: a,
        code: i
      }
    } ) )
  ...
  function Ke( i, t ) {
    ...
    var r = a( "cssClasses" ) || "";
    !0 === a( "retainCssClasses" ) && ( r += " " + ( Ie( i, "class" ) || "" ) );
    var n = r.replace( /\s+/g, " " ).trim().split( " " );
    return {
      language: e( "language" ),
      theme: e( "theme" ),
      layout: e( "layout" ),
  ...
  function tt( e ) {
    ...
    if ( !1 === t ) return !1;
    var r = et.splice( t, 1 );
    return Ae( r[ 0 ].wrapper ), r[ 0 ].elements.map( function ( e ) {
      return Oe( e, "enlighter-origin" )
    } ), !0
  }

  function rt( e ) {
    var t, r, n = 1 < arguments.length && void 0 !== arguments[ 1 ] ? arguments[ 1 ] : {};
    try {
      if ( Array.isArray( e ) || ( e = [ e ] ), 0 === e.length ) return !1;
      if ( !1 === n ) return tt( e[ 0 ] );
      if ( Te( e[ 0 ], "enlighter-origin" ) ) return !1;
      var i = Qe( e.map( function ( e ) {
        var t = Ke( e, n ),
          r = function ( e, t ) {
            var r = e.innerHTML || "";
            r = ( r = r.replace( /(^\s*\n|\n\s*$)/gi, "" ) ).replace( /&lt;/gim, "<" ).replace( /&gt;/gim, ">" ).replace( /&nbsp;/gim, " " ), !0 === t.ampersandCleanup && ( r = r.replace( /&amp;/gim, "&" ) );
            var n = t.indent;
            return !1 !== n && -1 < n && ( r = r.replace( /(\t*)/gim, function ( e, t ) {
              return new Array( n * t.length + 1 ).join( " " )
            } ) ), r
          }( e, t );
        return $e( e, "enlighter-origin" ), {
          element: e,
          code: r,
          params: t
        }
      } ) );
      return We( e[ 0 ], i ), t = e, r = i, et.push( {
        elements: t,
        wrapper: r
      } ), !0
    } catch ( e ) {
  ...
  return e.enlight = rt, e.init = function () {
    ...
    e = 2 < arguments.length && void 0 !== arguments[ 2 ] ? arguments[ 2 ] : null, Object.assign( c, e || {} );
    for ( var i = Le( t ), a = Le( r ), s = function ( e ) {
        for ( var t = {}, r = [], n = 0; n < e.length; n++ ) {
          var i = qe( e[ n ], "enlighter-group" );
      ...
      }( i ), o = s.standalone, l = s.groups, g = 0; g < o.length; g++ ) rt( o[ g ], {
      layout: n.block || "standard"
    } );
    for ( var u = 0; u < l.length; u++ ) rt( l[ u ], {
      layout: n.codegroup || "codegroup"
    } );
    for ( var p = 0; p < a.length; p++ ) rt( a[ p ], {
