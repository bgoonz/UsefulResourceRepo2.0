...
var strokeWidth = 1;
var thickness=1;
Session.set('brushSize', thickness)
var strokeColor = "black";
Session.set('brushColor', strokeColor)
...
Template.wall.helpers({
  ...
  "magentaBrush": function() {
    return "magenta"
  },

  "violetBrush": function() {
    return "violet"
  },
});
...
Template.wall.events({
  ...
  "click button.js-black": function () {
    lastX=0;
    lastY=0;
    strokeColor = "black";
    Session.set('brushColor', strokeColor)
  ...
  "click button.js-white": function () {
    lastX=0;
    lastY=0;
    strokeColor = "white";
    Session.set('brushColor', strokeColor)
  ...
  "click button.js-green": function () {
    lastX=0;
    lastY=0;
    strokeColor = "green";
    Session.set('brushColor', strokeColor)
  ...
  "click button.js-magenta": function () {
    lastX=0;
    lastY=0;
    strokeColor = "magenta";
    Session.set('brushColor', strokeColor)
  ...
  "click button.js-violet": function () {
    lastX=0;
    lastY=0;
    strokeColor = "violet";
    Session.set('brushColor', strokeColor)
