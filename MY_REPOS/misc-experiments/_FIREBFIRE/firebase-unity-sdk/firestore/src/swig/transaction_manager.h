 ...
 *
_UNITY_SRC_SWIG_TRANSACTION_MANAGER_H_
...
class TransactionResultOfGet {
 public:
  // Creates a new "invalid" instance of this class.
  TransactionResultOfGet() = default;

  // Creates a new "valid" instance of this class with the given information.
  TransactionResultOfGet(DocumentSnapshot&& snapshot, Error error_code,
...
class TransactionCallback {
 public:
  ...
  TransactionResultOfGet Get(const DocumentReference& doc);
...
#endif  // FIREBASE_FIRESTORE_CLIENT_UNITY_SRC_SWIG_TRANSACTION_MANAGER_H_
