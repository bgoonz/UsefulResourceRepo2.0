 ...
 *-----------------------------------------------------------*/
(function() {
    var e = ["require", "exports", "vs/editor/common/core/position", "vs/base/common/winjs.base", "vs/base/common/errors", "vs/base/common/platform", "vs/editor/common/core/uint", "vs/editor/common/core/range", "vs/base/common/uri", "vs/base/common/event", "vs/base/common/lifecycle", "vs/base/common/functional", "vs/base/common/diff/diff", "vs/base/common/cancellation", "vs/base/common/strings", "vs/base/common/diff/diffChange", "vs/editor/common/model/mirrorTextModel", "vs/base/common/linkedList", "vs/base/common/keyCodes", "vs/editor/common/core/selection", "vs/editor/common/core/token", "vs/base/common/arrays", "vs/editor/common/core/characterClassifier", "vs/editor/common/diff/diffComputer", "vs/editor/common/model/wordHelper", "vs/editor/common/modes/linkComputer", "vs/editor/common/modes/supports/inplaceReplaceSupport", "vs/editor/common/standalone/standaloneBase", "vs/editor/common/viewModel/prefixSumComputer", "vs/base/common/worker/simpleWorker", "vs/editor/common/services/editorSimpleWorker"],
        t = function(t) {
    ...
    ! function(e) {
        function t() {
            if (void 0 !== e.global.require || "undefined" != typeof require) {
                ...
                if ("function" == typeof t && "function" == typeof t.resolve) {
                    ...
                    e.global.nodeRequire = r, u.nodeRequire = r,
        ...
        var s = function() {
                ...
                return e.prototype.MarkNextChange = function() {
                    ...
                    this.m_originalStart = Math.min(this.m_originalStart, e),
                        this.m_modifiedStart = Math.min(this.m_modifiedStart, t), this.m_originalCount++
            ...
            u = function() {
                ...
                return e.prototype.ElementsAreEqual = function(e, t) {
                    ...
                    do {
                        (b = M + e) === L || b < N && c[b - 1] < c[b + 1] ? (m = (d = c[b + 1]) - M - i, d < A && S.MarkNextChange(), A = d, S.AddModifiedElement(d + 1, m), M = b + 1 - e) : (m = (d = c[b - 1] + 1) - M - i, d < A && S.MarkNextChange(), A = d - 1, S.AddOriginalElement(d, m + 1), M = b - 1 - e), P >= 0 && (e = (c = this.m_forwardHistory[P])[0], L = 1, N = c.length - 1)
                    } while (--P >= -1);
                    if (C = S.getReverseChanges(), y[0]) {
                        ...
                        S = new s, L = u, N = a, M = p[0] - _[0] - l,
                            A = Number.MAX_VALUE, P = v ? this.m_reverseHistory.length - 1 : this.m_reverseHistory.length - 2;
                        do {
                            (b = M + o) === L || b < N && f[b - 1] >= f[b + 1] ? (m = (d = f[b + 1] - 1) - M - l, d > A && S.MarkNextChange(), A = d + 1, S.AddOriginalElement(d + 1, m + 1), M = b + 1 - o) : (m = (d = f[b - 1]) - M - l, d > A && S.MarkNextChange(), A = d, S.AddModifiedElement(d + 1, m + 1), M = b - 1 - o), P >= 0 && (o = (f = this.m_reverseHistory[P])[0], L = 1, N = f.length - 1)
                        } while (--P >= -1);
                        E = S.getChanges()
                    }
                    ...
                    for (f = 1; f <= g / 2 + 1; f++) {
                        var A = 0,
                            P = 0;
                        for (d = this.ClipDiagonalBound(b - f, f, b, _), h = this.ClipDiagonalBound(b + f, f, b, _), N = d; N <= h; N += 2) {
                            for (c = (l = N === d || N < h && v[N - 1] < v[N + 1] ? v[N + 1] : v[N - 1] + 1) - (N - b) - E, M = l; l < t && c < i && this.ElementsAreEqual(l + 1, c + 1);) l++, c++;
                            if (v[N] = l, l + c > A + P && (A = l, P = c), !L && Math.abs(N - C) <= f - 1 && l >= y[N]) return s[0] = l, u[0] = c,
                                M <= y[N] && f <= 1448 ? this.WALKTRACE(b, d, h, E, C, p, m, S, v, y, l, t, s, c, i, u, L, a) : null
                        }
                        var w = (A - e + (P - r) - f) / 2;
                        if (null !== this.ContinueProcessingPredicate && !this.ContinueProcessingPredicate(A, this.OriginalSequence, w)) return a[0] = !0, s[0] = A, u[0] = P, w > 0 && f <= 1448 ? this.WALKTRACE(b, d, h, E, C, p, m, S, v, y, l, t, s, c, i, u, L, a) : (e++, r++, [new n.DiffChange(e, t - e + 1, r, i - r + 1)]);
                        for (p = this.ClipDiagonalBound(C - f, f, C, _), m = this.ClipDiagonalBound(C + f, f, C, _), N = p; N <= m; N += 2) {
                            for (c = (l = N === p || N < m && y[N - 1] >= y[N + 1] ? y[N + 1] - 1 : y[N - 1]) - (N - C) - S, M = l; l > e && c > r && this.ElementsAreEqual(l, c);) l--, c--;
                            if (y[N] = l, L && Math.abs(N - b) <= f && l <= v[N]) return s[0] = l, u[0] = c, M >= v[N] && f <= 1448 ? this.WALKTRACE(b, d, h, E, C, p, m, S, v, y, l, t, s, c, i, u, L, a) : null
                        }
                        if (f <= 1447) {
                            var D = new Array(h - d + 2);
                            D[0] = b - d + 1, o.Copy(v, d, D, 1, h - d + 1), this.m_forwardHistory.push(D), (D = new Array(m - p + 2))[0] = C - p + 1, o.Copy(y, p, D, 1, m - p + 1), this.m_reverseHistory.push(D)
                        }
                    }
                    return this.WALKTRACE(b, d, h, E, C, p, m, S, v, y, l, t, s, c, i, u, L, a)
                    ...
                    return function() {
                        for (var e = r._first; e instanceof n; e = e.next)
                            if (e === i) {
                                ...
                                } else e.prev || e.next ? e.next ? e.prev || (r._first = r._first.next, r._first.prev = void 0) : (r._last = r._last.prev,
                                    r._last.next = void 0) : (r._first = void 0, r._last = void 0);
                                break
                            }
                    }
        ...
        if (t.LANGUAGE_DEFAULT = "en", "object" == typeof process && "function" == typeof process.nextTick && "string" == typeof process.platform) {
            n = "win32" === process.platform, r = "darwin" === process.platform, i = "linux" === process.platform, u = t.LANGUAGE_DEFAULT, a = t.LANGUAGE_DEFAULT;
            var c = process.env.VSCODE_NLS_CONFIG;
            if (c) try {
                var f = JSON.parse(c),
                    d = f.availableLanguages["*"];
                u = f.locale, a = d || t.LANGUAGE_DEFAULT, l = f._translationsConfigFile
            } catch (e) {}
            o = !0
        } else if ("object" == typeof navigator) {
            var h = navigator.userAgent;
            n = h.indexOf("Windows") >= 0, r = h.indexOf("Macintosh") >= 0, i = h.indexOf("Linux") >= 0, s = !0, a = u = navigator.language
        }
        ...
        var p = 0;
        o && (r ? p = 1 : n ? p = 3 : i && (p = 2)), t.isWindows = n, t.isMacintosh = r, t.isLinux = i, t.isNative = o, t.isWeb = s, t.platform = p, t.isRootUser = function() {
            return o && !n && 0 === process.getuid()
        }, t.language = a, t.locale = u, t.translationsConfigFile = l;
        var m = "object" == typeof self ? self : "object" == typeof global ? global : {};
        t.globals = m;
        var g = null;
        ...
        t.format = function(e) {
                for (var t = [], n = 1; n < arguments.length; n++) t[n - 1] = arguments[n];
                return 0 === t.length ? e : e.replace(h, function(e, n) {
                    var r = parseInt(n, 10);
        ...
        var p = /(?:[\u05BE\u05C0\u05C3\u05C6\u05D0-\u05F4\u0608\u060B\u060D\u061B-\u064A\u066D-\u066F\u0671-\u06D5\u06E5\u06E6\u06EE\u06EF\u06FA-\u0710\u0712-\u072F\u074D-\u07A5\u07B1-\u07EA\u07F4\u07F5\u07FA-\u0815\u081A\u0824\u0828\u0830-\u0858\u085E-\u08BD\u200F\uFB1D\uFB1F-\uFB28\uFB2A-\uFD3D\uFD50-\uFDFC\uFE70-\uFEFC]|\uD802[\uDC00-\uDD1B\uDD20-\uDE00\uDE10-\uDE33\uDE40-\uDEE4\uDEEB-\uDF35\uDF40-\uDFFF]|\uD803[\uDC00-\uDCFF]|\uD83A[\uDC00-\uDCCF\uDD00-\uDD43\uDD50-\uDFFF]|\uD83B[\uDC00-\uDEBB])/;
        ...
        t.isBasicASCII = function(e) {
            ...
            t.containsFullWidthCharacter = function(e) {
                ...
                return !1
            }, t.isFullWidthCharacter = f, t.lcut = function(e, n) {
        ...
        t.removeAnsiEscapeCodes = function(e) {
            return e && (e = (e = (e = e.replace(_, "")).replace(v, "")).replace(y, "")), e
            ...
            return void 0 === t && (t = !1), !!e && (t && (e = e.replace(/\\./g, "")),
                e.toLowerCase() !== e)
    ...
    r(e[8], t([0, 1, 5]), function(e, t, n) {
        ...
        function r(e, t, n) {
            ...
            for (var r = void 0, i = -1, o = n; o < e.length; o++) {
                ...
                if (s >= 97 && s <= 122 || s >= 65 && s <= 90 || s >= 48 && s <= 57 || 45 === s || 46 === s || 95 === s || 126 === s || t && 47 === s) - 1 !== i && (r += encodeURIComponent(e.substring(i, o)), i = -1), void 0 !== r && (r += e.charAt(o));
                else {
                    void 0 === r && (r = e.substr(0, o));
                    var u = _[s];
                    void 0 !== u ? (-1 !== i && (r += encodeURIComponent(e.substring(i, o)), i = -1), r += u) : -1 === i && (i = o)
                }
            }
        ...
        function i(e) {
            return e.authority && e.path.length > 1 && "file" === e.scheme ? "//" + e.authority + e.path : e.path
        }
        ...
        function s(e, t) {
            ...
            if (u) {
                ...
                if (u.length >= 3 && 47 === u.charCodeAt(0) && 58 === u.charCodeAt(2)) {
                    (p = u.charCodeAt(1)) >= 65 && p <= 90 ? (u = "/" + String.fromCharCode(p + 32) + ":" + u.substr(3), d = 3) : p >= 97 && p <= 122 && (d = 3)
                } else if (u.length >= 2 && 58 === u.charCodeAt(1)) {
                    var p = u.charCodeAt(0);
                    p >= 65 && p <= 90 ? (u = String.fromCharCode(p + 32) + ":" + u.substr(2), d = 2) : p >= 97 && p <= 122 && (d = 2)
                }
                ("file" !== o || u.length > d && 47 !== u.charCodeAt(d)) && (d = 0), i += n(u, !0, d)
            }
            ...
            m = function() {
                ...
                return e.isUri = function(t) {
                    ...
                    if (n.isWindows && (e = e.replace(/\\/g, h)), e[0] === h && e[1] === h) {
                        var r = e.indexOf(h, 2); - 1 === r ? (t = e.substring(2), e = h) : (t = e.substring(2, r), e = e.substring(r) || h)
                    }
        ...
        var g = function(e) {
            ...
            _ = (u = {}, u[58] = "%3A", u[47] = "%2F", u[63] = "%3F", u[35] = "%23", u[91] = "%5B", u[93] = "%5D", u[64] = "%40", u[33] = "%21", u[36] = "%24", u[38] = "%26", u[39] = "%27", u[40] = "%28",
                u[41] = "%29", u[42] = "%2A", u[43] = "%2B", u[44] = "%2C", u[59] = "%3B", u[61] = "%3D", u[32] = "%20", u)
    });
    var s;
    ! function() {
        ...
        t("WinJS/Core/_Global", [], function() {
            ...
            t("WinJS/Core/_Base", ["WinJS/Core/_WinJS", "WinJS/Core/_Global", "WinJS/Core/_BaseCoreUtils", "WinJS/Core/_WriteProfilerMark"], function(e, t, n, r) {
                    ...
                    if (i) {
                        ...
                        for (s = 0, u = Array.isArray(i) ? i.length : 1; s < u; s++) {
                            var a = 1 === u ? i : i[s],
                                c = a.e,
                                f = a.promise,
                                d = e.Debug && (r && r.name === M ? e.Debug.MS_ASYNC_OP_STATUS_CANCELED : e.Debug.MS_ASYNC_OP_STATUS_ERROR);
                ...
                P.all = P.promise | P.thenPromise | P.errorPromise | P.exceptionPromise | P.completePromise;
                var w, D, I, x, O, k, R, U, T, F, W = 1;
                w = {
                    name: "created",
                    enter: function(e) {
                        e._setState(D)
                    ...
                    enter: function(e) {
                        var t = e._value;
                        if (t instanceof K && t._state !== F && t._state !== U) y(t, {
                            promise: e
                        });
                        else {
                            var n = function(r) {
                    ...
                    enter: function(e) {
                        if (e.done = Y.prototype.done, e.then = Y.prototype.then,
                            e._listeners)
                ...
                var q, j = n.Class.define(null, {
                    ...
                    B = n.Class.define(function(e) {
                        A && (!0 === A || A & P.errorPromise) && (this._stack = H._getStack()), this._value = e, _(this, e, f)
                    }, {
                        cancel: function() {},
                        done: function(e, t) {
                            var n = this._value;
                    ...
                    V = n.Class.derive(B, function(e) {
                        A && (!0 === A || A & P.exceptionPromise) && (this._stack = H._getStack()), this._value = e, _(this, e, d)
                    }, {}, {
                        supportedForProcessing: !1
                    }),
                    Y = n.Class.define(function(e) {
                        if (A && (!0 === A || A & P.completePromise) && (this._stack = H._getStack()), e && "object" == typeof e && "function" == typeof e.then) {
                            var t = new K(null);
                    ...
                    H = n.Class.derive(j, function(e, t) {
                        A && (!0 === A || A & P.promise) && (this._stack = H._getStack()), this._oncancel = t, this._setState(w), this._run();
                        try {
                            ...
                            return new H(function(t, n) {
                                ...
                                r.forEach(function(o) {
                                    H.as(e[o]).then(function() {
                                        ...
                                        s instanceof Error && s.name === M ? ++i === r.length && t(H.cancel) : n({
                                            key: o,
                                            value: e[o]
                                        })
                                    })
    ...
    r(e[21], t([0, 1, 4, 3]), function(e, t, n, r) {
            ...
            function s(e, t, n, r, i) {
                if (!(r <= n)) {
                    var o = n + (r - n) / 2 | 0;
                    s(e, t, n, o, i),
                        s(e, t, o + 1, r, i), t(e[o], e[o + 1]) <= 0 || function(e, t, n, r, i, o) {
            ...
            function l(e, t, n) {
                function r(e, t, n) {
                    ...
                    if (0 !== t || 0 !== n.length) {
                        var o = i[i.length - 1];
                        o && o.start + o.deleteCount === e ? (o.deleteCount += t, (r = o.toInsert).push.apply(r, n)) : i.push({
                            start: e,
                            deleteCount: t,
                            toInsert: n
                        })
                ...
                for (var i = [], o = 0, s = 0;;) {
                    ...
                    var u = e[o],
                        a = t[s],
                        l = n(u, a);
                    0 === l ? (o += 1, s += 1) : l < 0 ? (r(o, 1, []), o += 1) : l > 0 && (r(o, 0, [a]), s += 1)
                }
                return i
            }
            ...
            Object.defineProperty(t, "__esModule", {
                ...
                return -(r + 1)
            }, t.findFirstInSorted = i, t.mergeSort = o, t.groupBy = function(e, t) {
                for (var n, r = [], i = 0, s = o(e.slice(0), t); i < s.length; i++) {
                    var u = s[i];
                    n && 0 === t(n[0], u) ? n.push(u) : (n = [u], r.push(n))
                }
                return r
            }, t.sortedDiff = l, t.delta = function(e, t, n) {
                ...
                var l = this;
                return 0 === i ? r.TPromise.as([]) : new r.TPromise(function(r, f) {
                    u(l, void 0, void 0, function() {
                        var r, u, l, f;
                        return a(this, function(a) {
                            switch (a.label) {
                                case 0:
                                    r = e.length, u = e.slice(0, i).sort(t), l = i, f = Math.min(i + o, r), a.label = 1;
                                case 1:
                                    return l < r ? l > i ? [4, new Promise(function(e) {
                                        return setTimeout(e)
                                    })] : [3, 3] : [3, 5];
                                case 2:
                                    a.sent(), a.label = 3;
                ...
                for (var n = 0, r = 0; r < e.length; r++) e[r] && (e[n] = e[r], n += 1);
                e.length = n
                ...
                for (var n = "number" == typeof t ? function() {
                        var e = 179426549 * Math.sin(t++);
                        return e - Math.floor(e)
                    } : Math.random, r = e.length - 1; r > 0; r -= 1) {
            ...
            var _ = function(e) {
                ...
                return o(t, e), t.prototype.fireAsync = function(e) {
                        ...
                        return a(this, function(a) {
                            switch (a.label) {
                                case 0:
                                    ...
                                    for (this._asyncDeliveryQueue || (this._asyncDeliveryQueue = []), t = this._listeners.iterator(), r = t.next(); !r.done; r = t.next()) u = [], this._asyncDeliveryQueue.push([r.value, e(u, "function" == typeof r.value ? r.value : r.value[0]), u]);
                                    a.label = 1;
                                case 1:
                                    if (!(this._asyncDeliveryQueue.length > 0)) return [3, 3];
                                    i = this._asyncDeliveryQueue.shift(), o = i[0], s = i[1], u = i[2];
                                    try {
                                        "function" == typeof o ? o.call(void 0, s) : o[0].call(o[1], s)
                                    } catch (e) {
            ...
            var v = function() {
                function e() {
                    var e = this;
                    this.hasListeners = !1, this.events = [], this.emitter = new g({
            ...
            t.EventMultiplexer = v, t.fromCallback = function(e) {
                var t, n = new g({
                    onFirstListenerAdd: function() {
            ...
            t.EventBufferer = y, t.mapEvent = f, t.forEach = d, t.filterEvent = h, t.signalEvent = function(e) {
                return e
            };
            var b = function() {
                function e(e) {
            ...
            var C = function() {
                function e() {
                    var e = this;
                    this.listening = !1, this.inputEvent = m.None, this.inputEventListener = i.Disposable.None, this.emitter = new g({
                        onFirstListenerDidAdd: function() {
            ...
            t.Relay = C, t.fromNodeEventEmitter = function(e, t, n) {
        ...
        r(e[29], t([0, 1, 4, 10, 3, 5]), function(e, t, n, r, i, s) {
            ...
            t.logOnceWebWorkerWarning = function(e) {
                s.isWeb && (a || (a = !0, console.warn("Could not create web worker(s). Falling back to loading web worker code in main thread, which might cause UI freezes. Please see https://github.com/Microsoft/monaco-editor#faq")), console.warn(e.message))
            };
            var l = function() {
                    function e(e) {
                ...
                c = function(e) {
                    function t(t, n) {
                        ...
                        var a = null;
                        void 0 !== self.require && "function" == typeof self.require.getConfig ? a = self.require.getConfig() : void 0 !== self.requirejs && (a = self.requirejs.s.contexts._.config), r._lazyProxy = new i.TPromise(function(e, t) {
                            o = e, s = t
                        }), r._onModuleLoaded = r._protocol.sendMessage(u, [r._worker.getId(), n, a]), r._onModuleLoaded.then(function(e) {
                            for (var t = {}, n = 0; n < e.length; n++) t[e[n]] = f(e[n], c);
                            o(t)
                        }, function(e) {
            ...
            var f = function() {
                function e(e, t) {
                    var n = this;
                    this._requestHandler = t, this._protocol = new l({
                ...
                return e.prototype.onmessage = function(e) {
                    ...
                    var u, a, l = new i.TPromise(function(e, t) {
                        u = e, a = t
                    });
            ...
            var r = function() {
                function e(e, t, n, r) {
                    e > n || e === n && t > r ? (this.startLineNumber = n, this.startColumn = r, this.endLineNumber = e, this.endColumn = t) : (this.startLineNumber = e, this.startColumn = t,
                        this.endLineNumber = n, this.endColumn = r)
                }
                return e.prototype.isEmpty = function() {
            ...
            var o = 5e3,
                ...
                u = function() {
                    function e(t) {
                        ...
                        this._lines = t, this._startColumns = n,
                            this._endColumns = r
                    }
                    return e.prototype.getLength = function() {
                        ...
                        for (var r = [], i = [], o = [], s = 0, u = t; u <= n; u++)
                            for (var l = this._lines[u], c = e ? this._startColumns[u] : 1, f = e ? this._endColumns[u] : l.length + 1, d = c; d < f; d++) r[s] = l.charCodeAt(d - 1), i[s] = u + 1, o[s] = d, s++;
                        return new a(r, i, o)
                    }, e
                }(),
                a = function() {
                ...
                l = function() {
                    ...
                    return e.createFromDiffChange = function(t, n, r) {
                        var i, o, s, u, a, l, c, f;
                        return 0 === t.originalLength ? (i = 0, o = 0, s = 0, u = 0) : (i = n.getStartLineNumber(t.originalStart), o = n.getStartColumn(t.originalStart), s = n.getEndLineNumber(t.originalStart + t.originalLength - 1), u = n.getEndColumn(t.originalStart + t.originalLength - 1)), 0 === t.modifiedLength ? (a = 0, l = 0, c = 0, f = 0) : (a = r.getStartLineNumber(t.modifiedStart),
                            l = r.getStartColumn(t.modifiedStart), c = r.getEndLineNumber(t.modifiedStart + t.modifiedLength - 1), f = r.getEndColumn(t.modifiedStart + t.modifiedLength - 1)), new e(i, o, s, u, a, l, c, f)
                    }, e
                }(),
                c = function() {
                    function e(e, t, n, r, i) {
        ...
        }), r(e[27], t([0, 1, 9, 18, 2, 7, 19, 3, 13, 20, 8]), function(e, t, n, r, i, o, s, u, a, l, c) {
            "use strict";
            Object.defineProperty(t, "__esModule", {
                value: !0
            });
            ...
            var i = function() {
                ...
                return e.prototype.getCount = function() {
                    ...
                    var r = this.values,
                        i = this.prefixSum,
                        o = t.length;
                    return 0 !== o && (this.values = new Uint32Array(r.length + o), this.values.set(r.subarray(0, e), 0),
                        this.values.set(r.subarray(e), e + o), this.values.set(t, e), e - 1 < this.prefixSumValidIndex[0] && (this.prefixSumValidIndex[0] = e - 1), this.prefixSum = new Uint32Array(this.values.length), this.prefixSumValidIndex[0] >= 0 && this.prefixSum.set(i.subarray(0, this.prefixSumValidIndex[0] + 1)), !0)
            ...
            var i = function() {
                function e(e, t, n, r) {
                    this._uri = e,
                        this._lines = t, this._eol = n, this._versionId = r
                }
            ...
            t.MirrorTextModel = i
        }), r(e[30], t([0, 1, 8, 3, 7, 23, 12, 2, 16, 25, 26, 24, 27, 5, 21]), function(e, t, n, r, i, s, u, a, l, c, f, d, h, p, m) {
            "use strict";
            Object.defineProperty(t, "__esModule", {
                value: !0
            });
            var g = function(e) {
                ...
                _ = function() {
                    function t(e) {
                        this.removedListeners = [], this._foreignModuleFactory = e, this._foreignModule = null
                    }
                    return t.prototype.computeDiff = function(e, t, n) {
                        ...
                        for (var s, a = [], l = 0, c = n = m.mergeSort(n, function(e, t) {
                            ...
                            if ("number" == typeof p && (s = p), d) {
                                ...
                                if (h = h.replace(/\r\n|\n|\r/g, o.eol), g !== h)
                                    if (Math.max(h.length, g.length) > t._diffLimit) a.push({
                                        range: d,
                                        text: h
                                    });
                                    else
                                        for (var _ = u.stringDiff(g, h, !1), v = o.offsetAt(i.Range.lift(d).getStartPosition()), y = 0, b = _; y < b.length; y++) {
                                            var C = b[y],
                                                E = o.positionAt(v + C.originalStart),
                                                S = o.positionAt(v + C.originalStart + C.originalLength),
                                                L = {
                        ...
                        if (s) {
                            ...
                            c[l.word] = !0;
                            for (var f = s.createWordIterator(a), d = f.next(); !d.done && u.length <= t._suggestionsLimit; d = f.next()) {
                                var h = d.value;
                        ...
                        var d = f.BasicInplaceReplace.INSTANCE.navigateValueSet(t, a, l, c, n);
            ...
            var v = function(e) {
                ...
                return o(t, e), t.prototype.dispose = function() {
                    ...
                    this._models[e.url] = new g(n.URI.parse(e.url), e.lines, e.EOL, e.versionId)
                }, t.prototype.acceptModelChanged = function(e, t) {
                    if (this._models[e]) {
                        this._models[e].onEvents(t)
                    }
                }, t.prototype.acceptRemovedModel = function(e) {
                    this._models[e] && (this.removedListeners.forEach(function(t) {
                        return t(e)
