                        ...
                        <div className="footer-widgets">
                            <div className="widget footer-branding">
                                {_.get(config, 'footer.logo_img') ? (
                                    <p className="site-logo">
                                        <Link to={safePrefix('/')}>
                                            <img src={_.get(config, 'footer.logo_img.file.url')} alt="Logo" />
                                        </Link>
                                    </p>
                                ) : (
                                ...
                                {_.get(config, 'footer.tagline.tagline') && (
                                    <p className="site-description">{_.get(config, 'footer.tagline.tagline')}</p>
                                )}
                            </div>
                                    ...
                                    <div className="footer-nav-inside">
                                        {_.get(config, 'footer.nav_links') && _.get(config, 'footer.has_nav') && (
                                            <div className="secondary-nav">
                                                <h2 className="widget-title">
                                                    {_.get(config, 'footer.nav_title.nav_title')}
                                                </h2>
                                        ...
                                        {_.get(config, 'footer.has_social') && (
                                            <div className="social-nav">
                                                <h2 className="widget-title">
                                                    {_.get(config, 'footer.social_title.social_title')}
                                                </h2>
                            ...
                            {_.get(config, 'footer.has_subscribe') && (
                                <div className="widget footer-subscribe">
                                    <h2 className="widget-title">
                                        {_.get(config, 'footer.subscribe_title.subscribe_title')}
                                    </h2>
                                    {_.get(config, 'footer.subscribe_content') && (
                                        <p>
                                            {htmlToReact(_.get(config, 'footer.subscribe_content.subscribe_content'))}
                                        </p>
                                    )}
