    ...
    if (i) {
      ...
      for (var c = 0; c < i.length; c += 1) {
        ...
        if (!(g.length < 2)) {
          ...
          h.height = "auto";
          var p = h.maxHeight;
          if (((h.maxHeight = "none"), l.offsetHeight <= t))
            (h.height = u), (h.maxHeight = p);
          else {
            for (var m = g.length - 1, x = 0, y = void 0; x < m; )
              (y = (x + m + 1) >> 1),
                (l[f] = s ? g.slice(0, y).join(" ") : g.slice(0, y)),
                l.insertAdjacentHTML("beforeend", r),
                l.offsetHeight > t ? (m = y - 1) : (x = y);
            (l[f] = s ? g.slice(0, m).join(" ") : g.slice(0, m)),
              l.insertAdjacentHTML("beforeend", r);
            ...
            b.classList.add(a),
              ...
              b.appendChild(H),
              l.insertAdjacentElement("beforeend", b),
              (h.height = u),
              (h.maxHeight = p);
          }
        }
