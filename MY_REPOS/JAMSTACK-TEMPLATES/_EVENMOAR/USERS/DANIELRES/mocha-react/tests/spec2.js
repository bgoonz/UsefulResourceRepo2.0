...
describe("Spec 2", function () {
  ...
  it("renders CheckboxWithLabel and stubs BigComplicatedComponent", function () {
    var TestContext =
        require("./lib/TestContext").getRouterComponent(MyComponent),
    ...
    TestUtils.findRenderedDOMComponentWithClass(component, "CheckboxWithLabel");
  });

  it("renders CheckboxWithLabel and stubs BigComplicatedComponent and checks props", function () {
    var TestContext = require("./lib/TestContext").getRouterComponent(
        MyComponent,
        { myProp: "yadayada" }
      ),
      component = TestContext.component,
