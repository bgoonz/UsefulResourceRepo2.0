...
const entries = [
  ...
  },
  {
    ...
    tags: [
      ...
      "Ruby",
      "DataMapper",
      "Turnip (cucumber-like testing with Rspec)",
    ],
    pic: "tempo.jpg",
    links: {
...
const EntryTitle = styled((p) => (
  <h3 className={p.className}>
    <span className="text" dangerouslySetInnerHTML={{ __html: p.text }} />
    {p.tags && (
    ...
    <div className={`${className}`}>
      <div className="pic">
        {e.links && e.links.pic ? (
          ...
          e.pic && <img src={e.pic} alt={e.name} title={`Project: ${e.name}`} />
        )}
      </div>
      <div className={hasPic}>
        {e.desc && (
          <div className="desc" dangerouslySetInnerHTML={{ __html: e.desc }} />
        )}
        ...
        {e.links && e.links.github && (
          <p className="links">
            ...
            <a
              className="text-link"
              target="_blank"
              href={`https://github.com/${e.links.github}`}
            >
              {e.links.github}
            </a>
          </p>
        ...
        {e.links && e.links.web && (
          <p className="links">
            ...
            <a className="text-link" target="_blank" href={e.links.web.href}>
              {e.links.web.text}
            </a>
          </p>
        )}
