...
const ICode = () => <_ICode style={{ position: "relative", left: 1.5 }} />;
...
class Template extends React.Component {
  render() {
    ...
    const header = (
      <div>
        <div style={{ textAlign: "center" }}>
          <I>
            <Link title="Articles" to={prefixLink("/")}>
              <IHome />
            </Link>
          </I>

          <I>
            <Link title="Programming" to={prefixLink("/dev/")}>
              <ICode />
            </Link>
          </I>

          <I>
            <Link title="Creations" to={prefixLink("/gallery/")}>
              <IPicture />
            </Link>
          </I>

          <I>
            <Link title="About" to={prefixLink("/about/")}>
              <IAbout />
            </Link>
          </I>
        </div>
    ...
    return include(access(this, "props.location.pathname"), "/cv/") ? (
      <div>{children}</div>
    ) : (
      <Container>
        <Ribbon />
