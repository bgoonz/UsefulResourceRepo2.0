      ...
      (Array.from = (function () {
        ...
        return function (t) {
          ...
          for (
            var o,
              l = s(i.length),
              c = e(n) ? Object(new n(l)) : new Array(l),
              u = 0;
            u < l;

          )
            (o = i[u]),
              (c[u] = r ? (void 0 === a ? r(o, u) : r.call(a, o, u)) : o),
              (u += 1);
          return (c.length = l), c;
        };
      })()),
      ...
      return (
        n(e, [
          ...
          },
          {
            key: "_setRole",
            value: function (t, e) {
              (("boolean" == typeof this.settings.roles &&
                this.settings.roles) ||
                (void 0 !== this.settings.roles[t] &&
                  !1 !== this.settings.roles[t])) &&
          ...
          },
          {
            ...
            value: function () {
              ...
              this.headers.forEach(function (e, n) {
                e.setAttribute(
                  "id",
                  "badger-accordion-header-".concat(t.ids[n].id)
                ),
                  e.setAttribute(
                    "aria-controls",
                    "badger-accordion-panel-".concat(t.ids[n].id)
                  );
              });
            },
          },
