    ...
    var defaults = $.extend(
      {
        ...
        autoPlay: { enable: !0, interval: 5000, pauseOnHover: !0 },
    ...
    var methods = {
      ...
      initializeItems: function () {
        ...
        if (settings.infinite) {
          ...
          object.css({ left: -itemsWidth * Math.floor(childSet.length / 2) });
        }
      ...
      appendHTML: function () {
        ...
        object.wrap(
          "<div class='nbs-ctp_wud-container'><div class='nbs-ctp_wud-inner'></div></div>"
        );
        ...
        if (
          ...
          $(
            "<div class='nbs-ctp_wud-nav-left'></div><div class='nbs-ctp_wud-nav-right'></div>"
