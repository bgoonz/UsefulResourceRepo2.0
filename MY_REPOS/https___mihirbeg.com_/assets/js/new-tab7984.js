!(function (t) {
  ...
  function (t, n, r) {
    ...
    t.exports = function (t) {
      return (
        i(a, t) || (c && i(s, t) ? (a[t] = s[t]) : (a[t] = l("Symbol." + t))),
        a[t]
      );
    };
  },
  ...
  function (t, n, r) {
    ...
    t.exports = function (t, n, r, s, v, b, m) {
      ...
      if (
        ...
        else e({ target: n, proto: !0, forced: d || A }, x);
      return x;
    };
  },
  function (t, n, r) {
  ...
  function (t, n, r) {
    ...
    var e = r(14),
      ...
      ot = function (t, n) {
        ...
        return (
          z(r, { type: "Symbol", tag: t, description: n }),
          c || (r.description = n),
          r
        );
      },
      ...
      at = function (t, n) {
        ...
        if (r !== W || !l(K, e) || l(Q, e)) {
          var o = U(r, e);
          return (
            !o || !l(K, e) || (l(r, G) && r[G][e]) || (o.enumerable = !0), o
          );
        }
      },
      st = function (t) {
    ...
    (f ||
      ...
      c &&
        ...
        u || _(W, "propertyIsEnumerable", ft, { unsafe: !0 }))),
    e({ global: !0, wrap: !0, forced: !f, sham: !f }, { Symbol: H }),
    R(S(tt), function (t) {
      N(t);
    }),
    e(
  ...
  function (t, n, r) {
    ...
    (t.exports = c(
      ...
      "Array",
      function (t, n) {
        f(this, { type: "Array Iterator", target: e(t), index: 0, kind: n });
      },
      function () {
        var t = a(this),
          n = t.target,
  ...
  function (t, n, r) {
    ...
    var e = function (t) {
        ...
        if (
          "A" ===
            (null == t || null === (n = t.tagName) || void 0 === n
              ? void 0
              : n.toUpperCase()) &&
          r.test(null == t ? void 0 : t.getAttribute("href"))
        ) {
          var e = t.getAttribute("rel");
          (!e || e.indexOf("noopener") < 0) &&
            t.setAttribute("rel", "".concat(e ? e + " " : "", "noopener")),
            t.setAttribute("target", "_blank"),
            t.setAttribute(
              "aria-label",
              "".concat(t.innerText, " (opens in a new tab)")
            ),
