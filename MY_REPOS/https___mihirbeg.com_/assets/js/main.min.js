!(function (t) {
              ...
              return new Promise(function (n, i) {
                ...
                f.setAttribute("src", "" + s + l + "=" + p),
                  ...
                  (u = setTimeout(function () {
                    i(new Error("JSONP request to " + t + " timed out")),
                      r(p),
                      a(d),
                      (window[p] = function () {
                        r(p);
                  ...
                  (f.onerror = function () {
                    i(new Error("JSONP request to " + t + " failed")),
                      r(p),
                      a(d),
                      u && clearTimeout(u);
                  });
  ...
  function (t, e, n) {
     ...
     */ function i(t, e, n) {
      return (e =
        null == e ? n || 0 : e < 0 ? Math.max(t + e, 0) : Math.min(e, t));
    }
    t.exports = function (t, e, n) {
      var o = t.length,
        r = [];
  ...
  function (t, e, n) {
    ...
    !(function (e) {
      ...
      function a(t) {
        for (
          var e, n, i = {}, a = /^data\-/, s = t.attributes.length, c = -1;
          ++c < s;
    ...
    (function (e, n) {
      ...
      (i = function () {
        ...
        function M(t) {
          ...
          if (0 !== e.length) {
            for (
              var i = void 0, o = void 0, r = t._result, a = 0;
              a < e.length;
              a += 3
            )
              (i = e[a]), (o = e[a + n]), i ? A(n, i, o, r) : o(r);
  ...
  function (t, e, n) {
        ...
        return (
          t && void 0 !== t.splitText && t.parentNode && (!t._component || o)
            ...
            : ((r = document.createTextNode(e)),
              t && (t.parentNode && t.parentNode.replaceChild(r, t), C(t, !0))),
          (r.__preactattr_ = !0),
          r
        );
      var s,
            ...
            (function (t, e, n, i, o) {
              ...
              if (0 !== v)
                for (var g = 0; g < v; g++) {
                  ...
                  null !=
                  (S =
                    m && I ? (w._component ? w._component.__key : I.key) : null)
                    ? (f++, (d[S] = w))
                    : (I ||
                        (void 0 !== w.splitText
                          ? !o || w.nodeValue.trim()
              ...
              if (0 !== m)
                for (g = 0; g < m; g++) {
                  var S;
                  if (((c = e[g]), (l = null), null != (S = c.key)))
                    f && void 0 !== d[S] && ((l = d[S]), (d[S] = void 0), f--);
                  else if (b < h)
                    for (r = b; r < h; r++)
              ...
              if (f) for (var g in d) void 0 !== d[g] && C(d[g], !1);
    ...
    function D(t, e, n, i, o) {
      t._disable ||
        ...
        i &&
          i !== t.context &&
          (t.prevContext || (t.prevContext = t.context), (t.context = i)),
      ...
      if (!t._disable) {
        ...
        if (
          (t.constructor.getDerivedStateFromProps &&
            ((l = d(d({}, l), t.constructor.getDerivedStateFromProps(s, l))),
            (t.state = l)),
          v &&
            ((t.props = p),
            (t.state = f),
          ...
          (o = t.render(s, l, u)),
            t.getChildContext && (u = d(d({}, u), t.getChildContext())),
            v &&
          ...
          if ("function" == typeof j) {
            ...
            (a = m),
              ...
              (m || 1 === e) &&
                (a && (a._component = null),
                (S = N(a, o, u, n || !v, m && m.parentNode, !0)));
          if (m && S !== m && r !== y) {
            var O = m.parentNode;
            O &&
              S !== O &&
              (O.replaceChild(S, m), I || ((m._component = null), C(m, !1)));
          }
        ...
        for (
          !v || n
            ? k.unshift(t)
            : g ||
              (t.componentDidUpdate && t.componentDidUpdate(p, f, x),
    ...
    var J = (function (t) {
        function e(t) {
          ...
          return (
            ...
            (n.toggleDisplayTickets = n.toggleDisplayTickets.bind(Y(Y(n)))),
            n
          );
        }
        var n, i, o;
      ...
      Q = function () {
        return p(
          ...
          p(
            "svg",
            { width: "38px", height: "20px", viewBox: "0 0 38 20" },
            p("rect", {
              id: "Rectangle-Copy",
              fill: "#E4695D",
              fillRule: "nonzero",
          ...
          p(
            ...
            p(
              ...
              f &&
                p(
                  ...
                  p("span", null, " @ "),
                  p("span", { className: "bit-startTime" }, r)
                )
            ),
            p(
              "div",
            ...
            u &&
              ...
              p(
                ...
                p("span", { className: "bit-lineUp-with" }, c),
        ...
        return p(
          ...
          p(
            ...
            p(
              ...
              p(
                "a",
                { className: "bit-rsvp bit-button", href: l, target: u },
                c
              )
            )
          )
    ...
    var dt = (function (t) {
      ...
      vt = function () {
        return p(
          ...
          p("desc", { id: "bit-imgDesc" }, "Bandsintown Fist Logo"),
          p(
            "g",
            {
              id: "Page-1",
      ...
      ht = function () {
        return p(
          ...
          p("desc", { id: "bit-logoDesc" }, "Bandsintown Fist Logo"),
          p(
            "defs",
            null,
            p("path", {
          ...
          p(
            "g",
            { fill: "none", fillRule: "evenodd", opacity: "0.402400362" },
            p(
              "g",
              ...
              p(
                ...
                p(
                  ...
                  p(
                    ...
                    p("div", { className: "bit-logo-desktop" }, p(ht, null)),
                    p("div", { className: "bit-logo-mobile" }, p(vt, null))
                  )
                )
              )
          )
    ...
    var Tt = function (t) {
        ...
        if (!e) return p("div", { className: "bit-widget" }, p(R, null));
        ...
        return p(
          ...
          r ? p(R, null) : p(bt, jt({}, u, { showingPastEvents: a }))
        );
      },
      _t = function (t) {
        return t <= 320
      ...
      qt = (function (t) {
        function e(t) {
          ...
          return (
            ...
            (n.handleBreakpoints = n.handleBreakpoints.bind(Xt(Xt(n)))),
            (n.fetchPastEventsData = n.fetchPastEventsData.bind(Xt(Xt(n)))),
            (n.handlePastEventsClick = n.handlePastEventsClick.bind(Xt(Xt(n)))),
            (n.handleUpcomingEventsClick = n.handleUpcomingEventsClick.bind(
              Xt(Xt(n))
            )),
            (n.getUserLocation = n.getUserLocation.bind(Xt(Xt(n)))),
            n
          );
        }
        var n, i, o;
              ...
              value: function () {
                ...
                this.handleBreakpoints(),
                  ...
                  Promise.all([Lt(e.widgetOptions), Kt])
                    ...
                    .catch(function (e) {
                      console.log(e), t.setState({ isLoading: !1, error: e });
                    }),
                ...
                Promise.all([
                  ...
                  .then(function (n) {
                    var i = Vt(n, 2),
                      ...
                      c = a.data,
                      l = o.coords,
                      u = { latitude: l.latitude, longitude: l.longitude };
                    t.setState({
                      rawData: Bt({}, s, { userLocation: u }),
                      data: c && r(Bt({}, s, { userLocation: u }), e),
                    });
                  })
                  .catch(function (t) {
                    console.log(t);
                ...
                this.setState({ isLoading: !0 }),
                  Promise.all([Dt(e.widgetOptions), Kt]).then(function (n) {
                    var i = Vt(n, 2),
                      ...
                      a = t.state.rawData;
                    t.setState({
                      rawData: Bt({}, a, { pastEvents: o }),
                      data: r(Bt({}, a, { pastEvents: o }), e),
                      isLoading: !1,
                      showingPastEvents: !0,
    ...
    window.Promise || n(34).polyfill(),
      ...
      Object(Ie.docReady)(function () {
        ...
        e.observe(document.body, { childList: !0 }),
          (window.BIT.widgetInitializer = { append: Se, mutationObserver: e }),
