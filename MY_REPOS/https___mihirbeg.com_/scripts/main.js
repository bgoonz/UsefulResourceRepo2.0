    ...
    if (0 === c.url.indexOf("disc")) {
      ...
      (first = $("ol.playlist0 a").attr("data-src")),
        ...
        $("ol.playlist0 li").click(function (a) {
          a.preventDefault(),
            "playing" == $(this).attr("class")
              ? ($(this).addClass("pause"), f.playPause())
              : ($(this)
                  .removeClass("pause")
                  .addClass("playing")
                  .siblings()
    ...
    function a() {
      ...
      (first = $("ol.playlist a").attr("data-src")),
        ...
        $(".btnloop").click(function (a) {
          $("audio").attr("loop")
            ? ($("audio").removeAttr("loop"), $(this).removeClass("active"))
            : ($("audio").attr("loop", 0), $(this).addClass("active"));
        });
    }
    $(".player").length > 0 && a();
  }),
    ...
    function b() {
      function a(a) {
        for (
          var b = a.length,
            c = 0,
            d = document.getElementById("twitter-feed"),
            e = '<ul class="slider-twitter">';
          b > c;
    ...
    $(".button-group").on("click", ".button", function () {
      ...
      $(".playerVideo").length > 0 &&
        ...
        jQuery(".play-video").on("click", function (a) {
          jQuery(".play-video").hasClass("playing")
            ? jQuery(".playerVideo").pauseYTP()
            : (jQuery("audio").each(function (a, b) {
                this.pause();
              }),
  ...
  $(function () {
    $(window).bind("scroll", function () {
      $(window).scrollTop() >= 85
        ...
        $(window).scrollTop() >= $(".jIntro").height() / 2
