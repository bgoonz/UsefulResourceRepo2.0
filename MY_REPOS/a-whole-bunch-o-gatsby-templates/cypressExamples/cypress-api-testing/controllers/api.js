...
exports.callingCapital = function (req, res, next) {
  ...
  var country_capital = _.reduce(
    countries,
    function (result, country, key) {
...
exports.callingNativeLanguage = function (req, res, next) {
  ...
  var country_nativelanguage = _.reduce(
    countries,
    function (result, country, key) {
      if (
        country.nativeLanguage.toLowerCase() ==
        nativelanguage_label.toLowerCase()
      ) {
        result.push(country);
      }
      return result;
