describe(`collection-routing`, () => {
  ...
  it(`can navigate to a collection route and see its content rendered`, () => {
    ...
    cy.should(`have.attr`, `data-testslug`, `/2018-12-14-hello-world/`).click()
  ...
  it(`can navigate to a collection route that uses unions and see its content rendered`, () => {
    ...
    cy.should(`have.attr`, `data-testimagename`, `gatsby-astronaut`).click()
    cy.waitForRouteChange().assertRoute(`/collection-routing/gatsby-astronaut/`)
