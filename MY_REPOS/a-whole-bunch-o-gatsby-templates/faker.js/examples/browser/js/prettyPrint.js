  ...
  var util = {
    ...
    type: function (v) {
      try {
        ...
        if (
          /^(string|number|array|regexp|function|date|boolean)$/.test(oType)
        ) {
          return oType;
        }
        if (typeof v === "object") {
    ...
    expander: function (text, title, clickFn) {
      return util.el("a", {
        innerHTML:
          util.shorten(text) + ' <b style="visibility:hidden;">[+]</b>',
        title: title,
