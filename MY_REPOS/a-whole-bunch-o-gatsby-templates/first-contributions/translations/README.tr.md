...
Şimdi bu repoyu bilgisayarınıza klonlayın. Bunun için 'clone' butonuna basıp ardından _copy to clipboard_ ikonuna basın.
...
(Branch ismi içinde _ekle_ kelimesinin zorunluluğu bulunmamakta, fakat bu branch ismimizi contributor listesine eklemek için oluşturduğundan ekle kelimesinin konulması mantıklı olacaktır.)
