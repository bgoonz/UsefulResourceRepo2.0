...
function AnchorLink(_ref) {
  var to = _ref.to,
    ...
    gatsbyLinkProps =
      _ref$gatsbyLinkProps === void 0 ? {} : _ref$gatsbyLinkProps,
    onAnchorLinkClick = _ref.onAnchorLinkClick;
  var onClickHandler = stripHash
    ? _utils.handleStrippedLinkClick
    : _utils.handleLinkClick;

  var linkProps = _objectSpread(
    _objectSpread({}, gatsbyLinkProps),
    {},
    {
      /**
