...
if (!extension_loaded("mysql") && !function_exists("mysql_connect")) {
    ...
    if (function_exists("getLinkIdentifier")) {
        trigger_error(
            'The function name "getLinkIdentifier" is already defined, please change the function name',
            E_USER_ERROR
        );
    }
    ...
    {
        trigger_error(
            "This function was deprecated in PHP 4.3.0 and is therefor not supported",
            E_USER_DEPRECATED
        );
        return false;
    }
    ...
    {
        trigger_error(
            "The function mysql_db_name() is not implemented",
            E_USER_WARNING
        );
        return false;
    }
    ...
    {
        trigger_error(
            "This function is deprecated. It is preferable to use mysql_query() to issue an SQL Query: SHOW DATABASES statement instead.",
            E_USER_DEPRECATED
        );
    ...
    function mysql_list_fields(
        ...
        return mysqli_query(
            $mysqli,
            sprintf("SHOW COLUMNS FROM %s.%s", $db, $table)
        );
    }
    ...
    {
        trigger_error(
            "This function is deprecated since PHP 4.3.0 and therefore not implemented",
            E_USER_DEPRECATED
        );
        return false;
    }
    ...
    {
        trigger_error(
            "This function is deprecated since PHP 5.3.0 and therefore not implemented",
            E_USER_DEPRECATED
        );
        return false;
    }
