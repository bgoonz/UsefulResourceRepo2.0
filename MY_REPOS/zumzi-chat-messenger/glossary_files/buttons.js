...
!(function () {
  ...
  var e = window.document,
    ...
    x = function (e, t) {
      return (
        "@media(prefers-color-scheme:" + e + "){" + k[m(k, t) ? t : e] + "}"
      );
    },
    z = {
      "comment-discussion": {
    ...
    F = function (e, t, o) {
      var r = p(e.ownerDocument),
        ...
        n =
          ...
          (function (e) {
            ...
            return (
              k[m(k, t["no-preference"]) ? t["no-preference"] : "light"] +
              x("light", t.light) +
              x("dark", t.dark)
            );
          })(t["data-color-scheme"]);
      ...
      if (("." + h).substring(h.length - l.length) !== "." + l)
        return c.removeAttribute("href"), void o(d);
      var u = (" /" + c.pathname).split(/\/+/);
      if (
        ((((h === l || h === "gist." + l) && "archive" === u[3]) ||
          (h === l &&
            "releases" === u[3] &&
            ("download" === u[4] ||
              ("latest" === u[4] && "download" === u[5]))) ||
          h === "codeload." + l) &&
          (c.target = "_top"),
    ...
    G = function (t, r) {
      if (null != t && null != r)
        if (
          ...
          var a = v("span");
          F(a.attachShadow({ mode: "closed" }), t, function () {
            r(a);
          });
        } else {
          var n = v("iframe", {
  ...
  t.protocol + "//" + t.host + t.pathname === i
    ? F(e.body, s(window.name || t.hash.replace(/^#/, "")), function () {})
    : (function (t) {
        if (
