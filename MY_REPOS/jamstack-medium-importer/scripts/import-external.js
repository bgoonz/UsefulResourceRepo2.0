...
let argv = yargs
  .usage(
    "Usage: $0 --input-file=<input-file> --output-dir=<output-dir> --concurrency=<concurrency> --download-images=<download-images> --import-drafts=<import-drafts>"
  )
  .example(
...
const shouldImportDrafts =
  argv["importDrafts"] && argv["importDrafts"] !== "false";
