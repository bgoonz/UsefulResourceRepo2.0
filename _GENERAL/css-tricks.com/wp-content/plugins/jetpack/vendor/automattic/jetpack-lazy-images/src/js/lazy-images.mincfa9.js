  ...
  function (e, t) {
    var n = function () {
      var e,
        t,
        n,
        a = { rootMargin: "200px 0px", threshold: 0.01 },
        r = [];
      o();
      ...
      function s(t) {
        ...
        if (t instanceof HTMLImageElement) {
          ...
          o >= 0 && e.splice(o, 1),
            t.complete
              ? u.call(t, null)
              : (t.addEventListener("load", u, { once: !0 }),
                t.addEventListener("error", u, { once: !0 }));
          try {
      ...
      i &&
        (i.addEventListener("is.post-load", o),
        i.addEventListener("jetpack-lazy-images-load", o));
    };
