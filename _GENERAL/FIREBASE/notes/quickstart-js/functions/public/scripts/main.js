...
function FunctionsQuickstart() {
  ...
  firebase
    ...
    .ref("/messages")
    .limitToLast(10)
    .on("child_added", this.onNewMessage.bind(this));
}
...
FunctionsQuickstart.prototype.addNumbers = function () {
  ...
  sendNotification({ firstNumber: firstNumber, secondNumber: secondNumber })
  ...
  addMessage({ text: messageText })
    .then(function (result) {
      ...
      if (messageText !== sanitizedMessage) {
        window.alert(
          "You were naughty. Your message was sanitized to:\n\n" +
            sanitizedMessage
        );
      }
