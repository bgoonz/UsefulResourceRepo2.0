...
function testWrapMethodWithArgumentVerifier_wrapperStaticAndProto_valid() {
  fireauth.exportlib.wrapMethodWithArgumentVerifier_('Provider', Provider, []);
...
function testWrapMethodWithArgumentVerifier_constructor_noArgs_valid() {
  var ExportedDog = fireauth.exportlib.wrapMethodWithArgumentVerifier_(
    'Dog',
    Dog,
...
function testWrapMethodWithArgumentVerifier_static_oneArg_valid() {
  obj.exportedFunc = fireauth.exportlib.wrapMethodWithArgumentVerifier_(
    'myFunc',
    obj.myFunc,
