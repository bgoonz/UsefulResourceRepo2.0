...
function testAuthError_errorTranslation_match() {
  ...
  assertEquals(
    ...
    JSON.stringify(translatedError.toJSON())
  );
}
...
function assertErrorCodesHaveCorrectFormat(codes) {
  goog.object.forEach(codes, function (code) {
    var assertMessage = goog.string.format(
      'Error code %s should only ' +
...
function testAuthError_toPlainObject() {
  ...
  assertObjectEquals(authErrorObject, authError.toPlainObject());
}
...
function testAuthErrorWithCredential_toPlainObject() {
  ...
  assertObjectEquals(errorObject, error.toPlainObject());
  ...
  assertObjectEquals(errorObject2, error2.toPlainObject());
  ...
  assertObjectEquals(errorObject3, error3.toPlainObject());
  ...
  assertObjectEquals(errorObject4, error4.toPlainObject());
  ...
  assertObjectEquals(errorObject5, error5.toPlainObject());
}
