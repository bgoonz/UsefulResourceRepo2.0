...
function testValidate_invalid_type() {
  ...
  assertEquals(
    'myFunc failed: First argument "name" must be a valid ' + 'string.',
    error.message
  );
}
...
function testValidate_invalid_isSetter() {
  var error = assertThrows(function () {
    fireauth.args.validate('name', [fireauth.args.string('name')], [13], true);
  });
  assertEquals('auth/argument-error', error.code);
...
function testValidate_invalid_onlyOneValid() {
  ...
  assertEquals(
    'yourFunc failed: Second argument "password" must be a valid ' + 'string.',
    error.message
  );
}
...
function testValidate_invalid_noname() {
  ...
  assertEquals('auth/argument-error', error.code);
  assertEquals(
    'myFunc failed: First argument must be a valid ' + 'string.',
    error.message
  );
}
...
function testValidate_argNumber_tooFew() {
  ...
  assertEquals('myFunc failed: Expected 2 arguments but got 1.', error.message);
}
...
function testValidate_argNumber_tooMany() {
  ...
  assertEquals('myFunc failed: Expected 2 arguments but got 3.', error.message);
}

function testValidate_argNumber_oneValid() {
  var error = assertThrows(function () {
    var expectedArgs = [fireauth.args.string('email')];
    var args = ['foo@bar.com', 'whatamidoinghere'];
    fireauth.args.validate('myFunc', expectedArgs, args);
  });
  assertEquals('myFunc failed: Expected 1 argument but got 2.', error.message);
}
...
function testValidate_argNumber_validRange() {
  ...
  assertEquals(
    'myFunc failed: Expected 1-2 arguments but got 3.',
    error.message
  );
}
...
function testValidate_authCredential_invalid() {
  ...
  assertEquals(
    'myFunc failed: First argument "credential" must be a valid ' +
      'credential.',
    error.message
  );
}
...
function testValidate_authCredential_withType_invalid() {
  var expectedMessage =
    'myFunc failed: First argument "phoneCredential" ' +
...
function testValidate_authCredential_withTypeAndName_invalid() {
  var expectedMessage =
    'myFunc failed: First argument "myArgName" ' +
...
function testValidate_authProvider_invalid() {
  ...
  assertEquals(
    'myFunc failed: First argument "authProvider" must be a valid ' +
      'Auth provider.',
    error.message
  );
}
...
function testValidate_multiFactorInfo_invalid() {
  ...
  assertEquals(
    'myFunc failed: First argument "multiFactorInfo" must be a ' +
      'valid multiFactorInfo.',
    error.message
  );
}
...
function testValidate_phoneInfoOptions_enrollWithPhoneHint() {
  ...
  assertEquals(
    'myFunc failed: First argument "phoneInfoOptions" must be ' +
      'valid phone info options.',
    error.message
  );
}
...
function testValidate_or_invalid() {
  ...
  assertEquals('auth/argument-error', error.code);
  assertEquals(
    'myFunc failed: First argument "strOrBool" must be a valid ' +
      'string or a boolean.',
    error.message
  );
}
...
function testValidate_or_nested_invalid() {
  ...
  assertEquals(
    'myFunc failed: First argument "strOrBoolOrNull" must be a ' +
      'valid string or a boolean or null.',
    error.message
  );
}
...
function testValidate_number_valid() {
  fireauth.args.validate('myFunc', [fireauth.args.number('myNumber')], [-12.4]);
}
...
function testValidate_number_invalid() {
  ...
  assertEquals(
    'myFunc failed: First argument "myNumber" must be a valid ' + 'number.',
    error.message
  );
}
...
function testValidate_object_invalid() {
  var error = assertThrows(function () {
    fireauth.args.validate('myFunc', [fireauth.args.object('myObject')], [13]);
  });
  assertEquals(
    'myFunc failed: First argument "myObject" must be a valid ' + 'object.',
    error.message
  );
}
...
function testValidate_function_invalid() {
  var error = assertThrows(function () {
    fireauth.args.validate('myFunc', [fireauth.args.func('myCallback')], [{}]);
  });
  assertEquals(
    'myFunc failed: First argument "myCallback" must be a ' + 'function.',
    error.message
  );
}

function testValidate_null_valid() {
  fireauth.args.validate('myFunc', [fireauth.args.null()], [null]);
}
...
function testValidate_null_invalid() {
  ...
  assertEquals(
    'myFunc failed: First argument "noArg" must be null.',
    error.message
  );
}

function testValidate_firebaseAuth_valid() {
  fireauth.args.validate('myFunc', [fireauth.args.firebaseAuth()], [auth]);
}
...
function testValidate_firebaseAuth_invalid() {
  ...
  assertEquals(
    'myFunc failed: First argument "auth" must be an instance of ' +
      'Firebase Auth.',
    error.message
  );
}
...
function testValidate_firebaseUser_valid() {
  fireauth.args.validate('myFunc', [fireauth.args.firebaseUser()], [user]);
}

function testValidate_firebaseUser_valid_optional() {
  fireauth.args.validate('myFunc', [fireauth.args.firebaseUser(true)], []);
}
...
function testValidate_firebaseUser_invalid() {
  ...
  assertEquals(
    'myFunc failed: First argument "user" must be an instance of ' +
      'Firebase User.',
    error.message
  );
}
...
function testValidate_element_invalid() {
  ...
  assertEquals(
    'myFunc failed: First argument "myElement" must be an HTML ' + 'element.',
    error.message
  );
}

function testValidate_firebaseApp_valid() {
  fireauth.args.validate('myFunc', [fireauth.args.firebaseApp()], [app]);
}

function testValidate_firebaseApp_valid_optional() {
  fireauth.args.validate('myFunc', [fireauth.args.firebaseApp(true)], []);
}
...
function testValidate_firebaseApp_invalid() {
  ...
  assertEquals(
    'myFunc failed: First argument "app" must be an instance of ' +
      'Firebase App.',
    error.message
  );
}
...
function testValidate_appVerifier_invalid() {
  ...
  assertEquals(
    'myFunc failed: First argument "applicationVerifier" must be ' +
...
function testValidate_argumentsObj_invalid() {
  ...
  assertEquals(
    'fooFunc failed: First argument "name" must be a valid ' + 'string.',
    error.message
  );
}
...
function testValidate_multiFactorAssertion_withTypeAndName_invalid() {
  var expectedMessage =
    'myFunc failed: First argument "myArgName" ' +
    'must be a valid other multiFactorAssertion.';
  var expectedArgs = [fireauth.args.multiFactorAssertion('other', 'myArgName')];
  var error = assertThrows(function () {
    var cred = fireauth.PhoneAuthProvider.credential('verificationId', 'code');
    var args = [fireauth.PhoneMultiFactorGenerator.assertion(cred)];
    fireauth.args.validate('myFunc', expectedArgs, args);
