 ...
 * @return {!goog.Promise}
 */
fireauth.storage.testHelper.FakeAsyncStorage.prototype.getItem = function (
  key
) {
 ...
 * @return {!goog.Promise}
 */
fireauth.storage.testHelper.FakeAsyncStorage.prototype.setItem = function (
  key,
  value
) {
 ...
 * @return {!goog.Promise}
 */
fireauth.storage.testHelper.FakeAsyncStorage.prototype.removeItem = function (
  key
) {
