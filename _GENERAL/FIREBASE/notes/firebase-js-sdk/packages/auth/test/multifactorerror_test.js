  ...
  assertObjectEquals(
    {
      ...
      'message':
        'Proof of ownership of a second factor is required to ' +
        'complete sign-in.',
...
function testMultiFactorError_fromPlainObject() {
  ...
  var responseWithCredentialAndMessage = goog.object.clone(
    responseWithCredential
  );
  ...
  assertObjectEquals(
    ...
    fireauth.MultiFactorError.fromPlainObject(
      responseWithCredentialAndMessage,
      auth,
      onIdTokenResolver
    )
  );
