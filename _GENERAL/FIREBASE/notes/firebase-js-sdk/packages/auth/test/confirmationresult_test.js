...
function testConfirmationResult() {
  ...
  var credentialInstance = mockControl.createStrictMock(
    fireauth.PhoneAuthCredential
  );
  var credential = mockControl.createMethodMock(
...
function testConfirmationResult_initialize_success() {
  return installAndRunTest(
    'confirmationResult_initialize_success',
    function () {
      var expectedVerificationId = 'VERIFICATION_ID';
      ...
      var confirmationResultInstance = mockControl.createStrictMock(
      ...
      confirmationResultConstructor(expectedVerificationId, credentialResolver)
        .$returns(confirmationResultInstance)
        .$once();
      mockControl.$replayAll();
