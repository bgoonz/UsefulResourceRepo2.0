...
function testActionCodeURL_getOperation() {
  ...
  assertEquals(
    fireauth.ActionCodeInfo.Operation.PASSWORD_RESET,
    actionCodeUrl['operation']
  );

  // REVERT_SECOND_FACTOR_ADDITION email action.
  var revertSeconFactorLink =
    'https://www.example.com/finishSignIn?' +
