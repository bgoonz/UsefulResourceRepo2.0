...
export class _UploadTask {
  ...
  cancel(): boolean;
    ...
    onRejected: (p1: FirebaseStorageError_2) => T | Promise<T>
  ): Promise<T>;
  ...
  on(
    type: TaskEvent_2,
    nextOrObserver?:
      | StorageObserver_2<UploadTaskSnapshot_2>
      | ((a: UploadTaskSnapshot_2) => unknown),
    error?: ErrorFn,
    completed?: CompleteFn_2
  ): Unsubscribe_2 | Subscribe_2<UploadTaskSnapshot_2>;
  pause(): boolean;
  resume(): boolean;
  ...
  then<U>(
    onFulfilled?: ((value: UploadTaskSnapshot_2) => U | Promise<U>) | null,
    onRejected?: ((error: FirebaseStorageError_2) => U | Promise<U>) | null
  ): Promise<U>;
  _transferred: number;
}
