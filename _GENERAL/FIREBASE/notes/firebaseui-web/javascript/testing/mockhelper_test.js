...
function testMockHelper_success() {
  ...
  var method3Assert = myMock["ref2"].assertMethod3([], function () {
    return false;
  });
  ...
  return method1Assert
    ...
    .then(function () {
      ...
      myMock["ref2"].assertMethod4([10], null, function () {
...
function testMockHelper_uncalledApiError() {
  ...
  // error.
  myMock["ref2"].assertMethod3([], function () {
    return false;
  });
  return myMock
    .process()
    ...
    .thenCatch(function (e) {
      assertEquals("missing API request: method3", e.message);
    });
}
...
function testMockHelper_unexpectedApiError() {
  ...
  myMock.install();
  myMock["ref1"].method1(true, { a: 1 }).then(
    function (result) {
      assertEquals("success", result);
  ...
  return myMock
    ...
    .thenCatch(function (e) {
      assertEquals("unexpected API request(s): method3", e.message);
    });
}
