...
function getDialogButtons() {
  var dialog =
    firebaseui.auth.ui.element.dialog.getDialogElement.call(component);
...
function testListBoxDialogFocus() {
  return new goog.Promise(function (resolve, reject) {
    ...
    var scrollIntoContainerView = mockControl.createMethodMock(
      goog.style,
      "scrollIntoContainerView"
    );
    var scrollIntoContainerViewDialog =
      new goog.testing.mockmatchers.SaveArgument();
    var scrollIntoContainerViewButton =
      new goog.testing.mockmatchers.SaveArgument();
    scrollIntoContainerView(
      scrollIntoContainerViewButton,
