...
goog.scope(function () {
    ...
    function () {
      ...
      assertTrue(
        goog.dom.classlist.contains(
          this.getCountrySelectorFlagElement_(),
          "firebaseui-flag-US"
        )
      );
  ...
  /** @private */
  element.PhoneNumberTestHelper.prototype.testChangeCountry_ = function () {
    var nationalNumber = "6505550101";
  ...
  element.PhoneNumberTestHelper.prototype.getDialogButtonContainingText_ =
    function (text) {
      var dialog = firebaseui.auth.ui.element.dialog.getDialogElement.call(
        this.component
      );
