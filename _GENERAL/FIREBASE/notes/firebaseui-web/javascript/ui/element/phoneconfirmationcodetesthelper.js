...
goog.scope(function () {
  ...
  goog.inherits(
    element.PhoneConfirmationCodeTestHelper,
    element.ElementTestHelper
  );
  ...
  element.PhoneConfirmationCodeTestHelper.prototype.resetState = function () {
    ...
    goog.dom.forms.setValue(
      this.component.getPhoneConfirmationCodeElement(),
      ""
    );
  ...
  /** @private */
  element.PhoneConfirmationCodeTestHelper.prototype.testGetPhoneConfirmationCodeElement_ =
    function () {
      assertNotNull(this.component.getPhoneConfirmationCodeElement());
    };

  /** @private */
  element.PhoneConfirmationCodeTestHelper.prototype.testGetPhoneConfirmationCodeErrorElement_ =
    function () {
      assertNotNull(this.component.getPhoneConfirmationCodeErrorElement());
    };

  /** @private */
  element.PhoneConfirmationCodeTestHelper.prototype.testCheckAndGetPhoneConfirmationCode_ =
    function () {
