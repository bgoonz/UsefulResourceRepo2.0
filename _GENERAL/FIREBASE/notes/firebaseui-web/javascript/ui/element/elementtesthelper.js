 ...
 */
firebaseui.auth.ui.element.ElementTestHelper.prototype.setComponent = function (
  c
) {
  this.component = c;
  return this;
 ...
 *     itself.
 */
firebaseui.auth.ui.element.ElementTestHelper.prototype.excludeTests = function (
  var_arg
) {
