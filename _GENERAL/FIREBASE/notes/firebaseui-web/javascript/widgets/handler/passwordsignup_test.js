...
function testHandlePasswordSignUp_anonymousUpgrade_success() {
  ...
  externalAuth.currentUser.assertLinkWithCredential([cred], function () {
...
function testHandlePasswordSignUp_anonymousUpgrade_emailInUse() {
  ...
  externalAuth.currentUser.assertLinkWithCredential([cred], null, error);
  return externalAuth
    .process()
    .then(function () {
...
function testHandlePasswordSignUp_emailExistsError_providerNotFound() {
  ...
  testAuth.assertFetchSignInMethodsForEmail([passwordAccount.getEmail()], []);
  return testAuth.process().then(function () {
