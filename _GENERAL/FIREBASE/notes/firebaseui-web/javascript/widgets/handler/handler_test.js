...
function testHandlerRegistration() {
  ...
  assertEquals(
    ...
    firebaseui.auth.widget.handlers_[HandlerName.SEND_EMAIL_LINK_FOR_SIGN_IN]
  );
  assertEquals(
  ...
  assertEquals(
    ...
    firebaseui.auth.widget.handlers_[HandlerName.EMAIL_LINK_NEW_DEVICE_LINKING]
  );
  assertEquals(
  ...
  assertEquals(
    ...
    firebaseui.auth.widget.handlers_[HandlerName.EMAIL_LINK_SIGN_IN_CALLBACK]
  );
  assertEquals(
