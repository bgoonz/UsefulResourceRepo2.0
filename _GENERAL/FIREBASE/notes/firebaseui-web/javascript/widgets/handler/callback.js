 ...
 */
firebaseui.auth.widget.handler.handleCallback = function (
  app,
  container,
  opt_result
) {
 ...
 * @private
 */
firebaseui.auth.widget.handler.handleCallbackResult_ = function (
  app,
  component,
  result
) {
  if (result["user"]) {
    ...
    if (pendingCredential) {
      ...
      app.registerPending(
        result["user"].linkWithCredential(pendingCredential).then(
 ...
 * @private
 */
firebaseui.auth.widget.handler.handleCallbackSuccess_ = function (
  app,
  component,
  authResult
) {
 ...
 * @private
 */
firebaseui.auth.widget.handler.handleCallbackFailure_ = function (
  app,
  component,
  error
) {
 ...
 * @private
 */
firebaseui.auth.widget.handler.handleCallbackLinking_ = function (
  app,
  component,
  email,
  opt_infoBarMessage
 ...
 * @private
 */
firebaseui.auth.widget.handler.handleCallbackEmailMismatch_ = function (
  app,
  component,
  authResult
) {
  ...
  app.registerPending(
    app.clearTempAuthState().then(
      ...
      function (error) {
        ...
        var errorMessage =
          firebaseui.auth.widget.handler.common.getErrorMessage(error["code"]);
