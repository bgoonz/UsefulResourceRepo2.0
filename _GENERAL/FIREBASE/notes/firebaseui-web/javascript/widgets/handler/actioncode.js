...
firebaseui.auth.widget.handler.handlePasswordResetFailure_ = function (
  ...
  if (errorCode == "auth/weak-password") {
    ...
    firebaseui.auth.ui.element.setValid(
      opt_component.getNewPasswordElement(),
      false
    );
    firebaseui.auth.ui.element.show(
      opt_component.getNewPasswordErrorElement(),
      errorMessage
    );
 ...
 * @private
 */
firebaseui.auth.widget.handler.handleEmailChangeRevocationSuccess_ = function (
  app,
  container,
  email
) {
 ...
 * @private
 */
firebaseui.auth.widget.handler.handleEmailChangeRevocationFailure_ = function (
  app,
  container
) {
...
firebaseui.auth.widget.handler.handleEmailVerification = function (
  ...
  app.registerPending(
    app
      ...
      .then(
        function () {
          var component = new firebaseui.auth.ui.page.EmailVerificationSuccess(
            opt_onContinueClick
          );
          component.render(container);
          // Set current UI component.
 ...
 */
firebaseui.auth.widget.handler.handleRevertSecondFactorAddition = function (
  app,
  container,
  actionCode
) {
  ...
  app.registerPending(
    app
      ...
      .then(
        ...
        (error) => {
          const component =
            new firebaseui.auth.ui.page.RevertSecondFactorAdditionFailure();
          component.render(container);
          // Set current UI component.
          app.setCurrentComponent(component);
        }
...
firebaseui.auth.widget.handler.handleRevertSecondFactorAdditionSuccess_ =
  function (app, container, email, multiFactorInfo) {
    let component =
      new firebaseui.auth.ui.page.RevertSecondFactorAdditionSuccess(
