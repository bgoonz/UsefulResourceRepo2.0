...
var passwordIdToken1 =
  "HEADER1.eyJhdWQiOiAiY2xpZW50X2lkIiwgImVtYWlsIjogInVz" +
  "ZXJAZXhhbXBsZS5jb20iLCAiaXNzIjogMTQwNDYzMzQ0MiwgImV4cCI6IDE1MDQ2MzM0NDJ" +
  "9.SIGNATURE1";
var passwordIdToken2 =
  "HEADER2.eyJhdWQiOiAiY2xpZW50X2lkIiwgImVtYWlsIjogInVz" +
  "ZXJAZXhhbXBsZS5jb20iLCAiaXNzIjogMTQwNDYzMzQ0MiwgImV4cCI6IDE1MDQ2MzM0NDJ" +
  "9.SIGNATURE2";
var passwordIdToken3 =
  "HEADER3.eyJhdWQiOiAiY2xpZW50X2lkIiwgImVtYWlsIjogInVz" +
  "ZXJAZXhhbXBsZS5jb20iLCAiaXNzIjogMTQwNDYzMzQ0MiwgImV4cCI6IDE1MDQ2MzM0NDJ" +
  "9.SIGNATURE3";
...
function setUp() {
  ...
  firebase.initializeApp = function (options, name) {
    ...
    if (firebase.instances_[key]) {
      ...
      firebase.instances_[key] = new firebaseui.auth.testing.FakeAppClient(
        options,
        name
      );
    }
  ...
  for (var key in firebaseui.auth.idp.AuthProviders) {
    ...
    if (key != "twitter.com" && key != "password") {
      firebase["auth"][
        firebaseui.auth.idp.AuthProviders[key]
...
function testGetExternalAuth() {
  ...
  assertEquals(
    "subdomain.firebaseapp.com",
    app1.getAuth().app.options.authDomain
  );
  assertEquals(
    testAuth1.app.options.authDomain,
    app1.getAuth().app.options.authDomain
  );
...
function testTempAuth_emulatorConfig_handlesIPV6Hosts() {
  ...
  // Initialize app.
  testAuth.install();
  testAuth.useEmulator("http://[0:0:0:0:0:0:0:0]:1234", {
...
function testGetInstance() {
  ...
  assertEquals(
    'An AuthUI instance already exists for the key "id1"',
    error.message
  );
}
...
function testIsPendingRedirect() {
  ...
  testStubs.replace(firebaseui.auth.util, "getCurrentUrl", function () {
    return currentUrl;
  });
...
function testStart() {
  ...
  var resetWarning =
    "UI Widget is already rendered on the page and is pend" +
  ...
  testStubs.set(firebaseui.auth.log, "warning", goog.testing.recordFunction());
  // No rendered AuthUI.
  ...
  assertConfigEquals(config4, app1.getConfig());
  ...
  assertFalse(firebaseui.auth.storage.hasRedirectStatus(app2.getAppId()));
  app1.getAuth().assertSignOut([]);
...
function testStart_immediateFederatedRedirect_finishRedirect() {
  ...
  app1.getExternalAuth().runAuthChangeHandler();
  app1.getAuth().assertGetRedirectResult([], function () {
...
function testUiChangedCallback() {
  ...
  testStubs.set(firebaseui.auth.widget.dispatcher, "getMode", function () {
...
function testAuthUi_reset() {
  ...
  var p1 = new goog.Promise(function (resolve, reject) {}).thenCatch(function (
    e
  ) {
    assertEquals("cancel", e.name);
    asyncTestCase.signal();
  });
  var p2 = new goog.Promise(function (resolve, reject) {}).thenCatch(function (
    e
  ) {
    assertEquals("cancel", e.name);
    asyncTestCase.signal();
  ...
  assertEquals(
    0,
    firebaseui.auth.AuthUI.prototype.cancelOneTapSignIn.getCallCount()
  );
  var redirectStatus = new firebaseui.auth.RedirectStatus();
...
function testConfig() {
  ...
  assertConfigEquals(config1, app1.getConfig());
  assertConfigEquals(config2, app2.getConfig());
  assertConfigEquals(config3, app3.getConfig());
  app1.setConfig(config1);
  /** @suppress {missingRequire} */
  assertEquals(0, firebaseui.auth.log.warning.getCallCount());
...
function testUpdateConfig() {
  ...
  assertConfigEquals(config, app1.getConfig());
  // Update API key.
  ...
  assertConfigEquals(expectedConfig, app1.getConfig());
  /** @suppress {missingRequire} */
  assertEquals(0, firebaseui.auth.log.warning.getCallCount());
  // Verifies that signInSuccess callback throws deprecation warning.
  var callbacks = {
...
function testSendSignInLinkToEmail_success() {
  ...
  app.sendSignInLinkToEmail("user@example.com").then(function () {
    assertEquals(
      "user@example.com",
...
function testSendSignInLinkToEmail_error() {
  ...
  app.sendSignInLinkToEmail("user@example.com").then(fail, function (error) {
...
function testSendSignInLinkToEmail_linkingFlow_success() {
  ...
  app
    .sendSignInLinkToEmail("user@example.com", pendingEmailCredential)
    .then(function () {
      assertEquals(
        "user@example.com",
        firebaseui.auth.storage.getEmailForSignIn("SESSIONID", app.getAppId())
...
function testGetUpgradeableEmailLinkUser_requiredAndMismatch() {
  ...
  app
    .getUpgradeableEmailLinkUser(builder.toString())
...
function testUpgradeWithEmailLink_emailExists_noPendingCredential_conflict() {
  ...
  app
    .upgradeWithEmailLink(app.getExternalAuth().currentUser, email, link)
    .then(fail, function (error) {
  ...
  app.getAuth().assertFetchSignInMethodsForEmail([email], function () {
...
function testUpgradeWithEmailLink_emailExists_pendingCredential_conflict() {
  ...
  app
    ...
    .then(function () {
      ...
      app.getAuth().assertSignInWithEmailLink([email, link], function () {
    ...
    .then(function () {
      ...
      app
        .getAuth()
        .currentUser.assertLinkWithCredential([pendingCredential], function () {
          // Return internal currentUser reference.
...
function testUpgradeWithEmailLink_newEmail_success() {
  ...
  app
    ...
    .then(function () {
      ...
      app
        .getExternalAuth()
        .currentUser.assertLinkWithCredential([cred], function () {
...
function testUpgradeWithEmailLink_error() {
  ...
  app.getAuth().assertFetchSignInMethodsForEmail([email], null, expectedError);
  app.getAuth().process();
}
...
function testSignInWithEmailLink_pendingCredential_success() {
  ...
  app
    .signInWithEmailLink(email, link, pendingCredential)
    .then(function (userCredential) {
      assertObjectEquals(expectedUserCredential, userCredential);
      assertNull(app.getAuth().currentUser);
      assertEquals(userCredential["user"], app.getExternalAuth().currentUser);
  ...
  app
    ...
    .then(function () {
      ...
      app
        .getExternalAuth()
        .assertUpdateCurrentUser([tempInternalUser], function () {
...
function testSignInWithEmailLink_noPendingCredential_success() {
  ...
  app.signInWithEmailLink(email, link).then(function (userCredential) {
    assertObjectEquals(expectedUserCredential, userCredential);
    assertNull(app.getAuth().currentUser);
    assertEquals(userCredential["user"], app.getExternalAuth().currentUser);
    asyncTestCase.signal();
...
function testSignInWithEmailLink_error() {
  ...
  // Confirm backend error passed through to client.
  app.signInWithEmailLink(email, link).then(fail, function (error) {
    assertEquals(expectedError, error);
    asyncTestCase.signal();
  });

  // Simulate network error.
  app.getAuth().assertSignInWithEmailLink([email, link], null, expectedError);
  app.getAuth().process();
}
...
function testStartSignInWithEmailAndPassword_success() {
  ...
  app
    .startSignInWithEmailAndPassword("user@example.com", "password")
    .then(function (userCredential) {
      assertObjectEquals(expectedUserCredential, userCredential);
      asyncTestCase.signal();
    });
  app
    .getAuth()
    .assertSignInWithEmailAndPassword(
...
function testStartCreateUserWithEmailAndPassword_success() {
  ...
  app
    .startCreateUserWithEmailAndPassword("user@example.com", "password")
    .then(function (userCredential) {
      assertObjectEquals(expectedUserCredential, userCredential);
      asyncTestCase.signal();
    });
  app
    .getAuth()
    .assertCreateUserWithEmailAndPassword(
      ["user@example.com", "password"],
      function () {
        app.getAuth().setUser(expectedUser);
        // Make a copy of expected UserCredential to ensure
...
function testStartCreateUserWithEmailAndPassword__upgradeAnon_isAnon_success() {
  ...
  app
    .getExternalAuth()
    .currentUser.assertLinkWithCredential([emailCredential], function () {
      app.getExternalAuth().setUser(expectedUser);
      // Make a copy of expected UserCredential to ensure
      // expectedUserCredential which is used to be compared with later will
      // not be modified.
...
function testStartCreateUserWithEmailAndPassword_upgradeAnon_emailInUseError() {
  ...
  app
    .getExternalAuth()
    .currentUser.assertLinkWithCredential(
      [emailCredential],
      null,
      expectedError
    );
...
function testStartSignInWithCredential_success() {
  ...
  asyncTestCase.waitForSignals(1);
  app
    .startSignInWithCredential(expectedCredential)
    .then(function (userCredential) {
      assertEquals(expectedUserCredential, userCredential);
      asyncTestCase.signal();
    });
  app.getAuth().assertSignInWithCredential([expectedCredential], function () {
    app.getAuth().setUser(expectedUser);
    return expectedUserCredential;
  });
  app.getAuth().process();
...
function testStartSignInWithCredential_error() {
  ...
  app
    .getAuth()
    .assertSignInWithCredential([expectedCredential], null, expectedError);
  app.getAuth().process();
  app.getExternalAuth().process();
}
...
function testStartSignInWithCredential_upgradeAnonymous_isAnonymous_success() {
  ...
  app
    .getExternalAuth()
    .currentUser.assertLinkWithCredential([expectedCredential], function () {
      app.getExternalAuth().setUser(expectedUser);
      return expectedUserCredential;
    });
  app.getAuth().process();
...
function testStartSignInWithPopup_success() {
  ...
  app.getExternalAuth().install();
  asyncTestCase.waitForSignals(1);
  app.startSignInWithPopup(expectedProvider).then(function (userCredential) {
    assertEquals(expectedUserCredential, userCredential);
    asyncTestCase.signal();
  });
  app.getAuth().assertSignInWithPopup([expectedProvider], function () {
    app.getAuth().setUser(expectedUser);
    return expectedUserCredential;
  });
  app.getAuth().process();
...
function testStartSignInWithPopup_error() {
  ...
  app.getExternalAuth().install();
  asyncTestCase.waitForSignals(1);
  app.startSignInWithPopup(expectedProvider).then(fail, function (error) {
    assertEquals(expectedError, error);
    asyncTestCase.signal();
  });
  app.getAuth().assertSignInWithPopup([expectedProvider], null, expectedError);
  app.getAuth().process();
  app.getExternalAuth().process();
}
...
function testStartSignInWithPopup_upgradeAnonymous_isAnonymous_success() {
  ...
  app
    .getExternalAuth()
    .currentUser.assertLinkWithPopup([expectedProvider], function () {
      app.getExternalAuth().setUser(expectedUser);
      return expectedUserCredential;
    });
  app.getAuth().process();
...
function testStartSignInWithPopup_upgradeAnonymous_emailAlreadyInUseError() {
  ...
  app
    .getExternalAuth()
    .currentUser.assertLinkWithPopup([expectedProvider], null, expectedError);
  app.getAuth().process();
  app.getExternalAuth().process();
}
...
function testStartSignInWithRedirect_success() {
  ...
  app.getExternalAuth().install();
  asyncTestCase.waitForSignals(1);
  app.startSignInWithRedirect(expectedProvider).then(function () {
    asyncTestCase.signal();
  });
...
function testStartSignInWithRedirect_error() {
  ...
  app.getExternalAuth().install();
  asyncTestCase.waitForSignals(1);
  app.startSignInWithRedirect(expectedProvider).then(fail, function (error) {
    assertEquals(expectedError, error);
    asyncTestCase.signal();
  });
  app
    .getAuth()
    .assertSignInWithRedirect([expectedProvider], null, expectedError);
  app.getAuth().process();
  app.getExternalAuth().process();
}
...
function testStartSignInWithRedirect_upgradeAnonymous_isAnonymous_success() {
  ...
  app.getExternalAuth().currentUser.assertLinkWithRedirect([expectedProvider]);
  app.getAuth().process();
  app.getExternalAuth().process();
}
...
function testStartSignInWithRedirect_upgradeAnonymous_error() {
  ...
  app
    .getExternalAuth()
    .currentUser.assertLinkWithRedirect(
      [expectedProvider],
      null,
      expectedError
    );
...
function testStartSignInWithPhoneNumber_success() {
  ...
  asyncTestCase.waitForSignals(1);
  app
    .startSignInWithPhoneNumber(expectedPhoneNumber, expectedAppVerifier)
...
function testStartSignInWithPhoneNumber_upgradeAnon_isAnonymous_success() {
  ...
  app
    .getExternalAuth()
    .currentUser.assertLinkWithPhoneNumber(
      [expectedPhoneNumber, expectedAppVerifier],
      expectedConfirmationResult
    );
  app.getExternalAuth().process();
...
function testStartSignInAnonymously_success() {
  ...
  app.getExternalAuth().assertSignInAnonymously([], function () {
    app.getExternalAuth().setUser(anonymousUser);
    return expectedUserCredential;
  });
  app.getExternalAuth().process();
...
function testStartSignInAnonymously_error() {
  ...
  app.getExternalAuth().assertSignInAnonymously([], null, expectedError);
  app.getAuth().process();
  app.getExternalAuth().process();
}
...
function testFinishSignInAndRetrieveDataWithAuthResult_success() {
  ...
  app
    .finishSignInAndRetrieveDataWithAuthResult(authResult)
  ...
  app
    ...
    .then(function () {
      app
        .getExternalAuth()
        .assertUpdateCurrentUser([expectedUser], function () {
          app.getExternalAuth().setUser(expectedUser);
...
function testFinishSignInAndRetrieveDataWithAuthResult_error() {
  ...
  app
    ...
    .then(function () {
      app
        .getExternalAuth()
        .assertUpdateCurrentUser([expectedUser], null, expectedError);
      return app.getExternalAuth().process();
    });
}
...
function testClearTempAuthState_success() {
  ...
  app.getExternalAuth().install();
  asyncTestCase.waitForSignals(1);
  app.clearTempAuthState().then(function () {
    asyncTestCase.signal();
  });
  app.getAuth().assertSignOut([]);
  app.getAuth().process();
...
function testClearTempAuthState_error() {
  ...
  app.getExternalAuth().install();
  asyncTestCase.waitForSignals(1);
  app.clearTempAuthState().then(fail, function (error) {
    assertEquals(expectedError, error);
    asyncTestCase.signal();
  });
  app.getAuth().assertSignOut([], null, expectedError);
  app.getAuth().process();
  app.getExternalAuth().process();
}
...
function testGetRedirectResult_success() {
  ...
  app.getAuth().assertGetRedirectResult([], function () {
    app.getAuth().setUser(expectedUser);
    return expectedUserCredential;
  });
  app
...
function testGetRedirectResult_caching_signInFlow() {
  ...
  app
    ...
    .then(function (result) {
      ...
      return app
        .startSignInWithRedirect(expectedProvider)
        .then(fail, function (error) {
          assertEquals(expectedError, error);
...
function testGetRedirectResult_caching_anonymousUpgradeFlow() {
  ...
  app.getExternalAuth().runAuthChangeHandler();
  // getRedirectResult called on internal instance.
  app.getExternalAuth().assertGetRedirectResult([], function () {
    app.getExternalAuth().setUser(expectedUser);
    return expectedUserCredential;
  });
  app
    ...
    .then(function () {
      ...
      app
        .getExternalAuth()
        .currentUser.assertLinkWithRedirect([expectedProvider]);
      return app.getExternalAuth().process();
    })
    .then(function () {
      // Underlying auth.getRedirectResult should overwrite cached app
...
function testGetRedirectResult_error() {
  ...
  app.getAuth().assertGetRedirectResult([], null, expectedError);
  app
    .getAuth()
    .process()
    .then(function () {
...
function testGetRedirectResult_upgradeAnonymous_emailAlreadyInUseError() {
  ...
  // detected).
  app.getExternalAuth().assertGetRedirectResult([], null, expectedError);
  app
    .getExternalAuth()
    .process()
    .then(function () {
...
function testOnUpgradeError_credentialAlreadyInUseError() {
  ...
  app.onUpgradeError(expectedError).thenCatch(function (error) {
    ...
    assertEquals(
      1,
      anonymousUpgradeConfig.callbacks.signInFailure.getCallCount()
    );
    assertErrorEquals(
      expectedMergeError,
      anonymousUpgradeConfig.callbacks.signInFailure
        .getLastCall()
        .getArgument(0)
    );
    asyncTestCase.signal();
...
function testOnUpgradeError_emailAlreadyInUseError() {
  ...
  asyncTestCase.waitForSignals(1);
  app
    .onUpgradeError(expectedError, expectedCredential)
