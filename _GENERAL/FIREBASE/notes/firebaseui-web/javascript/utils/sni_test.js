...
function testFirefox() {
  // Firefox 10
  support(
    "Mozilla/5.0 (Macintosh; Intel Mac OS X 10.6; rv:10.0.1)" +
  ...
  // Firefox 5
  support(
    "Mozilla/5.0 (Windows NT 6.2; WOW64; rv:5.0)" +
  ...
  // Firefox 1.x
  notSupport(
    "Mozilla/5.0 (X11; U; Linux i686 (x86_64); en-US; rv:1.8.0.6)" +
...
function testOperaMini() {
  notSupport(
    "Opera/9.80 (J2ME/MIDP; Opera Mini/6.24288/25.729; U; en)" +
      " Presto/2.5.25 Version/10.54"
  );
  notSupport(
    "Opera/9.80 (Series 60; Opera Mini/5.1.22784/23.334; U; en)" +
      " Presto/2.5.25 Version/10.54"
  );
}
...
function testOperaMobile() {
  ...
  support(
    "Opera/9.80 (Android 2.3.3; Linux; Opera Mobi/ADR-1111101157; U;" +
      " es-ES) Presto/2.9.201 Version/11.50"
  );
  // Opera Mobile 11 on Symbian
  notSupport(
    "Opera/9.80 (S60; SymbOS; Opera Mobi/SYB-1107071606; U; en)" +
      " Presto/2.8.149 Version/11.10"
  );
  // Opera Mobile 10 on Android
  support(
    "Opera/9.80 (Android; Linux; Opera Mobi/ADR-1012221546; U; pl)" +
      " Presto/2.7.60 Version/10.5"
  );
  support(
    "Opera/9.80 (Android; Linux; Opera Mobi/ADR-1011151731; U; de)" +
      " Presto/2.5.28 Version/10.1"
  );
  notSupport(
    "Opera/9.80 (Android; Linux; Opera Mobi/27; U; en)" +
      " Presto/2.4.18 Version/10.00"
  );
  // Opera Mobile 10 on Symbian
  notSupport(
    "Opera/9.80 (S60; SymbOS; Opera Mobi/1209; U; sk)" +
      " Presto/2.5.28 Version/10.1"
  );
}
...
function testChrome() {
  ...
  support(
    "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_7_2) AppleWebKit/535.1" +
  ...
  support(
    "Mozilla/5.0 ArchLinux (X11; U; Linux x86_64; en-US) AppleWebKit" +
  ...
  support(
    "Mozilla/5.0 (X11; U; CrOS i686 0.9.128; en-US) AppleWebKit/534.10" +
...
function testSafari() {
  ...
  support(
    "Mozilla/5.0 (Windows; U; Windows NT 6.1; tr-TR) AppleWebKit" +
  ...
  support(
    "Mozilla/5.0 (Macintosh; U; Intel Mac OS X 10_5_8; zh-tw)" +
      " AppleWebKit/533.16 (KHTML, like Gecko) Version/5.0 Safari/533.16"
  );
  // Safari 4 on Windows7/Vista
  support(
    "Mozilla/5.0 (Windows; U; Windows NT 6.1; es-ES) AppleWebKit" +
  ...
  notSupport(
    "Mozilla/5.0 (Windows; U; Windows NT 5.1; cs-CZ) AppleWebKit" +
      "/531.22.7 (KHTML, like Gecko) Version/4.0.5 Safari/531.22.7"
  );
  // Safari 4 on Mac OS X 10.5.6 or higher
  support(
    "Mozilla/5.0 (Macintosh; U; Intel Mac OS X 10_6_2; ja-jp)" +
      " AppleWebKit/531.22.7 (KHTML, like Gecko) Version/4.0.5" +
      " Safari/531.22.7"
  );
  support(
    "Mozilla/5.0 (Macintosh; U; PPC Mac OS X 10_5_8; en-us) AppleWebKit" +
...
function testAndroid() {
  ...
  support(
    "Mozilla/5.0 (Linux; U; Android 4.0; en-us; Galaxy Nexus Build" +
  ...
  notSupport(
    "Mozilla/5.0 (Linux; U; Android 2.3.4; en-us; T-Mobile myTouch" +
  ...
  notSupport(
    "Mozilla/5.0 (Linux; U; Android 2.2; fr-lu; HTC Legend Build" +
      "/FRF91) AppleWebKit/533.1 (KHTML, like Gecko) Version/4.0 Mobile" +
      " Safari/533.1"
  );
  notSupport(
    "Mozilla/5.0 (Linux; U; Android 1.6; ar-us; SonyEricssonX10i" +
...
function testMobileSafari() {
  ...
  support(
    "Mozilla/5.0 (iPhone; U; fr; CPU iPhone OS 4_2_1 like Mac OS X; fr)" +
      " AppleWebKit/533.17.9 (KHTML, like Gecko) Version/5.0.2 Mobile/8C148a" +
      " Safari/6533.18.5"
  );
  support(
    "Mozilla/5.0 (iPad; U; CPU OS 4_3 like Mac OS X; en-gb)" +
...
function testKonqueror() {
  // Konqueror 4.7
  support(
    "Mozilla/5.0 (X11; Linux; en_US) KHTML/4.7.0 (like Gecko)" +
      " Konqueror/4.7"
  );
  // prior to 4.7
  notSupport(
    "Mozilla/5.0 (X11; U; Linux x86_64; C) AppleWebKit/533.3" +
