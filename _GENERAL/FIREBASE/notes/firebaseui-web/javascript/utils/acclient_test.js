...
function testTrySelectAccount() {
  ...
  stubs.set(
    firebaseui.auth.acClient.api_,
    "select",
    mock.createFunctionMock("select")
  );
...
function testTrySelectAccount_localAccounts() {
  ...
  var localAccounts = new goog.testing.mockmatchers.ObjectEquals([acAccount]);
  var config = new goog.testing.mockmatchers.ObjectEquals({
    clientCallbackUrl: "http://localhost",
  });
  // For not empty
...
function testTryStoreAccount_store() {
  ...
  stubs.set(
    firebaseui.auth.acClient.api_,
    "update",
    mock.createFunctionMock("update")
  );
  var onSkipStore = mock.createFunctionMock("onSkipStore");

  var storeAccounts = new goog.testing.mockmatchers.ObjectEquals([acAccount]);
  var config = new goog.testing.mockmatchers.ObjectEquals({
    clientCallbackUrl: "http://localhost",
  });
...
function testTryStoreAccount_update() {
  ...
  var updateAccount = new goog.testing.mockmatchers.ObjectEquals(acAccount);
  var config = new goog.testing.mockmatchers.ObjectEquals({
    clientCallbackUrl: "http://localhost",
  });
