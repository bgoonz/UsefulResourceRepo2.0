...
function testCookieMechanism() {
  var cookiesSet = mockControl.createMethodMock(goog.net.cookies, "set");
  var cookiesGet = mockControl.createMethodMock(goog.net.cookies, "get");
  var cookiesRemove = mockControl.createMethodMock(goog.net.cookies, "remove");
