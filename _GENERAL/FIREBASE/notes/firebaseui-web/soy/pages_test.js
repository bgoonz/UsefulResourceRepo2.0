...
function testSignIn_infoBar() {
  ...
  var message =
    "You are currently logged into a different account on Google" +
    ". Please select another account or visit Google to login to the " +
    "desired one.";
  var infoBar = goog.soy.renderAsElement(firebaseui.auth.soy2.element.infoBar, {
    message: message,
  });
...
function testBlank() {
  ...
  goog.soy.renderElement(root, firebaseui.auth.soy2.page.blank, {}, IJ_DATA_);
}
...
function testSpinner() {
  ...
  goog.soy.renderElement(root, firebaseui.auth.soy2.page.spinner, {}, IJ_DATA_);
}
...
function testPasswordRecovery() {
  ...
  goog.soy.renderElement(
    ...
    { email: "user@example.com", allowCancel: true },
    IJ_DATA_
  );
}
...
function testUnauthorizedUser_withEmailAdminEmailHelpLink() {
  ...
  goog.soy.renderElement(
    root,
    firebaseui.auth.soy2.page.unauthorizedUser,
    {
      email: "user@example.com",
...
function testPasswordReset() {
  ...
  goog.soy.renderElement(root, firebaseui.auth.soy2.page.passwordReset, {
    email: "user@example.com",
  });
}
...
function testPasswordResetSuccess() {
  ...
  goog.soy.renderElement(root, firebaseui.auth.soy2.page.passwordResetSuccess, {
    allowContinue: true,
  });
}
...
function testPasswordResetFailure() {
  ...
  goog.soy.renderElement(root, firebaseui.auth.soy2.page.passwordResetFailure, {
    allowContinue: true,
  });
}
...
function testRecoverableError() {
  ...
  goog.soy.renderElement(
    ...
    {
      errorMessage:
        "A network error (such as timeout, interrupted " +
...
function testPhoneSignInStartInvisibleRecaptcha() {
  ...
  goog.soy.renderElement(
    ...
    { enableVisibleRecaptcha: false, displayCancelButton: true },
    IJ_DATA_
  );
}
...
function testPhoneSignInStartVisibleRecaptcha() {
  ...
  goog.soy.renderElement(
    root,
    firebaseui.auth.soy2.page.phoneSignInStart,
    { enableVisibleRecaptcha: true, displayCancelButton: true },
    IJ_DATA_
  );
  loadRecaptcha(root);
}
...
function testPhoneSignInStart_noCancelButton() {
  ...
  goog.soy.renderElement(
    root,
    firebaseui.auth.soy2.page.phoneSignInStart,
    { enableVisibleRecaptcha: false, displayCancelButton: false },
    IJ_DATA_
  );
}
...
function testSignOut() {
  ...
  goog.soy.renderElement(root, firebaseui.auth.soy2.page.signOut, {}, IJ_DATA_);
}
