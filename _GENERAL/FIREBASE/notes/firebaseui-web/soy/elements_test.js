...
function testPhoneConfirmationCode() {
  ...
  goog.soy.renderElement(
    root,
    firebaseui.auth.soy2.element.phoneConfirmationCode
  );
}
...
function testNewPassword_toggled() {
  ...
  var newPassword = goog.dom.getElementByClass(
    "firebaseui-id-new-password",
    root
  );
  newPassword["type"] = "text";

  var toggle = goog.dom.getElementByClass(
...
function testTroubleGettingEmailButton() {
  ...
  goog.soy.renderElement(
    root,
    firebaseui.auth.soy2.element.troubleGettingEmailButton
  );
}
...
function testResendEmailLinkButton() {
  ...
  goog.soy.renderElement(
    root,
    firebaseui.auth.soy2.element.resendEmailLinkButton
  );
}
...
function testTosPpLink() {
  ...
  goog.soy.renderElement(
    root,
    firebaseui.auth.soy2.element.tosPpLink,
    {},
    IJ_DATA_
  );
}
...
function testPhoneTosPp() {
  ...
  goog.soy.renderElement(
    root,
    firebaseui.auth.soy2.element.phoneTosPp,
    {},
    IJ_DATA_
  );
}
...
function testFullMessageTosPp() {
  ...
  goog.soy.renderElement(
    root,
    firebaseui.auth.soy2.element.fullMessageTosPp,
    {},
    IJ_DATA_
  );
}
...
function testRecaptcha() {
  ...
  goog.soy.renderElement(
    root,
    firebaseui.auth.soy2.element.recaptcha,
    {},
    IJ_DATA_
  );
  loadRecaptcha(root);
...
function testLoadingDialog() {
  var data = {
    iconClass:
      "mdl-spinner mdl-spinner--single-color mdl-js-spinner " +
...
function testLoadingDialogLongText() {
  var data = {
    iconClass:
      ...
      "firebaseui-progress-dialog-loading-icon is-active",
    message:
      "I am loading dialog that has very long text. Seriously, the " +
