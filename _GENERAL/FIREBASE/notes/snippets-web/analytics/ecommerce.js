...
function ecommerceViewItemList() {
  ...
  firebase
    .analytics()
    .logEvent(firebase.analytics.EventName.VIEW_ITEM_LIST, params1);
...
function ecommerceSelectItem() {
  ...
  firebase
    .analytics()
    .logEvent(firebase.analytics.EventName.SELECT_ITEM, params2);
...
function ecommerceViewItemDetails() {
  ...
  firebase
    .analytics()
    .logEvent(firebase.analytics.EventName.VIEW_ITEM, params3);
...
function ecommerceAddCart() {
  ...
  firebase
    .analytics()
    .logEvent(firebase.analytics.EventName.ADD_TO_WISHLIST, params4);

  // Log event when a product is added to the cart
  firebase
    .analytics()
    .logEvent(firebase.analytics.EventName.ADD_TO_CART, params4);
...
function ecommerceViewCart() {
  ...
  firebase
    .analytics()
    .logEvent(firebase.analytics.EventName.VIEW_CART, params5);
...
function ecommerceRemoveCart() {
  ...
  firebase
    .analytics()
    .logEvent(firebase.analytics.EventName.REMOVE_FROM_CART, params6);
...
function ecommerceCheckout() {
  ...
  firebase
    .analytics()
    .logEvent(firebase.analytics.EventName.BEGIN_CHECKOUT, params7);
...
function ecommerceShippingInfo() {
  ...
  firebase
    .analytics()
    .logEvent(firebase.analytics.EventName.ADD_SHIPPING_INFO, params8);
...
function ecommercePaymentInfo() {
  ...
  firebase
    .analytics()
    .logEvent(firebase.analytics.EventName.ADD_PAYMENT_INFO, params9);
...
function ecommercePurchase() {
  ...
  firebase
    .analytics()
    .logEvent(firebase.analytics.EventName.PURCHASE, params10);
...
function ecommercePromotions() {
  ...
  firebase
    .analytics()
    .logEvent(firebase.analytics.EventName.VIEW_PROMOTION, params12);

  // Log event when a promotion is selected
  firebase
    .analytics()
    .logEvent(firebase.analytics.EventName.SELECT_PROMOTION, params12);
