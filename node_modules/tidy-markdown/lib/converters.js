...
'use_strict'
var CODE_HIGHLIGHT_REGEX, _, delimitCode, extractRows, fallback, formatHeaderSeparator, formatRow, getAttribute, getColumnWidths, indent, indentChildren, insertText, insertTextBefore, isBlock, isTextNode, isValidLink, languageCodeRewrite, ref, ref1, serialize, treeAdapter,
...
ref = require('./utils'), delimitCode = ref.delimitCode, getAttribute = ref.getAttribute, isBlock = ref.isBlock
