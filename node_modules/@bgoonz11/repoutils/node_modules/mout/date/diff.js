...
var totalDaysInMonth_1 = require("./totalDaysInMonth");
var totalDaysInYear_1 = require("./totalDaysInYear");
var convert_1 = require("../time/convert");
/**
...
function diff(start, end, unitName) {
    ...
    if (unitName === 'month') {
        ...
        output = convert_1["default"](end - start, 'ms', unitName);
    }
    else {
        output = end - start;
    }
...
function getFractionalMonth(start, end) {
    ...
    if (startDay !== endDay) {
        var startTotalDays = totalDaysInMonth_1["default"](start);
        var endTotalDays = totalDaysInMonth_1["default"](end);
        var totalDays = void 0;
        var daysElapsed = void 0;
        if (startDay > endDay) {
...
function getFractionalYear(start, end, elapsedYears) {
    ...
    return elapsedDays / totalDaysInYear_1["default"](end);
}
