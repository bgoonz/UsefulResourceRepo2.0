var _self =
  ...
  Prism = (function () {
      ...
      n = (_self.Prism = {
        util: {
          encode: function (e) {
            return e instanceof t
              ? new t(e.type, n.util.encode(e.content), e.alias)
              : "Array" === n.util.type(e)
              ? e.map(n.util.encode)
              : e
                  .replace(/&/g, "&amp;")
          ...
          clone: function (e) {
            ...
            switch (t) {
              case "Object":
                var i = {};
                for (var a in e)
                  e.hasOwnProperty(a) && (i[a] = n.util.clone(e[a]));
                return i;
              case "Array":
                return (
                  e.map &&
        ...
        languages: {
          ...
          insertBefore: function (e, t, i, a) {
            ...
            return (
              n.languages.DFS(n.languages, function (n, t) {
                t === a[e] && n != e && (this[n] = o);
              }),
              (a[e] = o)
            );
          ...
          DFS: function (e, t, i) {
            for (var a in e)
              e.hasOwnProperty(a) &&
                (t.call(e, a, e[a], i || a),
                "Object" === n.util.type(e[a])
                  ? n.languages.DFS(e[a], t)
                  : "Array" === n.util.type(e[a]) &&
                    n.languages.DFS(e[a], t, a));
          },
        },
        plugins: {},
        ...
        highlightElement: function (t, i, a) {
          ...
          o &&
            ((s = (o.className.match(e) || [, ""])[1]), (r = n.languages[s])),
            (t.className =
            ...
            /pre/i.test(o.nodeName) &&
              (o.className =
                ...
                s);
          var l = t.textContent,
            p = { element: t, language: s, grammar: r, code: l };
          if (!l || !r) return void n.hooks.run("complete", p);
          if ((n.hooks.run("before-highlight", p), i && _self.Worker)) {
            var c = new Worker(n.filename);
            (c.onmessage = function (e) {
              (p.highlightedCode = e.data),
                n.hooks.run("before-insert", p),
                (p.element.innerHTML = p.highlightedCode),
                a && a.call(p.element),
                n.hooks.run("after-highlight", p),
                n.hooks.run("complete", p);
            }),
              c.postMessage(
                JSON.stringify({
                  language: p.language,
            ...
            (p.highlightedCode = n.highlight(p.code, p.grammar, p.language)),
              n.hooks.run("before-insert", p),
              (p.element.innerHTML = p.highlightedCode),
              a && a.call(t),
              n.hooks.run("after-highlight", p),
        ...
        highlight: function (e, i, a) {
          var s = n.tokenize(e, i);
          return t.stringify(n.util.encode(s), a);
        },
                  ...
                  if (!(f instanceof i)) {
                    ...
                    if (b) {
                      ...
                      var h = b.index - 1 + m,
                        ...
                        x = [g, 1];
                      k && x.push(k);
                      var _ = new i(r, c ? n.tokenize(b, c) : b, u);
                      x.push(_),
                        y && x.push(y),
        ...
        hooks: {
          ...
          run: function (e, t) {
            var i = n.hooks.all[e];
            if (i && i.length) for (var a, s = 0; (a = i[s++]); ) a(t);
          },
        },
      }),
    ...
    if (
      ((t.stringify = function (e, i, a) {
        if ("string" == typeof e) return e;
        if ("Array" === n.util.type(e))
          return e
            .map(function (n) {
              return t.stringify(n, i, e);
            })
            .join("");
        var s = {
          type: e.type,
          content: t.stringify(e.content, i, a),
          tag: "span",
        ...
        if (
          ("comment" == s.type && (s.attributes.spellcheck = "true"), e.alias)
        ) {
        ...
        ? (_self.addEventListener(
            ...
            function (e) {
              var t = JSON.parse(e.data),
                ...
                a = t.code,
                s = t.immediateClose;
              _self.postMessage(n.highlight(a, n.languages[i], i)),
                s && _self.close();
            },
            !1
          ),
...
"undefined" != typeof module && module.exports && (module.exports = Prism),
    ...
    for (
      ...
      (r = "string" == typeof r ? { filter: r, language: r } : r),
        e.languages[r.language] &&
          (i["filter-" + r.filter] = {
            pattern: RegExp(n.replace("{{filter_name}}", r.filter)),
            lookbehind: !0,
            inside: {
  ...
  !(function (e) {
    ...
    (e.languages.handlebars = e.languages.extend("markup", {
      ...
      e.hooks.add("after-highlight", function (n) {
        if ("handlebars" === n.language) {
          for (var t, i = 0; (t = n.tokenStack[i]); i++)
            n.highlightedCode = n.highlightedCode.replace(
              "___HANDLEBARS" + (i + 1) + "___",
              e.highlight(t, n.grammar, "handlebars").replace(/\$/g, "$$$$")
            );
...
(Prism.languages.php = Prism.languages.extend("clike", {
  ...
  Prism.languages.markup &&
    ...
    Prism.hooks.add("after-highlight", function (e) {
      if ("php" === e.language) {
        for (var n, t = 0; (n = e.tokenStack[t]); t++)
  ...
  !(function (e) {
    ...
    e.languages.insertBefore("sass", "property", {
      "variable-line": {
        pattern: /^[ \t]*\$.+/m,
        inside: { punctuation: /:/, variable: n, operator: t },
      },
      "property-line": {
        pattern: /^[ \t]*(?:[^:\s]+ *:.*|:[^:\s]+.*)/m,
        inside: {
