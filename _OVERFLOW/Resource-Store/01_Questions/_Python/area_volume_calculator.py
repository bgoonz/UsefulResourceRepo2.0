    ...
    if raw_input("\n[{}] Exit(press e), Continue(press c): ".format(i)).lower() == "c":
        ...
        if which_fig == "s":
            if raw_input("\nArea(press a) or Perimeter(press p): ").lower() == "a":
                print(
                    "\tArea of square: "
                    + str(area_of_square(float(raw_input("Side of square: "))))
                )
            else:
                print(
                    "\tPerimeter of square: "
                    + str(peri_of_square(float(raw_input("Side: "))))
                )
            ...
            if raw_input("\nArea(press a) or Perimeter(press p): ").lower() == "a":
                print(
                    ...
                    + str(
                        area_of_rectangle(
                            float(raw_input("Length: ")), float(raw_input("Width: "))
                        )
                    )
                )
            else:
            ...
            if raw_input("\nArea(press a) or Perimeter(press p): ").lower() == "a":
                if raw_input("\nBy Heron's Formula[y/n]: ").lower() == "y":
                    ...
                    print(
                        ...
                        + str(
                            area_of_triangle(
                                float(raw_input("Base: ")), float(raw_input("Height: "))
                            )
                        )
                    )
            else:
            ...
            if raw_input("\nArea(press a) or Perimeter(press p): ").lower() == "a":
                ...
                print(
                    "\tPerimeter or right angled triangle: "
                    + str(
                        peri_of_rt_triangle(
                            float(raw_input("A: ")), float(raw_input("B: "))
                        )
                    )
                )
            ...
            if raw_input("\nArea(press a) or Perimeter(press p): ").lower() == "a":
                print(
                    ...
                    + str(
                        area_of_trapezoid(
                            float(raw_input("Base 1: ")),
                            float(raw_input("Base 2: ")),
                            float(raw_input("Height: ")),
                        )
                    )
                )
            else:
                print(
                    ...
                    + str(
                        peri_of_triangle(
                            float(raw_input("Side1: ")),
                            float(raw_input("Side4: ")),
                            float(raw_input("Side3: ")),
                        )
                        + float(raw_input("Side1: "))
                    )
                )
            ...
            if raw_input("\nArea(press a) or Perimeter(press p): ").lower() == "a":
                print(
                    "\tArea of circle: "
                    + str(area_of_circle(float(raw_input("Radius: "))))
                )
            else:
                if raw_input("\nUsing Radius(r) or Diameter(d): ").lower() == "r":
                    print(
                        "\tCircumference of circle: "
                        + str(peri_of_circle(float(raw_input("Radius: "))))
                    )
                else:
                    print(
                        "\tCircumference of circle: "
                        + str(peri_of_circle1(float(raw_input("Diameter: "))))
                    )
