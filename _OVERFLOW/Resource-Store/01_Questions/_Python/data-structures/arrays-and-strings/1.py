...
if __name__ == "__main__":
    ...
    print(method_a, timeit(method_a + "('abc')", setup=setup_a))
    print(method_b, timeit(method_b + "('abc')", setup=setup_b))
    print(
        method_a,
        timeit(method_a + "('abcdefghijklmnopqrstuvxwyz1234567890')", setup=setup_a),
    )
    print(
        method_b,
        timeit(method_b + "('abcdefghijklmnopqrstuvxwyz1234567890')", setup=setup_b),
    )
