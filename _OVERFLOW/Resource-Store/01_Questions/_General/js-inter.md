...
157. ### What are regular expression patterns
    ...
    1.  **Brackets:** These are used to find a range of characters. For example, below are some use cases,
        1.  2.  3.  (a|b): Used to find any of the alternatives separated with |
...
384. ### What is web speech API
    ...
    The above examples can be tested on chrome(33+) browser’s developer console. **Note:** This API is still a working draft and only available in Chrome and Firefox browsers(ofcourse Chrome only implemented the specification) **[⬆ Back to Top](#table-of-contents)**
...
388. ### What is microtask
    ...
    **Note:** All of these microtasks are processed in the same turn of the event loop. **[⬆ Back to Top](#table-of-contents)**
...
398. ### What is babel
    ...
    1.  Transform syntax
    2.  Polyfill features that are missing in your target environment (using <span class="citation" data-cites="babel/polyfill">@babel/polyfill</span>)
...
2.  ### How do style the console output using CSS?
