...
Stores things in order. Has quick lookups by index. ![](arr1.png) ![](array.png)
...
Like the line outside a busy restaurant. “First come, first served.” [](linked-list.png) ![](queue.png)

Stack
-----

![](stack.gif) ![](stack.png) Like a stack of dirty plates in the sink. The first one you take off the top is the last one you put down.

Tree
----

Good for storing hierarchies. Each node can have “child” nodes. ![](tree.png) ![](leaves-depth-height.png) ![](traversals.png) ![](dfs.png) ![](pre-and-in-order-traversal.png) ![](post-order.png)

Binary Search Tree
------------------

Everything in the left subtree is smaller than the current node, everything in the right subtree is larger. lookups, but only if the tree is balanced! ![](binary-tree.png)
...
Good for storing networks, geography, social relationships, etc. ![](graph.png) ![](directed-or-undirected-cycles.png) ![](weighted-or-unweighted.png)
...
1.  Level 0: 2^0 nodes,
2.  1.  Level 1: 2^1 nodes,

3.  1.  Level 2: 2^2 nodes,
